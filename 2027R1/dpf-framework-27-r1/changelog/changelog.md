...
Changes since the last released version for DPF 27.1.pre0 (as of 2026-02-18).
...
- [mapdl.pres_to_field](https://ansys-a.devportal.io/docs/dpf-framework-2027-r1/operator-specifications/result/mapdl.pres_to_field.md)
