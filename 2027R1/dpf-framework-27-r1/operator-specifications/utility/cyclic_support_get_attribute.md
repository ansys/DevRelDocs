...
|------------|------|--------|------------------|
| <strong>0</strong> | [cyclic_support](#input_0) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`cyclic_support`](../../core-concepts/dpf-types.md#cyclic-support) |
