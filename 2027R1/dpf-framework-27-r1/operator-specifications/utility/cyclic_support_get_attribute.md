...
|-------|-------|------------------|
| <strong>0</strong> <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  [cyclic_support](#input_0) |[`cyclic_support`](../../core-concepts/dpf-types.md#cyclic-support) |
