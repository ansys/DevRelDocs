...
|------------|------|--------|------------------|
| <strong>0</strong> | [scopings_containers](#input_0) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|`vector<shared_ptr<scopings_container>>`, [`scopings_container`](../../core-concepts/dpf-types.md#scopings-container) |
