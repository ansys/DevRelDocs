 ...
 **Scripting name**: heat_transport_rate

 **Full name**: result.heat_transport_rate

 **Internal name**: HeatTransportRate
...
ansys::dpf::Operator op("HeatTransportRate"); // operator instantiation
...
op = dpf.operators.result.heat_transport_rate() # operator instantiation
