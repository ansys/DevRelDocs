 ...
 **Scripting name**: raw_acceleration

 **Full name**: result.raw_acceleration
...
ansys::dpf::Operator op("ATOT"); // operator instantiation
...
op = dpf.operators.result.raw_acceleration() # operator instantiation
