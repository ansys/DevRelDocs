 ...
 **Scripting name**: acoustic_pressure

 **Full name**: result.acoustic_pressure

 **Internal name**: AcousticPressure
...
ansys::dpf::Operator op("AcousticPressure"); // operator instantiation
...
op = dpf.operators.result.acoustic_pressure() # operator instantiation
