 ...
 **Scripting name**: emissivity

 **Full name**: result.emissivity

 **Internal name**: Emissivity
...
ansys::dpf::Operator op("Emissivity"); // operator instantiation
...
op = dpf.operators.result.emissivity() # operator instantiation
