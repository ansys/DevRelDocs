...
# result:emitted radiation heat flux
 ...
 **Scripting name**: emitted_radiation_heat_flux

 **Full name**: result.emitted_radiation_heat_flux

 **Internal name**: EmittedRadiationHeatFlux
...
ansys::dpf::Operator op("EmittedRadiationHeatFlux"); // operator instantiation
...
op = dpf.operators.result.emitted_radiation_heat_flux() # operator instantiation
