 ...
 **Scripting name**: enclosure_number

 **Full name**: result.enclosure_number

 **Internal name**: EnclosureNumber
...
ansys::dpf::Operator op("EnclosureNumber"); // operator instantiation
...
op = dpf.operators.result.enclosure_number() # operator instantiation
