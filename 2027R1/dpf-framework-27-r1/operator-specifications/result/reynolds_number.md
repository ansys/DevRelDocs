 ...
 **Scripting name**: reynolds_number

 **Full name**: result.reynolds_number

 **Internal name**: ReynoldsNumber
...
ansys::dpf::Operator op("ReynoldsNumber"); // operator instantiation
...
op = dpf.operators.result.reynolds_number() # operator instantiation
