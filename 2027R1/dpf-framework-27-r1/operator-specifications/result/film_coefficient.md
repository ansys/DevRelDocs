 ...
 **Scripting name**: film_coefficient

 **Full name**: result.film_coefficient

 **Internal name**: FilmCoefficient
...
ansys::dpf::Operator op("FilmCoefficient"); // operator instantiation
...
op = dpf.operators.result.film_coefficient() # operator instantiation
