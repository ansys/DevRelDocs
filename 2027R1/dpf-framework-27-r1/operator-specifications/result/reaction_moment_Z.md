 ...
 **Scripting name**: reaction_moment_Z

 **Full name**: result.reaction_moment_Z

 **Internal name**: RF_MomentZ
...
ansys::dpf::Operator op("RF_MomentZ"); // operator instantiation
...
op = dpf.operators.result.reaction_moment_Z() # operator instantiation
