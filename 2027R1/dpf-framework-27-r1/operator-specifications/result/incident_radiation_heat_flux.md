...
# result:incident radiation heat flux
 ...
 **Scripting name**: incident_radiation_heat_flux

 **Full name**: result.incident_radiation_heat_flux

 **Internal name**: IncidentRadiationHeatFlux
...
ansys::dpf::Operator op("IncidentRadiationHeatFlux"); // operator instantiation
...
op = dpf.operators.result.incident_radiation_heat_flux() # operator instantiation
