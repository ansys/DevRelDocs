...
| <strong>1</strong> | [factor](#input_1) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`double`](../../core-concepts/dpf-types.md#standard-types) |
| <strong>2</strong> | [division_by_zero_value](#input_2) |  |[`double`](../../core-concepts/dpf-types.md#standard-types) |
