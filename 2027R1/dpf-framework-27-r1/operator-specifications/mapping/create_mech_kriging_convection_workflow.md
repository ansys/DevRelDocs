...
# mapping:create mechanical native mapping for kriging convection workflow
 ...
 **Scripting name**: create_mech_kriging_convection_workflow

 **Full name**: mapping.create_mech_kriging_convection_workflow

 **Internal name**: mech_kriging_secondary_wf
...
ansys::dpf::Operator op("mech_kriging_secondary_wf"); // operator instantiation
...
op = dpf.operators.mapping.create_mech_kriging_convection_workflow() # operator instantiation
