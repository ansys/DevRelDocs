...
* Custom Views with Natvis Files
...
The default debug view constructs a standard visualization for any class. However, you can define your own visualization using Natvis files.<br/>
<br/>
...
### <a id="_1debug6"></a>
Producing Chrome Trace Event traces

You can produce traces that follow the execution of operators and workflows in a format that can be interactively opened and explored. This approach does not carry any result data, unlike **DATAPROCESSING_DEBUG**.
...
4. Navigate to the special <code>about:tracing</code> URL.
...
On Windows, the available measures are <code>WorkingSetSize</code> and <code>PrivateUsage</code> from [PROCESS_MEMORY_COUNTERS_EX](https://learn.microsoft.com/en-us/windows/win32/api/psapi/ns-psapi-process_memory_counters_ex), in bytes.
