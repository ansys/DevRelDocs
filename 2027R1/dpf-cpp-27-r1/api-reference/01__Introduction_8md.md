<a id="01__Introduction_8md"></a>
# File 01\_Introduction.md

![][Markdown]

**Location**: `cpp\_doc/01\_Introduction.md`
...
The data in DPF is defined based on physics-agnostic mathematical quantities described in self-sufficient entities called fields. This allows DPF to be a modular and easy-to-use tool with a large range of capabilities. It is designed to handle large amounts of data.<br>![](dpf-flow.png)<br>
...
The following sections are summaries. For more detailed content, see @ref group_03.
...
#### <a name="access_server"></a>Accessing DPF Server files
...
- [C++ operator's library](@ref group_06_2)
...
See @ref getting_started section to know how to get started with DPF. 
...
@defgroup group_1_get_started Starting to use DPF
* Diverse way to get started with DPF in an easy manner. 
@defgroup group_2_concepts Concepts and terms
* Learn about DPF concepts and terms. 
@defgroup group_4_how_tos How-tos
