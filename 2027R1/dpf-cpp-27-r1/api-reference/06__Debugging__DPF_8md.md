<a id="06__Debugging__DPF_8md"></a>
# File 06\_Debugging\_DPF.md

![][Markdown]

**Location**: `cpp\_doc/06\_Debugging\_DPF.md`
...
```markdown
 @defgroup group_06 Debugging in DPF
 @ingroup group_4_how_tos

Debugging enables you to analyze how DPF runs and generates data so that you can find defects in your code. You can use the Watch window in Visual Studio to visualize any member of any object.<br><br>![](debugger.png)<br>
...
The default debug view constructs a standard visualization for any class. However, you can define your own visualization using [Natvis files](#debug2).<br><br>![](debug-views.png)<br>
...
**Default view with no customization:**<br><br>![](no-natvis.png)<br>

**Custom Natvis view:**<br><br>![](with-natvis.png)<br>
...
To enable graph visualization, workflows in DPF have a Graphviz export method:<br><br>![](graphviz-export.png)<br>
...
When you use a Graphviz diagram in combination with a Natvis view, you can see the content of each operator of a workflow (using their IDs).<br><br>![](graph-combo.png)<br>
