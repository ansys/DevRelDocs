//[mc_api](../../../index.md)/[com.phoenix_int.ModelCenter](../index.md)/[ITradeStudy3JobManager](index.md)/[setRunInParallel](set-run-in-parallel.md)
...
| | |
|---|---|
| runInParallel | whether runs should be run in parallel |
