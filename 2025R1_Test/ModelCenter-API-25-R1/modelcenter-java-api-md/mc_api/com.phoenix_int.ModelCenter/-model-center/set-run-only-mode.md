//[mc_api](../../../index.md)/[com.phoenix_int.ModelCenter](../index.md)/[ModelCenter](index.md)/[setRunOnlyMode](set-run-only-mode.md)

# setRunOnlyMode


public [setRunOnlyMode](set-run-only-mode.md)(shouldBeInRunOnly: [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html))
