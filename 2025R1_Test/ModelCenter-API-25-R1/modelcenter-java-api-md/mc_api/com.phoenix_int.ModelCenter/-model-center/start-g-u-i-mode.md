//[mc_api](../../../index.md)/[com.phoenix_int.ModelCenter](../index.md)/[ModelCenter](index.md)/[startGUIMode](start-g-u-i-mode.md)

# startGUIMode


public [startGUIMode](start-g-u-i-mode.md)(showDialogs: [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html))
