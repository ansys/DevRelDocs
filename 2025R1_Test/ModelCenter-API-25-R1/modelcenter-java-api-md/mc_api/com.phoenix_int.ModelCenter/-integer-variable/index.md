//[mc_api](../../../index.md)/[com.phoenix_int.ModelCenter](../index.md)/[IntegerVariable](index.md)

# IntegerVariable


public class [IntegerVariable](index.md) : [Variable](../-variable/index.md)
...
| [getLowerBound](get-lower-bound.md) | public [getLowerBound](get-lower-bound.md)(): [Long](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-long/index.html)<br>gets the lower bound for the variable |
...
| [getUpperBound](get-upper-bound.md) | public [getUpperBound](get-upper-bound.md)(): [Long](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-long/index.html)<br>gets the upper bound for the variable |
| [getValue](get-value.md) | public [getValue](get-value.md)(): [Long](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-long/index.html)<br>gets the value of the variable |
| [getValueAbsolute](get-value-absolute.md) | public [getValueAbsolute](get-value-absolute.md)(): [Long](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-long/index.html)<br>gets the value of the variable without validating it |
...
| [setLowerBound](set-lower-bound.md) | public [setLowerBound](set-lower-bound.md)(bound: [Long](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-long/index.html))<br>sets the lower bound for the variable |
...
| [setUpperBound](set-upper-bound.md) | public [setUpperBound](set-upper-bound.md)(bound: [Long](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-long/index.html))<br>sets the upper bound for the variable |
| [setValue](set-value.md) | public [setValue](set-value.md)(value: [Long](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-long/index.html))<br>sets the value of the variable |
