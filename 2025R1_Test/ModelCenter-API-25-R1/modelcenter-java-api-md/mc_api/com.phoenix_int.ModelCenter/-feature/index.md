//[mc_api](../../../index.md)/[com.phoenix_int.ModelCenter](../index.md)/[Feature](index.md)

# Feature


public class [Feature](index.md) : [PHXCOMObject](../../com.phoenix_int.ModelCenter.util/-p-h-x-c-o-m-object/index.md)

This is the wrapper class that handles the native COM calls to PHXFeature. The class is used by Java plug-ins to ModelCenter.
...
| Name | Summary |
|---|---|
| [checkin](checkin.md) | public [checkin](checkin.md)()<br>caused the feature to be checked in |
