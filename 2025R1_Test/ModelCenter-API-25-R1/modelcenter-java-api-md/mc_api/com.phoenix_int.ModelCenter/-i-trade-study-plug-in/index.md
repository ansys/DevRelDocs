//[mc_api](../../../index.md)/[com.phoenix_int.ModelCenter](../index.md)/[ITradeStudyPlugIn](index.md)

# ITradeStudyPlugIn

interface [ITradeStudyPlugIn](index.md)

This is the interface that must be implemented by all Java trade study plug-ins for ModelCenter. Please note that due to an issue in Java 8, we do not explicitly override [toString](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html#toString--) here, but you still need to implement it.

#### Inheritors

| |
|---|
| [ITradeStudyPlugIn2](../-i-trade-study-plug-in2/index.md) |
| [ITradeStudyPlugIn2](../-i-trade-study-plug-in2/index.md) |
