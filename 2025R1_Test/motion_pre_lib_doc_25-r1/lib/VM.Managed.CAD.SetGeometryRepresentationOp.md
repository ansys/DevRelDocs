# <a id="VM_Managed_CAD_SetGeometryRepresentationOp"></a> Class SetGeometryRepresentationOp
...
```csharp
public class SetGeometryRepresentationOp : OperationBase, IOperation
```
...
### <a id="VM_Managed_CAD_SetGeometryRepresentationOp__ctor_VM_Managed_IDrawFacet_System_String_System_String_System_Boolean_"></a> SetGeometryRepresentationOp\(IDrawFacet, string, string, bool\)

```csharp
public SetGeometryRepresentationOp(IDrawFacet facet, string strGeom, string strDefaultGeom, bool bUseRedraw)
```
...
### <a id="VM_Managed_CAD_SetGeometryRepresentationOp__ctor"></a> SetGeometryRepresentationOp\(\)
...
### <a id="VM_Managed_CAD_SetGeometryRepresentationOp_IsHistoryMerge"></a> IsHistoryMerge
...
### <a id="VM_Managed_CAD_SetGeometryRepresentationOp_Name"></a> Name
...
### <a id="VM_Managed_CAD_SetGeometryRepresentationOp_Result"></a> Result
...
### <a id="VM_Managed_CAD_SetGeometryRepresentationOp_Execute"></a> Execute\(\)
