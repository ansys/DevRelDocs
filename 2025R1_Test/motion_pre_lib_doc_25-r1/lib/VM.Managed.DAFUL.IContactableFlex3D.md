# <a id="VM_Managed_DAFUL_IContactableFlex3D"></a> Interface IContactableFlex3D
...
```csharp
public interface IContactableFlex3D : ITieContactable, IContactable3D, INTSFContactable, IContactable, IGeometricalComponent, IEntityRelation, IBodyAnalysisType, IHasBody
```
