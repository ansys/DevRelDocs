# <a id="VM_Managed_DAFUL_GearTrain_ConstantWeb"></a> Class ConstantWeb
...
```csharp
public class ConstantWeb : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public virtual void InitChild(Unit.ConvertFactor factor)
```
