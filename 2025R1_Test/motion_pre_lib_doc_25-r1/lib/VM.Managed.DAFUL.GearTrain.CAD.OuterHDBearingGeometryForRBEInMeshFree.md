# <a id="VM_Managed_DAFUL_GearTrain_CAD_OuterHDBearingGeometryForRBEInMeshFree"></a> Class OuterHDBearingGeometryForRBEInMeshFree
...
```csharp
public OuterHDBearingGeometryForRBEInMeshFree(Builder builder)
```
