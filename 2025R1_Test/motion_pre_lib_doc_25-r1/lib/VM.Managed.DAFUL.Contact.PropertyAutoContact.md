# <a id="VM_Managed_DAFUL_Contact_PropertyAutoContact"></a> Class PropertyAutoContact
...
```csharp
public class PropertyAutoContact : Property, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IContainer, ILinkContainer, IOwned, IHasID
```
