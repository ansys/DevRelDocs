# <a id="VM_Models_Project_Preset_AnalysisConditionStep"></a> Class AnalysisConditionStep

Namespace: [VM.Models.Project.Preset](VM.Models.Project.Preset.md)  
Assembly: VM.Models.Project.Preset.dll  

```csharp
public class AnalysisConditionStep : StepBase, IObservableObject, IStep, IProjectObject, IHasID, IHasName, IDisposableObject, ISelected, IHasParent<IScenario>
```
...
ProjectObjectBase ← 
StepBase ← 
[AnalysisConditionStep](VM.Models.Project.Preset.AnalysisConditionStep.md)
...
### <a id="VM_Models_Project_Preset_AnalysisConditionStep__ctor_VM_Models_IScenario_"></a> AnalysisConditionStep\(IScenario\)

```csharp
public AnalysisConditionStep(IScenario parent)
```
...
### <a id="VM_Models_Project_Preset_AnalysisConditionStep_Name"></a> Name
...
### <a id="VM_Models_Project_Preset_AnalysisConditionStep_TargetApplicationType"></a> TargetApplicationType
...
### <a id="VM_Models_Project_Preset_AnalysisConditionStep_Type"></a> Type
