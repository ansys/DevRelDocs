# <a id="VM_Models_Project_Preset_StrengthAnalysis"></a> Class StrengthAnalysis
...
public class StrengthAnalysis : AnalysisScenarioBase, IObservableObject, IAnalysisScenario, IScenario, IProjectObject, IHasID, IHasName, IDisposableObject, ISelected, IHasParent<IProjectDocument>
```
