# <a id="VM_Models_FE_Mesh_Sets_PatchSet"></a> Class PatchSet
...
```csharp
[Table]
public class PatchSet : Set, IEntity, ISet
```
...
[Set.ItemCount](VM.Models.FE.Mesh.Sets.Set.md\#VM\_Models\_FE\_Mesh\_Sets\_Set\_ItemCount), 
