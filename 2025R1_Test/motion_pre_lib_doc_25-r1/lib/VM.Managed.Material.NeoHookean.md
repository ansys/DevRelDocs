# <a id="VM_Managed_Material_NeoHookean"></a> Class NeoHookean
...
### <a id="VM_Managed_Material_NeoHookean__ctor"></a> NeoHookean\(\)

Initializes a new instance of the <xref href="VM.Managed.Material.NeoHookean" data-throw-if-not-resolved="false"></xref> class.

```csharp
public NeoHookean()
```

### <a id="VM_Managed_Material_NeoHookean__ctor_System_String_"></a> NeoHookean\(string\)
...
### <a id="VM_Managed_Material_NeoHookean_C10"></a> C10
...
### <a id="VM_Managed_Material_NeoHookean_D"></a> D
...
### <a id="VM_Managed_Material_NeoHookean_Initialize_VM_Unit_ConvertFactor_"></a> Initialize\(ConvertFactor\)
...
### <a id="VM_Managed_Material_NeoHookean_ReadTemplateImpl_System_Xml_XmlReader_"></a> ReadTemplateImpl\(XmlReader\)
...
### <a id="VM_Managed_Material_NeoHookean_WriteTemplateImpl_System_Xml_XmlWriter_"></a> WriteTemplateImpl\(XmlWriter\)
