# <a id="VM_Managed_DAFUL_Car_SweptSineSteerConfiguration"></a> Class SweptSineSteerConfiguration
...
```csharp
public class SweptSineSteerConfiguration : FullCarAnalysisConfigurationBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable, IEnableManager, IHasRoadFile, ILinkOwner, ILinkUpdateOwner
```
...
```csharp
public SweptSineSteerConfiguration(AnalysisSweptSineSteer analysis)
```

#### Parameters

`analysis` [AnalysisSweptSineSteer](VM.Managed.DAFUL.Car.AnalysisSweptSineSteer.md)
