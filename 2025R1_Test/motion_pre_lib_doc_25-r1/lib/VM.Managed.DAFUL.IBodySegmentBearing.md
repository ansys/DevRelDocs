# <a id="VM_Managed_DAFUL_IBodySegmentBearing"></a> Interface IBodySegmentBearing
...
```csharp
public interface IBodySegmentBearing : IManualTransmissionComponent, IHasBuilder, IConnectable, IMarkerParent, IEntityRelation, IHasBody
```
