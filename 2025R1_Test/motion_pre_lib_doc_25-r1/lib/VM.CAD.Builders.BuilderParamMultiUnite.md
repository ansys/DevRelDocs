# <a id="VM_CAD_Builders_BuilderParamMultiUnite"></a> Class BuilderParamMultiUnite

Namespace: [VM.CAD.Builders](VM.CAD.Builders.md)  
Assembly: VM.CAD.Builders.dll  

```csharp
public class BuilderParamMultiUnite : BuilderParamMulti
```
...
### <a id="VM_CAD_Builders_BuilderParamMultiUnite__ctor"></a> BuilderParamMultiUnite\(\)

```csharp
public BuilderParamMultiUnite()
```
