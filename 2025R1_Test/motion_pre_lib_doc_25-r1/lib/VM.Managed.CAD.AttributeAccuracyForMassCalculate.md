# <a id="VM_Managed_CAD_AttributeAccuracyForMassCalculate"></a> Class AttributeAccuracyForMassCalculate
...
```csharp
public class AttributeAccuracyForMassCalculate : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public AttributeAccuracyForMassCalculate(double dAccuracy)
```
