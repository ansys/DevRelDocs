# <a id="VM_Managed_Picker_Core_PickerFacesetSphere"></a> Class PickerFacesetSphere
...
```csharp
public class PickerFacesetSphere : PickerFaceset
```
...
[PickerFaceset.GetPickerInfo\(\)](VM.Managed.Picker.Core.PickerFaceset.md\#VM\_Managed\_Picker\_Core\_PickerFaceset\_GetPickerInfo), 
[PickerFaceset.GetResultXmlFromKey\(UIntPtr\)](VM.Managed.Picker.Core.PickerFaceset.md\#VM\_Managed\_Picker\_Core\_PickerFaceset\_GetResultXmlFromKey\_System\_UIntPtr\_), 
[PickerFaceset.Filtering\(UIntPtr\)](VM.Managed.Picker.Core.PickerFaceset.md\#VM\_Managed\_Picker\_Core\_PickerFaceset\_Filtering\_System\_UIntPtr\_), 
[PickerFaceset.FilteringAnother\(UIntPtr\)](VM.Managed.Picker.Core.PickerFaceset.md\#VM\_Managed\_Picker\_Core\_PickerFaceset\_FilteringAnother\_System\_UIntPtr\_), 
[PickerFaceset.FilteringReference\(UIntPtr, UIntPtr\)](VM.Managed.Picker.Core.PickerFaceset.md\#VM\_Managed\_Picker\_Core\_PickerFaceset\_FilteringReference\_System\_UIntPtr\_System\_UIntPtr\_), 
[PickerFaceset.Highlight\(bool\)](VM.Managed.Picker.Core.PickerFaceset.md\#VM\_Managed\_Picker\_Core\_PickerFaceset\_Highlight\_System\_Boolean\_), 
[PickerFaceset.SetResultImpl\(ref string, bool\)](VM.Managed.Picker.Core.PickerFaceset.md\#VM\_Managed\_Picker\_Core\_PickerFaceset\_SetResultImpl\_System\_String\_\_System\_Boolean\_), 
