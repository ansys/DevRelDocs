# <a id="VM_Managed_DAFUL_AttributeGroundGeometryIndexer"></a> Class AttributeGroundGeometryIndexer
...
```csharp
public class AttributeGroundGeometryIndexer : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public AttributeGroundGeometryIndexer()
```
