# <a id="VM_Managed_DAFUL_GearTrain_Operation_UpdateBearingInFE"></a> Class UpdateBearingInFE
...
```csharp
public class UpdateBearingInFE : OperationInHiddenDocument, IOperation
```
...
```csharp
public UpdateBearingInFE(string strBearingGeometryName, string strRBEName, string strZAxis)
```
...
```csharp
public UpdateBearingInFE(Document3D document3D, string strBearingGeometryName, string strRBEName, string strZAxis)
```
...
```csharp
public UpdateBearingInFE(JournalParameter jp)
```
