# <a id="VM_Managed_AttributeSubEntity_1"></a> Class AttributeSubEntity<TSubEntity\>
...
```csharp
public class AttributeSubEntity<TSubEntity> : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable where TSubEntity : SubEntity, new()
```
...
```csharp
public AttributeSubEntity(TSubEntity subentity)
```

#### Parameters

`subentity` TSubEntity
...
#### Field Value
 ...
 Child<TSubEntity, LinkContainer.Update\>
