# <a id="VM_Managed_DAFUL_Flexible_Force"></a> Namespace VM.Managed.DAFUL.Flexible.Force
...
<p>ui에 보이는 함수 갯수를 가리킵니다.</p>
 ...
 [ConcentratedLoadFunction.FunctionType](VM.Managed.DAFUL.Flexible.Force.ConcentratedLoadFunction.FunctionType.md)

<p>Indicates whether this is a standard type or a user sub-routine type.</p>
<p>함수 타입을 나타냅니다.</p>

 [PressureLoadFunction.FunctionType](VM.Managed.DAFUL.Flexible.Force.PressureLoadFunction.FunctionType.md)
