# <a id="VM_Models_Pre_IEntity"></a> Interface IEntity
...
```csharp
public interface IEntity : IEntityBase, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, IHasName, IEnabled, IHasComment, IVisible, IDocumentOwner
```
