# <a id="VM_Managed_CAD_GetFacetInformationForFaceOp"></a> Class GetFacetInformationForFaceOp
...
```csharp
public class GetFacetInformationForFaceOp : OperationBase, IOperation
```
...
### <a id="VM_Managed_CAD_GetFacetInformationForFaceOp__ctor_VM_Managed_CAD_Face_"></a> GetFacetInformationForFaceOp\(Face\)

```csharp
public GetFacetInformationForFaceOp(Face face)
```
