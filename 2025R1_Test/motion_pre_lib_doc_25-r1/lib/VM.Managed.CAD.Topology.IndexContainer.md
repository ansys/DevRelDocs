# <a id="VM_Managed_CAD_Topology_IndexContainer"></a> Class Topology.IndexContainer
...
```csharp
public sealed class Topology.IndexContainer : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
