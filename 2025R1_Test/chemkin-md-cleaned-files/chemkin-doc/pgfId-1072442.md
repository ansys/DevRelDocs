...
from a file information about a _Surface Kinetics_ Linking File, pointers for
the _Surface Kinetics_ Subroutine Library, and returns lengths of work arrays.  
`SUBROUTINE SKSNUM (LINE, NEXP, LOUT, KNAM, KKTOT, PNAM, NNPHAS, KKPHAS, KNUM, NT, NVAL, RVAL, KERR)`| This subroutine is used to read a format-free input
...
species in the _Surface Kinetics_ mechanism.  
