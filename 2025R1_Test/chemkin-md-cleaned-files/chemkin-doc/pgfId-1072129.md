...
`SUBROUTINE SKFLGS (IR, ISKWRK, NRPP, IREV, ISTFL, ICOV, IMOTZ, IEDP, IBHM,
IORD, IYLD)`| Returns several integer flags describing surface reaction IR.  
...
`SUBROUTINE SKIORD (IDIM, KDIM, ISKWRK, RSKWRK, NFORD, IFORD, FORD, NRORD,
IRORD, RORD)`| Returns the number and indices of surface reactions with
