...
Ansys Sound: VR Sound can be directly driven using the Open Sound Control Protocol \(OSC\) over either UDP or TCP/IP.

Note: The use of TCP/IP requires the installation of the Java Runtime Environment \(JRE\).
