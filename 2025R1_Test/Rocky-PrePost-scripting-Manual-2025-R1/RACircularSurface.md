...
#### GetMaxRadius(unit: Optional[str] = None)
...
#### GetMinRadius(unit: Optional[str] = None)
...
#### SetMaxRadius(value: Union[str, float], unit: Optional[str] = None)
...
#### SetMinRadius(value: Union[str, float], unit: Optional[str] = None)
