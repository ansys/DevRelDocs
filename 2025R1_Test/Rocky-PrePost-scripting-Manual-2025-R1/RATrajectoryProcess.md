...
<a id="generated.RATrajectoryProcess"></a>
...
analyzed the process must first be configured by calling [`SetStartingTimeStep()`](#generated.RATrajectoryProcess.SetStartingTimeStep),
[`SetNumberOfTimeSteps()`](#generated.RATrajectoryProcess.SetNumberOfTimeSteps) and [`SetParticleStride()`](#generated.RATrajectoryProcess.SetParticleStride), followed by
[`UpdateParticlesSelection()`](#generated.RATrajectoryProcess.UpdateParticlesSelection).

**Methods:**

| [`AddCurve`](#generated.RATrajectoryProcess.AddCurve)(curve_name, timesteps, values, unit)                                   | Add a curve to the element with a time-steps domain                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [`AddCustomCurve`](#generated.RATrajectoryProcess.AddCustomCurve)(name[, curve_type, ...])                                   | Add a custom curve in the database. :param name:     The name of the curve to be set. :param curve_type:     The type of the custom curve to be added. :param output_unit:     The output unit, in which case the unit database will be queried for a quantity that makes sense. If None, the quantity is considered unknown. :param scope:     The scope to be set. :param sources:     A dict pointing the variable used to the curve association it represents and a     string indicating in which unit the input data should be gotten. :param expression:     The expression to be set. |
| [`AddCustomProperty`](#generated.RATrajectoryProcess.AddCustomProperty)(name[, property_type, ...])                          | Add a custom property to the database                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| [`AddGridFunction`](#generated.RATrajectoryProcess.AddGridFunction)(grid_function_name, ...[, ...])                          | Adds a grid function to the grid.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| [`CreateCurveOutputVariable`](#generated.RATrajectoryProcess.CreateCurveOutputVariable)(curve_name[, ...])                   | Used to create an output variable based on a curve which doesn't change at each new timestep (i.e.: a curve with a single value for each time).                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [`CreateGridFunction`](#generated.RATrajectoryProcess.CreateGridFunction)(values[, location, time_step])                     | Create a grid function from the given values, location and time-step.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| [`CreateGridFunctionArrayOnCells`](#generated.RATrajectoryProcess.CreateGridFunctionArrayOnCells)([time_step])               | Creates a numpy array with the number of elements based on the cells and returns it.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| [`CreateGridFunctionStatisticOutputVariable`](#generated.RATrajectoryProcess.CreateGridFunctionStatisticOutputVariable)(...) | Used to create an output variable based on a grid function statistic (i.e.: will get a grid function, compute its statistic based on statistic_operation and then based on the statistic values will apply the operation to get a single scalar).                                                                                                                                                                                                                                                                                                                                             |
| [`CreateTransientCurveOutputVariable`](#generated.RATrajectoryProcess.CreateTransientCurveOutputVariable)(curve_name)        | Used to create an output variable based on a curve for which there's a completely new representation for each time step -- such as Power : Impact X Belt Width (i.e.: will get the curve multiple times based on the time range, compute a value for each time based on the operation, to convert the multiple curves into a single curve and then will apply the time_operation to get a single scalar from those values).                                                                                                                                                                   |
| [`EditCustomCurve`](#generated.RATrajectoryProcess.EditCustomCurve)(edit_curve[, new_name, ...])                             | Edit a custom curve saved in the database. :param edit_curve:     The name of the curve to be edited. :param new_name:     The new name of the curve to be set. :param sources:     A dict pointing the variable used to the curve association it represents and a     string indicating in which unit the input data should be gotten. :param expression:     The expression to be set.                                                                                                                                                                                                      |
| [`EditCustomProperty`](#generated.RATrajectoryProcess.EditCustomProperty)(edit_property[, ...])                              | Edit a custom property saved in the database. :param edit_property:     The name of the property to be edited. :param new_name:     The new name of the property to be set. :param sources:     A dict pointing the variable used to the property association it represents and a     string indicating in which unit the input data should be gotten. :param expression:     The expression to be set.                                                                                                                                                                                       |
| [`GetActivesArray`](#generated.RATrajectoryProcess.GetActivesArray)([time_step])                                             | Get an array representing the cells' "active" status.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| [`GetBoundingBox`](#generated.RATrajectoryProcess.GetBoundingBox)([unit, time_step])                                         | Get the element's bounding box.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [`GetCellAreaAsArray`](#generated.RATrajectoryProcess.GetCellAreaAsArray)([time_step])                                       | Get an array containing the area of each cell.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| [`GetCellCenterAsArray`](#generated.RATrajectoryProcess.GetCellCenterAsArray)([time_step])                                   | Get an array containing the center coordinates of each cell.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| [`GetCellDzAsArray`](#generated.RATrajectoryProcess.GetCellDzAsArray)([time_step])                                           | Get an array containing the thickness (in Z) of each cell.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| [`GetCellFromIJK`](#generated.RATrajectoryProcess.GetCellFromIJK)(i, j, k[, time_step])                                      | Creates a grid cell handle from the current I, J, K indexes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [`GetCellIJK`](#generated.RATrajectoryProcess.GetCellIJK)(cell_handle[, time_step])                                          | Converts the given cell handle to it's I, J, K indexes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [`GetCellNumberOfVertices`](#generated.RATrajectoryProcess.GetCellNumberOfVertices)(cell[, time_step])                       | Get an array containing the number of vertices of each cell.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| [`GetCellPointsAsFunction`](#generated.RATrajectoryProcess.GetCellPointsAsFunction)([time_step])                             | Get a function for the points (vertices) of each cell.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [`GetCellVolumeAsArray`](#generated.RATrajectoryProcess.GetCellVolumeAsArray)([time_step])                                   | Get an array with the volume of each cell.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| [`GetCurve`](#generated.RATrajectoryProcess.GetCurve)(curve_name[, simulation_name, ...])                                    | Override base class method to check for a request of a grid function statistic.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [`GetCurveNames`](#generated.RATrajectoryProcess.GetCurveNames)([simulation_name])                                           | @param simulation_name: unicode                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [`GetCurveNamesAssociation`](#generated.RATrajectoryProcess.GetCurveNamesAssociation)([simulation_name])                     | Get this element's curve names.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [`GetElementCurve`](#generated.RATrajectoryProcess.GetElementCurve)(element_name, curve_name[, ...])                         | Return the curves for the given element and name.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| [`GetGeometryQuantity`](#generated.RATrajectoryProcess.GetGeometryQuantity)()                                                | Get the quantity corresponding to the grid's geometry.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [`GetGeometryUnit`](#generated.RATrajectoryProcess.GetGeometryUnit)()                                                        | Get the grid's geometry's unit.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [`GetGridFunction`](#generated.RATrajectoryProcess.GetGridFunction)(grid_function_name[, ...])                               | Gets a grid function given its name.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| [`GetGridFunctionNames`](#generated.RATrajectoryProcess.GetGridFunctionNames)([translated, context])                         | Get a list of the available grid functions for this grid.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| [`GetMeshColoring`](#generated.RATrajectoryProcess.GetMeshColoring)(window)                                                  | Get the RAMeshColoring related to the current object and a window.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| [`GetNumberOfCells`](#generated.RATrajectoryProcess.GetNumberOfCells)([time_step])                                           | Get the total number of cells.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| [`GetNumberOfIntervals`](#generated.RATrajectoryProcess.GetNumberOfIntervals)()                                              | Get the total number of intervals in the computed trajectories.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [`GetNumberOfNodes`](#generated.RATrajectoryProcess.GetNumberOfNodes)([time_step])                                           | Get the total number of nodes (vertices).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| [`GetNumberOfParticles`](#generated.RATrajectoryProcess.GetNumberOfParticles)(time_step)                                     | Get the total number of particles in this selection.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| [`GetNumberOfTimeSteps`](#generated.RATrajectoryProcess.GetNumberOfTimeSteps)()                                              | Deprecated: Use GetNumberOfIntervals instead.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| [`GetNumpyCurve`](#generated.RATrajectoryProcess.GetNumpyCurve)(curve_name[, unit, realization])                             | Returns a curve as a tuple of numpy arrays (time, property) for the given element and name.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [`GetOutputVariableValue`](#generated.RATrajectoryProcess.GetOutputVariableValue)(variable_name)                             | Get the value of a previously-created output variable.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [`GetParticleStride`](#generated.RATrajectoryProcess.GetParticleStride)()                                                    | Get the particle stride for computed trajectories.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| [`GetStartingTime`](#generated.RATrajectoryProcess.GetStartingTime)()                                                        | Get the time step currently configured as the initial one for the particle trajectories.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [`GetStartingTimeStep`](#generated.RATrajectoryProcess.GetStartingTimeStep)()                                                | Deprecated: Use GetStartingTime instead.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [`GetTimeSet`](#generated.RATrajectoryProcess.GetTimeSet)()                                                                  | Get the list of time-steps associated to the grid.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| [`GetTimeStatistics`](#generated.RATrajectoryProcess.GetTimeStatistics)()                                                    | Get the object responsible for handling time-statistics grid functions for this process.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [`GetTimeStep`](#generated.RATrajectoryProcess.GetTimeStep)(time_step[, accept_global])                                      | Get the timestep corresponding to the given time.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| [`GetTopologyShape`](#generated.RATrajectoryProcess.GetTopologyShape)([time_step])                                           | Get the shape of the topology (similar to the shape of numpy arrays).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| [`HasGridFunction`](#generated.RATrajectoryProcess.HasGridFunction)(grid_function_name)                                      | Whether the grid has the given grid function.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| [`IsCellActive`](#generated.RATrajectoryProcess.IsCellActive)(i, j, k[, time_step])                                          | Checks if the given cell is active or not                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| [`IterCellVertices`](#generated.RATrajectoryProcess.IterCellVertices)(cell[, time_step])                                     | Iterate on the vertices of active grid cells at the given time.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [`IterCells`](#generated.RATrajectoryProcess.IterCells)([time_step])                                                         | Iterate on the active grid cells at the given time.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| [`IterParticles`](#generated.RATrajectoryProcess.IterParticles)(time_step)                                                   | Iterate on particles in this selection at the given time.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| [`Modified`](#generated.RATrajectoryProcess.Modified)(\*args, \*\*kwargs)                                                    | Resets all the cache information after a change in the subject being tracked.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| [`RemoveCustomCurve`](#generated.RATrajectoryProcess.RemoveCustomCurve)(name)                                                | Remove the curve from the database :param name:     The name of the curve to be removed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [`RemoveCustomProperty`](#generated.RATrajectoryProcess.RemoveCustomProperty)(name)                                          | Remove the property from the database :param name:     The name of the property to be removed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| [`RemoveOutputVariable`](#generated.RATrajectoryProcess.RemoveOutputVariable)(variable_name)                                 | Removes some output variable.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| [`RemoveProcess`](#generated.RATrajectoryProcess.RemoveProcess)()                                                            | Removes the process from the project.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| [`SetCurrentTimeStep`](#generated.RATrajectoryProcess.SetCurrentTimeStep)(time_step)                                         | Sets the current time step.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [`SetNumberOfIntervals`](#generated.RATrajectoryProcess.SetNumberOfIntervals)(number_of_intervals)                           | Set the total number of intervals in the computed trajectories.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [`SetNumberOfTimeSteps`](#generated.RATrajectoryProcess.SetNumberOfTimeSteps)(number_of_intervals)                           | Deprecated: Use SetNumberOfIntervals instead.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| [`SetParticleStride`](#generated.RATrajectoryProcess.SetParticleStride)(particle_stride)                                     | Set the particle stride for computed trajectories.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| [`SetStartingTime`](#generated.RATrajectoryProcess.SetStartingTime)(time)                                                    | Set the initial time step for the computed trajectories.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [`SetStartingTimeStep`](#generated.RATrajectoryProcess.SetStartingTimeStep)(time_step)                                       | Deprecated: Use SetStartingTime instead.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [`UpdateParticlesSelection`](#generated.RATrajectoryProcess.UpdateParticlesSelection)()                                      | Recompute the trajectories from the current values of starting timestep, number of timesteps and particle stride.                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |

<a id="generated.RATrajectoryProcess.AddCurve"></a>
...
<a id="generated.RATrajectoryProcess.AddCustomCurve"></a>
...
<a id="generated.RATrajectoryProcess.AddCustomProperty"></a>
...
<a id="generated.RATrajectoryProcess.AddGridFunction"></a>
...
<a id="generated.RATrajectoryProcess.CreateCurveOutputVariable"></a>
...
<a id="generated.RATrajectoryProcess.CreateGridFunction"></a>
...
<a id="generated.RATrajectoryProcess.CreateGridFunctionArrayOnCells"></a>
...
<a id="generated.RATrajectoryProcess.CreateGridFunctionStatisticOutputVariable"></a>
...
<a id="generated.RATrajectoryProcess.CreateTransientCurveOutputVariable"></a>
...
<a id="generated.RATrajectoryProcess.EditCustomCurve"></a>
...
<a id="generated.RATrajectoryProcess.EditCustomProperty"></a>
...
<a id="generated.RATrajectoryProcess.GetActivesArray"></a>
...
<a id="generated.RATrajectoryProcess.GetBoundingBox"></a>
...
<a id="generated.RATrajectoryProcess.GetCellAreaAsArray"></a>
...
<a id="generated.RATrajectoryProcess.GetCellCenterAsArray"></a>
...
<a id="generated.RATrajectoryProcess.GetCellDzAsArray"></a>
...
<a id="generated.RATrajectoryProcess.GetCellFromIJK"></a>
...
<a id="generated.RATrajectoryProcess.GetCellIJK"></a>
...
<a id="generated.RATrajectoryProcess.GetCellNumberOfVertices"></a>
...
<a id="generated.RATrajectoryProcess.GetCellPointsAsFunction"></a>
...
<a id="generated.RATrajectoryProcess.GetCellVolumeAsArray"></a>
...
<a id="generated.RATrajectoryProcess.GetCurve"></a>
...
<a id="generated.RATrajectoryProcess.GetCurveNames"></a>
...
<a id="generated.RATrajectoryProcess.GetCurveNamesAssociation"></a>
...
<a id="generated.RATrajectoryProcess.GetElementCurve"></a>
...
<a id="generated.RATrajectoryProcess.GetGeometryQuantity"></a>
...
<a id="generated.RATrajectoryProcess.GetGeometryUnit"></a>
...
<a id="generated.RATrajectoryProcess.GetGridFunction"></a>
...
<a id="generated.RATrajectoryProcess.GetGridFunctionNames"></a>
...
<a id="generated.RATrajectoryProcess.GetMeshColoring"></a>
...
<a id="generated.RATrajectoryProcess.GetNumberOfCells"></a>
...
<a id="generated.RATrajectoryProcess.GetNumberOfIntervals"></a>

#### GetNumberOfIntervals()

Get the total number of intervals in the computed trajectories.

<a id="generated.RATrajectoryProcess.GetNumberOfNodes"></a>
...
<a id="generated.RATrajectoryProcess.GetNumberOfParticles"></a>
...
<a id="generated.RATrajectoryProcess.GetNumberOfTimeSteps"></a>

#### GetNumberOfTimeSteps()

Deprecated: Use GetNumberOfIntervals instead.

<a id="generated.RATrajectoryProcess.GetNumpyCurve"></a>
...
<a id="generated.RATrajectoryProcess.GetOutputVariableValue"></a>
...
<a id="generated.RATrajectoryProcess.GetParticleStride"></a>
...
<a id="generated.RATrajectoryProcess.GetStartingTime"></a>

#### GetStartingTime()

Get the time step currently configured as the initial one for the particle trajectories.

<a id="generated.RATrajectoryProcess.GetStartingTimeStep"></a>

#### GetStartingTimeStep()

Deprecated: Use GetStartingTime instead.

<a id="generated.RATrajectoryProcess.GetTimeSet"></a>
...
<a id="generated.RATrajectoryProcess.GetTimeStatistics"></a>
...
<a id="generated.RATrajectoryProcess.GetTimeStep"></a>
...
<a id="generated.RATrajectoryProcess.GetTopologyShape"></a>
...
<a id="generated.RATrajectoryProcess.HasGridFunction"></a>
...
<a id="generated.RATrajectoryProcess.IsCellActive"></a>
...
<a id="generated.RATrajectoryProcess.IterCellVertices"></a>
...
<a id="generated.RATrajectoryProcess.IterCells"></a>
...
<a id="generated.RATrajectoryProcess.IterParticles"></a>
...
<a id="generated.RATrajectoryProcess.Modified"></a>

#### Modified(\*args, \*\*kwargs)

Resets all the cache information after a change in the subject being tracked.

<a id="generated.RATrajectoryProcess.RemoveCustomCurve"></a>
...
<a id="generated.RATrajectoryProcess.RemoveCustomProperty"></a>
...
<a id="generated.RATrajectoryProcess.RemoveOutputVariable"></a>
...
<a id="generated.RATrajectoryProcess.RemoveProcess"></a>

#### RemoveProcess()

Removes the process from the project.

<a id="generated.RATrajectoryProcess.SetCurrentTimeStep"></a>
...
<a id="generated.RATrajectoryProcess.SetNumberOfIntervals"></a>

#### SetNumberOfIntervals(number_of_intervals: int)

Set the total number of intervals in the computed trajectories.

<a id="generated.RATrajectoryProcess.SetNumberOfTimeSteps"></a>

#### SetNumberOfTimeSteps(number_of_intervals)

Deprecated: Use SetNumberOfIntervals instead.

<a id="generated.RATrajectoryProcess.SetParticleStride"></a>

#### SetParticleStride(particle_stride)
...
<a id="generated.RATrajectoryProcess.SetStartingTime"></a>

#### SetStartingTime(time: str | coilib50.time.time_step_interface.ITimeStep | int)

Set the initial time step for the computed trajectories.

* **Parameters:**
  **time** – The time step to use as the initial one to compute the trajectories. Can be either a TimeStep,
  an integer representing the timestep’s index in the timeset or the string ‘current’ for the
  current application time step.

<a id="generated.RATrajectoryProcess.SetStartingTimeStep"></a>

#### SetStartingTimeStep(time_step)

Deprecated: Use SetStartingTime instead.

<a id="generated.RATrajectoryProcess.UpdateParticlesSelection"></a>

#### UpdateParticlesSelection()
