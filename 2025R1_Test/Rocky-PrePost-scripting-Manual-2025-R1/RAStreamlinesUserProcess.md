<a id="rastreamlinesuserprocess"></a>
...
#### GetMaximumLength(unit: Optional[str] = None)
...
#### GetSpacing(unit: Optional[str] = None)
...
#### SetMaximumLength(value: Union[str, float], unit: Optional[str] = None)
...
#### SetSources(surfaces: Union[str, RASurface, RASurfaceUserProcess, RARectangularSurface, RACircularSurface, list])

Set the surfaces as sources to generate Streamlines.

<a id="generated.RAStreamlinesUserProcess.SetSpacing"></a>

#### SetSpacing(value: Union[str, float], unit: Optional[str] = None)
