<a id="structfortran_1_1syscsetupfileinfof"></a>
# Type fortran::syscsetupfileinfof undefined

![][Fortran]
![][public]

**Definition**: `syscCommonTypesF.fi` (line 316)
...
**Definition**: `syscCommonTypesF.fi` (line 317)
...
**Definition**: `syscCommonTypesF.fi` (line 318)
