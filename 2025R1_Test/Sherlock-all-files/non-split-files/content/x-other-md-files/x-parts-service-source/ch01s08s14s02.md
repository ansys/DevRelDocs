...
**Table  1.199. UpdatePartsLocationsRequest.PartLocation**

| **Field**     | **Type**                                       | **Label** | **Description**                                                                            |
| ------------- | ---------------------------------------------- | --------- | ------------------------------------------------------------------------------------------ |
| refDes        | [string](ch01s11.md "gRPC Scalar Value Types") |           | Reference Designator of the part.                                                          |
...
| [Prev](ch01s08s14.md) | [Up](ch01s08s14.md) / [Contents](index.md) / [Home](../../index.htm) | [Next](ch01s08s14s03.md) |
| --------------------- | -------------------------------------------------------------------- | ------------------------ |
