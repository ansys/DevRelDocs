...
For C++, Java, Python, and Go, refer to the table immediately below, [Table 1.277, "gRPC Scalar Value Types (A)"](ch01s11.md#sherlock_ug_table_gRPC_scalar_C_plus_java "Table 1.277. gRPC Scalar Value Types (A)").

For C#, PHP, and Ruby, refer to the table which follows, [Table 1.278, "gRPC Scalar Value Types (B)"](ch01s11.md#sherlock_ug_table_gRPC_scalar_Types_B "Table 1.278. gRPC Scalar Value Types (B)").

**Table  1.277. gRPC Scalar Value Types (A)**
...
**Table  1.278. gRPC Scalar Value Types (B)**
...
| [Prev](stakup-service/ch01s10s15s03.md) | / [Contents](index.md) / [Home](../../index.htm) |     |
| ------------------------ | ------------------------------------------------ | --- |
