...
**Table  1.225. ImportIPC2581Request**
...
| polylineTolerance      | [double](ch01s11.md "gRPC Scalar Value Types") |           | Polyline simplification tolerance.                                               |
| polylineTolerance      | [string](ch01s11.md "gRPC Scalar Value Types") |           | Polyline simplification tolerance units.                                         |



* * *

| [Prev](project-service/ch01s09s08s03.md) | [Up](ch01s09.md) / [Contents](index.md) / [Home](../../index.htm) | [Next](project-service/ch01s09s09s02.md) |
| ------------------------ | ----------------------------------------------------------------- | ------------------------ |
