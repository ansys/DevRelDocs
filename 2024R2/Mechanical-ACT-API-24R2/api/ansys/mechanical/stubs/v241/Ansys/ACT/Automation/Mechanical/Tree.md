...
| Name | Description |
|-----------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|
| [`Refresh`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#Tree.Refresh)                                       | Refreshes the tree.                                                              |
| [`Suspend`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#Tree.Suspend)                                       | Prevents the tree from being updated.                                            |
| [`GetPathToFirstActiveObject`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#Tree.GetPathToFirstActiveObject) | Gets the full path that needs to be typed in order to go to the selected object. |
| [`Find`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#Tree.Find)                                             | Find method.                                                                     |
| [`Sort`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#Tree.Sort)                                             | Sorts the tree objects based on given parameters.                                |
| [`ClearSort`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#Tree.ClearSort)                                   | Clears the current sort.                                                         |
| [`Filter`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#Tree.Filter)                                         | Filters the tree objects based on given parameters.                              |
| [`ClearFilter`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#Tree.ClearFilter)                               | Clears the current filter.                                                       |
| [`Group`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#id0)                                                  | Groups a list of objects together.                                               |
| [`Group`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#id0)                                                  | Moves dataModelObject to new tree grouping folder.                               |
| [`Activate`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#id1)                                               | selects an object in the tree.                                                   |
| [`Activate`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#id1)                                               | Activate method.                                                                 |
| [`IsSorted`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#Tree.IsSorted)                                     | Checks if the tree is currently sorted alphabetically.                           |

### Properties

| Name | Description |
|---------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|
| [`FirstActiveObject`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#Tree.FirstActiveObject)           | Gets the first object selected in the tree.                           |
| [`ActiveObjects`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#Tree.ActiveObjects)                   | Gets a list of all selected objects.                                  |
| [`AllObjects`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#Tree.AllObjects)                         | Gets a list of all objects available in the tree.                     |
| [`GroupingFoldersVisible`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#Tree.GroupingFoldersVisible) | Controls whether or not group folders are visible.                    |
| [`CurrentFilter`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#Tree.CurrentFilter)                   | Gets the current filter applied on the tree.                          |
| [`CurrentSearchString`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#Tree.CurrentSearchString)       | Gets the current search string (name/tag/propertyName/propertyValue). |
| [`CurrentSearchState`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#Tree.CurrentSearchState)         | Gets the current search state.                                        |
| [`CurrentSearchGraphics`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Tree.md#Tree.CurrentSearchGraphics)   | Gets the current visibility.                                          |
