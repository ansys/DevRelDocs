...
Note:  
For information, a python client exists and can be used.  
This is a way for user to use a client without having to auto generate code from the proto files.  
Documentation about this python client named PySpeos (package ansys-speos-core) can be find [here](https://speos.docs.pyansys.com/).
