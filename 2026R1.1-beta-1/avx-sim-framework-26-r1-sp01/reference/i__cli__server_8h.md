...
#ifndef SIMFWK_CORE_SERVICE_GRPC_CLI_ICLISERVER_H
#define SIMFWK_CORE_SERVICE_GRPC_CLI_ICLISERVER_H
...
class SIMFWK_CORE_API ISimfwkCliServer
{
  public:
...
#endif  // SIMFWK_CORE_SERVICE_GRPC_CLI_ICLISERVER_H
```
