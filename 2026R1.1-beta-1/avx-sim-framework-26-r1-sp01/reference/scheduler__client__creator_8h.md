...
#ifndef SIMFWK_CORE_SCHEDULER_SCHEDULERCLIENT_SCHEDULERCLIENTCREATOR_H
#define SIMFWK_CORE_SCHEDULER_SCHEDULERCLIENT_SCHEDULERCLIENTCREATOR_H
...
SIMFWK_CORE_API std::unique_ptr<ISchedulerClient> Create(const SchedulerClientType type);
...
#endif  // SIMFWK_CORE_SCHEDULER_SCHEDULERCLIENT_SCHEDULERCLIENTCREATOR_H
```
