...
| Name | Description |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|
| [`TetMeshSplineParams.decimation_factor`](ansys.meshing.prime.TetMeshSplineParams.decimation_factor.md#ansys.meshing.prime.TetMeshSplineParams.decimation_factor)   | Decimation factor used in meshing of the trimmed solid spline.       |
