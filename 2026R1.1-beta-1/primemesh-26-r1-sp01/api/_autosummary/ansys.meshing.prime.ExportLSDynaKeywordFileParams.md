...
### *class* ansys.meshing.prime.ExportLSDynaKeywordFileParams(model=None, material_properties=None, database_keywords=None, output_format=None, analysis_type=None, compute_spotweld_thickness=None, write_thickness_file=None, output_controls_d3_part=None, get_zone_mesh_results=None, json_data=None, \*\*kwargs)
...
| [`ExportLSDynaKeywordFileParams.get_zone_mesh_results`](ansys.meshing.prime.ExportLSDynaKeywordFileParams.get_zone_mesh_results.md#ansys.meshing.prime.ExportLSDynaKeywordFileParams.get_zone_mesh_results)                | Option to collect and return zone-wise mesh information for elements in the exported model. |
