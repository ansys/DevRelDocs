...
### *class* ansys.meshing.prime.FuseParams(model=None, use_absolute_tolerance=None, gap_tolerance=None, side_tolerance=None, check_interior=None, fuse_option=None, check_orientation=None, dump_mesh=None, local_remesh=None, n_layers=None, separate=None, angle=None, type=None, json_data=None, \*\*kwargs)
...
| [`FuseParams.type`](ansys.meshing.prime.FuseParams.type.md#ansys.meshing.prime.FuseParams.type)                                                       | Option to select type of fuse operation.                                                    |
