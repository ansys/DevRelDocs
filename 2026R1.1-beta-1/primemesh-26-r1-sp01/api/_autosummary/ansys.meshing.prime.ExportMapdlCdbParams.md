...
| [`ExportMapdlCdbParams.export_coupling_as_sfcgen`](ansys.meshing.prime.ExportMapdlCdbParams.export_coupling_as_sfcgen.md#ansys.meshing.prime.ExportMapdlCdbParams.export_coupling_as_sfcgen)                                              | Option to export coupling as sfcgen.                                                        |
...
| [`ExportMapdlCdbParams.export_tie_as_cntgen`](ansys.meshing.prime.ExportMapdlCdbParams.export_tie_as_cntgen.md#ansys.meshing.prime.ExportMapdlCdbParams.export_tie_as_cntgen)                                                             | Option to export ties as cntgen.                                                            |
| [`ExportMapdlCdbParams.get_zone_mesh_results`](ansys.meshing.prime.ExportMapdlCdbParams.get_zone_mesh_results.md#ansys.meshing.prime.ExportMapdlCdbParams.get_zone_mesh_results)                                                          | Option to collect and return zone-wise mesh information for elements in the exported model. |
| [`ExportMapdlCdbParams.initial_counters`](ansys.meshing.prime.ExportMapdlCdbParams.initial_counters.md#ansys.meshing.prime.ExportMapdlCdbParams.initial_counters)                                                                         | Parameter to specify the starting counter values for export                                 |
...
| [`ExportMapdlCdbParams.reorder_spotweldsurface`](ansys.meshing.prime.ExportMapdlCdbParams.reorder_spotweldsurface.md#ansys.meshing.prime.ExportMapdlCdbParams.reorder_spotweldsurface)                                                    | Option to choose the logic of spotweld computation.                                         |
...
| [`ExportMapdlCdbParams.skip_comments`](ansys.meshing.prime.ExportMapdlCdbParams.skip_comments.md#ansys.meshing.prime.ExportMapdlCdbParams.skip_comments)                                                                                  | Option to skip export of comments to the exported file.                                     |
