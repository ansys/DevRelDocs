...
[PyDYNA documentation (PyAnsys)](https://dyna.docs.pyansys.synopsys.com/version/stable/index.html)
...
* **PyMAPDL:** An open-source Python wrapper for APDL that can call APDL commands from within Python scripts when installed alongside a compatible installation of MAPDL. For more information, see [PyMAPDL documentation (PyAnsys)](https://mapdl.docs.pyansys.synopsys.com/).
* **PyMechanical:** An open-source Python interface with the Mechanical UI. This interface has access to the .NET objects available in ACT. For more information, see [PyMechanical documentation (PyAnsys)](https://mechanical.docs.pyansys.synopsys.com/).
...
* [WAPDL: The Language of Simulation](https://www.ansys.synopsys.com/blog/what-is-apdl)
* [Getting Started With Ansys PyMAPDL (AIS)](https://innovationspace.ansys.synopsys.com/product/getting-started-with-ansys-pymapdl/)
* [Introduction to Ansys APDL Scripting (AIS)](https://innovationspace.ansys.synopsys.com/product/intro-to-ansys-apdl-scripting/)
* [ML/AI Datasets using PyMAPDL (AIS)](https://innovationspace.ansys.synopsys.com/product/ml-ai-datasets-using-pymapdl/)
* [Creating Modeling and Simulation Applications using PyAnsys (AIS)](https://innovationspace.ansys.synopsys.com/product/developing-webapps-with-pymapdl/)
* [PyMAPDL Tutorial](https://tutorials.mapdl.docs.pyansys.synopsys.com/tutorials/01-pymapdl.html)
...
* [Introduction to Ansys ACT in Mechanical (ALH)](https://www.ansys.synopsys.com/training-center/course-catalog/structures/introduction-to-ansys-act-mechanical)
* [Ansys Mechanical Scripting (ALH)](https://learninghub.ansys.synopsys.com/learn/courses/902/ansys-mechanical-scripting)
* [Introduction to Ansys ACT Wizards (ALH)](https://www.ansys.synopsys.com/training-center/course-catalog/structures/introduction-to-ansys-act-wizards)
