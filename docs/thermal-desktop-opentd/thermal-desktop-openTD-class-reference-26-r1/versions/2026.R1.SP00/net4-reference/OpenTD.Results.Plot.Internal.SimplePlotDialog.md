...
`plotInfo` [SimplePlot](OpenTD.Results.Plot.SimplePlot.md)
...
`format` [ChartImageFormat](https://learn.microsoft.com/dotnet/api/system.windows.forms.datavisualization.charting.chartimageformat)
