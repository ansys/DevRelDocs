...
* [fmop_solver.h](fmop__solver_8h.md#fmop__solver_8h): C-API to evaluate a Field Meta model of Optimal Prognosis (FMOP)
...
* [sos_capi_script.h](sos__capi__script_8h.md#sos__capi__script_8h): C-API to run SoS scripts and exchange basic data.