...
| ScriptInterfaceVersion     | Specifies the version of the script interface and provides backwards compatibilty. Ensure this variable is set to the version of the current optiSLang release(i.e 2610). Defaults to a legacy version of the API. |
