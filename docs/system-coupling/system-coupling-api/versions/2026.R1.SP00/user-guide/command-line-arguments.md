---
title: "Command line arguments for participant solvers"
---
...
- `--screstart RESTART_STRING` : This command line argument is only used during
  ...
  [Creating restart points and restarting the coupled analysis](/docs/system-coupling/system-coupling-api/versions/2026.R1.SP00/user-guide/restarts)
  for more details.
...
See [Execution in a parallel environment](/docs/system-coupling/system-coupling-api/versions/2026.R1.SP00/user-guide/parallel-execution)
for more details.
