...
See [Steps to perform mapping](/docs/system-coupling/system-coupling-api/versions/2025.R2.SP00/user-guide/participant-steps-for-mapping) for more information.
...
See [Steps to perform parallel data transfers](/docs/system-coupling/system-coupling-api/versions/2025.R2.SP00/user-guide/participant-steps-for-data-transfers) for more information.
