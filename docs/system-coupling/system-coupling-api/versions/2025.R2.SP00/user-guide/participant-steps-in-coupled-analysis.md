...
[Access to heavyweight data](/docs/system-coupling/system-coupling-api/versions/2025.R2.SP00/user-guide/heavyweight-data-access) and
...
the analysis. If no initial value is set, the parameter will be initialized to zero. See [Parameter Data Access](/docs/system-coupling/system-coupling-api/versions/2025.R2.SP00/user-guide/parameter-data-access) for more details.
