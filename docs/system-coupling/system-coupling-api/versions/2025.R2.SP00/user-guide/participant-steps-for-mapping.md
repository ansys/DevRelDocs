...
See [Execution in a Parallel Environment](/docs/system-coupling/system-coupling-api/versions/2025.R2.SP00/user-guide/parallel-execution) for more details.

#### Mapping across multiple applications

See [Steps to perform data transfers](/docs/system-coupling/system-coupling-api/versions/2025.R2.SP00/user-guide/participant-steps-for-data-transfers) for details on
...
See [Access to heavyweight data](/docs/system-coupling/system-coupling-api/versions/2025.R2.SP00/user-guide/heavyweight-data-access) for more details.
...
- [Surface mapping example](/docs/system-coupling/system-coupling-api/versions/2025.R2.SP00/user-guide/participant-steps-for-mapping)
- [Volume mapping example](/docs/system-coupling/system-coupling-api/versions/2025.R2.SP00/user-guide/participant-steps-for-mapping)
