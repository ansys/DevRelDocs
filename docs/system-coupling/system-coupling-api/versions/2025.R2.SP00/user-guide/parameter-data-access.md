...
Since each parameter stores only a single value, the participant library does not provide access via shared memory (as is done with [Heavyweight Data](/docs/system-coupling/system-coupling-api/versions/2025.R2.SP00/user-guide/heavyweight-data-access)). Instead, the participant library provides access via direct get and set calls for the parameter data.

For more information, see:

- [Relevant concepts](/docs/system-coupling/system-coupling-api/versions/2025.R2.SP00/user-guide/parameter-data-access)
- [Input parameter data](/docs/system-coupling/system-coupling-api/versions/2025.R2.SP00/user-guide/parameter-data-access)
- [Output parameter data](/docs/system-coupling/system-coupling-api/versions/2025.R2.SP00/user-guide/parameter-data-access)
