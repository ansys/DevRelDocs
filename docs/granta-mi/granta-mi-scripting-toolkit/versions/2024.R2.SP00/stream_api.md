...
### *class* Database(\_gdl_obj, \_mi, \_service_providers)
...
#### \_\_init_\_(\_gdl_obj, \_mi, \_service_providers)
...
* **Parameters:**
  * **name** – str
  * **subsets** – Set[str] (default value of `None`)
...
Performs a search using criteria within tables across the database. Returns a list of matching [`Record`](#GRANTA_MIScriptingToolkit.granta.mi_record_classes.Record)
objects. If `silent` is True then errors caused by non-existent attributes will be ignored and no results
...
### *class* Table(\_gdl_obj, \_mi, \_service_providers, unit_system='Database', absolute_temperatures=False)
...
#### \_\_init_\_(\_gdl_obj, \_mi, \_service_providers, unit_system='Database', absolute_temperatures=False)
...
* **Parameters:**
  ...
  * **\_mi** – [`Session`](#GRANTA_MIScriptingToolkit.granta.mi.Session) object
  * **\_service_providers** – `BackendServiceCollection` object
  * **unit_system** – str (Unit system to use in this table, e.g. ‘UK Imperial’. Default
    value of [`DATABASE_UNIT_SYSTEM`](#GRANTA_MIScriptingToolkit.granta.mi_constants.DATABASE_UNIT_SYSTEM).)
...
Performs a search using criteria within the table. Returns a list of matching [`Record`](#GRANTA_MIScriptingToolkit.granta.mi_record_classes.Record) objects.
