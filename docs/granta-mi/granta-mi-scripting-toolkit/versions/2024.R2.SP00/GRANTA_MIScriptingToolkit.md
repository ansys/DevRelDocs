...
Property recordManipulatorService is of type [`RecordManipulatorService`](#module-GRANTA_MIScriptingToolkit.RecordManipulatorService)
...
Includes an array of [`CurrencyDetail`](#module-GRANTA_MIScriptingToolkit.CurrencyDetail) objects and
a [`ServiceLayerResponse`](#module-GRANTA_MIScriptingToolkit.ServiceLayerResponse) object.

* **Parameters:**
  **c_obj** – ctypes.Pointer to a GetCurrenciesResponse object.
...
* **Parameters:**
  * **DBKey** – type str
  * **newParentRecordHistoryGuid** – type str
  * **recordHistoryGuid** – type str
