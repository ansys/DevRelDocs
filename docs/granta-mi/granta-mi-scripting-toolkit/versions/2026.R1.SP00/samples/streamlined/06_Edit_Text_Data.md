...
```output
(<Record long name: Scripting Toolkit Example 6:Wed Jan  7 19:24:46 2026>,
...
*Previous cell output:*
```output
{'v1': <Record long name: Scripting Toolkit Example 6:Wed Jan  7 19:24:46 2026>}
```
...
```output
{'v1': <Record long name: Scripting Toolkit Example 6:Wed Jan  7 19:24:46 2026>,
 'v2': <Record long name: Scripting Toolkit Example 6:Wed Jan  7 19:24:46 2026>}
```
