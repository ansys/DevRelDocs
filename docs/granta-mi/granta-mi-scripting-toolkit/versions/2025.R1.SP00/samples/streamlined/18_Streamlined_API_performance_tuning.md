...
```output
0.3607 s - Time elapsed to reach the first milestone
0.0001 s - Time elapsed between milestone 1 and the end
0.0004 s - Time elapsed getting the MaterialUniverse table
```
## Locating records

There are many search methods in the Streamlined API that will return records that match a user-defined attribute-based criterion or text-based criterion.
...
*Previous cell output:*
```output
0.1820 s - Time elapsed to reach the first milestone
0.0001 s - Time elapsed between milestone 1 and the end
```
...
*Previous cell output:*
```output
['Top-level folder 2024-10-30 16:10:04.245965', 'our', 'new', 'path']
```
...
*Previous cell output:*
```output
['Top-level folder 2024-10-30 16:10:04.245965', 'our', 'new', 'route']
```
...
*Previous cell output:*
```output
8.5419 s - Time elapsed to reach the first milestone
1.9429 s - Time elapsed between milestone 1 and 2
0.4992 s - Time elapsed between milestone 2 and 3
0.1357 s - Time elapsed between milestone 2 and the end
```
...
*Previous cell output:*
```output
1.3176 s - Time elapsed to reach the first milestone
0.4944 s - Time elapsed between milestone 1 and 2
0.9680 s - Time elapsed between milestone 2 and 3
0.3884 s - Time elapsed between milestone 2 and the end
```
...
*Previous cell output:*
```output
0.4290 s - Time elapsed to reach the first milestone
0.1977 s - Time elapsed between milestone 1 and the end
```
...
```*Previous cell output:*
```output
0.1595 s - Time to fetch release states
0.4368 s - Time to manually delete the records
...
```*Previous cell output:*
```output
0.0495 s - Time to bulk fetch release states
0.4456 s - Time to bulk delete the records
```
## Conclusion
