...
This service release includes the following bug fixes and enhancements:

- Fixed an issue that prevented materials from being exported if the session token had expired
- The code example SimpleExample.py has been updated to prevent timeout errors
- Documentation about supported unit systems has been added to the user guide
- Enhanced guidance on integrating Granta Material Picker into your application, including:
  - Updated text for buttons, menus, and tooltips
  - Additional icons in 48 x 48 pixel size, and with transparent backgrounds
...
This release provides:
 ...
 - Ansys Granta MI Enterprise 2026 R1 in an instance that is hosted by Synopsys, that can be integrated with other applications.
