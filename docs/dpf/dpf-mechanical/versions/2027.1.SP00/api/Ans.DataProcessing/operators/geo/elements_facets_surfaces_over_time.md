...
**DPF Framework Reference:** [elements_facets_surfaces_over_time operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/geo/elements_facets_surfaces_over_time.md)
