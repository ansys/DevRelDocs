...
**DPF Framework Reference:** [timescoping_signed_high_pass operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/filter/timescoping_signed_high_pass.md)
