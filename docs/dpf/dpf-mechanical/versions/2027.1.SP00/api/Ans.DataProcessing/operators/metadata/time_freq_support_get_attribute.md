...
**DPF Framework Reference:** [time_freq_support_get_attribute operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/metadata/time_freq_support_get_attribute.md)
