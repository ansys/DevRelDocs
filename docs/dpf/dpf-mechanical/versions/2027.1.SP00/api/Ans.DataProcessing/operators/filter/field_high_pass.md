...
**DPF Framework Reference:** [field_high_pass operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/filter/field_high_pass.md)
