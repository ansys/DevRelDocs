...
**DPF Framework Reference:** [layer_orientation_provider operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/result/layer_orientation_provider.md)
