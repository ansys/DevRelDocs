...
**DPF Framework Reference:** [scoping_high_pass operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/filter/scoping_high_pass.md)
