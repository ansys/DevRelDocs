...
**DPF Framework Reference:** [compute_stress_von_mises operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/result/compute_stress_von_mises.md)
