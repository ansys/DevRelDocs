...
**DPF Framework Reference:** [integrate_over_time_freq operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/metadata/integrate_over_time_freq.md)
