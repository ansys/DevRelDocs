...
**DPF Framework Reference:** [identical_string_fields operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/logic/identical_string_fields.md)
