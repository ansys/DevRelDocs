...
**DPF Framework Reference:** [timefreq_low_pass operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/filter/timefreq_low_pass.md)
