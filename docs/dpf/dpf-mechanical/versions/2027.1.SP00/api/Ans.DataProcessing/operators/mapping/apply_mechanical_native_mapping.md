...
**DPF Framework Reference:** [apply_mechanical_native_mapping operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/mapping/apply_mechanical_native_mapping.md)
