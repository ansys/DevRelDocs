...
**DPF Framework Reference:** [num_surface_status_changes operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/result/num_surface_status_changes.md)
