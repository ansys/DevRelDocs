...
**DPF Framework Reference:** [assemble_scalars_to_matrices_fc operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/utility/assemble_scalars_to_matrices_fc.md)
