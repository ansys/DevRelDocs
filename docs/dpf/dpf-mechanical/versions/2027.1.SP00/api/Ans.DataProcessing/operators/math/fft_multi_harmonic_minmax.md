...
**DPF Framework Reference:** [fft_multi_harmonic_minmax operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/math/fft_multi_harmonic_minmax.md)
