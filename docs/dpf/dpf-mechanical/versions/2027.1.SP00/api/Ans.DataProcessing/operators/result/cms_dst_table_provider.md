...
**DPF Framework Reference:** [cms_dst_table_provider operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/result/cms_dst_table_provider.md)
