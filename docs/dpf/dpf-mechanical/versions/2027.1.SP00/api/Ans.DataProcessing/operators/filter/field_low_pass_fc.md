...
**DPF Framework Reference:** [field_low_pass_fc operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/filter/field_low_pass_fc.md)
