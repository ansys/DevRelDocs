...
**DPF Framework Reference:** [cms_subfile_info_provider operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/result/cms_subfile_info_provider.md)
