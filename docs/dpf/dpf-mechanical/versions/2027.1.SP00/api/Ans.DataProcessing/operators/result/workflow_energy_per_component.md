...
**DPF Framework Reference:** [workflow_energy_per_component operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/result/workflow_energy_per_component.md)
