...
**DPF Framework Reference:** [compute_element_centroids operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/scoping/compute_element_centroids.md)
