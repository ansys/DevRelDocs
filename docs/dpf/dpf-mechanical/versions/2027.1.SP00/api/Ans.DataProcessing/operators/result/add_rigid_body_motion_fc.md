...
**DPF Framework Reference:** [add_rigid_body_motion_fc operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/result/add_rigid_body_motion_fc.md)
