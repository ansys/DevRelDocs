...
**DPF Framework Reference:** [mesh_property_provider operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/metadata/mesh_property_provider.md)
