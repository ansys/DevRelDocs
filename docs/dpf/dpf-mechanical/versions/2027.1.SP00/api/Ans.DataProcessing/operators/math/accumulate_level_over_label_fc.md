...
**DPF Framework Reference:** [accumulate_level_over_label_fc operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/math/accumulate_level_over_label_fc.md)
