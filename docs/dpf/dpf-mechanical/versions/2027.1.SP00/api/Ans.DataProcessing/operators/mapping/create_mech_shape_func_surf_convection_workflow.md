...
**DPF Framework Reference:** [create_mech_shape_func_surf_convection_workflow operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/mapping/create_mech_shape_func_surf_convection_workflow.md)
