...
**DPF Framework Reference:** [elemental_nodal_to_nodal_elemental_fc operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/averaging/elemental_nodal_to_nodal_elemental_fc.md)
