...
**DPF Framework Reference:** [joint_relative_angular_acceleration operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/result/joint_relative_angular_acceleration.md)
