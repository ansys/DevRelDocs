...
**DPF Framework Reference:** [nodal_to_elemental_nodal_fc operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/averaging/nodal_to_elemental_nodal_fc.md)
