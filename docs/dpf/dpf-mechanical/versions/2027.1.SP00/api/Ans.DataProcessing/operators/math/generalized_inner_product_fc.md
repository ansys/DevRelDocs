...
**DPF Framework Reference:** [generalized_inner_product_fc operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/math/generalized_inner_product_fc.md)
