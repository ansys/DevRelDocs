...
**DPF Framework Reference:** [assemble_scalars_to_vectors operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/utility/assemble_scalars_to_vectors.md)
