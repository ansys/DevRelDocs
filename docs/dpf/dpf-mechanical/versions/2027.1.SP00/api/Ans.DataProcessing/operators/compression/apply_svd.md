...
**DPF Framework Reference:** [apply_svd operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/compression/apply_svd.md)
