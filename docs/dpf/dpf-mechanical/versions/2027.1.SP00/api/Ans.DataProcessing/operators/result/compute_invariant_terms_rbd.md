...
**DPF Framework Reference:** [compute_invariant_terms_rbd operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/result/compute_invariant_terms_rbd.md)
