...
**DPF Framework Reference:** [prepare_mechanical_native_mapping_point_cloud operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud.md)
