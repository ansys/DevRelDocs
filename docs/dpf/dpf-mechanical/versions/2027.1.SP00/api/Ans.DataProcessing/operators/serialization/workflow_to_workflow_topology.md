...
**DPF Framework Reference:** [workflow_to_workflow_topology operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/serialization/workflow_to_workflow_topology.md)
