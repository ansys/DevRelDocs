...
**DPF Framework Reference:** [boundary_condition_provider operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/metadata/boundary_condition_provider.md)
