...
**DPF Framework Reference:** [rigid_transformation_provider operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/result/rigid_transformation_provider.md)
