...
**DPF Framework Reference:** [min_max_over_time_by_entity operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/min_max/min_max_over_time_by_entity.md)
