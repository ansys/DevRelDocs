...
**DPF Framework Reference:** [rescope_custom_type_field operator specification](https://developer.ansys.com/docs/dpf-framework-2027.1.sp00/operator-specifications/scoping/rescope_custom_type_field.md)
