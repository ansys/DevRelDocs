...
# *class* part_momentum(data_sources: object = None, entity_scoping: object = None, unit_system: object = None, config: OperatorConfig = None)
...
**DPF Framework Reference:** [part_momentum operator specification](https://developer.ansys.com/docs/dpf-framework-2027.r1.sp00/operator-specifications/result/part_momentum.md)
...
op = part_momentum(data_sources=my_data_sources,entity_scoping=my_entity_scoping,unit_system=my_unit_system)
```
