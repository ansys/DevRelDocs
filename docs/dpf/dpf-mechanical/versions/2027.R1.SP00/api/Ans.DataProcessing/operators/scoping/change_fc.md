...
**DPF Framework Reference:** [change_fc operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/scoping/change_fc.md)
