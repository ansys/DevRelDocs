...
**DPF Framework Reference:** [elemental_mean operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/averaging/elemental_mean.md)
