...
**DPF Framework Reference:** [scoping_band_pass operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/filter/scoping_band_pass.md)
