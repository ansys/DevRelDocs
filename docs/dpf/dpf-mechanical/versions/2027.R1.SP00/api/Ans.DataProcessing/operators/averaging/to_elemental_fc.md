...
**DPF Framework Reference:** [to_elemental_fc operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/averaging/to_elemental_fc.md)
