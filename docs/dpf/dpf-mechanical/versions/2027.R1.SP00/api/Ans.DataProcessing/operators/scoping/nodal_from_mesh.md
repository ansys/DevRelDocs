...
**DPF Framework Reference:** [nodal_from_mesh operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/scoping/nodal_from_mesh.md)
