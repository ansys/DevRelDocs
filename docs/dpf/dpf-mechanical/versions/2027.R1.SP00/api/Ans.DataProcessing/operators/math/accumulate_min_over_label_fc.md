...
# *class* accumulate_min_over_label_fc(fields_container: object = None, label: object = None, config: OperatorConfig = None)
...
**DPF Framework Reference:** [accumulate_min_over_label_fc operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/math/accumulate_min_over_label_fc.md)
...
```python
op = accumulate_min_over_label_fc()

op = accumulate_min_over_label_fc(fields_container=my_fields_container,label=my_label)
```
