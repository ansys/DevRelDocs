...
**DPF Framework Reference:** [migrate_file_to_vtk operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/serialization/migrate_file_to_vtk.md)
