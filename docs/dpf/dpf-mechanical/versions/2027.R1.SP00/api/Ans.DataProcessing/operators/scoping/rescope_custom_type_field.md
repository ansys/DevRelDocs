...
**DPF Framework Reference:** [rescope_custom_type_field operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/scoping/rescope_custom_type_field.md)
