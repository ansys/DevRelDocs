...
**DPF Framework Reference:** [operator_id operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/utility/operator_id.md)
