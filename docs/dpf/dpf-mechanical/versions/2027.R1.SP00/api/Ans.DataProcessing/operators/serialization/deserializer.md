...
available inputs: `stream_type` (Int32) (optional), `file_path` (string)

available outputs: `any_output1` (Any), `any_output2` (Any)

**DPF Framework Reference:** [deserializer operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/serialization/deserializer.md)
