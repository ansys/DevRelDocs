...
# *class* global_added_mass_pct(data_sources: object = None, unit_system: object = None, config: OperatorConfig = None)
...
**DPF Framework Reference:** [global_added_mass_pct operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/result/global_added_mass_pct.md)
