...
**DPF Framework Reference:** [change_shell_layers operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/utility/change_shell_layers.md)
