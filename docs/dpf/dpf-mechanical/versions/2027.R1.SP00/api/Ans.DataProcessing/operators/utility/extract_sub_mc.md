...
**DPF Framework Reference:** [extract_sub_mc operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/utility/extract_sub_mc.md)
