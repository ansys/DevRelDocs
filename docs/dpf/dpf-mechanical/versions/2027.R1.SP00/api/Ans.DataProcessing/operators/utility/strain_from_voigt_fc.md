...
**DPF Framework Reference:** [strain_from_voigt_fc operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/utility/strain_from_voigt_fc.md)
