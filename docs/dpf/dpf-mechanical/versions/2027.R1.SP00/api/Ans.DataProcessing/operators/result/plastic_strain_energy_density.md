...
# *class* plastic_strain_energy_density(time_scoping: object = None, mesh_scoping: object = None, data_sources: object = None, requested_location: object = None, config: OperatorConfig = None)

plastic_strain_energy_density()
plastic_strain_energy_density(time_scoping: object, mesh_scoping: object, data_sources: object, requested_location: object, config: OperatorConfig)
plastic_strain_energy_density(config: OperatorConfig)


**DPF Framework Reference:** [plastic_strain_energy_density operator specification](https://developer.ansys.com/docs/dpf-framework-2027.r1.sp00/operator-specifications/result/plastic_strain_energy_density.md)
