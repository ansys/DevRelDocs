...
**DPF Framework Reference:** [incremental_concatenate_as_fc operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/utility/incremental_concatenate_as_fc.md)
