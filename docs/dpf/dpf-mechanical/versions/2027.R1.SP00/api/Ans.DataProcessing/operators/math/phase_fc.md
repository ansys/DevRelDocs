...
**DPF Framework Reference:** [phase_fc operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/math/phase_fc.md)
