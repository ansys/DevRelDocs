...
**DPF Framework Reference:** [property_field_provider_by_name operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/metadata/property_field_provider_by_name.md)
