...
**DPF Framework Reference:** [cyclic_support_get_attribute operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/utility/cyclic_support_get_attribute.md)
