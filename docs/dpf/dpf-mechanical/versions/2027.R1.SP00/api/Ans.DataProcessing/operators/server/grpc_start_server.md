...
**DPF Framework Reference:** [grpc_start_server operator specification](https://developer.ansys.com/docs/dpf-framework-2027.r1.sp00/operator-specifications/server/grpc_start_server.md)
