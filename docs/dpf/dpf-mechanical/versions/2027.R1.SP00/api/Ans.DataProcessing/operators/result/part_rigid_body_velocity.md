...
# *class* part_rigid_body_velocity(data_sources: object = None, entity_scoping: object = None, unit_system: object = None, config: OperatorConfig = None)
...
**DPF Framework Reference:** [part_rigid_body_velocity operator specification](https://developer.ansys.com/docs/dpf-framework-2027.r1.sp00/operator-specifications/result/part_rigid_body_velocity.md)
...
```python
op = part_rigid_body_velocity()

op = part_rigid_body_velocity(data_sources=my_data_sources,entity_scoping=my_entity_scoping,unit_system=my_unit_system)
```
