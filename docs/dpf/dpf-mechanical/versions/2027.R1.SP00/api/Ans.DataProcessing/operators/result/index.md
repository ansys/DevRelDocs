...
| [acoustic_energy_density](Ans_DataProcessing_operators_result_acoustic_energy_density.md) | acoustic_energy_density() |
| [acoustic_pressure](Ans_DataProcessing_operators_result_acoustic_pressure.md) | acoustic_pressure() |
...
| [average_velocity](Ans_DataProcessing_operators_result_average_velocity.md) | average_velocity() |
...
| [compute_stress](Ans_DataProcessing_operators_result_compute_stress.md) | Computes the stress from an elastic strain field. compute_total_strain limitations are applicable for stress computation   ///available inputs: scoping (Scoping) (optional), streams_container (StreamsContainer) (optional), data_sources (DataSources) (optional), requested_location (string) (optional), strain (FieldsContainer, Field) |
| [compute_stress_1](Ans_DataProcessing_operators_result_compute_stress_1.md) | Computes the stress from an elastic strain field. compute_total_strain limitations are applicable for stress computation Get the 1st principal component.   ///available inputs: scoping (Scoping) (optional), streams_container (StreamsContainer) (optional), data_sources (DataSources) (optional), requested_location (string) (optional), strain (FieldsContainer, Field) |
| [compute_stress_2](Ans_DataProcessing_operators_result_compute_stress_2.md) | Computes the stress from an elastic strain field. compute_total_strain limitations are applicable for stress computation Get the 2nd principal component.   ///available inputs: scoping (Scoping) (optional), streams_container (StreamsContainer) (optional), data_sources (DataSources) (optional), requested_location (string) (optional), strain (FieldsContainer, Field) |
| [compute_stress_3](Ans_DataProcessing_operators_result_compute_stress_3.md) | Computes the stress from an elastic strain field. compute_total_strain limitations are applicable for stress computation Get the 3rd principal component.   ///available inputs: scoping (Scoping) (optional), streams_container (StreamsContainer) (optional), data_sources (DataSources) (optional), requested_location (string) (optional), strain (FieldsContainer, Field) |
| [compute_stress_X](Ans_DataProcessing_operators_result_compute_stress_X.md) | Computes the stress from an elastic strain field. compute_total_strain limitations are applicable for stress computation Get the XX normal component (00 component).   ///available inputs: scoping (Scoping) (optional), streams_container (StreamsContainer) (optional), data_sources (DataSources) (optional), requested_location (string) (optional), strain (FieldsContainer, Field) |
| [compute_stress_XY](Ans_DataProcessing_operators_result_compute_stress_XY.md) | Computes the stress from an elastic strain field. compute_total_strain limitations are applicable for stress computation Get the XY shear component (01 component).   ///available inputs: scoping (Scoping) (optional), streams_container (StreamsContainer) (optional), data_sources (DataSources) (optional), requested_location (string) (optional), strain (FieldsContainer, Field) |
| [compute_stress_XZ](Ans_DataProcessing_operators_result_compute_stress_XZ.md) | Computes the stress from an elastic strain field. compute_total_strain limitations are applicable for stress computation Get the XZ shear component (02 component).   ///available inputs: scoping (Scoping) (optional), streams_container (StreamsContainer) (optional), data_sources (DataSources) (optional), requested_location (string) (optional), strain (FieldsContainer, Field) |
| [compute_stress_Y](Ans_DataProcessing_operators_result_compute_stress_Y.md) | Computes the stress from an elastic strain field. compute_total_strain limitations are applicable for stress computation Get the YY normal component (11 component).   ///available inputs: scoping (Scoping) (optional), streams_container (StreamsContainer) (optional), data_sources (DataSources) (optional), requested_location (string) (optional), strain (FieldsContainer, Field) |
| [compute_stress_YZ](Ans_DataProcessing_operators_result_compute_stress_YZ.md) | Computes the stress from an elastic strain field. compute_total_strain limitations are applicable for stress computation Get the YZ shear component (12 component).   ///available inputs: scoping (Scoping) (optional), streams_container (StreamsContainer) (optional), data_sources (DataSources) (optional), requested_location (string) (optional), strain (FieldsContainer, Field) |
| [compute_stress_Z](Ans_DataProcessing_operators_result_compute_stress_Z.md) | Computes the stress from an elastic strain field. compute_total_strain limitations are applicable for stress computation Get the ZZ normal component (22 component).   ///available inputs: scoping (Scoping) (optional), streams_container (StreamsContainer) (optional), data_sources (DataSources) (optional), requested_location (string) (optional), strain (FieldsContainer, Field) |
| [compute_stress_von_mises](Ans_DataProcessing_operators_result_compute_stress_von_mises.md) | Computes the stress from an elastic strain field. compute_total_strain limitations are applicable for stress computationGet the Von Mises equivalent stress.   ///available inputs: scoping (Scoping) (optional), streams_container (StreamsContainer) (optional), data_sources (DataSources) (optional), requested_location (string) (optional), strain (FieldsContainer, Field) |
| [compute_total_strain](Ans_DataProcessing_operators_result_compute_total_strain.md) | compute_total_strain() |
| [compute_total_strain_1](Ans_DataProcessing_operators_result_compute_total_strain_1.md) | compute_total_strain_1() |
| [compute_total_strain_2](Ans_DataProcessing_operators_result_compute_total_strain_2.md) | compute_total_strain_2() |
| [compute_total_strain_3](Ans_DataProcessing_operators_result_compute_total_strain_3.md) | compute_total_strain_3() |
| [compute_total_strain_X](Ans_DataProcessing_operators_result_compute_total_strain_X.md) | compute_total_strain_X() |
| [compute_total_strain_XY](Ans_DataProcessing_operators_result_compute_total_strain_XY.md) | compute_total_strain_XY() |
| [compute_total_strain_XZ](Ans_DataProcessing_operators_result_compute_total_strain_XZ.md) | compute_total_strain_XZ() |
...
| [creep_strain_X](Ans_DataProcessing_operators_result_creep_strain_X.md) | creep_strain_X() |
| [creep_strain_XY](Ans_DataProcessing_operators_result_creep_strain_XY.md) | creep_strain_XY() |
| [creep_strain_XZ](Ans_DataProcessing_operators_result_creep_strain_XZ.md) | creep_strain_XZ() |
| [creep_strain_Y](Ans_DataProcessing_operators_result_creep_strain_Y.md) | creep_strain_Y() |
| [creep_strain_YZ](Ans_DataProcessing_operators_result_creep_strain_YZ.md) | creep_strain_YZ() |
| [creep_strain_Z](Ans_DataProcessing_operators_result_creep_strain_Z.md) | creep_strain_Z() |
...
| [creep_strain_eqv](Ans_DataProcessing_operators_result_creep_strain_eqv.md) | creep_strain_eqv() |
| [creep_strain_intensity](Ans_DataProcessing_operators_result_creep_strain_intensity.md) | creep_strain_intensity() |
| [creep_strain_max_shear](Ans_DataProcessing_operators_result_creep_strain_max_shear.md) | creep_strain_max_shear() |
| [creep_strain_principal_1](Ans_DataProcessing_operators_result_creep_strain_principal_1.md) | creep_strain_principal_1() |
| [creep_strain_principal_2](Ans_DataProcessing_operators_result_creep_strain_principal_2.md) | creep_strain_principal_2() |
| [creep_strain_principal_3](Ans_DataProcessing_operators_result_creep_strain_principal_3.md) | creep_strain_principal_3() |
...
| [element_nodal_heat](Ans_DataProcessing_operators_result_element_nodal_heat.md) | element_nodal_heat() |
| [element_nodal_moments](Ans_DataProcessing_operators_result_element_nodal_moments.md) | element_nodal_moments() |
...
| [enclosure_number](Ans_DataProcessing_operators_result_enclosure_number.md) | enclosure_number() |
...
| [film_coefficient](Ans_DataProcessing_operators_result_film_coefficient.md) | film_coefficient() |
| [flow_rate](Ans_DataProcessing_operators_result_flow_rate.md) | flow_rate() |
| [fluid_velocity](Ans_DataProcessing_operators_result_fluid_velocity.md) | fluid_velocity() |
...
| [gasket_total_closure](Ans_DataProcessing_operators_result_gasket_total_closure.md) | gasket_total_closure() |
| [gasket_total_closure_X](Ans_DataProcessing_operators_result_gasket_total_closure_X.md) | gasket_total_closure_X() |
| [gasket_total_closure_XY](Ans_DataProcessing_operators_result_gasket_total_closure_XY.md) | gasket_total_closure_XY() |
| [gasket_total_closure_XZ](Ans_DataProcessing_operators_result_gasket_total_closure_XZ.md) | gasket_total_closure_XZ() |
...
| [heat_conductivity_rate](Ans_DataProcessing_operators_result_heat_conductivity_rate.md) | heat_conductivity_rate() |
...
| [heat_transport_rate](Ans_DataProcessing_operators_result_heat_transport_rate.md) | heat_transport_rate() |
| [hydrostatic_pressure](Ans_DataProcessing_operators_result_hydrostatic_pressure.md) | hydrostatic_pressure() |
| [incident_radiation_heat_flux](Ans_DataProcessing_operators_result_incident_radiation_heat_flux.md) | incident_radiation_heat_flux() |
...
| [input_sound_power](Ans_DataProcessing_operators_result_input_sound_power.md) | input_sound_power() |
...
| [net_radiation_heat_flux](Ans_DataProcessing_operators_result_net_radiation_heat_flux.md) | net_radiation_heat_flux() |
...
| [nodal_to_global](Ans_DataProcessing_operators_result_nodal_to_global.md) | Rotates nodal elemental results to global coordinate system   ///available inputs: fieldA (Field), fieldB (Field), inverse_rotation (bool) (optional) |
...
| [nusselt_number](Ans_DataProcessing_operators_result_nusselt_number.md) | nusselt_number() |
...
| [raw_velocity](Ans_DataProcessing_operators_result_raw_velocity.md) | raw_velocity() |
...
| [reaction_heat](Ans_DataProcessing_operators_result_reaction_heat.md) | reaction_heat() |
| [reaction_moment](Ans_DataProcessing_operators_result_reaction_moment.md) | reaction_moment() |
| [reaction_moment_X](Ans_DataProcessing_operators_result_reaction_moment_X.md) | reaction_moment_X() |
| [reaction_moment_Y](Ans_DataProcessing_operators_result_reaction_moment_Y.md) | reaction_moment_Y() |
| [reaction_moment_Z](Ans_DataProcessing_operators_result_reaction_moment_Z.md) | reaction_moment_Z() |
...
| [record_reader](Ans_DataProcessing_operators_result_record_reader.md) | Extracts a record from a file.   ///available inputs: streams (StreamsContainer) (optional), data_sources (DataSources), record_name (Any) |
| [reflected_radiation_heat_flux](Ans_DataProcessing_operators_result_reflected_radiation_heat_flux.md) | reflected_radiation_heat_flux() |
...
| [reynolds_number](Ans_DataProcessing_operators_result_reynolds_number.md) | reynolds_number() |
...
| [torque](Ans_DataProcessing_operators_result_torque.md) | Compute torque of a force based on a 3D point. The torque is computed in units consistent with the force and the mesh support.   ///available inputs: fields_container (FieldsContainer), spoint (Field, FieldsContainer) |
...
| [view_factor_sum](Ans_DataProcessing_operators_result_view_factor_sum.md) | view_factor_sum() |
