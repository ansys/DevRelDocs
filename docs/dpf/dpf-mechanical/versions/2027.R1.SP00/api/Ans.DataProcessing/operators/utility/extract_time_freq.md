...
**DPF Framework Reference:** [extract_time_freq operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/utility/extract_time_freq.md)
