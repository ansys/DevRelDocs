...
**DPF Framework Reference:** [merge_time_freq_supports operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/utility/merge_time_freq_supports.md)
