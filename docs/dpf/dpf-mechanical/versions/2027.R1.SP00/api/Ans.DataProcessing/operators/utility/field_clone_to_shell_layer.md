...
**DPF Framework Reference:** [field_clone_to_shell_layer operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/utility/field_clone_to_shell_layer.md)
