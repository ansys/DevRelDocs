...
**DPF Framework Reference:** [reduce_sampling operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/scoping/reduce_sampling.md)
