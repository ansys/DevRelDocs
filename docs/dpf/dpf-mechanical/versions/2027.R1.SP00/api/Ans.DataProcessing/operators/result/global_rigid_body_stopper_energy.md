...
# *class* global_rigid_body_stopper_energy(data_sources: object = None, unit_system: object = None, config: OperatorConfig = None)
...
**DPF Framework Reference:** [global_rigid_body_stopper_energy operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/result/global_rigid_body_stopper_energy.md)
