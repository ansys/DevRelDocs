...
# *class* beam_properties(streams: object = None, data_sources: object = None, config: OperatorConfig = None)
...
**DPF Framework Reference:** [beam_properties operator specification](https://developer.ansys.com/docs/dpf-framework-2027.r1.sp00/operator-specifications/mesh/beam_properties.md)
