...
**DPF Framework Reference:** [temperature_grad operator specification](https://developer.ansys.com/docs/dpf-framework-2027-r1/operator-specifications/result/temperature_grad.md)
