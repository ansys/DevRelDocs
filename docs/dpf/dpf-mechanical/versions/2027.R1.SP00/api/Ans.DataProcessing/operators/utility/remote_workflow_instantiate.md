...
**DPF Framework Reference:** [remote_workflow_instantiate operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/utility/remote_workflow_instantiate.md)
