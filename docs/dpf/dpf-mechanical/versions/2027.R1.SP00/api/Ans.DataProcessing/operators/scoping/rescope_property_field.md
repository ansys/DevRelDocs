...
**DPF Framework Reference:** [rescope_property_field operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/scoping/rescope_property_field.md)
