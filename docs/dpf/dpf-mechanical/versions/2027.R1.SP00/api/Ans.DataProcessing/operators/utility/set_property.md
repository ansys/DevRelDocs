...
**DPF Framework Reference:** [set_property operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/utility/set_property.md)
