...
**DPF Framework Reference:** [strain_eqv_as_mechanical_workflow operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/result/strain_eqv_as_mechanical_workflow.md)
