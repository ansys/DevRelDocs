...
# *class* accumulate_over_label_fc(fields_container: object = None, label: object = None, config: OperatorConfig = None)
...
**DPF Framework Reference:** [accumulate_over_label_fc operator specification](https://developer.ansys.com/docs/dpf-framework-2027.r1.sp00/operator-specifications/math/accumulate_over_label_fc.md)
