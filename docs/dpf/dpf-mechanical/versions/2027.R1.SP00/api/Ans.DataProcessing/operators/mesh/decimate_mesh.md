...
**DPF Framework Reference:** [decimate_mesh operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/mesh/decimate_mesh.md)
