...
**DPF Framework Reference:** [get_operators operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/utility/get_operators.md)
