...
**DPF Framework Reference:** [exclude_levelset operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/mesh/exclude_levelset.md)
