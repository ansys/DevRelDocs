...
**DPF Framework Reference:** [field_to_fc operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/utility/field_to_fc.md)
