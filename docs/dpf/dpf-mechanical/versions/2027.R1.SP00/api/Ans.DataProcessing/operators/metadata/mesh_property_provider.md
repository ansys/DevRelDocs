...
**DPF Framework Reference:** [mesh_property_provider operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/metadata/mesh_property_provider.md)
