...
**DPF Framework Reference:** [abc_weightings operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/filter/abc_weightings.md)
