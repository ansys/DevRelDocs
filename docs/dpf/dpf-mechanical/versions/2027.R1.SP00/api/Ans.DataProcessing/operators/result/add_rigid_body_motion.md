...
**DPF Framework Reference:** [add_rigid_body_motion operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/result/add_rigid_body_motion.md)
