...
**DPF Framework Reference:** [generalized_inner_product_fc operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/math/generalized_inner_product_fc.md)
