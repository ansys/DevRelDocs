...
**DPF Framework Reference:** [elemental_density operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/math/elemental_density.md)
