...
**DPF Framework Reference:** [prepare_mapping_workflow operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/mapping/prepare_mapping_workflow.md)
