...
**DPF Framework Reference:** [server_path operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/utility/server_path.md)
