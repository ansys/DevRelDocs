...
**DPF Framework Reference:** [cyclic_expansion operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/result/cyclic_expansion.md)
