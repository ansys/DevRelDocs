...
**DPF Framework Reference:** [equivalent_radiated_power operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/result/equivalent_radiated_power.md)
