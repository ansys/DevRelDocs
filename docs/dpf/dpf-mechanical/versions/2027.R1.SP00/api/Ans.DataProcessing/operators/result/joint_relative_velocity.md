...
# *class* joint_relative_velocity(time_scoping: object = None, mesh_scoping: object = None, data_sources: object = None, config: OperatorConfig = None)

joint_relative_velocity()

joint_relative_velocity(time_scoping: object, mesh_scoping: object, data_sources: object, config: OperatorConfig)

joint_relative_velocity(config: OperatorConfig)



**DPF Framework Reference:** [joint_relative_velocity operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/result/joint_relative_velocity.md)
