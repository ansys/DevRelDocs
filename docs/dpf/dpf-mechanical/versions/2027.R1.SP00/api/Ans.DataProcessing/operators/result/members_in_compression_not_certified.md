...
**DPF Framework Reference:** [members_in_compression_not_certified operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/result/members_in_compression_not_certified.md)
