...
# *class* scoping_signed_high_pass(field: object = None, threshold: object = None, both: object = None, config: OperatorConfig = None)
...
**DPF Framework Reference:** [scoping_signed_high_pass operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/filter/scoping_signed_high_pass.md)
...
```python
op = scoping_signed_high_pass()

op = scoping_signed_high_pass(field=my_field,threshold=my_threshold,both=my_both)
```
