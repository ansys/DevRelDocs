...
**DPF Framework Reference:** [workflow_to_workflow_topology operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/serialization/workflow_to_workflow_topology.md)
