...
**DPF Framework Reference:** [segalman_von_mises_eqv operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/invariant/segalman_von_mises_eqv.md)
