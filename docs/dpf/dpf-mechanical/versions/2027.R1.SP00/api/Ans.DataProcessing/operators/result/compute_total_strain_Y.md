...
**DPF Framework Reference:** [compute_total_strain_Y operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/result/compute_total_strain_Y.md)
