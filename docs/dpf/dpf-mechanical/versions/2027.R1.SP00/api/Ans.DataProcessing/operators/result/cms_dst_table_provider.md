...
**DPF Framework Reference:** [cms_dst_table_provider operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/result/cms_dst_table_provider.md)
