...
**DPF Framework Reference:** [workflow_energy_per_component operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/result/workflow_energy_per_component.md)
