...
**DPF Framework Reference:** [mesh_selection_manager_provider operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/metadata/mesh_selection_manager_provider.md)
