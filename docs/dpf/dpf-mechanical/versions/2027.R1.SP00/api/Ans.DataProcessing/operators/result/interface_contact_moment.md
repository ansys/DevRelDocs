...
# *class* interface_contact_moment(data_sources: object = None, entity_scoping: object = None, unit_system: object = None, config: OperatorConfig = None)
...
**DPF Framework Reference:** [interface_contact_moment operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/result/interface_contact_moment.md)
...
```python
op = interface_contact_moment()

op = interface_contact_moment(data_sources=my_data_sources,entity_scoping=my_entity_scoping,unit_system=my_unit_system)
```
