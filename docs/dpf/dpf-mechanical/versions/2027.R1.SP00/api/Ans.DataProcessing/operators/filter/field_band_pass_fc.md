...
**DPF Framework Reference:** [field_band_pass_fc operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/filter/field_band_pass_fc.md)
