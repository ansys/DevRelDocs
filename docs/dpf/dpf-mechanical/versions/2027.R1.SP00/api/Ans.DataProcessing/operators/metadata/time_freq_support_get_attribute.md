...
**DPF Framework Reference:** [time_freq_support_get_attribute operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/metadata/time_freq_support_get_attribute.md)
