...
**DPF Framework Reference:** [elemental_from_mesh operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/scoping/elemental_from_mesh.md)
