...
**DPF Framework Reference:** [adapt_with_scopings_container operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/scoping/adapt_with_scopings_container.md)
