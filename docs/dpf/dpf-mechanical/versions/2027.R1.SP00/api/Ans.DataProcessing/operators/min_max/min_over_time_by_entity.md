...
**DPF Framework Reference:** [min_over_time_by_entity operator specification](https://developer.ansys.com/docs/dpf-framework-2027-r1/operator-specifications/min_max/min_over_time_by_entity.md)
