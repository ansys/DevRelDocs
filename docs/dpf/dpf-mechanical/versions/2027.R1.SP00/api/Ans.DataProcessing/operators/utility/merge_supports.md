...
**DPF Framework Reference:** [merge_supports operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/utility/merge_supports.md)
