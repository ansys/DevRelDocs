...
# *class* component_wise_product(fieldA: object = None, fieldB: object = None, config: OperatorConfig = None)
...
**DPF Framework Reference:** [component_wise_product operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/math/component_wise_product.md)
...
```python
op = component_wise_product()

op = component_wise_product(fieldA=my_fieldA,fieldB=my_fieldB)
```
