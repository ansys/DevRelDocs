...
# *class* interface_contact_area(data_sources: object = None, entity_scoping: object = None, unit_system: object = None, config: OperatorConfig = None)
...
**DPF Framework Reference:** [interface_contact_area operator specification](https://developer.ansys.com/docs/dpf-framework-2027.r1.sp00/operator-specifications/result/interface_contact_area.md)
...
```python
op = interface_contact_area()

op = interface_contact_area(data_sources=my_data_sources,entity_scoping=my_entity_scoping,unit_system=my_unit_system)
```
