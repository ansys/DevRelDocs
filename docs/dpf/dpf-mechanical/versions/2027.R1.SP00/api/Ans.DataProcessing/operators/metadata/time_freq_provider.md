...
# *class* time_freq_provider(streams_container: object = None, data_sources: object = None, config: OperatorConfig = None)
...
**DPF Framework Reference:** [time_freq_provider operator specification](https://developer.ansys.com/docs/dpf-framework-2027.r1.sp00/operator-specifications/metadata/time_freq_provider.md)
