...
**DPF Framework Reference:** [streams_provider operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/metadata/streams_provider.md)
