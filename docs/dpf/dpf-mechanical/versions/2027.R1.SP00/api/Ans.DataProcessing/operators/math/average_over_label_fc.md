...
# *class* average_over_label_fc(fields_container: object = None, label: object = None, config: OperatorConfig = None)
...
**DPF Framework Reference:** [average_over_label_fc operator specification](https://developer.ansys.com/docs/dpf-framework-2027.r1.sp00/operator-specifications/math/average_over_label_fc.md)
