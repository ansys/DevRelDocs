...
**DPF Framework Reference:** [field_low_pass operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/filter/field_low_pass.md)
