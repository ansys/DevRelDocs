...
# *class* field_low_pass(field: object = None, threshold: object = None, both: object = None, config: OperatorConfig = None)
...
**DPF Framework Reference:** [field_low_pass operator specification](https://developer.ansys.com/docs/dpf-framework-2027.r1.sp00/operator-specifications/filter/field_low_pass.md)
...
op = field_low_pass(field=my_field,threshold=my_threshold,both=my_both)
```
