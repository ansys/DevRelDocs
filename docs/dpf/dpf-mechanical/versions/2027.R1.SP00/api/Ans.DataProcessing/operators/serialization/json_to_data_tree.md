...
# *class* json_to_data_tree(string_or_path: object = None, config: OperatorConfig = None)
...
**DPF Framework Reference:** [json_to_data_tree operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/serialization/json_to_data_tree.md)
