...
**DPF Framework Reference:** [timefreq_signed_high_pass operator specification](https://developer.ansys.com/docs/dpf-framework-2027.r1.sp00/operator-specifications/filter/timefreq_signed_high_pass.md)
