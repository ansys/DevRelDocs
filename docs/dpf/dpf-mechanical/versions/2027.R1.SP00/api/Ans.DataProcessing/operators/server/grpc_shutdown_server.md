...
**DPF Framework Reference:** [grpc_shutdown_server operator specification](https://developer.ansys.com/docs/dpf-framework-2027.r1.sp00/operator-specifications/server/grpc_shutdown_server.md)
