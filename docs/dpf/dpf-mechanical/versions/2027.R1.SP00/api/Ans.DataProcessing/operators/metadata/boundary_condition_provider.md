...
**DPF Framework Reference:** [boundary_condition_provider operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/metadata/boundary_condition_provider.md)
