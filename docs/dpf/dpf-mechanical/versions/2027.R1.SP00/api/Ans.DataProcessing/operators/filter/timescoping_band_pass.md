...
**DPF Framework Reference:** [timescoping_band_pass operator specification](https://developer.ansys.com/docs/dpf-framework-2027-r1/operator-specifications/filter/timescoping_band_pass.md)
