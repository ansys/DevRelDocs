---
uid: Ans.DataProcessing.operators.result.acceleration
---

# *class* acceleration(time_scoping: object = None, mesh_scoping: object = None, data_sources: object = None, expanded_meshed_region: object = None, sectors_to_expand: object = None, phi: object = None, config: OperatorConfig = None)

acceleration()
acceleration(time_scoping: object, mesh_scoping: object, data_sources: object, expanded_meshed_region: object, sectors_to_expand: object, phi: object, config: OperatorConfig)
acceleration(config: OperatorConfig)


**DPF Framework Reference:** [acceleration operator specification](https://developer.ansys.com/docs/dpf-framework-2027.r1.sp00/operator-specifications/result/acceleration.md)
