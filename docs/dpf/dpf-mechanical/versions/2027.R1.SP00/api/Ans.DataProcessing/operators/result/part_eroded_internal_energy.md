...
# *class* part_eroded_internal_energy(data_sources: object = None, entity_scoping: object = None, unit_system: object = None, config: OperatorConfig = None)
...
**DPF Framework Reference:** [part_eroded_internal_energy operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/result/part_eroded_internal_energy.md)
...
```python
op = part_eroded_internal_energy()

op = part_eroded_internal_energy(data_sources=my_data_sources,entity_scoping=my_entity_scoping,unit_system=my_unit_system)
```
