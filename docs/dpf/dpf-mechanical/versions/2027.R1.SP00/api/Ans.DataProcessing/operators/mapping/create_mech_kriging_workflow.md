---
uid: Ans.DataProcessing.operators.mapping.create_mech_kriging_workflow
---

# *class* create_mech_kriging_workflow(source_mesh: object = None, target_mesh: object = None, target_scoping: object = None, shell_offset_field: object = None, options_data_tree: object = None, config: OperatorConfig = None)
...
**DPF Framework Reference:** [create_mech_kriging_workflow operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/mapping/create_mech_kriging_workflow.md)
...
```python
op = create_mech_kriging_workflow()

op = create_mech_kriging_workflow(source_mesh=my_source_mesh,target_mesh=my_target_mesh,target_scoping=my_target_scoping,shell_offset_field=my_shell_offset_field,options_data_tree=my_options_data_tree)
```
