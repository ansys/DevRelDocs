...
**DPF Framework Reference:** [timescoping_signed_high_pass operator specification](https://developer-a.synopsys.com/docs/dpf-framework-2027-r1/operator-specifications/filter/timescoping_signed_high_pass.md)
