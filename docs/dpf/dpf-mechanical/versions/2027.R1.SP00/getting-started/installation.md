...
DPF is automatically available in Ansys Mechanical 2027.R1.SP00. No separate installation is required. DPF is exposed through IronPython using the underlying C# DLLs.
...
- Verify you're using Ansys Mechanical 2027.R1.SP00 or later
