...
| Class | Description |
|-------|-------------|
| [global_to_nodal](mapdl_global_to_nodal.md) | Rotate results from global coordinate system to local coordinate system.   ///available inputs: fieldA (Field), fieldB (Field)
 |
| [pres_to_field](mapdl_pres_to_field.md) | Read the presol generated file from mapdl.   ///available inputs: filepath (string), columns_to_read (Int32) (optional)
 |
