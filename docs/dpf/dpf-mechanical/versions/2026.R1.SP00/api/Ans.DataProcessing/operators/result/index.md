...
| Class | Description |
|-------|-------------|
| [acceleration](acceleration.md) | acceleration()
 |
| [acceleration_X](acceleration_X.md) | acceleration_X()
 |
| [acceleration_Y](Ans_Datation_Y.md) | acceleration_Y()
 |
| [acceleration_Z](Ans_DataPion_Z.md) | acceleration_Z()
 |
| [accu_eqv_creep_strain](Ansu_eqv_creep_strain.md) | accu_eqv_creep_strain()
 |
...
| [artificial_hourglasss_result_artificial_hourglass_energy.md) | artificial_hourglass_energy()
 |
| [beam_axial_force](Ans__axial_force.md) | beam_axial_force()
 |
...
| [beam_axial__result_beam_axial_stress.md) | beam_axial_stress()
 |
| [beam_axial_total_strain](Ans__axial_total_strain.md) | beam_axial_total_strain()
 |
...
| [beam_torsional_moment]_beam_torsional_moment.md) | beam_torsional_moment()
 |
| [beam_tr_shear_stress](Anam_tr_shear_stress.md) | beam_tr_shear_stress()
 |
| [cms_dst_table_provider](cms_dst_table_provider.md) | Read CST table from a subfile.   ///available inputs: data_sources (DataSources)
 |
| [cms_matrices_provider](Ans_matrices_provider.md) | Read reduced matrices for cms elements. Extract stiffness, damping, mass matrices and load vector from a subfile.   ///available inputs: data_sources (DataSources), matrix_form (bool)
 |
...
| [compute_total_strainsult_compute_total_strain_YZ.md) | compute_total_strain_YZ()
 |
| [compute_total_strain_Z](Anmpute_total_strain_Z.md) | compute_total_strain_Z()
 |
| [contact_fluid_penetration_pr_result_contact_fluid_penetration_pressure.md) | contact_fluid_penetration_pressure()
 |
| [contact_friction_stress](Ans_DataProcessn_stress.md) | contact_friction_stress()
 |
...
| [contact_penetratiolt_contact_penetration.md) | contact_penetration()
 |
| [contact_pressure](Ans_Dat_pressure.md) | contact_pressure()
 |
| [contact_sliding_distance]_contact_sliding_distance.md) | contact_sliding_distance()
 |
| [contact_status](Anstact_status.md) | contact_status()
 |
| [contact_surface_heat_fsult_contact_surface_heat_flux.md) | contact_surface_heat_flux()
 |
| [contact_total_stress](Anntact_total_stress.md) | contact_total_stress()
 |
| [coordinate_system](Ans_Datate_system.md) | Extracts the Rotation Matrix and Origin of a specific coordinate system.   ///available inputs: cs_id (Int32), streams_container (StreamsContainer) (optional), data_sources (DataSources)
 |
| [coordinates](Ans_Dinates.md) | coordinates()
 |
| [creep_strault_creep_strain.md) | creep_strain()
 |
| [creep_strresult_creep_strain_X.md) | creep_strain_X()
 |
| [creep_strain_XY](Ans_DataPrin_XY.md) | creep_strain_XY()
 |
| [creep_strain_XZ](Ans_DataPain_XZ.md) | creep_strain_XZ()
 |
| [creep_strain_lt_creep_strain_Y.md) | creep_strain_Y()
 |
| [creep_strain_YZ](Ans_DataPain_YZ.md) | creep_strain_YZ()
 |
| [creep_strain_Z](Ans_DataProceZ.md) | creep_strain_Z()
 |
| [creep_strain_enrators_result_creep_strain_energy_density.md) | creep_strain_energy_density()
 |
| [creep_strain_eqv](creep_strain_eqv.md) | creep_strain_eqv()
 |
| [creep_strain_intensity](creep_strain_intensity.md) | creep_strain_intensity()
 |
| [creep_strain_max_shear](Ansep_strain_max_shear.md) | creep_strain_max_shear()
 |
...
| [elastic_strailt_elastic_strain.md) | elastic_strain()
 |
| [elastic_strain_X](Anastic_strain_X.md) | elastic_strain_X()
 |
| [elastic_strain_XY](elastic_strain_XY.md) | elastic_strain_XY()
 |
| [elastic_strain_XZ](Ans_Dac_strain_XZ.md) | elastic_strain_XZ()
 |
| [elastic_strain_Y](Ans_Datastrain_Y.md) | elastic_strain_Y()
 |
| [elastic_strain_YZ](Ansstic_strain_YZ.md) | elastic_strain_YZ()
 |
| [elastic_strain_Z](Ans_DataProain_Z.md) | elastic_strain_Z()
 |
| [elastic_strain_energy_density](Anastic_strain_energy_density.md) | elastic_strain_energy_density()
 |
| [elastic_strain_eqv](Ans_Dic_strain_eqv.md) | elastic_strain_eqv()
 |
...
| [elastic_strain_rotation_berators_result_elastic_strain_rotation_by_euler_nodes.md) | read Euler angles on elements from the result file and rotate the fields in the fieldsContainer.   ///available inputs: fields_container (FieldsContainer) (optional), streams_container (StreamsContainer, Stream) (optional), data_sources (DataSources)
 |
| [electric_field](Ans_DataProeld.md) | electric_field()
 |
| [electric_field_lt_electric_field_X.md) | electric_field_X()
 |
| [electric_field_Y](Ans_DataProcessinmd) | electric_field_Y()
 |
...
| [electric_flux_drs_result_electric_flux_density_X.md) | electric_flux_density_X()
 |
| [electric_flux_density_Y](Ans_DataProce_density_Y.md) | electric_flux_density_Y()
 |
...
| [element_orientatioesult_element_orientations_X.md) | element_orientations_X()
 |
| [element_orientations_Y](Ans_DataPrientations_Y.md) | element_orientations_Y()
 |
| [element_orientations_Z](Ans_DataPrientations_Z.md) | element_orientations_Z()
 |
| [elemental_heat_generation](Anemental_heat_generation.md) | elemental_heat_generation()
 |
| [elemental_mass](Ans_DataProces.md) | elemental_mass()
 |
| [elemental_volume](Alemental_volume.md) | elemental_volume()
 |
...
| [epsilon](Ans_DataPro | epsilon()
 |
| [equivalent_mass](Ans_DataProcass.md) | equivalent_mass()
 |
...
| [eqv_stress_parameter]_eqv_stress_parameter.md) | eqv_stress_parameter()
 |
| [erp_radiation_efficiency](erp_radiation_efficiency.md) | Compute the radiation efficiency (enhanced erp divided by classical erp)   ///available inputs: fields_container (FieldsContainer), mesh (MeshedRegion, MeshesContainer), time_scoping (Int32, IList int, Scoping, System.Collections.IEnumerable), mass_density (double), speed_of_sound (double)
 |
| [euler_load_bucklsult_euler_load_buckling.md) | Computing Euler's Critical Load. Formula: Ncr = n*E*I*pi*pi /(L*L)    ///available inputs: field_beam_end_condition (DataSources, Field), field_beam_moment_inertia (Field), field_beam_young_modulus (Field), field_beam_length (Field)
 |
| [euler_nodes](Ans_Danodes.md) | Reads a field made of 3 coordinates and 3 Euler angles (6 dofs) by node from the result file.   ///available inputs: streams_container (StreamsContainer, Stream) (optional), data_sources (DataSources), filter_zeros (bool), coord_and_euler (bool), mesh (MeshedRegion) (optional)
 |
| [fluid_velocity](Anuid_velocity.md) | fluid_velocity()
 |
...
| [gasket_stress](Ans_DataProcessing_operatt_stress()
 |
| [gasket_stress_X](Ans_Datatress_X.md) | gasket_stress_X()
 |
| [gasket_stresesult_gasket_stress_XY.md) | gasket_stress_XY()
 |
| [gasket_stress_XZ](Ansket_stress_XZ.md) | gasket_stress_XZ()
 |
...
| [gasket_thermal_clo_result_gasket_thermal_closure_X.md) | gasket_thermal_closure_X()
 |
| [gasket_thermal_closure_XY](Ans_Datahermal_closure_XY.md) | gasket_thermal_closure_XY()
 |
| [gasket_thermal_closure_XZ](Ansket_thermal_closure_XZ.md) | gasket_thermal_closure_XZ()
 |
| [gasket_total_closure](gasket_total_closure.md) | gasket_total_closure()
 |
...
| [global_added_masresult_global_added_mass_pct.md) | Read Global Added Mass (percentage) (LSDyna) by calling the readers defined by the datasources.   ///available inputs: streams_container (StreamsContainer) (optional), data_sources (DataSources), unit_system (Int32, string) (optional)
 |
| [global_center_mass](Ans_Dl_center_mass.md) | Read Global Center of Mass (LSDyna) by calling the readers defined by the datasources.   ///available inputs: streams_container (StreamsContainer) (optional), data_sources (DataSources), unit_system (Int32, string) (optional)
 |
| [global_energy_ratio](Ans_DataProcesratio.md) | Read Global Energy Ratio (LSDyna) by calling the readers defined by the datasources.   ///available inputs: streams_container (StreamsContainer) (optional), data_sources (DataSources), unit_system (Int32, string) (optional)
 |
...
| [global_internal_enerult_global_internal_energy.md) | Read Global Internal Energy (LSDyna) by calling the readers defined by the datasources.   ///available inputs: streams_container (StreamsContainer) (optional), data_sources (DataSources), unit_system (Int32, string) (optional)
 |
| [global_joint_internal_energy](Anobal_joint_internal_energy.md) | Read Global Joint Internal Energy (LSDyna) by calling the readers defined by the datasources.   ///available inputs: streams_container (StreamsContainer) (optional), data_sources (DataSources), unit_system (Int32, string) (optional)
 |
| [global_kinetic_energy](Alobal_kinetic_energy.md) | Read Global Kinetic Energy (LSDyna) by calling the readers defined by the datasources.   ///available inputs: streams_container (StreamsContainer) (optional), data_sources (DataSources), unit_system (Int32, string) (optional)
 |
...
| [global_system_dampinrs_result_global_system_damping_energy.md) | Read Global System Damping Energy (LSDyna) by calling the readers defined by the datasources.   ///available inputs: streams_container (StreamsContainer) (optional), data_sources (DataSources), unit_system (Int32, string) (optional)
 |
| [global_time_step](Anobal_time_step.md) | Read Global Time Step (LSDyna) by calling the readers defined by the datasources.   ///available inputs: streams_container (StreamsContainer) (optional), data_sources (DataSources), unit_system (Int32, string) (optional)
 |
| [global_total_energy](Ans_Dattotal_energy.md) | Read Global Total Energy (LSDyna) by calling the readers defined by the datasources.   ///available inputs: streams_container (StreamsContainer) (optional), data_sources (DataSources), unit_system (Int32, string) (optional)
 |
| [global_total_mass]_global_total_mass.md) | Read Global Total Mass (LSDyna) by calling the readers defined by the datasources.   ///available inputs: streams_container (StreamsContainer) (optional), data_sources (DataSources), unit_system (Int32, string) (optional)
 |
| [global_velocity](Anobal_velocity.md) | Read Global Velocity (LSDyna) by calling the readers defined by the datasources.   ///available inputs: streams_container (StreamsContainer) (optional), data_sources (DataSources), unit_system (Int32, string) (optional)
 |
| [heat_flux](Ans_Datax.md) | heat_flux()
 |
...
| [initial_coordiresult_initial_coordinates.md) | initial_coordinates()
 |
| [input_sound_power](Ans_DataProcpower.md) | input_sound_power()
 |
| [interface_contact_area](Anterface_contact_area.md) | Read Interface Contact Area (LSDyna) by calling the readers defined by the datasources.   ///available inputs: streams_container (StreamsContainer) (optional), data_sources (DataSources), entity_scoping (Scoping) (optional), unit_system (Int32, string) (optional)
 |
...
| [kinetic_energy](Ans_DataProcessing_operators_result_kinetic_energy.md) | kinetic_energy()
 |
| [layer_orientation_provider](Ans_DataProcessing_operators_result_layer_orientation_provider.md) | Read the layer orientations.   ///available inputs: streams (StreamsContainer) (optional), data_sources (DataSources)
 |
...
| [migrate_to_h5dpf](Ans_DataProcessing_operators_result_migrate_to_h5dpf.md) | Read mesh properties from the results files contained in the streams or data sources and make those properties available through a mesh selection manager in output.User can input a GenericDataContainer that will map an item to a result name. Example of Map: {{ default: wf1}, {EUL: wf2}, {ENG_SE: wf3}}.   ///available inputs: h5_chunk_size (Int32, GenericDataContainer) (optional), dataset_size_compression_threshold (Int32, GenericDataContainer) (optional), h5_native_compression (Int32, DataTree, GenericDataContainer) (optional), export_floats (bool, GenericDataContainer) (optional), filename (string), comma_separated_list_of_results (string) (optional), all_time_sets (bool) (optional), streams_container (StreamsContainer) (optional), data_sources (DataSources) (optional), compression_workflow (Workflow, GenericDataContainer) (optional), filtering_workflow (Workflow, GenericDataContainer) (optional)
 |
| [modal_acceleration](Ans_DataProcessing_operators_result_modal_acceleration.md) | modal_acceleration()
 |
| [modal_basis](Ans_DataProcessing_operators_result_modal_basis.md) | modal_basis()
 |
| [modal_coordinate](Ans_DataProcessing_operators_result_modal_coordinate.md) | modal_coordinate()
 |
| [modal_velocity](Ans_DataProcessing_operators_result_modal_velocity.md) | modal_velocity()
 |
...
| [nodal_force](Ans_DataProcessing_operators_result_nodal_force.md) | nodal_force()
 |
| [nodal_rotation](Ans_DataProcessing_operators_result_nodal_rotation.md) | nodal_rotation()
 |
| [nodal_rotation_X](Ans_DataProcessing_operators_result_nodal_rotation_X.md) | nodal_rotation_X()
 |
| [nodal_rotation_Y](Ans_DataProcessing_operators_result_nodal_rotation_Y.md) | nodal_rotation_Y()
 |
| [nodal_rotation_Z](Ans_DataProcessing_operators_result_nodal_rotation_Z.md) | nodal_rotation_Z()
 |
| [nodal_rotational_acceleration](Ans_DataProcessing_operators_result_nodal_rotational_acceleration.md) | nodal_rotational_acceleration()
 |
| [nodal_rotational_acceleration_X](Ans_DataProcessing_operators_result_nodal_rotational_acceleration_X.md) | nodal_rotational_acceleration_X()
 |
| [nodal_rotational_acceleration_Y](Ans_DataProcessing_operators_result_nodal_rotational_acceleration_Y.md) | nodal_rotational_acceleration_Y()
 |
| [nodal_rotational_acceleration_Z](Ans_DataProcessing_operators_result_nodal_rotational_acceleration_Z.md) | nodal_rotational_acceleration_Z()
 |
| [nodal_rotational_velocity](Ans_DataProcessing_operators_result_nodal_rotational_velocity.md) | nodal_rotational_velocity()
 |
| [nodal_rotational_velocity_X](Ans_DataProcessing_operators_result_nodal_rotational_velocity_X.md) | nodal_rotational_velocity_X()
 |
| [nodal_rotational_velocity_Y](Ans_DataProcessing_operators_result_nodal_rotational_velocity_Y.md) | nodal_rotational_velocity_Y()
 |
| [nodal_rotational_velocity_Z](Ans_DataProcessing_operators_result_nodal_rotational_velocity_Z.md) | nodal_rotational_velocity_Z()
 |
| [nodal_to_global](Ans_DataProcessing_operators_result_nodal_to_global.md) | Rotates nodal elemental results to global coordinate system   ///available inputs: fieldA (Field), fieldB (Field)
 |
| [node_orientations](Ans_DataProcessing_operators_result_node_orientations.md) | node_orientations()
 |
| [node_orientations_X](Ans_DataProcessing_operators_result_node_orientations_X.md) | node_orientations_X()
 |
| [node_orientations_Y](Ans_DataProcessing_operators_result_node_orientations_Y.md) | node_orientations_Y()
 |
| [node_orientations_Z](Ans_DataProcessing_operators_result_node_orientations_Z.md) | node_orientations_Z()
 |
...
| [omega](Ans_DataProcessing_operators_result_omega.md) | omega()
 |
| [output_sound_power](Ans_DataProcessing_operators_result_output_sound_power.md) | output_sound_power()
 |
...
| [read_cms_rbd_file](Ans_DataProcessing_operators_result_read_cms_rbd_file.md) | read_cms_rbd_file()
 |
| [recombine_harmonic_indeces_cyclic](Ans_DataProcessing_operators_result_recombine_harmonic_indeces_cyclic.md) | Add the fields corresponding to different load steps with the same frequencies to compute the response.   ///available inputs: fields_container (FieldsContainer), is_constant (bool) (optional)
 |
...
| [spectrum_data](Ans_DataProcessing_operators_result_spectrum_data.md) | Read spectral data from the result files contained in the streams or data sources.   ///available inputs: streams (StreamsContainer) (optional), data_sources (DataSources)
 |
| [squared_l2norm_pressure](Ans_DataProcessing_operators_result_squared_l2norm_pressure.md) | squared_l2norm_pressure()
 |
...
| [thickness](Ans_DataProcessing_operators_result_thickness.md) | thickness()
 |
| [torque](Ans_DataProcessing_operators_result_torque.md) | Compute torque of a force based on a 3D point.   ///available inputs: fields_container (FieldsContainer), spoint (Field, FieldsContainer)
 |
