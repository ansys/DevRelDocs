...
```python
compute_total_strain_XZ(time_scoping, scoping, streams_container, data_sources, extrapolate, nonlinear, meshed_region, requested_location, displacement, config)
```
