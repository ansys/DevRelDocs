...
| Class | Description |
|-------|-------------|
| [convertnum_bcs_to_nod](convertnum_bcs_to_nod.md) | Converts a fields container from BCS to NOD ordering.   ///available inputs: fields_container (FieldsContainer), data_sources (DataSources)
 |
| [convertnum_nod_variant_convertnum_nod_to_bcs.md) | Converts a fields container from NOD to BCS ordering.   ///available inputs: fields_container (FieldsContainer), data_sources (DataSources)
 |
| [convertnum_op](Annvertnum_op.md) | Converts a fields container from one mapdl ordering to another mapdl ordering. Supported mapdl ordering are BCS=0, FUL=1, NOD=2.   ///available inputs: input_ordering (Int32), output_ordering (Int32), fields_container (FieldsContainer), data_sources (DataSources)
 |
| [eigen_values](Ans_n_values.md) | Computes the element-wise Eigen values of a tensor field.   ///available inputs: field (Field, FieldsContainer)
 |
| [eigen_values_fct_eigen_values_fc.md) | Computes the element-wise Eigen values of all the tensor fields of a fields container.   ///available inputs: fields_container (FieldsContainer)
 |
| [eigen_vectors](Ans_DataPrors.md) | Computes the element-wise Eigen vectors for each tensor in the field.   ///available inputs: field (FieldsContainer, Field)
 |
| [eigen_vectors_fc](Ans_DataPtors_fc.md) | Computes the element-wise Eigen vectors for each tensor in the fields of the field container.   ///available inputs: fields_container (FieldsContainer, Field)
 |
| [invariants](Ans_Daants.md) | Computes the element-wise invariants of a tensor field.   ///available inputs: field (Field)
 |
