...
| Class | Description |
|-------|-------------|
| [csv_to_field](csv_to_field.md) | transform csv file to a field or fields container   ///available inputs: time_scoping (Scoping) (optional), data_sources (DataSources)
 |
| [data_tree_to_json]_data_tree_to_json.md) | Writes a json file or string from a DataTree   ///available inputs: data_tree (DataTree), path (string) (optional)
 |
| [data_tree_to_txt](Ans_Datae_to_txt.md) | Writes a txt file or string from a DataTree   ///available inputs: data_tree (DataTree), path (string) (optional)
 |
| [deserializer](Ans_Datlizer.md) | Takes a file generated by the serializer and deserializes it into DPF's entities.   ///available inputs: stream_type (Int32), file_path (string)
 |
| [export_symbolic_workflow](export_symbolic_workflow.md) | Transforms a Workflow into a symbolic Workflow and writes it to a file (if a path is set in input) or string   ///available inputs: workflow (Workflow), path (string) (optional), format (Int32) (optional), options (Int32) (optional)
 |
| [field_to_csv](Ans_DataProv.md) | Exports a field or a fields container into a csv file   ///available inputs: field_or_fields_container (FieldsContainer, Field), file_path (string), storage_type (Int32) (optional)
 |
| [hdf5dpf_custom_readn_hdf5dpf_custom_read.md) | Extract a custom result from an hdf5dpf file. This operator is deprecated, please use the 'custom' operator instead.   ///available inputs: time_scoping (Scoping) (optional), mesh_scoping (Scoping) (optional), streams (StreamsContainer) (optional), data_sources (DataSources) (optional), meta_data (DataTree) (optional), result_name (object)
 |
| [hdf5dpf_generate_resulization_hdf5dpf_generate_result_file.md) | Generate a dpf result file from provided information.   ///available inputs: h5_chunk_size (Int32) (optional), append_mode (bool) (optional), dataset_size_compression_threshold (Int32) (optional), h5_native_compression (Int32, DataTree) (optional), export_floats (bool) (optional), filename (string), mesh_provider_out (MeshedRegion) (optional), time_freq_support_out (TimeFreqSupport) (optional), ansys_unit_system_id (Int32, ResultInfo) (optional), input_name1 (string, object) (optional), input_name2 (string, object) (optional)
 |
| [import_symbolic_woization_import_symbolic_workflow.md) | Reads a file or string holding a Symbolic Workflow and instantiate a WorkFlow with its data.   ///available inputs: string_or_path (string, DataSources), format (Int32) (optional)
 |
| [json_to_data_trion_json_to_data_tree.md) | Reads a json file or string to a DataTree   ///available inputs: string_or_path (string, DataSources)
 |
| [mechanical_csv_to_field](Ans_Daical_csv_to_field.md) | Reads mechanical exported csv file   ///available inputs: unit (), mesh (MeshedRegion) (optional), data_sources (DataSources), requested_location (string, FieldDefinition)
 |
