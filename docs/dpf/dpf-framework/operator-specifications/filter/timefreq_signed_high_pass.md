...
|------------|------|--------|------------------|
| <strong>0</strong> | [time_freq_support](/docs/dpf/dpf-framework/operator-specifications/filter/timefreq_signed_high_pass) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`time_freq_support`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [threshold](/docs/dpf/dpf-framework/operator-specifications/filter/timefreq_signed_high_pass) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [both](/docs/dpf/dpf-framework/operator-specifications/filter/timefreq_signed_high_pass) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [time_freq_support](/docs/dpf/dpf-framework/operator-specifications/filter/timefreq_signed_high_pass) |[`time_freq_support`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [scoping](/docs/dpf/dpf-framework/operator-specifications/filter/timefreq_signed_high_pass) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
