...
|-------|------|------------------|
|  **0**| [field](/docs/dpf/dpf-framework/operator-specifications/filter/field_low_pass) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
