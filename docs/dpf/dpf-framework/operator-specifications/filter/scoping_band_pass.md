...
|-------|------|------------------|
|  **0**| [scoping](/docs/dpf/dpf-framework/operator-specifications/filter/scoping_band_pass) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
