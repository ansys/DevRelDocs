...
|------------|------|--------|------------------|
| <strong>-1</strong> | [generate_principal_stress](/docs/dpf/dpf-framework/operator-specifications/invariant/invariants) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>0</strong> | [field](/docs/dpf/dpf-framework/operator-specifications/invariant/invariants) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [field_int](/docs/dpf/dpf-framework/operator-specifications/invariant/invariants) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [field_eqv](/docs/dpf/dpf-framework/operator-specifications/invariant/invariants) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **2**| [field_max_shear](/docs/dpf/dpf-framework/operator-specifications/invariant/invariants) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **3**| [field_eig_1](/docs/dpf/dpf-framework/operator-specifications/invariant/invariants) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **4**| [field_eig_2](/docs/dpf/dpf-framework/operator-specifications/invariant/invariants) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **5**| [field_eig_3](/docs/dpf/dpf-framework/operator-specifications/invariant/invariants) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
