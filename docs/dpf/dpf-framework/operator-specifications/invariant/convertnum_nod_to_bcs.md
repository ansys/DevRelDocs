...
|-------|------|------------------|
|  **0**| [fields_container](/docs/dpf/dpf-framework/operator-specifications/invariant/convertnum_nod_to_bcs) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
