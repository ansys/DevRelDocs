...
|------------|------|--------|------------------|
| <strong>0</strong> | [scopingA](/docs/dpf/dpf-framework/operator-specifications/logic/identical_scopings) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [scopingB](/docs/dpf/dpf-framework/operator-specifications/logic/identical_scopings) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [boolean](/docs/dpf/dpf-framework/operator-specifications/logic/identical_scopings) |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [message](/docs/dpf/dpf-framework/operator-specifications/logic/identical_scopings) |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
