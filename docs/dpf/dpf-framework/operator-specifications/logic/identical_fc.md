...
|------------|------|--------|------------------|
| <strong>0</strong> | [fields_containerA](/docs/dpf/dpf-framework/operator-specifications/logic/identical_fc) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [fields_containerB](/docs/dpf/dpf-framework/operator-specifications/logic/identical_fc) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [small_value](/docs/dpf/dpf-framework/operator-specifications/logic/identical_fc) |  |[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [tolerance](/docs/dpf/dpf-framework/operator-specifications/logic/identical_fc) |  |[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [boolean](/docs/dpf/dpf-framework/operator-specifications/logic/identical_fc) |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [message](/docs/dpf/dpf-framework/operator-specifications/logic/identical_fc) |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
