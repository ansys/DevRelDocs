...
|------------|------|--------|------------------|
| <strong>0</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/logic/split_data_sources) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [output_count](/docs/dpf/dpf-framework/operator-specifications/logic/split_data_sources) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **-1**| [output_count](/docs/dpf/dpf-framework/operator-specifications/logic/split_data_sources) |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **0**| [outputs](/docs/dpf/dpf-framework/operator-specifications/logic/split_data_sources) |[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
