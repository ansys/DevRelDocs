...
|------------|------|--------|------------------|
| <strong>0</strong> | [string_fieldA](/docs/dpf/dpf-framework/operator-specifications/logic/identical_string_fields) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`string_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [string_fieldB](/docs/dpf/dpf-framework/operator-specifications/logic/identical_string_fields) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`string_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
