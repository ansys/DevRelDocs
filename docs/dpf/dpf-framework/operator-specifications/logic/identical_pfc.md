...
|------------|------|--------|------------------|
| <strong>0</strong> | [property_fields_containerA](/docs/dpf/dpf-framework/operator-specifications/logic/identical_pfc) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`property_fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [property_fields_containerB](/docs/dpf/dpf-framework/operator-specifications/logic/identical_pfc) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`property_fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [boolean](/docs/dpf/dpf-framework/operator-specifications/logic/identical_pfc) |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [message](/docs/dpf/dpf-framework/operator-specifications/logic/identical_pfc) |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
