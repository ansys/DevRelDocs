...
|------------|------|--------|------------------|
| <strong>0</strong> | [fieldA](/docs/dpf/dpf-framework/operator-specifications/logic/identical_fields) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [fieldB](/docs/dpf/dpf-framework/operator-specifications/logic/identical_fields) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [double_value](/docs/dpf/dpf-framework/operator-specifications/logic/identical_fields) |  |[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [double_tolerance](/docs/dpf/dpf-framework/operator-specifications/logic/identical_fields) |  |[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [boolean](/docs/dpf/dpf-framework/operator-specifications/logic/identical_fields) |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [message](/docs/dpf/dpf-framework/operator-specifications/logic/identical_fields) |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
