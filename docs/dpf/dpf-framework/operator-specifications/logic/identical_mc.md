...
|------------|------|--------|------------------|
| <strong>0</strong> | [meshes_containerA](/docs/dpf/dpf-framework/operator-specifications/logic/identical_mc) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`meshes_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [meshes_containerB](/docs/dpf/dpf-framework/operator-specifications/logic/identical_mc) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`meshes_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [small_value](/docs/dpf/dpf-framework/operator-specifications/logic/identical_mc) |  |[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [tolerance](/docs/dpf/dpf-framework/operator-specifications/logic/identical_mc) |  |[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [compare_auxiliary](/docs/dpf/dpf-framework/operator-specifications/logic/identical_mc) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [boolean](/docs/dpf/dpf-framework/operator-specifications/logic/identical_mc) |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [message](/docs/dpf/dpf-framework/operator-specifications/logic/identical_mc) |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
