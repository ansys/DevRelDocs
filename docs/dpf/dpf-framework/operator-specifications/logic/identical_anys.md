...
|------------|------|--------|------------------|
| <strong>0</strong> | [anyA](/docs/dpf/dpf-framework/operator-specifications/logic/identical_anys) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`any`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [anyB](/docs/dpf/dpf-framework/operator-specifications/logic/identical_anys) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`any`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [double_value](/docs/dpf/dpf-framework/operator-specifications/logic/identical_anys) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [double_tolerance](/docs/dpf/dpf-framework/operator-specifications/logic/identical_anys) |  |[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [compare_auxiliary](/docs/dpf/dpf-framework/operator-specifications/logic/identical_anys) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
- **Required:** Yes
- **Expected type(s):** [`any`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
|-------|------|------------------|
|  **0**| [included](/docs/dpf/dpf-framework/operator-specifications/logic/identical_anys) |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [message](/docs/dpf/dpf-framework/operator-specifications/logic/identical_anys) |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
