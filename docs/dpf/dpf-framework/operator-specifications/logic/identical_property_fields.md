...
|------------|------|--------|------------------|
| <strong>0</strong> | [property_fieldA](/docs/dpf/dpf-framework/operator-specifications/logic/identical_property_fields) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [property_fieldB](/docs/dpf/dpf-framework/operator-specifications/logic/identical_property_fields) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [are_identical](/docs/dpf/dpf-framework/operator-specifications/logic/identical_property_fields) |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [information](/docs/dpf/dpf-framework/operator-specifications/logic/identical_property_fields) |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
