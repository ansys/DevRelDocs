...
|------------|------|--------|------------------|
| <strong>0</strong> | [field](/docs/dpf/dpf-framework/operator-specifications/logic/ascending_sort) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [component_priority_table](/docs/dpf/dpf-framework/operator-specifications/logic/ascending_sort) |  |[`vector&lt;int32&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [sort_by_scoping](/docs/dpf/dpf-framework/operator-specifications/logic/ascending_sort) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [field](/docs/dpf/dpf-framework/operator-specifications/logic/ascending_sort) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
