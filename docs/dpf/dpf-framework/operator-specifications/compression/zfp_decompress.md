...
|------------|------|--------|------------------|
| <strong>0</strong> | [dataIn](/docs/dpf/dpf-framework/operator-specifications/compression/zfp_decompress) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`custom_type_fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [dataOut](/docs/dpf/dpf-framework/operator-specifications/compression/zfp_decompress) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [decompress_speed](/docs/dpf/dpf-framework/operator-specifications/compression/zfp_decompress) |[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
