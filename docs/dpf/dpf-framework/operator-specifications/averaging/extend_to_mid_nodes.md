...
|-------|------|------------------|
|  **0**| [field](/docs/dpf/dpf-framework/operator-specifications/averaging/extend_to_mid_nodes) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
