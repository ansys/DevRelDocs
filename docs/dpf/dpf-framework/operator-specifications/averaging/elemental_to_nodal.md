...
|------------|------|--------|------------------|
| <strong>0</strong> | [field](/docs/dpf/dpf-framework/operator-specifications/averaging/elemental_to_nodal) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [mesh_scoping](/docs/dpf/dpf-framework/operator-specifications/averaging/elemental_to_nodal) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [force_averaging](/docs/dpf/dpf-framework/operator-specifications/averaging/elemental_to_nodal) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>200</strong> | [algorithm](/docs/dpf/dpf-framework/operator-specifications/averaging/elemental_to_nodal) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [field](/docs/dpf/dpf-framework/operator-specifications/averaging/elemental_to_nodal) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
