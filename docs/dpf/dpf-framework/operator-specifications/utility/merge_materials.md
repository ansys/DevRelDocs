...
|------------|------|--------|------------------|
| <strong>0</strong> | [materials](/docs/dpf/dpf-framework/operator-specifications/utility/merge_materials) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|`vector<shared_ptr&lt;materials&gt;>`, `materials` |
...
|-------|------|------------------|
|  **0**| [merged_materials](/docs/dpf/dpf-framework/operator-specifications/utility/merge_materials) |`materials` |
