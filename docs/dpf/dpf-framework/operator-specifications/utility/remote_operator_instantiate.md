...
|------------|------|--------|------------------|
| <strong>0</strong> | [operator_to_send](/docs/dpf/dpf-framework/operator-specifications/utility/remote_operator_instantiate) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [output_pin](/docs/dpf/dpf-framework/operator-specifications/utility/remote_operator_instantiate) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [streams_to_remote](/docs/dpf/dpf-framework/operator-specifications/utility/remote_operator_instantiate) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [data_sources_to_remote](/docs/dpf/dpf-framework/operator-specifications/utility/remote_operator_instantiate) |  |[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>5</strong> | [output_name](/docs/dpf/dpf-framework/operator-specifications/utility/remote_operator_instantiate) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [remote_workflow](/docs/dpf/dpf-framework/operator-specifications/utility/remote_operator_instantiate) |[`workflow`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
