...
|------------|------|--------|------------------|
| <strong>0</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/utility/ds_get_attribute) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [property_name](/docs/dpf/dpf-framework/operator-specifications/utility/ds_get_attribute) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [property_index](/docs/dpf/dpf-framework/operator-specifications/utility/ds_get_attribute) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [property_key](/docs/dpf/dpf-framework/operator-specifications/utility/ds_get_attribute) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [property_result_key](/docs/dpf/dpf-framework/operator-specifications/utility/ds_get_attribute) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [property](/docs/dpf/dpf-framework/operator-specifications/utility/ds_get_attribute) |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
