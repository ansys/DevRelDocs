...
|------------|------|--------|------------------|
| <strong>0</strong> | [time_freq_supports](/docs/dpf/dpf-framework/operator-specifications/utility/merge_time_freq_supports) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|`vector<shared_ptr&lt;time_freq_support&gt;>`, [`time_freq_support`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
- **Required:** Yes
- **Expected type(s):** `vector<shared_ptr&lt;time_freq_support&gt;>`, [`time_freq_support`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
|-------|------|------------------|
|  **0**| [merged_support](/docs/dpf/dpf-framework/operator-specifications/utility/merge_time_freq_supports) |[`time_freq_support`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
