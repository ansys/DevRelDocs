...
|------------|------|--------|------------------|
| <strong>0</strong> | [input_string](/docs/dpf/dpf-framework/operator-specifications/utility/txt_file_to_dpf) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [any_output](/docs/dpf/dpf-framework/operator-specifications/utility/txt_file_to_dpf) | |
