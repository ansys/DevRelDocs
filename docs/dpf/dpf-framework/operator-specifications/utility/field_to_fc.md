...
| <strong>1</strong> | [label](/docs/dpf/dpf-framework/operator-specifications/utility/field_to_fc) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`label_space`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
