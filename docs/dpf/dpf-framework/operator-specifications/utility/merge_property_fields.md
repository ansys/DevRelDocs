...
|------------|------|--------|------------------|
| <strong>-201</strong> | [naive_merge](/docs/dpf/dpf-framework/operator-specifications/utility/merge_property_fields) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>0</strong> | [property_fields](/docs/dpf/dpf-framework/operator-specifications/utility/merge_property_fields) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|`vector<shared_ptr&lt;property_field&gt;>`, [`property_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`property_fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
