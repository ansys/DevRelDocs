...
|------------|------|--------|------------------|
| <strong>0</strong> | [result_infos](/docs/dpf/dpf-framework/operator-specifications/utility/merge_result_infos) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|`vector<shared_ptr&lt;result_info&gt;>`, [`result_info`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
- **Required:** Yes
- **Expected type(s):** `vector<shared_ptr&lt;result_info&gt;>`, [`result_info`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
|-------|------|------------------|
|  **0**| [merged_result_infos](/docs/dpf/dpf-framework/operator-specifications/utility/merge_result_infos) |[`result_info`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
