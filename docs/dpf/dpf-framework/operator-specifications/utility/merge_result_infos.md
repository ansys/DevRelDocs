...
|------------|------|--------|------------------|
| <strong>0</strong> | [result_infos](/docs/dpf/dpf-framework/operator-specifications/utility/merge_result_infos) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|`vector<shared_ptr&lt;result_info&gt;>`, [`result_info`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
