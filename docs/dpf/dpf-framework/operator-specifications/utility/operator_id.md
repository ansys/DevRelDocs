...
|------------|------|--------|------------------|
| <strong>0</strong> | [op](/docs/dpf/dpf-framework/operator-specifications/utility/operator_id) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`operator`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [id](/docs/dpf/dpf-framework/operator-specifications/utility/operator_id) |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
