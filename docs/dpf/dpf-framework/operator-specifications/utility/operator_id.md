...
|------------|------|--------|------------------|
| <strong>0</strong> | [op](/docs/dpf/dpf-framework/operator-specifications/utility/operator_id) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`operator`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
