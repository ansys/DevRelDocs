...
- **Required:** Yes
- **Expected type(s):** [`vector&lt;fields_container&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
|-------|------|------------------|
|  **0**| [merged_collections](/docs/dpf/dpf-framework/operator-specifications/utility/concatenate_fields_containers) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
