...
|------------|------|--------|------------------|
| <strong>0</strong> | [data_tree](/docs/dpf/dpf-framework/operator-specifications/utility/merge_data_tree) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`data_tree`](/docs/dpf/dpf-framework/core-concepts/dpf-types), `vector<shared_ptr&lt;data_tree&gt;>` |
...
- **Required:** Yes
- **Expected type(s):** [`data_tree`](/docs/dpf/dpf-framework/core-concepts/dpf-types), `vector<shared_ptr&lt;data_tree&gt;>`
...
|-------|------|------------------|
|  **0**| [any](/docs/dpf/dpf-framework/operator-specifications/utility/merge_data_tree) |[`any`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
