...
|------------|------|--------|------------------|
| <strong>0</strong> | [custom_type_field](/docs/dpf/dpf-framework/operator-specifications/utility/customtypefield_get_attribute) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`custom_type_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`custom_type_fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [property_name](/docs/dpf/dpf-framework/operator-specifications/utility/customtypefield_get_attribute) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
