...
| <strong>0</strong> | [supports](/docs/dpf/dpf-framework/operator-specifications/utility/merge_supports) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|`vector<shared_ptr&lt;abstract_field_support&gt;>`, `abstract_field_support` |
