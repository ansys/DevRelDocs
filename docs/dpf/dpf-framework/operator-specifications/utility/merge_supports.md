...
|------------|------|--------|------------------|
| <strong>-200</strong> | [should_merge_named_selections](/docs/dpf/dpf-framework/operator-specifications/utility/merge_supports) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>0</strong> | [supports](/docs/dpf/dpf-framework/operator-specifications/utility/merge_supports) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|`vector<shared_ptr&lt;abstract_field_support&gt;>`, `abstract_field_support` |
...
|-------|------|------------------|
|  **0**| [merged_support](/docs/dpf/dpf-framework/operator-specifications/utility/merge_supports) |`abstract_field_support` |
