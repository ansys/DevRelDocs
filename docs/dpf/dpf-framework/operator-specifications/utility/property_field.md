...
|------------|------|--------|------------------|
| <strong>0</strong> | [input](/docs/dpf/dpf-framework/operator-specifications/utility/property_field) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`property_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [incremented_result](/docs/dpf/dpf-framework/operator-specifications/utility/property_field) | |
