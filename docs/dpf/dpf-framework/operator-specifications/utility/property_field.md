...
|------------|------|--------|------------------|
| <strong>0</strong> | [input](/docs/dpf/dpf-framework/operator-specifications/utility/property_field) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`property_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
