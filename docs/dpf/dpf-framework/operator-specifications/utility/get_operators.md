...
|------------|------|--------|------------------|
| <strong>0</strong> | [workflow](/docs/dpf/dpf-framework/operator-specifications/utility/get_operators) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`workflow`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [operators](/docs/dpf/dpf-framework/operator-specifications/utility/get_operators) |[`generic_data_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
