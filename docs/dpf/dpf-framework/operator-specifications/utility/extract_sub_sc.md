...
|------------|------|--------|------------------|
| <strong>0</strong> | [scopings_container](/docs/dpf/dpf-framework/operator-specifications/utility/extract_sub_sc) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`scopings_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [label_space](/docs/dpf/dpf-framework/operator-specifications/utility/extract_sub_sc) |  |[`label_space`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [collapse_labels](/docs/dpf/dpf-framework/operator-specifications/utility/extract_sub_sc) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
- **Required:** No
- **Expected type(s):** [`label_space`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
|-------|------|------------------|
|  **0**| [scopings_container](/docs/dpf/dpf-framework/operator-specifications/utility/extract_sub_sc) |[`scopings_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
