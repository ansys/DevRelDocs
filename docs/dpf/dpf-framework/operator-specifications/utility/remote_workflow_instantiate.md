...
|------------|------|--------|------------------|
| <strong>0</strong> | [workflow_to_send](/docs/dpf/dpf-framework/operator-specifications/utility/remote_workflow_instantiate) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`workflow`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [streams_to_remote](/docs/dpf/dpf-framework/operator-specifications/utility/remote_workflow_instantiate) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
