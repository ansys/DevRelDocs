...
|------------|------|--------|------------------|
| <strong>0</strong> | [operator_name](/docs/dpf/dpf-framework/operator-specifications/utility/operator_changelog) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [changelog_gdc](/docs/dpf/dpf-framework/operator-specifications/utility/operator_changelog) |[`generic_data_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
