...
|-------|------|------------------|
|  **0**| [merged_field_matrix](/docs/dpf/dpf-framework/operator-specifications/utility/merge_to_field_matrix) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
