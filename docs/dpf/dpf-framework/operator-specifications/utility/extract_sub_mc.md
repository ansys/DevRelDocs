...
|------------|------|--------|------------------|
| <strong>0</strong> | [meshes](/docs/dpf/dpf-framework/operator-specifications/utility/extract_sub_mc) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`meshes_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [label_space](/docs/dpf/dpf-framework/operator-specifications/utility/extract_sub_mc) |  |[`label_space`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [collapse_labels](/docs/dpf/dpf-framework/operator-specifications/utility/extract_sub_mc) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [meshes_container](/docs/dpf/dpf-framework/operator-specifications/utility/extract_sub_mc) |[`meshes_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
