...
|------------|------|--------|------------------|
| <strong>0</strong> | [generic_support](/docs/dpf/dpf-framework/operator-specifications/utility/generic_support_get_attribute) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|`class dataProcessing::GenericSupport` |
| <strong>1</strong> | [property_name](/docs/dpf/dpf-framework/operator-specifications/utility/generic_support_get_attribute) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [property](/docs/dpf/dpf-framework/operator-specifications/utility/generic_support_get_attribute) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`property_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`string_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |


<a id="output_0"></a>
### property (Pin 0)

- **Expected type(s):** [`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`property_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`string_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
