...
|------------|------|--------|------------------|
| <strong>0</strong> | [scopings](/docs/dpf/dpf-framework/operator-specifications/utility/merge_scopings) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`scopings_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types), `vector<shared_ptr&lt;scoping&gt;>` |
