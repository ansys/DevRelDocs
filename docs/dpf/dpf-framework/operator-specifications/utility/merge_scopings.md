...
|------------|------|--------|------------------|
| <strong>0</strong> | [scopings](/docs/dpf/dpf-framework/operator-specifications/utility/merge_scopings) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`scopings_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types), `vector<shared_ptr&lt;scoping&gt;>` |
...
- **Required:** Yes
- **Expected type(s):** [`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`scopings_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types), `vector<shared_ptr&lt;scoping&gt;>`
...
|-------|------|------------------|
|  **0**| [merged_scoping](/docs/dpf/dpf-framework/operator-specifications/utility/merge_scopings) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
