...
|------------|------|--------|------------------|
| <strong>-201</strong> | [naive_merge_elements](/docs/dpf/dpf-framework/operator-specifications/utility/merge_meshes) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>-200</strong> | [should_merge_named_selections](/docs/dpf/dpf-framework/operator-specifications/utility/merge_meshes) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>0</strong> | [meshes](/docs/dpf/dpf-framework/operator-specifications/utility/merge_meshes) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|`vector<shared_ptr&lt;abstract_meshed_region&gt;>`, [`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`meshes_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>101</strong> | [merge_method](/docs/dpf/dpf-framework/operator-specifications/utility/merge_meshes) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>102</strong> | [box_size](/docs/dpf/dpf-framework/operator-specifications/utility/merge_meshes) |  |[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>103</strong> | [remove_duplicate_elements](/docs/dpf/dpf-framework/operator-specifications/utility/merge_meshes) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
- **Required:** Yes
- **Expected type(s):** `vector<shared_ptr&lt;abstract_meshed_region&gt;>`, [`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`meshes_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
|-------|------|------------------|
|  **0**| [merges_mesh](/docs/dpf/dpf-framework/operator-specifications/utility/merge_meshes) |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
