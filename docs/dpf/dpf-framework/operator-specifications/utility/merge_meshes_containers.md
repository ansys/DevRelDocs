...
|------------|------|--------|------------------|
| <strong>0</strong> | [meshes_containers](/docs/dpf/dpf-framework/operator-specifications/utility/merge_meshes_containers) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|`vector<shared_ptr&lt;meshes_container&gt;>`, [`meshes_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
