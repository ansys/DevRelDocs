...
|------------|------|--------|------------------|
| <strong>0</strong> | [bogus_input](/docs/dpf/dpf-framework/operator-specifications/info/markdown_latex_example) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [bogus_output](/docs/dpf/dpf-framework/operator-specifications/info/markdown_latex_example) | |
