...
|------------|------|--------|------------------|
| <strong>0</strong> | [real_field](/docs/dpf/dpf-framework/operator-specifications/min_max/max_over_phase) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [imaginary_field](/docs/dpf/dpf-framework/operator-specifications/min_max/max_over_phase) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [abs_value](/docs/dpf/dpf-framework/operator-specifications/min_max/max_over_phase) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [phase_increment](/docs/dpf/dpf-framework/operator-specifications/min_max/max_over_phase) |  |[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [field](/docs/dpf/dpf-framework/operator-specifications/min_max/max_over_phase) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
