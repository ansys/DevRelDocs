...
|------------|------|--------|------------------|
| <strong>0</strong> | [field](/docs/dpf/dpf-framework/operator-specifications/min_max/min_max_inc) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>17</strong> | [domain_id](/docs/dpf/dpf-framework/operator-specifications/min_max/min_max_inc) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [field_min](/docs/dpf/dpf-framework/operator-specifications/min_max/min_max_inc) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [field_max](/docs/dpf/dpf-framework/operator-specifications/min_max/min_max_inc) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **2**| [domain_ids_min](/docs/dpf/dpf-framework/operator-specifications/min_max/min_max_inc) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **3**| [domain_ids_max](/docs/dpf/dpf-framework/operator-specifications/min_max/min_max_inc) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
