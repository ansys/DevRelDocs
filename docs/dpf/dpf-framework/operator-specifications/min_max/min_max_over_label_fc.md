...
|------------|------|--------|------------------|
| <strong>0</strong> | [fields_container](/docs/dpf/dpf-framework/operator-specifications/min_max/min_max_over_label_fc) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [label](/docs/dpf/dpf-framework/operator-specifications/min_max/min_max_over_label_fc) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [field_min](/docs/dpf/dpf-framework/operator-specifications/min_max/min_max_over_label_fc) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [field_max](/docs/dpf/dpf-framework/operator-specifications/min_max/min_max_over_label_fc) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **2**| [domain_ids_min](/docs/dpf/dpf-framework/operator-specifications/min_max/min_max_over_label_fc) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **3**| [domain_ids_max](/docs/dpf/dpf-framework/operator-specifications/min_max/min_max_over_label_fc) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **4**| [scoping_ids_min](/docs/dpf/dpf-framework/operator-specifications/min_max/min_max_over_label_fc) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **5**| [scoping_ids_max](/docs/dpf/dpf-framework/operator-specifications/min_max/min_max_over_label_fc) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
