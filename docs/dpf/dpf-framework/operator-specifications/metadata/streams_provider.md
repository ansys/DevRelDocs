...
|------------|------|--------|------------------|
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/metadata/streams_provider) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [streams_container](/docs/dpf/dpf-framework/operator-specifications/metadata/streams_provider) |[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
