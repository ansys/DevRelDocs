...
|------------|------|--------|------------------|
| <strong>7</strong> | [sector_meshed_region](/docs/dpf/dpf-framework/operator-specifications/metadata/cyclic_mesh_expansion) |  |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`meshes_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>16</strong> | [cyclic_support](/docs/dpf/dpf-framework/operator-specifications/metadata/cyclic_mesh_expansion) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`cyclic_support`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>18</strong> | [sectors_to_expand](/docs/dpf/dpf-framework/operator-specifications/metadata/cyclic_mesh_expansion) |  |[`vector&lt;int32&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`scopings_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [meshed_region](/docs/dpf/dpf-framework/operator-specifications/metadata/cyclic_mesh_expansion) |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [cyclic_support](/docs/dpf/dpf-framework/operator-specifications/metadata/cyclic_mesh_expansion) |[`cyclic_support`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
