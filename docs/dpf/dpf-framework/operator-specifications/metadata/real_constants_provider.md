...
|------------|------|--------|------------------|
| <strong>1</strong> | [solver_real_constants_ids](/docs/dpf/dpf-framework/operator-specifications/metadata/real_constants_provider) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`vector&lt;int32&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [streams](/docs/dpf/dpf-framework/operator-specifications/metadata/real_constants_provider) |  |[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/metadata/real_constants_provider) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [real_constants](/docs/dpf/dpf-framework/operator-specifications/metadata/real_constants_provider) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
