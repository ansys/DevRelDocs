...
|------------|------|--------|------------------|
| <strong>3</strong> | [streams_container](/docs/dpf/dpf-framework/operator-specifications/metadata/result_info_provider) |  |[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/metadata/result_info_provider) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [result_info](/docs/dpf/dpf-framework/operator-specifications/metadata/result_info_provider) |[`result_info`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |


<a id="output_0"></a>
### result_info (Pin 0)

- **Expected type(s):** [`result_info`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
