...
|------------|------|--------|------------------|
| <strong>3</strong> | [streams_container](/docs/dpf/dpf-framework/operator-specifications/metadata/cyclic_support_provider) |  |[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/metadata/cyclic_support_provider) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>7</strong> | [sector_meshed_region](/docs/dpf/dpf-framework/operator-specifications/metadata/cyclic_support_provider) |  |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`meshes_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>15</strong> | [expanded_meshed_region](/docs/dpf/dpf-framework/operator-specifications/metadata/cyclic_support_provider) |  |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`meshes_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>18</strong> | [sectors_to_expand](/docs/dpf/dpf-framework/operator-specifications/metadata/cyclic_support_provider) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`scopings_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`vector&lt;int32&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
- **Required:** No
- **Expected type(s):** [`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`scopings_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`vector&lt;int32&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
|-------|------|------------------|
|  **0**| [cyclic_support](/docs/dpf/dpf-framework/operator-specifications/metadata/cyclic_support_provider) |[`cyclic_support`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [sector_meshes](/docs/dpf/dpf-framework/operator-specifications/metadata/cyclic_support_provider) |[`meshes_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
