...
|------------|------|--------|------------------|
| <strong>1</strong> | [solver_element_types_ids](/docs/dpf/dpf-framework/operator-specifications/metadata/element_types_provider) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`vector&lt;int32&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [streams](/docs/dpf/dpf-framework/operator-specifications/metadata/element_types_provider) |  |[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/metadata/element_types_provider) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>200</strong> | [output_type](/docs/dpf/dpf-framework/operator-specifications/metadata/element_types_provider) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [element_types_data](/docs/dpf/dpf-framework/operator-specifications/metadata/element_types_provider) |[`generic_data_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`property_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |


<a id="output_0"></a>
### element_types_data (Pin 0)

- **Expected type(s):** [`generic_data_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`property_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
