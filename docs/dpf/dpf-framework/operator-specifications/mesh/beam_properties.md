...
|------------|------|--------|------------------|
| <strong>3</strong> | [streams](/docs/dpf/dpf-framework/operator-specifications/mesh/beam_properties) |  |[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/mesh/beam_properties) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [mesh_out](/docs/dpf/dpf-framework/operator-specifications/mesh/beam_properties) |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [field_type_section_id](/docs/dpf/dpf-framework/operator-specifications/mesh/beam_properties) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **2**| [field_area](/docs/dpf/dpf-framework/operator-specifications/mesh/beam_properties) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **3**| [field_moment_inertia](/docs/dpf/dpf-framework/operator-specifications/mesh/beam_properties) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **4**| [field_geometry](/docs/dpf/dpf-framework/operator-specifications/mesh/beam_properties) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **5**| [field_young_modulus](/docs/dpf/dpf-framework/operator-specifications/mesh/beam_properties) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **6**| [field_poisson_ratio](/docs/dpf/dpf-framework/operator-specifications/mesh/beam_properties) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **7**| [field_shear_modulus](/docs/dpf/dpf-framework/operator-specifications/mesh/beam_properties) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **8**| [field_beam_length](/docs/dpf/dpf-framework/operator-specifications/mesh/beam_properties) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **9**| [field_torsion_constant](/docs/dpf/dpf-framework/operator-specifications/mesh/beam_properties) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **10**| [field_warping_constant](/docs/dpf/dpf-framework/operator-specifications/mesh/beam_properties) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **11**| [field_offset_type](/docs/dpf/dpf-framework/operator-specifications/mesh/beam_properties) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **12**| [field_offset_y](/docs/dpf/dpf-framework/operator-specifications/mesh/beam_properties) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **13**| [field_offset_z](/docs/dpf/dpf-framework/operator-specifications/mesh/beam_properties) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
