...
|------------|------|--------|------------------|
| <strong>1</strong> | [mesh_scoping](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_graphics_edges) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>6</strong> | [include_mid_nodes](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_graphics_edges) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>7</strong> | [mesh](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_graphics_edges) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [nodes](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_graphics_edges) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **2**| [connectivity](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_graphics_edges) |[`property_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
