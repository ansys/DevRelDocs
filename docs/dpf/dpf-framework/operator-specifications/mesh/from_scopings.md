...
|------------|------|--------|------------------|
| <strong>1</strong> | [scopings_container](/docs/dpf/dpf-framework/operator-specifications/mesh/from_scopings) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`scopings_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [inclusive](/docs/dpf/dpf-framework/operator-specifications/mesh/from_scopings) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [nodes_only](/docs/dpf/dpf-framework/operator-specifications/mesh/from_scopings) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>7</strong> | [mesh](/docs/dpf/dpf-framework/operator-specifications/mesh/from_scopings) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [meshes](/docs/dpf/dpf-framework/operator-specifications/mesh/from_scopings) |[`meshes_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
