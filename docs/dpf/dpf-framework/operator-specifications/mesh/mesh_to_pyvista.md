...
|------------|------|--------|------------------|
| <strong>2</strong> | [coordinates](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_pyvista) |  |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>6</strong> | [as_linear](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_pyvista) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>7</strong> | [mesh](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_pyvista) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>60</strong> | [vtk_updated](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_pyvista) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>200</strong> | [as_poly](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_pyvista) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [nodes](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_pyvista) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [cells](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_pyvista) |[`vector&lt;int32&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **2**| [cell_types](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_pyvista) |[`vector&lt;int32&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **3**| [offsets](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_pyvista) |[`vector&lt;int32&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
