...
|------------|------|--------|------------------|
| <strong>0</strong> | [mesh](/docs/dpf/dpf-framework/operator-specifications/mesh/decimate_mesh) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [preservation_ratio](/docs/dpf/dpf-framework/operator-specifications/mesh/decimate_mesh) |  |[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [aggressiveness](/docs/dpf/dpf-framework/operator-specifications/mesh/decimate_mesh) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [mesh](/docs/dpf/dpf-framework/operator-specifications/mesh/decimate_mesh) |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
