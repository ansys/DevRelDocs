...
|------------|------|--------|------------------|
| <strong>0</strong> | [mesh](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_tetra) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [mesh](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_tetra) |[`meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [node_mapping](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_tetra) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **2**| [element_mapping](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_tetra) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
