...
|------------|------|--------|------------------|
| <strong>0</strong> | [field](/docs/dpf/dpf-framework/operator-specifications/mesh/iso_surfaces) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [num_surfaces](/docs/dpf/dpf-framework/operator-specifications/mesh/iso_surfaces) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [mesh](/docs/dpf/dpf-framework/operator-specifications/mesh/iso_surfaces) |  |[`meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [slice_surfaces](/docs/dpf/dpf-framework/operator-specifications/mesh/iso_surfaces) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [vector_iso_values](/docs/dpf/dpf-framework/operator-specifications/mesh/iso_surfaces) |  |[`vector&lt;double&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [meshes](/docs/dpf/dpf-framework/operator-specifications/mesh/iso_surfaces) |[`meshes_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [fields_container](/docs/dpf/dpf-framework/operator-specifications/mesh/iso_surfaces) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
