...
|------------|------|--------|------------------|
| <strong>0</strong> | [assembly_mesh](/docs/dpf/dpf-framework/operator-specifications/mesh/acmo_mesh_provider) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|`ans_dispatch_holder`, `struct IAnsDispatch` |
