...
|------------|------|--------|------------------|
| <strong>0</strong> | [assembly_mesh](/docs/dpf/dpf-framework/operator-specifications/mesh/acmo_mesh_provider) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|`ans_dispatch_holder`, `struct IAnsDispatch` |
| <strong>1</strong> | [unit](/docs/dpf/dpf-framework/operator-specifications/mesh/acmo_mesh_provider) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [meshes_container](/docs/dpf/dpf-framework/operator-specifications/mesh/acmo_mesh_provider) |[`meshes_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
