...
|------------|------|--------|------------------|
| <strong>1</strong> | [mesh_scoping](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_graphics) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [node_normals](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_graphics) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>7</strong> | [mesh](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_graphics) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [nodes](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_graphics) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [normals](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_graphics) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **2**| [connectivity](/docs/dpf/dpf-framework/operator-specifications/mesh/mesh_to_graphics) |[`property_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
