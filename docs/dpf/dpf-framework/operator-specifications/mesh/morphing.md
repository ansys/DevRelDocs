...
|------------|------|--------|------------------|
| <strong>0</strong> | [displacement](/docs/dpf/dpf-framework/operator-specifications/mesh/morphing) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [disp_mesh](/docs/dpf/dpf-framework/operator-specifications/mesh/morphing) |  |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [mesh](/docs/dpf/dpf-framework/operator-specifications/mesh/morphing) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [in_place](/docs/dpf/dpf-framework/operator-specifications/mesh/morphing) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [morphing_type](/docs/dpf/dpf-framework/operator-specifications/mesh/morphing) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>5</strong> | [morphing_manager_data](/docs/dpf/dpf-framework/operator-specifications/mesh/morphing) |  | |
| <strong>6</strong> | [sliding_planes](/docs/dpf/dpf-framework/operator-specifications/mesh/morphing) |  |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>7</strong> | [sliding_nodes](/docs/dpf/dpf-framework/operator-specifications/mesh/morphing) |  |[`scopings_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [mesh](/docs/dpf/dpf-framework/operator-specifications/mesh/morphing) |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
