...
|------------|------|--------|------------------|
| <strong>0</strong> | [mesh](/docs/dpf/dpf-framework/operator-specifications/geo/element_nodal_contribution) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [scoping](/docs/dpf/dpf-framework/operator-specifications/geo/element_nodal_contribution) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [volume_fraction](/docs/dpf/dpf-framework/operator-specifications/geo/element_nodal_contribution) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [field](/docs/dpf/dpf-framework/operator-specifications/geo/element_nodal_contribution) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
