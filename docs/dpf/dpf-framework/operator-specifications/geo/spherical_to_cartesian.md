...
|-------|------|------------------|
|  **0**| [field](/docs/dpf/dpf-framework/operator-specifications/geo/spherical_to_cartesian) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
