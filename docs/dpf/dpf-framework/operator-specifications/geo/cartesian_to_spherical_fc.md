...
|-------|------|------------------|
|  **0**| [fields_container](/docs/dpf/dpf-framework/operator-specifications/geo/cartesian_to_spherical_fc) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
