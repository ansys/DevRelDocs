...
|------------|------|--------|------------------|
| <strong>0</strong> | [ip](/docs/dpf/dpf-framework/operator-specifications/server/grpc_start_server) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [port](/docs/dpf/dpf-framework/operator-specifications/server/grpc_start_server) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [starting_option](/docs/dpf/dpf-framework/operator-specifications/server/grpc_start_server) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [should_start_server](/docs/dpf/dpf-framework/operator-specifications/server/grpc_start_server) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/server/grpc_start_server) |  |[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>5</strong> | [dpf_context](/docs/dpf/dpf-framework/operator-specifications/server/grpc_start_server) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>6</strong> | [transport_mode](/docs/dpf/dpf-framework/operator-specifications/server/grpc_start_server) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>7</strong> | [tls_certificates_dir](/docs/dpf/dpf-framework/operator-specifications/server/grpc_start_server) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [grpc_streams](/docs/dpf/dpf-framework/operator-specifications/server/grpc_start_server) |[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
