...
|------------|------|--------|------------------|
| <strong>0</strong> | [source_mesh](/docs/dpf/dpf-framework/operator-specifications/mapping/create_sc_mapping_workflow) |  |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`meshes_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [target_mesh](/docs/dpf/dpf-framework/operator-specifications/mapping/create_sc_mapping_workflow) |  |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`meshes_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [is_conservative](/docs/dpf/dpf-framework/operator-specifications/mapping/create_sc_mapping_workflow) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [location](/docs/dpf/dpf-framework/operator-specifications/mapping/create_sc_mapping_workflow) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [dimensionality](/docs/dpf/dpf-framework/operator-specifications/mapping/create_sc_mapping_workflow) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>5</strong> | [is_pointcloud](/docs/dpf/dpf-framework/operator-specifications/mapping/create_sc_mapping_workflow) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>6</strong> | [target_scoping](/docs/dpf/dpf-framework/operator-specifications/mapping/create_sc_mapping_workflow) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`scopings_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
- **Required:** No
- **Expected type(s):** [`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`meshes_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
|-------|------|------------------|
|  **0**| [mapping_workflow](/docs/dpf/dpf-framework/operator-specifications/mapping/create_sc_mapping_workflow) |[`workflow`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
