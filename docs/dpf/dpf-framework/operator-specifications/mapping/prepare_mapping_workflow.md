...
|-------|------|------------------|
|  **0**| [mapping_workflow](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mapping_workflow) |[`workflow`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
