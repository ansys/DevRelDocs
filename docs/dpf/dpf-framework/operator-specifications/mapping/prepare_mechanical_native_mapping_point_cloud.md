...
|------------|------|--------|------------------|
| <strong>0</strong> | [source_mesh](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [target_mesh](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [target_mesh_scoping](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [unit](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>5</strong> | [location](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>6</strong> | [dimensionality](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>7</strong> | [e_shell_layers](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>8</strong> | [html_report_path](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>9</strong> | [threads_user_requested](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>10</strong> | [weighting_type](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>11</strong> | [outside_option](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>12</strong> | [num_outside_points](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>13</strong> | [max_outside_distance](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>14</strong> | [search_limit](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>15</strong> | [bounding_box_sizing](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>16</strong> | [geometry_type](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>17</strong> | [shell_thickness_factor](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>100</strong> | [is_element_centroidal_data_mapping](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>101</strong> | [projection_options](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`data_tree`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>102</strong> | [dynamic_coordinate_system](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`data_tree`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>103</strong> | [source_dimension](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>104</strong> | [wb_external_data_info](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`data_tree`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>105</strong> | [target_dimension](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [source_mesh](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [source_mesh_id](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **2**| [target_mesh](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **3**| [target_mesh_id](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **4**| [mapping_manager_data](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) | |
|  **6**| [target_scoping](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **7**| [prepare_output](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping_point_cloud) | |
