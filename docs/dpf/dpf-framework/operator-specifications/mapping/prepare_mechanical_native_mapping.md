...
|------------|------|--------|------------------|
| <strong>0</strong> | [source_mesh](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [target_mesh](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [target_mesh_scoping](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>8</strong> | [html_report_path](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>9</strong> | [threads_user_requested](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>30</strong> | [shape_function_volumes_mapping](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |  |[`data_tree`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>31</strong> | [shape_function_surfaces_mapping](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |  |[`data_tree`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>32</strong> | [point_cloud_mapping](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |  |[`data_tree`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>33</strong> | [kriging_mapping](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |  |[`data_tree`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>100</strong> | [is_element_centroidal_data_mapping](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>101</strong> | [projection_options](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |  |[`data_tree`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>102</strong> | [dynamic_coordinate_system](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |  |[`data_tree`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>103</strong> | [source_dimension](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>104</strong> | [wb_external_data_info](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |  |[`data_tree`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>105</strong> | [target_dimension](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [source_mesh](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [source_mesh_id](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **2**| [target_mesh](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **3**| [target_mesh_id](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **4**| [mapping_manager_data](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) | |
|  **6**| [target_scoping](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **7**| [prepare_output](/docs/dpf/dpf-framework/operator-specifications/mapping/prepare_mechanical_native_mapping) | |
