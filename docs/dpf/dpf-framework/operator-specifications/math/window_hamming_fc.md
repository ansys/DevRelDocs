...
|-------|------|------------------|
|  **0**| [fields_container](/docs/dpf/dpf-framework/operator-specifications/math/window_hamming_fc) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
