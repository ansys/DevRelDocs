...
|------------|------|--------|------------------|
| <strong>0</strong> | [fields_container](/docs/dpf/dpf-framework/operator-specifications/math/time_freq_interpolation) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [time_freq_values](/docs/dpf/dpf-framework/operator-specifications/math/time_freq_interpolation) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`vector&lt;double&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [step](/docs/dpf/dpf-framework/operator-specifications/math/time_freq_interpolation) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [interpolation_type](/docs/dpf/dpf-framework/operator-specifications/math/time_freq_interpolation) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [force_new_time_freq_support](/docs/dpf/dpf-framework/operator-specifications/math/time_freq_interpolation) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>8</strong> | [time_freq_support](/docs/dpf/dpf-framework/operator-specifications/math/time_freq_interpolation) |  |[`time_freq_support`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
- **Required:** Yes
- **Expected type(s):** [`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`vector&lt;double&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
|-------|------|------------------|
|  **0**| [fields_container](/docs/dpf/dpf-framework/operator-specifications/math/time_freq_interpolation) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
