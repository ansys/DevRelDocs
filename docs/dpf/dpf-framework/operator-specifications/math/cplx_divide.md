...
|------------|------|--------|------------------|
| <strong>0</strong> | [fields_containerA](/docs/dpf/dpf-framework/operator-specifications/math/cplx_divide) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [fields_containerB](/docs/dpf/dpf-framework/operator-specifications/math/cplx_divide) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
