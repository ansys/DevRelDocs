...
|------------|------|--------|------------------|
| <strong>0</strong> | [field_or_fields_container1](/docs/dpf/dpf-framework/operator-specifications/math/compute_residual_and_error) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [normalization_type](/docs/dpf/dpf-framework/operator-specifications/math/compute_residual_and_error) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [norm_calculation_type](/docs/dpf/dpf-framework/operator-specifications/math/compute_residual_and_error) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [field_reference](/docs/dpf/dpf-framework/operator-specifications/math/compute_residual_and_error) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [field_or_fields_container2](/docs/dpf/dpf-framework/operator-specifications/math/compute_residual_and_error) |  |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [residual](/docs/dpf/dpf-framework/operator-specifications/math/compute_residual_and_error) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [error](/docs/dpf/dpf-framework/operator-specifications/math/compute_residual_and_error) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **2**| [residual_normalization_factor](/docs/dpf/dpf-framework/operator-specifications/math/compute_residual_and_error) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **3**| [error_normalization_factor](/docs/dpf/dpf-framework/operator-specifications/math/compute_residual_and_error) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
