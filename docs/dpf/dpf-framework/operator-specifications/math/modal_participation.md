...
|------------|------|--------|------------------|
| <strong>0</strong> | [v_real](/docs/dpf/dpf-framework/operator-specifications/math/modal_participation) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [v_imag](/docs/dpf/dpf-framework/operator-specifications/math/modal_participation) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [mode_shapes](/docs/dpf/dpf-framework/operator-specifications/math/modal_participation) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [ponderation](/docs/dpf/dpf-framework/operator-specifications/math/modal_participation) |  |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [force_label_space](/docs/dpf/dpf-framework/operator-specifications/math/modal_participation) |  |[`label_space`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [output](/docs/dpf/dpf-framework/operator-specifications/math/modal_participation) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
