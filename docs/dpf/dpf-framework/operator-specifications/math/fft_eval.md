...
|------------|------|--------|------------------|
| <strong>0</strong> | [field_t](/docs/dpf/dpf-framework/operator-specifications/math/fft_eval) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [time_scoping](/docs/dpf/dpf-framework/operator-specifications/math/fft_eval) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [field](/docs/dpf/dpf-framework/operator-specifications/math/fft_eval) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **2**| [offset](/docs/dpf/dpf-framework/operator-specifications/math/fft_eval) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
