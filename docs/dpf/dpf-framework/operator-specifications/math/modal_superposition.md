...
|------------|------|--------|------------------|
| <strong>0</strong> | [modal_basis](/docs/dpf/dpf-framework/operator-specifications/math/modal_superposition) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [solution_in_modal_space](/docs/dpf/dpf-framework/operator-specifications/math/modal_superposition) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [incremental_fc](/docs/dpf/dpf-framework/operator-specifications/math/modal_superposition) |  |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [time_scoping](/docs/dpf/dpf-framework/operator-specifications/math/modal_superposition) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`vector&lt;int32&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [mesh_scoping](/docs/dpf/dpf-framework/operator-specifications/math/modal_superposition) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`scopings_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [fields_container](/docs/dpf/dpf-framework/operator-specifications/math/modal_superposition) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
