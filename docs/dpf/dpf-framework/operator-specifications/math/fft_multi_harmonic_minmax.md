...
|------------|------|--------|------------------|
| <strong>0</strong> | [fields_container](/docs/dpf/dpf-framework/operator-specifications/math/fft_multi_harmonic_minmax) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [rpm_scoping](/docs/dpf/dpf-framework/operator-specifications/math/fft_multi_harmonic_minmax) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [fs_ratio](/docs/dpf/dpf-framework/operator-specifications/math/fft_multi_harmonic_minmax) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [num_subdivisions](/docs/dpf/dpf-framework/operator-specifications/math/fft_multi_harmonic_minmax) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [max_num_subdivisions](/docs/dpf/dpf-framework/operator-specifications/math/fft_multi_harmonic_minmax) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>5</strong> | [num_cycles](/docs/dpf/dpf-framework/operator-specifications/math/fft_multi_harmonic_minmax) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>6</strong> | [use_harmonic_zero](/docs/dpf/dpf-framework/operator-specifications/math/fft_multi_harmonic_minmax) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>7</strong> | [calculate_time_series](/docs/dpf/dpf-framework/operator-specifications/math/fft_multi_harmonic_minmax) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>8</strong> | [substeps_selector](/docs/dpf/dpf-framework/operator-specifications/math/fft_multi_harmonic_minmax) |  |[`vector&lt;int32&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [field_min](/docs/dpf/dpf-framework/operator-specifications/math/fft_multi_harmonic_minmax) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [field_max](/docs/dpf/dpf-framework/operator-specifications/math/fft_multi_harmonic_minmax) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **2**| [all_fields](/docs/dpf/dpf-framework/operator-specifications/math/fft_multi_harmonic_minmax) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
