...
|------------|------|--------|------------------|
| <strong>0</strong> | [string_or_path](/docs/dpf/dpf-framework/operator-specifications/serialization/import_symbolic_workflow) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [format](/docs/dpf/dpf-framework/operator-specifications/serialization/import_symbolic_workflow) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
- **Required:** Yes
- **Expected type(s):** [`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
|-------|------|------------------|
|  **0**| [workflow](/docs/dpf/dpf-framework/operator-specifications/serialization/import_symbolic_workflow) |[`workflow`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
