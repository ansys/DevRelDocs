...
|------------|------|--------|------------------|
| <strong>0</strong> | [string_or_path](/docs/dpf/dpf-framework/operator-specifications/serialization/json_to_data_tree) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
