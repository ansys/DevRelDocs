...
|-------|------|------------------|
|  **0**| [workflow_topology](/docs/dpf/dpf-framework/operator-specifications/serialization/workflow_to_workflow_topology) |[`generic_data_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
