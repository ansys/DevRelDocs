...
|------------|------|--------|------------------|
| <strong>-1</strong> | [stream_type](/docs/dpf/dpf-framework/operator-specifications/serialization/serializer_to_string) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [any_input](/docs/dpf/dpf-framework/operator-specifications/serialization/serializer_to_string) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`any`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **-1**| [nof_chunks](/docs/dpf/dpf-framework/operator-specifications/serialization/serializer_to_string) |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **0**| [serialized_string](/docs/dpf/dpf-framework/operator-specifications/serialization/serializer_to_string) |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
