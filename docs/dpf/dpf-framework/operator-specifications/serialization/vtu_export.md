...
|------------|------|--------|------------------|
| <strong>0</strong> | [directory](/docs/dpf/dpf-framework/operator-specifications/serialization/vtu_export) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
| <strong>2</strong> | [mesh](/docs/dpf/dpf-framework/operator-specifications/serialization/vtu_export) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [fields](/docs/dpf/dpf-framework/operator-specifications/serialization/vtu_export) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`property_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
