...
|------------|------|--------|------------------|
| <strong>0</strong> | [workflow](/docs/dpf/dpf-framework/operator-specifications/serialization/workflow_to_pydpf) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`workflow`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
