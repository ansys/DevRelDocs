...
|------------|------|--------|------------------|
| <strong>0</strong> | [workflow](/docs/dpf/dpf-framework/operator-specifications/serialization/workflow_to_pydpf) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`workflow`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [output_path](/docs/dpf/dpf-framework/operator-specifications/serialization/workflow_to_pydpf) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [pydpf_code](/docs/dpf/dpf-framework/operator-specifications/serialization/workflow_to_pydpf) |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
