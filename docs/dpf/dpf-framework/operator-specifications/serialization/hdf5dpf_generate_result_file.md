...
|------------|------|--------|------------------|
| <strong>-7</strong> | [h5_chunk_size](/docs/dpf/dpf-framework/operator-specifications/serialization/hdf5dpf_generate_result_file) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>-6</strong> | [append_mode](/docs/dpf/dpf-framework/operator-specifications/serialization/hdf5dpf_generate_result_file) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>-5</strong> | [dataset_size_compression_threshold](/docs/dpf/dpf-framework/operator-specifications/serialization/hdf5dpf_generate_result_file) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>-2</strong> | [h5_native_compression](/docs/dpf/dpf-framework/operator-specifications/serialization/hdf5dpf_generate_result_file) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`abstract_data_tree`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>-1</strong> | [export_floats](/docs/dpf/dpf-framework/operator-specifications/serialization/hdf5dpf_generate_result_file) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>0</strong> | [filename](/docs/dpf/dpf-framework/operator-specifications/serialization/hdf5dpf_generate_result_file) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [mesh_provider_out](/docs/dpf/dpf-framework/operator-specifications/serialization/hdf5dpf_generate_result_file) |  |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [time_freq_support_out](/docs/dpf/dpf-framework/operator-specifications/serialization/hdf5dpf_generate_result_file) |  |[`time_freq_support`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [ansys_unit_system_id](/docs/dpf/dpf-framework/operator-specifications/serialization/hdf5dpf_generate_result_file) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`result_info`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [input_name](/docs/dpf/dpf-framework/operator-specifications/serialization/hdf5dpf_generate_result_file) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`any`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
- **Required:** No
- **Expected type(s):** [`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`abstract_data_tree`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
- **Required:** No
- **Expected type(s):** [`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`result_info`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
- **Required:** No
- **Expected type(s):** [`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`any`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
|-------|------|------------------|
|  **0**| [data_sources](/docs/dpf/dpf-framework/operator-specifications/serialization/hdf5dpf_generate_result_file) |[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
### [evaluate_inputs_before_run](/docs/dpf/dpf-framework/core-concepts/operator-configurations)
