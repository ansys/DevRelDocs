...
|------------|------|--------|------------------|
| <strong>0</strong> | [time_scoping](/docs/dpf/dpf-framework/operator-specifications/serialization/migrate_to_vtu) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`vector&lt;int32&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [streams_container](/docs/dpf/dpf-framework/operator-specifications/serialization/migrate_to_vtu) |  |[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/serialization/migrate_to_vtu) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>20</strong> | [directory](/docs/dpf/dpf-framework/operator-specifications/serialization/migrate_to_vtu) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>21</strong> | [base_name](/docs/dpf/dpf-framework/operator-specifications/serialization/migrate_to_vtu) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>30</strong> | [result](/docs/dpf/dpf-framework/operator-specifications/serialization/migrate_to_vtu) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>100</strong> | [write_mode](/docs/dpf/dpf-framework/operator-specifications/serialization/migrate_to_vtu) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [path](/docs/dpf/dpf-framework/operator-specifications/serialization/migrate_to_vtu) |[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
