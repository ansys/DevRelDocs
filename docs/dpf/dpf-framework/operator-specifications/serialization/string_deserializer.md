...
|------------|------|--------|------------------|
| <strong>-1</strong> | [stream_type](/docs/dpf/dpf-framework/operator-specifications/serialization/string_deserializer) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>0</strong> | [serialized_string](/docs/dpf/dpf-framework/operator-specifications/serialization/string_deserializer) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **1**| [any_output](/docs/dpf/dpf-framework/operator-specifications/serialization/string_deserializer) |[`any`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
