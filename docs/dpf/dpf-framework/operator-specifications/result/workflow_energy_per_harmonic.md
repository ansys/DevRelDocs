...
|------------|------|--------|------------------|
| <strong>0</strong> | [time_scoping](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_harmonic) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [mesh_scoping](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_harmonic) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [energy_type](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_harmonic) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [stream](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_harmonic) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|`stream` |
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_harmonic) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [harmonic_energy](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_harmonic) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [harmonic_energy_percentage](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_harmonic) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
