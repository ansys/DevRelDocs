...
|------------|------|--------|------------------|
| <strong>3</strong> | [streams](/docs/dpf/dpf-framework/operator-specifications/result/spectrum_data) |  |[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/result/spectrum_data) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [participation_factors](/docs/dpf/dpf-framework/operator-specifications/result/spectrum_data) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [mode_coefficients](/docs/dpf/dpf-framework/operator-specifications/result/spectrum_data) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **2**| [damping_ratios](/docs/dpf/dpf-framework/operator-specifications/result/spectrum_data) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **3**| [global_damping](/docs/dpf/dpf-framework/operator-specifications/result/spectrum_data) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **4**| [missing_mass](/docs/dpf/dpf-framework/operator-specifications/result/spectrum_data) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **5**| [rigid_response](/docs/dpf/dpf-framework/operator-specifications/result/spectrum_data) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
