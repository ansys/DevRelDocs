...
|------------|------|--------|------------------|
| <strong>2</strong> | [fields_container](/docs/dpf/dpf-framework/operator-specifications/result/plastic_strain_rotation_by_euler_nodes) |  |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [streams_container](/docs/dpf/dpf-framework/operator-specifications/result/plastic_strain_rotation_by_euler_nodes) |  |[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types), `stream`, `class dataProcessing::CRstFileWrapper` |
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/result/plastic_strain_rotation_by_euler_nodes) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [fields_container](/docs/dpf/dpf-framework/operator-specifications/result/plastic_strain_rotation_by_euler_nodes) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
