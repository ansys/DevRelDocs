...
| <strong>5</strong> | [nod](/docs/dpf/dpf-framework/operator-specifications/result/compute_invariant_terms_motion) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`vector&lt;int32&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
