...
|------------|------|--------|------------------|
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/result/cms_subfile_info_provider) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>200</strong> | [cms_subfile_data](/docs/dpf/dpf-framework/operator-specifications/result/cms_subfile_info_provider) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>300</strong> | [output_maxdof_on_masternodes](/docs/dpf/dpf-framework/operator-specifications/result/cms_subfile_info_provider) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [int32](/docs/dpf/dpf-framework/operator-specifications/result/cms_subfile_info_provider) |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [field](/docs/dpf/dpf-framework/operator-specifications/result/cms_subfile_info_provider) |[`property_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
