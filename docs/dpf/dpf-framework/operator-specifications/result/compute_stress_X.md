...
|------------|------|--------|------------------|
| <strong>1</strong> | [scoping](/docs/dpf/dpf-framework/operator-specifications/result/compute_stress_X) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [streams_container](/docs/dpf/dpf-framework/operator-specifications/result/compute_stress_X) |  |[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/result/compute_stress_X) |  |[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>9</strong> | [requested_location](/docs/dpf/dpf-framework/operator-specifications/result/compute_stress_X) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>10</strong> | [strain](/docs/dpf/dpf-framework/operator-specifications/result/compute_stress_X) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [fields_container](/docs/dpf/dpf-framework/operator-specifications/result/compute_stress_X) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
