...
|------------|------|--------|------------------|
| <strong>0</strong> | [properties_name](/docs/dpf/dpf-framework/operator-specifications/result/mapdl_section) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`vector&lt;string&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [section](/docs/dpf/dpf-framework/operator-specifications/result/mapdl_section) |  |[`property_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [streams_container](/docs/dpf/dpf-framework/operator-specifications/result/mapdl_section) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/result/mapdl_section) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>5</strong> | [layer_property](/docs/dpf/dpf-framework/operator-specifications/result/mapdl_section) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>6</strong> | [layers_requested](/docs/dpf/dpf-framework/operator-specifications/result/mapdl_section) |  |[`vector&lt;int32&gt;`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [properties_value](/docs/dpf/dpf-framework/operator-specifications/result/mapdl_section) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [layers_per_section](/docs/dpf/dpf-framework/operator-specifications/result/mapdl_section) |[`property_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
