...
|------------|------|--------|------------------|
| <strong>0</strong> | [fields_container](/docs/dpf/dpf-framework/operator-specifications/result/remove_rigid_body_motion_fc) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [reference_node_id](/docs/dpf/dpf-framework/operator-specifications/result/remove_rigid_body_motion_fc) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>7</strong> | [mesh](/docs/dpf/dpf-framework/operator-specifications/result/remove_rigid_body_motion_fc) |  |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [fields_container](/docs/dpf/dpf-framework/operator-specifications/result/remove_rigid_body_motion_fc) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [translation_field](/docs/dpf/dpf-framework/operator-specifications/result/remove_rigid_body_motion_fc) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **2**| [rotation_field](/docs/dpf/dpf-framework/operator-specifications/result/remove_rigid_body_motion_fc) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **3**| [center_field](/docs/dpf/dpf-framework/operator-specifications/result/remove_rigid_body_motion_fc) |[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
