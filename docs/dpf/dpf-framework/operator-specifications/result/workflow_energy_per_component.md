...
|------------|------|--------|------------------|
| <strong>0</strong> | [time_scoping](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_component) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [mesh_scoping](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_component) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`scopings_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [energy_type](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_component) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [streams_container](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_component) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_component) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>5</strong> | [named_selection](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_component) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [component_energy](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_component) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [component_energy_percentage](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_component) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **2**| [component_total_energy](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_component) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **3**| [component_total_energy_percentage](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_component) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **4**| [component_strain_energy](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_component) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **5**| [component_strain_energy_percentage](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_component) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **6**| [component_kinetic_energy](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_component) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **7**| [component_kinetic_energy_percentage](/docs/dpf/dpf-framework/operator-specifications/result/workflow_energy_per_component) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
