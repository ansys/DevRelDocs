...
|------------|------|--------|------------------|
| <strong>3</strong> | [streams_container](/docs/dpf/dpf-framework/operator-specifications/result/interface_contact_mass) |  |[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/result/interface_contact_mass) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>6</strong> | [entity_scoping](/docs/dpf/dpf-framework/operator-specifications/result/interface_contact_mass) |  |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>50</strong> | [unit_system](/docs/dpf/dpf-framework/operator-specifications/result/interface_contact_mass) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types), `class dataProcessing::unit::CUnitSystem` |
...
|-------|------|------------------|
|  **0**| [fields_container](/docs/dpf/dpf-framework/operator-specifications/result/interface_contact_mass) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
