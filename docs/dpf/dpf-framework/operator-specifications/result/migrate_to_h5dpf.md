...
|------------|------|--------|------------------|
| <strong>-7</strong> | [h5_chunk_size](/docs/dpf/dpf-framework/operator-specifications/result/migrate_to_h5dpf) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`generic_data_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>-5</strong> | [dataset_size_compression_threshold](/docs/dpf/dpf-framework/operator-specifications/result/migrate_to_h5dpf) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`generic_data_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>-2</strong> | [h5_native_compression](/docs/dpf/dpf-framework/operator-specifications/result/migrate_to_h5dpf) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`abstract_data_tree`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`generic_data_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>-1</strong> | [export_floats](/docs/dpf/dpf-framework/operator-specifications/result/migrate_to_h5dpf) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`generic_data_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>0</strong> | [filename](/docs/dpf/dpf-framework/operator-specifications/result/migrate_to_h5dpf) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [comma_separated_list_of_results](/docs/dpf/dpf-framework/operator-specifications/result/migrate_to_h5dpf) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [all_time_sets](/docs/dpf/dpf-framework/operator-specifications/result/migrate_to_h5dpf) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [streams_container](/docs/dpf/dpf-framework/operator-specifications/result/migrate_to_h5dpf) |  |[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/result/migrate_to_h5dpf) |  |[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>6</strong> | [compression_workflow](/docs/dpf/dpf-framework/operator-specifications/result/migrate_to_h5dpf) |  |[`workflow`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`generic_data_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>7</strong> | [filtering_workflow](/docs/dpf/dpf-framework/operator-specifications/result/migrate_to_h5dpf) |  |[`workflow`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`generic_data_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
- **Required:** No
- **Expected type(s):** [`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`generic_data_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
- **Required:** No
- **Expected type(s):** [`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`abstract_data_tree`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`generic_data_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
- **Required:** No
- **Expected type(s):** [`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`generic_data_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
- **Required:** No
- **Expected type(s):** [`workflow`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`generic_data_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
|-------|------|------------------|
|  **0**| [migrated_file](/docs/dpf/dpf-framework/operator-specifications/result/migrate_to_h5dpf) |[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
