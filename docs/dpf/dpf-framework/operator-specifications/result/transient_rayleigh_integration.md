...
| <strong>6</strong> | [speed_of_sound](/docs/dpf/dpf-framework/operator-specifications/result/transient_rayleigh_integration) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`double`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [fields_container](/docs/dpf/dpf-framework/operator-specifications/result/transient_rayleigh_integration) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
