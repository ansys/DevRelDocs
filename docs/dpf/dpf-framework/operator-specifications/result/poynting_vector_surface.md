...
|------------|------|--------|------------------|
| <strong>0</strong> | [fields_containerA](/docs/dpf/dpf-framework/operator-specifications/result/poynting_vector_surface) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [fields_containerB](/docs/dpf/dpf-framework/operator-specifications/result/poynting_vector_surface) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [fields_containerC](/docs/dpf/dpf-framework/operator-specifications/result/poynting_vector_surface) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [fields_containerD](/docs/dpf/dpf-framework/operator-specifications/result/poynting_vector_surface) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [abstract_meshed_region](/docs/dpf/dpf-framework/operator-specifications/result/poynting_vector_surface) |  |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>5</strong> | [int32](/docs/dpf/dpf-framework/operator-specifications/result/poynting_vector_surface) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [fields_container](/docs/dpf/dpf-framework/operator-specifications/result/poynting_vector_surface) |[`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
