...
|------------|------|--------|------------------|
| <strong>0</strong> | [displacement_field](/docs/dpf/dpf-framework/operator-specifications/result/add_rigid_body_motion) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [translation_field](/docs/dpf/dpf-framework/operator-specifications/result/add_rigid_body_motion) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [rotation_field](/docs/dpf/dpf-framework/operator-specifications/result/add_rigid_body_motion) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [center_field](/docs/dpf/dpf-framework/operator-specifications/result/add_rigid_body_motion) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
