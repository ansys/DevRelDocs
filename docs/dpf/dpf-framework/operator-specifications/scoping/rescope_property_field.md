...
|------------|------|--------|------------------|
| <strong>0</strong> | [fields](/docs/dpf/dpf-framework/operator-specifications/scoping/rescope_property_field) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`property_fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types), [`property_field`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
