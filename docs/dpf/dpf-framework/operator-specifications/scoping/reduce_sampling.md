...
|------------|------|--------|------------------|
| <strong>0</strong> | [mesh_scoping](/docs/dpf/dpf-framework/operator-specifications/scoping/reduce_sampling) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [denominator](/docs/dpf/dpf-framework/operator-specifications/scoping/reduce_sampling) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [mesh_scoping](/docs/dpf/dpf-framework/operator-specifications/scoping/reduce_sampling) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
