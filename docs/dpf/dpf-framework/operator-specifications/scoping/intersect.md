...
|------------|------|--------|------------------|
| <strong>0</strong> | [scopingA](/docs/dpf/dpf-framework/operator-specifications/scoping/intersect) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [scopingB](/docs/dpf/dpf-framework/operator-specifications/scoping/intersect) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
