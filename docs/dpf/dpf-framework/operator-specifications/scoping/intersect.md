...
|------------|------|--------|------------------|
| <strong>0</strong> | [scopingA](/docs/dpf/dpf-framework/operator-specifications/scoping/intersect) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [scopingB](/docs/dpf/dpf-framework/operator-specifications/scoping/intersect) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [intersection](/docs/dpf/dpf-framework/operator-specifications/scoping/intersect) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [scopingA_min_intersection](/docs/dpf/dpf-framework/operator-specifications/scoping/intersect) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
