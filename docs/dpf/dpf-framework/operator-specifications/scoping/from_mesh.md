...
|------------|------|--------|------------------|
| <strong>0</strong> | [mesh](/docs/dpf/dpf-framework/operator-specifications/scoping/from_mesh) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [requested_location](/docs/dpf/dpf-framework/operator-specifications/scoping/from_mesh) |  |[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [scoping](/docs/dpf/dpf-framework/operator-specifications/scoping/from_mesh) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
