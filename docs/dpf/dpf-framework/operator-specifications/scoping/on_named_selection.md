...
|------------|------|--------|------------------|
| <strong>0</strong> | [requested_location](/docs/dpf/dpf-framework/operator-specifications/scoping/on_named_selection) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>1</strong> | [named_selection_name](/docs/dpf/dpf-framework/operator-specifications/scoping/on_named_selection) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>2</strong> | [int_inclusive](/docs/dpf/dpf-framework/operator-specifications/scoping/on_named_selection) |  |[`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>3</strong> | [streams_container](/docs/dpf/dpf-framework/operator-specifications/scoping/on_named_selection) |  |[`streams_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/operator-specifications/scoping/on_named_selection) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [mesh_scoping](/docs/dpf/dpf-framework/operator-specifications/scoping/on_named_selection) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
