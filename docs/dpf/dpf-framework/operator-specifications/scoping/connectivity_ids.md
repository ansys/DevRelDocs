...
|------------|------|--------|------------------|
| <strong>1</strong> | [mesh_scoping](/docs/dpf/dpf-framework/operator-specifications/scoping/connectivity_ids) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>7</strong> | [mesh](/docs/dpf/dpf-framework/operator-specifications/scoping/connectivity_ids) |  |[`abstract_meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| <strong>10</strong> | [take_mid_nodes](/docs/dpf/dpf-framework/operator-specifications/scoping/connectivity_ids) |  |[`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [mesh_scoping](/docs/dpf/dpf-framework/operator-specifications/scoping/connectivity_ids) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
|  **1**| [elemental_scoping](/docs/dpf/dpf-framework/operator-specifications/scoping/connectivity_ids) |[`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
