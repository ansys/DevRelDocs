...
2. **Download the files** by typing:
   ...
   ```powershell
   git sparse-checkout add 2027R1/dpf-framework-27-r1
   cd 2027R1/dpf-framework-27-r1
   ```
...
You need to install the DPF server software. Select the installation method that best fits your setup. For detailed instructions, see [Installation](/docs/dpf/dpf-framework/versions/2026.R1.SP00/getting-started/installation).
...
2. **Set your license server** by typing:
   ...
   **What these do:** Configure DPF to work with your license and permissions. See [Licensing](/docs/dpf/dpf-framework/versions/2026.R1.SP00/getting-started/licensing) section for more information.
...
Refer to the previous main section [Create your DPF Framework HTML documentation](/docs/dpf/dpf-framework/versions/2026.R1.SP00/user-guide/dpf-docs-local-preview) and **Step 3: Generate a local website** to update the HTML documentation with the new content for DPF operators.
