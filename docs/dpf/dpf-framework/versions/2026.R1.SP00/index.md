...
See [`Installation`](/docs/dpf/dpf-framework/versions/2026.R1.SP00/getting-started/installation) in the Getting started for more information.
...
- HGP documentation (C++):
  ...
  - [DPF C++ Client library](https://developer.ansys.com/docs/dpf-cpp-client-library-2027-r1/index.xhtml) in the Developer Portal documentation for DPF.
...
- Mechanical scripting (IronPython):
  ...
  - [Data Processing Framework](https://ansyshelp.ansys.com/account/secured?returnurl=/Views/Secured/corp/v271/en/act_script/mech_apis_data_process_frame.html)
    in the *Scripting in Mechanical Guide*.

  - [Python Result](https://ansyshelp.ansys.com/account/secured?returnurl=/Views/Secured/corp/v271/en/wb_sim/ds_python_result_dpf.html)
