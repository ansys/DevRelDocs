...
|------------|------|--------|------------------|
| <strong>0</strong> | [input_string](/docs/dpf/dpf-framework/versions/2026.R1.SP00/operator-specifications/utility/txt_file_to_dpf) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`string`](/docs/dpf/dpf-framework/versions/2026.R1.SP00/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [any_output](/docs/dpf/dpf-framework/versions/2026.R1.SP00/operator-specifications/utility/txt_file_to_dpf) | |
