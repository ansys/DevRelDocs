...
|------------|------|--------|------------------|
| <strong>0</strong> | [MaterialContainer](/docs/dpf/dpf-framework/versions/2026.R1.SP00/operator-specifications/logic/enrich_materials) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>| |
| <strong>1</strong> | [streams](/docs/dpf/dpf-framework/versions/2026.R1.SP00/operator-specifications/logic/enrich_materials) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`streams_container`](/docs/dpf/dpf-framework/versions/2026.R1.SP00/core-concepts/dpf-types), [`fields_container`](/docs/dpf/dpf-framework/versions/2026.R1.SP00/core-concepts/dpf-types) |
| <strong>2</strong> | [streams_mapping](/docs/dpf/dpf-framework/versions/2026.R1.SP00/operator-specifications/logic/enrich_materials) |  <span style={{backgroundColor:"#d93025",color:"white",padding:"2px 6px",borderRadius:"3px",fontSize:"0.75em"}} title="This pin is required">Required</span>|[`property_fields_container`](/docs/dpf/dpf-framework/versions/2026.R1.SP00/core-concepts/dpf-types) |
