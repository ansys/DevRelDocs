...
|------------|------|--------|------------------|
| <strong>0</strong> | [anyA](/docs/dpf/dpf-framework/versions/2026.R1.SP00/operator-specifications/logic/identical_anys) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`any`](/docs/dpf/dpf-framework/versions/2026.R1.SP00/core-concepts/dpf-types) |
