...
As detailed in [Licensing](/docs/dpf/dpf-framework/versions/2026.R1.SP00/getting-started/licensing), a standalone DPF Server is protected using the license terms specified in the
...
To use [licensed DPF capabilities](/docs/dpf/dpf-framework/versions/2026.R1.SP00/getting-started/licensing) you must set the
**ANSYSLMD_LICENSE_FILE** environment variable to point to a valid local or remote license
following indications in [Configure licensing](/docs/dpf/dpf-framework/versions/2026.R1.SP00/getting-started/licensing).
