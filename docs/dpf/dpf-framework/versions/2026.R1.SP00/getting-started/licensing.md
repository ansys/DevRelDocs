...
You can also [configure a DPF installation](/docs/dpf/dpf-framework/versions/2026.R1.SP00/getting-started/configuration) to mark explicit acceptance for every session.
...
To change this behavior, see [here](/docs/dpf/dpf-framework/versions/2026.R1.SP00/getting-started/licensing).

To know if operators require a license increment checkout to run, check their **license**
attribute in the [Operator specifications reference](/docs/dpf/dpf-framework/versions/2026.R1.SP00/operator-specifications/operator-specifications).

To check which Ansys licensing increments correspond to **any_dpf_supported_increments**,
see [Compatible Ansys license increments](/docs/dpf/dpf-framework/versions/2026.R1.SP00/getting-started/licensing).
...
<a id="server-context"></a>

### Server context

You can allow or prevent licensed operators from running and using a license with a
[server context](/docs/dpf/dpf-framework/versions/2026.R1.SP00/user-guide/server-context)
...
- Starting a standalone DPF Server may fail due to the
  **DPF Preview License Agreement** (see [here](/docs/dpf/dpf-framework/versions/2026.R1.SP00/getting-started/licensing)).
- Creating an operator may fail if the operator performs data transformation and no license server
  or license file is found (see [here](/docs/dpf/dpf-framework/versions/2026.R1.SP00/getting-started/licensing)).
- Running an operator requiring a license checkout may fail if no
  [compatible license increment](/docs/dpf/dpf-framework/versions/2026.R1.SP00/getting-started/licensing) is available or if the DPF Server context is **Entry**, 
  preventing any license check-out (see [here](/docs/dpf/dpf-framework/versions/2026.R1.SP00/getting-started/licensing)).
