...
|  **1**| [mapping_warning_codes](#output_1) |[`int32`](../../core-concepts/dpf-types.md#standard-types) |
...
<a id="output_1"></a>
### mapping_warning_codes (Pin 1)

- **Expected type(s):** [`int32`](../../core-concepts/dpf-types.md#standard-types)

contains the warning codes from the mapping manager kernel
...
int my_mapping_warning_codes = op.getOutput<int>(1);
```
</details>
...
my_mapping_warning_codes = op.outputs.mapping_warning_codes()
```
</details>
...
my_mapping_warning_codes = op.outputs.mapping_warning_codes.GetData()
```
</details>
<br>
