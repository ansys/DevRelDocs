...
| <strong>10</strong> | [samples_limit](#input_10) |  |[`int32`](../../core-concepts/dpf-types.md#standard-types) |
| <strong>11</strong> | [correlation_function_type](#input_11) |  |[`string`](../../core-concepts/dpf-types.md#standard-types) |
| <strong>12</strong> | [polynomial_type](#input_12) |  |[`string`](../../core-concepts/dpf-types.md#standard-types) |
| <strong>13</strong> | [outside_distance_checking](#input_13) |  |[`bool`](../../core-concepts/dpf-types.md#standard-types) |
| <strong>14</strong> | [bounding_box_tolerance](#input_14) |  |[`double`](../../core-concepts/dpf-types.md#standard-types) |
| <strong>15</strong> | [adaptive_tolerance_percent](#input_15) |  |[`double`](../../core-concepts/dpf-types.md#standard-types) |
...
|  **7**| [unmapped_nodes_scoping](#output_7) |[`scoping`](../../core-concepts/dpf-types.md#scoping) |
|  **8**| [outside_nodes_scoping](#output_8) |[`scoping`](../../core-concepts/dpf-types.md#scoping) |
|  **9**| [mapping_error_codes](#output_9) |[`int32`](../../core-concepts/dpf-types.md#standard-types) |
...
<a id="output_7"></a>
### unmapped_nodes_scoping (Pin 7)

- **Expected type(s):** [`scoping`](../../core-concepts/dpf-types.md#scoping)

Unmapped nodes scoping

<a id="output_8"></a>
### outside_nodes_scoping (Pin 8)

- **Expected type(s):** [`scoping`](../../core-concepts/dpf-types.md#scoping)

Outside nodes scoping

<a id="output_9"></a>
### mapping_error_codes (Pin 9)

- **Expected type(s):** [`int32`](../../core-concepts/dpf-types.md#standard-types)

contains the error codes from the mapping manager kernel
...
ansys::dpf::Scoping my_unmapped_nodes_scoping = op.getOutput<ansys::dpf::Scoping>(7);
ansys::dpf::Scoping my_outside_nodes_scoping = op.getOutput<ansys::dpf::Scoping>(8);
int my_mapping_error_codes = op.getOutput<int>(9);
```
</details>
...
my_unmapped_nodes_scoping = op.outputs.unmapped_nodes_scoping()
my_outside_nodes_scoping = op.outputs.outside_nodes_scoping()
my_mapping_error_codes = op.outputs.mapping_error_codes()
```
</details>
...
my_unmapped_nodes_scoping = op.outputs.unmapped_nodes_scoping.GetData()
my_outside_nodes_scoping = op.outputs.outside_nodes_scoping.GetData()
my_mapping_error_codes = op.outputs.mapping_error_codes.GetData()
```
</details>
<br>
