...
|------------|------|--------|------------------|
| <strong>0</strong> | [input](#input_0) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`property_field`](../../core-concepts/dpf-types.md#property-field) |
...
op = dpf.operators.utility.incremental::merge::property_field() # operator instantiation
