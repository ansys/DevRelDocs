...
| <strong>Pin 2</strong>|  recording_type |[`string`](../../core-concepts/dpf-types.md#standard-types) | Recording system used to measure the input signal (supported values: 'Mic', 'Head'. 'Mic' stands for Single microphone, 'Head' stands for Head and torso simulator). Default: 'Mic'. |
