...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  surface_shape |[`string`](../../core-concepts/dpf-types.md#standard-types) | Shape of the measurement surface. Supported values are: 'Hemisphere', 'Half-hemisphere'. |
