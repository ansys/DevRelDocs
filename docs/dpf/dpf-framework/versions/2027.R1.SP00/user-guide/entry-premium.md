...
Refer to the [Using DPF capabilities in an existing project](use-dpf-in-existing.md) section to learn more about the use the LibraryHandle to use DPF capabilities.
