 ...
 **Scripting name**: flow_rate

 **Full name**: result.flow_rate

 **Internal name**: FlowRate
...
ansys::dpf::Operator op("FlowRate"); // operator instantiation
...
op = dpf.operators.result.flow_rate() # operator instantiation
