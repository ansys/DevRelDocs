 ...
 **Scripting name**: reaction_moment_X

 **Full name**: result.reaction_moment_X

 **Internal name**: RF_MomentX
...
ansys::dpf::Operator op("RF_MomentX"); // operator instantiation
...
op = dpf.operators.result.reaction_moment_X() # operator instantiation
