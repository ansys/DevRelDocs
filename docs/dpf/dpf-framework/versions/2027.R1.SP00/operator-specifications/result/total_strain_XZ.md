 ...
 **Scripting name**: total_strain_XZ

 **Full name**: result.total_strain_XZ
...
ansys::dpf::Operator op("ELXZ"); // operator instantiation
...
op = dpf.operators.result.total_strain_XZ() # operator instantiation
