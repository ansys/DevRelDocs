 ...
 **Scripting name**: total_strain_max_shear

 **Full name**: result.total_strain_max_shear

 **Internal name**: EL_max_shear
...
ansys::dpf::Operator op("EL_max_shear"); // operator instantiation
...
op = dpf.operators.result.total_strain_max_shear() # operator instantiation
