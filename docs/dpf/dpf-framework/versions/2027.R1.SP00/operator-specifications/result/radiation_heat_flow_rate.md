...
# result:radiation heat flow rate
 ...
 **Scripting name**: radiation_heat_flow_rate

 **Full name**: result.radiation_heat_flow_rate

 **Internal name**: RadiationHeatFlowRate
...
ansys::dpf::Operator op("RadiationHeatFlowRate"); // operator instantiation
...
op = dpf.operators.result.radiation_heat_flow_rate() # operator instantiation
