 ...
 **Scripting name**: prandtl_number

 **Full name**: result.prandtl_number

 **Internal name**: PrandtlNumber
...
ansys::dpf::Operator op("PrandtlNumber"); // operator instantiation
...
op = dpf.operators.result.prandtl_number() # operator instantiation
