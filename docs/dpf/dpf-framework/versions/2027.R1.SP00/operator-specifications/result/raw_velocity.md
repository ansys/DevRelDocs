 ...
 **Scripting name**: raw_velocity

 **Full name**: result.raw_velocity
...
ansys::dpf::Operator op("VTOT"); // operator instantiation
...
op = dpf.operators.result.raw_velocity() # operator instantiation
