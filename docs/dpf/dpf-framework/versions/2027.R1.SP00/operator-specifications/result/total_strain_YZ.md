 ...
 **Scripting name**: total_strain_YZ

 **Full name**: result.total_strain_YZ
...
ansys::dpf::Operator op("ELYZ"); // operator instantiation
...
op = dpf.operators.result.total_strain_YZ() # operator instantiation
