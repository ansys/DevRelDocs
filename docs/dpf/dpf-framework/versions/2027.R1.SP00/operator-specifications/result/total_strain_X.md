 ...
 **Scripting name**: total_strain_X

 **Full name**: result.total_strain_X
...
ansys::dpf::Operator op("ELX"); // operator instantiation
...
op = dpf.operators.result.total_strain_X() # operator instantiation
