 ...
 **Scripting name**: average_velocity

 **Full name**: result.average_velocity
...
ansys::dpf::Operator op("Veloc"); // operator instantiation
...
op = dpf.operators.result.average_velocity() # operator instantiation
