...
# result:contact element heat flow
 ...
 **Scripting name**: contact_element_heat_flow

 **Full name**: result.contact_element_heat_flow

 **Internal name**: ContactElementHeatFlow
...
ansys::dpf::Operator op("ContactElementHeatFlow"); // operator instantiation
...
op = dpf.operators.result.contact_element_heat_flow() # operator instantiation
