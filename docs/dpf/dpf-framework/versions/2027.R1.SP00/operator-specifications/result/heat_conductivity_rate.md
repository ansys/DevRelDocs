 ...
 **Scripting name**: heat_conductivity_rate

 **Full name**: result.heat_conductivity_rate

 **Internal name**: HeatConductivityRate
...
ansys::dpf::Operator op("HeatConductivityRate"); // operator instantiation
...
op = dpf.operators.result.heat_conductivity_rate() # operator instantiation
