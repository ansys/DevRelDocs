...
# result:total strain principal 3
 ...
 **Scripting name**: total_strain_principal_3

 **Full name**: result.total_strain_principal_3
...
ansys::dpf::Operator op("EL3"); // operator instantiation
...
op = dpf.operators.result.total_strain_principal_3() # operator instantiation
