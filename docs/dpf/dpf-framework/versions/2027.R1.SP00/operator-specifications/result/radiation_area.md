 ...
 **Scripting name**: radiation_area

 **Full name**: result.radiation_area

 **Internal name**: RadiationArea
...
ansys::dpf::Operator op("RadiationArea"); // operator instantiation
...
op = dpf.operators.result.radiation_area() # operator instantiation
