...
# result:total strain principal 1
 ...
 **Scripting name**: total_strain_principal_1

 **Full name**: result.total_strain_principal_1
...
ansys::dpf::Operator op("EL1"); // operator instantiation
...
op = dpf.operators.result.total_strain_principal_1() # operator instantiation
