...
# result:net radiation heat flux
 ...
 **Scripting name**: net_radiation_heat_flux

 **Full name**: result.net_radiation_heat_flux

 **Internal name**: NetRadiationHeatFlux
...
ansys::dpf::Operator op("NetRadiationHeatFlux"); // operator instantiation
...
op = dpf.operators.result.net_radiation_heat_flux() # operator instantiation
