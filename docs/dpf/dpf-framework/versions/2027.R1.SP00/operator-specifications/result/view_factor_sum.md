 ...
 **Scripting name**: view_factor_sum

 **Full name**: result.view_factor_sum

 **Internal name**: ViewFactorSum
...
ansys::dpf::Operator op("ViewFactorSum"); // operator instantiation
...
op = dpf.operators.result.view_factor_sum() # operator instantiation
