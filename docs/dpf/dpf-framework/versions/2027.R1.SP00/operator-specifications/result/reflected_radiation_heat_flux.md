...
# result:reflected radiation heat flux
 ...
 **Scripting name**: reflected_radiation_heat_flux

 **Full name**: result.reflected_radiation_heat_flux

 **Internal name**: ReflectedRadiationHeatFlux
...
ansys::dpf::Operator op("ReflectedRadiationHeatFlux"); // operator instantiation
...
op = dpf.operators.result.reflected_radiation_heat_flux() # operator instantiation
