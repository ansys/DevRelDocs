 ...
 **Scripting name**: total_strain_intensity

 **Full name**: result.total_strain_intensity

 **Internal name**: EL_intensity
...
ansys::dpf::Operator op("EL_intensity"); // operator instantiation
...
op = dpf.operators.result.total_strain_intensity() # operator instantiation
