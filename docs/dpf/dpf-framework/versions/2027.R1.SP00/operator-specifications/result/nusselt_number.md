 ...
 **Scripting name**: nusselt_number

 **Full name**: result.nusselt_number

 **Internal name**: NusseltNumber
...
ansys::dpf::Operator op("NusseltNumber"); // operator instantiation
...
op = dpf.operators.result.nusselt_number() # operator instantiation
