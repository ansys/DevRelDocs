...
# result:total strain principal 2
 ...
 **Scripting name**: total_strain_principal_2

 **Full name**: result.total_strain_principal_2
...
ansys::dpf::Operator op("EL2"); // operator instantiation
...
op = dpf.operators.result.total_strain_principal_2() # operator instantiation
