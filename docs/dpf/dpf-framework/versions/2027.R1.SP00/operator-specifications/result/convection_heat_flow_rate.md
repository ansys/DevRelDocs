...
# result:convection heat flow rate
 ...
 **Scripting name**: convection_heat_flow_rate

 **Full name**: result.convection_heat_flow_rate

 **Internal name**: ConvectionHeatFlowRate
...
ansys::dpf::Operator op("ConvectionHeatFlowRate"); // operator instantiation
...
op = dpf.operators.result.convection_heat_flow_rate() # operator instantiation
