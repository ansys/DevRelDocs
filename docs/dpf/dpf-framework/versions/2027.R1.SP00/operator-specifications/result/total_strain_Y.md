 ...
 **Scripting name**: total_strain_Y

 **Full name**: result.total_strain_Y
...
ansys::dpf::Operator op("ELY"); // operator instantiation
...
op = dpf.operators.result.total_strain_Y() # operator instantiation
