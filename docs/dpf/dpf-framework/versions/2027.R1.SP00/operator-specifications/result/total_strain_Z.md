 ...
 **Scripting name**: total_strain_Z

 **Full name**: result.total_strain_Z
...
ansys::dpf::Operator op("ELZ"); // operator instantiation
...
op = dpf.operators.result.total_strain_Z() # operator instantiation
