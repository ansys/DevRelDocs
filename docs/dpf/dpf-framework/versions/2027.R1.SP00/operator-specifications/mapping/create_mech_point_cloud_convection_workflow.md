...
# mapping:create mechanical native mapping for point cloud convection workflow
...
|------------|------|--------|------------------|
| <strong>0</strong> | [source_mesh](#input_0) |  |[`abstract_meshed_region`](../../core-concepts/dpf-types.md#meshed-region), [`field`](../../core-concepts/dpf-types.md#field) |
 ...
 **Scripting name**: create_mech_point_cloud_convection_workflow

 **Full name**: mapping.create_mech_point_cloud_convection_workflow

 **Internal name**: mech_point_cloud_secondary_wf
...
ansys::dpf::Operator op("mech_point_cloud_secondary_wf"); // operator instantiation
...
op = dpf.operators.mapping.create_mech_point_cloud_convection_workflow() # operator instantiation
