...
# mapping:create mechanical native mapping for shape functions surfaces convection workflow
 ...
 **Scripting name**: create_mech_shape_func_surf_convection_workflow

 **Full name**: mapping.create_mech_shape_func_surf_convection_workflow

 **Internal name**: mech_shape_function_surf_secondary_wf
...
ansys::dpf::Operator op("mech_shape_function_surf_secondary_wf"); // operator instantiation
...
op = dpf.operators.mapping.create_mech_shape_func_surf_convection_workflow() # operator instantiation
