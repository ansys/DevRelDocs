...
|------------|------|--------|------------------|
| <strong>3</strong> | [streams_container](/docs/dpf/dpf-framework/versions/2027.R1.SP01/operator-specifications/metadata/mesh_selection_manager_provider) |  |[`streams_container`](/docs/dpf/dpf-framework/versions/2027.R1.SP01/core-concepts/dpf-types) |
| <strong>4</strong> | [data_sources](/docs/dpf/dpf-framework/versions/2027.R1.SP01/operator-specifications/metadata/mesh_selection_manager_provider) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`data_sources`](/docs/dpf/dpf-framework/versions/2027.R1.SP01/core-concepts/dpf-types) |
...
|-------|------|------------------|
|  **0**| [mesh_selection_manager](/docs/dpf/dpf-framework/versions/2027.R1.SP01/operator-specifications/metadata/mesh_selection_manager_provider) |`mesh_selection_manager` |
