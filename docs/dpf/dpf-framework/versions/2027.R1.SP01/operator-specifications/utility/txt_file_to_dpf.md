...
|-------|------|------------------|
|  **0**| [any_output](/docs/dpf/dpf-framework/versions/2027.R1.SP01/operator-specifications/utility/txt_file_to_dpf) | |
