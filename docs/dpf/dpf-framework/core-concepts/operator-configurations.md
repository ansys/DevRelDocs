...
The following are all the currently existing configurations. Not all operators support every configuration - refer to the individual [operator specification](/docs/dpf/dpf-framework/operator-specifications/operator-specifications) page to see which configurations are available for a specific operator.
...
**Type:** [`bool`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
**Type:** [`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
**Type:** `enum dataProcessing::EBinaryOperation`, [`int32`](/docs/dpf/dpf-framework/core-concepts/dpf-types)
...
- [Operator fundamentals](/docs/dpf/dpf-framework/core-concepts/operator)
- [Operator specifications](/docs/dpf/dpf-framework/operator-specifications/operator-specifications)
- [Available types](/docs/dpf/dpf-framework/core-concepts/dpf-types)
