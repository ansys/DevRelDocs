...
| `scoping` | Entity IDs with data | [`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| `unit` | Measurement unit | `str` |
| `shell_layers` | Shell layer configuration | `enum` |
| `field_definition` | Aggregated metadata | [`field_definition`](/docs/dpf/dpf-framework/core-concepts/dpf-types) |
| `data` | Raw data array | `array of double` |

## Related types

Fields are often used in combination with:
- [`fields_container`](/docs/dpf/dpf-framework/core-concepts/dpf-types): Collection of fields indexed by labels (time, frequency, etc.)
- [`meshed_region`](/docs/dpf/dpf-framework/core-concepts/dpf-types): Support for spatial fields
- [`time_freq_support`](/docs/dpf/dpf-framework/core-concepts/dpf-types): Support for temporal/frequency fields
- [`scoping`](/docs/dpf/dpf-framework/core-concepts/dpf-types): Entity selection mechanism
