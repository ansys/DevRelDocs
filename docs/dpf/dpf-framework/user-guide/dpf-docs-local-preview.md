...
You need to install the DPF server software. Select the installation method that best fits your setup. For detailed instructions, see [Installation](/docs/dpf/dpf-framework/getting-started/installation).
...
2. **Set your license server** by typing:
   ...
   **What these do:** Configure DPF to work with your license and permissions. See [Licensing](/docs/dpf/dpf-framework/getting-started/licensing) section for more information.
...
Refer to the previous main section [Create your DPF Framework HTML documentation](/docs/dpf/dpf-framework/user-guide/dpf-docs-local-preview) and **Step 3: Generate a local website** to update the HTML documentation with the new content for DPF operators.
