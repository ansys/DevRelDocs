...
Each container will store a vector with the defined data type.
For example, a ScopingsContainer will store a vector of Scopings.
...
See the Field section to learn how to access the Field's data.
