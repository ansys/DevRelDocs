...
The following sections are summaries. For more detailed content, see [Ways of Using DPF](user-guide/ways-of-using.md).

#### Operators

Most of the DPF capabilities can be accessed using the operators.

For a list of DPF existing operators, see [Operators](operators.md).
