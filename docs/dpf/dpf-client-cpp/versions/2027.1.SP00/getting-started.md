...
> **New to DPF?** If you are new to the Data Processing Framework and prefer a guided, step-by-step learning path, consider starting with [DPF Onboarding](https://developer.ansys.com/docs/dpf-onboarding-2027-271-substring-2-1/index.md) which covers foundational concepts before diving into the C++ API.

> **_NOTE:_**
> This documentation focuses on the C++ API for DPF.
>
> Check the [DPF Framework documentation](https://developer.ansys.com/docs/dpf-framework-2027-271-substring-2-1/index.md) to learn more about DPF and its capabilities.
>
