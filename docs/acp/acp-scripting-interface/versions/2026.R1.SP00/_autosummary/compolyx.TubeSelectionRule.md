...
Represents a tube selection rule.

### Attributes

| Name | Description |
|---------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| [`TubeSelectionRule.active`](compolyx.TubeSelectionRule.active.md#compolyx.TubeSelectionRule.active)                                              | Active status of the object.                                                            |
| [`TubeSelectionRule.changed`](compolyx.TubeSelectionRule.changed.md#compolyx.TubeSelectionRule.changed)                                           | Triggers an observable to dispatch a change notification.                                    |
...
| [`TubeSelectionRule.enabled`](compolyx.TubeSelectionRule.enabled.md#compolyx.TubeSelectionRule.enabled)                                           | Indicates whether the object is enabled.                                   |
...
| [`TubeSelectionRule.id`](compolyx.TubeSelectionRule.id.md#compolyx.TubeSelectionRule.id)                                                          | ID of the object.                                                                       |
...
| [`TubeSelectionRule.is_dict_item`](compolyx.TubeSelectionRule.is_dict_item.md#compolyx.TubeSelectionRule.is_dict_item)                            | Indicates whether the object is an item in a dictionary.                                   |
| [`TubeSelectionRule.is_list_item`](compolyx.TubeSelectionRule.is_list_item.md#compolyx.TubeSelectionRule.is_list_item)                            | Indicates whether the object is an item of a list.                                   |
...
| [`TubeSelectionRule.name`](compolyx.TubeSelectionRule.name.md#compolyx.TubeSelectionRule.name)                                                    | Name of the object.                                                                     |
...
| [`TubeSelectionRule.parent`](compolyx.TubeSelectionRule.parent.md#compolyx.TubeSelectionRule.parent)                                              | Parent object in the tree.                                                              |
...
| [`TubeSelectionRule.tail_extension`](compolyx.TubeSelectionRule.tail_extension.md#compolyx.TubeSelectionRule.tail_extension)                      | Specifies the length of the extension at the tail of the tube.                 |
| [`TubeSelectionRule.uid`](compolyx.TubeSelectionRule.uid.md#compolyx.TubeSelectionRule.uid)                                                       | UID of the object.                                                                      |
| [`TubeSelectionRule.vertex`](compolyx.TubeSelectionRule.vertex.md#compolyx.TubeSelectionRule.vertex)                                              | Raises an error if the object has been removed from the graph.            |

### Methods

| Name | Description |
|-----------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------|
| [`TubeSelectionRule.find_parent`](compolyx.TubeSelectionRule.find_parent.md#compolyx.TubeSelectionRule.find_parent)(type)                           | Steps up the tree and returns the first parent with given type.                                                     |
...
| [`TubeSelectionRule.obj_exists`](compolyx.TubeSelectionRule.obj_exists.md#compolyx.TubeSelectionRule.obj_exists)()                                  | Checks if \_\_obj still references the c++ object (has not been reset to None by self._delete) and exists in the graph. |
...
| [`TubeSelectionRule.serialize_name_and_id`](compolyx.TubeSelectionRule.serialize_name_and_id.md#compolyx.TubeSelectionRule.serialize_name_and_id)() | Serializes the name and ID.                                                                                    |
