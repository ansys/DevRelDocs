...
| Name | Description |
|------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| [`EdgeSet.active`](compolyx.EdgeSet.active.md#compolyx.EdgeSet.active)                         | Active status of the object.                                                            |
...
| [`EdgeSet.enabled`](compolyx.EdgeSet.enabled.md#compolyx.EdgeSet.enabled)                      | Indicates whether the object is enabled.                                   |
| [`EdgeSet.id`](compolyx.EdgeSet.id.md#compolyx.EdgeSet.id)                                     | ID of the object.                                                                       |
| [`EdgeSet.is_closed`](compolyx.EdgeSet.is_closed.md#compolyx.EdgeSet.is_closed)                | Edge Set is closed.                                                                |
| [`EdgeSet.is_dict_item`](compolyx.EdgeSet.is_dict_item.md#compolyx.EdgeSet.is_dict_item)       | Indicates whether the object is an item in a dictionary.                                   |
| [`EdgeSet.is_list_item`](compolyx.EdgeSet.is_list_item.md#compolyx.EdgeSet.is_list_item)       | Indicates whether the object is an item of a list.                                   |
...
| [`EdgeSet.uid`](compolyx.EdgeSet.uid.md#compolyx.EdgeSet.uid)                                  | UID of the object.                                                                      |
| [`EdgeSet.vertex`](compolyx.EdgeSet.vertex.md#compolyx.EdgeSet.vertex)                         | Raises an error if the object has been removed from the graph.            |
...
| [`EdgeSet.obj_exists`](compolyx.EdgeSet.obj_exists.md#compolyx.EdgeSet.obj_exists)()                                             | Checks if \_\_obj still references the c++ object (has not been reset to None by self._delete) and exists in the graph. |
| [`EdgeSet.serialize`](compolyx.EdgeSet.serialize.md#compolyx.EdgeSet.serialize)()                                                | Serialize to Python string.                                                                                                  |
| [`EdgeSet.serialize_name_and_id`](compolyx.EdgeSet.serialize_name_and_id.md#compolyx.EdgeSet.serialize_name_and_id)()            | Serializes the name and ID.                                                                                    |
