...
| Name | Description |
|------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| [`Stackup.active`](compolyx.Stackup.active.md#compolyx.Stackup.active)                                                             | Active status of the object.                                                            |
...
| [`Stackup.cut_off_material_handling`](compolyx.Stackup.cut_off_material_handling.md#compolyx.Stackup.cut_off_material_handling)    | Defines how cut‑off material is used in cut‑off areas of this stackup.       |
...
| [`Stackup.enabled`](compolyx.Stackup.enabled.md#compolyx.Stackup.enabled)                                                          | Indicates whether the object is enabled.                                   |
...
| [`Stackup.id`](compolyx.Stackup.id.md#compolyx.Stackup.id)                                                                         | ID of the object.                                                                       |
| [`Stackup.is_dict_item`](compolyx.Stackup.is_dict_item.md#compolyx.Stackup.is_dict_item)                                           | Indicates whether the object is an item in a dictionary.                                   |
| [`Stackup.is_list_item`](compolyx.Stackup.is_list_item.md#compolyx.Stackup.is_list_item)                                           | Indicates whether the object is an item of a list.                                   |
...
| [`Stackup.name`](compolyx.Stackup.name.md#compolyx.Stackup.name)                                                                   | Name of the object.                                                                     |
| [`Stackup.parent`](compolyx.Stackup.parent.md#compolyx.Stackup.parent)                                                             | Parent object in the tree.                                                              |
...
| [`Stackup.uid`](compolyx.Stackup.uid.md#compolyx.Stackup.uid)                                                                      | UID of the object.                                                                      |
| [`Stackup.vertex`](compolyx.Stackup.vertex.md#compolyx.Stackup.vertex)                                                             | Raises an error if the object has been removed from the graph.            |
...
| [`Stackup.find_parent`](compolyx.Stackup.find_parent.md#compolyx.Stackup.find_parent)(type)                                       | Steps up the tree and returns the first parent with given type.                                                     |
...
| [`Stackup.obj_exists`](compolyx.Stackup.obj_exists.md#compolyx.Stackup.obj_exists)()                                              | Checks if \_\_obj still references the c++ object (has not been reset to None by self._delete) and exists in the graph. |
...
| [`Stackup.serialize_name_and_id`](compolyx.Stackup.serialize_name_and_id.md#compolyx.Stackup.serialize_name_and_id)()             | Serializes the name and ID.                                                                                    |
