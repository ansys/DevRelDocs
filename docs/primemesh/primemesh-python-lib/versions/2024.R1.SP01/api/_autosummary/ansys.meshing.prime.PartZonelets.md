...
| [`PartZonelets.print_default`](ansys.meshing.prime.PartZonelets.print_default.md#ansys.meshing.prime.PartZonelets.print_default)()         | Print the default values of PartZonelets.   |
|--------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|
| [`PartZonelets.set_default`](ansys.meshing.prime.PartZonelets.set_default.md#ansys.meshing.prime.PartZonelets.set_default)([part_id, ...]) | Set the default values of PartZonelets.     |
