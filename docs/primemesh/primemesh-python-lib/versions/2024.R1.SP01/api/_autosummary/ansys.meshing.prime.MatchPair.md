...
| [`MatchPair.print_default`](ansys.meshing.prime.MatchPair.print_default.md#ansys.meshing.prime.MatchPair.print_default())                 | Print the default values of MatchPair.   |
|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|
| [`MatchPair.set_default`](ansys.meshing.prime.MatchPair.set_default.md#ansys.meshing.prime.MatchPair.set_default)([source_surfaces, ...]) | Set the default values of MatchPair.     |
