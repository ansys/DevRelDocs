...
| [`SurfaceMeshSizeScaling.print_default`](ansys.meshing.prime.SurfaceMeshSizeScaling.print_default.md#ansys.meshing.prime.SurfaceMeshSizeScaling.print_default)()        | Print the default values of SurfaceMeshSizeScaling.   |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------|
| [`SurfaceMeshSizeScaling.set_default`](ansys.meshing.prime.SurfaceMeshSizeScaling.set_default.md#ansys.meshing.prime.SurfaceMeshSizeScaling.set_default)([factor, ...]) | Set the default values of SurfaceMeshSizeScaling.     |
