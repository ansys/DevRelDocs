...
| [`ScaffolderMergeResults.print_default`](ansys.meshing.prime.ScaffolderMergeResults.print_default.md#ansys.meshing.prime.ScaffolderMergeResults.print_default)()   | Print the default values of ScaffolderMergeResults.   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------|
| [`ScaffolderMergeResults.set_default`](ansys.meshing.prime.ScaffolderMergeResults.set_default.md#ansys.meshing.prime.ScaffolderMergeResults.set_default)([...])    | Set the default values of ScaffolderMergeResults.     |
