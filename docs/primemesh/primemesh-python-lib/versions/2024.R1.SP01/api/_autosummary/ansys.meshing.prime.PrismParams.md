...
| [`PrismParams.print_default`](ansys.meshing.prime.PrismParams.print_default.md#ansys.meshing.prime.PrismParams.print_default)()            | Print the default values of PrismParams.   |
|--------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|
| [`PrismParams.set_default`](ansys.meshing.prime.PrismParams.set_default.md#ansys.meshing.prime.PrismParams.set_default)([stair_step, ...]) | Set the default values of PrismParams.     |
