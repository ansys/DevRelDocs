...
| [`PrismStairStep.print_default`](ansys.meshing.prime.PrismStairStep.print_default.md#ansys.meshing.prime.PrismStairStep.print_default)()   | Print the default values of PrismStairStep.   |
|--------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|
| [`PrismStairStep.set_default`](ansys.meshing.prime.PrismStairStep.set_default.md#ansys.meshing.prime.PrismStairStep.set_default)([...])    | Set the default values of PrismStairStep.     |
