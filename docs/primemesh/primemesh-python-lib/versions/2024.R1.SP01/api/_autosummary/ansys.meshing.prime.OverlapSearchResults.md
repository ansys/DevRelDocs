...
| [`OverlapSearchResults.print_default`](ansys.meshing.prime.OverlapSearchResults.print_default.md#ansys.meshing.prime.OverlapSearchResults.print_default)()         | Print the default values of OverlapSearchResults.   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|
| [`OverlapSearchResults.set_default`](ansys.meshing.prime.OverlapSearchResults.set_default.md#ansys.meshing.prime.OverlapSearchResults.set_default)([n_pairs, ...]) | Set the default values of OverlapSearchResults.     |
