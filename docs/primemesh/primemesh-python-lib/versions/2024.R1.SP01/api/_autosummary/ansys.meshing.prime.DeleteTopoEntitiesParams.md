...
| [`DeleteTopoEntitiesParams.print_default`](ansys.meshing.prime.DeleteTopoEntitiesParams.print_default.md#ansys.meshing.prime.DeleteTopoEntitiesParams.print_default)()   | Print the default values of DeleteTopoEntitiesParams.   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|
| [`DeleteTopoEntitiesParams.set_default`](ansys.meshing.prime.DeleteTopoEntitiesParams.set_default.md#ansys.meshing.prime.DeleteTopoEntitiesParams.set_default)([...])    | Set the default values of DeleteTopoEntitiesParams.     |
