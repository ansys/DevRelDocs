...
| [`PeriodicControlParams.print_default`](ansys.meshing.prime.PeriodicControlParams.print_default.md#ansys.meshing.prime.PeriodicControlParams.print_default)()        | Print the default values of PeriodicControlParams.   |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|
| [`PeriodicControlParams.set_default`](ansys.meshing.prime.PeriodicControlParams.set_default.md#ansys.meshing.prime.PeriodicControlParams.set_default)([center, ...]) | Set the default values of PeriodicControlParams.     |
