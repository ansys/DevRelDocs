...
| [`LeakPreventionParams.print_default`](ansys.meshing.prime.LeakPreventionParams.print_default.md#ansys.meshing.prime.LeakPreventionParams.print_default)()   | Print the default values of LeakPreventionParams.   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|
| [`LeakPreventionParams.set_default`](ansys.meshing.prime.LeakPreventionParams.set_default.md#ansys.meshing.prime.LeakPreventionParams.set_default)([...])    | Set the default values of LeakPreventionParams.     |
