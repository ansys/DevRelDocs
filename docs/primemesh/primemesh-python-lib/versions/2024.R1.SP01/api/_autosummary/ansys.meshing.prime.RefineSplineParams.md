...
| [`RefineSplineParams.print_default`](ansys.meshing.prime.RefineSplineParams.print_default.md#ansys.meshing.prime.RefineSplineParams.print_default)()   | Print the default values of RefineSplineParams.   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|
| [`RefineSplineParams.set_default`](ansys.meshing.prime.RefineSplineParams.set_default.md#ansys.meshing.prime.RefineSplineParams.set_default)([...])    | Set the default values of RefineSplineParams.     |
