...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|
| [`MaterialPointManager.delete_material_point`](ansys.meshing.prime.MaterialPointManager.delete_material_point.md#ansys.meshing.prime.MaterialPointManager.delete_material_point)(name)  | Deletes material point with the given name.          |
