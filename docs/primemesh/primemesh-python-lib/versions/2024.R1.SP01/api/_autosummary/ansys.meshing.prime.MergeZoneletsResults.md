...
| [`MergeZoneletsResults.print_default`](ansys.meshing.prime.MergeZoneletsResults.print_default.md#ansys.meshing.prime.MergeZoneletsResults.print_default)()   | Print the default values of MergeZoneletsResults.   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|
| [`MergeZoneletsResults.set_default`](ansys.meshing.prime.MergeZoneletsResults.set_default.md#ansys.meshing.prime.MergeZoneletsResults.set_default)([...])    | Set the default values of MergeZoneletsResults.     |
