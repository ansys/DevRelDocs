...
| Name | Description |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| [`SearchInfoByRegisterIdResults.error_code`](ansys.meshing.prime.SearchInfoByRegisterIdResults.error_code.md#ansys.meshing.prime.SearchInfoByRegisterIdResults.error_code)                            | Error code associated with the retrieving information based on register id.   |
| [`SearchInfoByRegisterIdResults.face_zonelets_found`](ansys.meshing.prime.SearchInfoByRegisterIdResults.face_zonelets_found.md#ansys.meshing.prime.SearchInfoByRegisterIdResults.face_zonelets_found) | Ids of the face zonelets containing at least one registered face element.     |
