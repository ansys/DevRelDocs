...
Prime Mesh Python client library 2025 R1 SP01  is a modified version of the PyPrimeMesh. You can access the latest Prime Mesh Python client library from  the latest Ansys package.
...
8. In Windows OS, click Enter Interpreter Path and click Find to select runPrime.bat as 
   ...
   Example: C:\Program Files\ANSYS Inc\v251\meshing\Prime\runPrime.bat 

   In Linux OS, press Ctrl + Shift + P to view the search bar and type Python: Select 
   Interpreter and select it.
     
    Example:/ANSYS_Inc/v251/meshing/Prime/runPrime.sh
