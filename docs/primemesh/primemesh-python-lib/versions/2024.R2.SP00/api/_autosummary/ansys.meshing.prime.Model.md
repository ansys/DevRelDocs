...
| [`Model.delete_zone`](ansys.meshing.prime.Model.delete_zone.md#ansys.meshing.prime.Model.delete_zone)(zone_id)                                                               | Deletes zone identified with the given id.                                     |
...
| [`Model.get_zone_by_name`](ansys.meshing.prime.Model.get_zone_by_name.md#ansys.meshing.prime.Model.get_zone_by_name)(zone_name)                                              | Gets the zone by name.                                                         |
...
| [`Model.set_suggested_zone_name`](ansys.meshing.prime.Model.set_suggested_zone_name.md#ansys.meshing.prime.Model.set_suggested_zone_name)(id, name)                          | Sets the unique name for zone with given id based on the given suggested name. |
