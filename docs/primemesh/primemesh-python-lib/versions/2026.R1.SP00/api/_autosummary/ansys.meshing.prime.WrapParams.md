...
### *class* ansys.meshing.prime.WrapParams(model=None, sizing_method=None, base_size=None, size_control_ids=None, feature_recovery_control_ids=None, size_field_ids=None, wrap_region=None, number_of_threads=None, imprint_relative_range=None, imprint_iterations=None, json_data=None, \*\*kwargs)
...
| [`WrapParams.feature_recovery_control_ids`](ansys.meshing.prime.WrapParams.feature_recovery_control_ids.md#ansys.meshing.prime.WrapParams.feature_recovery_control_ids) | Used to recover input features for wrapper imprint.      |
