...
![image](../images/cad_structure(2).png)
...
![image](../images/creation_model(2).png)
...
![image](../images/creation_assembly(2).png)
...
![image](../images/creation_part(2).png)
...
![image](../images/creation_body(2).png)
...
> - The [`FileIO.export_fluent_meshing_mesh()`](../api/_autosummary/ansys.meshing.prime.FileIO.export_fluent_meshing_mesh.md#ansys.meshing.prime.FileIO.export_fluent_meshing_mesh) method
