...
<a id="abaqus-to-ansys-mapdl-conversion"></a>
...
> stores the information internally as a JSON document. [`ImportAbaqusParams`](../api/_autosummary/ansys.meshing.prime.ImportAbaqusParams.md#ansys.meshing.prime.ImportAbaqusParams)
...
> [`ExportMapdlCdbParams`](../api/_autosummary/ansys.meshing.prime.ExportMapdlCdbParams.md#ansys.meshing.prime.ExportMapdlCdbParams) allows setting parameters to control
> the export of MAPDL CDB files.

> [`ExportMapdlCdbResults`](../api/_autosummary/ansys.meshing.prime.ExportMapdlCdbResults.md#ansys.meshing.prime.ExportMapdlCdbResults) contains the summary
...
> | FREQUENCY                   | DAMPING PROJECTION=ON; EIGENSOLVER=AMS; NORMALIZATION=MASS; RESIDUAL MODES; SIMULATION=STEADY STATE                                                                        |

<a id="abaqus-to-ls-dyna-conversion"></a>
...
1. Import the Abaqus INP file.
   ...
   > [`ImportAbaqusParams`](../api/_autosummary/ansys.meshing.prime.ImportAbaqusParams.md#ansys.meshing.prime.ImportAbaqusParams) allows you to set the parameters for importing the model.
...
2. Export the K file.
   ...
   [`FileIO.export_lsdyna_keyword_file`](../api/_autosummary/ansys.meshing.prime.FileIO.export_lsdyna_keyword_file.md#ansys.meshing.prime.FileIO.export_lsdyna_keyword_file) allows you
   ...
   [`ExportLSDynaKeywordFileParams`](../api/_autosummary/ansys.meshing.prime.FileIO.export_lsdyna_keyword_file.md#ansys.meshing.prime.FileIO.export_lsdyna_keyword_file) allows you to
