...
* Check volume mesh quality based on cell quality measures. For more information, see [Mesh diagnostics](mesh_diagnostics.md).
...
![thin volume imprints](../images/thinvol_withoutimprints.png)
