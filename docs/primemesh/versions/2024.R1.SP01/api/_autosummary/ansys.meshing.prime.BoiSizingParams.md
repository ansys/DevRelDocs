...
| [`BoiSizingParams.print_default`](ansys.meshing.prime.BoiSizingParams.print_default.md#ansys.meshing.prime.BoiSizingParams.print_default)()             | Print the default values of BoiSizingParams.   |
|---------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|
| [`BoiSizingParams.set_default`](ansys.meshing.prime.BoiSizingParams.set_default.md#ansys.meshing.prime.BoiSizingParams.set_default)([max, growth_rate]) | Set the default values of BoiSizingParams.     |
