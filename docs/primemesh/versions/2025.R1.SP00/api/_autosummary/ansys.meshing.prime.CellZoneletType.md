...
### *class* ansys.meshing.prime.CellZoneletType(value, names=None, \*values, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`CellZoneletType.from_bytes`](ansys.meshing.prime.CellZoneletType.from_bytes.md#ansys.meshing.prime.CellZoneletType.from_bytes)(/, bytes[, ...])     | Return the integer represented by the given array of bytes.                |
| [`CellZoneletType.as_integer_ratio`](ansys.meshing.prime.CellZoneletType.as_integer_ratio.md#ansys.meshing.prime.CellZoneletType.as_integer_ratio)(/) | Return a pair of integers, whose ratio is equal to the original int.       |
| [`CellZoneletType.is_integer`](ansys.meshing.prime.CellZoneletType.is_integer.md#ansys.meshing.prime.CellZoneletType.is_integer)(/)                   | Returns True.                                                              |
