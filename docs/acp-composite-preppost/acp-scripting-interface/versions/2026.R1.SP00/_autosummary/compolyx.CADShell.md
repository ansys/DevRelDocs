...
| [`CADShell.obj_exists`](compolyx.CADShell.obj_exists.md#compolyx.CADShell.obj_exists)()                                  | Checks if \_\_obj still references the c++ object (has not been reset to None by self._delete) and exists in the graph. |
| [`CADShell.serialize_name_and_id`](compolyx.CADShell.serialize_name_and_id.md#compolyx.CADShell.serialize_name_and_id)() | Serializes the name and ID.                                                                                    |
| [`CADShell.update`](compolyx.CADShell.update.md#compolyx.CADShell.update)()                                              | Update the CAD component.                                                                                                     |
