...
### Parameters
  - variables: Optional string of variable to be retrieved (property or environment variable). If this string is set to mat_type, then the Puck Material Classification is returned if available.
### Returns
