...
**Definition**: `core/service/sim_runner/i_sim_runner.h` (line 30)
...
**Definition**: `core/communication/i_topic.h` (line 27)
...
**Definition**: `core/communication/topic.h` (line 22)
...
**Definition**: `core/communication/i_subscriber.h` (line 33)
...
**Definition**: `core/communication/i_topic.h` (line 93)
...
**Definition**: `core/communication/i_topic.h` (line 94)
...
**Definition**: `core/communication/i_publisher.h` (line 35)
...
<a id="standalone__init__data_8h_1a44dcf14a7fa1a939d6f5aca80c108305"></a>
### Function operator==
...
```cpp
SIMFWK_CORE_API bool simulation_framework::core::operator==(const StandaloneInitData &lhs, const StandaloneInitData &rhs)
```
...
**Return type**: [SIMFWK_CORE_API](classsimulation__framework_1_1core_1_1Topic.md#classsimulation__framework_1_1core_1_1Topic) [bool](classsimulation__framework_1_1core_1_1Topic.md#classsimulation__framework_1_1core_1_1Topic)
...
<a id="version_8h_1abfa0feef516d737e3b36569632bd67ba"></a>
...
```cpp
SIMFWK_CORE_API std::string simulation_framework::core::GetCoreVersion()
```
...
**Return type**: [SIMFWK_CORE_API](classsimulation__framework_1_1core_1_1Topic.md#classsimulation__framework_1_1core_1_1Topic) std::string
...
<a id="version_8h_1a257ad60611c172c19abeae13d1f19327"></a>
...
```cpp
SIMFWK_CORE_API std::string simulation_framework::core::GetCorePublicVersion()
```
...
<a id="version_8h_1a49c7dc5c442c7ef226cd299bbd2d7c0a"></a>
...
```cpp
SIMFWK_CORE_API std::string simulation_framework::core::GetCoreInternalVersion()
```
