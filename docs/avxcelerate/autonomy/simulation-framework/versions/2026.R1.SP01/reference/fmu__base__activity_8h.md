...
#ifndef SIMFWK_CORE_LIFECYCLE_FMUACTIVITY_FMUBASEACTIVITY_H
#define SIMFWK_CORE_LIFECYCLE_FMUACTIVITY_FMUBASEACTIVITY_H
...
class SIMFWK_CORE_API FmuBaseActivity : public BaseActivity
{
  public:
...
#endif  // SIMFWK_CORE_LIFECYCLE_FMUACTIVITY_FMUBASEACTIVITY_H
```
