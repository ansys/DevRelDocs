...
#ifndef SIMFWK_CORE_LIFECYCLE_FMUACTIVITY_IFMULOGIC_H
#define SIMFWK_CORE_LIFECYCLE_FMUACTIVITY_IFMULOGIC_H
...
class SIMFWK_CORE_API IFmuLogic
{
  public:
...
#endif  // SIMFWK_CORE_LIFECYCLE_FMUACTIVITY_IFMULOGIC_H
```
