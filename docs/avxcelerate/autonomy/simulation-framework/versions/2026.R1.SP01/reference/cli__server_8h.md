...
#ifndef SIMFWK_CORE_SERVICE_GRPC_CLI_CLISERVER_H
#define SIMFWK_CORE_SERVICE_GRPC_CLI_CLISERVER_H
...
class SIMFWK_CORE_API SimfwkCliServer : public ISimfwkCliServer
{
  public:
...
#endif  // SIMFWK_CORE_SERVICE_GRPC_CLI_CLISERVER_H
```
