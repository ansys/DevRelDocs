...
* "ObjectSpeedInputTopic" -> <code>GenericBytesTopicType</code> (uses <code>rtidds::GenericBytesMessage</code>)
...
5) VehicleControlInputMsg I/O (<code>VehicleControlInputTopic</code>) 
```cpp
AddPublisher<core::Topic<rtidds::GenericBytesMessage>>(
    "VehicleControlInputTopic", [&]() {
  autonomy::communication::messages::VehicleControlInputMsg msg;
...
AddSubscriber<core::Topic<rtidds::GenericBytesMessage>>(
  ...
  autonomy::communication::messages::VehicleControlInputMsg inputs;
...
6) Object speed input I/O (<code>ObjectSpeedInputTopic</code>) 
```cpp
AddPublisher<core::Topic<rtidds::GenericBytesMessage>>(
    "ObjectSpeedInputTopic", [&]() {
  autonomy::communication::messages::ObjectSpeedInputMsg msg;
  return autonomy::communication::utils::ConvertAutonomyMsgToGenericBytes(frame_counter, header_name, msg); //
rtidds::GenericBytesMessage
}
);
...
AddSubscriber<core::Topic<rtidds::GenericBytesMessage>>(
    "ObjectSpeedInputTopic", [&](const rtidds::GenericBytesMessage& msg) {
  autonomy::communication::messages::ObjectSpeedInputMsg speed_input;
  autonomy::communication::utils::ConvertGenericBytesToAutonomyMsg(msg, speed_input);}
);
```
...
**Definition**: `autonomy/communication/topic_registry/topic_registry.h` (line 154)
...
* **topic_id**: One of: "KpiLoggerTopic", "DriverInputTopic", "SensorViewTopic", "SensorDataTopic", "TrafficUpdateTopic", "TrafficCommandTopic", "MotionRequestTopic", "FmuInput", "FmuOutput", "ScenarioVariableTopic", "VehicleControlInputTopic", "ObjectSpeedInputTopic".


**Returns**:

A <code>std::shared_ptr<[core::ITopic](classsimulation__framework_1_1core_1_1ITopic.md#classsimulation__framework_1_1core_1_1ITopic)></code> of the appropriate concrete Topic type, or throws <code>std::runtime_error</code> if the ID is not recognized.
