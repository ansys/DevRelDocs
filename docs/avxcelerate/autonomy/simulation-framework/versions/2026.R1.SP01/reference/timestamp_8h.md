...
#ifndef SIMFWK_CORE_TIME_ICLOCK_TIMESTAMP_H
#define SIMFWK_CORE_TIME_ICLOCK_TIMESTAMP_H
...
struct SIMFWK_CORE_API Timestamp
{
    uint32_t seconds;
...
#endif  // SIMFWK_CORE_TIME_ICLOCK_TIMESTAMP_H
```
