...
#ifndef SIMFWK_CORE_LIFECYCLE_FMUACTIVITY_FMULOGIC_H
#define SIMFWK_CORE_LIFECYCLE_FMUACTIVITY_FMULOGIC_H
...
class SIMFWK_CORE_API FmuLogic : public IFmuLogic
{
  public:
...
#endif  // SIMFWK_CORE_LIFECYCLE_FMUACTIVITY_FMULOGIC_H
```
