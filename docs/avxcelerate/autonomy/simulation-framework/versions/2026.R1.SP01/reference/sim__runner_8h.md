...
#ifndef SIMFWK_CORE_SERVICE_SIMRUNNER_SIMRUNNER_H
#define SIMFWK_CORE_SERVICE_SIMRUNNER_SIMRUNNER_H
...
class SIMFWK_CORE_API SimRunner final : public ISimRunner
{
  public:
    ~SimRunner();
...
#endif  // SIMFWK_CORE_SERVICE_SIMRUNNER_SIMRUNNER_H
```
