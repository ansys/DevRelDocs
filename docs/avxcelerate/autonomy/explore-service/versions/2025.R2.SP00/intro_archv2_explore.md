...
The AVxcelerate Explore Service REST API v0.1.0 is compatible with the AVX Architecture V2.

This REST API allows you to perform operations related to jobs and create post job sessions.
