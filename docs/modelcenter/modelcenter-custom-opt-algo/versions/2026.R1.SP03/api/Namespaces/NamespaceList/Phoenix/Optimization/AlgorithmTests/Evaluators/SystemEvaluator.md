...
|override bool |`UsesMinMax [get]` |Evaluator does not use minimize/maximize objectives. |
|override bool |`UsesMultipleObjectives [get]` |Evaluator uses multiple Objectives |
|override bool |`UsesSolveFor [get]` |Evaluator uses the `solve for` objective. |
