...
```csharp
public Func<Task> HelpAsyncDelegate { get; set; }
...
`Phoenix.BuilderUIClient.ComponentInfoControlViewModel.HelpCommandAsync` is the command that hooks up this to the view via `Phoenix.BuilderUIClient.ComponentInfoControlViewModel._onHelp`.
