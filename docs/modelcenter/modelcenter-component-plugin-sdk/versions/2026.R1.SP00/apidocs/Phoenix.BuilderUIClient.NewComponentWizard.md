...
```csharp
public class NewComponentWizard : Window, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
...
[NewComponentWizard(string, string, DelegateCommandAsync)](Phoenix.BuilderUIClient.NewComponentWizard.-ctor.md#Phoenix_BuilderUIClient_NewComponentWizard__ctor_System_String_System_String_Phoenix_DotNetUtils_DelegateCommandAsync_)

Construct a NewComponentWizard object

## Properties

[Model](Phoenix.BuilderUIClient.NewComponentWizard.Model.md#Phoenix_BuilderUIClient_NewComponentWizard_Model)

The model object for this view

## Methods

[OnOK(object, RoutedEventArgs)](Phoenix.BuilderUIClient.NewComponentWizard.OnOK.md#Phoenix_BuilderUIClient_NewComponentWizard_OnOK_System_Object_System_Windows_RoutedEventArgs_)
