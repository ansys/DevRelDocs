# Class PaczInitializationDialog
...
```csharp
public class PaczInitializationDialog : Window, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild
...
[PaczInitializationDialog()](Phoenix.BuilderUIClient.PaczInitializationDialog.-ctor.md#Phoenix_BuilderUIClient_PaczInitializationDialog__ctor)

Constructor.

## Properties

[ChosenOption](Phoenix.BuilderUIClient.PaczInitializationDialog.ChosenOption.md#Phoenix_BuilderUIClient_PaczInitializationDialog_ChosenOption)

The option selected by the user. Changed by valid after a call to ShowDialog().

[ShowHelpCommand](Phoenix.BuilderUIClient.PaczInitializationDialog.ShowHelpCommand.md#Phoenix_BuilderUIClient_PaczInitializationDialog_ShowHelpCommand)

Command to show a help page.

## Methods

[GetFromUser(DelegateCommandAsync)](Phoenix.BuilderUIClient.PaczInitializationDialog.GetFromUser.md#Phoenix_BuilderUIClient_PaczInitializationDialog_GetFromUser_Phoenix_DotNetUtils_DelegateCommandAsync_)
