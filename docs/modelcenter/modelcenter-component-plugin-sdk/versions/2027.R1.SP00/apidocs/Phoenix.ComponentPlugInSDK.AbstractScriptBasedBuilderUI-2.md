# Class AbstractScriptBasedBuilderUI<RUNNER, MODEL>
...
```csharp
public abstract class AbstractScriptBasedBuilderUI<RUNNER, MODEL> : AbstractModelBasedBuilderUI<RUNNER, MODEL>, IHarnessBuilderUI<RUNNER>, IHarnessBuilderUIBase, IDisposable where RUNNER : IHarnessRunner where MODEL : ScriptModel, new()
...
The model type to be used. Usually `Phoenix.ComponentPlugInSDK.Models.ScriptModel`1`
...
[ComponentIcon](Phoenix.ComponentPlugInSDK.AbstractScriptBasedBuilderUI-2.ComponentIcon.md#Phoenix_ComponentPlugInSDK_AbstractScriptBasedBuilderUI_2_ComponentIcon)

The URI of the icon to use for the builder UI. If null, the default Windows icon will be used.

[ComponentName](Phoenix.ComponentPlugInSDK.AbstractScriptBasedBuilderUI-2.ComponentName.md#Phoenix_ComponentPlugInSDK_AbstractScriptBasedBuilderUI_2_ComponentName)

The name of the builder to use in the UI.

[ScriptLanguage](Phoenix.ComponentPlugInSDK.AbstractScriptBasedBuilderUI-2.ScriptLanguage.md#Phoenix_ComponentPlugInSDK_AbstractScriptBasedBuilderUI_2_ScriptLanguage)

The ScriptLanguage that is being used.

## Methods

[CreateWindow()](Phoenix.ComponentPlugInSDK.AbstractScriptBasedBuilderUI-2.CreateWindow.md#Phoenix_ComponentPlugInSDK_AbstractScriptBasedBuilderUI_2_CreateWindow)
...
[GetTreeProperties()](Phoenix.ComponentPlugInSDK.AbstractScriptBasedBuilderUI-2.GetTreeProperties.md#Phoenix_ComponentPlugInSDK_AbstractScriptBasedBuilderUI_2_GetTreeProperties)

Gets the properties for configuring the VariableTree.

[SetupView(IExtractedPacz, ScriptEditorViewModel, Menu)](Phoenix.ComponentPlugInSDK.AbstractScriptBasedBuilderUI-2.SetupView.md#Phoenix_ComponentPlugInSDK_AbstractScriptBasedBuilderUI_2_SetupView_Phoenix_PaczAPI_IExtractedPacz_Phoenix_ComponentPlugInSDK_ViewModels_ScriptEditorViewModel_System_Windows_Controls_Menu_)
