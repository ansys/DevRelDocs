...
```python
@TheFullCode[OperationAPI_ExportAllCurves.py](./examples/Examples/OperationAPI/OperationAPI_ExportAllCurves.py)
```

## Export Contour Result To File
This example demonstrates how to export contour results to a file.
```python
@TheFullCode[OperationAPI_ExportAllCurves.py](./examples/References/OperationAPI/Export.py)
```