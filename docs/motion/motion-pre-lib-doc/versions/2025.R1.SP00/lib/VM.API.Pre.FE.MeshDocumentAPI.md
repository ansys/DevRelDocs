...
public static Obj ImportMesh(this MeshDocument doc, string feDataFilePath, string modalDataFileName = "", Color? meshColor = null, bool degenerateElement = false, bool modalOnly = false)
```
...
`modalOnly` [bool](https://learn.microsoft.com/dotnet/api/system.boolean)

The flag for modal only.
