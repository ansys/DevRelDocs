...
```csharp
public class UpdateBodyInMeshFree : OperationInHiddenDocument, IOperation
```
...
```csharp
public UpdateBodyInMeshFree(AssembledBody assem, BodyAnalysisType bodyAnalysisType, SolidBodyProperty.MassPropertyType massPropertyType, string[] massInfo)
```
...
```csharp
public UpdateBodyInMeshFree(Document3D document3D, AssembledBody assem, BodyAnalysisType bodyAnalysisType, SolidBodyProperty.MassPropertyType massPropertyType, string[] massInfo)
```
...
```csharp
public UpdateBodyInMeshFree(JournalParameter jp)
```
