...
```csharp
public abstract class NormalPressureFormulationBase : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public NormalPressureFormulationBase()
```
