...
```csharp
public class AttributeMultiSubEntity<TSubEntity> : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable where TSubEntity : SubEntity, new()
```
