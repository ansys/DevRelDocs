...
```csharp
public class ChainedMultiConnectorsInfo : ChainedMultiBaseInfo, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public ChainedMultiConnectorsInfo()
```
