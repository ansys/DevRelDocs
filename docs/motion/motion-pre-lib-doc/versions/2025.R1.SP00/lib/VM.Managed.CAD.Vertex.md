...
```csharp
public class Vertex : Topology, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer
```
...
### <a id="VM_Managed_CAD_Vertex_ToplogyInfo"></a> ToplogyInfo\(\)
