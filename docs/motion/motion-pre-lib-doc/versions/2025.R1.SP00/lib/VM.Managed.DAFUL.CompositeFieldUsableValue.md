...
```csharp
public class CompositeFieldUsableValue : CompositeFieldUsable, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
[CompositeFieldUsable.IsUse](VM.Managed.DAFUL.CompositeFieldUsable.md\#VM\_Managed\_DAFUL\_CompositeFieldUsable\_IsUse), 
[CompositeFieldUsable.Use](VM.Managed.DAFUL.CompositeFieldUsable.md\#VM\_Managed\_DAFUL\_CompositeFieldUsable\_Use), 
...
```csharp
public CompositeFieldUsableValue(Property owner)
```
...
```csharp
public CompositeFieldUsableValue(double dValue)
```
...
```csharp
public CompositeFieldUsableValue(Property owner, double dValue)
```
