...
```csharp
public class ParallelWheelTravelConfiguration : SuspensionAnalysisConfigurationBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable, IEnableManager
```
...
```csharp
public ParallelWheelTravelConfiguration(AnalysisParallelTravel analysis)
```

#### Parameters

`analysis` [AnalysisParallelTravel](VM.Managed.DAFUL.Car.AnalysisParallelTravel.md)
