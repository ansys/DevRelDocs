...
```csharp
public class CLoadStandard.CLoadFunction : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public CLoadFunction(CLoadStandard objParent)
```

#### Parameters

`objParent` [CLoadStandard](VM.Managed.DAFUL.FE.Force.CLoadStandard.md)
