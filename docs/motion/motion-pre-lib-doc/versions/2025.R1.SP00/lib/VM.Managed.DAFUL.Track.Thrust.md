...
Entity<PropertyThrust\>.Initialize\(Unit.ConvertFactor\), 
Entity<PropertyThrust\>.GetUnnamedObjectName\(object\), 
Entity<PropertyThrust\>.FindLocal\(string\), 
Entity<PropertyThrust\>.Property, 
