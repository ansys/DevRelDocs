...
```csharp
public class Assembly : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public ExpressionValueVariable DesignLoad { get; set; }
```
...
```csharp
public ForceTest ForceTest { get; set; }
```
...
```csharp
public TorqueTest TorqueTest { get; set; }
```
