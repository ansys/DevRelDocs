...
```csharp
public SolidBodySprocket(string strName)
```
...
```csharp
public SolidBodySprocket(string strName, Builder builder)
```
...
```csharp
public SolidBodySprocket ReGenerateBodyInformation(XmlDocument dom)
```
