...
```csharp
public class SetHousingMeshFreeDesignDocument : SetMeshFreeDesignDocument, IOperation
```
...
```csharp
public SetHousingMeshFreeDesignDocument(IMeshEntity meshEntity)
```
...
```csharp
public SetHousingMeshFreeDesignDocument(JournalParameter jp)
```
