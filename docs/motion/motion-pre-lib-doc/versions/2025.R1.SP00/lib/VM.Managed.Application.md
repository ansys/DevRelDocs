...
### <a id="VM_Managed_Application_CreateDocument_VM_Managed_Application_DocumentType_System_Type_System_String___VM_Managed_DocCreateInfo_"></a> CreateDocument\(DocumentType, Type, string\[\], DocCreateInfo\)
...
### <a id="VM_Managed_Application_CreateDocument_VM_Managed_Application_DocumentType_System_Type_"></a> CreateDocument\(DocumentType, Type\)
...
### <a id="VM_Managed_Application_OpenDocument_System_String_VM_Managed_Application_DocumentType_System_String___VM_Managed_Application_PostOpenDocument_"></a> OpenDocument\(string, DocumentType, string\[\], PostOpenDocument\)
...
### <a id="VM_Managed_Application_OpenTemplateBasedDocument_System_String_VM_Managed_Application_DocumentType_System_String___VM_Managed_Application_PostOpenDocument_"></a> OpenTemplateBasedDocument\(string, DocumentType, string\[\], PostOpenDocument\)
...
### <a id="VM_Managed_Application_OpenXmlDocument_System_String_VM_Managed_Application_DocumentType_System_String___VM_Managed_Application_PostOpenDocument_"></a> OpenXmlDocument\(string, DocumentType, string\[\], PostOpenDocument\)
