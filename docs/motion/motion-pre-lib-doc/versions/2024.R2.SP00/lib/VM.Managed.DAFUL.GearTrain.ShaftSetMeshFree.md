...
EntityBase ← 
Entity<PropertyShaftSetMeshFree\> ← 
...
Entity<PropertyShaftSetMeshFree\>.Initialize\(Unit.ConvertFactor\), 
Entity<PropertyShaftSetMeshFree\>.GetUnnamedObjectName\(object\), 
Entity<PropertyShaftSetMeshFree\>.FindLocal\(string\), 
Entity<PropertyShaftSetMeshFree\>.Property, 
