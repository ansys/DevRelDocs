...
```csharp
public HiddenDocumentForGearTrain(UIntPtr docCore)
```
...
```csharp
protected bool CheckActiveDocument(Document3D GTDoc, Document3D docAct)
```
