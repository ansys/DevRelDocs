...
<a id="VM_Managed_DAFUL_GearTrain_CAD_AddedHDBearingBuilderForRBEInFE"></a>
...
```csharp
public class AddedHDBearingBuilderForRBEInFE : HDBearingBuilderForRBEInFE, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IHasReplaceableEntity, IGeometryBuilder, IAddedBuilderForBearing, IAddedBuilder
```
