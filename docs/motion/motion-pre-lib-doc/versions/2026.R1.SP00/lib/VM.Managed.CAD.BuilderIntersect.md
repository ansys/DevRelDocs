...
<a id="VM_Managed_CAD_BuilderIntersect"></a>
...
```csharp
public class BuilderIntersect : BuilderPair, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IHasReplaceableEntity, IContainer, ILinkContainer, IOwned, IHasID
```
