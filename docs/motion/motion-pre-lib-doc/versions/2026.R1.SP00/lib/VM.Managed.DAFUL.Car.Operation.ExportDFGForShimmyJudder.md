# Class ExportDFGForShimmyJudder
<a id="VM_Managed_DAFUL_Car_Operation_ExportDFGForShimmyJudder"></a>
...
```csharp
public class ExportDFGForShimmyJudder : ExportDFG, IOperation
```
...
[ExportDFG](https://github.com/AnsysVirtualMotion/DAFUL/blob/9110677a5f6a53d7604f8dfd35b4c5fceb59e8e0/DAFUL/ClassicPre/Operations/VMOpCore/ExportDFG.cs) ← 
...
[ExportDFG.Execute\(\)](https://github.com/AnsysVirtualMotion/DAFUL/blob/9110677a5f6a53d7604f8dfd35b4c5fceb59e8e0/DAFUL/ClassicPre/Operations/VMOpCore/ExportDFG.cs), 
[ExportDFG.ExportDFGImpl\(\)](https://github.com/AnsysVirtualMotion/DAFUL/blob/9110677a5f6a53d7604f8dfd35b4c5fceb59e8e0/DAFUL/ClassicPre/Operations/VMOpCore/ExportDFG.cs), 
[ExportDFG.Name](https://github.com/AnsysVirtualMotion/DAFUL/blob/9110677a5f6a53d7604f8dfd35b4c5fceb59e8e0/DAFUL/ClassicPre/Operations/VMOpCore/ExportDFG.cs), 
...
### <a id="VM_Managed_DAFUL_Car_Operation_ExportDFGForShimmyJudder__ctor_VM_Managed_Document_"></a> ExportDFGForShimmyJudder\(Document\)

```csharp
public ExportDFGForShimmyJudder(Document doc)
```
...
### <a id="VM_Managed_DAFUL_Car_Operation_ExportDFGForShimmyJudder__ctor_VM_Managed_Operation_JournalParameter_"></a> ExportDFGForShimmyJudder\(JournalParameter\)

```csharp
public ExportDFGForShimmyJudder(JournalParameter jp)
```
...
### <a id="VM_Managed_DAFUL_Car_Operation_ExportDFGForShimmyJudder_Name"></a> Name
...
### <a id="VM_Managed_DAFUL_Car_Operation_ExportDFGForShimmyJudder_ExportDFGImpl"></a> ExportDFGImpl\(\)
