...
<a id="VM_Managed_DAFUL_Car_AnalysisSingleTravel"></a>
...
[AnalysisOppositeTravel.GetTestRigMotionUSUBArgument\(string\[\]\)](VM.Managed.DAFUL.Car.AnalysisOppositeTravel.md\#VM\_Managed\_DAFUL\_Car\_AnalysisOppositeTravel\_GetTestRigMotionUSUBArgument\_System\_String\_\_\_), 
[AnalysisOppositeTravel.GetDataForLoadCase\(int, Dictionary<SuspensionLoadCase.Column, double\[\]\>, SuspensionLoadCase.SuspensionMode\)](VM.Managed.DAFUL.Car.AnalysisOppositeTravel.md\#VM\_Managed\_DAFUL\_Car\_AnalysisOppositeTravel\_GetDataForLoadCase\_System\_Int32\_System\_Collections\_Generic\_Dictionary\_VM\_Managed\_DAFUL\_Car\_SuspensionLoadCase\_Column\_System\_Double\_\_\_\_VM\_Managed\_DAFUL\_Car\_SuspensionLoadCase\_SuspensionMode\_), 
[AnalysisOppositeTravel.SetDataForLoadCase\(SuspensionLoadCase.SuspensionMode\)](VM.Managed.DAFUL.Car.AnalysisOppositeTravel.md\#VM\_Managed\_DAFUL\_Car\_AnalysisOppositeTravel\_SetDataForLoadCase\_VM\_Managed\_DAFUL\_Car\_SuspensionLoadCase\_SuspensionMode\_), 
[AnalysisOppositeTravel.GetXmlData\(XmlWriter\)](VM.Managed.DAFUL.Car.AnalysisOppositeTravel.md\#VM\_Managed\_DAFUL\_Car\_AnalysisOppositeTravel\_GetXmlData\_System\_Xml\_XmlWriter\_), 
[AnalysisOppositeTravel.SetXmlData\(XmlReader\)](VM.Managed.DAFUL.Car.AnalysisOppositeTravel.md\#VM\_Managed\_DAFUL\_Car\_AnalysisOppositeTravel\_SetXmlData\_System\_Xml\_XmlReader\_), 
[AnalysisOppositeTravel.GetDataForLoadCaseCore\(int, Dictionary<SuspensionLoadCase.Column, double\[\]\>, SuspensionLoadCase.SuspensionMode\)](VM.Managed.DAFUL.Car.AnalysisOppositeTravel.md\#VM\_Managed\_DAFUL\_Car\_AnalysisOppositeTravel\_GetDataForLoadCaseCore\_System\_Int32\_System\_Collections\_Generic\_Dictionary\_VM\_Managed\_DAFUL\_Car\_SuspensionLoadCase\_Column\_System\_Double\_\_\_\_VM\_Managed\_DAFUL\_Car\_SuspensionLoadCase\_SuspensionMode\_), 
[AnalysisOppositeTravel.SteeringFunctionArgument](VM.Managed.DAFUL.Car.AnalysisOppositeTravel.md\#VM\_Managed\_DAFUL\_Car\_AnalysisOppositeTravel\_SteeringFunctionArgument), 
[AnalysisOppositeTravel.CoordinateSystemType](VM.Managed.DAFUL.Car.AnalysisOppositeTravel.md\#VM\_Managed\_DAFUL\_Car\_AnalysisOppositeTravel\_CoordinateSystemType), 
...
```csharp
public AnalysisSingleTravel(ILinkContainer lnkContainer)
```
