# Class ExportFilesForFourPost
<a id="VM_Managed_DAFUL_Car_Operation_ExportFilesForFourPost"></a>

Namespace: [VM.Managed.DAFUL.Car.Operation](VM.Managed.DAFUL.Car.Operation.md)  
Assembly: VMOpFullCar.dll  

```csharp
public class ExportFilesForFourPost : ExportFiles, IOperation
```
...
### <a id="VM_Managed_DAFUL_Car_Operation_ExportFilesForFourPost__ctor_VM_Managed_Document3D_System_String_System_Boolean_System_Boolean_System_Boolean_System_Boolean_"></a> ExportFilesForFourPost\(Document3D, string, bool, bool, bool, bool\)

```csharp
public ExportFilesForFourPost(Document3D doc, string strFilePath, bool bWriteDFS, bool bWriteXML, bool bWriteDFG, bool bIncludeReferenceFiles)
```
...
### <a id="VM_Managed_DAFUL_Car_Operation_ExportFilesForFourPost__ctor_VM_Managed_Operation_JournalParameter_"></a> ExportFilesForFourPost\(JournalParameter\)

```csharp
public ExportFilesForFourPost(JournalParameter jp)
```
...
### <a id="VM_Managed_DAFUL_Car_Operation_ExportFilesForFourPost_SetScenario"></a> SetScenario\(\)
