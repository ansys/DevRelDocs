...
<a id="VM_Managed_DirectionExpression"></a>
...
```csharp
public class DirectionExpression : DirectionBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable, IHasReplaceableEntity
```
