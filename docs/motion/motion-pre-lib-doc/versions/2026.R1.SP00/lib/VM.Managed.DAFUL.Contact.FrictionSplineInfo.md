...
<a id="VM_Managed_DAFUL_Contact_FrictionSplineInfo"></a>
...
```csharp
public class FrictionSplineInfo : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
