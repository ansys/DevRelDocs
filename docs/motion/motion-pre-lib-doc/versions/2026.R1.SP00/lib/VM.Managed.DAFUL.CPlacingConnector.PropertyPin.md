# Class PropertyPin
<a id="VM_Managed_DAFUL_CPlacingConnector_PropertyPin"></a>
...
```csharp
public class PropertyPin : Property, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IContainer, ILinkContainer, IOwned, IHasID
```
