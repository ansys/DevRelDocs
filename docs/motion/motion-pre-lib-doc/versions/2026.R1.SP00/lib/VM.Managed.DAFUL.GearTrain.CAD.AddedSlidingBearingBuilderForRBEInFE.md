# Class AddedSlidingBearingBuilderForRBEInFE
<a id="VM_Managed_DAFUL_GearTrain_CAD_AddedSlidingBearingBuilderForRBEInFE"></a>
...
```csharp
public class AddedSlidingBearingBuilderForRBEInFE : SlidingBearingBuilderForRBEInFE, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IHasReplaceableEntity, IGeometryBuilder, IPostDeserialized, ISlidingBuilder, IGTBuilder, IAddedBuilder
```
...
[SlidingBearingBuilderForRBEInFE.SetRotation\(OMatrix\)](VM.Managed.DAFUL.GearTrain.CAD.SlidingBearingBuilderForRBEInFE.md\#VM\_Managed\_DAFUL\_GearTrain\_CAD\_SlidingBearingBuilderForRBEInFE\_SetRotation\_VM\_Managed\_OMatrix\_), 
[SlidingBearingBuilderForRBEInFE.GetTransform\(\)](VM.Managed.DAFUL.GearTrain.CAD.SlidingBearingBuilderForRBEInFE.md\#VM\_Managed\_DAFUL\_GearTrain\_CAD\_SlidingBearingBuilderForRBEInFE\_GetTransform), 
[SlidingBearingBuilderForRBEInFE.GetCenterPosition\(\)](VM.Managed.DAFUL.GearTrain.CAD.SlidingBearingBuilderForRBEInFE.md\#VM\_Managed\_DAFUL\_GearTrain\_CAD\_SlidingBearingBuilderForRBEInFE\_GetCenterPosition), 
[SlidingBearingBuilderForRBEInFE.CreateGeometryInFE\(HiddenDocument, SBGeometryInfo, IConnectable, bool\)](VM.Managed.DAFUL.GearTrain.CAD.SlidingBearingBuilderForRBEInFE.md\#VM\_Managed\_DAFUL\_GearTrain\_CAD\_SlidingBearingBuilderForRBEInFE\_CreateGeometryInFE\_VM\_Managed\_DAFUL\_HiddenDocument\_VM\_Managed\_DAFUL\_GearTrain\_SBGeometryInfo\_VM\_Managed\_DAFUL\_IConnectable\_System\_Boolean\_), 
[SlidingBearingBuilderForRBEInFE.DeleteCondition\(object\)](VM.Managed.DAFUL.GearTrain.CAD.SlidingBearingBuilderForRBEInFE.md\#VM\_Managed\_DAFUL\_GearTrain\_CAD\_SlidingBearingBuilderForRBEInFE\_DeleteCondition\_System\_Object\_), 
[SlidingBearingBuilderForRBEInFE.ParentConnectable](VM.Managed.DAFUL.GearTrain.CAD.SlidingBearingBuilderForRBEInFE.md\#VM\_Managed\_DAFUL\_GearTrain\_CAD\_SlidingBearingBuilderForRBEInFE\_ParentConnectable), 
[SlidingBearingBuilderForRBEInFE.\_ParentConnectable](VM.Managed.DAFUL.GearTrain.CAD.SlidingBearingBuilderForRBEInFE.md\#VM\_Managed\_DAFUL\_GearTrain\_CAD\_SlidingBearingBuilderForRBEInFE\_\_ParentConnectable), 
[SlidingBearingBuilderForRBEInFE.Rotation](VM.Managed.DAFUL.GearTrain.CAD.SlidingBearingBuilderForRBEInFE.md\#VM\_Managed\_DAFUL\_GearTrain\_CAD\_SlidingBearingBuilderForRBEInFE\_Rotation), 
[SlidingBearingBuilderForRBEInFE.StartPoint](VM.Managed.DAFUL.GearTrain.CAD.SlidingBearingBuilderForRBEInFE.md\#VM\_Managed\_DAFUL\_GearTrain\_CAD\_SlidingBearingBuilderForRBEInFE\_StartPoint), 
[SlidingBearingBuilderForRBEInFE.Position](VM.Managed.DAFUL.GearTrain.CAD.SlidingBearingBuilderForRBEInFE.md\#VM\_Managed\_DAFUL\_GearTrain\_CAD\_SlidingBearingBuilderForRBEInFE\_Position), 
[SlidingBearingBuilderForRBEInFE.ConnectableEntity](VM.Managed.DAFUL.GearTrain.CAD.SlidingBearingBuilderForRBEInFE.md\#VM\_Managed\_DAFUL\_GearTrain\_CAD\_SlidingBearingBuilderForRBEInFE\_ConnectableEntity), 
[SlidingBearingBuilderForRBEInFE.OffsetToAxisDirection](VM.Managed.DAFUL.GearTrain.CAD.SlidingBearingBuilderForRBEInFE.md\#VM\_Managed\_DAFUL\_GearTrain\_CAD\_SlidingBearingBuilderForRBEInFE\_OffsetToAxisDirection), 
...
### <a id="VM_Managed_DAFUL_GearTrain_CAD_AddedSlidingBearingBuilderForRBEInFE__ctor"></a> AddedSlidingBearingBuilderForRBEInFE\(\)

Initializes a new instance of the <xref href="VM.Managed.DAFUL.GearTrain.CAD.AddedSlidingBearingBuilderForRBEInFE" data-throw-if-not-resolved="false"></xref> class.

```csharp
public AddedSlidingBearingBuilderForRBEInFE()
```

### <a id="VM_Managed_DAFUL_GearTrain_CAD_AddedSlidingBearingBuilderForRBEInFE__ctor_VM_Managed_DAFUL_GearTrain_CAD_SlidingBearingGeom_VM_Managed_DAFUL_GearTrain_SBGeometryInfo_"></a> AddedSlidingBearingBuilderForRBEInFE\(SlidingBearingGeom, SBGeometryInfo\)

Initializes a new instance of the <xref href="VM.Managed.DAFUL.GearTrain.CAD.AddedSlidingBearingBuilderForRBEInFE" data-throw-if-not-resolved="false"></xref> class.

```csharp
public AddedSlidingBearingBuilderForRBEInFE(SlidingBearingGeom sbGeom, SBGeometryInfo info)
```
...
### <a id="VM_Managed_DAFUL_GearTrain_CAD_AddedSlidingBearingBuilderForRBEInFE_GetTransform"></a> GetTransform\(\)
...
### <a id="VM_Managed_DAFUL_GearTrain_CAD_AddedSlidingBearingBuilderForRBEInFE_LinkRequestDestroying_System_Object_VM_Managed_LinkEventArgs_"></a> LinkRequestDestroying\(object, LinkEventArgs\)
...
### <a id="VM_Managed_DAFUL_GearTrain_CAD_AddedSlidingBearingBuilderForRBEInFE_UpdateGeometry"></a> UpdateGeometry\(\)
