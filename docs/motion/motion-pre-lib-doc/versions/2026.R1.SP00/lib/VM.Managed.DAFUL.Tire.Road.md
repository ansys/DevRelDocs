# Class Road
<a id="VM_Managed_DAFUL_Tire_Road"></a>
...
```csharp
public class Road : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
