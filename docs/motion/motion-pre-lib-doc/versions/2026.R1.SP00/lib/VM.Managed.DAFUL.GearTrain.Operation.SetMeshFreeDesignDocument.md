...
```csharp
public abstract class SetMeshFreeDesignDocument : SetMeshDesignDocument, IOperation
```
...
```csharp
public SetMeshFreeDesignDocument(IMeshEntity meshEntity)
```
...
```csharp
public SetMeshFreeDesignDocument(JournalParameter jp)
```
