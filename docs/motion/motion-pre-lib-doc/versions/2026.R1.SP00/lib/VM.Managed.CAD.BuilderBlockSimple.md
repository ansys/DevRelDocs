...
<a id="VM_Managed_CAD_BuilderBlockSimple"></a>
...
```csharp
public class BuilderBlockSimple : BuilderBlock, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IHasReplaceableEntity
```
...
[BuilderBlock.CheckValidationAboutBuild\(\)](VM.Managed.CAD.BuilderBlock.md\#VM\_Managed\_CAD\_BuilderBlock\_CheckValidationAboutBuild), 
[BuilderBlock.CreateParameter\(\)](VM.Managed.CAD.BuilderBlock.md\#VM\_Managed\_CAD\_BuilderBlock\_CreateParameter), 
[BuilderBlock.FillParameter\(BuilderParamBase\)](VM.Managed.CAD.BuilderBlock.md\#VM\_Managed\_CAD\_BuilderBlock\_FillParameter\_VM\_CAD\_Builders\_BuilderParamBase\_), 
[BuilderBlock.TransformationMatrix](VM.Managed.CAD.BuilderBlock.md\#VM\_Managed\_CAD\_BuilderBlock\_TransformationMatrix), 
[BuilderBlock.\_Transform](VM.Managed.CAD.BuilderBlock.md\#VM\_Managed\_CAD\_BuilderBlock\_\_Transform), 
[BuilderBlock.\_Depth](VM.Managed.CAD.BuilderBlock.md\#VM\_Managed\_CAD\_BuilderBlock\_\_Depth), 
[BuilderBlock.\_Height](VM.Managed.CAD.BuilderBlock.md\#VM\_Managed\_CAD\_BuilderBlock\_\_Height), 
[BuilderBlock.\_Width](VM.Managed.CAD.BuilderBlock.md\#VM\_Managed\_CAD\_BuilderBlock\_\_Width), 
[BuilderHasTransformationMatrix.FillParameter\(BuilderParamBase\)](VM.Managed.CAD.BuilderHasTransformationMatrix.md\#VM\_Managed\_CAD\_BuilderHasTransformationMatrix\_FillParameter\_VM\_CAD\_Builders\_BuilderParamBase\_), 
[BuilderHasTransformationMatrix.TransformationMatrix](VM.Managed.CAD.BuilderHasTransformationMatrix.md\#VM\_Managed\_CAD\_BuilderHasTransformationMatrix\_TransformationMatrix), 
...
`Width` [Variable](VM.Managed.Variable.md)
...
`Depth` [Variable](VM.Managed.Variable.md)
...
### <a id="VM_Managed_CAD_BuilderBlockSimple_HasReplaceableEntity_VM_Models_Pre_IObjectBase_"></a> HasReplaceableEntity\(IObjectBase\)
...
### <a id="VM_Managed_CAD_BuilderBlockSimple_ReplaceEntity_VM_Models_Pre_IObjectBase_VM_Models_Pre_IObjectBase_"></a> ReplaceEntity\(IObjectBase, IObjectBase\)
