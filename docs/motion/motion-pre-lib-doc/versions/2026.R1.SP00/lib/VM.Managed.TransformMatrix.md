...
<a id="VM_Managed_TransformMatrix"></a>
...
```csharp
public class TransformMatrix : TransformBase, IObservableObject, IDisposableObject, ILinkable, ILinkContainerEvent, IVerifiable, IExpression, ITransformBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasReplaceableEntity
```
...
```csharp
public TransformMatrix(TMatrix matTransform)
```
