# Class SInput
<a id="VM_Managed_DAFUL_CoSim_SInput"></a>
...
```csharp
public class SInput : CoSimIO, IObservableObject, IDisposableObject, ILinkable, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, ISubEntity, IEntityBase, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, IHasName, IEnabled, IHasComment, INamed, INavigatorItem, IArgument, IReportable
```
...
[SInput](VM.Managed.DAFUL.CoSim.SInput.md)
...
Name of the <xref href="VM.Managed.DAFUL.CoSim.SInput" data-throw-if-not-resolved="false"></xref> class.
