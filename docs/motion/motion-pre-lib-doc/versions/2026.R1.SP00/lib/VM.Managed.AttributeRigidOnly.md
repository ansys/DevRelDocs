...
<a id="VM_Managed_AttributeRigidOnly"></a>
...
```csharp
public class AttributeRigidOnly : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
