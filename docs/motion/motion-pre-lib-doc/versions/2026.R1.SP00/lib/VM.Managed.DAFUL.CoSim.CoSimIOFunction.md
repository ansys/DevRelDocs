...
<a id="VM_Managed_DAFUL_CoSim_CoSimIOFunction"></a>
...
```csharp
public abstract class CoSimIOFunction : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
protected CoSimIOFunction(CoSimIO owner)
```
