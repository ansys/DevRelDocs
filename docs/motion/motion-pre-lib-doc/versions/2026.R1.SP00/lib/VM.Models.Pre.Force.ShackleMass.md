...
```csharp
public class ShackleMass : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public ExpressionValueVariable InertiaXX { get; set; }
```
...
```csharp
public ExpressionValueVariable InertiaYY { get; set; }
```
...
```csharp
public ExpressionValueVariable InertiaZZ { get; set; }
```
