...
<a id="VM_Managed_DAFUL_GearTrain_PropertyShaftSetMeshFree"></a>
...
```csharp
public class PropertyShaftSetMeshFree : PropertyShaftSetMeshBase, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IContainer, ILinkContainer, IOwned, IHasID
```
...
[PropertyShaftSetMeshBase.AddPowerLoadOnRBE\(PowerLoadOnRBE\)](VM.Managed.DAFUL.GearTrain.PropertyShaftSetMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_PropertyShaftSetMeshBase\_AddPowerLoadOnRBE\_VM\_Managed\_DAFUL\_GearTrain\_PowerLoadOnRBE\_), 
[PropertyShaftSetMeshBase.RemovePowerLoadOnRBE\(PowerLoadOnRBE\)](VM.Managed.DAFUL.GearTrain.PropertyShaftSetMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_PropertyShaftSetMeshBase\_RemovePowerLoadOnRBE\_VM\_Managed\_DAFUL\_GearTrain\_PowerLoadOnRBE\_), 
[PropertyShaftSetMeshBase.IsContainsNameOfPowerLoadOnRBE\(string\)](VM.Managed.DAFUL.GearTrain.PropertyShaftSetMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_PropertyShaftSetMeshBase\_IsContainsNameOfPowerLoadOnRBE\_System\_String\_), 
[PropertyShaftSetMeshBase.FindLocal\(string\)](VM.Managed.DAFUL.GearTrain.PropertyShaftSetMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_PropertyShaftSetMeshBase\_FindLocal\_System\_String\_), 
[PropertyShaftSetMeshBase.OnDeserialization\(object\)](VM.Managed.DAFUL.GearTrain.PropertyShaftSetMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_PropertyShaftSetMeshBase\_OnDeserialization\_System\_Object\_), 
[PropertyShaftSetMeshBase.PowerLoadOnRBEs](VM.Managed.DAFUL.GearTrain.PropertyShaftSetMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_PropertyShaftSetMeshBase\_PowerLoadOnRBEs), 
[PropertyShaftSetMeshBase.InputPowerLoad](VM.Managed.DAFUL.GearTrain.PropertyShaftSetMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_PropertyShaftSetMeshBase\_InputPowerLoad), 
[PropertyShaftSetMeshBase.OutputPowerLoad](VM.Managed.DAFUL.GearTrain.PropertyShaftSetMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_PropertyShaftSetMeshBase\_OutputPowerLoad), 
