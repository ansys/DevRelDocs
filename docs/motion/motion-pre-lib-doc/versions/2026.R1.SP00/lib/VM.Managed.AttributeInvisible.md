...
<a id="VM_Managed_AttributeInvisible"></a>
...
```csharp
public class AttributeInvisible : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
