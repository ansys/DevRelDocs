...
<a id="VM_Managed_DAFUL_FE_ReferenceModeMasterPoint"></a>
...
```csharp
public ReferenceModeMasterPoint(ObjectBase obj)
```
...
```csharp
protected ReferenceModeMasterPoint(SerializationInfo info, StreamingContext context)
```
