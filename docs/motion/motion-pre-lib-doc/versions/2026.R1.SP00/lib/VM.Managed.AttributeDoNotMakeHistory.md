...
<a id="VM_Managed_AttributeDoNotMakeHistory"></a>
...
```csharp
public class AttributeDoNotMakeHistory : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
