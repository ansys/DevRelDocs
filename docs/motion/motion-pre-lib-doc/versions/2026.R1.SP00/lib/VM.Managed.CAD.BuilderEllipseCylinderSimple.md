...
<a id="VM_Managed_CAD_BuilderEllipseCylinderSimple"></a>
...
```csharp
public class BuilderEllipseCylinderSimple : BuilderEllipseCylinder, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IHasReplaceableEntity
```
...
[BuilderEllipseCylinder.CheckValidationAboutBuild\(\)](VM.Managed.CAD.BuilderEllipseCylinder.md\#VM\_Managed\_CAD\_BuilderEllipseCylinder\_CheckValidationAboutBuild), 
[BuilderEllipseCylinder.CreateParameter\(\)](VM.Managed.CAD.BuilderEllipseCylinder.md\#VM\_Managed\_CAD\_BuilderEllipseCylinder\_CreateParameter), 
[BuilderEllipseCylinder.FillParameter\(BuilderParamBase\)](VM.Managed.CAD.BuilderEllipseCylinder.md\#VM\_Managed\_CAD\_BuilderEllipseCylinder\_FillParameter\_VM\_CAD\_Builders\_BuilderParamBase\_), 
[BuilderEllipseCylinder.\_MajorAxis](VM.Managed.CAD.BuilderEllipseCylinder.md\#VM\_Managed\_CAD\_BuilderEllipseCylinder\_\_MajorAxis), 
[BuilderEllipseCylinder.\_RadiusMinor](VM.Managed.CAD.BuilderEllipseCylinder.md\#VM\_Managed\_CAD\_BuilderEllipseCylinder\_\_RadiusMinor), 
...
### <a id="VM_Managed_CAD_BuilderEllipseCylinderSimple_HasReplaceableEntity_VM_Models_Pre_IObjectBase_"></a> HasReplaceableEntity\(IObjectBase\)
...
### <a id="VM_Managed_CAD_BuilderEllipseCylinderSimple_ReplaceEntity_VM_Models_Pre_IObjectBase_VM_Models_Pre_IObjectBase_"></a> ReplaceEntity\(IObjectBase, IObjectBase\)
