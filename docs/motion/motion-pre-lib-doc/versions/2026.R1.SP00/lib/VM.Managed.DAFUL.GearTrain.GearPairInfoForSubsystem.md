...
<a id="VM_Managed_DAFUL_GearTrain_GearPairInfoForSubsystem"></a>
...
```csharp
public class GearPairInfoForSubsystem : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public Body DrivenGearBody { get; set; }
```
