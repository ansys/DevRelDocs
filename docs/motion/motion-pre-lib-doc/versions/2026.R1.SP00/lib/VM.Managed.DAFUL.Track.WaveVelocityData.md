...
<a id="VM_Managed_DAFUL_Track_WaveVelocityData"></a>
...
```csharp
public class WaveVelocityData : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public ExpressionValueVariable Position { get; set; }
```
