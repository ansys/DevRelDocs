# Class GearShapeWorm
<a id="VM_Managed_DAFUL_GearTrain_GearShapeWorm"></a>
...
```csharp
public class GearShapeWorm : GearShapeHelical, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
