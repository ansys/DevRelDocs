# Class VariableEq
<a id="VM_Managed_DAFUL_Equation_VariableEq"></a>
...
```csharp
public class VariableEq : Equation, IObservableObject, IDisposableObject, ILinkable, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, ISubEntity, IEntityBase, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, IHasName, IEnabled, IHasComment, INamed, INavigatorItem, IArgument, ITemplateObject, IReportable
```
...
[VariableEq](VM.Managed.DAFUL.Equation.VariableEq.md)
...
```csharp
public VariableEq(string strName)
```
