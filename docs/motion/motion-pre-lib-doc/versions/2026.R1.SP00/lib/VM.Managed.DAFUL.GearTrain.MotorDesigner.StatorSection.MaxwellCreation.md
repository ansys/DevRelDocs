...
<a id="VM_Managed_DAFUL_GearTrain_MotorDesigner_StatorSection_MaxwellCreation"></a>
...
```csharp
public class MotorDesigner.StatorSection.MaxwellCreation : MotorDesigner.CreationBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
