...
<a id="VM_Managed_DAFUL_Builder_SolidBodyBlockTwoPoint"></a>

Namespace: [VM.Managed.DAFUL.Builder](VM.Managed.DAFUL.Builder.md)  
Assembly: VMBld.dll  

```csharp
public class SolidBodyBlockTwoPoint : SolidBodyBlock<BuilderBlockTwoPoint>, IBuilder
```
...
[SolidBody<BuilderBlockTwoPoint\>](VM.Managed.DAFUL.Builder.SolidBody\-1.md) ← 
[SolidBodyBlock<BuilderBlockTwoPoint\>](VM.Managed.DAFUL.Builder.SolidBodyBlock\-1.md) ← 
...
[SolidBody<BuilderBlockTwoPoint\>.OnPostBuild\(ObjectBase, Document\)](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_OnPostBuild\_VM\_Managed\_ObjectBase\_VM\_Managed\_Document\_), 
[SolidBody<BuilderBlockTwoPoint\>.OnFinalBuild\(string, Document\)](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_OnFinalBuild\_System\_String\_VM\_Managed\_Document\_), 
[SolidBody<BuilderBlockTwoPoint\>.OnPostAddDoc\(ObjectBase\)](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_OnPostAddDoc\_VM\_Managed\_ObjectBase\_), 
[SolidBody<BuilderBlockTwoPoint\>.SetSolidBuilderProperty\(BuilderBlockTwoPoint\)](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_SetSolidBuilderProperty\_\_0\_), 
[SolidBody<BuilderBlockTwoPoint\>.MakeSymmetricSolidBuilder\(\)](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_MakeSymmetricSolidBuilder), 
[SolidBody<BuilderBlockTwoPoint\>.SolidBuilder](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_SolidBuilder), 
[SolidBody<BuilderBlockTwoPoint\>.Interface](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_Interface), 
[SolidBody<BuilderBlockTwoPoint\>.BodyName](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_BodyName), 
[SolidBody<BuilderBlockTwoPoint\>.Name](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_Name), 
[SolidBody<BuilderBlockTwoPoint\>.AddToDoc](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_AddToDoc), 
