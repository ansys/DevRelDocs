...
```csharp
public class CoSimulationConfig : SimulationConfigurationExtraBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
