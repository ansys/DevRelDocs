...
<a id="VM_Managed_DAFUL_AttributeCurvesetTypeColor"></a>
...
```csharp
public class AttributeCurvesetTypeColor : AttributeCurvesetTypeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
[AttributeCurvesetTypeBase.Type](VM.Managed.DAFUL.AttributeCurvesetTypeBase.md\#VM\_Managed\_DAFUL\_AttributeCurvesetTypeBase\_Type), 
...
```csharp
public AttributeCurvesetTypeColor()
```
