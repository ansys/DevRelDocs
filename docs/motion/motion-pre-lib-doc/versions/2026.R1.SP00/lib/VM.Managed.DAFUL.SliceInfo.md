# Class SliceInfo
<a id="VM_Managed_DAFUL_SliceInfo"></a>
...
```csharp
public class SliceInfo : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public ExpressionValueVariable MaxTolerance { get; set; }
```
