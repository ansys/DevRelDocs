...
<a id="VM_Managed_DAFUL_Constraints_FrictionCylindrical"></a>
...
```csharp
public class FrictionCylindrical : Friction, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
