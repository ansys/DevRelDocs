...
<a id="VM_Managed_CAD_BuilderPlaneCircle"></a>
...
```csharp
public class BuilderPlaneCircle : BuilderPlane, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IHasReplaceableEntity
```
...
[BuilderPlane.SetTransform\(TMatrix\)](VM.Managed.CAD.BuilderPlane.md\#VM\_Managed\_CAD\_BuilderPlane\_SetTransform\_VM\_Managed\_TMatrix\_), 
[BuilderPlane.GetBuildPlaneXml\(StringBuilder\)](VM.Managed.CAD.BuilderPlane.md\#VM\_Managed\_CAD\_BuilderPlane\_GetBuildPlaneXml\_System\_Text\_StringBuilder\_), 
[BuilderPlane.FillParameter\(BuilderParamBase\)](VM.Managed.CAD.BuilderPlane.md\#VM\_Managed\_CAD\_BuilderPlane\_FillParameter\_VM\_CAD\_Builders\_BuilderParamBase\_), 
[BuilderPlane.TransformationMatrix](VM.Managed.CAD.BuilderPlane.md\#VM\_Managed\_CAD\_BuilderPlane\_TransformationMatrix), 
[BuilderPlane.Plane](VM.Managed.CAD.BuilderPlane.md\#VM\_Managed\_CAD\_BuilderPlane\_Plane), 
...
```csharp
public BuilderPlaneCircle(PlaneBase plane, Variable Radius)
```

#### Parameters

`plane` [PlaneBase](VM.Managed.PlaneBase.md)

The plane info.

`Radius` [Variable](VM.Managed.Variable.md)
...
```csharp
public BuilderPlaneCircle(PlaneBase plane, double dRadius)
```
...
```csharp
public BuilderPlaneCircle(Variable Radius)
```
...
```csharp
public BuilderPlaneCircle(double dRadius)
```
