...
<a id="VM_Managed_CAD_Roller_BuilderRollerDoubleFlangeSimple"></a>
...
```csharp
public class BuilderRollerDoubleFlangeSimple : BuilderRollerFlange, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IHasReplaceableEntity
```
...
```csharp
public ExpressionValueVariable InnerFlangeDiameter { get; set; }
```
...
```csharp
public ExpressionValueVariable InnerFlangeWidth { get; set; }
```
...
```csharp
public ExpressionValueVariable OuterFlangeDiameter { get; set; }
```
