...
<a id="VM_Managed_DAFUL_Builder_SolidBodyBlockSimple"></a>

Namespace: [VM.Managed.DAFUL.Builder](VM.Managed.DAFUL.Builder.md)  
Assembly: VMBld.dll  

```csharp
public class SolidBodyBlockSimple : SolidBodyBlock<BuilderBlockSimple>, IBuilder
```
...
[SolidBody<BuilderBlockSimple\>](VM.Managed.DAFUL.Builder.SolidBody\-1.md) ← 
[SolidBodyBlock<BuilderBlockSimple\>](VM.Managed.DAFUL.Builder.SolidBodyBlock\-1.md) ← 
...
[SolidBody<BuilderBlockSimple\>.OnPostBuild\(ObjectBase, Document\)](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_OnPostBuild\_VM\_Managed\_ObjectBase\_VM\_Managed\_Document\_), 
[SolidBody<BuilderBlockSimple\>.OnFinalBuild\(string, Document\)](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_OnFinalBuild\_System\_String\_VM\_Managed\_Document\_), 
[SolidBody<BuilderBlockSimple\>.OnPostAddDoc\(ObjectBase\)](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_OnPostAddDoc\_VM\_Managed\_ObjectBase\_), 
[SolidBody<BuilderBlockSimple\>.SetSolidBuilderProperty\(BuilderBlockSimple\)](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_SetSolidBuilderProperty\_\_0\_), 
[SolidBody<BuilderBlockSimple\>.MakeSymmetricSolidBuilder\(\)](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_MakeSymmetricSolidBuilder), 
[SolidBody<BuilderBlockSimple\>.SolidBuilder](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_SolidBuilder), 
[SolidBody<BuilderBlockSimple\>.Interface](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_Interface), 
[SolidBody<BuilderBlockSimple\>.BodyName](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_BodyName), 
[SolidBody<BuilderBlockSimple\>.Name](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_Name), 
[SolidBody<BuilderBlockSimple\>.AddToDoc](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_AddToDoc), 
