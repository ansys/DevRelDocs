# Class PLoadStandard
<a id="VM_Managed_DAFUL_FE_Force_PLoadStandard"></a>
...
```csharp
public class PLoadStandard : FEForceFunction, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public PLoadStandard(PropertyPLoad objParent)
```
