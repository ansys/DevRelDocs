...
<a id="VM_Managed_DAFUL_CPlacingConnector_AttributePulleyAndPin"></a>
...
```csharp
public class AttributePulleyAndPin : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public Reference ReferencePin { get; set; }
```
