...
<a id="VM_Managed_DAFUL_Chained_ChainedMultiBaseInfo"></a>
...
```csharp
public abstract class ChainedMultiBaseInfo : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
