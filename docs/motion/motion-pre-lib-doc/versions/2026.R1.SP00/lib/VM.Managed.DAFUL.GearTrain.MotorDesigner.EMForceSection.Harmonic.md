...
<a id="VM_Managed_DAFUL_GearTrain_MotorDesigner_EMForceSection_Harmonic"></a>
...
```csharp
public class MotorDesigner.EMForceSection.Harmonic : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public ExpressionValueVariable Order { get; set; }
```
