...
This class is to represent the document information for hidden document.

```csharp
public class HiddenDocInfo : AssemblyDocInfo
```
...
[AssemblyDocInfo.Format](VM.Managed.DAFUL.Pre.AssemblyDocInfo.md\#VM\_Managed\_DAFUL\_Pre\_AssemblyDocInfo\_Format), 
[AssemblyDocInfo.BuilderType](VM.Managed.DAFUL.Pre.AssemblyDocInfo.md\#VM\_Managed\_DAFUL\_Pre\_AssemblyDocInfo\_BuilderType), 
[AssemblyDocInfo.PriorityType](VM.Managed.DAFUL.Pre.AssemblyDocInfo.md\#VM\_Managed\_DAFUL\_Pre\_AssemblyDocInfo\_PriorityType), 
[AssemblyDocInfo.BaseType](VM.Managed.DAFUL.Pre.AssemblyDocInfo.md\#VM\_Managed\_DAFUL\_Pre\_AssemblyDocInfo\_BaseType), 
[AssemblyDocInfo.CategoryName](VM.Managed.DAFUL.Pre.AssemblyDocInfo.md\#VM\_Managed\_DAFUL\_Pre\_AssemblyDocInfo\_CategoryName), 
[AssemblyDocInfo.IconFiles](VM.Managed.DAFUL.Pre.AssemblyDocInfo.md\#VM\_Managed\_DAFUL\_Pre\_AssemblyDocInfo\_IconFiles), 
[AssemblyDocInfo.ChangeUsageForCADImport](VM.Managed.DAFUL.Pre.AssemblyDocInfo.md\#VM\_Managed\_DAFUL\_Pre\_AssemblyDocInfo\_ChangeUsageForCADImport), 
[AssemblyDocInfo.ChangeUsageForCADExport](VM.Managed.DAFUL.Pre.AssemblyDocInfo.md\#VM\_Managed\_DAFUL\_Pre\_AssemblyDocInfo\_ChangeUsageForCADExport), 
[AssemblyDocInfo.ChangeUsageForFEImport](VM.Managed.DAFUL.Pre.AssemblyDocInfo.md\#VM\_Managed\_DAFUL\_Pre\_AssemblyDocInfo\_ChangeUsageForFEImport), 
[AssemblyDocInfo.ChangeUsageForSubsystemAssembly](VM.Managed.DAFUL.Pre.AssemblyDocInfo.md\#VM\_Managed\_DAFUL\_Pre\_AssemblyDocInfo\_ChangeUsageForSubsystemAssembly), 
[AssemblyDocInfo.ChangeUsageForPartAssembly](VM.Managed.DAFUL.Pre.AssemblyDocInfo.md\#VM\_Managed\_DAFUL\_Pre\_AssemblyDocInfo\_ChangeUsageForPartAssembly), 
[AssemblyDocInfo.ChangeUsageForMeshAssembly](VM.Managed.DAFUL.Pre.AssemblyDocInfo.md\#VM\_Managed\_DAFUL\_Pre\_AssemblyDocInfo\_ChangeUsageForMeshAssembly), 
