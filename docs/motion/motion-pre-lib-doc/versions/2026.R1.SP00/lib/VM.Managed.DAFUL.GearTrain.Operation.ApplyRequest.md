# Class ApplyRequest
<a id="VM_Managed_DAFUL_GearTrain_Operation_ApplyRequest"></a>
...
```csharp
public class ApplyRequest : OperationBase, IOperation
```
...
```csharp
public ApplyRequest(GearTrainDocument gearTrainDocument, Request request, IEnumerable<bool> lstGearsetForceDisplay)
```
...
`request` [Request](https://github.com/AnsysVirtualMotion/DAFUL/blob/9110677a5f6a53d7604f8dfd35b4c5fceb59e8e0/DAFUL/ClassicPre/Data/VMDGearTrain/Request.cs)

The request

`lstGearsetForceDisplay` IEnumerable<bool\>
...
```csharp
public ApplyRequest(JournalParameter jp)
```
