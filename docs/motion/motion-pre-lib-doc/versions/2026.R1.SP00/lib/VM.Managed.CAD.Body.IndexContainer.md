...
<a id="VM_Managed_CAD_Body_IndexContainer"></a>
...
```csharp
public sealed class Body.IndexContainer : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
