...
<a id="VM_Managed_DAFUL_GearTrain_Operation_ShowHideDimension"></a>
...
```csharp
public class ShowHideDimension : OperationBase, IOperation
```
...
```csharp
public ShowHideDimension(Document doc)
```
...
```csharp
public ShowHideDimension(JournalParameter jp)
```
