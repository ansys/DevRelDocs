...
<a id="VM_Managed_CAD_BuilderTorusSimple"></a>
...
```csharp
public class BuilderTorusSimple : BuilderTorus, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IHasReplaceableEntity
```
...
[BuilderTorus.CheckValidationAboutBuild\(\)](VM.Managed.CAD.BuilderTorus.md\#VM\_Managed\_CAD\_BuilderTorus\_CheckValidationAboutBuild), 
[BuilderTorus.CreateParameter\(\)](VM.Managed.CAD.BuilderTorus.md\#VM\_Managed\_CAD\_BuilderTorus\_CreateParameter), 
[BuilderTorus.FillParameter\(BuilderParamBase\)](VM.Managed.CAD.BuilderTorus.md\#VM\_Managed\_CAD\_BuilderTorus\_FillParameter\_VM\_CAD\_Builders\_BuilderParamBase\_), 
[BuilderTorus.\_RadiusMinor](VM.Managed.CAD.BuilderTorus.md\#VM\_Managed\_CAD\_BuilderTorus\_\_RadiusMinor), 
[BuilderTorus.\_RadiusMajor](VM.Managed.CAD.BuilderTorus.md\#VM\_Managed\_CAD\_BuilderTorus\_\_RadiusMajor), 
[BuilderTorus.\_UpDirection](VM.Managed.CAD.BuilderTorus.md\#VM\_Managed\_CAD\_BuilderTorus\_\_UpDirection), 
[BuilderTorus.\_CenterPosition](VM.Managed.CAD.BuilderTorus.md\#VM\_Managed\_CAD\_BuilderTorus\_\_CenterPosition), 
...
```csharp
public BuilderTorusSimple(Variable RadiusMajor, Variable RadiusMinor, PointBase center, DirectionBase up)
```
...
The major radius of torus(variable).

`RadiusMinor` [Variable](VM.Managed.Variable.md)

The minor radius of torus(variable).

`center` [PointBase](VM.Managed.PointBase.md)

The center position of sphere.

`up` [DirectionBase](VM.Managed.DirectionBase.md)
...
```csharp
public BuilderTorusSimple(double dRadiusMajor, double dRadiusMinor, PointBase center, DirectionBase up)
```
...
```csharp
public BuilderTorusSimple(Variable RadiusMajor, Variable RadiusMinor)
```
...
```csharp
public BuilderTorusSimple(double dRadiusMajor, double dRadiusMinor)
```
...
```csharp
public override VectorBase _UpDirection { get; }
```
...
### <a id="VM_Managed_CAD_BuilderTorusSimple_HasReplaceableEntity_VM_Models_Pre_IObjectBase_"></a> HasReplaceableEntity\(IObjectBase\)
...
### <a id="VM_Managed_CAD_BuilderTorusSimple_ReplaceEntity_VM_Models_Pre_IObjectBase_VM_Models_Pre_IObjectBase_"></a> ReplaceEntity\(IObjectBase, IObjectBase\)
