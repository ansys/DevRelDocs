...
```csharp
public class GearShapeBase.Spec
```
...
```csharp
public double ActiveRootDiameter { get; set; }
```
...
```csharp
public double ActiveTipDiameter { get; set; }
```
...
```csharp
public double DiameterNA { get; set; }
```
...
```csharp
public double HelixDirection { get; set; }
```
...
```csharp
public double ProfileShift { get; set; }
```
...
```csharp
public double RadiusNF { get; set; }
```
