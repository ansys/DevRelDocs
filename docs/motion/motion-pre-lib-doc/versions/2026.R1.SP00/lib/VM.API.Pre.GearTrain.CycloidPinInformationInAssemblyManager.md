...
```csharp
public struct CycloidPinInformationInAssemblyManager
```
...
```csharp
public CycloidPinInformationInAssemblyManager()
```
...
```csharp
public Vector CenterOfPinSet { readonly get; set; }
```
...
```csharp
public string CycloidPinGearSetName { readonly get; set; }
```
...
```csharp
public string ReferenceGearSetName { readonly get; set; }
```
