...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL__ctor"></a> ELLIPTICAL\(\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_GenerateMultiSection_System_Double___System_Int32_"></a> GenerateMultiSection\(double\[\], int\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_GenerateOneSection_System_Double___"></a> GenerateOneSection\(double\[\]\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_GeneratePostConnectivities_System_Int32_System_Int32____System_Int32____"></a> GeneratePostConnectivities\(int, ref int\[\], ref int\[\]\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_GeneratePostOneSection_System_Double___System_Int32_"></a> GeneratePostOneSection\(double\[\], int\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_GetArea_System_Double___"></a> GetArea\(double\[\]\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_GetAsy_System_Double___System_Double_"></a> GetAsy\(double\[\], double\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_GetAsz_System_Double___System_Double_"></a> GetAsz\(double\[\], double\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_GetIyy_System_Double___"></a> GetIyy\(double\[\]\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_GetIzz_System_Double___"></a> GetIzz\(double\[\]\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_GetJyy_System_Double_System_Double___System_Double_System_Double_"></a> GetJyy\(double, double\[\], double, double\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_GetJyy_System_Double___System_Double_System_Double_"></a> GetJyy\(double\[\], double, double\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_GetJzz_System_Double_System_Double___System_Double_System_Double_"></a> GetJzz\(double, double\[\], double, double\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_GetJzz_System_Double___System_Double_System_Double_"></a> GetJzz\(double\[\], double, double\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_GetNumSideEdges_System_Int32_"></a> GetNumSideEdges\(int\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_GetNumTotalElements_System_Int32_"></a> GetNumTotalElements\(int\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_GetNumTotalNodes_System_Int32_"></a> GetNumTotalNodes\(int\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_GetSphereBodyRadius_System_Double___"></a> GetSphereBodyRadius\(double\[\]\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_SetVariablesFromArray2Local_System_Double___"></a> SetVariablesFromArray2Local\(double\[\]\)
...
### <a id="VM_Managed_DAFUL_Beam_ELLIPTICAL_TranslateNastran2DAFUL_System_Double___"></a> TranslateNastran2DAFUL\(double\[\]\)
