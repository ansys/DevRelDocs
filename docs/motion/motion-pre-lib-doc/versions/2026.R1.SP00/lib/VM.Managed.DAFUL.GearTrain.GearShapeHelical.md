...
<a id="VM_Managed_DAFUL_GearTrain_GearShapeHelical"></a>
...
```csharp
public class GearShapeHelical : GearShapeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
