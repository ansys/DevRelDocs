...
<a id="VM_Managed_AttributeVolume"></a>
...
```csharp
public class AttributeVolume : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
