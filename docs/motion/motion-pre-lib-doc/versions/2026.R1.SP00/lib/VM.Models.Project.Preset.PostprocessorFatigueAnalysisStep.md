...
```csharp
public class PostprocessorFatigueAnalysisStep : StepBase, IObservableObject, IStep, IProjectObject, IHasID, IHasName, IDisposableObject, ISelected, IHasParent<IScenario>
```
...
### <a id="VM_Models_Project_Preset_PostprocessorFatigueAnalysisStep__ctor_VM_Models_IScenario_"></a> PostprocessorFatigueAnalysisStep\(IScenario\)

```csharp
public PostprocessorFatigueAnalysisStep(IScenario parent)
```
...
### <a id="VM_Models_Project_Preset_PostprocessorFatigueAnalysisStep_Name"></a> Name
...
### <a id="VM_Models_Project_Preset_PostprocessorFatigueAnalysisStep_Type"></a> Type
