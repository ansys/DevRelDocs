# Class AddGearToRBEInMeshFree
<a id="VM_Managed_DAFUL_Builder_GearTrain_AddGearToRBEInMeshFree"></a>

Namespace: [VM.Managed.DAFUL.Builder.GearTrain](VM.Managed.DAFUL.Builder.GearTrain.md)  
Assembly: VMBldGearTrain.dll  

```csharp
public class AddGearToRBEInMeshFree : AddGearToRBEInMeshBase, IBuilder
```
...
[AddGearToRBEInMeshFree](VM.Managed.DAFUL.Builder.GearTrain.AddGearToRBEInMeshFree.md)

#### Derived

[AddRackToRBEInMeshFree](VM.Managed.DAFUL.Builder.GearTrain.AddRackToRBEInMeshFree.md)
...
[AddGearToRBEInMeshBase.GetTmpGearGeometry\(GearGeometryInfo, IConnectable, HiddenDocumentMeshBase, DirectionBase, GearBuilder.ParentType, ReferencePointType, double, Vector, OMatrix\)](VM.Managed.DAFUL.Builder.GearTrain.AddGearToRBEInMeshBase.md\#VM\_Managed\_DAFUL\_Builder\_GearTrain\_AddGearToRBEInMeshBase\_GetTmpGearGeometry\_VM\_Managed\_DAFUL\_GearTrain\_GearGeometryInfo\_VM\_Managed\_DAFUL\_IConnectable\_VM\_Managed\_DAFUL\_GearTrain\_HiddenDocumentMeshBase\_VM\_Managed\_DirectionBase\_VM\_Managed\_DAFUL\_GearTrain\_CAD\_GearBuilder\_ParentType\_VM\_Managed\_DAFUL\_GearTrain\_CAD\_ReferencePointType\_System\_Double\_VM\_Managed\_Vector\_VM\_Managed\_OMatrix\_), 
[AddGearToRBEInMeshBase.GetGearBuilder\(GeometryBase\)](VM.Managed.DAFUL.Builder.GearTrain.AddGearToRBEInMeshBase.md\#VM\_Managed\_DAFUL\_Builder\_GearTrain\_AddGearToRBEInMeshBase\_GetGearBuilder\_VM\_Managed\_DAFUL\_GearTrain\_CAD\_GeometryBase\_), 
[AddGearToRBEInMeshBase.RBEName\(IConnectable\)](VM.Managed.DAFUL.Builder.GearTrain.AddGearToRBEInMeshBase.md\#VM\_Managed\_DAFUL\_Builder\_GearTrain\_AddGearToRBEInMeshBase\_RBEName\_VM\_Managed\_DAFUL\_IConnectable\_), 
[AddGearToRBEInMeshBase.Validate\(IList<string\>\)](VM.Managed.DAFUL.Builder.GearTrain.AddGearToRBEInMeshBase.md\#VM\_Managed\_DAFUL\_Builder\_GearTrain\_AddGearToRBEInMeshBase\_Validate\_System\_Collections\_Generic\_IList\_System\_String\_\_), 
[AddGearToRBEInMeshBase.Build\(Document\)](VM.Managed.DAFUL.Builder.GearTrain.AddGearToRBEInMeshBase.md\#VM\_Managed\_DAFUL\_Builder\_GearTrain\_AddGearToRBEInMeshBase\_Build\_VM\_Managed\_Document\_), 
[AddGearEntityBase.AddPairGeneralGear\(List<IGearBuilder\>, IGearSet, Body, IGearBuilder\)](VM.Managed.DAFUL.Builder.GearTrain.AddGearEntityBase.md\#VM\_Managed\_DAFUL\_Builder\_GearTrain\_AddGearEntityBase\_AddPairGeneralGear\_System\_Collections\_Generic\_List\_VM\_Managed\_DAFUL\_GearTrain\_CAD\_IGearBuilder\_\_VM\_Managed\_DAFUL\_GearTrain\_IGearSet\_VM\_Managed\_CAD\_Body\_VM\_Managed\_DAFUL\_GearTrain\_CAD\_IGearBuilder\_), 
[AddGearEntityBase.AddPairPlanertaryGear\(IGearSet, IGearBuilder\)](VM.Managed.DAFUL.Builder.GearTrain.AddGearEntityBase.md\#VM\_Managed\_DAFUL\_Builder\_GearTrain\_AddGearEntityBase\_AddPairPlanertaryGear\_VM\_Managed\_DAFUL\_GearTrain\_IGearSet\_VM\_Managed\_DAFUL\_GearTrain\_CAD\_IGearBuilder\_), 
...
### <a id="VM_Managed_DAFUL_Builder_GearTrain_AddGearToRBEInMeshFree__ctor"></a> AddGearToRBEInMeshFree\(\)

```csharp
public AddGearToRBEInMeshFree()
```

## Methods

### <a id="VM_Managed_DAFUL_Builder_GearTrain_AddGearToRBEInMeshFree_CreateGearGeom_VM_Managed_DAFUL_GearTrain_GearGeometryInfo_VM_Managed_DAFUL_IConnectable_VM_Managed_DAFUL_GearTrain_HiddenDocumentMeshBase_VM_Managed_DirectionBase_VM_Managed_DAFUL_GearTrain_CAD_GearBuilder_ParentType_VM_Managed_DAFUL_GearTrain_CAD_ReferencePointType_System_Double_VM_Managed_Vector_VM_Managed_OMatrix_"></a> CreateGearGeom\(GearGeometryInfo, IConnectable, HiddenDocumentMeshBase, DirectionBase, ParentType, ReferencePointType, double, Vector, OMatrix\)

```csharp
protected virtual GearGeometryForRBEInMeshFree CreateGearGeom(GearGeometryInfo gInfo, IConnectable con, HiddenDocumentMeshBase doc, DirectionBase dirZ, GearBuilder.ParentType typeParent, ReferencePointType typeRP, double dOffset, Vector vecBearingOffset, OMatrix matO)
```

#### Parameters

`gInfo` [GearGeometryInfo](https://github.com/AnsysVirtualMotion/DAFUL/blob/9110677a5f6a53d7604f8dfd35b4c5fceb59e8e0/DAFUL/ClassicPre/Data/VMDGearTrain/GearGeometryInfo.cs)

`con` IConnectable

`doc` [HiddenDocumentMeshBase](https://github.com/AnsysVirtualMotion/DAFUL/blob/9110677a5f6a53d7604f8dfd35b4c5fceb59e8e0/DAFUL/ClassicPre/Data/VMDGearTrain/HiddenDocumentFEBase.cs)
...
#### Returns
 ...
 [GearGeometryForRBEInMeshFree](https://github.com/AnsysVirtualMotion/DAFUL/blob/9110677a5f6a53d7604f8dfd35b4c5fceb59e8e0/DAFUL/ClassicPre/Data/VMDGearTrain/GeometryForRBEInMeshFree.cs)

### <a id="VM_Managed_DAFUL_Builder_GearTrain_AddGearToRBEInMeshFree_GetGearBuilder_VM_Managed_DAFUL_GearTrain_CAD_GeometryBase_"></a> GetGearBuilder\(GeometryBase\)

```csharp
protected override GearBuilderForRBEInFE GetGearBuilder(GeometryBase gearGeom)
```
...
### <a id="VM_Managed_DAFUL_Builder_GearTrain_AddGearToRBEInMeshFree_GetTmpGearGeometry_VM_Managed_DAFUL_GearTrain_GearGeometryInfo_VM_Managed_DAFUL_IConnectable_VM_Managed_DAFUL_GearTrain_HiddenDocumentMeshBase_VM_Managed_DirectionBase_VM_Managed_DAFUL_GearTrain_CAD_GearBuilder_ParentType_VM_Managed_DAFUL_GearTrain_CAD_ReferencePointType_System_Double_VM_Managed_Vector_VM_Managed_OMatrix_"></a> GetTmpGearGeometry\(GearGeometryInfo, IConnectable, HiddenDocumentMeshBase, DirectionBase, ParentType, ReferencePointType, double, Vector, OMatrix\)

```csharp
protected override GeometryBase GetTmpGearGeometry(GearGeometryInfo ggInfo, IConnectable con, HiddenDocumentMeshBase hiddenDoc, DirectionBase zAxis, GearBuilder.ParentType typeParent, ReferencePointType typeRP, double dOffset, Vector vecBearingOffset, OMatrix matO)
```
...
### <a id="VM_Managed_DAFUL_Builder_GearTrain_AddGearToRBEInMeshFree_RBEName_VM_Managed_DAFUL_IConnectable_"></a> RBEName\(IConnectable\)
