...
<a id="VM_Managed_DAFUL_Thermal_HeatFlowBase_1"></a>
...
```csharp
public abstract class HeatFlowBase<TProperty> : ThermalBase<TProperty>, IObservableObject, IDisposableObject, ILinkable, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IContainer, IEntity, IEntityBase, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, IHasName, IEnabled, IHasComment, IVisible, IDocumentOwner, INamed, INavigatorItem, IVisible, IMultiChangable, IHasProperty, IGroup, IDraw, IDrawIcon, IHasReplaceableEntity where TProperty : PropertyHeatFlowBase, new()
```
...
```csharp
public HeatFlowBase(string strName)
```
