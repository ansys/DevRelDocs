# Class DirectionOnFace
<a id="VM_Managed_DirectionOnFace"></a>
...
```csharp
public class DirectionOnFace : DirectionOnGeometryBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable, IHasReplaceableEntity
```
...
### <a id="VM_Managed_DirectionOnFace__ctor"></a> DirectionOnFace\(\)

Initializes a new instance of the <xref href="VM.Managed.DirectionOnFace" data-throw-if-not-resolved="false"></xref> class.
...
### <a id="VM_Managed_DirectionOnFace_GetSchema"></a> GetSchema\(\)
...
### <a id="VM_Managed_DirectionOnFace_ReadXml_System_Xml_XmlReader_"></a> ReadXml\(XmlReader\)
...
### <a id="VM_Managed_DirectionOnFace_WriteXml_System_Xml_XmlWriter_"></a> WriteXml\(XmlWriter\)
