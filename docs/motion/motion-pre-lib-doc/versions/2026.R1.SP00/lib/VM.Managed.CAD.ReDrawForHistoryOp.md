# Class ReDrawForHistoryOp
<a id="VM_Managed_CAD_ReDrawForHistoryOp"></a>
...
```csharp
public class ReDrawForHistoryOp : OperationBase, IOperation
```
...
### <a id="VM_Managed_CAD_ReDrawForHistoryOp__ctor_VM_Managed_Render_IDrawIcon_"></a> ReDrawForHistoryOp\(IDrawIcon\)

```csharp
public ReDrawForHistoryOp(IDrawIcon itfDrawIcon)
```
...
### <a id="VM_Managed_CAD_ReDrawForHistoryOp_Name"></a> Name
...
### <a id="VM_Managed_CAD_ReDrawForHistoryOp_Execute"></a> Execute\(\)
