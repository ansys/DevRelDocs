# Class PointOnVertex
<a id="VM_Managed_PointOnVertex"></a>
...
```csharp
public class PointOnVertex : PointOnGeometryBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable, IHasReplaceableEntity
```
