...
<a id="VM_Managed_DAFUL_GearTrain_HiddenDocumentMeshFreeBase"></a>
...
```csharp
public HiddenDocumentMeshFreeBase(UIntPtr docCore)
```
...
```csharp
public void ReAssemblyAssembledBody(AssembledBody ab)
```

#### Parameters

`ab` [AssembledBody](https://github.com/AnsysVirtualMotion/DAFUL/blob/9110677a5f6a53d7604f8dfd35b4c5fceb59e8e0/DAFUL/ClassicPre/Data/VMDFBase/AssembledBody.cs)
