...
<a id="VM_Managed_TransformThreePoints"></a>
...
```csharp
public class TransformThreePoints : TransformBase, IObservableObject, IDisposableObject, ILinkable, ILinkContainerEvent, IVerifiable, IExpression, ITransformBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasReplaceableEntity
```
...
```csharp
public TransformThreePoints(PointBase ptOrigin, PointBase ptZ, PointBase ptX)
```
...
### <a id="VM_Managed_TransformThreePoints_HasReplaceableEntity_VM_Models_Pre_IObjectBase_"></a> HasReplaceableEntity\(IObjectBase\)
...
### <a id="VM_Managed_TransformThreePoints_ReplaceEntity_VM_Models_Pre_IObjectBase_VM_Models_Pre_IObjectBase_"></a> ReplaceEntity\(IObjectBase, IObjectBase\)
