...
<a id="VM_Managed_DAFUL_Car_Operation_TireAnalysisHandlingTransient"></a>
...
```csharp
public class TireAnalysisHandlingTransient : TireAnalysisBase, IOperation
```
...
### <a id="VM_Managed_DAFUL_Car_Operation_TireAnalysisHandlingTransient__ctor_VM_Managed_Document_"></a> TireAnalysisHandlingTransient\(Document\)

Initializes a new instance of the <xref href="VM.Managed.DAFUL.Car.Operation.TireAnalysisHandlingTransient" data-throw-if-not-resolved="false"></xref> class.

```csharp
public TireAnalysisHandlingTransient(Document doc)
```
...
### <a id="VM_Managed_DAFUL_Car_Operation_TireAnalysisHandlingTransient__ctor_VM_Managed_Operation_JournalParameter_"></a> TireAnalysisHandlingTransient\(JournalParameter\)

Initializes a new instance of the <xref href="VM.Managed.DAFUL.Car.Operation.TireAnalysisHandlingTransient" data-throw-if-not-resolved="false"></xref> class.

```csharp
public TireAnalysisHandlingTransient(JournalParameter jp)
```
...
### <a id="VM_Managed_DAFUL_Car_Operation_TireAnalysisHandlingTransient_ExecuteName"></a> ExecuteName
...
### <a id="VM_Managed_DAFUL_Car_Operation_TireAnalysisHandlingTransient_Name"></a> Name
...
### <a id="VM_Managed_DAFUL_Car_Operation_TireAnalysisHandlingTransient_ExecuteCore_System_Int32_VM_Managed_DAFUL_Car_TireTestRigDocument_VM_Managed_DAFUL_Car_TireAnalysisConfigurationBase__"></a> ExecuteCore\(int, TireTestRigDocument, ref TireAnalysisConfigurationBase\)
...
### <a id="VM_Managed_DAFUL_Car_Operation_TireAnalysisHandlingTransient_UpdateUI_VM_Managed_UI_IUIUpdate_VM_Managed_Document_"></a> UpdateUI\(IUIUpdate, Document\)
