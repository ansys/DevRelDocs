...
<a id="VM_Managed_DAFUL_IContactableRigid"></a>
...
```csharp
public interface IContactableRigid : IContactable, IGeometricalComponent, IEntityRelation, IBodyAnalysisType, IHasBody
```
