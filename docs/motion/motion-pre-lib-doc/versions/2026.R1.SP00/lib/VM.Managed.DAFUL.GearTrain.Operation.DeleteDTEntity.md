...
<a id="VM_Managed_DAFUL_GearTrain_Operation_DeleteDTEntity"></a>
...
```csharp
public class DeleteDTEntity : OperationBase, IOperation
```
...
```csharp
public DeleteDTEntity(ObjectBase[] obj)
```
...
```csharp
public DeleteDTEntity(JournalParameter jp)
```
