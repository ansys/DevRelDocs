...
<a id="VM_Managed_DAFUL_FE_SetPatch_PatchIndexContainer"></a>
...
```csharp
public sealed class SetPatch.PatchIndexContainer : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
