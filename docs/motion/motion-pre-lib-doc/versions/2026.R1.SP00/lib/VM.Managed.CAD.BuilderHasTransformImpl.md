...
<a id="VM_Managed_CAD_BuilderHasTransformImpl"></a>
...
```csharp
public abstract class BuilderHasTransformImpl : BuilderHasTransform, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IHasReplaceableEntity
```
