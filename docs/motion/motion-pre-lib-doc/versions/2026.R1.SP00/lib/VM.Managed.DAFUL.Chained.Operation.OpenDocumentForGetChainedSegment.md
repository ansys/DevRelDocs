...
```csharp
public class OpenDocumentForGetChainedSegment : OperationBase, IOperation
```
...
```csharp
public OpenDocumentForGetChainedSegment(string strFullPath)
```
...
```csharp
public OpenDocumentForGetChainedSegment(JournalParameter jp)
```
