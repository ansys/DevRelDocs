...
<a id="VM_Managed_CAD_BuilderMultiUniteSimple"></a>
...
```csharp
public class BuilderMultiUniteSimple : BuilderMultiUnite, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IHasReplaceableEntity
```
...
[BuilderMultiUnite.CreateParameter\(\)](VM.Managed.CAD.BuilderMultiUnite.md\#VM\_Managed\_CAD\_BuilderMultiUnite\_CreateParameter), 
[BuilderMultiUnite.FillParameter\(BuilderParamBase\)](VM.Managed.CAD.BuilderMultiUnite.md\#VM\_Managed\_CAD\_BuilderMultiUnite\_FillParameter\_VM\_CAD\_Builders\_BuilderParamBase\_), 
...
```csharp
public BuilderMultiUniteSimple(Builder builderTarget, Builder builderTool)
```
