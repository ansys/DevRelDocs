...
<a id="VM_Managed_CAD_BuilderSphereSimple"></a>
...
```csharp
public class BuilderSphereSimple : BuilderSphere, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IHasReplaceableEntity
```
...
[BuilderSphereSimple](VM.Managed.CAD.BuilderSphereSimple.md)
...
[BuilderSphere.CheckValidationAboutBuild\(\)](VM.Managed.CAD.BuilderSphere.md\#VM\_Managed\_CAD\_BuilderSphere\_CheckValidationAboutBuild), 
[BuilderSphere.CreateParameter\(\)](VM.Managed.CAD.BuilderSphere.md\#VM\_Managed\_CAD\_BuilderSphere\_CreateParameter), 
[BuilderSphere.FillParameter\(BuilderParamBase\)](VM.Managed.CAD.BuilderSphere.md\#VM\_Managed\_CAD\_BuilderSphere\_FillParameter\_VM\_CAD\_Builders\_BuilderParamBase\_), 
[BuilderSphere.\_Radius](VM.Managed.CAD.BuilderSphere.md\#VM\_Managed\_CAD\_BuilderSphere\_\_Radius), 
[BuilderSphere.\_CenterPosition](VM.Managed.CAD.BuilderSphere.md\#VM\_Managed\_CAD\_BuilderSphere\_\_CenterPosition), 
...
### <a id="VM_Managed_CAD_BuilderSphereSimple_HasReplaceableEntity_VM_Models_Pre_IObjectBase_"></a> HasReplaceableEntity\(IObjectBase\)
...
### <a id="VM_Managed_CAD_BuilderSphereSimple_ReplaceEntity_VM_Models_Pre_IObjectBase_VM_Models_Pre_IObjectBase_"></a> ReplaceEntity\(IObjectBase, IObjectBase\)
