...
```csharp
public class PropertyEHDBearing : Property, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IContainer, ILinkContainer, IOwned, IHasID
```
...
```csharp
public TransformBase BearingTransform { get; set; }
```
...
```csharp
public ExpressionValueVariable Compliance { get; set; }
```
...
```csharp
public ExpressionValueVariable DynamicViscosity { get; set; }
```
...
```csharp
public ExpressionValueVariable ElasticFactor { get; set; }
```
...
```csharp
public ExpressionValueVariable ElasticModulus { get; set; }
```
...
```csharp
public ExpressionValueVariable JournalRadius { get; set; }
```
...
```csharp
public TransformBase JournalTransform { get; set; }
```
...
```csharp
public ExpressionValueVariable NumberOfAxialNode { get; set; }
```
...
```csharp
public ExpressionValueVariable NumberOfCircumferentialNode { get; set; }
```
...
```csharp
public ExpressionValueVariable SurfaceRoughness { get; set; }
```
...
```csharp
public bool UseAsperityContact { get; set; }
```
