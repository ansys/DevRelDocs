...
```csharp
public class AttributeSurfaceOption : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public AttributeSurfaceOption(Variable halfthickness, SurfaceSmoothing surfacesmoothingtype)
```
...
`surfacesmoothingtype` [SurfaceSmoothing](VM.Managed.DAFUL.SurfaceSmoothing.md)

The surface smoothing type.
