...
### GetHeatBetween\(IEnumerable<INodeInfo\>, IEnumerable<INodeInfo\>\)
...
### GetHeatBetween\(IEnumerable<INodeInfo\>, IEnumerable<ITieInfo\>\)
...
### GetHeatBetweenSubmodels\(string, string\)
...
### GetHeatMap\(IEnumerable<INodeInfo\>\)
...
### GetHeatMap\(IEnumerable<SindaName\>\)
