...
A custom control for displaying output text, with optional buttons for copying and saving text.
...
[UserControl.OnCreateControl\(\)](https://learn.microsoft.com/dotnet/api/system.windows.forms.usercontrol.oncreatecontrol), 
[UserControl.OnLoad\(EventArgs\)](https://learn.microsoft.com/dotnet/api/system.windows.forms.usercontrol.onload), 
[UserControl.OnResize\(EventArgs\)](https://learn.microsoft.com/dotnet/api/system.windows.forms.usercontrol.onresize), 
[UserControl.OnMouseDown\(MouseEventArgs\)](https://learn.microsoft.com/dotnet/api/system.windows.forms.usercontrol.onmousedown), 
[UserControl.WndProc\(ref Message\)](https://learn.microsoft.com/dotnet/api/system.windows.forms.usercontrol.wndproc), 
[UserControl.AutoSize](https://learn.microsoft.com/dotnet/api/system.windows.forms.usercontrol.autosize), 
[UserControl.AutoSizeMode](https://learn.microsoft.com/dotnet/api/system.windows.forms.usercontrol.autosizemode), 
[UserControl.AutoValidate](https://learn.microsoft.com/dotnet/api/system.windows.forms.usercontrol.autovalidate), 
[UserControl.BorderStyle](https://learn.microsoft.com/dotnet/api/system.windows.forms.usercontrol.borderstyle), 
[UserControl.CreateParams](https://learn.microsoft.com/dotnet/api/system.windows.forms.usercontrol.createparams), 
[UserControl.DefaultSize](https://learn.microsoft.com/dotnet/api/system.windows.forms.usercontrol.defaultsize), 
[UserControl.AutoSizeChanged](https://learn.microsoft.com/dotnet/api/system.windows.forms.usercontrol.autosizechanged), 
[UserControl.AutoValidateChanged](https://learn.microsoft.com/dotnet/api/system.windows.forms.usercontrol.autovalidatechanged), 
[UserControl.Load](https://learn.microsoft.com/dotnet/api/system.windows.forms.usercontrol.load), 
