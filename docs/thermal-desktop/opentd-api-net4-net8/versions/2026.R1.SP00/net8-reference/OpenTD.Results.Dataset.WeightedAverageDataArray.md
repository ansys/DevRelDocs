...
```csharp
public WeightedAverageDataArray(DataSubtype dataSubtype, DataSubtype weightingSubtype, ItemIdentifierCollection itemIdentifiers, IDataset dataset)
```
...
`weightingSubtype` [DataSubtype](OpenTD.Results.Dataset.DataSubtype.md)

`itemIdentifiers` [ItemIdentifierCollection](OpenTD.Results.Dataset.ItemIdentifierCollection.md)
...
```csharp
public DataArrayCollection MultipleWeightingArrays { get; set; }
```
...
```csharp
public DataArray WeightingArray { get; set; }
```
