...
subdirectory _user_routines_ , that is,
...
routines, users must explicitly include auxiliary information in the _Gas-
phase Kinetics_ or _Surface Kinetics_ input file that activates the user
subroutine.
