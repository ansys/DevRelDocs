...
| Name | Description |
|--------------------------------------|------------------------------------------------|
| [`WriteError`](#ILog.WriteError)     | Adds a new error message entry into the log.   |
| [`WriteMessage`](#ILog.WriteMessage) | Adds a new message entry into the log.         |
| [`WriteWarning`](#ILog.WriteWarning) | Adds a new warning message entry into the log. |
