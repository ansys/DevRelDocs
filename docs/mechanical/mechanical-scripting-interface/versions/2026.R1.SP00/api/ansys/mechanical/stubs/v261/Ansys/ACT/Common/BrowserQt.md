...
<a id="ansys.mechanical.stubs.v261.Ansys.ACT.Common.BrowserQt"></a>
...
### BrowserQt.BeginInvoke(method: System.Delegate, args: Any) → System.IAsyncResult
...
### BrowserQt.BringToFront() → [None](https://docs.python.org/3/library/constants.html#None)
...
### BrowserQt.Dispose() → [None](https://docs.python.org/3/library/constants.html#None)
...
### BrowserQt.EndInvoke(asyncResult: System.IAsyncResult) → Any
...
### BrowserQt.FindParentDialog() → Ansys.UI.Toolkit.Dialog
...
### BrowserQt.FindParentWindow() → Ansys.UI.Toolkit.Window
...
### BrowserQt.FindTopMostParentControl() → Ansys.UI.Toolkit.Control
...
### BrowserQt.Focus() → [None](https://docs.python.org/3/library/constants.html#None)
...
### BrowserQt.GetPreferredHeightForWidth(width: [int](https://docs.python.org/3/library/functions.html#int)) → [int](https://docs.python.org/3/library/functions.html#int)
...
### BrowserQt.GetPreferredSize() → Ansys.UI.Toolkit.Drawing.Size
...
### BrowserQt.Hide() → [None](https://docs.python.org/3/library/constants.html#None)
...
### BrowserQt.Invalidate() → [None](https://docs.python.org/3/library/constants.html#None)
...
### BrowserQt.Invoke(method: System.Delegate, args: Any) → Any
...
### BrowserQt.Refresh() → [None](https://docs.python.org/3/library/constants.html#None)
...
### BrowserQt.SendToBack() → [None](https://docs.python.org/3/library/constants.html#None)
...
### BrowserQt.Show() → [None](https://docs.python.org/3/library/constants.html#None)
...
### BrowserQt.Update() → [None](https://docs.python.org/3/library/constants.html#None)
