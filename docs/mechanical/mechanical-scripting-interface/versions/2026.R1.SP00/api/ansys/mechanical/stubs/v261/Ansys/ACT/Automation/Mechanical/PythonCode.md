...
<a id="ansys.mechanical.stubs.v261.Ansys.ACT.Automation.Mechanical.PythonCode"></a>
...
| [`ResetPropertyProviderText`](#PythonCode.ResetPropertyProviderText) | Resets the code inside the property provider tab with default property provider text. Any changes made to the property provider text are lost. |
...
| [`PropertyProvider`](#PythonCode.PropertyProvider)               | Gets or sets the property provider instance associated with this python code object.                 |
| [`PropertyProviderText`](#PythonCode.PropertyProviderText)       | Gets or sets the text in the property provider tab for the Python Code object.                       |
| [`ScriptEngineType`](#PythonCode.ScriptEngineType)               | Gets or sets what type of engine used to execute the scripts associated with the Python Code object. |
...
### *property* PythonCode.DataModelObjectCategory *: [Ansys.Mechanical.DataModel.Enums.DataModelObjectCategory](../../../Mechanical/DataModel/Enums/DataModelObjectCategory.md#ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.Enums.DataModelObjectCategory) | [None](https://docs.python.org/3/library/constants.html#None)*
...
<a id="PythonCode.PropertyProviderText"></a>

### *property* PythonCode.PropertyProviderText *: [str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)*

Gets or sets the text in the property provider tab for the Python Code object.

<!-- !! processed by numpydoc !! -->

<a id="PythonCode.ScriptEngineType"></a>

### *property* PythonCode.ScriptEngineType *: [Ansys.Mechanical.DataModel.MechanicalEnums.Scripting.EngineType](../../../Mechanical/DataModel/MechanicalEnums/Scripting/EngineType.md#ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.MechanicalEnums.Scripting.EngineType) | [None](https://docs.python.org/3/library/constants.html#None)*
...
### PythonCode.Duplicate() → [Ansys.Mechanical.DataModel.Interfaces.IDataModelObject](../../../Mechanical/DataModel/Interfaces/IDataModelObject.md#ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.Interfaces.IDataModelObject)
...
### PythonCode.GroupSimilarObjects() → [Ansys.ACT.Automation.Mechanical.TreeGroupingFolder](TreeGroupingFolder.md#ansys.mechanical.stubs.v261.Ansys.ACT.Automation.Mechanical.TreeGroupingFolder)
...
<a id="PythonCode.ResetPropertyProviderText"></a>

### PythonCode.ResetPropertyProviderText() → [None](https://docs.python.org/3/library/constants.html#None)
