...
<a id="ansys.mechanical.stubs.v261.Ansys.ACT.Automation.Mechanical.FE.CDB.SFECommand"></a>
...
| [`ToCdbCommandString`](#SFECommand.ToCdbCommandString) | Gets the command text formatted as a CDB file entry. |
