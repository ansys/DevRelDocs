...
| Name | Description |
|-----------------------------------------|-------------------------------------------------------|
| [`IsEnabled`](#IBreakpoint.IsEnabled)   | Specifies whether the breakpoint is enabled or not.   |
| [`Line`](#IBreakpoint.Line)             | The line number on which the breakpoint is.           |
| [`SourceFile`](#IBreakpoint.SourceFile) | The file to which the breakpoint is attached.         |
