...
<a id="ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.Enums.LoadVariableVariationType"></a>

#### *class* Ansys.Mechanical.DataModel.Enums.LoadVariableVariationType(\*args, \*\*kwds)
...
| [`PSDPressure`](#LoadVariableVariationType.PSDPressure) |
...
### LoadVariableVariationType.IndependentsEnd *= 53*
...
### LoadVariableVariationType.PSDEnd *= 556*

<a id="LoadVariableVariationType.PSDGAcceleration"></a>

### LoadVariableVariationType.PSDGAcceleration *= 551*

<a id="LoadVariableVariationType.PSDPressure"></a>

### LoadVariableVariationType.PSDPressure *= 555*
