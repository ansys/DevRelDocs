...
<a id="ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.Enums.SectionPlaneCappingType"></a>

#### *class* Ansys.Mechanical.DataModel.Enums.SectionPlaneCappingType(\*args, \*\*kwds)
...
### SectionPlaneCappingType.Hide *= -1*
