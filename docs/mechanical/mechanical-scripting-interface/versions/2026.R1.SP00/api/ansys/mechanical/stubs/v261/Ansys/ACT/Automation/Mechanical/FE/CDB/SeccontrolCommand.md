...
<a id="ansys.mechanical.stubs.v261.Ansys.ACT.Automation.Mechanical.FE.CDB.SeccontrolCommand"></a>
...
| [`ToCdbCommandString`](#SeccontrolCommand.ToCdbCommandString) | Gets the command text formatted as a CDB file entry. |
| [`Values`](#SeccontrolCommand.Values)                         | Gets the values.                                     |
