...
<a id="ansys.mechanical.stubs.v252.Ansys.ACT.Automation.Mechanical.FE.CDB.CPCommand"></a>
...
| [`ToCdbCommandString`](#CPCommand.ToCdbCommandString) | Gets the command text formatted as a CDB file entry. |
