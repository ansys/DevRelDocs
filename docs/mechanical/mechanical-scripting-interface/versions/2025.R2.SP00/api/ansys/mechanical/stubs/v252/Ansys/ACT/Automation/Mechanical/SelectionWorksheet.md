...
<a id="ansys.mechanical.stubs.v252.Ansys.ACT.Automation.Mechanical.SelectionWorksheet"></a>
...
### SelectionWorksheet.AddRow() → [int](https://docs.python.org/3/library/functions.html#int)
...
### SelectionWorksheet.DeleteRow(index: [int](https://docs.python.org/3/library/functions.html#int)) → [None](https://docs.python.org/3/library/constants.html#None)
...
### SelectionWorksheet.Generate() → [None](https://docs.python.org/3/library/constants.html#None)
...
### SelectionWorksheet.GetAction(index: [int](https://docs.python.org/3/library/functions.html#int)) → Ansys.Mechanical.DataModel.Enums.NamedSelectionWorksheetAction
...
### SelectionWorksheet.GetBodyTypeValue(index: [int](https://docs.python.org/3/library/functions.html#int)) → Ansys.Mechanical.DataModel.Enums.NamedSelectionWorksheetBodyTypeValues
...
### SelectionWorksheet.GetCoordinateSystemSelection(index: [int](https://docs.python.org/3/library/functions.html#int)) → [int](https://docs.python.org/3/library/functions.html#int)
...
### SelectionWorksheet.GetCriterion(index: [int](https://docs.python.org/3/library/functions.html#int)) → Ansys.Mechanical.DataModel.Enums.NamedSelectionWorksheetCriterion
...
### SelectionWorksheet.GetCriterionActive(index: [int](https://docs.python.org/3/library/functions.html#int)) → [bool](https://docs.python.org/3/library/functions.html#bool)
...
### SelectionWorksheet.GetEdgeTypeValue(index: [int](https://docs.python.org/3/library/functions.html#int)) → Ansys.Mechanical.DataModel.Enums.NamedSelectionWorksheetEdgeTypeValues
...
### SelectionWorksheet.GetFaceTypeValue(index: [int](https://docs.python.org/3/library/functions.html#int)) → Ansys.Mechanical.DataModel.Enums.NamedSelectionWorksheetFaceTypeValues
...
### SelectionWorksheet.GetGeometryType(index: [int](https://docs.python.org/3/library/functions.html#int)) → Ansys.Mechanical.DataModel.Enums.NamedSelectionWorksheetEntityType
...
### SelectionWorksheet.GetLowerBound(index: [int](https://docs.python.org/3/library/functions.html#int)) → [float](https://docs.python.org/3/library/functions.html#float)
...
### SelectionWorksheet.GetMeshElementTypeValue(index: [int](https://docs.python.org/3/library/functions.html#int)) → [Ansys.Mechanical.DataModel.Enums.MeshElementShape](../../../Mechanical/DataModel/Enums/MeshElementShape.md#ansys.mechanical.stubs.v252.Ansys.Mechanical.DataModel.Enums.MeshElementShape)
...
### SelectionWorksheet.GetOperator(index: [int](https://docs.python.org/3/library/functions.html#int)) → [Ansys.Mechanical.DataModel.Enums.NamedSelectionWorksheetOperator](../../../Mechanical/DataModel/Enums/NamedSelectionWorksheetOperator.md#ansys.mechanical.stubs.v252.Ansys.Mechanical.DataModel.Enums.NamedSelectionWorksheetOperator)
...
### SelectionWorksheet.GetStringValue(index: [int](https://docs.python.org/3/library/functions.html#int)) → [str](https://docs.python.org/3/library/stdtypes.html#str)
...
### SelectionWorksheet.GetTag(index: [int](https://docs.python.org/3/library/functions.html#int)) → [str](https://docs.python.org/3/library/stdtypes.html#str)
...
### SelectionWorksheet.GetUpperBound(index: [int](https://docs.python.org/3/library/functions.html#int)) → [float](https://docs.python.org/3/library/functions.html#float)
...
### SelectionWorksheet.GetValue(index: [int](https://docs.python.org/3/library/functions.html#int)) → [float](https://docs.python.org/3/library/functions.html#float)
...
### SelectionWorksheet.SetAction(index: [int](https://docs.python.org/3/library/functions.html#int), newVal: Ansys.Mechanical.DataModel.Enums.NamedSelectionWorksheetAction) → [None](https://docs.python.org/3/library/constants.html#None)
...
### SelectionWorksheet.SetBodyTypeValue(index: [int](https://docs.python.org/3/library/functions.html#int), newVal: Ansys.Mechanical.DataModel.Enums.NamedSelectionWorksheetBodyTypeValues) → [None](https://docs.python.org/3/library/constants.html#None)
...
### SelectionWorksheet.SetCoordinateSystemSelection(index: [int](https://docs.python.org/3/library/functions.html#int), newVal: [int](https://docs.python.org/3/library/functions.html#int)) → [None](https://docs.python.org/3/library/constants.html#None)
...
### SelectionWorksheet.SetCriterion(index: [int](https://docs.python.org/3/library/functions.html#int), value: Ansys.Mechanical.DataModel.Enums.NamedSelectionWorksheetCriterion) → [None](https://docs.python.org/3/library/constants.html#None)
...
### SelectionWorksheet.SetCriterionActive(index: [int](https://docs.python.org/3/library/functions.html#int), newVal: [bool](https://docs.python.org/3/library/functions.html#bool)) → [None](https://docs.python.org/3/library/constants.html#None)
...
### SelectionWorksheet.SetEdgeTypeValue(index: [int](https://docs.python.org/3/library/functions.html#int), newVal: Ansys.Mechanical.DataModel.Enums.NamedSelectionWorksheetEdgeTypeValues) → [None](https://docs.python.org/3/library/constants.html#None)
...
### SelectionWorksheet.SetEntityType(index: [int](https://docs.python.org/3/library/functions.html#int), newVal: Ansys.Mechanical.DataModel.Enums.NamedSelectionWorksheetEntityType) → [None](https://docs.python.org/3/library/constants.html#None)
...
### SelectionWorksheet.SetFaceTypeValue(index: [int](https://docs.python.org/3/library/functions.html#int), newVal: Ansys.Mechanical.DataModel.Enums.NamedSelectionWorksheetFaceTypeValues) → [None](https://docs.python.org/3/library/constants.html#None)
...
### SelectionWorksheet.SetLowerBound(index: [int](https://docs.python.org/3/library/functions.html#int), newVal: [float](https://docs.python.org/3/library/functions.html#float)) → [None](https://docs.python.org/3/library/constants.html#None)
...
### SelectionWorksheet.SetMeshElementTypeValue(index: [int](https://docs.python.org/3/library/functions.html#int), newVal: [Ansys.Mechanical.DataModel.Enums.MeshElementShape](../../../Mechanical/DataModel/Enums/MeshElementShape.md#ansys.mechanical.stubs.v252.Ansys.Mechanical.DataModel.Enums.MeshElementShape)) → [None](https://docs.python.org/3/library/constants.html#None)
...
### SelectionWorksheet.SetOperator(index: [int](https://docs.python.org/3/library/functions.html#int), newVal: [Ansys.Mechanical.DataModel.Enums.NamedSelectionWorksheetOperator](../../../Mechanical/DataModel/Enums/NamedSelectionWorksheetOperator.md#ansys.mechanical.stubs.v252.Ansys.Mechanical.DataModel.Enums.NamedSelectionWorksheetOperator)) → [None](https://docs.python.org/3/library/constants.html#None)
...
### SelectionWorksheet.SetStringValue(index: [int](https://docs.python.org/3/library/functions.html#int), newVal: [str](https://docs.python.org/3/library/stdtypes.html#str)) → [None](https://docs.python.org/3/library/constants.html#None)
...
### SelectionWorksheet.SetTag(index: [int](https://docs.python.org/3/library/functions.html#int), newVal: [str](https://docs.python.org/3/library/stdtypes.html#str)) → [None](https://docs.python.org/3/library/constants.html#None)
...
### SelectionWorksheet.SetUpperBound(index: [int](https://docs.python.org/3/library/functions.html#int), newVal: [float](https://docs.python.org/3/library/functions.html#float)) → [None](https://docs.python.org/3/library/constants.html#None)
...
### SelectionWorksheet.SetValue(index: [int](https://docs.python.org/3/library/functions.html#int), newVal: [float](https://docs.python.org/3/library/functions.html#float)) → [None](https://docs.python.org/3/library/constants.html#None)
