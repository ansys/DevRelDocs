...
<a id="ansys.mechanical.stubs.v252.Ansys.ACT.Mechanical.Fields.Adapters.FieldAdapterManager"></a>
...
### *classmethod* FieldAdapterManager.RegisterNewAdapter(definition: Ansys.ACT.Mechanical.Fields.Adapters.FieldAdapter.IDefinition) → [None](https://docs.python.org/3/library/constants.html#None)
...
### *classmethod* FieldAdapterManager.UnregisterAdapter(index: [int](https://docs.python.org/3/library/functions.html#int)) → [None](https://docs.python.org/3/library/constants.html#None)
