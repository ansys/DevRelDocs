...
<a id="ansys.mechanical.stubs.v252.Ansys.ACT.Automation.Mechanical.Results.CompositeFailureResults.TsaiWuSettings"></a>
...
### TsaiWuSettings.Reset() → [None](https://docs.python.org/3/library/constants.html#None)
