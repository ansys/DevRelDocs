...
<a id="ansys.mechanical.stubs.v252.Ansys.Mechanical.DataModel.Results.ResultDataTable"></a>
...
### ResultDataTable.ContainsKey(key: [str](https://docs.python.org/3/library/stdtypes.html#str)) → [bool](https://docs.python.org/3/library/functions.html#bool)
