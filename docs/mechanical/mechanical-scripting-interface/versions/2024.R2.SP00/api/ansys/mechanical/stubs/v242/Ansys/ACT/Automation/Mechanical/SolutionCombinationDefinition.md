...
### SolutionCombinationDefinition.AddBaseCase(name: [str](https://docs.python.org/3/library/stdtypes.html#str), analysis: [Ansys.ACT.Automation.Mechanical.Analysis](Analysis.md#ansys.mechanical.stubs.v242.Ansys.ACT.Automation.Mechanical.Analysis), time: [float](https://docs.python.org/3/library/functions.html#float))
...
### SolutionCombinationDefinition.SetBaseCaseAnalysis(index: [int](https://docs.python.org/3/library/functions.html#int), analysis: [Ansys.ACT.Automation.Mechanical.Analysis](Analysis.md#ansys.mechanical.stubs.v242.Ansys.ACT.Automation.Mechanical.Analysis))
