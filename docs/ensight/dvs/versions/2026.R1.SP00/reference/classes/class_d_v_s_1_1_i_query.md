...
An instance of this object can be initially created by calling [DVS::CREATE\_QUERY\_INSTANCE()](../namespaces/namespace_d_v_s.md#function-create_query_instance). A URI must then be added via [DVS::IQuery::add\_uri()](#function-add_uri). Then you can either start querying the dataset or you can add filters by chaining queries via [DVS::IQuery::filter()](#function-filter). When finished to clean up memory call [DVS::IQuery::release()](#function-release).





**IMPORTANT**: Calling [DVS::IQuery::release()](#function-release) destroys all chained queries as well and any object references retrieved from the query from calls such as [DVS::IQuery::get\_part()](#function-get_num_parts)
...
```
 See [Cache URIs](../../user-guide/dvs-uri.md#cache-uris) and [Query Stanzas](../../user-guide/dvs-filtering.md#query-stanzas)) for more information on cache URIs and queries.

## Members

* [add\_uri](#function-add_uri)
* [clear\_data](#function-clear_data)
* [filter](#function-filter)
* [get\_chunks\_per\_rank](#function-get_chunks_per_rank)
* [get\_dataset](#function-get_dataset)
* [get\_hash\_available](#function-get_hash_available)
* [get\_mesh\_chunk](#function-get_mesh_chunk)
* [get\_num\_chunks\_per\_rank](#function-get_num_chunks_per_rank)
* [get\_num\_datasets](#function-get_num_datasets)
* [get\_num\_mesh\_chunks](#function-get_num_mesh_chunks)
* [get\_num\_parts](#function-get_num_parts)
* [get\_num\_plot\_chunks](#function-get_num_plot_chunks)
* [get\_num\_plots](#function-get_num_plots)
* [get\_num\_ranks](#function-get_num_ranks)
* [get\_num\_servers](#function-get_num_servers)
* [get\_num\_timesteps](#function-get_num_timesteps)
* [get\_num\_variables](#function-get_num_variables)
* [get\_part](#function-get_part)
* [get\_plot](#function-get_plot)
* [get\_plot\_chunk](#function-get_plot_chunk)
* [get\_ranks](#function-get_ranks)
* [get\_timesteps](#function-get_timesteps)
* [get\_variable](#function-get_variable)
* [get\_variable\_data](#function-get_variable_data)
* [IQuery](#class-dvsiquery)
* [IQuery](#class-dvsiquery)
* [IQuery](#class-dvsiquery)
* [operator=](#class-dvsiquery)
* [operator=](#class-dvsiquery)
* [release](#function-release)
* [set\_logger](#function-set_logger)
* [set\_server\_mod](#function-set_server_mod)
* [~IQuery](#class-dvsiquery)
...
* **uri**: URI of a cache. See [Cache URIs](../../user-guide/dvs-uri.md#cache-uris)


**Returns**:

[dvs\_ret](../files/dynamic__visualization__store__error__codes_8h.md#typedef-dvs_ret) DVS_NONE on success, otherwise see method description
...
* **[filter](class_d_v_s_1_1_i_query.md#class_d_v_s_1_1_i_query_1a8a810da09342690eb371b324079f206e)**: the filter to append to the new chained child query. See [Query Stanzas](../../user-guide/dvs-filtering.md#query-stanzas)).
...
[dvs\_ret](../files/dynamic__visualization__store__error__codes_8h.md#typedef-dvs_ret) DVS_NONE if success, otherwise see method description
...
[dvs\_ret](../files/dynamic__visualization__store__error__codes_8h.md#typedef-dvs_ret) DVS_NONE on success, else see method description
...
[dvs\_ret](../files/dynamic__visualization__store__error__codes_8h.md#typedef-dvs_ret) [dvs\_ret](../files/dynamic__visualization__store__error__codes_8h.md#typedef-dvs_ret) DVS_NONE on success, else see method description
...
[dvs\_ret](../files/dynamic__visualization__store__error__codes_8h.md#typedef-dvs_ret) DVS_NONE if no errors, DVS_NO_DATA if no data found, otherwise see method description
