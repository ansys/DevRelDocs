...
[dvs\_ret](../files/dynamic__visualization__store__error__codes_8h.md#dynamic__visualization__store__error__codes_8h_1a1d7466ae72e89fe36cbf2408b4f7d9c1) TODO
...
**Return type**: [dvs\_ret](../files/dynamic__visualization__store__error__codes_8h.md#dynamic__visualization__store__error__codes_8h_1a1d7466ae72e89fe36cbf2408b4f7d9c1)
...
[dvs\_ret](../files/dynamic__visualization__store__error__codes_8h.md#dynamic__visualization__store__error__codes_8h_1a1d7466ae72e89fe36cbf2408b4f7d9c1) DVS_NONE on success, otherwise see method description
...
* const [dvs\_part\_info](../structures/structdvs__part__info.md#structdvs__part__info) * **part_info**
* uint32_t **num_parts**
...
* const [dvs\_var\_info](../structures/structdvs__var__info.md#structdvs__var__info) * **var_info**
* uint32_t **num_vars**
...
* const [dvs\_plot\_info](../structures/structdvs__plot__info.md#structdvs__plot__info) * **plot_info**
* uint32_t **num_plots**
...
Get the number of [dvs\_part\_info](../structures/structdvs__part__info.md#structdvs__part__info) objects this client has stored.
...
uint32_t number of [dvs\_part\_info](../structures/structdvs__part__info.md#structdvs__part__info) objects
...
Get the number of [dvs\_var\_info](../structures/structdvs__var__info.md#structdvs__var__info) objects this client has stored.
...
uint32_t number of [dvs\_var\_info](../structures/structdvs__var__info.md#structdvs__var__info) objects
...
Get the number of [dvs\_plot\_info](../structures/structdvs__plot__info.md#structdvs__plot__info) objects this client has stored.
...
uint32_t number of [dvs\_plot\_info](../structures/structdvs__plot__info.md#structdvs__plot__info) objects
...
Get the [dvs\_part\_info](../structures/structdvs__part__info.md#structdvs__part__info) object for a specific index.

Note: This only gets the [dvs\_part\_info](../structures/structdvs__part__info.md#structdvs__part__info) objects from the current client it does not query the server for the information
...
* **index**: index of the [dvs\_part\_info](../structures/structdvs__part__info.md#structdvs__part__info) object to retrieve
...
**Return type**: const [dvs\_part\_info](../structures/structdvs__part__info.md#structdvs__part__info) *
...
[dvs\_ret](../files/dynamic__visualization__store__error__codes_8h.md#dynamic__visualization__store__error__codes_8h_1a1d7466ae72e89fe36cbf2408b4f7d9c1) DVS_NONE on success, else see method description
...
Get the [dvs\_var\_info](../structures/structdvs__var__info.md#structdvs__var__info) object for a specific index.

Note: This only gets the [dvs\_var\_info](../structures/structdvs__var__info.md#structdvs__var__info) objects from the current client it does not query the server for the information
...
* **index**: index of the [dvs\_var\_info](../structures/structdvs__var__info.md#structdvs__var__info) object to retrieve
...
**Return type**: const [dvs\_var\_info](../structures/structdvs__var__info.md#structdvs__var__info) *
...
Get the [dvs\_plot\_info](../structures/structdvs__plot__info.md#structdvs__plot__info) object for a specific index.

Note: This only gets the [dvs\_plot\_info](../structures/structdvs__plot__info.md#structdvs__plot__info) objects from the current client it does not query the server for the information
...
* **index**: index of the [dvs\_plot\_info](../structures/structdvs__plot__info.md#structdvs__plot__info) object to retrieve
...
**Return type**: const [dvs\_plot\_info](../structures/structdvs__plot__info.md#structdvs__plot__info) *
...
**Note:** iblanking information is sent via [update\_var\_node()](class_d_v_s_1_1_i_client.md#class_d_v_s_1_1_i_client_1ae67a2884dd8f68f4757d8d7fac3828d3) using [SCALAR](../files/dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1af6aa6351345da4151507012681b3aff0a7efbb6cac96595e63e8fa171bde1eb68) as the var type and [DVS\_STRUCTURED\_IBLANKED\_NODES](../files/dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1aa405c87964a066405de5426a3089702b) as the variable id





**Note:** Ghost element information is sent [update\_var\_element()](class_d_v_s_1_1_i_client.md#class_d_v_s_1_1_i_client_1aec8ed14b290237049976f68cb81b200f) using [SCALAR](../files/dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1af6aa6351345da4151507012681b3aff0a7efbb6cac96595e63e8fa171bde1eb68) as the var type and [DVS\_STRUCTURED\_GHOST\_ELEMENTS](../files/dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1a5f85a0e808c3bad9b9b616e62f5724c0) as the variable id
...
* uint32_t **part_id**
* [dvs\_element\_type](../files/dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1af1c8824b29a0ab747460216716cc2895) **type**
...
* [dvs\_var\_type](../files/dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1af6aa6351345da4151507012681b3aff0) **var_type**
* uint32_t **var_id**
* const float * **values**
* uint32_t **num_values**
...
* **var_type**: type of var see ensight_dynmaic_data_enums.h: [dvs\_element\_type](../files/dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1af1c8824b29a0ab747460216716cc2895) for more info
* **var_id**: id of variable
* **part_id**: id of part
...
* [dvs\_element\_type](../files/dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1af1c8824b29a0ab747460216716cc2895) **elem_type**
* [dvs\_var\_type](../files/dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1af6aa6351345da4151507012681b3aff0) **var_type**
* uint32_t **var_id**
* uint32_t **part_id**
* const float * **values**
...
* [dvs\_var\_location](../files/dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1af4f0eba512eff253854b44d7ce078491) **location**
* [dvs\_element\_type](../files/dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1af1c8824b29a0ab747460216716cc2895) **elem_type**
* [dvs\_var\_type](../files/dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1af6aa6351345da4151507012681b3aff0) **var_type**
* uint32_t **var_id**
* uint32_t **part_id**
