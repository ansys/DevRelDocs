# File dynamic_visualization_store_enums.h
...
### Macro DVS_MAX_USER_DEFINED_VAR_ID
...
### Macro DVS_IBLANK_INTERNAL_BOUNDARY
...
### Macro DVS_STRUCTURED_IBLANKED_NODES

![][public]


```cpp
#define DVS_STRUCTURED_IBLANKED_NODES ([DVS_MAX_USER_DEFINED_VAR_ID](dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1a5e6fa5a06a37ae50af937ca7195800cd)+1)
```
...
### Macro DVS_STRUCTURED_GHOST_ELEMENTS

![][public]


```cpp
#define DVS_STRUCTURED_GHOST_ELEMENTS ([DVS_MAX_USER_DEFINED_VAR_ID](dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1a5e6fa5a06a37ae50af937ca7195800cd)+2)
```
...
```cpp
#define DVS_NODE_ID ([DVS_MAX_USER_DEFINED_VAR_ID](dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1a5e6fa5a06a37ae50af937ca7195800cd)+3)
```
...
### Macro DVS_ELEMENT_ID

![][public]


```cpp
#define DVS_ELEMENT_ID ([DVS_MAX_USER_DEFINED_VAR_ID](dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1a5e6fa5a06a37ae50af937ca7195800cd)+4)
```
...
### Macro DVS_BEGIN_INTERNAL_CONN_ID

![][public]


```cpp
#define DVS_BEGIN_INTERNAL_CONN_ID ([DVS_MAX_USER_DEFINED_VAR_ID](dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1a5e6fa5a06a37ae50af937ca7195800cd)+5+PNT)
```
...
### Macro DVS_END_INTERNAL_CONN_ID

![][public]


```cpp
#define DVS_END_INTERNAL_CONN_ID ([DVS_MAX_USER_DEFINED_VAR_ID](dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1a5e6fa5a06a37ae50af937ca7195800cd)+5+UNDEFINED)
```
...
### Macro DVS_BEGIN_INTERNAL_COORD_ID

![][public]


```cpp
#define DVS_BEGIN_INTERNAL_COORD_ID ([DVS_END_INTERNAL_CONN_ID](dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1a991e2afb5c20b847daf1581cb7dac29b)+1)
```
...
### Macro DVS_END_INTERNAL_COORD_ID

![][public]


```cpp
#define DVS_END_INTERNAL_COORD_ID ([DVS_BEGIN_INTERNAL_COORD_ID](dynamic__visualization__store__enums_8h.md#dynamic__visualization__store__enums_8h_1a437b7d261fd6c93718d52eed922f176e)+2)
```
...
### Macro DVS_ENV_LISTEN_ALL_NETWORKS
...
### Macro DVS_ENV_UNIX_DOMAIN_SOCKET_PATH
...
### Macro DVS_SERVER_OPT_LISTEN_ALL_NETWORKS
...
### Macro DVS_SERVER_OPT_USE_TCP_SOCKETS
...
### Macro DVS_SERVER_OPT_DISABLE_TLS
...
### Macro DVS_SERVER_OPT_UNIX_DOMAIN_SOCKET_PATH
...
### Enumeration type dvs_var_location
...
### Enumeration type dvs_structured_type
...
### Enumeration type dvs_client_flags
...
#### Enumerator BEGIN_INIT_WAIT_ON_REINIT
...
### Enumeration type dvs_log_flags
...
### Enumeration type dvs_verbosity
...
### Enumeration type dvs_log_level
...
### Enumeration type dvs_structured_iblanking_vals
...
#### Enumerator IBLANK_INTERNAL_BOUNDARY
...
### Enumeration type dvs_element_type
...
### Variable dvs_element_type_name
