...
Name | Description | Syntax
--- | --- | ---
MoveToFront |  | `void MoveToFront(SpaceClaim.Api.V251.IDocObject selectedFace)`
MoveToBack |  | `void MoveToBack(SpaceClaim.Api.V251.IDocObject selectedFace)`
MoveToEdge |  | `void MoveToEdge(SpaceClaim.Api.V251.IDocObject selectedFace)`
ToString |  | `string ToString()`
...
SOPReflectanceText | Number attribute (as text) | `string SOPReflectanceText`
SOPLibrary | File attribute | `string SOPLibrary`
SopAppearancePath | File attribute | `Fou.Utils.ValueObjects.FilePath SopAppearancePath`
...
Name | Description | Syntax
--- | --- | ---
TypeOpaque | String attribute | `string TypeOpaque`
