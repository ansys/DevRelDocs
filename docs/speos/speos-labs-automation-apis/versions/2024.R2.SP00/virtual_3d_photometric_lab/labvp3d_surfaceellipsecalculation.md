...
Computes the measures for an ellipse area projected on the 3D surface.
...
*object.SurfaceEllipseCalculation\(double dXPos, double dYPos, double dZPos, double dXDir, double dYDir, double dZDir, double dPhi, double dWidth, double dHeight, long lSampling\) As Variant*
...
Sub TestLab()
  ...
  RetVal = Viewer.SurfaceEllipseCalculation(13,13,11,0,0,-1,0,1,1,10000)
End Sub
...
ellipseCalculation = MyXm3Viewer.SurfaceEllipseCalculation(5, 0, 0, -1, 0, 0, 0, 5, 5, 1000)
result = ""
i = 0
print "Surface Rectangle Calculation"
for c in ellipseCalculation:
    if i == 0:
