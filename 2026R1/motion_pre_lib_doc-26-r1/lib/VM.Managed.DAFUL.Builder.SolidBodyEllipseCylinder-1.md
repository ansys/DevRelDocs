...
<a id="VM_Managed_DAFUL_Builder_SolidBodyEllipseCylinder_1"></a>

Namespace: [VM.Managed.DAFUL.Builder](VM.Managed.DAFUL.Builder.md)  
Assembly: VMBld.dll  

```csharp
public abstract class SolidBodyEllipseCylinder<T> : SolidBody<T>, IBuilder where T : BuilderEllipseCylinder, new()
```
