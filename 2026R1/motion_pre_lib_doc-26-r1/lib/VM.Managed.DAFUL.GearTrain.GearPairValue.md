# Class GearPairValue
<a id="VM_Managed_DAFUL_GearTrain_GearPairValue"></a>
...
```csharp
public class GearPairValue : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public Variable this[int i] { get; set; }
```
