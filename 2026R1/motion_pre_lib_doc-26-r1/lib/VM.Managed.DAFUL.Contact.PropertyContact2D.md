...
<a id="VM_Managed_DAFUL_Contact_PropertyContact2D"></a>
...
```csharp
public abstract class PropertyContact2D : PropertyContact, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IContainer, ILinkContainer, IOwned, IHasID
```
