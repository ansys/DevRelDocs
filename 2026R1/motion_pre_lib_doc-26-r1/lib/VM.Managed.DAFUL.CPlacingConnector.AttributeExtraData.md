...
<a id="VM_Managed_DAFUL_CPlacingConnector_AttributeExtraData"></a>
...
```csharp
public class AttributeExtraData : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
