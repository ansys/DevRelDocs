...
<a id="VM_Managed_DAFUL_Builder_OnePointPosition"></a>

Namespace: [VM.Managed.DAFUL.Builder](VM.Managed.DAFUL.Builder.md)  
Assembly: VMBld.dll  

```csharp
public struct OnePointPosition : IConnectorPosition
```
...
### <a id="VM_Managed_DAFUL_Builder_OnePointPosition_NumberOfPoint"></a> NumberOfPoint
...
### <a id="VM_Managed_DAFUL_Builder_OnePointPosition_SetPosition_VM_Managed_DAFUL_Marker_VM_Managed_DAFUL_Marker_VM_Managed_DAFUL_Builder_PickedResult___"></a> SetPosition\(Marker, Marker, PickedResult\[\]\)
