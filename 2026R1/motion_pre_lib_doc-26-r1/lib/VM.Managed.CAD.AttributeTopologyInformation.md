...
<a id="VM_Managed_CAD_AttributeTopologyInformation"></a>
...
```csharp
public class AttributeTopologyInformation : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public AttributeTopologyInformation(string strName, string strType)
```
