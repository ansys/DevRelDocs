# Class PartExportFiles
<a id="VM_Managed_DAFUL_MeshFree_Operation_PartExportFiles"></a>

Namespace: [VM.Managed.DAFUL.MeshFree.Operation](VM.Managed.DAFUL.MeshFree.Operation.md)  
Assembly: VMOpMeshFree.dll  

```csharp
public class PartExportFiles : SimulateForPartComponentEigenvalue, IOperation
```
...
### <a id="VM_Managed_DAFUL_MeshFree_Operation_PartExportFiles__ctor_VM_Managed_Document3D_System_String_System_Boolean_System_Boolean_System_Boolean_System_Boolean_"></a> PartExportFiles\(Document3D, string, bool, bool, bool, bool\)

```csharp
public PartExportFiles(Document3D doc, string strFilePath, bool bWriteDFS, bool bWriteXML, bool bWriteDFG, bool bIncludeReferenceFiles)
```
...
### <a id="VM_Managed_DAFUL_MeshFree_Operation_PartExportFiles__ctor_VM_Managed_Operation_JournalParameter_"></a> PartExportFiles\(JournalParameter\)

```csharp
public PartExportFiles(JournalParameter jp)
```
...
### <a id="VM_Managed_DAFUL_MeshFree_Operation_PartExportFiles_m_bIncludeReferenceFiles"></a> m\_bIncludeReferenceFiles
...
### <a id="VM_Managed_DAFUL_MeshFree_Operation_PartExportFiles_m_bWriteDFG"></a> m\_bWriteDFG
...
### <a id="VM_Managed_DAFUL_MeshFree_Operation_PartExportFiles_m_bWriteDFS"></a> m\_bWriteDFS
...
### <a id="VM_Managed_DAFUL_MeshFree_Operation_PartExportFiles_m_bWriteXML"></a> m\_bWriteXML
...
### <a id="VM_Managed_DAFUL_MeshFree_Operation_PartExportFiles_Name"></a> Name
...
### <a id="VM_Managed_DAFUL_MeshFree_Operation_PartExportFiles_ReadExtraJournal_System_Xml_XmlElement_"></a> ReadExtraJournal\(XmlElement\)
...
### <a id="VM_Managed_DAFUL_MeshFree_Operation_PartExportFiles_SimulationRunImpl_System_Boolean_"></a> SimulationRunImpl\(bool\)
...
### <a id="VM_Managed_DAFUL_MeshFree_Operation_PartExportFiles_WriteExtraJournal_System_Xml_XmlWriter_"></a> WriteExtraJournal\(XmlWriter\)
