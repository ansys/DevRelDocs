...
Entity<GroundBodyProperty\>.Initialize\(Unit.ConvertFactor\), 
Entity<GroundBodyProperty\>.GetUnnamedObjectName\(object\), 
Entity<GroundBodyProperty\>.FindLocal\(string\), 
Entity<GroundBodyProperty\>.Property, 
