...
<a id="VM_Managed_DAFUL_Contact_PropertyContactGeomCylinder"></a>
...
```csharp
public class PropertyContactGeomCylinder : PropertyContactGeomBody, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IContainer, ILinkContainer, IOwned, IHasID
```
...
```csharp
public VectorBase _BottomPosition { get; }
```
