...
<a id="VM_Managed_DAFUL_GearTrain_AttributeUnuseProperty"></a>
...
```csharp
public class AttributeUnuseProperty : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
