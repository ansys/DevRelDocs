# Class BuilderTorus
<a id="VM_Managed_CAD_BuilderTorus"></a>
...
```csharp
public abstract class BuilderTorus : BuilderColorGeom, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IHasReplaceableEntity
```
...
```csharp
public abstract double _RadiusMajor { get; }
```
