...
<a id="VM_Managed_DAFUL_GearTrain_CAD_AddedHDBearingBuilder"></a>
...
```csharp
public class AddedHDBearingBuilder : HDBearingBuilder, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IHasReplaceableEntity, IGeometryBuilder, IAddedBuilderForBearing, IAddedBuilder
```
