...
<a id="VM_Managed_DAFUL_GearTrain_BaseTangentLength"></a>
...
```csharp
public class BaseTangentLength : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public GearPairValue PairUpperLengthOfSpan { get; set; }
```
