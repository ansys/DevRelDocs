...
<a id="VM_Managed_DAFUL_GearTrain_CAD_RacewayGeometryForRBEInMeshFree"></a>
...
```csharp
public RacewayGeometryForRBEInMeshFree(Builder builder)
```
...
```csharp
public static RacewayGeometryForRBEInMeshFree TemperaryRacewayGeometry(RacewayGeometryInfo rInfo, IConnectable con, HiddenDocumentMeshBase doc, DirectionBase dirZ, OMatrix matO, bool bAddDoc)
```
