...
<a id="VM_Managed_DAFUL_GearTrain_AttributeBodyToAttachedDT"></a>
...
```csharp
public abstract class AttributeBodyToAttachedDT : AttributeBodyToDT, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
