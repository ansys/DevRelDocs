...
<a id="VM_Managed_DAFUL_Equation_EquationFunction"></a>
...
```csharp
public abstract class EquationFunction : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
protected EquationFunction(Equation owner)
```
