...
<a id="VM_Managed_CAD_CADBodyApplyOperation"></a>
...
```csharp
public class CADBodyApplyOperation : OperationBase, IOperation
```
...
```csharp
public CADBodyApplyOperation.ApplyCallback Apply
```

#### Field Value

 [CADBodyApplyOperation](VM.Managed.CAD.CADBodyApplyOperation.md).[ApplyCallback](VM.Managed.CAD.CADBodyApplyOperation.ApplyCallback.md)
