...
<a id="VM_Managed_DAFUL_AttributeFacesetTypeColor"></a>
...
```csharp
public class AttributeFacesetTypeColor : AttributeFacesetTypeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
[AttributeFacesetTypeBase.Type](VM.Managed.DAFUL.AttributeFacesetTypeBase.md\#VM\_Managed\_DAFUL\_AttributeFacesetTypeBase\_Type), 
