...
<a id="VM_Managed_PointOnSphereCenter"></a>
...
```csharp
public class PointOnSphereCenter : PointOnGeometryBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable, IHasReplaceableEntity
```
