...
<a id="VM_Managed_AttributeIconColor"></a>
...
```csharp
[Obsolete("Do not create this class.")]
public class AttributeIconColor : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public AttributeIconColor(Color color)
```
