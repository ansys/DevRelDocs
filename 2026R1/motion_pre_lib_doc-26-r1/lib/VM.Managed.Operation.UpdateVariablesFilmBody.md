...
<a id="VM_Managed_Operation_UpdateVariablesFilmBody"></a>

Namespace: [VM.Managed.Operation](VM.Managed.Operation.md)  
Assembly: VMOpFEFilm.dll  

```csharp
public class UpdateVariablesFilmBody : OperationBase, IOperation
```
...
object ← 
OperationBase ← 
[UpdateVariablesFilmBody](VM.Managed.Operation.UpdateVariablesFilmBody.md)
