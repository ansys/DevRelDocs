...
<a id="VM_Managed_ICunstomLink"></a>
...
`colLinkCollections` ICollection<[ILinkCollection](VM.Managed.Collections.ILinkCollection.md)\>
...
`hs` HashSet<[ILink](VM.Managed.ILink.md)\>
