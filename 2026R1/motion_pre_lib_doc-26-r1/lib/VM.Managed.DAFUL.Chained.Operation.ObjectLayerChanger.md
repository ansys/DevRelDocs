...
```csharp
public class ObjectLayerChanger : OperationBase, IOperation
```
...
```csharp
public ObjectLayerChanger(Document3D doc3D, ObjectBase[] lstObj, bool[] lstHide)
```
...
```csharp
public ObjectLayerChanger(JournalParameter jp)
```
