...
<a id="VM_Managed_DAFUL_GearTrain_CAD_HDBearingBuilderForRBEInMeshFree"></a>
...
```csharp
public class HDBearingBuilderForRBEInMeshFree : HDBearingBuilderForRBEInFE, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IHasReplaceableEntity, IGeometryBuilder
```
