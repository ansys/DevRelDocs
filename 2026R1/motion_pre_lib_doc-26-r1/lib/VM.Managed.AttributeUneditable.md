...
<a id="VM_Managed_AttributeUneditable"></a>
...
```csharp
public class AttributeUneditable : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
