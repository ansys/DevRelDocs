...
<a id="VM_Managed_DAFUL_Flexible_PropertyBoundaryConditionBase_BCConstrainedType"></a>
...
<p>The BC is constrained by user.</p>
<p>사용자에 의해 정의된 경계조건.</p>



`InLine = 1` 

<p>The BC is constrained in line.</p>
<p>선상에 정의된 경계조건.</p>
...
<p>The BC is constrained on plane.</p>
<p>평면상에 정의된 경계조건.</p>
