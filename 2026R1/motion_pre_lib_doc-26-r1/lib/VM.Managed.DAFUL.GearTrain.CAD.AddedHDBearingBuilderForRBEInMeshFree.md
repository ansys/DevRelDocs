...
<a id="VM_Managed_DAFUL_GearTrain_CAD_AddedHDBearingBuilderForRBEInMeshFree"></a>
...
```csharp
public class AddedHDBearingBuilderForRBEInMeshFree : HDBearingBuilderForRBEInMeshFree, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IHasReplaceableEntity, IGeometryBuilder, IAddedBuilderForBearing, IAddedBuilder
```
