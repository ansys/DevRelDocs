...
<a id="VM_Managed_DAFUL_Track_ShearPressureFormulationBase"></a>
...
```csharp
public abstract class ShearPressureFormulationBase : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public ShearPressureFormulationBase()
```
