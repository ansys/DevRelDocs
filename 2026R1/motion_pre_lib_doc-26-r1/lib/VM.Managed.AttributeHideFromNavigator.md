...
<a id="VM_Managed_AttributeHideFromNavigator"></a>
...
```csharp
public class AttributeHideFromNavigator : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
