...
<a id="VM_Managed_DAFUL_Builder_MeshFree_ColorRigidBodyElementPairPart"></a>

Namespace: [VM.Managed.DAFUL.Builder.MeshFree](VM.Managed.DAFUL.Builder.MeshFree.md)  
Assembly: VMBldMeshFree.dll  

```csharp
public class ColorRigidBodyElementPairPart : BuilderNamed<RigidBodyElementPair>, IBuilder
```
