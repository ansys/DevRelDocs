...
<a id="VM_Managed_DAFUL_AttributeCurvesetTypeBase"></a>
...
```csharp
public abstract class AttributeCurvesetTypeBase : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public AttributeCurvesetTypeBase()
```
