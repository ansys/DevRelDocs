...
<a id="VM_Managed_DAFUL_GearTrain_GearPropertyBase"></a>
...
```csharp
public abstract class GearPropertyBase : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public virtual void InitChild(int nNum)
```
