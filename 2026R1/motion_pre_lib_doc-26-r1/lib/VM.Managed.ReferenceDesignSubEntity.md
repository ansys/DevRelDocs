...
<a id="VM_Managed_ReferenceDesignSubEntity"></a>
...
```csharp
public class ReferenceDesignSubEntity : Reference, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IReferencable, INamed, INavigatorItem, IVisible, IReferenceAutoContactable, IAutoContactable, IBody
```
...
```csharp
protected ReferenceDesignSubEntity(SerializationInfo info, StreamingContext context)
```
...
```csharp
public ReferenceDesignSubEntity(ObjectBase obj)
```
