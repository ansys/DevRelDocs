...
```csharp
public class MotorDesigner.EMForceSection.MaxwellFileMethod : MotorDesigner.EMForceSection.MethodBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public MotorDesigner.EMForceSection.VectorCreator[] RotorVectorSet { get; set; }
```
...
```csharp
public MotorDesigner.EMForceSection.VectorCreator[] StatorVectorSet { get; set; }
```
