...
```csharp
public class PointOnFace : PointOnGeometryBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable, IHasReplaceableEntity
```
...
### <a id="VM_Managed_PointOnFace__ctor"></a> PointOnFace\(\)

Initializes a new instance of the <xref href="VM.Managed.PointOnFace" data-throw-if-not-resolved="false"></xref> class.
...
### <a id="VM_Managed_PointOnFace_GetSchema"></a> GetSchema\(\)
...
### <a id="VM_Managed_PointOnFace_ReadXml_System_Xml_XmlReader_"></a> ReadXml\(XmlReader\)
...
### <a id="VM_Managed_PointOnFace_WriteXml_System_Xml_XmlWriter_"></a> WriteXml\(XmlWriter\)
