# Class CoSimIOList
<a id="VM_Managed_DAFUL_CoSim_CoSimIOList"></a>
...
```csharp
public class CoSimIOList : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public CoSimIOList(CoSimSettingsBase owner)
```

#### Parameters

`owner` [CoSimSettingsBase](VM.Managed.DAFUL.CoSim.CoSimSettingsBase.md)
