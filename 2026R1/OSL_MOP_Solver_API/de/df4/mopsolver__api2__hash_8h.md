...
* **_flags**: uint value representing the specified flags (see enum DMOP_DIMENSION_FLAG in [mopsolver_api2.h](d7/df7/mopsolver__api2_8h.md#d7/df7/mopsolver__api2_8h))
...
* **_flags**: integer value representing the set flags (see enum DMOP_SOLVE_FLAG in [mopsolver_api2.h](d7/df7/mopsolver__api2_8h.md#d7/df7/mopsolver__api2_8h))
...
* **_flags**: integer value representing the set flags (see enum DMOP_PER_RESPONSE_FLAG in [mopsolver_api2.h](d7/df7/mopsolver__api2_8h.md#d7/df7/mopsolver__api2_8h))
...
* **_omdbfile**: zero terminated character string containing the filesystem path to the optiSLang monitoring database file (*.omdb) containing MOP
* **_flag**: DMOP_NAME_FLAG value specifying which names to return (see enum DMOP_NAME_FLAG in [mopsolver_api2.h](d7/df7/mopsolver__api2_8h.md#d7/df7/mopsolver__api2_8h))
