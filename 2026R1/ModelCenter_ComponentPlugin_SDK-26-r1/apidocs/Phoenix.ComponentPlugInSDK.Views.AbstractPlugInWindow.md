...
```csharp
public abstract class AbstractPlugInWindow : Window, IAnimatable, IFrameworkInputElement, IInputElement, ISupportInitialize, IQueryAmbient, IAddChild, ISaveableWindow
...
[AbstractPlugInWindow(ILogger)](Phoenix.ComponentPlugInSDK.Views.AbstractPlugInWindow.-ctor.md#Phoenix_ComponentPlugInSDK_Views_AbstractPlugInWindow__ctor_Microsoft_Extensions_Logging_ILogger_)

Creates a new instance of the view.

## Fields

[_forceClose](Phoenix.ComponentPlugInSDK.Views.AbstractPlugInWindow._forceClose.md#Phoenix_ComponentPlugInSDK_Views_AbstractPlugInWindow__forceClose)

Used to allow the window to close without the closing check.

[_logger](Phoenix.ComponentPlugInSDK.Views.AbstractPlugInWindow._logger.md#Phoenix_ComponentPlugInSDK_Views_AbstractPlugInWindow__logger)

The logger to use.

[_variableScope](Phoenix.ComponentPlugInSDK.Views.AbstractPlugInWindow._variableScope.md#Phoenix_ComponentPlugInSDK_Views_AbstractPlugInWindow__variableScope)

A scope object used to managed the FileValue objects created as part
of the legacy UI components that work in PHXVariables instead of IRuntimeVariable.
Note that currently the tree control and properties control do not maintain
this as an exhaustive list, but merely keep track of FileValue objects.

## Properties

[_cancelButton](Phoenix.ComponentPlugInSDK.Views.AbstractPlugInWindow._cancelButton.md#Phoenix_ComponentPlugInSDK_Views_AbstractPlugInWindow__cancelButton)
...
[_editVariablesButton](Phoenix.ComponentPlugInSDK.Views.AbstractPlugInWindow._editVariablesButton.md#Phoenix_ComponentPlugInSDK_Views_AbstractPlugInWindow__editVariablesButton)
...
[_treeControl](Phoenix.ComponentPlugInSDK.Views.AbstractPlugInWindow._treeControl.md#Phoenix_ComponentPlugInSDK_Views_AbstractPlugInWindow__treeControl)

The TreeControl for editing variables.

[_treeControlHost](Phoenix.ComponentPlugInSDK.Views.AbstractPlugInWindow._treeControlHost.md#Phoenix_ComponentPlugInSDK_Views_AbstractPlugInWindow__treeControlHost)

The WindowsFormsHost that contains the TreeControl.

## Methods

[EditVariablesButton_Click(object, RoutedEventArgs)](Phoenix.ComponentPlugInSDK.Views.AbstractPlugInWindow.EditVariablesButton_Click.md#Phoenix_ComponentPlugInSDK_Views_AbstractPlugInWindow_EditVariablesButton_Click_System_Object_System_Windows_RoutedEventArgs_)

Show the edit variables dialog.

[TreeCtrlHost_GotKeyboardFocus(object, KeyboardFocusChangedEventArgs)](Phoenix.ComponentPlugInSDK.Views.AbstractPlugInWindow.TreeCtrlHost_GotKeyboardFocus.md#Phoenix_ComponentPlugInSDK_Views_AbstractPlugInWindow_TreeCtrlHost_GotKeyboardFocus_System_Object_System_Windows_Input_KeyboardFocusChangedEventArgs_)

Called when the TreeCtrl gets focus.

[TrySaveAsync()](Phoenix.ComponentPlugInSDK.Views.AbstractPlugInWindow.TrySaveAsync.md#Phoenix_ComponentPlugInSDK_Views_AbstractPlugInWindow_TrySaveAsync)
...
[_programmaticClose()](Phoenix.ComponentPlugInSDK.Views.AbstractPlugInWindow._programmaticClose.md#Phoenix_ComponentPlugInSDK_Views_AbstractPlugInWindow__programmaticClose)

Closes the view without the closing check.

[_showErrorDialog(Exception)](Phoenix.ComponentPlugInSDK.Views.AbstractPlugInWindow._showErrorDialog.md#Phoenix_ComponentPlugInSDK_Views_AbstractPlugInWindow__showErrorDialog_System_Exception_)

Display an error message to the user.

[_updateAbstractWindow(IPlugInViewModel, VariableTreeProperties)](Phoenix.ComponentPlugInSDK.Views.AbstractPlugInWindow._updateAbstractWindow.md#Phoenix_ComponentPlugInSDK_Views_AbstractPlugInWindow__updateAbstractWindow_Phoenix_ComponentPlugInSDK_ViewModels_IPlugInViewModel_Phoenix_ComponentPlugInSDK_Models_VariableTreeProperties_)
