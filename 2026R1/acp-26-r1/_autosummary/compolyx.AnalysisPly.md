...
| [`AnalysisPly.obj_exists`](compolyx.AnalysisPly.obj_exists.md#compolyx.AnalysisPly.obj_exists)()                                      | True (boolean) if \_\_obj references the C++ object (has not been reset to None by `self._delete`) and still exists in the graph. |
