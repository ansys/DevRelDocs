...
| [`ExtrusionGuide.obj_exists`](compolyx.ExtrusionGuide.obj_exists.md#compolyx.ExtrusionGuide.obj_exists)()                                  | Checks if \_\_obj still references the c++ object (has not been reset to None by self._delete) and exists in the graph. |
