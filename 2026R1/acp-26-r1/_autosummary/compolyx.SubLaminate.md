...
| [`SubLaminate.find_parent`](compolyx.SubLaminate.find_parent.md#compolyx.SubLaminate.find_parent)(type)                                       | Steps up the tree and returns the first parent with given type.                                                     |
...
| [`SubLaminate.obj_exists`](compolyx.SubLaminate.obj_exists.md#compolyx.SubLaminate.obj_exists)()                                              | Checks if \_\_obj still references the c++ object (has not been reset to None by self._delete) and exists in the graph. |
...
| [`SubLaminate.serialize_name_and_id`](compolyx.SubLaminate.serialize_name_and_id.md#compolyx.SubLaminate.serialize_name_and_id)()             | Serializes the name and ID.                                                                                    |
