...
| Name | Description |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------|
| [`SamplingPoint.active`](compolyx.SamplingPoint.active.md#compolyx.SamplingPoint.active)                                                                            | Active status of the object.                                                                                    |
...
| [`SamplingPoint.id`](compolyx.SamplingPoint.id.md#compolyx.SamplingPoint.id)                                                                                        | ID of the object.                                                                                               |
| [`SamplingPoint.is_dict_item`](compolyx.SamplingPoint.is_dict_item.md#compolyx.SamplingPoint.is_dict_item)                                                          | Indicates whether the object is an item in a dictionary.                                                           |
| [`SamplingPoint.is_list_item`](compolyx.SamplingPoint.is_list_item.md#compolyx.SamplingPoint.is_list_item)                                                          | Indicates whether the object is an item of a list.                                                           |
...
| [`SamplingPoint.name`](compolyx.SamplingPoint.name.md#compolyx.SamplingPoint.name)                                                                                  | Name of the object.                                                                                             |
...
| [`SamplingPoint.uid`](compolyx.SamplingPoint.uid.md#compolyx.SamplingPoint.uid)                                                                                     | UID of the object.                                                                                              |
...
| [`SamplingPoint.vertex`](compolyx.SamplingPoint.vertex.md#compolyx.SamplingPoint.vertex)                                                                            | Raises an error if the object has been removed from the graph.                                    |
...
| [`SamplingPoint.find_parent`](compolyx.SamplingPoint.find_parent.md#compolyx.SamplingPoint.find_parent)(type)                                       | Steps up the tree and returns the first parent with given type.                                                     |
| [`SamplingPoint.obj_exists`](compolyx.SamplingPoint.obj_exists.md#compolyx.SamplingPoint.obj_exists)()                                              | Checks if \_\_obj still references the c++ object (has not been reset to None by self._delete) and exists in the graph. |
| [`SamplingPoint.serialize`](compolyx.SamplingPoint.serialize.md#compolyx.SamplingPoint.serialize)()                                                 |                                                                                                                              |
| [`SamplingPoint.serialize_name_and_id`](compolyx.SamplingPoint.serialize_name_and_id.md#compolyx.SamplingPoint.serialize_name_and_id)()             | Serializes the name and ID.                                                                                    |
