...
Represents user-defined scripts operating on the input parameters.
...
| [`Script.enabled`](compolyx.Script.enabled.md#compolyx.Script.enabled)                      | Indicates whether the object is enabled.                              |
| [`Script.is_dict_item`](compolyx.Script.is_dict_item.md#compolyx.Script.is_dict_item)       | Indicates whether the object is an item in a dictionary                              |
| [`Script.is_list_item`](compolyx.Script.is_list_item.md#compolyx.Script.is_list_item)       | Indicates whether the object is an item of a list                              |
...
| [`Script.name`](compolyx.Script.name.md#compolyx.Script.name)                               | Name of the object                                                                |
| [`Script.parent`](compolyx.Script.parent.md#compolyx.Script.parent)                         | Parent object in the tree                                                         |
...
| Name | Description |
|-----------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| [`Script.find_parent`](compolyx.Script.find_parent.md#compolyx.Script.find_parent)(type)      | Steps up the tree and returns the first parent with given type.           |
