...
| Name | Description |
|---------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| [`Fabric.active`](compolyx.Fabric.active.md#compolyx.Fabric.active)                                                             | Active status of the object.                                                            |
| [`Fabric.area_price`](compolyx.Fabric.area_price.md#compolyx.Fabric.area_price)                                                 | Area price of the fabric.                                                               |
| [`Fabric.area_weight`](compolyx.Fabric.area_weight.md#compolyx.Fabric.area_weight)                                              | Area weight of the fabric.                                                              |
...
| [`Fabric.cut_off_material_handling`](compolyx.Fabric.cut_off_material_handling.md#compolyx.Fabric.cut_off_material_handling)    | Defines how cut‑off material is used in cut‑off areas of this fabric.        |
...
| [`Fabric.enabled`](compolyx.Fabric.enabled.md#compolyx.Fabric.enabled)                                                          | Indicates whether the object is enabled.                                   |
| [`Fabric.graph_plot`](compolyx.Fabric.graph_plot.md#compolyx.Fabric.graph_plot)                                                 | Graph Plot object used to configure 2D plots.                                      |
| [`Fabric.id`](compolyx.Fabric.id.md#compolyx.Fabric.id)                                                                         | ID of the object.                                                                       |
| [`Fabric.ignore_for_postprocessing`](compolyx.Fabric.ignore_for_postprocessing.md#compolyx.Fabric.ignore_for_postprocessing)    | Indicates whether this material is excluded from postprocessing.                                       |
| [`Fabric.is_dict_item`](compolyx.Fabric.is_dict_item.md#compolyx.Fabric.is_dict_item)                                           | Indicates whether the object is an item in a dictionary.                                   |
| [`Fabric.is_list_item`](compolyx.Fabric.is_list_item.md#compolyx.Fabric.is_list_item)                                           | Indicates whether the object is an item of a list.                                   |
...
| [`Fabric.name`](compolyx.Fabric.name.md#compolyx.Fabric.name)                                                                   | Name of the object.                                                                     |
| [`Fabric.parent`](compolyx.Fabric.parent.md#compolyx.Fabric.parent)                                                             | Parent object in the tree.                                                              |
...
| [`Fabric.uid`](compolyx.Fabric.uid.md#compolyx.Fabric.uid)                                                                      | UID of the object.                                                                      |
| [`Fabric.vertex`](compolyx.Fabric.vertex.md#compolyx.Fabric.vertex)                                                             | Raises an error if the object has been removed from the graph.            |
...
| [`Fabric.obj_exists`](compolyx.Fabric.obj_exists.md#compolyx.Fabric.obj_exists)()                                                | Checks if \_\_obj still references the c++ object (has not been reset to None by self._delete) and exists in the graph. |
| [`Fabric.serialize`](compolyx.Fabric.serialize.md#compolyx.Fabric.serialize)()                                                   | Serialize to Python string.                                                                                                  |
| [`Fabric.serialize_name_and_id`](compolyx.Fabric.serialize_name_and_id.md#compolyx.Fabric.serialize_name_and_id)()               | Serializes the name and ID.                                                                                    |
