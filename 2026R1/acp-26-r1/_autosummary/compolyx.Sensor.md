...
| [`Sensor.find_parent`](compolyx.Sensor.find_parent.md#compolyx.Sensor.find_parent)(type)                           | Steps up the tree and returns the first parent with given type.                                                     |
| [`Sensor.obj_exists`](compolyx.Sensor.obj_exists.md#compolyx.Sensor.obj_exists)()                                  | Checks if \_\_obj still references the c++ object (has not been reset to None by self._delete) and exists in the graph. |
...
| [`Sensor.serialize_name_and_id`](compolyx.Sensor.serialize_name_and_id.md#compolyx.Sensor.serialize_name_and_id)() | Serializes the name and ID.                                                                                    |
