...
| [`CutOffGeometry.obj_exists`](compolyx.CutOffGeometry.obj_exists.md#compolyx.CutOffGeometry.obj_exists)()                                  | Checks if \_\_obj still references the c++ object (has not been reset to None by self._delete) and exists in the graph. |
| [`CutOffGeometry.serialize`](compolyx.CutOffGeometry.serialize.md#compolyx.CutOffGeometry.serialize)()                                     |                                                                                                                              |
| [`CutOffGeometry.serialize_name_and_id`](compolyx.CutOffGeometry.serialize_name_and_id.md#compolyx.CutOffGeometry.serialize_name_and_id)() | Serializes the name and ID.                                                                                    |
