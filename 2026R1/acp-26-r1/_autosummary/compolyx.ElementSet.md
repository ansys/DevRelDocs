...
| [`ElementSet.obj_exists`](compolyx.ElementSet.obj_exists.md#compolyx.ElementSet.obj_exists)()                                     | Checks if \_\_obj still references the c++ object (has not been reset to None by self._delete) and exists in the graph. |
