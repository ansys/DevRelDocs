...
### Parameters:
  ...
  - subcase: Optional subcase to read. Only available for ‘nastran:f06’ format. (False,0) if not given in the F06 file.
  - load_factor: Optional load factor within substep of non-linear solution where the nodal solution should be taken from. Only available for ‘nastran:f06’ format. (False,0) if not given in the F06 file.
