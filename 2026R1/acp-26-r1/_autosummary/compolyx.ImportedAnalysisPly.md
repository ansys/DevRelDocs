...
| [`ImportedAnalysisPly.is_reinforcing`](compolyx.ImportedAnalysisPly.is_reinforcing.md#compolyx.ImportedAnalysisPly.is_reinforcing)()                      | True if the analysis ply is a reinforcing ply.                                                                                |
| [`ImportedAnalysisPly.obj_exists`](compolyx.ImportedAnalysisPly.obj_exists.md#compolyx.ImportedAnalysisPly.obj_exists)()                                  | Checks if \_\_obj still references the c++ object (has not been reset to None by self._delete) and exists in the graph. |
