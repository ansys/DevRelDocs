...
| [`PlyBook.find_parent`](compolyx.PlyBook.find_parent.md#compolyx.PlyBook.find_parent)(type)                            | Steps up the tree and returns the first parent with given type.           |
