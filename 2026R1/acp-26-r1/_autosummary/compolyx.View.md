...
Represents a view and its properties.
...
| Name | Description |
|--------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| [`View.find_parent`](compolyx.View.find_parent.md#compolyx.View.find_parent)(type)   | Steps up the tree and returns the first parent with given type.           |
