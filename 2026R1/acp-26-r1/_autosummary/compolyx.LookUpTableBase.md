...
| [`LookUpTableBase.enabled`](compolyx.LookUpTableBase.enabled.md#compolyx.LookUpTableBase.enabled)                                        | Indicates whether the object is enabled.                                     |
| [`LookUpTableBase.id`](compolyx.LookUpTableBase.id.md#compolyx.LookUpTableBase.id)                                                       | ID of the object.                                                                         |
| [`LookUpTableBase.is_dict_item`](compolyx.LookUpTableBase.is_dict_item.md#compolyx.LookUpTableBase.is_dict_item)                         | Indicates whether the object is an item in a dictionary.                                     |
| [`LookUpTableBase.is_list_item`](compolyx.LookUpTableBase.is_list_item.md#compolyx.LookUpTableBase.is_list_item)                         | Indicates whether the object is an item of a list.                                     |
...
| [`LookUpTableBase.name`](compolyx.LookUpTableBase.name.md#compolyx.LookUpTableBase.name)                                                 | Name of the object.                                                                       |
...
| [`LookUpTableBase.parent`](compolyx.LookUpTableBase.parent.md#compolyx.LookUpTableBase.parent)                                           | Parent object in the tree.                                                                |
...
| [`LookUpTableBase.uid`](compolyx.LookUpTableBase.uid.md#compolyx.LookUpTableBase.uid)                                                    | UID of the object.                                                                        |
...
| [`LookUpTableBase.vertex`](compolyx.LookUpTableBase.vertex.md#compolyx.LookUpTableBase.vertex)                                           | Raises an error if the object has been removed from the graph.              |
...
| [`LookUpTableBase.obj_exists`](compolyx.LookUpTableBase.obj_exists.md#compolyx.LookUpTableBase.obj_exists)()                                  | Checks if \_\_obj still references the c++ object (has not been reset to None by self._delete) and exists in the graph. |
...
| [`LookUpTableBase.serialize_name_and_id`](compolyx.LookUpTableBase.serialize_name_and_id.md#compolyx.LookUpTableBase.serialize_name_and_id)() | Serializes the name and ID.                                                                                    |
