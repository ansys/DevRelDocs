...
<a id="generated.RAParticleTimeSelectionProcess"></a>

### *class* RAParticleTimeSelectionProcess
...
| [`CreateCurveOutputVariable`](#generated.RAParticleTimeSelectionProcess.CreateCurveOutputVariable)(curve_name[, ...])                   | Used to create an output variable based on a curve which doesn't change at each new timestep (i.e.: a curve with a single value for each time).                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [`CreateGridFunction`](#generated.RAParticleTimeSelectionProcess.CreateGridFunction)(values[, location, time_step])                     | Create a grid function from the given values, location and time-step.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| [`CreateGridFunctionArrayOnCells`](#generated.RAParticleTimeSelectionProcess.CreateGridFunctionArrayOnCells)([time_step])               | Creates a numpy array with the number of elements based on the cells and returns it.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| [`CreateGridFunctionStatisticOutputVariable`](#generated.RAParticleTimeSelectionProcess.CreateGridFunctionStatisticOutputVariable)(...) | Used to create an output variable based on a grid function statistic (i.e.: will get a grid function, compute its statistic based on statistic_operation and then based on the statistic values will apply the operation to get a single scalar).                                                                                                                                                                                                                                                                                                                                             |
| [`CreateTransientCurveOutputVariable`](#generated.RAParticleTimeSelectionProcess.CreateTransientCurveOutputVariable)(curve_name)        | Used to create an output variable based on a curve for which there's a completely new representation for each time step -- such as Power : Impact X Belt Width (i.e.: will get the curve multiple times based on the time range, compute a value for each time based on the operation, to convert the multiple curves into a single curve and then will apply the time_operation to get a single scalar from those values).                                                                                                                                                                   |
| [`EditCustomCurve`](#generated.RAParticleTimeSelectionProcess.EditCustomCurve)(edit_curve[, new_name, ...])                             | Edit a custom curve saved in the database. :param edit_curve:     The name of the curve to be edited. :param new_name:     The new name of the curve to be set. :param sources:     A dict pointing the variable used to the curve association it represents and a     string indicating in which unit the input data should be gotten. :param expression:     The expression to be set.                                                                                                                                                                                                      |
| [`EditCustomProperty`](#generated.RAParticleTimeSelectionProcess.EditCustomProperty)(edit_property[, ...])                              | Edit a custom property saved in the database. :param edit_property:     The name of the property to be edited. :param new_name:     The new name of the property to be set. :param sources:     A dict pointing the variable used to the property association it represents and a     string indicating in which unit the input data should be gotten. :param expression:     The expression to be set.                                                                                                                                                                                       |
| [`GetActivesArray`](#generated.RAParticleTimeSelectionProcess.GetActivesArray)([time_step])                                             | Get an array representing the cells' "active" status.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| [`GetBoundingBox`](#generated.RAParticleTimeSelectionProcess.GetBoundingBox)([unit, time_step])                                         | Get the element's bounding box.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [`GetCellAreaAsArray`](#generated.RAParticleTimeSelectionProcess.GetCellAreaAsArray)([time_step])                                       | Get an array containing the area of each cell.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| [`GetCellCenterAsArray`](#generated.RAParticleTimeSelectionProcess.GetCellCenterAsArray)([time_step])                                   | Get an array containing the center coordinates of each cell.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| [`GetCellDzAsArray`](#generated.RAParticleTimeSelectionProcess.GetCellDzAsArray)([time_step])                                           | Get an array containing the thickness (in Z) of each cell.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| [`GetCellFromIJK`](#generated.RAParticleTimeSelectionProcess.GetCellFromIJK)(i, j, k[, time_step])                                      | Creates a grid cell handle from the current I, J, K indexes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [`GetCellIJK`](#generated.RAParticleTimeSelectionProcess.GetCellIJK)(cell_handle[, time_step])                                          | Converts the given cell handle to it's I, J, K indexes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [`GetCellNumberOfVertices`](#generated.RAParticleTimeSelectionProcess.GetCellNumberOfVertices)(cell[, time_step])                       | Get an array containing the number of vertices of each cell.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| [`GetCellPointsAsFunction`](#generated.RAParticleTimeSelectionProcess.GetCellPointsAsFunction)([time_step])                             | Get a function for the points (vertices) of each cell.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [`GetCellVolumeAsArray`](#generated.RAParticleTimeSelectionProcess.GetCellVolumeAsArray)([time_step])                                   | Get an array with the volume of each cell.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| [`GetCurve`](#generated.RAParticleTimeSelectionProcess.GetCurve)(curve_name[, simulation_name, ...])                                    | Override base class method to check for a request of a grid function statistic.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| [`GetNumberOfParticles`](#generated.RAParticleTimeSelectionProcess.GetNumberOfParticles)(time_step)                                     | Get the total number of particles in this selection.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| [`GetNumpyCurve`](#generated.RAParticleTimeSelectionProcess.GetNumpyCurve)(curve_name[, unit, realization])                             | Returns a curve as a tuple of numpy arrays (time, property) for the given element and name.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [`GetOutputVariableValue`](#generated.RAParticleTimeSelectionProcess.GetOutputVariableValue)(variable_name)                             | Get the value of a previously-created output variable.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [`GetTimeRange`](#generated.RAParticleTimeSelectionProcess.GetTimeRange)()                                                              | Get a dictionary with the current time range configuration.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [`GetTimeSet`](#generated.RAParticleTimeSelectionProcess.GetTimeSet)()                                                                  | Get the list of time-steps associated to the grid.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| [`IterCells`](#generated.RAParticleTimeSelectionProcess.IterCells)([time_step])                                                         | Iterate on the active grid cells at the given time.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| [`IterParticles`](#generated.RAParticleTimeSelectionProcess.IterParticles)(time_step)                                                   | Iterate on particles in this selection at the given time.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| [`Modified`](#generated.RAParticleTimeSelectionProcess.Modified)(\*args, \*\*kwargs)                                                    | Resets all the cache information after a change in the subject being tracked.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| [`RemoveCustomCurve`](#generated.RAParticleTimeSelectionProcess.RemoveCustomCurve)(name)                                                | Remove the curve from the database :param name:     The name of the curve to be removed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [`RemoveCustomProperty`](#generated.RAParticleTimeSelectionProcess.RemoveCustomProperty)(name)                                          | Remove the property from the database :param name:     The name of the property to be removed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| [`RemoveOutputVariable`](#generated.RAParticleTimeSelectionProcess.RemoveOutputVariable)(variable_name)                                 | Removes some output variable.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| [`RemoveProcess`](#generated.RAParticleTimeSelectionProcess.RemoveProcess)()                                                            | Removes the process from the project.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| [`SetAbsoluteTimeRange`](#generated.RAParticleTimeSelectionProcess.SetAbsoluteTimeRange)(initial_time, final_time)                      | Configure this process to use an absolute time range.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| [`SetCurrentTimeStep`](#generated.RAParticleTimeSelectionProcess.SetCurrentTimeStep)(time_step)                                         | Sets the current time step.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [`SetTimeRange`](#generated.RAParticleTimeSelectionProcess.SetTimeRange)([range_definition, initial, ...])                              | Set the values for this process' time range.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |

<a id="generated.RAParticleTimeSelectionProcess.AddCurve"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.AddCustomCurve"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.AddCustomProperty"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.AddGridFunction"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.CreateCurveOutputVariable"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.CreateGridFunction"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.CreateGridFunctionArrayOnCells"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.CreateGridFunctionStatisticOutputVariable"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.CreateTransientCurveOutputVariable"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.EditCustomCurve"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.EditCustomProperty"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetActivesArray"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetBoundingBox"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetCellAreaAsArray"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetCellCenterAsArray"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetCellDzAsArray"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetCellFromIJK"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetCellIJK"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetCellNumberOfVertices"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetCellPointsAsFunction"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetCellVolumeAsArray"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetCurve"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetCurveNames"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetCurveNamesAssociation"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetElementCurve"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetFacePositions"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetFaceVertices"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetGeometryQuantity"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetGeometryTransform"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetGeometryUnit"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetGridFunction"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetGridFunctionNames"></a>

#### GetGridFunctionNames(translated: bool = False, context: str | None = None)

Overridden to filter out deprecated property names.

<a id="generated.RAParticleTimeSelectionProcess.GetMeshColoring"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetNumberOfCells"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetNumberOfNodes"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetNumberOfParticles"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetNumpyCurve"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetOutputVariableValue"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetTimeRange"></a>
...
* **Return {‘range_definition’:**
  unicode, ‘initial’: int, ‘final’: int, ‘unit’: unicode}:
  Returns a dict with the details currently set as the time range.

<a id="generated.RAParticleTimeSelectionProcess.GetTimeSet"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetTimeStatistics"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetTimeStep"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetTopologyShape"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.GetVertices"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.HasGridFunction"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.IsCellActive"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.IterCellVertices"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.IterCells"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.IterParticles"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.Modified"></a>

#### Modified(\*args, \*\*kwargs)

Resets all the cache information after a change in the subject being tracked.

<a id="generated.RAParticleTimeSelectionProcess.RemoveCustomCurve"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.RemoveCustomProperty"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.RemoveOutputVariable"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.RemoveProcess"></a>

#### RemoveProcess()

Removes the process from the project.

<a id="generated.RAParticleTimeSelectionProcess.SetAbsoluteTimeRange"></a>

#### SetAbsoluteTimeRange(initial_time, final_time, unit='s')
...
<a id="generated.RAParticleTimeSelectionProcess.SetCurrentTimeStep"></a>
...
<a id="generated.RAParticleTimeSelectionProcess.SetTimeRange"></a>

#### SetTimeRange(range_definition=None, initial=None, final=None, unit='s')
