...
**Example 1.1: Sample Reaction Mechanism as Read by the _Gas-phase Kinetics_
Pre-processor**
...
where ![image](./graphics/eq46866867-7696-0694-4316-160670959464.svg) is the temperature, ![image](./graphics/eq03997499-9721-2657-4837-302200179031.svg) the mass
...
production rates. The representation of this equation begins with _Gas-phase
Kinetics_ subroutine calls (the output variables are underlined to help
distinguish them):

**Example 1.2:_Gas-phase Kinetics_ subroutine call**
...
_chem.asc_ , and `LOUT` is the logical file number for printed diagnostic and
