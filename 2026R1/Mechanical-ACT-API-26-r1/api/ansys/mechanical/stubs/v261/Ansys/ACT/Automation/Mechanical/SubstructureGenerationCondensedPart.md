...
| [`FutureExpansion`](#SubstructureGenerationCondensedPart.FutureExpansion)                 | Gets or sets the Future Expansion property that controls whether to request specific data in the solver files required to perform an expansion pass on the condensed part. Default: ProgramControlled |
