...
<a id="ansys.mechanical.stubs.v261.Ansys.ACT.Automation.Mechanical.MeshWorkflowOutcome"></a>
...
| Name | Description |
|-----------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------|
| [`BodyCountChange`](#MeshWorkflowOutcome.BodyCountChange)                                           | Gets the change in number of bodies due to repairing.                                                                                       |
...
| [`EdgeCountChange`](#MeshWorkflowOutcome.EdgeCountChange)                                           | Gets the change in number of edges due to repairing.                                                                                        |
| [`FaceCountChange`](#MeshWorkflowOutcome.FaceCountChange)                                           | Gets the change in number of faces due to repairing.                                                                                        |
...
| [`IncompleteBoundaries`](#MeshWorkflowOutcome.IncompleteBoundaries)                                 | Gets the count of faces with incomplete boundaries.                                                                                         |
| [`InternalObject`](#MeshWorkflowOutcome.InternalObject)                                             | Gets the internal object. For advanced usage only.                                                                                          |
| [`IntersectingPairs`](#MeshWorkflowOutcome.IntersectingPairs)                                       | Gets the count of faces with intersecting pairs.                                                                                            |
| [`InvalidBoundaries`](#MeshWorkflowOutcome.InvalidBoundaries)                                       | Gets the count of faces with invalid boundary orientation.                                                                                  |
| [`MissingBoundaries`](#MeshWorkflowOutcome.MissingBoundaries)                                       | Gets the count of faces with missing boundaries.                                                                                            |
...
| [`NumberOfFacesWithSkewedElements`](#MeshWorkflowOutcome.NumberOfFacesWithSkewedElements)           | Gets the count of faces with skewed elements.                                                                                               |
| [`NumberOfFreeEdges`](#MeshWorkflowOutcome.NumberOfFreeEdges)                                       | Gets the count of free edges.                                                                                                               |
| [`NumberOfMultiEdges`](#MeshWorkflowOutcome.NumberOfMultiEdges)                                     | Gets the count of multi edges.                                                                                                              |
| [`NumberOfSelfIntersections`](#MeshWorkflowOutcome.NumberOfSelfIntersections)                       | Gets the count of faces with self-intersections.                                                                                            |
| [`NumberOfVolumes`](#MeshWorkflowOutcome.NumberOfVolumes)                                           | Gets the count of volumes.                                                                                                                  |
| [`OutcomeType`](#MeshWorkflowOutcome.OutcomeType)                                                   | Returns the type of the control.                                                                                                            |
| [`OverlappingFaces`](#MeshWorkflowOutcome.OverlappingFaces)                                         | Gets the count of faces which overlap.                                                                                                      |
| [`Properties`](#MeshWorkflowOutcome.Properties)                                                     | Gets the list of properties for this object.                                                                                                |
| [`RecordingName`](#MeshWorkflowOutcome.RecordingName)                                               |                                                                                                                                             |
...
| [`SmallEdges`](#MeshWorkflowOutcome.SmallEdges)                                                     | Gets the count of small edges.                                                                                                              |
...
| [`SolderBallBottomPadScopeMethod`](#MeshWorkflowOutcome.SolderBallBottomPadScopeMethod)             | Gets the scope method for the Solder Ball Bottom Pad scope outcome.                                                                         |
| [`SolderBallBottomPadScopePattern`](#MeshWorkflowOutcome.SolderBallBottomPadScopePattern)           | Gets the scope pattern for the Solder Ball Bottom Pad scope outcome.                                                                        |
| [`SolderBallTopPadScopeMethod`](#MeshWorkflowOutcome.SolderBallTopPadScopeMethod)                   | Gets the scope method for the Solder Ball Top Pad scope outcome.                                                                            |
| [`SolderBallTopPadScopePattern`](#MeshWorkflowOutcome.SolderBallTopPadScopePattern)                 | Gets the scope pattern for the Solder Ball Top Pad scope outcome.                                                                           |
| [`ThinStripes`](#MeshWorkflowOutcome.ThinStripes)                                                   | Gets the count of faces which are considered thin stripes.                                                                                  |
| [`UnconnectedFreeEdges`](#MeshWorkflowOutcome.UnconnectedFreeEdges)                                 | Gets the count of unconnected free edges.                                                                                                   |
| [`VertexCountChange`](#MeshWorkflowOutcome.VertexCountChange)                                       | Gets the change in number of vertices due to repairing.                                                                                     |
...
<a id="MeshWorkflowOutcome.BodyCountChange"></a>

### *property* MeshWorkflowOutcome.BodyCountChange *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)*
...
### *property* MeshWorkflowOutcome.BoundingBoxDimensions *: [Ansys.Mechanical.Graphics.Point](../../../Mechanical/Graphics/Point.md#ansys.mechanical.stubs.v261.Ansys.Mechanical.Graphics.Point) | [None](https://docs.python.org/3/library/constants.html#None)*
...
### *property* MeshWorkflowOutcome.Children *: List[[Ansys.Mechanical.DataModel.Interfaces.IDataModelObject](../../../Mechanical/DataModel/Interfaces/IDataModelObject.md#ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.Interfaces.IDataModelObject)] | [None](https://docs.python.org/3/library/constants.html#None)*
...
### *property* MeshWorkflowOutcome.DataModelObjectCategory *: [Ansys.Mechanical.DataModel.Enums.DataModelObjectCategory](../../../Mechanical/DataModel/Enums/DataModelObjectCategory.md#ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.Enums.DataModelObjectCategory) | [None](https://docs.python.org/3/library/constants.html#None)*

Gets the current DataModelObject's category.

<!-- !! processed by numpydoc !! -->

<a id="MeshWorkflowOutcome.EdgeCountChange"></a>

### *property* MeshWorkflowOutcome.EdgeCountChange *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)*

Gets the change in number of edges due to repairing.

<!-- !! processed by numpydoc !! -->

<a id="MeshWorkflowOutcome.FaceCountChange"></a>

### *property* MeshWorkflowOutcome.FaceCountChange *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)*
...
### *property* MeshWorkflowOutcome.Figures *: Iterable[[Ansys.ACT.Automation.Mechanical.Figure](Figure.md#ansys.mechanical.stubs.v261.Ansys.ACT.Automation.Mechanical.Figure)] | [None](https://docs.python.org/3/library/constants.html#None)*
...
### *property* MeshWorkflowOutcome.Images *: Iterable[[Ansys.ACT.Automation.Mechanical.Image](Image.md#ansys.mechanical.stubs.v261.Ansys.ACT.Automation.Mechanical.Image)] | [None](https://docs.python.org/3/library/constants.html#None)*

Gets the list of associated images.

<!-- !! processed by numpydoc !! -->

<a id="MeshWorkflowOutcome.IncompleteBoundaries"></a>

### *property* MeshWorkflowOutcome.IncompleteBoundaries *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)*
...
<a id="MeshWorkflowOutcome.IntersectingPairs"></a>

### *property* MeshWorkflowOutcome.IntersectingPairs *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)*

Gets the count of faces with intersecting pairs.

<!-- !! processed by numpydoc !! -->

<a id="MeshWorkflowOutcome.InvalidBoundaries"></a>

### *property* MeshWorkflowOutcome.InvalidBoundaries *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)*

Gets the count of faces with invalid boundary orientation.

<!-- !! processed by numpydoc !! -->

<a id="MeshWorkflowOutcome.MissingBoundaries"></a>

### *property* MeshWorkflowOutcome.MissingBoundaries *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)*
...
### *property* MeshWorkflowOutcome.MultiZoneDefeaturedEdgesScopeMethod *: [Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType](../../../Mechanical/DataModel/MechanicalEnums/MeshWorkflow/ScopeType.md#ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType) | [None](https://docs.python.org/3/library/constants.html#None)*
...
### *property* MeshWorkflowOutcome.MultiZoneFailedInflationScopeMethod *: [Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType](../../../Mechanical/DataModel/MechanicalEnums/MeshWorkflow/ScopeType.md#ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType) | [None](https://docs.python.org/3/library/constants.html#None)*
...
### *property* MeshWorkflowOutcome.MultiZoneFailedInputScopeMethod *: [Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType](../../../Mechanical/DataModel/MechanicalEnums/MeshWorkflow/ScopeType.md#ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType) | [None](https://docs.python.org/3/library/constants.html#None)*
...
### *property* MeshWorkflowOutcome.MultiZoneFailedMeshCheckScopeMethod *: [Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType](../../../Mechanical/DataModel/MechanicalEnums/MeshWorkflow/ScopeType.md#ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType) | [None](https://docs.python.org/3/library/constants.html#None)*
...
### *property* MeshWorkflowOutcome.MultiZoneFailedMeshScopeMethod *: [Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType](../../../Mechanical/DataModel/MechanicalEnums/MeshWorkflow/ScopeType.md#ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType) | [None](https://docs.python.org/3/library/constants.html#None)*
...
### *property* MeshWorkflowOutcome.MultiZoneFreeMeshScopeMethod *: [Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType](../../../Mechanical/DataModel/MechanicalEnums/MeshWorkflow/ScopeType.md#ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType) | [None](https://docs.python.org/3/library/constants.html#None)*
...
<a id="MeshWorkflowOutcome.NumberOfFacesWithSkewedElements"></a>

### *property* MeshWorkflowOutcome.NumberOfFacesWithSkewedElements *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)*

Gets the count of faces with skewed elements.

<!-- !! processed by numpydoc !! -->

<a id="MeshWorkflowOutcome.NumberOfFreeEdges"></a>

### *property* MeshWorkflowOutcome.NumberOfFreeEdges *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)*

Gets the count of free edges.

<!-- !! processed by numpydoc !! -->

<a id="MeshWorkflowOutcome.NumberOfMultiEdges"></a>

### *property* MeshWorkflowOutcome.NumberOfMultiEdges *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)*

Gets the count of multi edges.

<!-- !! processed by numpydoc !! -->

<a id="MeshWorkflowOutcome.NumberOfSelfIntersections"></a>

### *property* MeshWorkflowOutcome.NumberOfSelfIntersections *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)*

Gets the count of faces with self-intersections.

<!-- !! processed by numpydoc !! -->

<a id="MeshWorkflowOutcome.NumberOfVolumes"></a>

### *property* MeshWorkflowOutcome.NumberOfVolumes *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)*
...
### *property* MeshWorkflowOutcome.OutcomeType *: [Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.OutcomeType](../../../Mechanical/DataModel/MechanicalEnums/MeshWorkflow/OutcomeType.md#ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.OutcomeType) | [None](https://docs.python.org/3/library/constants.html#None)*

Returns the type of the control.

<!-- !! processed by numpydoc !! -->

<a id="MeshWorkflowOutcome.OverlappingFaces"></a>

### *property* MeshWorkflowOutcome.OverlappingFaces *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)*
...
<a id="MeshWorkflowOutcome.RecordingName"></a>

### *property* MeshWorkflowOutcome.RecordingName *: [str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)*
...
### *property* MeshWorkflowOutcome.ScopeMethod *: [Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType](../../../Mechanical/DataModel/MechanicalEnums/MeshWorkflow/ScopeType.md#ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType) | [None](https://docs.python.org/3/library/constants.html#None)*
...
### *property* MeshWorkflowOutcome.ScopeOutcome *: [Ansys.ACT.Automation.Mechanical.MeshWorkflowOutcome](#ansys.mechanical.stubs.v261.Ansys.ACT.Automation.Mechanical.MeshWorkflowOutcome) | [None](https://docs.python.org/3/library/constants.html#None)*
...
<a id="MeshWorkflowOutcome.SmallEdges"></a>

### *property* MeshWorkflowOutcome.SmallEdges *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)*
...
### *property* MeshWorkflowOutcome.SmallestLateralEdgeLength *: [Ansys.Core.Units.Quantity](../../../Core/Units/Quantity.md#ansys.mechanical.stubs.v261.Ansys.Core.Units.Quantity) | [None](https://docs.python.org/3/library/constants.html#None)*
...
### *property* MeshWorkflowOutcome.SmallestStackingEdgeLength *: [Ansys.Core.Units.Quantity](../../../Core/Units/Quantity.md#ansys.mechanical.stubs.v261.Ansys.Core.Units.Quantity) | [None](https://docs.python.org/3/library/constants.html#None)*

Gets the smallest edge length along the stacking direction.

<!-- !! processed by numpydoc !! -->

<a id="MeshWorkflowOutcome.SolderBallBottomPadScopeMethod"></a>

### *property* MeshWorkflowOutcome.SolderBallBottomPadScopeMethod *: [Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType](../../../Mechanical/DataModel/MechanicalEnums/MeshWorkflow/ScopeType.md#ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType) | [None](https://docs.python.org/3/library/constants.html#None)*

Gets the scope method for the Solder Ball Bottom Pad scope outcome.

<!-- !! processed by numpydoc !! -->

<a id="MeshWorkflowOutcome.SolderBallBottomPadScopePattern"></a>

### *property* MeshWorkflowOutcome.SolderBallBottomPadScopePattern *: [str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)*

Gets the scope pattern for the Solder Ball Bottom Pad scope outcome.

<!-- !! processed by numpydoc !! -->

<a id="MeshWorkflowOutcome.SolderBallTopPadScopeMethod"></a>

### *property* MeshWorkflowOutcome.SolderBallTopPadScopeMethod *: [Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType](../../../Mechanical/DataModel/MechanicalEnums/MeshWorkflow/ScopeType.md#ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.MechanicalEnums.MeshWorkflow.ScopeType) | [None](https://docs.python.org/3/library/constants.html#None)*

Gets the scope method for the Solder Ball Top Pad scope outcome.

<!-- !! processed by numpydoc !! -->

<a id="MeshWorkflowOutcome.SolderBallTopPadScopePattern"></a>

### *property* MeshWorkflowOutcome.SolderBallTopPadScopePattern *: [str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)*

Gets the scope pattern for the Solder Ball Top Pad scope outcome.

<!-- !! processed by numpydoc !! -->

<a id="MeshWorkflowOutcome.ThinStripes"></a>

### *property* MeshWorkflowOutcome.ThinStripes *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)*

Gets the count of faces which are considered thin stripes.

<!-- !! processed by numpydoc !! -->

<a id="MeshWorkflowOutcome.UnconnectedFreeEdges"></a>

### *property* MeshWorkflowOutcome.UnconnectedFreeEdges *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)*

Gets the count of unconnected free edges.

<!-- !! processed by numpydoc !! -->

<a id="MeshWorkflowOutcome.VertexCountChange"></a>

### *property* MeshWorkflowOutcome.VertexCountChange *: [int](https://docs.python.org/3/library/functions.html#int) | [None](https://docs.python.org/3/library/constants.html#None)*
...
### MeshWorkflowOutcome.AddFigure() → [Ansys.ACT.Automation.Mechanical.Figure](Figure.md#ansys.mechanical.stubs.v261.Ansys.ACT.Automation.Mechanical.Figure)
...
### MeshWorkflowOutcome.AddImage(filePath: [str](https://docs.python.org/3/library/stdtypes.html#str)) → [Ansys.ACT.Automation.Mechanical.Image](Image.md#ansys.mechanical.stubs.v261.Ansys.ACT.Automation.Mechanical.Image)
...
### MeshWorkflowOutcome.Duplicate() → [Ansys.Mechanical.DataModel.Interfaces.IDataModelObject](../../../Mechanical/DataModel/Interfaces/IDataModelObject.md#ansys.mechanical.stubs.v261.Ansys.Mechanical.DataModel.Interfaces.IDataModelObject)
...
### MeshWorkflowOutcome.GroupSimilarObjects() → [Ansys.ACT.Automation.Mechanical.TreeGroupingFolder](TreeGroupingFolder.md#ansys.mechanical.stubs.v261.Ansys.ACT.Automation.Mechanical.TreeGroupingFolder)
