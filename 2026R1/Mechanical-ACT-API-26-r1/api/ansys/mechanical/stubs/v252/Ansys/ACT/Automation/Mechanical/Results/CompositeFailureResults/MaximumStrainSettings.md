...
<a id="ansys.mechanical.stubs.v252.Ansys.ACT.Automation.Mechanical.Results.CompositeFailureResults.MaximumStrainSettings"></a>
...
### MaximumStrainSettings.Reset() → [None](https://docs.python.org/3/library/constants.html#None)
