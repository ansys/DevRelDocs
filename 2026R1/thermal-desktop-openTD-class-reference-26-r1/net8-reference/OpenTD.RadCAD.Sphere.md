# <a id="OpenTD_RadCAD_Sphere"></a> Class Sphere
...
```csharp
public class Sphere : RcSphereData, IUpdatable
```
...
### <a id="OpenTD_RadCAD_Sphere_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_RadCAD_Sphere_Update"></a> Update\(\)
...
### <a id="OpenTD_RadCAD_Sphere_UpdateFromTD"></a> UpdateFromTD\(\)
