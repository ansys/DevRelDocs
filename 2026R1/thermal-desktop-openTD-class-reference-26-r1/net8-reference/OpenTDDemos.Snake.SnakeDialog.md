# <a id="OpenTDDemos_Snake_SnakeDialog"></a> Class SnakeDialog

Namespace: [OpenTDDemos.Snake](OpenTDDemos.Snake.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class SnakeDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[SnakeDialog](OpenTDDemos.Snake.SnakeDialog.md)
...
### <a id="OpenTDDemos_Snake_SnakeDialog__ctor"></a> SnakeDialog\(\)
...
### <a id="OpenTDDemos_Snake_SnakeDialog_ControlDown"></a> ControlDown
...
### <a id="OpenTDDemos_Snake_SnakeDialog_ControlLeft"></a> ControlLeft
...
### <a id="OpenTDDemos_Snake_SnakeDialog_ControlRight"></a> ControlRight
...
### <a id="OpenTDDemos_Snake_SnakeDialog_ControlUp"></a> ControlUp
...
### <a id="OpenTDDemos_Snake_SnakeDialog_StopRequested"></a> StopRequested
...
### <a id="OpenTDDemos_Snake_SnakeDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
...
### <a id="OpenTDDemos_Snake_SnakeDialog_ProcessCmdKey_System_Windows_Forms_Message__System_Windows_Forms_Keys_"></a> ProcessCmdKey\(ref Message, Keys\)
...
`msg` [Message](https://learn.microsoft.com/dotnet/api/system.windows.forms.message)

A <xref href="System.Windows.Forms.Message" data-throw-if-not-resolved="false"></xref>, passed by reference, that represents the Win32 message to process.

`keyData` [Keys](https://learn.microsoft.com/dotnet/api/system.windows.forms.keys)

One of the <xref href="System.Windows.Forms.Keys" data-throw-if-not-resolved="false"></xref> values that represents the key to process.

#### Returns

 [bool](https://learn.microsoft.com/dotnet/api/system.boolean)

<a href="https://learn.microsoft.com/dotnet/csharp/language-reference/builtin-types/bool">true</a> if the keystroke was processed and consumed by the control; otherwise, <a href="https://learn.microsoft.com/dotnet/csharp/language-reference/builtin-types/bool">false</a> to allow further processing.
