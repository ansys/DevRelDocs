# <a id="OpenTDDemos_FeMeshSpiral_FeMeshSpiralDialog"></a> Class FeMeshSpiralDialog

Namespace: [OpenTDDemos.FeMeshSpiral](OpenTDDemos.FeMeshSpiral.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class FeMeshSpiralDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
### <a id="OpenTDDemos_FeMeshSpiral_FeMeshSpiralDialog__ctor"></a> FeMeshSpiralDialog\(\)
...
### <a id="OpenTDDemos_FeMeshSpiral_FeMeshSpiralDialog_td"></a> td
...
### <a id="OpenTDDemos_FeMeshSpiral_FeMeshSpiralDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
