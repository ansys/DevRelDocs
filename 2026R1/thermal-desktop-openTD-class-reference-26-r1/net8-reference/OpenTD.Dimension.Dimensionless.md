# <a id="OpenTD_Dimension_Dimensionless"></a> Class Dimensionless
...
### <a id="OpenTD_Dimension_Dimensionless_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Dimensionless_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Dimensionless_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Dimensionless_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Dimensionless_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
