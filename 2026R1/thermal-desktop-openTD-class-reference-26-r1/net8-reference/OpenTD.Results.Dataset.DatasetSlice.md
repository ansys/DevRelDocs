...
`inputDataset` [IDataset](OpenTD.Results.Dataset.IDataset.md)

`beginTime` [double](https://learn.microsoft.com/dotnet/api/system.double)
...
```csharp
public Dimensional<Time> BeginTime { get; set; }
```
