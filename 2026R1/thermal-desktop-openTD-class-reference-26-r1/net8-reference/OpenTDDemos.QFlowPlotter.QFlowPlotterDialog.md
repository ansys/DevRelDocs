# <a id="OpenTDDemos_QFlowPlotter_QFlowPlotterDialog"></a> Class QFlowPlotterDialog

Namespace: [OpenTDDemos.QFlowPlotter](OpenTDDemos.QFlowPlotter.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class QFlowPlotterDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[QFlowPlotterDialog](OpenTDDemos.QFlowPlotter.QFlowPlotterDialog.md)
...
### <a id="OpenTDDemos_QFlowPlotter_QFlowPlotterDialog__ctor"></a> QFlowPlotterDialog\(\)
...
### <a id="OpenTDDemos_QFlowPlotter_QFlowPlotterDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
