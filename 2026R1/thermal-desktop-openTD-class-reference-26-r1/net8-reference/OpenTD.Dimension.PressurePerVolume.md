# <a id="OpenTD_Dimension_PressurePerVolume"></a> Class PressurePerVolume

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class PressurePerVolume : IDimension
```
...
### <a id="OpenTD_Dimension_PressurePerVolume_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_PressurePerVolume_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_PressurePerVolume_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_PressurePerVolume_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_PressurePerVolume_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
