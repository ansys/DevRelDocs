# <a id="OpenTD_Contactor"></a> Class Contactor
...
### <a id="OpenTD_Contactor_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_Contactor_Update"></a> Update\(\)
