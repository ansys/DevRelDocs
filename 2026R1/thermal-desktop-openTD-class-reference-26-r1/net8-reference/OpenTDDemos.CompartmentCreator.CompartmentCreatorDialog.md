# <a id="OpenTDDemos_CompartmentCreator_CompartmentCreatorDialog"></a> Class CompartmentCreatorDialog

Namespace: [OpenTDDemos.CompartmentCreator](OpenTDDemos.CompartmentCreator.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class CompartmentCreatorDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
### <a id="OpenTDDemos_CompartmentCreator_CompartmentCreatorDialog__ctor"></a> CompartmentCreatorDialog\(\)
...
### <a id="OpenTDDemos_CompartmentCreator_CompartmentCreatorDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
