...
```csharp
public class Text : TdTextData, IUpdatable
```
...
### <a id="OpenTD_Text_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_Text_Update"></a> Update\(\)
