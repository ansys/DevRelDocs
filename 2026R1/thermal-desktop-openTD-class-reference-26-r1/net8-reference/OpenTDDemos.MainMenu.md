# <a id="OpenTDDemos_MainMenu"></a> Class MainMenu

Namespace: [OpenTDDemos](OpenTDDemos.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class MainMenu : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[MainMenu](OpenTDDemos.MainMenu.md)
...
### <a id="OpenTDDemos_MainMenu__ctor_System_Collections_Generic_List_OpenTD_Script__"></a> MainMenu\(List<Script\>\)
...
`demos` [List](https://learn.microsoft.com/dotnet/api/system.collections.generic.list\-1)<Script\>

## Methods

### <a id="OpenTDDemos_MainMenu_Dispose_System_Boolean_"></a> Dispose\(bool\)
