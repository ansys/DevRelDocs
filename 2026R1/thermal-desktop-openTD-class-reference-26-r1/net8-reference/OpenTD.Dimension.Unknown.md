# <a id="OpenTD_Dimension_Unknown"></a> Class Unknown

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class Unknown : IDimension
```
...
### <a id="OpenTD_Dimension_Unknown_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Unknown_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Unknown_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Unknown_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Unknown_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
