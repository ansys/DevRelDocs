# <a id="OpenTD_Dimension_Current"></a> Class Current

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class Current : IDimension
```
...
### <a id="OpenTD_Dimension_Current_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Current_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Current_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Current_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Current_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
