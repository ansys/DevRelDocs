# <a id="OpenTD_Results_Dataset_CSR"></a> Class CSR
...
```csharp
public class CSR : RecordFocusedDataset, IDataset
```
...
### <a id="OpenTD_Results_Dataset_CSR__ctor_System_String_"></a> CSR\(string\)

```csharp
public CSR(string pathToCSR)
```

#### Parameters

`pathToCSR` [string](https://learn.microsoft.com/dotnet/api/system.string)

## Properties

### <a id="OpenTD_Results_Dataset_CSR_Pathname"></a> Pathname
...
### <a id="OpenTD_Results_Dataset_CSR_Close"></a> Close\(\)

```csharp
public override void Close()
```

### <a id="OpenTD_Results_Dataset_CSR_GetAbszro"></a> GetAbszro\(\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetConductorIds_System_String_"></a> GetConductorIds\(string\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetConstraintData_System_Int64_OpenTD_Results_Dataset_DataSubtype_OpenTD_UnitsData_"></a> GetConstraintData\(long, DataSubtype, UnitsData\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetDataAtRecord_OpenTD_Results_Dataset_DataSubtype_System_Int64_"></a> GetDataAtRecord\(DataSubtype, long\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetFluidSubmodels"></a> GetFluidSubmodels\(\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetFtieIds_System_String_"></a> GetFtieIds\(string\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetIfaceIds_System_String_"></a> GetIfaceIds\(string\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetInternalIndex_OpenTD_Results_Dataset_DataTypes_System_String_System_Int64_"></a> GetInternalIndex\(DataTypes, string, long\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetLoopcoData"></a> GetLoopcoData\(\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetLoopctData"></a> GetLoopctData\(\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetLumpIds_System_String_"></a> GetLumpIds\(string\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetNamedInt_System_String_"></a> GetNamedInt\(string\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetNamedIntArray_System_String_"></a> GetNamedIntArray\(string\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetNodeIds_System_String_"></a> GetNodeIds\(string\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetNpcsrec_System_Int64_"></a> GetNpcsrec\(long\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetNsol_System_Int64_"></a> GetNsol\(long\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetPathIds_System_String_"></a> GetPathIds\(string\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetPatmos"></a> GetPatmos\(\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetRecordNames"></a> GetRecordNames\(\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetRecordNumbers"></a> GetRecordNumbers\(\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetRegisterDataAtRecord_System_Int64_OpenTD_Results_Dataset_DataSubtype_OpenTD_UnitsData_"></a> GetRegisterDataAtRecord\(long, DataSubtype, UnitsData\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetRegisterNames"></a> GetRegisterNames\(\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetReliabilityData_System_Int64_OpenTD_Results_Dataset_DataSubtype_OpenTD_UnitsData_"></a> GetReliabilityData\(long, DataSubtype, UnitsData\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetSigma"></a> GetSigma\(\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetThermalSubmodels"></a> GetThermalSubmodels\(\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetTieIds_System_String_"></a> GetTieIds\(string\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetTimes"></a> GetTimes\(\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetUdcaDataAtRecord_OpenTD_Results_Dataset_DataSubtype_System_Int64_"></a> GetUdcaDataAtRecord\(DataSubtype, long\)
...
### <a id="OpenTD_Results_Dataset_CSR_GetUdfasAtRecord_System_Int64_"></a> GetUdfasAtRecord\(long\)
...
### <a id="OpenTD_Results_Dataset_CSR_ReOpen"></a> ReOpen\(\)
