# <a id="OpenTD_RadCAD_ScarfedCylinder"></a> Class ScarfedCylinder
...
```csharp
public class ScarfedCylinder : RcScarfedCylinderData, IUpdatable
```
...
### <a id="OpenTD_RadCAD_ScarfedCylinder_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_RadCAD_ScarfedCylinder_Update"></a> Update\(\)
...
### <a id="OpenTD_RadCAD_ScarfedCylinder_UpdateFromTD"></a> UpdateFromTD\(\)
