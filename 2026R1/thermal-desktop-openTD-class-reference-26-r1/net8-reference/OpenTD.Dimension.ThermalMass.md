# <a id="OpenTD_Dimension_ThermalMass"></a> Class ThermalMass

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class ThermalMass : IDimension
```
...
### <a id="OpenTD_Dimension_ThermalMass_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_ThermalMass_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_ThermalMass_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_ThermalMass_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_ThermalMass_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
