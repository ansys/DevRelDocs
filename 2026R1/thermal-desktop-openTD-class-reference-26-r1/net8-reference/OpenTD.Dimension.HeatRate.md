# <a id="OpenTD_Dimension_HeatRate"></a> Class HeatRate

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class HeatRate : IDimension
```
...
### <a id="OpenTD_Dimension_HeatRate_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_HeatRate_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_HeatRate_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_HeatRate_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_HeatRate_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
