# <a id="OpenTD_Heater"></a> Class Heater
...
```csharp
public class Heater : RcHeaterData, IUpdatable
```
...
### <a id="OpenTD_Heater_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_Heater_Update"></a> Update\(\)
