# <a id="OpenTD_Dimension_SpecificHeat"></a> Class SpecificHeat

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class SpecificHeat : IDimension
```
...
### <a id="OpenTD_Dimension_SpecificHeat_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_SpecificHeat_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_SpecificHeat_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_SpecificHeat_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_SpecificHeat_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
