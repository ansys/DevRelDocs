# <a id="OpenTD_RadCAD_Torus"></a> Class Torus
...
```csharp
public class Torus : RcTorusData, IUpdatable
```
...
### <a id="OpenTD_RadCAD_Torus_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_RadCAD_Torus_Update"></a> Update\(\)
...
### <a id="OpenTD_RadCAD_Torus_UpdateFromTD"></a> UpdateFromTD\(\)
