# <a id="OpenTD_Dimension_ModelLength"></a> Class ModelLength

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class ModelLength : IDimension
```
...
### <a id="OpenTD_Dimension_ModelLength_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_ModelLength_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_ModelLength_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_ModelLength_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_ModelLength_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
