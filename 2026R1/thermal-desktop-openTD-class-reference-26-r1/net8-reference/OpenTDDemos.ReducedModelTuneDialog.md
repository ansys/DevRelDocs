# <a id="OpenTDDemos_ReducedModelTuneDialog"></a> Class ReducedModelTuneDialog

Namespace: [OpenTDDemos](OpenTDDemos.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class ReducedModelTuneDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[ReducedModelTuneDialog](OpenTDDemos.ReducedModelTuneDialog.md)
...
### <a id="OpenTDDemos_ReducedModelTuneDialog__ctor_OpenTD_ThermalDesktop_OpenTD_ThermalDesktop_OpenTD_FloCAD_Lump_OpenTD_FloCAD_Lump_OpenTD_FloCAD_Path_System_String_"></a> ReducedModelTuneDialog\(ThermalDesktop, ThermalDesktop, Lump, Lump, Path, string\)

```csharp
public ReducedModelTuneDialog(ThermalDesktop tdin, ThermalDesktop tdout, Lump beg, Lump end, Path reduced, string WorkingDirectory)
```
...
### <a id="OpenTDDemos_ReducedModelTuneDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
