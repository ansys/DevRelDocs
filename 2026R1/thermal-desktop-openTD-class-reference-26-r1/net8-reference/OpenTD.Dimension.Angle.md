# <a id="OpenTD_Dimension_Angle"></a> Class Angle

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class Angle : IDimension
```
...
### <a id="OpenTD_Dimension_Angle_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Angle_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Angle_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Angle_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Angle_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
