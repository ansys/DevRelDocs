# <a id="OpenTD_Dimension_Velocity"></a> Class Velocity
...
### <a id="OpenTD_Dimension_Velocity_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Velocity_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Velocity_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Velocity_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Velocity_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
