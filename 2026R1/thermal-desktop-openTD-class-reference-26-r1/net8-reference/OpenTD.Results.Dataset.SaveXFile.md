# <a id="OpenTD_Results_Dataset_SaveXFile"></a> Class SaveXFile
...
```csharp
public class SaveXFile : RecordFocusedDataset, IDataset, IDisposable
```
...
### <a id="OpenTD_Results_Dataset_SaveXFile__ctor_System_String_"></a> SaveXFile\(string\)

```csharp
public SaveXFile(string pathToSaveX)
```

#### Parameters

`pathToSaveX` [string](https://learn.microsoft.com/dotnet/api/system.string)

## Properties

### <a id="OpenTD_Results_Dataset_SaveXFile_Pathname"></a> Pathname
...
### <a id="OpenTD_Results_Dataset_SaveXFile_Close"></a> Close\(\)

```csharp
public override void Close()
```

### <a id="OpenTD_Results_Dataset_SaveXFile_Dispose_System_Boolean_"></a> Dispose\(bool\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_Dispose"></a> Dispose\(\)

Do not use. To release resources, call Close() instead.

```csharp
public void Dispose()
```

### <a id="OpenTD_Results_Dataset_SaveXFile_Finalize"></a> \~SaveXFile\(\)

```csharp
protected ~SaveXFile()
```

### <a id="OpenTD_Results_Dataset_SaveXFile_GetAbszro"></a> GetAbszro\(\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetConductorIds_System_String_"></a> GetConductorIds\(string\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetConstraintData_System_Int64_OpenTD_Results_Dataset_DataSubtype_OpenTD_UnitsData_"></a> GetConstraintData\(long, DataSubtype, UnitsData\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetDataAtRecord_OpenTD_Results_Dataset_DataSubtype_System_Int64_"></a> GetDataAtRecord\(DataSubtype, long\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetFluidSubmodels"></a> GetFluidSubmodels\(\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetFtieIds_System_String_"></a> GetFtieIds\(string\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetIfaceIds_System_String_"></a> GetIfaceIds\(string\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetInternalIndex_OpenTD_Results_Dataset_DataTypes_System_String_System_Int64_"></a> GetInternalIndex\(DataTypes, string, long\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetLoopcoData"></a> GetLoopcoData\(\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetLoopctData"></a> GetLoopctData\(\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetLumpIds_System_String_"></a> GetLumpIds\(string\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetNamedInt_System_String_"></a> GetNamedInt\(string\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetNamedIntArray_System_String_"></a> GetNamedIntArray\(string\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetNodeIds_System_String_"></a> GetNodeIds\(string\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetNpcsrec_System_Int64_"></a> GetNpcsrec\(long\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetNsol_System_Int64_"></a> GetNsol\(long\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetPathIds_System_String_"></a> GetPathIds\(string\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetPatmos"></a> GetPatmos\(\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetRecordNames"></a> GetRecordNames\(\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetRecordNumbers"></a> GetRecordNumbers\(\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetRegisterDataAtRecord_System_Int64_OpenTD_Results_Dataset_DataSubtype_OpenTD_UnitsData_"></a> GetRegisterDataAtRecord\(long, DataSubtype, UnitsData\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetRegisterNames"></a> GetRegisterNames\(\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetReliabilityData_System_Int64_OpenTD_Results_Dataset_DataSubtype_OpenTD_UnitsData_"></a> GetReliabilityData\(long, DataSubtype, UnitsData\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetSigma"></a> GetSigma\(\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetThermalSubmodels"></a> GetThermalSubmodels\(\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetTieIds_System_String_"></a> GetTieIds\(string\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetTimes"></a> GetTimes\(\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetUdcaData_OpenTD_Results_Dataset_DataItemIdentifierCollection_"></a> GetUdcaData\(DataItemIdentifierCollection\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetUdcaDataAtRecord_OpenTD_Results_Dataset_DataSubtype_System_Int64_"></a> GetUdcaDataAtRecord\(DataSubtype, long\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_GetUdfasAtRecord_System_Int64_"></a> GetUdfasAtRecord\(long\)
...
### <a id="OpenTD_Results_Dataset_SaveXFile_ReOpen"></a> ReOpen\(\)
