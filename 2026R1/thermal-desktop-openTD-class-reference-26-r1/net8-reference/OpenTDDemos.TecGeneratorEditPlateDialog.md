# <a id="OpenTDDemos_TecGeneratorEditPlateDialog"></a> Class TecGeneratorEditPlateDialog

Namespace: [OpenTDDemos](OpenTDDemos.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class TecGeneratorEditPlateDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[TecGeneratorEditPlateDialog](OpenTDDemos.TecGeneratorEditPlateDialog.md)
...
### <a id="OpenTDDemos_TecGeneratorEditPlateDialog__ctor_OpenTDDemos_Plate_"></a> TecGeneratorEditPlateDialog\(Plate\)
...
`x` [Plate](OpenTDDemos.Plate.md)

## Methods

### <a id="OpenTDDemos_TecGeneratorEditPlateDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
