...
```csharp
public class Tec : RcTecData, IUpdatable
```
...
### <a id="OpenTD_Tec_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_Tec_Update"></a> Update\(\)
