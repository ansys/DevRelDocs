# <a id="OpenTD_Dimension_HeatRatePerVolume"></a> Class HeatRatePerVolume

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class HeatRatePerVolume : IDimension
```
...
### <a id="OpenTD_Dimension_HeatRatePerVolume_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_HeatRatePerVolume_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_HeatRatePerVolume_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_HeatRatePerVolume_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_HeatRatePerVolume_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
