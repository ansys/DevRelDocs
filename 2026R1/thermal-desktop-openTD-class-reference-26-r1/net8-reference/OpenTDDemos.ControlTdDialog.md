# <a id="OpenTDDemos_ControlTdDialog"></a> Class ControlTdDialog

Namespace: [OpenTDDemos](OpenTDDemos.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class ControlTdDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[ControlTdDialog](OpenTDDemos.ControlTdDialog.md)
...
### <a id="OpenTDDemos_ControlTdDialog__ctor"></a> ControlTdDialog\(\)
...
### <a id="OpenTDDemos_ControlTdDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
