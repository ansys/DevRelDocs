# <a id="OpenTD_Dimension_MassFlowRate"></a> Class MassFlowRate

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class MassFlowRate : IDimension
```
...
### <a id="OpenTD_Dimension_MassFlowRate_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_MassFlowRate_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_MassFlowRate_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_MassFlowRate_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_MassFlowRate_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
