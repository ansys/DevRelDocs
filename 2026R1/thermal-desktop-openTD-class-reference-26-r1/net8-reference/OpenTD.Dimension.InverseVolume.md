# <a id="OpenTD_Dimension_InverseVolume"></a> Class InverseVolume

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class InverseVolume : IDimension
```
...
### <a id="OpenTD_Dimension_InverseVolume_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_InverseVolume_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_InverseVolume_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_InverseVolume_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_InverseVolume_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
