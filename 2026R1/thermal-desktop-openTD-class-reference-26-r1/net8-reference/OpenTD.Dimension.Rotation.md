# <a id="OpenTD_Dimension_Rotation"></a> Class Rotation

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class Rotation : IDimension
```
...
### <a id="OpenTD_Dimension_Rotation_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Rotation_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Rotation_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Rotation_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Rotation_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
