# <a id="OpenTDDemos_TranslatorDialog"></a> Class TranslatorDialog

Namespace: [OpenTDDemos](OpenTDDemos.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class TranslatorDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[TranslatorDialog](OpenTDDemos.TranslatorDialog.md)
...
### <a id="OpenTDDemos_TranslatorDialog__ctor"></a> TranslatorDialog\(\)
...
### <a id="OpenTDDemos_TranslatorDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
