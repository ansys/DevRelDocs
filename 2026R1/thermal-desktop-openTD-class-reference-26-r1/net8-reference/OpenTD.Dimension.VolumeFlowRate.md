# <a id="OpenTD_Dimension_VolumeFlowRate"></a> Class VolumeFlowRate

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class VolumeFlowRate : IDimension
```
...
### <a id="OpenTD_Dimension_VolumeFlowRate_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_VolumeFlowRate_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_VolumeFlowRate_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_VolumeFlowRate_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_VolumeFlowRate_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
