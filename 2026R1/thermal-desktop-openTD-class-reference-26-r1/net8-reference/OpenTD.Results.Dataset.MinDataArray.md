# <a id="OpenTD_Results_Dataset_MinDataArray"></a> Class MinDataArray
...
```csharp
public class MinDataArray : OneSubtypeDerivedDataArray, IEnumerable<double>, IEnumerable
```
...
### <a id="OpenTD_Results_Dataset_MinDataArray__ctor_OpenTD_Results_Dataset_DataArrayCollection_"></a> MinDataArray\(DataArrayCollection\)

```csharp
public MinDataArray(DataArrayCollection inputCollection)
```
...
### <a id="OpenTD_Results_Dataset_MinDataArray__ctor"></a> MinDataArray\(\)
...
### <a id="OpenTD_Results_Dataset_MinDataArray_CheckData"></a> CheckData\(\)

```csharp
protected override void CheckData()
```

### <a id="OpenTD_Results_Dataset_MinDataArray_GetSelfSuggestedName"></a> GetSelfSuggestedName\(\)
...
### <a id="OpenTD_Results_Dataset_MinDataArray_SetDerivedData"></a> SetDerivedData\(\)
