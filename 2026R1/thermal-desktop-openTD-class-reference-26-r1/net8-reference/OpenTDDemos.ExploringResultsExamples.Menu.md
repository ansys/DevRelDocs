# <a id="OpenTDDemos_ExploringResultsExamples_Menu"></a> Class Menu

Namespace: [OpenTDDemos.ExploringResultsExamples](OpenTDDemos.ExploringResultsExamples.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class Menu : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[Menu](OpenTDDemos.ExploringResultsExamples.Menu.md)
...
### <a id="OpenTDDemos_ExploringResultsExamples_Menu__ctor_System_Collections_Generic_List_OpenTDDemos_ExploringResultsExamples_Example__"></a> Menu\(List<Example\>\)
...
`examples` [List](https://learn.microsoft.com/dotnet/api/system.collections.generic.list\-1)<[Example](OpenTDDemos.ExploringResultsExamples.Example.md)\>

## Methods

### <a id="OpenTDDemos_ExploringResultsExamples_Menu_Dispose_System_Boolean_"></a> Dispose\(bool\)
