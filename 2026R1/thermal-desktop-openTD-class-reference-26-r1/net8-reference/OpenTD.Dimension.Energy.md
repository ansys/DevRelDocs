# <a id="OpenTD_Dimension_Energy"></a> Class Energy

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class Energy : IDimension
```
...
### <a id="OpenTD_Dimension_Energy_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Energy_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Energy_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Energy_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Energy_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
