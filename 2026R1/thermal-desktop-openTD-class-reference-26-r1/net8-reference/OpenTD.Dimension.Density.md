# <a id="OpenTD_Dimension_Density"></a> Class Density

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class Density : IDimension
```
...
### <a id="OpenTD_Dimension_Density_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Density_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Density_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Density_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Density_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
