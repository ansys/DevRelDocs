# <a id="OpenTDDemos_ReducedModelDialog"></a> Class ReducedModelDialog

Namespace: [OpenTDDemos](OpenTDDemos.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class ReducedModelDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[ReducedModelDialog](OpenTDDemos.ReducedModelDialog.md)
...
### <a id="OpenTDDemos_ReducedModelDialog__ctor"></a> ReducedModelDialog\(\)
...
### <a id="OpenTDDemos_ReducedModelDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
