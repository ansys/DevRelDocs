# <a id="OpenTDDemos_TecGeneratorEditCouplesDialog"></a> Class TecGeneratorEditCouplesDialog

Namespace: [OpenTDDemos](OpenTDDemos.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class TecGeneratorEditCouplesDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[TecGeneratorEditCouplesDialog](OpenTDDemos.TecGeneratorEditCouplesDialog.md)
...
### <a id="OpenTDDemos_TecGeneratorEditCouplesDialog__ctor_OpenTDDemos_Couples_"></a> TecGeneratorEditCouplesDialog\(Couples\)
...
`x` [Couples](OpenTDDemos.Couples.md)

## Methods

### <a id="OpenTDDemos_TecGeneratorEditCouplesDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
