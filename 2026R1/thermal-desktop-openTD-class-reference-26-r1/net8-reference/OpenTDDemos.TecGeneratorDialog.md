# <a id="OpenTDDemos_TecGeneratorDialog"></a> Class TecGeneratorDialog

Namespace: [OpenTDDemos](OpenTDDemos.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class TecGeneratorDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[TecGeneratorDialog](OpenTDDemos.TecGeneratorDialog.md)
...
### <a id="OpenTDDemos_TecGeneratorDialog__ctor"></a> TecGeneratorDialog\(\)
...
### <a id="OpenTDDemos_TecGeneratorDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
