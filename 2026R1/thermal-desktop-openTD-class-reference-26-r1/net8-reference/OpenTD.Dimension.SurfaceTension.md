# <a id="OpenTD_Dimension_SurfaceTension"></a> Class SurfaceTension

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class SurfaceTension : IDimension
```
...
### <a id="OpenTD_Dimension_SurfaceTension_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_SurfaceTension_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_SurfaceTension_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_SurfaceTension_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_SurfaceTension_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
