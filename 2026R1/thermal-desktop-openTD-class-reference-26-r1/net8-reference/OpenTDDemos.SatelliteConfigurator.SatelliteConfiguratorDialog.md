# <a id="OpenTDDemos_SatelliteConfigurator_SatelliteConfiguratorDialog"></a> Class SatelliteConfiguratorDialog

Namespace: [OpenTDDemos.SatelliteConfigurator](OpenTDDemos.SatelliteConfigurator.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class SatelliteConfiguratorDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[SatelliteConfiguratorDialog](OpenTDDemos.SatelliteConfigurator.SatelliteConfiguratorDialog.md)
...
### <a id="OpenTDDemos_SatelliteConfigurator_SatelliteConfiguratorDialog__ctor"></a> SatelliteConfiguratorDialog\(\)
...
### <a id="OpenTDDemos_SatelliteConfigurator_SatelliteConfiguratorDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
