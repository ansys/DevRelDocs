# <a id="OpenTD_Dimension_Voltage"></a> Class Voltage

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class Voltage : IDimension
```
...
### <a id="OpenTD_Dimension_Voltage_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Voltage_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Voltage_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Voltage_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Voltage_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
