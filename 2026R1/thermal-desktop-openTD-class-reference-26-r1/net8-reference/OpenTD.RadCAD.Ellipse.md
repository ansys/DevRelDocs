# <a id="OpenTD_RadCAD_Ellipse"></a> Class Ellipse
...
```csharp
public class Ellipse : RcEllipseData, IUpdatable
```
...
### <a id="OpenTD_RadCAD_Ellipse_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_RadCAD_Ellipse_Update"></a> Update\(\)
...
### <a id="OpenTD_RadCAD_Ellipse_UpdateFromTD"></a> UpdateFromTD\(\)
