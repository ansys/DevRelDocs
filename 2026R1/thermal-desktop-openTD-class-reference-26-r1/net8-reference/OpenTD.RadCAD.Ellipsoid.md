# <a id="OpenTD_RadCAD_Ellipsoid"></a> Class Ellipsoid
...
```csharp
public class Ellipsoid : RcEllipsoidData, IUpdatable
```
...
### <a id="OpenTD_RadCAD_Ellipsoid_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_RadCAD_Ellipsoid_Update"></a> Update\(\)
...
### <a id="OpenTD_RadCAD_Ellipsoid_UpdateFromTD"></a> UpdateFromTD\(\)
