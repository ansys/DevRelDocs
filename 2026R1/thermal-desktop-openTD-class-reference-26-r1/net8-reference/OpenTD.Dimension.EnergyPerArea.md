# <a id="OpenTD_Dimension_EnergyPerArea"></a> Class EnergyPerArea

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class EnergyPerArea : IDimension
```
...
### <a id="OpenTD_Dimension_EnergyPerArea_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_EnergyPerArea_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_EnergyPerArea_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_EnergyPerArea_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_EnergyPerArea_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
