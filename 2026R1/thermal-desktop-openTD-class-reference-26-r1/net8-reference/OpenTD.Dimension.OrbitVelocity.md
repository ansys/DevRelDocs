# <a id="OpenTD_Dimension_OrbitVelocity"></a> Class OrbitVelocity

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class OrbitVelocity : IDimension
```
...
### <a id="OpenTD_Dimension_OrbitVelocity_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_OrbitVelocity_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_OrbitVelocity_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_OrbitVelocity_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_OrbitVelocity_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
