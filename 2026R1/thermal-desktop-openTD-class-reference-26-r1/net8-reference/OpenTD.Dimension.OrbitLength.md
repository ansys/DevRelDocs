# <a id="OpenTD_Dimension_OrbitLength"></a> Class OrbitLength

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class OrbitLength : IDimension
```
...
### <a id="OpenTD_Dimension_OrbitLength_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_OrbitLength_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_OrbitLength_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_OrbitLength_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_OrbitLength_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
