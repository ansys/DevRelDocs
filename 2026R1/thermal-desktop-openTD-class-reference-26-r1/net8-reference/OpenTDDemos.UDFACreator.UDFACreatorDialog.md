# <a id="OpenTDDemos_UDFACreator_UDFACreatorDialog"></a> Class UDFACreatorDialog

Namespace: [OpenTDDemos.UDFACreator](OpenTDDemos.UDFACreator.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class UDFACreatorDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[UDFACreatorDialog](OpenTDDemos.UDFACreator.UDFACreatorDialog.md)
...
### <a id="OpenTDDemos_UDFACreator_UDFACreatorDialog__ctor"></a> UDFACreatorDialog\(\)
...
### <a id="OpenTDDemos_UDFACreator_UDFACreatorDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
