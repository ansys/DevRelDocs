# <a id="OpenTD_RadCAD_OffsetParaboloid"></a> Class OffsetParaboloid
...
```csharp
public class OffsetParaboloid : RcOffsetParaboloidData, IUpdatable
```
...
[RcConicData.LocalToWorldTransformation](OpenTD.RadCAD.RcConicData.md\#OpenTD\_RadCAD\_RcConicData\_LocalToWorldTransformation), 
[RcConicData.TransformBy\(Matrix3d\)](OpenTD.RadCAD.RcConicData.md\#OpenTD\_RadCAD\_RcConicData\_TransformBy\_OpenTD\_Matrix3d\_), 
[RcConicData.ToString\(\)](OpenTD.RadCAD.RcConicData.md\#OpenTD\_RadCAD\_RcConicData\_ToString), 
...
### <a id="OpenTD_RadCAD_OffsetParaboloid_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_RadCAD_OffsetParaboloid_Update"></a> Update\(\)
...
### <a id="OpenTD_RadCAD_OffsetParaboloid_UpdateFromTD"></a> UpdateFromTD\(\)
