# <a id="OpenTD_Dimension_Conductance"></a> Class Conductance

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class Conductance : IDimension
```
...
### <a id="OpenTD_Dimension_Conductance_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Conductance_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Conductance_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Conductance_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Conductance_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
