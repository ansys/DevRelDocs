# <a id="OpenTD_Dimension_Temp"></a> Class Temp

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class Temp : IDimension
```
...
### <a id="OpenTD_Dimension_Temp_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Temp_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Temp_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Temp_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Temp_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
