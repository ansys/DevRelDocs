# <a id="OpenTDDemos_TrussDialog"></a> Class TrussDialog

Namespace: [OpenTDDemos](OpenTDDemos.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class TrussDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[TrussDialog](OpenTDDemos.TrussDialog.md)
...
### <a id="OpenTDDemos_TrussDialog__ctor"></a> TrussDialog\(\)
...
### <a id="OpenTDDemos_TrussDialog_NumSections"></a> NumSections
...
### <a id="OpenTDDemos_TrussDialog_TrussLength"></a> TrussLength

```csharp
public double TrussLength { get; set; }
```
...
### <a id="OpenTDDemos_TrussDialog_TrussWidth"></a> TrussWidth

```csharp
public double TrussWidth { get; set; }
```
...
### <a id="OpenTDDemos_TrussDialog_td"></a> td
...
### <a id="OpenTDDemos_TrussDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
