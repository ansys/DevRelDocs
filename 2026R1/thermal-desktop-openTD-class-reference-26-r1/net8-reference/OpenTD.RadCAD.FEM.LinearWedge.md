# <a id="OpenTD_RadCAD_FEM_LinearWedge"></a> Class LinearWedge
...
### <a id="OpenTD_RadCAD_FEM_LinearWedge__ctor"></a> LinearWedge\(\)
...
### <a id="OpenTD_RadCAD_FEM_LinearWedge_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_RadCAD_FEM_LinearWedge_Update"></a> Update\(\)
...
### <a id="OpenTD_RadCAD_FEM_LinearWedge_UpdateFromTD"></a> UpdateFromTD\(\)
