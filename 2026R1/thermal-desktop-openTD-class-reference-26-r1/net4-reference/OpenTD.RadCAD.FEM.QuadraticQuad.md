# <a id="OpenTD_RadCAD_FEM_QuadraticQuad"></a> Class QuadraticQuad

Namespace: [OpenTD.RadCAD.FEM](OpenTD.RadCAD.FEM.md)  
Assembly: OpenTD.dll  

Client-side representation of a QuadraticQuad entity in a TD instance.

```csharp
[DataContract]
public class QuadraticQuad : RcSurfaceElement, IUpdatable
```
...
[RcSurfaceElement.BotThickness](OpenTD.RadCAD.FEM.RcSurfaceElement.md\#OpenTD\_RadCAD\_FEM\_RcSurfaceElement\_BotThickness), 
[RcSurfaceElement.BotMaterial](OpenTD.RadCAD.FEM.RcSurfaceElement.md\#OpenTD\_RadCAD\_FEM\_RcSurfaceElement\_BotMaterial), 
[RcSurfaceElement.BotOrientName](OpenTD.RadCAD.FEM.RcSurfaceElement.md\#OpenTD\_RadCAD\_FEM\_RcSurfaceElement\_BotOrientName), 
[RcSurfaceElement.ToString\(\)](OpenTD.RadCAD.FEM.RcSurfaceElement.md\#OpenTD\_RadCAD\_FEM\_RcSurfaceElement\_ToString), 
...
### <a id="OpenTD_RadCAD_FEM_QuadraticQuad__ctor"></a> QuadraticQuad\(\)

```csharp
public QuadraticQuad()
```

## Methods

### <a id="OpenTD_RadCAD_FEM_QuadraticQuad_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_RadCAD_FEM_QuadraticQuad_Update"></a> Update\(\)
...
### <a id="OpenTD_RadCAD_FEM_QuadraticQuad_UpdateFromTD"></a> UpdateFromTD\(\)
