# <a id="OpenTD_FloCAD_Tie"></a> Class Tie
...
```csharp
public class Tie : RcTieData, IUpdatable
```
...
### <a id="OpenTD_FloCAD_Tie_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_FloCAD_Tie_Update"></a> Update\(\)
