# <a id="OpenTD_Dimension_Resistivity"></a> Class Resistivity

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class Resistivity : IDimension
```
...
### <a id="OpenTD_Dimension_Resistivity_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Resistivity_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Resistivity_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Resistivity_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Resistivity_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
