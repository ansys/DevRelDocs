# <a id="OpenTD_RadCAD_Cone"></a> Class Cone
...
```csharp
[DataContract]
public class Cone : RcConeData, IUpdatable
```
...
### <a id="OpenTD_RadCAD_Cone_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_RadCAD_Cone_Update"></a> Update\(\)
...
### <a id="OpenTD_RadCAD_Cone_UpdateFromTD"></a> UpdateFromTD\(\)
