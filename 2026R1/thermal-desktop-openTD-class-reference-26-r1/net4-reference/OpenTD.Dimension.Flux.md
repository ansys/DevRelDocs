# <a id="OpenTD_Dimension_Flux"></a> Class Flux

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class Flux : IDimension
```
...
### <a id="OpenTD_Dimension_Flux_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Flux_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Flux_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Flux_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Flux_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
