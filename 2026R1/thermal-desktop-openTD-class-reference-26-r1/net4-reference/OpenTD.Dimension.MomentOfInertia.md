# <a id="OpenTD_Dimension_MomentOfInertia"></a> Class MomentOfInertia

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class MomentOfInertia : IDimension
```
...
### <a id="OpenTD_Dimension_MomentOfInertia_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_MomentOfInertia_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_MomentOfInertia_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_MomentOfInertia_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_MomentOfInertia_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
