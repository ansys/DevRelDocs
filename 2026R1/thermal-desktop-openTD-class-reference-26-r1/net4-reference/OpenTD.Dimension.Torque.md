# <a id="OpenTD_Dimension_Torque"></a> Class Torque

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class Torque : IDimension
```
...
### <a id="OpenTD_Dimension_Torque_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Torque_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Torque_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Torque_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Torque_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
