# <a id="OpenTD_Dimension_MassFlux"></a> Class MassFlux

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class MassFlux : IDimension
```
...
### <a id="OpenTD_Dimension_MassFlux_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_MassFlux_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_MassFlux_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_MassFlux_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_MassFlux_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
