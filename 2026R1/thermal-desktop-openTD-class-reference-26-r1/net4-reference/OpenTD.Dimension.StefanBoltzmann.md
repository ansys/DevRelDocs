# <a id="OpenTD_Dimension_StefanBoltzmann"></a> Class StefanBoltzmann

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class StefanBoltzmann : IDimension
```
...
### <a id="OpenTD_Dimension_StefanBoltzmann_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_StefanBoltzmann_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_StefanBoltzmann_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_StefanBoltzmann_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_StefanBoltzmann_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
