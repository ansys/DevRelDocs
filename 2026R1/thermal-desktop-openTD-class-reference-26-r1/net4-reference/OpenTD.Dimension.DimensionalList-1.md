...
```csharp
public class DimensionalList<T> : List<Dimensional<T>>, IList<Dimensional<T>>, ICollection<Dimensional<T>>, IList, ICollection, IReadOnlyList<Dimensional<T>>, IReadOnlyCollection<Dimensional<T>>, IEnumerable<Dimensional<T>>, IEnumerable where T : IDimension, new()
```
