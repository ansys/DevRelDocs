# <a id="OpenTD_Dimension_Gravity"></a> Class Gravity

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class Gravity : IDimension
```
...
### <a id="OpenTD_Dimension_Gravity_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Gravity_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Gravity_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Gravity_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Gravity_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
