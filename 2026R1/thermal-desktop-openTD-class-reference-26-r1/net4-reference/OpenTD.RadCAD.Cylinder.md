# <a id="OpenTD_RadCAD_Cylinder"></a> Class Cylinder
...
```csharp
[DataContract]
public class Cylinder : RcCylinderData, IUpdatable
```
...
### <a id="OpenTD_RadCAD_Cylinder_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_RadCAD_Cylinder_Update"></a> Update\(\)
...
### <a id="OpenTD_RadCAD_Cylinder_UpdateFromTD"></a> UpdateFromTD\(\)
