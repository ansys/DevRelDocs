# <a id="OpenTD_Dimension_TempAbs"></a> Class TempAbs

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class TempAbs : IDimension
```
...
### <a id="OpenTD_Dimension_TempAbs_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_TempAbs_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_TempAbs_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_TempAbs_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_TempAbs_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
