# <a id="OpenTD_RadCAD_FEM_LinearTri"></a> Class LinearTri

Namespace: [OpenTD.RadCAD.FEM](OpenTD.RadCAD.FEM.md)  
Assembly: OpenTD.dll  

Client-side representation of a LinearTri entity in a TD instance.

```csharp
[DataContract]
public class LinearTri : RcSurfaceElement, IUpdatable
```
...
### <a id="OpenTD_RadCAD_FEM_LinearTri__ctor"></a> LinearTri\(\)
...
### <a id="OpenTD_RadCAD_FEM_LinearTri_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_RadCAD_FEM_LinearTri_Update"></a> Update\(\)
...
### <a id="OpenTD_RadCAD_FEM_LinearTri_UpdateFromTD"></a> UpdateFromTD\(\)
