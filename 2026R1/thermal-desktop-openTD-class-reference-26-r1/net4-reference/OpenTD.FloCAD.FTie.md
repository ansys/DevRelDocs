# <a id="OpenTD_FloCAD_FTie"></a> Class FTie
...
```csharp
public class FTie : RcFTieData, IUpdatable
```
...
### <a id="OpenTD_FloCAD_FTie_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_FloCAD_FTie_Update"></a> Update\(\)
