# <a id="OpenTD_Dimension_Enthalpy"></a> Class Enthalpy

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class Enthalpy : IDimension
```
...
### <a id="OpenTD_Dimension_Enthalpy_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Enthalpy_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Enthalpy_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Enthalpy_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Enthalpy_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
