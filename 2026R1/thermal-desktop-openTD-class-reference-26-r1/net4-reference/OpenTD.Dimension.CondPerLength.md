# <a id="OpenTD_Dimension_CondPerLength"></a> Class CondPerLength

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class CondPerLength : IDimension
```
...
### <a id="OpenTD_Dimension_CondPerLength_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_CondPerLength_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_CondPerLength_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_CondPerLength_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_CondPerLength_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
