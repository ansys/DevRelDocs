# <a id="OpenTD_Dimension_Mass"></a> Class Mass
...
### <a id="OpenTD_Dimension_Mass_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Mass_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Mass_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Mass_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Mass_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
