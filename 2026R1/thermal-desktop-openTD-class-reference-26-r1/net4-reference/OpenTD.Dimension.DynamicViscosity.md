# <a id="OpenTD_Dimension_DynamicViscosity"></a> Class DynamicViscosity

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class DynamicViscosity : IDimension
```
...
### <a id="OpenTD_Dimension_DynamicViscosity_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_DynamicViscosity_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_DynamicViscosity_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_DynamicViscosity_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_DynamicViscosity_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
