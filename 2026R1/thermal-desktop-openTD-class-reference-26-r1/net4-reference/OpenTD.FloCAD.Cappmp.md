# <a id="OpenTD_FloCAD_Cappmp"></a> Class Cappmp
...
```csharp
public class Cappmp : RcCappmpData, IUpdatable
```
...
### <a id="OpenTD_FloCAD_Cappmp_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_FloCAD_Cappmp_Update"></a> Update\(\)
