# <a id="OpenTD_Dimension_Inertial"></a> Class Inertial

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class Inertial : IDimension
```
...
### <a id="OpenTD_Dimension_Inertial_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Inertial_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Inertial_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Inertial_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Inertial_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
