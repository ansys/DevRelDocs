# <a id="OpenTD_Dimension_VoltsPerTemp"></a> Class VoltsPerTemp

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class VoltsPerTemp : IDimension
```
...
### <a id="OpenTD_Dimension_VoltsPerTemp_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_VoltsPerTemp_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_VoltsPerTemp_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_VoltsPerTemp_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_VoltsPerTemp_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
