# <a id="OpenTD_Dimension_Time"></a> Class Time
...
### <a id="OpenTD_Dimension_Time_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Time_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Time_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Time_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Time_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
