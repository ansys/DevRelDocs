...
```csharp
public class Line : LineData, IUpdatable
```
...
### <a id="OpenTD_Line_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_Line_Update"></a> Update\(\)
