# <a id="OpenTD_Dimension_EnergyPerLength"></a> Class EnergyPerLength

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class EnergyPerLength : IDimension
```
...
### <a id="OpenTD_Dimension_EnergyPerLength_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_EnergyPerLength_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_EnergyPerLength_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_EnergyPerLength_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_EnergyPerLength_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
