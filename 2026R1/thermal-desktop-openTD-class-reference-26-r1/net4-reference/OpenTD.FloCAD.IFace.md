# <a id="OpenTD_FloCAD_IFace"></a> Class IFace
...
```csharp
public class IFace : RcIFaceData, IUpdatable
```
...
### <a id="OpenTD_FloCAD_IFace_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_FloCAD_IFace_Update"></a> Update\(\)
