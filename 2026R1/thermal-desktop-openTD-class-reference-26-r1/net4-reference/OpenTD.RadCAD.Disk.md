# <a id="OpenTD_RadCAD_Disk"></a> Class Disk
...
```csharp
[DataContract]
public class Disk : RcDiskData, IUpdatable
```
...
### <a id="OpenTD_RadCAD_Disk_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_RadCAD_Disk_Update"></a> Update\(\)
...
### <a id="OpenTD_RadCAD_Disk_UpdateFromTD"></a> UpdateFromTD\(\)
