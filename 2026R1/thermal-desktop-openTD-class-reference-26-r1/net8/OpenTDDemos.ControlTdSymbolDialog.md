# <a id="OpenTDDemos_ControlTdSymbolDialog"></a> Class ControlTdSymbolDialog

Namespace: [OpenTDDemos](OpenTDDemos.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class ControlTdSymbolDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[ControlTdSymbolDialog](OpenTDDemos.ControlTdSymbolDialog.md)
...
### <a id="OpenTDDemos_ControlTdSymbolDialog__ctor_OpenTD_ThermalDesktop_OpenTD_Symbol_"></a> ControlTdSymbolDialog\(ThermalDesktop, Symbol\)
...
### <a id="OpenTDDemos_ControlTdSymbolDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
