# <a id="OpenTD_Dimension_Pressure"></a> Class Pressure

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class Pressure : IDimension
```
...
### <a id="OpenTD_Dimension_Pressure_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Pressure_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Pressure_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Pressure_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Pressure_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
