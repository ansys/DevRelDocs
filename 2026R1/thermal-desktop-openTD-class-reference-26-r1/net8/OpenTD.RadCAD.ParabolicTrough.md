# <a id="OpenTD_RadCAD_ParabolicTrough"></a> Class ParabolicTrough
...
```csharp
public class ParabolicTrough : RcParabolicTroughData, IUpdatable
```
...
### <a id="OpenTD_RadCAD_ParabolicTrough_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_RadCAD_ParabolicTrough_Update"></a> Update\(\)
...
### <a id="OpenTD_RadCAD_ParabolicTrough_UpdateFromTD"></a> UpdateFromTD\(\)
