# <a id="OpenTDDemos_ContourFinder_ContourFinderDialog"></a> Class ContourFinderDialog

Namespace: [OpenTDDemos.ContourFinder](OpenTDDemos.ContourFinder.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class ContourFinderDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
### <a id="OpenTDDemos_ContourFinder_ContourFinderDialog__ctor"></a> ContourFinderDialog\(\)
...
### <a id="OpenTDDemos_ContourFinder_ContourFinderDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
