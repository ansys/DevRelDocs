# <a id="OpenTDDemos_Robot_RobotDialog"></a> Class RobotDialog

Namespace: [OpenTDDemos.Robot](OpenTDDemos.Robot.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class RobotDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[RobotDialog](OpenTDDemos.Robot.RobotDialog.md)
...
### <a id="OpenTDDemos_Robot_RobotDialog__ctor"></a> RobotDialog\(\)
...
### <a id="OpenTDDemos_Robot_RobotDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
