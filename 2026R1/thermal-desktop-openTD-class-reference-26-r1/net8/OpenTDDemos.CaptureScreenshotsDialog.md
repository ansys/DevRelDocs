# <a id="OpenTDDemos_CaptureScreenshotsDialog"></a> Class CaptureScreenshotsDialog

Namespace: [OpenTDDemos](OpenTDDemos.md)  
Assembly: OpenTDDemos.dll  

```csharp
public class CaptureScreenshotsDialog : Form, IDropTarget, ISynchronizeInvoke, IWin32Window, IBindableComponent, IComponent, IDisposable, IContainerControl
```
...
[CaptureScreenshotsDialog](OpenTDDemos.CaptureScreenshotsDialog.md)
...
### <a id="OpenTDDemos_CaptureScreenshotsDialog__ctor"></a> CaptureScreenshotsDialog\(\)
...
### <a id="OpenTDDemos_CaptureScreenshotsDialog_Dispose_System_Boolean_"></a> Dispose\(bool\)
