# <a id="OpenTD_RadCAD_Rectangle"></a> Class Rectangle
...
```csharp
public class Rectangle : RcRectangleData, IUpdatable
```
...
### <a id="OpenTD_RadCAD_Rectangle_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_RadCAD_Rectangle_Update"></a> Update\(\)
...
### <a id="OpenTD_RadCAD_Rectangle_UpdateFromTD"></a> UpdateFromTD\(\)
