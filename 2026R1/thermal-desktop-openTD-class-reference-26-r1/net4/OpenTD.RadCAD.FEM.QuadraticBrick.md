# <a id="OpenTD_RadCAD_FEM_QuadraticBrick"></a> Class QuadraticBrick

Namespace: [OpenTD.RadCAD.FEM](OpenTD.RadCAD.FEM.md)  
Assembly: OpenTD.dll  

Client-side representation of a QuadraticBrick entity in a TD instance.

```csharp
[DataContract]
public class QuadraticBrick : RcSolidElement, IUpdatable
```
...
### <a id="OpenTD_RadCAD_FEM_QuadraticBrick__ctor"></a> QuadraticBrick\(\)

```csharp
public QuadraticBrick()
```

## Methods

### <a id="OpenTD_RadCAD_FEM_QuadraticBrick_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_RadCAD_FEM_QuadraticBrick_Update"></a> Update\(\)
...
### <a id="OpenTD_RadCAD_FEM_QuadraticBrick_UpdateFromTD"></a> UpdateFromTD\(\)
