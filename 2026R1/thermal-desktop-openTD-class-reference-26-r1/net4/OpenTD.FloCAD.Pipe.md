# <a id="OpenTD_FloCAD_Pipe"></a> Class Pipe
...
```csharp
public class Pipe : RcPipeData, IUpdatable
```
...
### <a id="OpenTD_FloCAD_Pipe_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_FloCAD_Pipe_Update"></a> Update\(\)
