# <a id="OpenTD_OpticalPropAliasManager"></a> Class OpticalPropAliasManager
...
```csharp
public class OpticalPropAliasManager
```
...
### <a id="OpenTD_OpticalPropAliasManager_CreateOrUpdateAlias_System_String_System_String_"></a> CreateOrUpdateAlias\(string, string\)
...
### <a id="OpenTD_OpticalPropAliasManager_DeleteAlias_System_String_"></a> DeleteAlias\(string\)
...
### <a id="OpenTD_OpticalPropAliasManager_GetAlias_System_String_"></a> GetAlias\(string\)
...
### <a id="OpenTD_OpticalPropAliasManager_GetAliases"></a> GetAliases\(\)
...
### <a id="OpenTD_OpticalPropAliasManager_RenameAlias_System_String_System_String_"></a> RenameAlias\(string, string\)
