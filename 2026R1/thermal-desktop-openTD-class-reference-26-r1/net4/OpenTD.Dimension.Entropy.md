# <a id="OpenTD_Dimension_Entropy"></a> Class Entropy

Namespace: [OpenTD.Dimension](OpenTD.Dimension.md)  
Assembly: OpenTD.dll  

```csharp
public class Entropy : IDimension
```
...
### <a id="OpenTD_Dimension_Entropy_ConvertFromSI_System_Double_OpenTD_UnitsData_"></a> ConvertFromSI\(double, UnitsData\)
...
### <a id="OpenTD_Dimension_Entropy_ConvertToSI_OpenTD_UnitsData_System_Double_"></a> ConvertToSI\(UnitsData, double\)
...
### <a id="OpenTD_Dimension_Entropy_GetName"></a> GetName\(\)
...
### <a id="OpenTD_Dimension_Entropy_GetTitle_OpenTD_UnitsData_"></a> GetTitle\(UnitsData\)
...
### <a id="OpenTD_Dimension_Entropy_GetUnitsName_OpenTD_UnitsData_"></a> GetUnitsName\(UnitsData\)
