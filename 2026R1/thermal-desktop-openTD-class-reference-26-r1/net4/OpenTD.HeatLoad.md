# <a id="OpenTD_HeatLoad"></a> Class HeatLoad
...
```csharp
public class HeatLoad : RcHeatLoadData, IUpdatable
```
...
### <a id="OpenTD_HeatLoad_CreateIn_OpenTD_ThermalDesktop_"></a> CreateIn\(ThermalDesktop\)
...
### <a id="OpenTD_HeatLoad_Update"></a> Update\(\)
