...
These example scripts show you how to use the foundation API to search for records, export data, and import data. All
examples use the MI Training database, available from the Ansys Download Center.
