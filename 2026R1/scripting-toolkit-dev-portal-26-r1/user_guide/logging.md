...
log level of [`WARNING`](https://docs.python.org/3/library/logging.html#logging.WARNING), so they ignore messages of [`INFO`](https://docs.python.org/3/library/logging.html#logging.INFO) or lower. To change a logger’s log level, use
