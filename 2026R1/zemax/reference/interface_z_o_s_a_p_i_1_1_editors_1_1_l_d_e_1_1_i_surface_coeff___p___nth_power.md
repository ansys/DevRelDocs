...
<a id="interface_z_o_s_a_p_i_1_1_editors_1_1_l_d_e_1_1_i_surface_coeff___p___nth_power_1a27edc07fa96a6cc1af8e66141d292ef1"></a>
...
```csharp
IEditorCell ZOSAPI.Editors.LDE.ISurfaceCoeff_P_NthPower.NumberOfTermsCell
```
...
* `qualifiedname {"type":"element","name":"qualifiedname","attributes":{},"children":[{"type":"text","text":"ZOSAPI.Editors.LDE.ISurfaceCoeff_P_NthPower.NumberOfTermsCell"}]}`
-->

### Property NumberOfTerms

<a id="interface_z_o_s_a_p_i_1_1_editors_1_1_l_d_e_1_1_i_surface_coeff___p___nth_power_1a8bfe6a98904feb5f6015cf380f525064"></a>
...
```csharp
int ZOSAPI.Editors.LDE.ISurfaceCoeff_P_NthPower.NumberOfTerms
```
...
* `qualifiedname {"type":"element","name":"qualifiedname","attributes":{},"children":[{"type":"text","text":"ZOSAPI.Editors.LDE.ISurfaceCoeff_P_NthPower.NumberOfTerms"}]}`
-->
...
```csharp
IEditorCell ZOSAPI.Editors.LDE.ISurfaceCoeff_P_NthPower.Coeff_P_NthPowerCell(int n)
```
...
```csharp
double ZOSAPI.Editors.LDE.ISurfaceCoeff_P_NthPower.GetCoeff_P_NthPower(int n)
```
...
```csharp
void ZOSAPI.Editors.LDE.ISurfaceCoeff_P_NthPower.SetCoeff_P_NthPower(int n, double Value)
```
