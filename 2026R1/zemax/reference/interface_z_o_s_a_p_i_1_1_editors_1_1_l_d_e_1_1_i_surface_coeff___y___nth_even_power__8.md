# Interface ZOSAPI::Editors::LDE::ISurfaceCoeff\_Y\_NthEvenPower\_8

<a id="interface_z_o_s_a_p_i_1_1_editors_1_1_l_d_e_1_1_i_surface_coeff___y___nth_even_power__8"></a>
...
```csharp
IEditorCell ZOSAPI.Editors.LDE.ISurfaceCoeff_Y_NthEvenPower_8.Coeff_Y_NthEvenPowerCell(int n)
```
...
```csharp
double ZOSAPI.Editors.LDE.ISurfaceCoeff_Y_NthEvenPower_8.GetCoeff_Y_NthEvenPower(int n)
```
...
```csharp
void ZOSAPI.Editors.LDE.ISurfaceCoeff_Y_NthEvenPower_8.SetCoeff_Y_NthEvenPower(int n, double Value)
```
