...
{
    [ComVisible(true)]
    [Guid("59ED7B0C-64FE-4ADE-B7B8-08F747466CDD")]
    public enum SurfaceMtfTypes
    {
        MTF_Incoherent, Real_Incoherent, Imaginary_Incoherent,
        MTF_Coherent, Real_Coherent, Imaginary_Coherent,
    }

    [ComVisible(true)]
    [Guid("07CA848E-F712-4E17-8A3C-512C3C5C99CA")]
    [InterfaceType(ComInterfaceType.InterfaceIsDual)]
    public interface IAS_FftSurfaceMtf : IAS_
    {
        IAS_Field Field { get; }
