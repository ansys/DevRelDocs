...
<a id="group__group__dvs__features"></a>
...
Sometimes solvers need to rewind to a previous timestep and begin writing new data for various reasons. The delete api facilitates this allowing users to make a call to delete specific timesteps or a collection of timesteps. This call is similar to the [dvs\_begin\_update()](dynamic__visualization__store__api_8h.md#dynamic__visualization__store__api_8h_1aaac598618be531e8aa2b72ad41e18537) and [dvs\_end\_update()](dynamic__visualization__store__api_8h.md#dynamic__visualization__store__api_8h_1ae75177bf47fcb28313e79840bf778c75) calls where all ranks must make the same call for each rank in parallel. The API calls for this are [dvs\_delete\_item()](dynamic__visualization__store__api_8h.md#dynamic__visualization__store__api_8h_1a5237ada583b0cb7817d12d1135f9349e) (C API), [DVS::IClient::delete\_item()](class_d_v_s_1_1_i_client.md#class_d_v_s_1_1_i_client_1a5e8f192f5c683a8265dd94020506a0aa) (C API), and delete_item() (Python API).
