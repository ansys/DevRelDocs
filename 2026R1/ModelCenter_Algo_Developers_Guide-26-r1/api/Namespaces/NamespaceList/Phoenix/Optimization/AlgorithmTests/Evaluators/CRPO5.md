...
![CRPO5](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o5.png)
...
```
Number of variables: 4 variables. Definition: f(x) = 3*x1 + 0.000001*x1^3 + 2*x2 + (0.000002/3)*x2^3 Search domain: 0<= xi <=1200, i=1 to 2; -0.55<= xi <=0.55, i= 3 to 4; Subject to: gi <= 0, i= 1 to 5 ; g3,g4,g5 are equality constraints. Number of local minima: no local minima except the global one. The global minima: x* = (679.945148297028709, 1026.06697600004691, 0.118876369094410433, -0.39623348521517826), f(x*) = 5126.4967140071 
```
...
| |`CRPO5 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`CRPO5 (Goal goal)`<br>Constructor to use custom goal |
