...
![CRPO21](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o21.png)
...
```
Number of variables: 7 variables. Definition: f(x) = x1 Search domain: 0<= x1 <=1000; 0<= xi <= 40, i=2,3; 100<= x4 <= 300; 6.3<= x5 <=6.7; 5.9<= x6 <=6.4; 4.5<= x7 <=6.25 Subject to: gi <= 0, i= 1 to 6 ; 2 to 6 equality constraints. Number of local minima: no local minima except the global one. The global minima: x* = (193.724510070034967, 5.56944131553368433e-27, 17.3191887294084914, 100.047897801386839, 6.68445185362377892, 5.99168428444264833, 6.21451648886070451) f(x*) = 193.724510070035 
```
...
| |`CRPO21 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`CRPO21 (Goal goal)`<br>Constructor to use custom goal |
