...
![CRPO18](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o18.png)
...
```
Number of variables: 9 variables. Definition: f(x) = −0.5(x1 x4 − x2 x3 + x3 x9 − x5 x9 + x5 x8 − x6 x7 ) Search domain: -10<= xi <= 10, i=1 to 8; 0<= x9 <= 20; Subject to: gi <= 0, i= 1 to 13 ; Number of local minima: no local minima except the global one. The global minima: x* = (−0.657776192427943163, −0.153418773482438542, 0.323413871675240938, −0.946257611651304398,− 0.657776194376798906, −0.753213434632691414, 0.323413874123576972, −0.346462947962331735, 0.59979466285217542) f(x*) = −0.866025403784439 
```
...
| |`CRPO18 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`CRPO18 (Goal goal)`<br>Constructor to use custom goal |
