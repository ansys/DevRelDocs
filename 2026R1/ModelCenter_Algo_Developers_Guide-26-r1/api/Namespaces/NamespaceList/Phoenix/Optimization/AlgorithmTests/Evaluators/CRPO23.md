...
![CRPO23](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o23.png)
...
```
Number of variables: 9 variables. Definition: f(x) = −9x5 − 15x8 + 6x1 + 16x2 + 10(x6 + x7 ) Search domain: 0<= xi <= 300, i=1,2,6; 0<= xi <= 100,i=3,5,7; 0<= xi <=200, i=4,8; 0.01<= x9 <=0.03; Subject to: gi <= 0, i= 1 to 6 ; 3 to 6 equality constraints. Number of local minima: no local minima except the global one. The global minima: x* = is at x∗ = (0.00510000000000259465, 99.9947000000000514, 9.01920162996045897e-18, 99.9999000000000535, 0.000100000000027086086, 2.75700683389584542e-14, 99.9999999999999574, 200.00, 0.0100000100000100008 ) f(x*) = -400.055099999999584 
```
...
| |`CRPO23 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`CRPO23 (Goal goal)`<br>Constructor to use custom goal |
