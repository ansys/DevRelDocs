...
Implementation of Constrained Multi-objective Optimization problem 10 from CEC'09.  
 

## Inheritance

![MOC4](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_m_o_c4.png)
...
```
Number of variables: 10 variables. Definition: f(x) = f1,f2,f3 Search domain: 0<= x1,x2 <=1; -2<= xi <=2, i=3 to 10;
```
...
| |`MOC4 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`MOC4 (Goal goal)`<br>Constructor to use custom goal |
