...
Implementation of Constrained Real-Parameter Optimization Fucntion - 04  
 

## Inheritance

![CRPO4](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o4.png)
...
```
Number of variables: 5 variables. Definition: f(x) = 5.3578547*(Math.Pow(x[3],2)) + (0.8356891*x[1]*x[5]) + (37.293239*x[1]) - 40792.141 Search domain: 0<= xi <=1, i=1 to 9; 0<= xi <=100, i= 10 to 12; 0<= x13 <=1 Subject to: gi <= 0, i= 1 to 6 Number of local minima: no local minima except the global one. The global minima: x* = (78, 33, 29.9952560256815985, 45, 36.7758129057882073), f(x*) = -3.066553867178332e + 004. 
```
...
| |`CRPO4 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`CRPO4 (Goal goal)`<br>Constructor to use custom goal |
