...
![CRPO22](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o22.png)
...
```
Number of variables: 22 variables. Definition: f(x) = x1 Search domain: 0<= x1 <=20000; 0<= xi <= 10^6, i=2,3,4; 0<= xi <= 4*(10^7),i=5,6,7; 100<= x8 <=299.99; 100<= x9 <=399.99; 100.01<= x10 <=300 100<= x11 <=400; 100<= x12 <= 600; 0<= xi <= 500,i=13,14,15; 0.01<= x16 <=300; 0.01<= x17 <= 400; -4.7<= xi <=6.25, i=18 to 22; Subject to: gi <= 0, i= 1 to 20 ; 2 to 20 equality constraints. Number of local minima: no local minima except the global one. The global minima: x* = is at x∗ = (236.430975504001054, 135.82847151732463, 204.818152544824585, 6446.54654059436416, 3007540.83940215595, 4074188.65771341929, 32918270.5028952882, 130.075408394314167, 170.817294970528621, 299.924591605478554, 399.258113423595205, 330.817294971142758, 184.51831230897065, 248.64670239647424, 127.658546694545862, 269.182627528746707, 160.000016724090955, 5.29788288102680571, 5.13529735903945728, 5.59531526444068827, 5.43444479314453499, 5.07517453535834395 ) f(x*) = 236.430975504001 
```
...
| |`CRPO22 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`CRPO22 (Goal goal)`<br>Constructor to use custom goal |
