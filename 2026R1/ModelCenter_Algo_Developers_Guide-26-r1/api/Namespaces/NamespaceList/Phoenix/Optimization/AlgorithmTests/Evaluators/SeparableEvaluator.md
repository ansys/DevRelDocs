# SeparableEvaluator Class

**Namespace:** `Phoenix.Optimization.AlgorithmTests.Evaluators`

## Overview

Implementation for the Separable Function problem Source: NonLinear Programming Theory and Algorithms, Second Edition Wiley Student edition ISBN 9812-53-068-1 by Mokhtar S Bazaraa, Hanif D.  
 

## Inheritance

![SeparableEvaluator](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_separable_evaluator.png)

## Declaration

```csharp
class SeparableEvaluator
```
...
Sherali and C.M. Shetty Page No. 514, Example 11.3.2 
```
Minimize x1^2 - 6*x1 + x2^2 - 8*x2 - 1/2*x3 subject to x1 + x2+ x3 <= 5 x1^2 - x2 <= 3 Number of variables: 3 variables Search domain: 0 <= xi , i = 1, 2, 3 The global minima: x* = {2, 3, 0}, f(x*) = -23 
```
...
|Name|Description|
|-----|-----|
|override object[,] | `GlobalBestDesigns [get]`<br>The expected result is (2, 3, 0) for the minima |
...
The expected result is (2, 3, 0) for the minima
