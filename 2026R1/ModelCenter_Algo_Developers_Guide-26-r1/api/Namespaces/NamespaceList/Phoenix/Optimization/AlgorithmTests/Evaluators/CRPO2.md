...
Implementation of Constrained Real-Parameter Optimization Fucntion - 02  
 

## Inheritance

![CRPO2](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o2.png)
...
```
Number of variables: 20 variables. Definition: f(x) = Search domain: 0<= xi <=10, i=1 to n; n = 20 Subject to: gi <= 0, i= 1,2 Number of local minima: no local minima except the global one. The global minima: x* = (3.16246061572185, 3.12833142812967, 3.09479212988791, 3.06145059523469, 3.02792915885555, 2.99382606701730, 2.95866871765285, 2.92184227312450, 0.49482511456933, 0.48835711005490, 0.48231642711865, 0.47664475092742, 0.47129550835493, 0.46623099264167, 0.46142004984199, 0.45683664767217, 0.45245876903267, 0.44826762241853, 0.44424700958760, 0.44038285956317), f(x*) = -0.80361910412559 
```
...
| |`CRPO2 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`CRPO2 (Goal goal)`<br>Constructor to use custom goal |
