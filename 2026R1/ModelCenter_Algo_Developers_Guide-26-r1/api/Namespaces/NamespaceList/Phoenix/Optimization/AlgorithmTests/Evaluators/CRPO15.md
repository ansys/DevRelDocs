...
Implementation of Constrained Real-Parameter Optimization Fucntion - 15  
 

## Inheritance

![CRPO15](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o15.png)
...
```
Number of variables: 3 variables. Definition: f(x) = 1000 − x1^2 * x2^2 − x3^2 − x1 * x2 − x1 * x3 Search domain: 0<= xi <=10, i=1 to 3; Subject to: hi <= 0, i= 1 to 2 ;equality constraints. Number of local minima: no local minima except the global one. The global minima: x* = ( 3.51212812611795133, 0.216987510429556135, 3.55217854929179921) f(x*) = 961.715022289961 
```
...
| |`CRPO15 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`CRPO15 (Goal goal)`<br>Constructor to use custom goal |
