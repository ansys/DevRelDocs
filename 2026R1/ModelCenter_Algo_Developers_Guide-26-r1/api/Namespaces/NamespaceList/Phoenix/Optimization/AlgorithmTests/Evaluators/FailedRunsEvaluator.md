...
|override bool |`HasFailedRuns [get]` |Does the evalutor have failed runs? |
|override bool |`HasNonSmoothResponses [get]` |Does the evaluator have non-smooth responses. |
|override string |`Name [get]` |Name of the evaluator. |
|override bool |`UsesConstraints [get]` |Does the evaluator use constraints? |
|override bool |`UsesDiscreteVariables [get]` |Does the evaluator use discrete variables? |
|override bool |`UsesMinMax [get]` |Does the evaluator use a `Minimize/Maximize` objective? |
|override bool |`UsesMultipleObjectives [get]` |Does the evaluator specify multiple objectives? |
|override bool |`UsesSolveFor [get]` |Does the evaluator use the `solve for` objective? |
