...
Generic system evaluator used for testing algorithms that support solve for objectives but not minimize/maximize objectives.  
 

## Inheritance

![SystemEvaluator](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_system_evaluator.png)
...
|override bool | `UsesMinMax [get]`<br>Evaluator does not use minimize/maximize objectives. |
|override bool | `UsesMultipleObjectives [get]`<br>Evaluator uses multiple Objectives |
|override bool | `UsesSolveFor [get]`<br>Evaluator uses the `solve for` objective. |
...
Evaluator does not use minimize/maximize objectives.
...
Evaluator uses multiple Objectives
...
Evaluator uses the `solve for` objective.
