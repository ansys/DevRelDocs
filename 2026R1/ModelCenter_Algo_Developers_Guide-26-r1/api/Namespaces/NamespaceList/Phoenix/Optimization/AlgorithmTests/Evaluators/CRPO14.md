...
Implementation of Constrained Real-Parameter Optimization Fucntion - 14  
 

## Inheritance

![CRPO14](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o14.png)
...
```
Number of variables: 10 variables. Definition: f(x) = [sum i= 1 to 10]{x[i]*(c[i] + Ln(x[i]/([sum j=1 to 10]{x[j]})))} Search domain: 0<= xi <=10, i=1 to 10; c[i] = { -6.089, -17.164, -34.054, -5.914, -24.721, -14.986, -24.100, -10.708, -26.662, -22.179}; Subject to: hi <= 0, i= 1 to 3 ;equality constraints. Number of local minima: no local minima except the global one. The global minima: x* = (0.0406684113216282, 0.147721240492452, 0.783205732104114, 0.00141433931889084, 0.485293636780388, 0.000693183051556082, 0.0274052040687766, 0.0179509660214818, 0.0373268186859717, 0.0968844604336845) f(x*) = -47.7648884594915 
```
...
| |`CRPO14 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`CRPO14 (Goal goal)`<br>Constructor to use custom goal |
