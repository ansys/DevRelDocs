# RosenSuzukiDiscreteEvaluator Class

**Namespace:** `Phoenix.Optimization.AlgorithmTests.Evaluators`

## Overview

Implementation of `T:Phoenix.Optimization.AlgorithmTests.Evaluators.RosenSuzukiEvaluator` using discrete variables.  
 

## Inheritance

![RosenSuzukiDiscreteEvaluator](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_rosen_suzuki_discrete_evaluator.png)

## Declaration

```csharp
class RosenSuzukiDiscreteEvaluator
```
