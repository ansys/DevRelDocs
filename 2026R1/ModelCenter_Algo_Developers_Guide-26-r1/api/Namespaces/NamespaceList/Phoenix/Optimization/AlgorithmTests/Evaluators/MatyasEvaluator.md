# MatyasEvaluator Class

**Namespace:** `Phoenix.Optimization.AlgorithmTests.Evaluators`

## Overview

Implementation of Matyas Fucntion  
 

## Inheritance

![MatyasEvaluator](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_matyas_evaluator.png)

## Declaration

```csharp
class MatyasEvaluator
```
...
Source: http://www-optima.amp.i.kyoto-u.ac.jp/member/student/hedar/Hedar_files/TestGO_files/Page2213.htm
```
Number of variables: 2 variables. Definition: f(x) = 0.20 * ( x1^2 + x2^2 ) - 0.48 * x1 * x2 Search domain: ?10 <= xi <= 10, i = 1, 2. Number of local minima: no local minima except the global one. The global minima: x* = (0, 0), f(x*) = 0. 
```
...
| |`MatyasEvaluator ()`<br>Default constructor, uses the default goal of `minimize` |
| |`MatyasEvaluator (Goal goal)`<br>Constructor to use custom goal |
