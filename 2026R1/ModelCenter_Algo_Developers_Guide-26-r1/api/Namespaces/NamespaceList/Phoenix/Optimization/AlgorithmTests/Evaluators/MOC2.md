...
Implementation of Constrained Multi-objective Optimization problem 4 from CEC'09.  
 

## Inheritance

![MOC2](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_m_o_c2.png)
...
```
Number of variables: 10 variables. Definition: f(x) = f1,f2 Search domain: 0<= x1 <=1; -2<= xi <=2, i=2 to 10;
```
...
| |`MOC2 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`MOC2 (Goal goal)`<br>Constructor to use custom goal |
