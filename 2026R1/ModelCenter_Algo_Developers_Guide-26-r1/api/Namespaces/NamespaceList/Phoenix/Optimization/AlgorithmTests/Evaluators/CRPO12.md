...
![CRPO12](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o12.png)
...
```
Number of variables: 3 variables. Definition: f(x) = −(100 − (x1 − 5)^2 − (x2 − 5)^2 − (x3 − 5)^2 )/100 Search domain: 100<= x1 <=10000; 1000<= xi <= 10000, i=2,3; 10<= xi <= 1000, i=4 to 8; Subject to: g1 <= 0 Number of local minima: no local minima except the global one. The global minima: x* = (5, 5, 5) f(x*) = -1 
```
...
| |`CRPO12 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`CRPO12 (Goal goal)`<br>Constructor to use custom goal |
