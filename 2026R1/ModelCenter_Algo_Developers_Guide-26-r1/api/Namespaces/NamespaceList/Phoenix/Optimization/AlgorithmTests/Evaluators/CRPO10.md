...
![CRPO10](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o10.png)
...
```
Number of variables: 8 variables. Definition: f(x) = x1 + x2 + x3 Search domain: 100<= x1 <=10000; 1000<= xi <= 10000, i=2,3; 10<= xi <= 1000, i=4 to 8; Subject to: gi <= 0, i= 1 to 6 ; Number of local minima: no local minima except the global one. The global minima: x* = (579.306685017979589, 1359.97067807935605, 5109.97065743133317, 182.01769963061534, 295.601173702746792, 217.982300369384632, 286.41652592786852, 395.601173702746735) f(x*) = 7049.24802052867 
```
...
| |`CRPO10 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`CRPO10 (Goal goal)`<br>Constructor to use custom goal |
