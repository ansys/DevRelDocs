...
![CRPO9](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o9.png)
...
```
Number of variables: 7 variables. Definition: f(x) = (x1 − 10)^2 + 5(x2 − 12)^2 + x3^4 + 3*(x4 − 11)^2 +10*x5^6 + 7*x6^2 + x7^4 − 4*x6*x7 − 10*x6 − 8*x7 Search domain: -10<= xi <=10, i=1 to 7; Subject to: gi <= 0, i= 1 to 4 ; Number of local minima: no local minima except the global one. The global minima: x* = (2.33049935147405174, 1.95137236847114592, -0.477541399510615805, 4.36572624923625874, -0.624486959100388983, 1.03813099410962173, 1.5942266780671519) f(x*) = 680.630057374402 
```
