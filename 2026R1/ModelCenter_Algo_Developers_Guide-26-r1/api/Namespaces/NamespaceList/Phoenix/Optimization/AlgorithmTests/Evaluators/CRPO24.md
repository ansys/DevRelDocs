...
![CRPO24](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o24.png)
...
```
Number of variables: 2 variables. Definition: f(x) = −x1 - x2 Search domain: 0<= x1 <= 3; 0<= x2 <=4; Subject to: gi <= 0, i= 1 to 2 ; Number of local minima: no local minima except the global one. The global minima: x* = is at x∗ = (2.32952019747762, 3.17849307411774 ) f(x*) = −5.50801327159536 
```
...
| |`CRPO24 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`CRPO24 (Goal goal)`<br>Constructor to use custom goal |
