# Stelmack98FailEvaluator Class

**Namespace:** `Phoenix.Optimization.AlgorithmTests.Evaluators`

## Overview

Implementation of the Stelmack 98 function with failed runs.  
 

## Inheritance

![Stelmack98FailEvaluator](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_stelmack98_fail_evaluator.png)

## Declaration

```csharp
class Stelmack98FailEvaluator
```
