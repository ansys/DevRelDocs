...
![CRPO6](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o6.png)
...
```
Number of variables: 2 variables. Definition: f(x) = (x1 − 10)^3 + (x2 − 20)^3 Search domain: 13<= x1 <=100, 0<= x2 <=100 Subject to: gi <= 0, i= 1 to 2 ; Number of local minima: no local minima except the global one. The global minima: x* = (14.09500000000000064, 0.8429607892154795668), f(x*) = -6961.81387558 
```
...
| |`CRPO6 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`CRPO6 (Goal goal)`<br>Constructor to use custom goal |
