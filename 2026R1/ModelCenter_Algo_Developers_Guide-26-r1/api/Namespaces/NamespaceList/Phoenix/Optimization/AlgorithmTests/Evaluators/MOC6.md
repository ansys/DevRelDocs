...
Implementation of Constrained Multi-objective Optimization problem 1 from CEC'09.  
 

## Inheritance

![MOC6](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_m_o_c6.png)
...
```
Number of variables: 10 variables. Definition: f(x) = f1,f2 Search domain: 0<= xi <=1, i=1 to 10;
```
...
| |`MOC6 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`MOC6 (Goal goal)`<br>Constructor to use custom goal |
