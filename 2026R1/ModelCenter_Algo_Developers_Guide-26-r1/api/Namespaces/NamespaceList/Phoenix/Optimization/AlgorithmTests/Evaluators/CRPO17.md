...
![CRPO17](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o17.png)
...
```
Number of variables: 6 variables. Definition: f(x) = f1(x1) + f2(x2) Where: f1(x1) = 30*x1, 0<=x1<300 f2(x2) = 28*x2, 0<=x2<100 31*x1, 300<=x1<400 29*x2, 100<=x2<200 30*x2, 200<=x2<1000

Search domain: 0<= x1 <=400; 0<= x2 <= 1000; 340<= xi <= 420, i=3,4; -1000<= x5 <=1000; 0<= x6 <=0.5236; Subject to: hi <= 0, i= 1 to 4 ; equality constraints Number of local minima: no local minima except the global one. The global minima: x* = (201.784467214523659, 99.9999999999999005, 383.071034852773266, 420, −10.9076584514292652, 0.0731482312084287128) f(x*) = 8853.53967480648 
```
