# AckleyEvaluator Class

**Namespace:** `Phoenix.Optimization.AlgorithmTests.Evaluators`

## Overview

Implementation fo the Ackley Function Source: http://www-optima.amp.i.kyoto-u.ac.jp/member/student/hedar/Hedar_files/TestGO_files/Page295.htm


## Inheritance

![AckleyEvaluator](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_ackley_evaluator.png)
...
Implementation of the Ackley Function Source: http://www-optima.amp.i.kyoto-u.ac.jp/member/student/hedar/Hedar_files/TestGO_files/Page295.htm
...
|Name|Description|
|-----|-----|
|override object[,] | `GlobalBestDesigns [get]`<br>The expected result is 0 for the minima to be at 0 for all design variables |
...
### AckleyEvaluator()
```csharp
AckleyEvaluator ( int numDesignVariables)
```

Specifies a number of design variables to use

**Parameters:**

- `numDesignVariables` - Number of design variables
...
The expected result is 0 for the minima to be at 0 for all design variables
