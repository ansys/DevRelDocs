...
![CRPO13](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o13.png)
...
```
Number of variables: 4 variables. Definition: f(x) = e^(x1*x2*x3*x4*x5) Search domain: -2.3<= xi <=2.3, i=1 to 2; -3.2<= xi <=3.2, i= 3 to 5; Subject to: hi <= 0, i= 1 to 3 ;equality constraints. Number of local minima: no local minima except the global one. The global minima: x* = (-1.71714224003, 1.59572124049468, 1.8272502406271, -0.763659881912867, -0.76365986736498), f(x*) = 0.053941514041898 
```
...
| |`CRPO13 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`CRPO13 (Goal goal)`<br>Constructor to use custom goal |
