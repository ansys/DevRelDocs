...
![MOUC1](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_m_o_u_c1.png)
...
```
Number of variables: 30 variables. Definition: f(x) = Search domain: 0<= x1 <=1; -1<= xi <=1, i=2 to 30;
```
...
| |`MOUC1 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`MOUC1 (Goal goal)`<br>Constructor to use custom goal |
