...
![CRPO11](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o11.png)
...
```
Number of variables: 2 variables. Definition: f(x) = x1^2 + (x2 − 1)^2 Search domain: -1<= xi <= 1, i=1,2; Subject to: g1 = 0 Number of local minima: no local minima except the global one. The global minima: x* = ( -0.707036070037170616, 0.500000004333606807 ) f(x*) = 0.7499 
```
...
| |`CRPO11 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`CRPO11 (Goal goal)`<br>Constructor to use custom goal |
