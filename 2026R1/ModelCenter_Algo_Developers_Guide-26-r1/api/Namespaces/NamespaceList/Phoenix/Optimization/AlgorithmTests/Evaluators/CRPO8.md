...
![CRPO8](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o8.png)
...
```
Number of variables: 2 variables. Definition: f(x) = -(sin3 (2πx1) * sin(2πx2))/(x1^3*(x1+x2)) Search domain: 0<= xi <=10, i=1 to 2; Subject to: gi <= 0, i= 1 to 2 ; Number of local minima: no local minima except the global one. The global minima: x* = (1.22797135260752599, 4.24537336612274885) f(x*) = -0.0958250414180359 
```
...
| |`CRPO8 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`CRPO8 (Goal goal)`<br>Constructor to use custom goal |
