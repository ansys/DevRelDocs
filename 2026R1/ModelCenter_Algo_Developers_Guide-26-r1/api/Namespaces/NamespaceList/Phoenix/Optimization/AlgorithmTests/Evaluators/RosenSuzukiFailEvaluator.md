# RosenSuzukiFailEvaluator Class

**Namespace:** `Phoenix.Optimization.AlgorithmTests.Evaluators`

## Overview

Implementation of `T:Phoenix.Optimization.AlgorithmTests.Evaluators.RosenSuzukiEvaluator` with failed runs.  
 

## Inheritance

![RosenSuzukiFailEvaluator](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_rosen_suzuki_fail_evaluator.png)

## Declaration

```csharp
class RosenSuzukiFailEvaluator
```
...
|override bool | `HasFailedRuns [get]`<br>Evaluator can have failed runs. |
...
Evaluator can have failed runs.
