...
Implementation for the TB1 Function problem Source: NonLinear Programming Theory and Algorithms, Second Edition Wiley Student edition ISBN 9812-53-068-1 by Mokhtar S Bazaraa, Hanif D.  
 

## Inheritance

![TB1Evaluator](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_t_b1_evaluator.png)
...
Sherali and C.M. Shetty Page No. 419, Example 10.1.8 
```
Minimize 2*x1^2 + 2*x2^2 - 2*x1*x2 - 4*x1 - 6*x2 subject to x1 + 5*x2 <= 5 2*x1^2 - x2 <= 0 Number of variables: 2 variables Search domain: 0 <= xi , i = 1, 2 The global minima: x* = {0.658872, 0.868226}, f(x*) = -6.5590  
```
...
|Name|Description|
|-----|-----|
|override object[,] | `GlobalBestDesigns [get]`<br>The expected result is -6.5590 for the minima at (0.658872, 0.868226) |
...
The expected result is -6.5590 for the minima at (0.658872, 0.868226)
