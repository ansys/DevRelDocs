...
![CRPO20](../../../../../../graphics/class_phoenix_1_1_optimization_1_1_algorithm_tests_1_1_evaluators_1_1_c_r_p_o20.png)
...
```
Number of variables: 24 variables. Definition: f(x) = [sum:i=1 to 24]{a(i)*x(i)} Search domain: 0<= xi <= 10, i=1 to 24; Subject to: gi <= 0, i= 1 to 20 ; 14 equality; Number of local minima: no local minima except the global one. The global minima: x* = (1.28582343498528086e-18, 4.83460302526130664e-34, 0, 0, 6.30459929660781851e-18, 7.57192526201145068e-34, 5.03350698372840437e-34, 9.28268079616618064e-34, 0, 1.76723384525547359e-17, 3.55686101822965701e-34, 2.9941385008347e-34, 0.158143376337580827, 2.29601774161699833e-19, 1.06106938611042947e-18, 1.31968344319506391e-18, 0.530902525044209539, 0, 2.89148310257773535e-18, 3.34892126180666159e-18, 0, 0.310999974151577319, 5.41244666317833561e-05, 4.849931652469595e-16) /// f(x*) = no feasible solution, the provided design is also little infeasible. 
```
...
| |`CRPO20 ()`<br>Default constructor, uses the default goal of `minimize` |
| |`CRPO20 (Goal goal)`<br>Constructor to use custom goal |
