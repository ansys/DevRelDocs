...
Server options are specified by the C API call [dvs\_server\_set\_option()](../reference/files/dynamic__visualization__store__api_8h.md#function-dvs_server_set_option), or the C++ API call [DVS::IServer::set\_option()](../reference/classes/class_d_v_s_1_1_i_server.md#function-set_option).

| Server Option | Default | Description |
| --- | --- | --- |
| `CACHE_URI` | None | A URI used to specify cache type, location and filtering options. See [Cache URIs](./dvs-uri.md#cache-uris) for more information. |
