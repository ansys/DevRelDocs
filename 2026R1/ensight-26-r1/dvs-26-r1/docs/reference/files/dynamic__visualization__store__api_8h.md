...
1.) Call [dvs_server_create()](#function-dvs_server_create)
2.) Call [dvs_connect()](#function-dvs_connect)
3.) Provide a logging method ([dvs_register_log_func()](#function-dvs_register_log_func)) (optional)
4.) Begin initialization ([dvs_begin_init()](#function-dvs_begin_init))
5.) Set unit system ([dvs_set_unit_system()](#function-dvs_set_unit_system)) (optional)
6.) Add information about all parts if applicable ([dvs_add_part_info()](#function-dvs_add_part_info))
7.) Add information about all variables if applicable ([dvs_add_var_info()](#function-dvs_add_var_info)) (optional)
8.) Add information about all plots if applicable ([dvs_add_plot_info()](#function-dvs_add_plot_info)) (optional)
9.) End initialization ([dvs_end_init()](#function-dvs_end_init))

Now at the end of each timestep we can push data to the ensight server

1.) Begin the update ([dvs_begin_update()](#function-dvs_begin_update))
2.) For Each Part
        Update mesh/nodes ([dvs_update_nodes()](#function-dvs_update_nodes))
3.) For Each Element Type
        Update Element ([dvs_update_elements()](#function-dvs_update_elements))
4.) For Each Variable
        If location on case or part use corresponding update methods i.e. [dvs_update_var_case_scalar()](#function-dvs_update_var_case_scalar),
        [dvs_update_var_case_vector()](#function-dvs_update_var_case_vector), [dvs_update_var_part_scalar()](#function-dvs_update_var_part_scalar), [dvs_update_var_part_vector()](#function-dvs_update_var_part_vector)

        If location element or node use corresponding update methods i.e. [dvs_update_var_element_scalar()](#function-dvs_update_var_element_scalar),
        [dvs_update_var_element_vector()](#function-dvs_update_var_element_vector), dvs_update_var_node_scalar, [dvs_update_var_node_vector()](#function-dvs_update_var_node_vector)
4.) For Each Plot
         Update plot values ([dvs_update_plot()](#function-dvs_update_plot))
5.) End update ([dvs_end_update()](#function-dvs_end_update))

On application shutdown let the API shut itself down

1.) Call [dvs_shutdown()](#function-dvs_shutdown) to cleanup data structures
```


## Classes

* [dvs\_part\_info](../structures/structdvs__part__info.md)
* [dvs\_var\_info](../structures/structdvs__var__info.md)
* [dvs\_plot\_info](../structures/structdvs__plot__info.md)

## Includes

* <stdint.h>
* [dynamic_visualization_store_enums.h](dynamic__visualization__store__enums_8h.md)
* [dynamic_visualization_store_error_codes.h](dynamic__visualization__store__error__codes_8h.md)
* [dynamic_visualization_store_version.h](dynamic__visualization__store__version_8h.md)
* dvs_import_export.h
...
click 1 "dynamic__visualization__store__api_8h.md"
1 --> 2
1 --> 3
1 --> 4
1 --> 5
...
click 3 "dynamic__visualization__store__enums_8h.md"
3 --> 2

4["dynamic_visualization_store_error_codes.h"]
click 4 "dynamic__visualization__store__error__codes_8h.md"
4 --> 2

5["dynamic_visualization_store_version.h"]
click 5 "dynamic__visualization__store__version_8h.md"
...
* [test_dvs_client.c](test__dvs__client_8c.md)
...
click 5 "dvs__query__interface_8h.md"
6 --> 5

6["dvs_server_interface.h"]
click 6 "dvs__server__interface_8h.md"
2 --> 6
3 --> 6
7 --> 6
8 --> 6
...
This call will connect to a server that has been created using [dvs\_server\_create()](#function-dvs_server_create) If server is being created locally [dvs\_server\_start()](#function-dvs_server_start) must be called before connecting.
...
* **server_id**: id of server created by [dvs\_server\_create()](#function-dvs_server_create)
* **flags**: flags for client setup see [dvs\_client\_flags](dynamic__visualization__store__enums_8h.md) ([dynamic\_visualization\_store\_enums.h](dynamic__visualization__store__enums_8h.md))
...
* int32_t **server_id**
* enum [dvs\_client\_flags](dynamic__visualization__store__enums_8h.md#enumeration-type-dvs_client_flags) **flags**
* const char * **secret**
* int32_t * **session_id**
...
See [dynamic\_visualization\_store\_error\_codes.h](dynamic__visualization__store__error__codes_8h.md) for possible error codes
...
* **session_id**: id for session created by [dvs\_connect()](#function-dvs_connect)
* **key**: option key
* **value**: option value
...
[dvs\_ret](dynamic__visualization__store__error__codes_8h.md#typedef-dvs_ret) DVS_NONE on success, otherwise see method description
...
* **session_id**: id for session created by [dvs\_connect()](#function-dvs_connect)
* **user_data**: user data that will be passed into [dvs\_log\_func](#typedef-dvs_log_func) calls
* **func**: function pointer for logging (see [dvs\_log\_func](#typedef-dvs_log_func))
* **flags**: which items to be logged, see [dvs\_log\_flags](dynamic__visualization__store__enums_8h.md#enumeration-type-dvs_log_flags) ([dynamic\_visualization\_store\_enums.h](dynamic__visualization__store__enums_8h.md))


**Returns**:

[dvs\_ret](dynamic__visualization__store__error__codes_8h.md#typedef-dvs_ret) TODO
...
* int32_t **session_id**
* void * **user_data**
* [dvs\_log\_func](#typedef-dvs_log_func) **func**
* enum [dvs\_log\_flags](dynamic__visualization__store__enums_8h.md) **flags**
...
* int32_t **session_id**
* const struct [dvs\_part\_info](../structures/structdvs__part__info.md) * **parts**
* uint32_t **num_parts**
...
* int32_t **session_id**
* const struct [dvs\_var\_info](../structures/structdvs__part__info.md) * **vars**
* uint32_t **num_vars**
...
* int32_t **session_id**
* const struct [dvs\_plot\_info](../structures/structdvs__plot__info.md) * **plots**
* uint32_t **num_plots**
...
Get the number of [dvs\_part\_info](../structures/structdvs__part__info.md) objects for this client session.
...
uint32_t number of [dvs\_part\_info](../structures/structdvs__part__info.md) objects, or 0 on error
...
Get the number of [dvs\_var\_info](../structures/structdvs__part__info.md) objects for this client session.
...
uint32_t number of [dvs\_var\_info](../structures/structdvs__part__info.md) objects, or 0 on error
...
Get the number of [dvs\_plot\_info](../structures/structdvs__plot__info.md) objects for this client session.
...
uint32_t number of [dvs\_plot\_info](../structures/structdvs__plot__info.md) objects, or 0 on error
...
Get the [dvs\_part\_info](../structures/structdvs__part__info.md) object for this index.
...
* **session_id**: which client session id to check
* **index**: index of the [dvs\_part\_info](../structures/structdvs__part__info.md) object to retrieve
...
Get the [dvs\_var\_info](../structures/structdvs__part__info.md) object for this index.
...
* **session_id**: which client session id to check
* **index**: index of the [dvs\_var\_info](../structures/structdvs__part__info.md) object to retrieve
...
Get the [dvs\_plot\_info](../structures/structdvs__plot__info.md) object for this index.
...
* **session_id**: which client session id to check
* **index**: index of the [dvs\_plot\_info](../structures/structdvs__plot__info.md) object to retrieve
...
Currently this will only allow for timesteps to be deleted. In the future it can be expanded to all objects via the filter mechanism (see [Query Stanzas](../../user-guide/dvs-filtering.md#query-stanzas)). Currently this supports the operands of eq, gt, gte, lt, lte. Example: To delete all timesteps >= time 1.1 the filter would be "/timestep.time/gte/1.1//" .
...
* **server_uri**: URI of server to create of the format protocol://hostname:port, i.e. grpc://localhost:50055 or null:// see [Server URIs](../../user-guide/dvs-uri.md#server-uris) for more info.
...
These options are used on server startup. Setting an option after a server is started will do nothing until the server is restarted (not common). See [Server Options](../../user-guide/dvs-server.md#server-options).
