...
- [EUL_NOD](https://ansys-a.devportal.io/docs/dpf-framework-2026-r1/operator-specifications/result/EUL_NOD.md):
  > Read/compute node euler angles by calling the readers defined by the datasources.

- [EUL_NODX](https://ansys-a.devportal.io/docs/dpf-framework-2026-r1/operator-specifications/result/EUL_NODX.md):
  > Read/compute node euler angles X component of the vector (1st component) by calling the readers defined by the datasources.

- [EUL_NODY](https://ansys-a.devportal.io/docs/dpf-framework-2026-r1/operator-specifications/result/EUL_NODY.md):
  > Read/compute node euler angles Y component of the vector (2nd component) by calling the readers defined by the datasources.

- [EUL_NODZ](https://ansys-a.devportal.io/docs/dpf-framework-2026-r1/operator-specifications/result/EUL_NODZ.md):
