...
# composite:von_mises_operator

**Version: 0.0.0**

## Description

Computes VonMises for ElementalNodal data
...
| <strong>Pin 100</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  criterion_configuration |[`string`](../../core-concepts/dpf-types.md#standard-types) | Criterion specification (json dict as string): For instance "{"active": true, "vme" : true, "vms" : true, "wf_vme" : 1.0, "wf_vms" : 1.0}"  |
 ...
 **Scripting name**: von_mises_operator

 **Full name**: composite.von_mises_operator

 **Internal name**: composite::von_mises_operator
