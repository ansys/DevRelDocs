...
# composite:tsai_wu_operator

**Version: 0.0.0**

## Description

Computes Tsai-Wu for ElementalNodal data
 ...
 **Scripting name**: tsai_wu_operator

 **Full name**: composite.tsai_wu_operator

 **Internal name**: composite::tsai_wu_operator
