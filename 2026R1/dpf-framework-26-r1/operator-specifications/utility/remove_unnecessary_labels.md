...
|------------|------|--------|------------------|
| <strong>-1</strong> | [permissive](#input_-1) |  |[`bool`](../../core-concepts/dpf-types.md#standard-types) |
...
| <strong>1</strong> | [label_to_remove](#input_1) |  <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;" title="This pin is required">Required</span>|[`string`](../../core-concepts/dpf-types.md#standard-types) |
