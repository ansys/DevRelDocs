...
|-------|-------|------------------|
| <strong>0</strong> <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  [time_freq_supports](#input_0) |`vector<shared_ptr<time_freq_support>>`, [`time_freq_support`](../../core-concepts/dpf-types.md#time-freq-support) |
