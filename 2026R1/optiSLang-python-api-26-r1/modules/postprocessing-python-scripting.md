...
|`text_import_settings_file`|Sets the file path to the [Design Point Import wizard](https://ansyshelp.ansys.com/account/secured?returnurl=/Views/Secured/corp/v261/en/opti_ug/opti_ug_text_import_wizard.html?q=design%20point%20import%20wizard) settings file.|
