...
min_max_fc_inc()
min_max_fc_inc(fields_container: object, config: OperatorConfig)
min_max_fc_inc(config: OperatorConfig)
...
```python
min_max_fc_inc(fields_container, config)
```
