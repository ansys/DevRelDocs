...
available inputs: `time_scoping` (Scoping) (optional), `mesh_scoping` (Scoping, ScopingsContainer) (optional), `energy_type` (Int32) (optional), `data_sources` (DataSources), `named_selection1` (string) (optional), `named_selection2` (string) (optional)
...
op = workflow_energy_per_component(time_scoping=my_time_scoping,mesh_scoping=my_mesh_scoping,energy_type=my_energy_type,data_sources=my_data_sources,named_selection1=my_named_selection1,named_selection2=my_named_selection2)
```
...
```python
workflow_energy_per_component(time_scoping, mesh_scoping, energy_type, data_sources, named_selection1, named_selection2, config)
```
