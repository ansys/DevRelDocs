...
timescoping_low_pass(time_freq_support: object, threshold: object, both: object, config: OperatorConfig)
timescoping_low_pass(config: OperatorConfig)
...
```python
timescoping_low_pass(time_freq_support, threshold, both, config)
```
