...
timefreq_high_pass()
timefreq_high_pass(time_freq_support: object, threshold: object, both: object, config: OperatorConfig)
timefreq_high_pass(config: OperatorConfig)
...
```python
timefreq_high_pass(time_freq_support, threshold, both, config)
```
