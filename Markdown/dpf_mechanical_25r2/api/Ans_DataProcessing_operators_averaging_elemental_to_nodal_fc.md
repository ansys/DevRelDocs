...
Transforms Elemental Nodal fields to Nodal fields. The result is computed on a given node's scoping.1. For a finite element mesh, the value on a node is the average of the values of the neighbour elements.
            ...
            3. For a face finite volume mesh inverse distance weighted average is used.   ///available inputs: fields_container (FieldsContainer), mesh (MeshedRegion, MeshesContainer) (optional), force_averaging (Int32) (optional), mesh_scoping (Scoping, ScopingsContainer) (optional), algorithm (Int32) (optional)
            available outputs: fields_container (FieldsContainer)

elemental_to_nodal_fc()
elemental_to_nodal_fc(fields_container: object, mesh: object, force_averaging: object, mesh_scoping: object, algorithm: object, config: OperatorConfig)
elemental_to_nodal_fc(config: OperatorConfig)
