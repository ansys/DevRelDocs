...
- **Parameters**
  ...
  - **store_password** – bool (Default value False. Set to True when password is given and needs to be saved for the session’s duration, for example when parallelisation is required.)
