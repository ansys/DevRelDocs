...
before using the *ExtendedSetSourceRatio* method. See the [ExtendedSetActiveSource](DevPor_LAB_api_labvhv_extendedsetactivesource.md) chapter for more details.
