# FilteringRemoveHighestPeaks 

## Description 

Applies the XMP filtering and removes highest peaks on the map data. Returns a value different than 0 if no error has occurred.
