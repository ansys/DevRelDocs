...
| [migrate_to_vtu](Ans_DataProcessing_operators_serialization_migrate_to_vtu.md) | Extract results from data sources and export them to **VTU format**. |
| [serialize_to_hdf5](Ans_DataProcessing_operators_serialization_serialize_to_hdf5.md) | This operator is deprecated: use 'hdf5dpf_generate_result_file' instead. Serialize the inputs in an hdf5 format.   ///available inputs: file_path (string), export_floats (bool) (optional), export_flat_vectors (bool) (optional), data1 (Any), data2 (Any) |
| [serializer](Ans_DataProcessing_operators_serialization_serializer.md) | Take any input and serialize them in a file.   ///available inputs: stream_type (Int32), file_path (string), any_input1 (Any), any_input2 (Any) |
| [serializer_to_string](Ans_DataProcessing_operators_serialization_serializer_to_string.md) | Take any input and serialize them in a string.   ///available inputs: stream_type (Int32), any_input1 (Any), any_input2 (Any) |
