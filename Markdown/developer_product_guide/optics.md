...
Zemax has the ZOS-API, which provides interaction with the product in a variety of languages.
This API is a COM-enabled .NET library available for Windows, with templates and code examples provided for:
