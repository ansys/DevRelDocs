...
Ansys Mechanical and MAPDL are essentially two sides of the same coin, being two ways to access the same solver, and there are four principle developer tools associated with them plus a fifth that is only available as part of the Mechanical Premium and Enterprise products.
...
* [Installation and Usaged Demo (Beginner)](https://www.youtube.com/watch?v=ugiueYuNEKk)
* [Installation and Usaged Demo (Advanced)](https://www.youtube.com/watch?v=06s_tNvlOTM)

## Forming 

There are no Forming developer tools available at this time.

However, Ansys Forming is powered by the LS-Dyna solver, so see the section on LS-Dyna for more information.
