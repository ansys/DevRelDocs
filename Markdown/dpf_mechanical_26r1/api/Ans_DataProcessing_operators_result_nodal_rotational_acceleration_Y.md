...
title: nodal_rotational_acceleration_Y
---
...
```python
nodal_rotational_acceleration_Y(time_scoping, mesh_scoping, data_sources, config)
```
...
```python
nodal_rotational_acceleration_Y(config)
```
