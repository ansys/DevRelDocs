...
accumulate_min_over_label_fc(fields_container: object, label: object, config: OperatorConfig)
accumulate_min_over_label_fc(config: OperatorConfig)
...
```python
accumulate_min_over_label_fc(fields_container, label, config)
```
