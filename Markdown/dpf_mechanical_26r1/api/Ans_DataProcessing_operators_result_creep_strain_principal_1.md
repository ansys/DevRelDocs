...
title: creep_strain_principal_1
---
...
```python
creep_strain_principal_1(time_scoping, mesh_scoping, data_sources, requested_location, config)
```
...
```python
creep_strain_principal_1(config)
```
