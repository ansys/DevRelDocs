...
# accumulate_level_over_label_fc Class
...
accumulate_level_over_label_fc(fields_container: object, label: object, config: OperatorConfig)
accumulate_level_over_label_fc(config: OperatorConfig)
...
```python
accumulate_level_over_label_fc(fields_container, label, config)
```
