...
Evaluates maximum over time/frequency.   ///available inputs: fields_container (FieldsContainer), abs_value (bool) (optional), compute_amplitude (bool) (optional)
            available outputs: fields_container (FieldsContainer)

max_over_time_by_entity()
max_over_time_by_entity(fields_container: object, abs_value: object, compute_amplitude: object, config: OperatorConfig)
max_over_time_by_entity(config: OperatorConfig)
