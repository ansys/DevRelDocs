...
compute_stress_2()
compute_stress_2(scoping: object, streams_container: object, data_sources: object, requested_location: object, strain: object, config: OperatorConfig)
compute_stress_2(config: OperatorConfig)
...
```python
compute_stress_2(scoping, streams_container, data_sources, requested_location, strain, config)
```
