...
field_signed_high_pass(field: object, threshold: object, both: object, config: OperatorConfig)
field_signed_high_pass(config: OperatorConfig)
...
```python
field_signed_high_pass(field, threshold, both, config)
```
