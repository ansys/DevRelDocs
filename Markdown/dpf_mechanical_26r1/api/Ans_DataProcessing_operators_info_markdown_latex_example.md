...
This operator showcases the use of Markdown and LaTeX in operator and pin descriptions:
            ...
            * an *unordered list*
            ...
            \[x = \frac{-b \pm \sqrt{b^2-4ac}}{2a}.\]   ///available inputs: bogus_input (string) (optional)
            available outputs: bogus_output (object)

markdown_latex_example()
markdown_latex_example(bogus_input: object, config: OperatorConfig)
markdown_latex_example(config: OperatorConfig)
