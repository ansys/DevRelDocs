...
# global_eroded_hourglass_energy Class
...
global_eroded_hourglass_energy(data_sources: object, unit_system: object, config: OperatorConfig)
global_eroded_hourglass_energy(config: OperatorConfig)
...
```python
global_eroded_hourglass_energy(data_sources, unit_system, config)
```
