...
```python
stress_eqv_as_mechanical_workflow(time_scoping, mesh_scoping, streams_container, data_sources, mesh, requested_location, read_cyclic, average_across_bodies, config)
```
