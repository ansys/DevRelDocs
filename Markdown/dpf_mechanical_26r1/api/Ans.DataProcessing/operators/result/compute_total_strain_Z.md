...
```python
compute_total_strain_Z(time_scoping, scoping, streams_container, data_sources, extrapolate, nonlinear, meshed_region, requested_location, displacement, config)
```
