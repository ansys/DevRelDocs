...
Give the maximum for each element rank by comparing several fields.   ///available inputs: use_absolute_value (bool), field1 (Field, FieldsContainer), field2 (Field, FieldsContainer)
            available outputs: field (Field)

max_by_component()
max_by_component(use_absolute_value: object, field1: object, field2: object, config: OperatorConfig)
max_by_component(config: OperatorConfig)
