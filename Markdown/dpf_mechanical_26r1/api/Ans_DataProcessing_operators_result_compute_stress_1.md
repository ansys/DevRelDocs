...
compute_stress_1()
compute_stress_1(scoping: object, streams_container: object, data_sources: object, requested_location: object, strain: object, config: OperatorConfig)
compute_stress_1(config: OperatorConfig)
...
```python
compute_stress_1(scoping, streams_container, data_sources, requested_location, strain, config)
```
