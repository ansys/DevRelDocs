...
compute_stress_YZ()
compute_stress_YZ(scoping: object, streams_container: object, data_sources: object, requested_location: object, strain: object, config: OperatorConfig)
compute_stress_YZ(config: OperatorConfig)
...
```python
compute_stress_YZ(scoping, streams_container, data_sources, requested_location, strain, config)
```
