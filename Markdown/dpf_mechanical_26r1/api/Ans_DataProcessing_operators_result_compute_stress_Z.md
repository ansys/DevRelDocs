...
compute_stress_Z()
compute_stress_Z(scoping: object, streams_container: object, data_sources: object, requested_location: object, strain: object, config: OperatorConfig)
compute_stress_Z(config: OperatorConfig)
...
```python
compute_stress_Z(scoping, streams_container, data_sources, requested_location, strain, config)
```
