...
Ansys Prime Mesh Python client library 2024 R1 is a forked and modified version of the
open source project PyPrimeMesh 0.5.0. 
Ansys Prime Mesh Python client library 2024 R1 is distributed with Ansys 2024 R1.
PyPrimeMesh is part of the [PyAnsys](https://docs.pyansys.com) effort to facilitate the use of Ansys technologies directly
