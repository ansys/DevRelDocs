...
### *class* ansys.meshing.prime.PrismControlOffsetType(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`PrismControlOffsetType.as_integer_ratio`](ansys.meshing.prime.PrismControlOffsetType.as_integer_ratio.md#ansys.meshing.prime.PrismControlOffsetType.as_integer_ratio)(/)   | Return integer ratio.                                                      |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
