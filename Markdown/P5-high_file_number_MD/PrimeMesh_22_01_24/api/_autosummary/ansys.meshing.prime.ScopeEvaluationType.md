...
### *class* ansys.meshing.prime.ScopeEvaluationType(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`ScopeEvaluationType.as_integer_ratio`](ansys.meshing.prime.ScopeEvaluationType.as_integer_ratio.md#ansys.meshing.prime.ScopeEvaluationType.as_integer_ratio)(/)   | Return integer ratio.                                                      |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
