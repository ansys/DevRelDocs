...
### *class* ansys.meshing.prime.SplineRefinementType(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`SplineRefinementType.as_integer_ratio`](ansys.meshing.prime.SplineRefinementType.as_integer_ratio.md#ansys.meshing.prime.SplineRefinementType.as_integer_ratio)(/)   | Return integer ratio.                                                      |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
