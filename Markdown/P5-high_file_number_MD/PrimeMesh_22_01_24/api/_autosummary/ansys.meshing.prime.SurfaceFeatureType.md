...
### *class* ansys.meshing.prime.SurfaceFeatureType(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`SurfaceFeatureType.as_integer_ratio`](ansys.meshing.prime.SurfaceFeatureType.as_integer_ratio.md#ansys.meshing.prime.SurfaceFeatureType.as_integer_ratio)(/)   | Return integer ratio.                                                      |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
