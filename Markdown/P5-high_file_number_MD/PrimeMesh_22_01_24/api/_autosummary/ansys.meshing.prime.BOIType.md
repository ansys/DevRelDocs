...
### *class* ansys.meshing.prime.BOIType(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`BOIType.as_integer_ratio`](ansys.meshing.prime.BOIType.as_integer_ratio.md#ansys.meshing.prime.BOIType.as_integer_ratio)(/)           | Return integer ratio.                                                      |
|-----------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
