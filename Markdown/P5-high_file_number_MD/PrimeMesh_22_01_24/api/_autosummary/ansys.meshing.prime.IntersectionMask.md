...
### *class* ansys.meshing.prime.IntersectionMask(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`IntersectionMask.as_integer_ratio`](ansys.meshing.prime.IntersectionMask.as_integer_ratio.md#ansys.meshing.prime.IntersectionMask.as_integer_ratio)(/)   | Return integer ratio.                                                      |
|------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
