...
### *class* ansys.meshing.prime.QuadToSplineParams(model=None, feature_capture_type=None, feature_angle=None, corner_angle=None, shell_thickness=None, solid_shell=None, separate_by_zone=None, zone_name_shell_thickness_pairs=None, project_on_geometry=None, json_data=None, \*\*kwargs)
...
| [`QuadToSplineParams.print_default`](ansys.meshing.prime.QuadToSplineParams.print_default.md#ansys.meshing.prime.QuadToSplineParams.print_default)()   | Print the default values of QuadToSplineParams.   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|
| [`QuadToSplineParams.set_default`](ansys.meshing.prime.QuadToSplineParams.set_default.md#ansys.meshing.prime.QuadToSplineParams.set_default)([...])    | Set the default values of QuadToSplineParams.     |
