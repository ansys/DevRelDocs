...
### *class* ansys.meshing.prime.lucid.LabelToZoneMethod(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`LabelToZoneMethod.as_integer_ratio`](ansys.meshing.prime.lucid.LabelToZoneMethod.as_integer_ratio.md#ansys.meshing.prime.lucid.LabelToZoneMethod.as_integer_ratio)(/)   | Return integer ratio.                                                      |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
