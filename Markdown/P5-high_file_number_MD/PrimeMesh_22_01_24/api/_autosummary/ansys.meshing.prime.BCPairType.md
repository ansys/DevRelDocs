...
### *class* ansys.meshing.prime.BCPairType(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`BCPairType.as_integer_ratio`](ansys.meshing.prime.BCPairType.as_integer_ratio.md#ansys.meshing.prime.BCPairType.as_integer_ratio)(/)        | Return integer ratio.                                                      |
|-----------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
