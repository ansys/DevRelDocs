# PickerManager.TopSubPickerType Method 
 

Tops the type of the sub picker.
...
**C#**<br />
``` C#
public static PickerType TopSubPickerType()
```

**VB**<br />
``` VB
Public Shared Function TopSubPickerType As PickerType
```

**C++**<br />
``` C++
public:
static PickerType TopSubPickerType()
```

**F#**<br />
``` F#
static member TopSubPickerType : unit -> PickerType 
