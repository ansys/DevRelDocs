...
**VB**<br />
``` VB
Public Property RotCX As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable RotCX {
...
**F#**<br />
``` F#
member RotCX : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The rotational damping coefficient of x direction.
