# Configuration.StepOfStaticSimulation Property 
...
**VB**<br />
``` VB
Public Property StepOfStaticSimulation As UInteger
	Get
	Set
```
...
``` C++
public:
property unsigned int StepOfStaticSimulation {
	unsigned int get ();
...
**F#**<br />
``` F#
member StepOfStaticSimulation : uint32 with get, set
