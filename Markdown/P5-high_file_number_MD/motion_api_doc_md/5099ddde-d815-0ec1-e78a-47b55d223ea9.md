# GearGeometryForRBEInMeshFree.TemperaryGearGeometry(*T*) Method 
...
where T : new(), GearGeometryForRBEInMeshFree

```

**VB**<br />
``` VB
Public Shared Function TemperaryGearGeometry(Of T As {New, GearGeometryForRBEInMeshFree}) ( 
...
public:
generic<typename T>
where T : gcnew(), GearGeometryForRBEInMeshFree
...
static member TemperaryGearGeometry : 
        ...
        matO : OMatrix -> 'T  when 'T : new() and GearGeometryForRBEInMeshFree
