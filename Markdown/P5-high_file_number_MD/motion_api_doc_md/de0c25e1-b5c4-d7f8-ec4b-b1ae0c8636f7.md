# ContactStandard.BasePoissonsRatio Property 
...
**VB**<br />
``` VB
Public Property BasePoissonsRatio As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable BasePoissonsRatio {
...
**F#**<br />
``` F#
member BasePoissonsRatio : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The poisson's ratio of base surface.
