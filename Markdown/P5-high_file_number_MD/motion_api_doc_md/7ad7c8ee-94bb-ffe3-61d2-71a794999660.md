# View3D.IsDefaultOperation Method 
...
**VB**<br />
``` VB
Public Function IsDefaultOperation As Boolean
```

**C++**<br />
``` C++
public:
bool IsDefaultOperation()
```

**F#**<br />
``` F#
member IsDefaultOperation : unit -> bool 

```


#### Return Value
Type: Boolean<br />`true` if default; otherwise, `false`.
