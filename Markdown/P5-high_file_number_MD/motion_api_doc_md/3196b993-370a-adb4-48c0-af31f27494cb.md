# SimulationConfiguration.ExportICFPath Property 
...
**VB**<br />
``` VB
Public Property ExportICFPath As String
	Get
	Set
```
...
**F#**<br />
``` F#
member ExportICFPath : string with get, set

```


#### Property Value
Type: String<br />The export ICF path.
