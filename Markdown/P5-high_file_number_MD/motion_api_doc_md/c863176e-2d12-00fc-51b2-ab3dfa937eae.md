# Configuration.TreatAsModalForEFModalBodyResult Property 
...
**VB**<br />
``` VB
Public Property TreatAsModalForEFModalBodyResult As Boolean
	Get
	Set
```
...
``` C++
public:
property bool TreatAsModalForEFModalBodyResult {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member TreatAsModalForEFModalBodyResult : bool with get, set

```


#### Property Value
Type: Boolean<br />The flag that whether treat as modal for efmodal body result or not.
