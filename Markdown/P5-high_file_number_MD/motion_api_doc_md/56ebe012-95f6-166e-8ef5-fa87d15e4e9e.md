# PowerFlow.GetInputSplineValue Method 
...
**C#**<br />
``` C#
public static SplineValue GetInputSplineValue(
	Document3D doc,
...
**VB**<br />
``` VB
Public Shared Function GetInputSplineValue ( 
	doc As Document3D,
...
``` C++
public:
static SplineValue^ GetInputSplineValue(
	Document3D^ doc, 
...
**F#**<br />
``` F#
static member GetInputSplineValue : 
        doc : Document3D * 
