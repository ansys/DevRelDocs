# LinkDataBase.BushTransformRight Property 
...
**VB**<br />
``` VB
Public Property BushTransformRight As ObjectBase
	Get
	Set
```
...
``` C++
public:
property ObjectBase^ BushTransformRight {
	ObjectBase^ get ();
...
**F#**<br />
``` F#
member BushTransformRight : ObjectBase with get, set
