# Document3D.MappingEntity Method 
...
**VB**<br />
``` VB
Protected Overridable Sub MappingEntity
```

**C++**<br />
``` C++
protected:
virtual void MappingEntity()
```

**F#**<br />
``` F#
abstract MappingEntity : unit -> unit 
override MappingEntity : unit -> unit 
```
