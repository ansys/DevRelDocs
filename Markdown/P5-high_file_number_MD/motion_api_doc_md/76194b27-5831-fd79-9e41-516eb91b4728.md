# SetPatchBase.GetDefaultMaxPenetrationImpl Method 
...
**C#**<br />
``` C#
protected virtual bool GetDefaultMaxPenetrationImpl(
...
**VB**<br />
``` VB
Protected Overridable Function GetDefaultMaxPenetrationImpl ( 
