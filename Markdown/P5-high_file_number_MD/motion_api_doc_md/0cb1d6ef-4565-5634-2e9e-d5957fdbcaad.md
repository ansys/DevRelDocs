# PropertyBoundaryConditionBase.ElementRX Property 
...
**VB**<br />
``` VB
Public Property ElementRX As CompositeFieldUsable
	Get
	Set
```
...
``` C++
public:
property CompositeFieldUsable^ ElementRX {
...
**F#**<br />
``` F#
member ElementRX : CompositeFieldUsable with get, set
