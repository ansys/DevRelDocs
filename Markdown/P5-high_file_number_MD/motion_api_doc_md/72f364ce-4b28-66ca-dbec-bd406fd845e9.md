# Settings.UserStartPage Property 
...
**VB**<br />
``` VB
Public Property UserStartPage As String
	Get
	Set
```
...
**F#**<br />
``` F#
member UserStartPage : string with get, set

```


#### Property Value
Type: String<br />Url of user setting page.
