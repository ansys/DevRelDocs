# Configuration.UseAutoSolverProgressBar Property 
...
**VB**<br />
``` VB
Public Property UseAutoSolverProgressBar As Boolean
	Get
	Set
```
...
``` C++
public:
property bool UseAutoSolverProgressBar {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member UseAutoSolverProgressBar : bool with get, set
