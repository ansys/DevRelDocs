# PowerFlow.VehicleSimulatorResultFile Property 
...
**VB**<br />
``` VB
Public Property VehicleSimulatorResultFile As String
	Get
	Set
```
...
``` C++
public:
property String^ VehicleSimulatorResultFile {
	String^ get ();
...
**F#**<br />
``` F#
member VehicleSimulatorResultFile : string with get, set

```


#### Property Value
Type: String<br />The vehicle simulator result file.
