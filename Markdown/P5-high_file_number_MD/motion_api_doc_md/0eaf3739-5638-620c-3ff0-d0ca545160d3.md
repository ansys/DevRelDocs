# NTSF.StaticFrictionCoefficient Property 
...
**VB**<br />
``` VB
Public Property StaticFrictionCoefficient As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable StaticFrictionCoefficient {
...
**F#**<br />
``` F#
member StaticFrictionCoefficient : ExpressionValueVariable with get, set
