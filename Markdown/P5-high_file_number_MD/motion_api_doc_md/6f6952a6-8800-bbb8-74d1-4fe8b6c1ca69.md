# Document3D.UnderCursorObjects Property 
...
**VB**<br />
``` VB
Public ReadOnly Property UnderCursorObjects As List(Of ObjectBase)
	Get
```
...
``` C++
public:
property List<ObjectBase^>^ UnderCursorObjects {
	List<ObjectBase^>^ get ();
}
```
...
**F#**<br />
``` F#
member UnderCursorObjects : List<ObjectBase> with get
