# CouplerBase(*TProperty*).Joint1_FullName Property 
...
**VB**<br />
``` VB
Public ReadOnly Property Joint1_FullName As String
	Get
```
...
``` C++
public:
property String^ Joint1_FullName {
	String^ get ();
}
```
...
**F#**<br />
``` F#
member Joint1_FullName : string with get

```


#### Property Value
Type: String<br />The full name of the first joint.
