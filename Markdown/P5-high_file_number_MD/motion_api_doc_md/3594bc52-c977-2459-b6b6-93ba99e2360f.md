# CLoadStandard.FunctionTX Property 
...
``` VB
<ObsoleteAttribute>
Public Property FunctionTX As CLoadStandard.CLoadFunction
	Get
	Set
```
...
public:
[ObsoleteAttribute]
property CLoadStandard.CLoadFunction^ FunctionTX {
...
``` F#
[<ObsoleteAttribute>]
member FunctionTX : CLoadStandard.CLoadFunction with get, set
