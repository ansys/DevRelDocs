# ContactStandard.BounceOffDampingFactor Property 
...
**VB**<br />
``` VB
Public Property BounceOffDampingFactor As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable BounceOffDampingFactor {
...
**F#**<br />
``` F#
member BounceOffDampingFactor : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The bounce off damping factor.
