# Configuration.MotionStepForPositionAnaly Property 
...
**VB**<br />
``` VB
Public Property MotionStepForPositionAnaly As UInteger
	Get
	Set
```
...
``` C++
public:
property unsigned int MotionStepForPositionAnaly {
	unsigned int get ();
...
**F#**<br />
``` F#
member MotionStepForPositionAnaly : uint32 with get, set
