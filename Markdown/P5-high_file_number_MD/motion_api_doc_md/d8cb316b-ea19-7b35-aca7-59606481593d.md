# BeamElement.BaseBodyMomentOfInertia Property 
...
**VB**<br />
``` VB
Public Property BaseBodyMomentOfInertia As Variable()
	Get
	Set
```
...
``` C++
public:
property array<Variable^>^ BaseBodyMomentOfInertia {
	array<Variable^>^ get ();
...
**F#**<br />
``` F#
member BaseBodyMomentOfInertia : Variable[] with get, set
