...
**VB**<br />
``` VB
Public Event OnChildAdded As EventHandler(Of DocumentEventArgs)
```

**C++**<br />
``` C++
public:
 event EventHandler<DocumentEventArgs^>^ OnChildAdded {
...
**F#**<br />
``` F#
member OnChildAdded : IEvent<EventHandler<DocumentEventArgs>,
    DocumentEventArgs>
