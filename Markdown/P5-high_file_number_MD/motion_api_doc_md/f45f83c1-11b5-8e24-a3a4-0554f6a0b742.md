# ContactStandard.ActionYoungsModulus Property 
...
**VB**<br />
``` VB
Public Property ActionYoungsModulus As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable ActionYoungsModulus {
...
**F#**<br />
``` F#
member ActionYoungsModulus : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The young's modulus of action surface.
