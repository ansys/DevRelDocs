# BeamElement.ActionBodyMass Property 
...
**VB**<br />
``` VB
Public Property ActionBodyMass As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable ActionBodyMass {
...
**F#**<br />
``` F#
member ActionBodyMass : ExpressionValueVariable with get, set
