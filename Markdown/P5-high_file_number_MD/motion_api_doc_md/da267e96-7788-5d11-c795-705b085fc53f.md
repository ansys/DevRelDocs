# Settings.LogLicenseEvent Property 
...
**VB**<br />
``` VB
Public Property LogLicenseEvent As Integer
	Get
	Set
```
...
**F#**<br />
``` F#
member LogLicenseEvent : int with get, set

```


#### Property Value
Type: Int32<br />License status event log flag.
