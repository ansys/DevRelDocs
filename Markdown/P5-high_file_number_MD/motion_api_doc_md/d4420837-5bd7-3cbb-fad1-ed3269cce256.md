# PropertyBoundaryConditionBase.ElementTX Property 
...
**VB**<br />
``` VB
Public Property ElementTX As CompositeFieldUsable
	Get
	Set
```
...
``` C++
public:
property CompositeFieldUsable^ ElementTX {
...
**F#**<br />
``` F#
member ElementTX : CompositeFieldUsable with get, set
