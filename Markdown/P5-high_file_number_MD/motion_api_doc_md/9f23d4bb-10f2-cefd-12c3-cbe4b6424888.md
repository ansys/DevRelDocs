# PropertyBoundaryConditionBase.ElementRY Property 
...
**VB**<br />
``` VB
Public Property ElementRY As CompositeFieldUsable
	Get
	Set
```
...
``` C++
public:
property CompositeFieldUsable^ ElementRY {
...
**F#**<br />
``` F#
member ElementRY : CompositeFieldUsable with get, set
