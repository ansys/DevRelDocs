# Settings.CenterSubKey2 Property 
...
**VB**<br />
``` VB
Public Property CenterSubKey2 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys CenterSubKey2 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member CenterSubKey2 : NavigationKeys with get, set
