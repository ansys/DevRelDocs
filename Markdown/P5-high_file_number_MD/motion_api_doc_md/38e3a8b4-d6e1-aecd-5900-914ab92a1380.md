# MotorDesigner.RotateAxis Property 
...
**VB**<br />
``` VB
Public Property RotateAxis As DirectionBase
	Get
	Set
```
...
``` C++
public:
property DirectionBase^ RotateAxis {
	DirectionBase^ get ();
...
**F#**<br />
``` F#
member RotateAxis : DirectionBase with get, set

```


#### Property Value
Type: <a href="e766a5cd-064f-37a0-f7d1-fc7cadc8fad5">DirectionBase</a><br />The rotate axis.
