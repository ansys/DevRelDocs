# Document.OnSubentityAdded Event
...
**VB**<br />
``` VB
Public Event OnSubentityAdded As EventHandler(Of DocumentEventArgs)
```

**C++**<br />
``` C++
public:
 event EventHandler<DocumentEventArgs^>^ OnSubentityAdded {
...
**F#**<br />
``` F#
member OnSubentityAdded : IEvent<EventHandler<DocumentEventArgs>,
    DocumentEventArgs>
