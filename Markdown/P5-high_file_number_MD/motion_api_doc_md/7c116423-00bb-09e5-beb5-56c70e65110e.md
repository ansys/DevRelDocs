# StreamFooter.GetVersionInfoSize Method 
...
**VB**<br />
``` VB
Public Shared Function GetVersionInfoSize As Long
```

**C++**<br />
``` C++
public:
static long long GetVersionInfoSize()
```

**F#**<br />
``` F#
static member GetVersionInfoSize : unit -> int64 
