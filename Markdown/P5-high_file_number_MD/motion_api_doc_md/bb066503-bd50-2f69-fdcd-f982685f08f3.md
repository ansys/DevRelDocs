# PropertyBush.TypeOfTransKX Property 
...
**VB**<br />
``` VB
Public Property TypeOfTransKX As PropertyBush.InputType
	Get
	Set
```
...
``` C++
public:
property PropertyBush.InputType TypeOfTransKX {
...
**F#**<br />
``` F#
member TypeOfTransKX : PropertyBush.InputType with get, set

```


#### Property Value
Type: <a href="e0c421fe-e473-4933-fa8c-ec3972bb297e">PropertyBush.InputType</a><br />The type of the trans KX.
