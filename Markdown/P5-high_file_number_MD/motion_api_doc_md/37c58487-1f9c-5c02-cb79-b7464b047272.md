# PropertyBush.TransKType Property 
...
``` VB
<ObsoleteAttribute>
Public ReadOnly Property TransKType As PropertyBush.InputType
	Get
```
...
public:
[ObsoleteAttribute]
property PropertyBush.InputType TransKType {
...
``` F#
[<ObsoleteAttribute>]
member TransKType : PropertyBush.InputType with get

```


#### Property Value
Type: <a href="e0c421fe-e473-4933-fa8c-ec3972bb297e">PropertyBush.InputType</a><br />The input type of the translational stiffness.
