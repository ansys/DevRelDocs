# Settings.TranslateMainKey4 Property 
...
**VB**<br />
``` VB
Public Property TranslateMainKey4 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys TranslateMainKey4 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member TranslateMainKey4 : NavigationKeys with get, set
