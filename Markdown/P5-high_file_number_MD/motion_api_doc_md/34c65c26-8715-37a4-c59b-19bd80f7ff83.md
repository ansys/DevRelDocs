# LinkConfigurationBase.TimeToSteadyState Property 
...
**VB**<br />
``` VB
Public Property TimeToSteadyState As Double
	Get
	Set
```
...
``` C++
public:
property double TimeToSteadyState {
	double get ();
...
**F#**<br />
``` F#
member TimeToSteadyState : float with get, set
