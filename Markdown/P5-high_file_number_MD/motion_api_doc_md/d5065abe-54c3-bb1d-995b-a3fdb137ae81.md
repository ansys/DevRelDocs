# NodalBody.NumberOfElement Property 
...
**VB**<br />
``` VB
Public ReadOnly Property NumberOfElement As Integer
	Get
```
...
**F#**<br />
``` F#
member NumberOfElement : int with get

```


#### Property Value
Type: Int32<br />The number of element.
