# CreateCLoad.CreateCLoadSimple Method 
...
**C#**<br />
``` C#
public static CLoad CreateCLoadSimple(
...
``` VB
<ExtensionAttribute>
Public Shared Function CreateCLoadSimple ( 
...
public:
[ExtensionAttribute]
static CLoad^ CreateCLoadSimple(
...
``` F#
[<ExtensionAttribute>]
static member CreateCLoadSimple : 
        docToAdd : SubSystemDocument * 
        strName : string * 
        CLoadComponent : ICLoadComponent -> CLoad 

```


#### Parameters
&nbsp;<dl><dt>docToAdd</dt><dd>Type: <a href="e9919a27-be97-b564-ea2b-cbc9db8ce58d">VM.Managed.DAFUL.SubSystemDocument</a><br /></dd><dt>strName</dt><dd>Type: System.String<br /></dd><dt>CLoadComponent</dt><dd>Type: <a href="c690b044-e934-b0ab-13b0-8864cf444a0c">VM.Managed.DAFUL.ICLoadComponent</a><br /></dd></dl>
