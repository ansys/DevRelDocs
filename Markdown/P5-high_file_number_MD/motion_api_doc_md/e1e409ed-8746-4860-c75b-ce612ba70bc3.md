# BeamElement._BaseBody Property 
...
**VB**<br />
``` VB
Public Property _BaseBody As Linker(Of SolidBody)
	Get
	Set
```
...
``` C++
public:
property Linker<SolidBody^> _BaseBody {
...
**F#**<br />
``` F#
member _BaseBody : Linker<SolidBody> with get, set
