# Settings.CenterMainKey3 Property 
...
**VB**<br />
``` VB
Public Property CenterMainKey3 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys CenterMainKey3 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member CenterMainKey3 : NavigationKeys with get, set
