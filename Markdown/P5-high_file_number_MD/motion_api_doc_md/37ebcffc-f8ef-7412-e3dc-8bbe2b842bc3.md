# PowerFlow.MaxTorqueValue Property 
...
**VB**<br />
``` VB
Public Property MaxTorqueValue As Double
	Get
	Set
```
...
``` C++
public:
property double MaxTorqueValue {
	double get ();
...
**F#**<br />
``` F#
member MaxTorqueValue : float with get, set

```


#### Property Value
Type: Double<br />The max torque.
