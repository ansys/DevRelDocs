# PressureLoadBase(*TProperty*).PLoadComponent Property 
...
**VB**<br />
``` VB
Public Property PLoadComponent As IGeometricalComponent
	Get
	Set
```
...
``` C++
public:
property IGeometricalComponent^ PLoadComponent {
...
**F#**<br />
``` F#
member PLoadComponent : IGeometricalComponent with get, set
