...
**VB**<br />
``` VB
Public Property Area As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable Area {
...
**F#**<br />
``` F#
member Area : ExpressionValueVariable with get, set
