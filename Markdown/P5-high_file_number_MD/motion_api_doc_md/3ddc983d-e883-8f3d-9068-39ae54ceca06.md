# MultiObjectContainerMToN.NumberOfForward Property 
...
**VB**<br />
``` VB
Public Property NumberOfForward As Integer
	Get
	Set
```
...
**F#**<br />
``` F#
member NumberOfForward : int with get, set
