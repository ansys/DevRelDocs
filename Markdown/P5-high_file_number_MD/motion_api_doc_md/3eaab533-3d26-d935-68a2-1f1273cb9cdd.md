# PropertyShaftSetBase.GetBearingStartEndPoint Method 
...
**VB**<br />
``` VB
Public Function GetBearingStartEndPoint As List(Of Vector)
```

**C++**<br />
``` C++
public:
List<Vector^>^ GetBearingStartEndPoint()
```

**F#**<br />
``` F#
member GetBearingStartEndPoint : unit -> List<Vector> 
