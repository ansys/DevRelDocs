# Document3D.IncreaseReferedDocumentCount Method 
...
**VB**<br />
``` VB
Public Sub IncreaseReferedDocumentCount
```

**C++**<br />
``` C++
public:
void IncreaseReferedDocumentCount()
```

**F#**<br />
``` F#
member IncreaseReferedDocumentCount : unit -> unit 
