...
**VB**<br />
``` VB
Public Overridable Event ChildReplaced As EventHandler(Of Identifier)
```

**C++**<br />
``` C++
public:
virtual  event EventHandler<Identifier>^ ChildReplaced {
...
**F#**<br />
``` F#
abstract ChildReplaced : IEvent<EventHandler<Identifier>,
    Identifier>
override ChildReplaced : IEvent<EventHandler<Identifier>,
    Identifier>
```
