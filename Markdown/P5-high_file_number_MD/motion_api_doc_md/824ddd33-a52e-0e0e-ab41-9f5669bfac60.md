# Settings.ZoomMainKey2 Property 
...
**VB**<br />
``` VB
Public Property ZoomMainKey2 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys ZoomMainKey2 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member ZoomMainKey2 : NavigationKeys with get, set
