# PowerFlow.InputPowerFilePath Property 
...
**VB**<br />
``` VB
Public Property InputPowerFilePath As String
	Get
	Set
```
...
``` C++
public:
property String^ InputPowerFilePath {
	String^ get ();
...
**F#**<br />
``` F#
member InputPowerFilePath : string with get, set

```


#### Property Value
Type: String<br />The input power path.
