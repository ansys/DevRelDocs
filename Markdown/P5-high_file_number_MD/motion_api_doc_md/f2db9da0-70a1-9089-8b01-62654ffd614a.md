# Document3D.ExistUnderCursor Method 
...
**VB**<br />
``` VB
Public Function ExistUnderCursor As Boolean
```
...
**F#**<br />
``` F#
member ExistUnderCursor : unit -> bool 

```


#### Return Value
Type: Boolean<br />`true` if object exists under cursor; otherwise, `false`.
