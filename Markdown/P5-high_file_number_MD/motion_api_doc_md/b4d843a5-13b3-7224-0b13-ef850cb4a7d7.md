# Document3D.SkipUIUpdating Property 
...
**VB**<br />
``` VB
Public Property SkipUIUpdating As Boolean
	Get
	Set
```
...
**F#**<br />
``` F#
member SkipUIUpdating : bool with get, set

```


#### Property Value
Type: Boolean<br />The document's skip ui updating state.
