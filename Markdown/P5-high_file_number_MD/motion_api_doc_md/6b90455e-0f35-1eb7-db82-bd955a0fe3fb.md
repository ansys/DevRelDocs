# PropertyBush.TypeOfRotKX Property 
...
**VB**<br />
``` VB
Public Property TypeOfRotKX As PropertyBush.InputType
	Get
	Set
```
...
``` C++
public:
property PropertyBush.InputType TypeOfRotKX {
...
**F#**<br />
``` F#
member TypeOfRotKX : PropertyBush.InputType with get, set

```


#### Property Value
Type: <a href="e0c421fe-e473-4933-fa8c-ec3972bb297e">PropertyBush.InputType</a><br />The type of the rot KX.
