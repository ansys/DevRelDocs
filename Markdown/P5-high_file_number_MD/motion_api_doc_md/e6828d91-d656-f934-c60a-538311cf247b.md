# MultiObjectContainerMToN.BaseObjects Property 
...
**VB**<br />
``` VB
Public Property BaseObjects As ObjectBase()
	Get
	Set
```
...
``` C++
public:
property array<ObjectBase^>^ BaseObjects {
...
**F#**<br />
``` F#
member BaseObjects : ObjectBase[] with get, set

```


#### Property Value
Type: <a href="e4ef36d2-6ffe-3d20-3215-f6ddb4918c59">ObjectBase</a>[]<br />The Base objects.
