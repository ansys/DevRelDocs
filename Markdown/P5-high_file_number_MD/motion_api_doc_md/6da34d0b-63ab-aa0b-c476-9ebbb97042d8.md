# LinkDataBase.InnerGauge Property 
...
**VB**<br />
``` VB
Public Property InnerGauge As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable InnerGauge {
...
**F#**<br />
``` F#
member InnerGauge : ExpressionValueVariable with get, set
