# ImprintUtil.GetFacesWithCylinderRange Method 
...
**C#**<br />
``` C#
public static bool GetFacesWithCylinderRange(
	Document3D doc3D,
	Body body,
	TMatrix matT,
	double dRadius,
...
**VB**<br />
``` VB
Public Shared Function GetFacesWithCylinderRange ( 
	doc3D As Document3D,
	body As Body,
	matT As TMatrix,
	dRadius As Double,
...
``` C++
public:
static bool GetFacesWithCylinderRange(
	Document3D^ doc3D, 
	Body^ body, 
	TMatrix^ matT, 
	double dRadius, 
...
**F#**<br />
``` F#
static member GetFacesWithCylinderRange : 
        doc3D : Document3D * 
        body : Body * 
        matT : TMatrix * 
        dRadius : float * 
