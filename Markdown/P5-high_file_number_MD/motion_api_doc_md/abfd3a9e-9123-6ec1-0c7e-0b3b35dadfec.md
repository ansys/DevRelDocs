# Configuration.AppendedDateTime Property 
...
**VB**<br />
``` VB
Public Property AppendedDateTime As Boolean
	Get
	Set
```
...
``` C++
public:
property bool AppendedDateTime {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member AppendedDateTime : bool with get, set
