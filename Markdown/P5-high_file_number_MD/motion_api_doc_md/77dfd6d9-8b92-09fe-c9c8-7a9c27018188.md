# Document3D.ContainsEntityToEntityDictionary Method 
...
**C#**<br />
``` C#
public bool ContainsEntityToEntityDictionary(
	ObjectBase obj
)
```
...
**VB**<br />
``` VB
Public Function ContainsEntityToEntityDictionary ( 
	obj As ObjectBase
) As Boolean
```
...
``` C++
public:
bool ContainsEntityToEntityDictionary(
	ObjectBase^ obj
)
```
...
**F#**<br />
``` F#
member ContainsEntityToEntityDictionary : 
        obj : ObjectBase -> bool 
