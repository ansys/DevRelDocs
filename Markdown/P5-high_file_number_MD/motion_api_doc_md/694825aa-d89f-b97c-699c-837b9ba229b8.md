# CLoadStandard.FunctionTZ Property 
...
``` VB
<ObsoleteAttribute>
Public Property FunctionTZ As CLoadStandard.CLoadFunction
	Get
	Set
```
...
public:
[ObsoleteAttribute]
property CLoadStandard.CLoadFunction^ FunctionTZ {
...
``` F#
[<ObsoleteAttribute>]
member FunctionTZ : CLoadStandard.CLoadFunction with get, set
