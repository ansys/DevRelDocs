# ObjectBaseAddon.BeforeRollback Method 
...
**C#**<br />
``` C#
protected override sealed void BeforeRollback(
	Object o,
...
**VB**<br />
``` VB
Protected Overrides NotOverridable Sub BeforeRollback ( 
	o As Object,
...
**F#**<br />
``` F#
abstract BeforeRollback : 
        o : Object * 
        args : HistoryEventArgs -> unit 
override BeforeRollback : 
        o : Object * 
        args : HistoryEventArgs -> unit 
```
