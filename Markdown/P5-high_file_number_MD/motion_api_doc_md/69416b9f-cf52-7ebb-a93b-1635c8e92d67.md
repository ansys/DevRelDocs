# Body.CalculateMassPropertyForAssembly Method 
...
**C#**<br />
``` C#
public void CalculateMassPropertyForAssembly(
	ref double dMass,
	ref double dVolume,
...
**VB**<br />
``` VB
Public Sub CalculateMassPropertyForAssembly ( 
...
``` C++
public:
void CalculateMassPropertyForAssembly(
	double% dMass, 
	double% dVolume, 
...
**F#**<br />
``` F#
member CalculateMassPropertyForAssembly : 
        dMass : float byref * 
        dVolume : float byref * 
