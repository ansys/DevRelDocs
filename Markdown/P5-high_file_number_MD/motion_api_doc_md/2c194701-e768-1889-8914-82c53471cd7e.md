...
**VB**<br />
``` VB
Public Property SphereRadius As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable SphereRadius {
...
**F#**<br />
``` F#
member SphereRadius : ExpressionValueVariable with get, set
