...
**VB**<br />
``` VB
Public Property ZoomSubKey3 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys ZoomSubKey3 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member ZoomSubKey3 : NavigationKeys with get, set
