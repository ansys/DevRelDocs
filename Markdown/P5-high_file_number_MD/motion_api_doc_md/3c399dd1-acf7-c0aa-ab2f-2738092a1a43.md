...
**VB**<br />
``` VB
Public Property Iyy As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable Iyy {
...
**F#**<br />
``` F#
member Iyy : ExpressionValueVariable with get, set
