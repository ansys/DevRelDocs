# Settings.ZoomMainKey3 Property 
...
**VB**<br />
``` VB
Public Property ZoomMainKey3 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys ZoomMainKey3 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member ZoomMainKey3 : NavigationKeys with get, set
