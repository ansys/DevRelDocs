# Document.OperationBegin Method 
...
**VB**<br />
``` VB
Public Overridable Sub OperationBegin
```

**C++**<br />
``` C++
public:
virtual void OperationBegin()
```

**F#**<br />
``` F#
abstract OperationBegin : unit -> unit 
override OperationBegin : unit -> unit 
```
