# Settings.RotateMainKey4 Property 
...
**VB**<br />
``` VB
Public Property RotateMainKey4 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys RotateMainKey4 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member RotateMainKey4 : NavigationKeys with get, set
