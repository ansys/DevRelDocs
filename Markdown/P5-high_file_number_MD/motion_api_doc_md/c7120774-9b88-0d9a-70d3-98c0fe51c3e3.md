# Configuration.IsIncludeThermal Property 
...
**VB**<br />
``` VB
Public Property IsIncludeThermal As Boolean
	Get
	Set
```
...
``` C++
public:
property bool IsIncludeThermal {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member IsIncludeThermal : bool with get, set

```


#### Property Value
Type: Boolean<br />`true` if [include thermal]; otherwise, `false`.
