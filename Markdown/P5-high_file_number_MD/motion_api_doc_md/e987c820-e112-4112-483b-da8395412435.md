# NodalBody.NumberOfElementset Property 
...
**VB**<br />
``` VB
Public ReadOnly Property NumberOfElementset As Integer
	Get
```
...
``` C++
public:
property int NumberOfElementset {
	int get ();
}
```
...
**F#**<br />
``` F#
member NumberOfElementset : int with get

```


#### Property Value
Type: Int32<br />The number of elementset.
