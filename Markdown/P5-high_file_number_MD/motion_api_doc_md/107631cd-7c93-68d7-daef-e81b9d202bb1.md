# LinkDataBase.BushTransformLeft Property 
...
**VB**<br />
``` VB
Public Property BushTransformLeft As ObjectBase
	Get
	Set
```
...
``` C++
public:
property ObjectBase^ BushTransformLeft {
	ObjectBase^ get ();
...
**F#**<br />
``` F#
member BushTransformLeft : ObjectBase with get, set
