# LinkDataBase.PositionForLinkCombination Property 
...
**VB**<br />
``` VB
Public Property PositionForLinkCombination As ObjectBase
	Get
	Set
```
...
``` C++
public:
property ObjectBase^ PositionForLinkCombination {
	ObjectBase^ get ();
...
**F#**<br />
``` F#
member PositionForLinkCombination : ObjectBase with get, set
