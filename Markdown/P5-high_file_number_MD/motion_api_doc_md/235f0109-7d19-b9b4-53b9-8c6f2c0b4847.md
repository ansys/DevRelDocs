# Settings.FunctionExpressionScriptHeader Property 
...
**VB**<br />
``` VB
Public ReadOnly Property FunctionExpressionScriptHeader As String
	Get
```
...
``` C++
public:
property String^ FunctionExpressionScriptHeader {
	String^ get ();
}
```
...
**F#**<br />
``` F#
member FunctionExpressionScriptHeader : string with get
