...
**VB**<br />
``` VB
Public Property Thickness As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable Thickness {
...
**F#**<br />
``` F#
member Thickness : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The thickness.

## Exceptions
&nbsp;<table><tr><th>Exception</th><th>Condition</th></tr><tr><td>Exception</td><td>Thickness is null.</td></tr></table>
