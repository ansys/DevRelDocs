# CLoadStandard.CLoadFunctionTX Property 
...
**VB**<br />
``` VB
Public Property CLoadFunctionTX As CLoadStandard.CLoadFunction
	Get
	Set
```
...
``` C++
public:
property CLoadStandard.CLoadFunction^ CLoadFunctionTX {
...
**F#**<br />
``` F#
member CLoadFunctionTX : CLoadStandard.CLoadFunction with get, set

```


#### Property Value
Type: <a href="51d60eff-e4d7-b5ee-11ce-fef7adfcd0c3">CLoadStandard.CLoadFunction</a><br />The rotational X coordinate function.
