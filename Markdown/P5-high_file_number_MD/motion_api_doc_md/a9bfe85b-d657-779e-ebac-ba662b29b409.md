# ContactStandard.DampCoefRatio Property 
...
**VB**<br />
``` VB
Public Property DampCoefRatio As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable DampCoefRatio {
...
**F#**<br />
``` F#
member DampCoefRatio : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The damping coefficient ratio.
