# PickerMulti.Initialize Method 
 

Initializes a multi picker's attributes. Sets the already selected objects.Whether selected objects highlight.If set to `true` add to list; otherwise, If set to `false` can remove object from already selected list.
