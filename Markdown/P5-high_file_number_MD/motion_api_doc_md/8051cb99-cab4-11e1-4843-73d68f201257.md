# SubSystemDocument.ChangeOldFilePaths Property 
...
**VB**<br />
``` VB
Public Property ChangeOldFilePaths As List(Of String)
	Get
	Set
```
...
``` C++
public:
property List<String^>^ ChangeOldFilePaths {
	List<String^>^ get ();
...
**F#**<br />
``` F#
member ChangeOldFilePaths : List<string> with get, set

```


#### Property Value
Type: List(String)<br />The change old file paths.
