# BeamElement.BaseBodyOrientationArray Property 
...
**VB**<br />
``` VB
Public ReadOnly Property BaseBodyOrientationArray As Double()
	Get
```
...
``` C++
public:
property array<double>^ BaseBodyOrientationArray {
	array<double>^ get ();
}
```
...
**F#**<br />
``` F#
member BaseBodyOrientationArray : float[] with get
