# PropertySixMotion.TranslationalXProperty Property 
...
**VB**<br />
``` VB
Public Property TranslationalXProperty As PropertyTranslational
	Get
	Set
```
...
``` C++
public:
property PropertyTranslational^ TranslationalXProperty {
...
**F#**<br />
``` F#
member TranslationalXProperty : PropertyTranslational with get, set
