# Settings.CopyrightAndOSSLicenseInfoPath Property 
...
**VB**<br />
``` VB
Public ReadOnly Property CopyrightAndOSSLicenseInfoPath As String
	Get
```
...
``` C++
public:
property String^ CopyrightAndOSSLicenseInfoPath {
	String^ get ();
}
```
...
**F#**<br />
``` F#
member CopyrightAndOSSLicenseInfoPath : string with get

```


#### Property Value
Type: String<br />The Copyright and OSS License info file path.
