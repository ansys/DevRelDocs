# NodalBody.NumberOfFrequency Property 
...
**VB**<br />
``` VB
Public ReadOnly Property NumberOfFrequency As Integer
	Get
```
...
``` C++
public:
property int NumberOfFrequency {
	int get ();
}
```
...
**F#**<br />
``` F#
member NumberOfFrequency : int with get

```


#### Property Value
Type: Int32<br />The number of frequency.
