# LinkDataBase.PinTransformLeft Property 
...
**VB**<br />
``` VB
Public Property PinTransformLeft As ObjectBase
	Get
	Set
```
...
``` C++
public:
property ObjectBase^ PinTransformLeft {
	ObjectBase^ get ();
...
**F#**<br />
``` F#
member PinTransformLeft : ObjectBase with get, set
