# NamedObjectDictionary(*T*).Contains Method 
...
#### Parameters
&nbsp;<dl><dt>item</dt><dd>Type: <a href="6dd3b861-7487-0764-03f5-2be635eae096">*T*</a><br />The object to locate in the ICollection(T).</dd></dl>

#### Return Value
Type: Boolean<br />true if *item* is found in the ICollection(T); otherwise, false.
