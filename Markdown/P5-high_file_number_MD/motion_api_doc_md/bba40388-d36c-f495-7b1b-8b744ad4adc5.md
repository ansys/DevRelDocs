# PropertySixMotion.UseRotationalXProperty Property 
...
**VB**<br />
``` VB
Public Property UseRotationalXProperty As Boolean
	Get
	Set
```
...
``` C++
public:
property bool UseRotationalXProperty {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member UseRotationalXProperty : bool with get, set
...
#### Property Value
Type: Boolean<br />
The rotational x property use flag.
