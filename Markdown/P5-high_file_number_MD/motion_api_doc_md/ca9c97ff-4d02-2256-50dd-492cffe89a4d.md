# EigenvalueAnalysisParameter.ReferenceStressVal Property 
...
**VB**<br />
``` VB
Public Property ReferenceStressVal As Double
	Get
	Set
```
...
``` C++
public:
property double ReferenceStressVal {
	double get ();
...
**F#**<br />
``` F#
member ReferenceStressVal : float with get, set

```


#### Property Value
Type: Double<br />The reference stress.
