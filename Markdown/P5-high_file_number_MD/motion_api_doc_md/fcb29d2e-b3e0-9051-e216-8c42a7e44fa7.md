# PropertyBush.TypeOfTransCZ Property 
...
**VB**<br />
``` VB
Public Property TypeOfTransCZ As PropertyBush.InputType
	Get
	Set
```
...
``` C++
public:
property PropertyBush.InputType TypeOfTransCZ {
...
**F#**<br />
``` F#
member TypeOfTransCZ : PropertyBush.InputType with get, set

```


#### Property Value
Type: <a href="e0c421fe-e473-4933-fa8c-ec3972bb297e">PropertyBush.InputType</a><br />The type of the trans CZ.
