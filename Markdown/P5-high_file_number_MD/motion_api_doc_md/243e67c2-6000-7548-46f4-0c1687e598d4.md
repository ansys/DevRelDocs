# ConcentratedLoadBase(*TProperty*)._CLoadComponent Property 
...
**VB**<br />
``` VB
Public Property _CLoadComponent As Linker(Of IGeometricalComponent)
	Get
	Set
```
...
``` C++
public:
property Linker<IGeometricalComponent^> _CLoadComponent {
...
**F#**<br />
``` F#
member _CLoadComponent : Linker<IGeometricalComponent> with get, set
