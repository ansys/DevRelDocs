# PropertySixMotion.UseTranslationalZProperty Property 
...
**VB**<br />
``` VB
Public Property UseTranslationalZProperty As Boolean
	Get
	Set
```
...
``` C++
public:
property bool UseTranslationalZProperty {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member UseTranslationalZProperty : bool with get, set
...
#### Property Value
Type: Boolean<br />
The translational z property use flag.
