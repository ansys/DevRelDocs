# PickerMultiGeneral.HighlightCurveset Method 
...
**C#**<br />
``` C#
protected void HighlightCurveset(
	ObjectBase obj,
	bool bHighlight
)
```
...
**VB**<br />
``` VB
Protected Sub HighlightCurveset ( 
	obj As ObjectBase,
