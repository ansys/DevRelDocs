# PropertyBush.TypeOfTransKZ Property 
...
**VB**<br />
``` VB
Public Property TypeOfTransKZ As PropertyBush.InputType
	Get
	Set
```
...
``` C++
public:
property PropertyBush.InputType TypeOfTransKZ {
...
**F#**<br />
``` F#
member TypeOfTransKZ : PropertyBush.InputType with get, set

```


#### Property Value
Type: <a href="e0c421fe-e473-4933-fa8c-ec3972bb297e">PropertyBush.InputType</a><br />The type of the trans KZ.
