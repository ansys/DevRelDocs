# PropertySixMotion.UseRotationalYProperty Property 
...
**VB**<br />
``` VB
Public Property UseRotationalYProperty As Boolean
	Get
	Set
```
...
``` C++
public:
property bool UseRotationalYProperty {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member UseRotationalYProperty : bool with get, set
...
#### Property Value
Type: Boolean<br />
The rotational y property use flag.
