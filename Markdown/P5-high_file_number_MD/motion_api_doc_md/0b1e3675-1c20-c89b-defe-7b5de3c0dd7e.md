# OperationBase.GlobalOverride Property 
...
**VB**<br />
``` VB
Public Shared Property GlobalOverride As SessionOverride
	Get
	Set
```
...
``` C++
public:
static property SessionOverride^ GlobalOverride {
	SessionOverride^ get ();
...
**F#**<br />
``` F#
static member GlobalOverride : SessionOverride with get, set

```


#### Property Value
Type: SessionOverride<br />The session attributes.
