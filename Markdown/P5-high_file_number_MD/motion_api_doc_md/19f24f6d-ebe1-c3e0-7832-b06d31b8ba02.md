# EigenvalueAnalysisParameter.IsUseNumberOfDomain Property 
...
**VB**<br />
``` VB
Public Property IsUseNumberOfDomain As Boolean
	Get
	Set
```
...
``` C++
public:
property bool IsUseNumberOfDomain {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member IsUseNumberOfDomain : bool with get, set

```


#### Property Value
Type: Boolean<br />`true` if [use number of domain]; otherwise, `false`.
