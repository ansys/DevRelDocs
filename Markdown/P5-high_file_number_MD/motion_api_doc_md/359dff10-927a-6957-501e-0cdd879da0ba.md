# Settings.KernelBinaryLocation Property 
...
**VB**<br />
``` VB
Public ReadOnly Property KernelBinaryLocation As String
	Get
```
...
``` C++
public:
property String^ KernelBinaryLocation {
	String^ get ();
}
```
...
**F#**<br />
``` F#
member KernelBinaryLocation : string with get
