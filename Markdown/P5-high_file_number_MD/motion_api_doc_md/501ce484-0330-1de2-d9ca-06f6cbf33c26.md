# PropertyBush.TypeOfRotCX Property 
...
**VB**<br />
``` VB
Public Property TypeOfRotCX As PropertyBush.InputType
	Get
	Set
```
...
``` C++
public:
property PropertyBush.InputType TypeOfRotCX {
...
**F#**<br />
``` F#
member TypeOfRotCX : PropertyBush.InputType with get, set

```


#### Property Value
Type: <a href="e0c421fe-e473-4933-fa8c-ec3972bb297e">PropertyBush.InputType</a><br />The type of the rot CX.
