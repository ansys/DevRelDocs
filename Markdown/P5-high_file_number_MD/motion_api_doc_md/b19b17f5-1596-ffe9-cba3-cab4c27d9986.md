# Document.OnChildMultiAdded Event
...
**VB**<br />
``` VB
Public Event OnChildMultiAdded As EventHandler(Of DocumentEventArgs)
```

**C++**<br />
``` C++
public:
 event EventHandler<DocumentEventArgs^>^ OnChildMultiAdded {
...
**F#**<br />
``` F#
member OnChildMultiAdded : IEvent<EventHandler<DocumentEventArgs>,
    DocumentEventArgs>
