# AnalysisParallelTravel.ReboundTravelOfOpposit Property 
...
**VB**<br />
``` VB
Public Property ReboundTravelOfOpposit As Double
	Get
	Set
```
...
``` C++
public:
property double ReboundTravelOfOpposit {
	double get ();
...
**F#**<br />
``` F#
member ReboundTravelOfOpposit : float with get, set

```


#### Property Value
Type: Double<br />The rebound travel.
