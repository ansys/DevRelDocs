...
**VB**<br />
``` VB
Public Overridable Function Instantiate As LinkedList(Of Reference)
```
...
**F#**<br />
``` F#
abstract Instantiate : unit -> LinkedList<Reference> 
override Instantiate : unit -> LinkedList<Reference> 
```
