# BoundaryConditionBase(*TProperty*).BCComponent Property 
...
**VB**<br />
``` VB
Public Property BCComponent As IGeometricalComponent
	Get
	Set
```
...
``` C++
public:
property IGeometricalComponent^ BCComponent {
...
**F#**<br />
``` F#
member BCComponent : IGeometricalComponent with get, set
