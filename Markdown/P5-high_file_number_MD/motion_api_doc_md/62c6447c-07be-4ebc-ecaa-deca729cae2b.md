# AddedGearBuilderForRBEInFE.LinkRequestUpdating Method 
...
**C#**<br />
``` C#
protected override void LinkRequestUpdating(
	Object objNotifier,
	LinkEventArgs arg
)
```
...
**VB**<br />
``` VB
Protected Overrides Sub LinkRequestUpdating ( 
...
``` C++
protected:
virtual void LinkRequestUpdating(
	Object^ objNotifier, 
	LinkEventArgs^ arg
) override
```
...
**F#**<br />
``` F#
abstract LinkRequestUpdating : 
        objNotifier : Object * 
        arg : LinkEventArgs -> unit 
override LinkRequestUpdating : 
        objNotifier : Object * 
        arg : LinkEventArgs -> unit 
```
