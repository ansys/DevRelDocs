# PropertyBush.TranslationalOneSideBushingZ Property 
...
**VB**<br />
``` VB
Public Property TranslationalOneSideBushingZ As Boolean
	Get
	Set
```
...
``` C++
public:
property bool TranslationalOneSideBushingZ {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member TranslationalOneSideBushingZ : bool with get, set

```


#### Property Value
Type: Boolean<br />The flag of translational one side bushing Z.
