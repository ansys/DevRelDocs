# Settings.RotateMainKey2 Property 
...
**VB**<br />
``` VB
Public Property RotateMainKey2 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys RotateMainKey2 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member RotateMainKey2 : NavigationKeys with get, set
