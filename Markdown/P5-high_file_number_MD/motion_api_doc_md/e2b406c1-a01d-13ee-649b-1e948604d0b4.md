...
**VB**<br />
``` VB
Public Property ZoomSubKey4 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys ZoomSubKey4 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member ZoomSubKey4 : NavigationKeys with get, set
