# SetCurveForEdges.MaximumLength Property 
...
**VB**<br />
``` VB
Public Property MaximumLength As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable MaximumLength {
...
**F#**<br />
``` F#
member MaximumLength : ExpressionValueVariable with get, set
