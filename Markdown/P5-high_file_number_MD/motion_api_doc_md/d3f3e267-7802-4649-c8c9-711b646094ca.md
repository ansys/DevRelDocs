# NodalBody.NumberOfPatchset Property 
...
**VB**<br />
``` VB
Public ReadOnly Property NumberOfPatchset As Integer
	Get
```
...
**F#**<br />
``` F#
member NumberOfPatchset : int with get

```


#### Property Value
Type: Int32<br />The number of patchset.
