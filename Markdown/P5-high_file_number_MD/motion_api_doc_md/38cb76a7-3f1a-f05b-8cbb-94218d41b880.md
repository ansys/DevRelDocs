# ContactStandard.MaxSticDeform Property 
...
**VB**<br />
``` VB
Public Property MaxSticDeform As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable MaxSticDeform {
...
**F#**<br />
``` F#
member MaxSticDeform : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The max stiction deformation.
