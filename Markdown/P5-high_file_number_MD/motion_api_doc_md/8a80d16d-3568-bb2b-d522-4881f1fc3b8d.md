...
**C#**<br />
``` C#
public static bool CloseHiddenFile(
	string strFileName
)
```
...
**VB**<br />
``` VB
Public Shared Function CloseHiddenFile ( 
