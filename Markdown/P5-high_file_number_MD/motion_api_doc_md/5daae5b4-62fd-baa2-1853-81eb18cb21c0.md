...
public class PropertyMCTMC : PropertyContact2Dot5D
```

**VB**<br />
``` VB
<SerializableAttribute>
Public Class PropertyMCTMC
...
``` C++
[SerializableAttribute]
public ref class PropertyMCTMC : public PropertyContact2Dot5D
```
...
The PropertyMCTMC type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="62e1d5d4-93ce-b304-c466-5a0d609bf10c">PropertyMCTMC</a></td><td>
Initializes a new instance of the PropertyMCTMC class.</td></tr></table>&nbsp;
<a href="#propertymctmc-class">Back to Top</a>
