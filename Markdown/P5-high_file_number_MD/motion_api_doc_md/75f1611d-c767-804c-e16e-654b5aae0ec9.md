# MeshDocument.ImportMesh Method (String, Color, Unit)
...
#### Parameters
&nbsp;<dl><dt>strMeshFile</dt><dd>Type: System.String<br />The mesh file path.The mesh file path.</dd><dt>color</dt><dd>Type: System.Drawing.Color<br />The mesh color.The mesh color.</dd><dt>unit</dt><dd>Type: Unit<br />The unit convert factor.The unit convert factor.</dd></dl>
