# PickerPoint.GetVaildNPointsCenterXml Method 
...
**C#**<br />
``` C#
public string GetVaildNPointsCenterXml(
	string strDesireXml
)
```
...
**VB**<br />
``` VB
Public Function GetVaildNPointsCenterXml ( 
...
``` C++
public:
String^ GetVaildNPointsCenterXml(
	String^ strDesireXml
)
```
...
**F#**<br />
``` F#
member GetVaildNPointsCenterXml : 
