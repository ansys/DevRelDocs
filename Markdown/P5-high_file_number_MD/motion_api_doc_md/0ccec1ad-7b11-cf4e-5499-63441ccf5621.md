# Document3D.IsCuttingPlaneSelected Method 
...
**VB**<br />
``` VB
Public Function IsCuttingPlaneSelected As Boolean
```

**C++**<br />
``` C++
public:
bool IsCuttingPlaneSelected()
```

**F#**<br />
``` F#
member IsCuttingPlaneSelected : unit -> bool 
