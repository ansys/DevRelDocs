...
**VB**<br />
``` VB
Public Property Ixx As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable Ixx {
...
**F#**<br />
``` F#
member Ixx : ExpressionValueVariable with get, set
