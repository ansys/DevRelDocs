# CLoadStandard.FunctionFY Property 
...
``` VB
<ObsoleteAttribute>
Public Property FunctionFY As CLoadStandard.CLoadFunction
	Get
	Set
```
...
public:
[ObsoleteAttribute]
property CLoadStandard.CLoadFunction^ FunctionFY {
...
``` F#
[<ObsoleteAttribute>]
member FunctionFY : CLoadStandard.CLoadFunction with get, set
