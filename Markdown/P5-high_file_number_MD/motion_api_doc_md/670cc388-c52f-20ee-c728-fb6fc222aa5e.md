...
**VB**<br />
``` VB
Public Property RotCY As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable RotCY {
...
**F#**<br />
``` F#
member RotCY : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The rotational damping coefficient of y direction.
