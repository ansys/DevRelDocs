# Settings.GUISolverPath Property 
...
**VB**<br />
``` VB
Public ReadOnly Property GUISolverPath As String
	Get
```
...
**F#**<br />
``` F#
member GUISolverPath : string with get

```


#### Property Value
Type: String<br />The GUI solver path.
