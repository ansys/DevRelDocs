# PropertyBearing.DampingRatio Property 
 

Gets or sets the damping ratio. Use SetDampingRatio() when this instance sets for undo/redo
...
**F#**<br />
``` F#
member DampingRatio : float with get, set

```


#### Property Value
Type: Double<br />The damping ratio.
