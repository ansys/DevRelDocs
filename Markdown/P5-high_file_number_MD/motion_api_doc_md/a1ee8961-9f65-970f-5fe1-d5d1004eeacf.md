# Settings.SolverDirectory Property 
...
**VB**<br />
``` VB
Public ReadOnly Property SolverDirectory As String
	Get
```
...
``` C++
public:
property String^ SolverDirectory {
	String^ get ();
}
```
...
**F#**<br />
``` F#
member SolverDirectory : string with get

```


#### Property Value
Type: String<br />The solver directory.
