# BeamElement.ActionBodyOrientationArray Property 
...
**VB**<br />
``` VB
Public ReadOnly Property ActionBodyOrientationArray As Double()
	Get
```
...
``` C++
public:
property array<double>^ ActionBodyOrientationArray {
	array<double>^ get ();
}
```
...
**F#**<br />
``` F#
member ActionBodyOrientationArray : float[] with get
