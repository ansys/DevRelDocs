# Settings.NastranOutReaderPath Property 
...
**VB**<br />
``` VB
Public ReadOnly Property NastranOutReaderPath As String
	Get
```
...
``` C++
public:
property String^ NastranOutReaderPath {
	String^ get ();
}
```
...
**F#**<br />
``` F#
member NastranOutReaderPath : string with get

```


#### Property Value
Type: String<br />The NastranOutReader.dll.
