# PropertySixMotion.UseRotationalZProperty Property 
...
**VB**<br />
``` VB
Public Property UseRotationalZProperty As Boolean
	Get
	Set
```
...
``` C++
public:
property bool UseRotationalZProperty {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member UseRotationalZProperty : bool with get, set
...
#### Property Value
Type: Boolean<br />
The rotational z property use flag.
