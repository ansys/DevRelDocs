# ImprintUtil.ImprintWithCylinder Method 
...
**C#**<br />
``` C#
public static bool ImprintWithCylinder(
	Document3D doc,
	Body body,
...
**VB**<br />
``` VB
Public Shared Function ImprintWithCylinder ( 
	doc As Document3D,
	body As Body,
...
``` C++
public:
static bool ImprintWithCylinder(
	Document3D^ doc, 
	Body^ body, 
	VectorBase^ vecBottom, 
	VectorBase^ vecTop, 
...
**F#**<br />
``` F#
static member ImprintWithCylinder : 
        doc : Document3D * 
        body : Body * 
