# Settings.RotateSubKey2 Property 
...
**VB**<br />
``` VB
Public Property RotateSubKey2 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys RotateSubKey2 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member RotateSubKey2 : NavigationKeys with get, set
