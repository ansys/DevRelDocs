...
``` F#
static member Open : 
        strFullFilePath : string -> Document 

```


#### Parameters
&nbsp;<dl><dt>strFullFilePath</dt><dd>Type: System.String<br />The full file path.The full file path.</dd></dl>
