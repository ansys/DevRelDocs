...
``` C++
public:
virtual property String^ CodePath {
	String^ get () sealed;
...
**F#**<br />
``` F#
abstract CodePath : string with get, set
override CodePath : string with get, set
```
