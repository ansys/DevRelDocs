# PropertySoilInteraction Constructor 
 

Initializes a new instance of the <a href="87a05509-d2eb-8071-2ad7-f4ba473047e4">PropertySoilInteraction</a> class.
...
**F#**<br />
``` F#
new : unit -> PropertySoilInteraction
```
