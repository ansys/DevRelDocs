# ILinkContainerEvent.DestroyingEventHandler Property 
...
**VB**<br />
``` VB
ReadOnly Property DestroyingEventHandler As EventHandler(Of LinkEventArgs)
	Get
```

**C++**<br />
``` C++
property EventHandler<LinkEventArgs^>^ DestroyingEventHandler {
...
**F#**<br />
``` F#
abstract DestroyingEventHandler : EventHandler<LinkEventArgs> with get
