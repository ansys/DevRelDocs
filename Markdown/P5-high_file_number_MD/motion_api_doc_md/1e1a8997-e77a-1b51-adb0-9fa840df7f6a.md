# Document.OnChildDocNameUpdated Event
...
**VB**<br />
``` VB
Public Event OnChildDocNameUpdated As EventHandler(Of DocumentEventArgs)
```

**C++**<br />
``` C++
public:
 event EventHandler<DocumentEventArgs^>^ OnChildDocNameUpdated {
...
**F#**<br />
``` F#
member OnChildDocNameUpdated : IEvent<EventHandler<DocumentEventArgs>,
    DocumentEventArgs>
