# SimulationConfiguration.IsUsePLT Property 
...
**VB**<br />
``` VB
Public Property IsUsePLT As Boolean
	Get
	Set
```
...
**F#**<br />
``` F#
member IsUsePLT : bool with get, set

```


#### Property Value
Type: Boolean<br />`true` if this instance is use the simulation step of plt; otherwise, `false`.
