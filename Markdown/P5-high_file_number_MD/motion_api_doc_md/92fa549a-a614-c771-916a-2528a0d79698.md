# BallPlacing.InitRadius Property 
...
**VB**<br />
``` VB
Public Property InitRadius As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable InitRadius {
...
**F#**<br />
``` F#
member InitRadius : ExpressionValueVariable with get, set
