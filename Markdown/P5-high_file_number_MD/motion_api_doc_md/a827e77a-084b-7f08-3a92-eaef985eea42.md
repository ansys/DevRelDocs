# Api.OpenDocument Method (String, String, Boolean)
...
#### Parameters
&nbsp;<dl><dt>strFileName</dt><dd>Type: System.String<br />Name of the STR file.</dd><dt>strRelatedPath</dt><dd>Type: System.String<br />The STR related path.</dd><dt>bActivate</dt><dd>Type: System.Boolean<br />if set to `true` [b activate].</dd></dl>
