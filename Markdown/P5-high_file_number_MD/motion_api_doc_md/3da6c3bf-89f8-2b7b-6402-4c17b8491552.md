# PropertyBush.TranslationalOneSideBushingX Property 
...
**VB**<br />
``` VB
Public Property TranslationalOneSideBushingX As Boolean
	Get
	Set
```
...
``` C++
public:
property bool TranslationalOneSideBushingX {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member TranslationalOneSideBushingX : bool with get, set

```


#### Property Value
Type: Boolean<br />The flag of translational one side bushing X.
