...
**VB**<br />
``` VB
Public Property Asy As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable Asy {
...
**F#**<br />
``` F#
member Asy : ExpressionValueVariable with get, set
