# Settings.TranslateSubKey3 Property 
...
**VB**<br />
``` VB
Public Property TranslateSubKey3 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys TranslateSubKey3 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member TranslateSubKey3 : NavigationKeys with get, set
