# Settings.RotateSubKey4 Property 
...
**VB**<br />
``` VB
Public Property RotateSubKey4 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys RotateSubKey4 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member RotateSubKey4 : NavigationKeys with get, set
