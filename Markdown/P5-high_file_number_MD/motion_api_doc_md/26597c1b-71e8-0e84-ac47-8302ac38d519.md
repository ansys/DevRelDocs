# BeamElement.ActionBodyPosition Property 
...
**VB**<br />
``` VB
Public ReadOnly Property ActionBodyPosition As VectorBase
	Get
```
...
``` C++
public:
property VectorBase^ ActionBodyPosition {
	VectorBase^ get ();
}
```
...
**F#**<br />
``` F#
member ActionBodyPosition : VectorBase with get
