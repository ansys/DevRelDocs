# PropertyBush.TransKYSpline Property 
...
**VB**<br />
``` VB
Public Property TransKYSpline As Spline
	Get
	Set
```
...
**F#**<br />
``` F#
member TransKYSpline : Spline with get, set

```


#### Property Value
Type: <a href="44538ce3-d5fa-fa34-d6b6-7a78fd0b79de">Spline</a><br />The translational stiffness spline of y direction.
