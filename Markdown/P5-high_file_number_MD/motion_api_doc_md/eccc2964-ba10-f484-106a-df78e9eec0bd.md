# NodalBody.NumberOfEdgeset Property 
...
**VB**<br />
``` VB
Public ReadOnly Property NumberOfEdgeset As Integer
	Get
```
...
**F#**<br />
``` F#
member NumberOfEdgeset : int with get

```


#### Property Value
Type: Int32<br />The number of edgeset.
