# Settings.RotateMainKey3 Property 
...
**VB**<br />
``` VB
Public Property RotateMainKey3 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys RotateMainKey3 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member RotateMainKey3 : NavigationKeys with get, set
