# PropertyHousingBase.GetUnbalanceMassPoint Method 
...
**VB**<br />
``` VB
Public Function GetUnbalanceMassPoint As List(Of Vector)
```

**C++**<br />
``` C++
public:
List<Vector^>^ GetUnbalanceMassPoint()
```

**F#**<br />
``` F#
member GetUnbalanceMassPoint : unit -> List<Vector> 
