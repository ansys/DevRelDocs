# ContactStandard.UseBounceOffDampingFactor Property 
...
**VB**<br />
``` VB
Public Property UseBounceOffDampingFactor As Boolean
	Get
	Set
```
...
``` C++
public:
property bool UseBounceOffDampingFactor {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member UseBounceOffDampingFactor : bool with get, set

```


#### Property Value
Type: Boolean<br />`true` if [use bounce off damping factor]; otherwise, `false`.
