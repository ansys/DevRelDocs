...
**VB**<br />
``` VB
Public Property TransKY As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable TransKY {
...
**F#**<br />
``` F#
member TransKY : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The translational stiffness coefficient of y direction.
