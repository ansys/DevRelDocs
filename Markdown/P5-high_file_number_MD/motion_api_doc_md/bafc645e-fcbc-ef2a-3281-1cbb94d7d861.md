# Body.SkipCalcMassProp Property 
...
**VB**<br />
``` VB
Public Property SkipCalcMassProp As Boolean
	Get
	Set
```
...
``` C++
public:
property bool SkipCalcMassProp {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member SkipCalcMassProp : bool with get, set

```


#### Property Value
Type: Boolean<br />`true` if use [Calculate mass property]; otherwise, `false`.
