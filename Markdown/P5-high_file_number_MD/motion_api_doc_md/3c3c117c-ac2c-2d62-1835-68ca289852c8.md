...
**VB**<br />
``` VB
Public Property ZoomSubKey2 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys ZoomSubKey2 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member ZoomSubKey2 : NavigationKeys with get, set
