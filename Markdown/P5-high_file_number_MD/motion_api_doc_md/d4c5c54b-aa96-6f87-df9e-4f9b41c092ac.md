...
**VB**<br />
``` VB
Public Property RotKZ As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable RotKZ {
...
**F#**<br />
``` F#
member RotKZ : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The rotational stiffness coefficient of z direction.
