...
**VB**<br />
``` VB
Public Property RotKY As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable RotKY {
...
**F#**<br />
``` F#
member RotKY : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The rotational stiffness coefficient of y direction.
