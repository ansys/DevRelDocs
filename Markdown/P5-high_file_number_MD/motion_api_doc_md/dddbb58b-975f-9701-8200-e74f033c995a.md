# LinkDataBase.PinBooleanType Property 
...
**VB**<br />
``` VB
Public Property PinBooleanType As BooleanType
	Get
	Set
```
...
``` C++
public:
property BooleanType PinBooleanType {
	BooleanType get ();
...
**F#**<br />
``` F#
member PinBooleanType : BooleanType with get, set
