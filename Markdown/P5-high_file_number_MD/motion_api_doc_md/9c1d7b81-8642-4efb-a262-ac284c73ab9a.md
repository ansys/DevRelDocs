# Configuration.UserTetraFilePath Property 
...
**VB**<br />
``` VB
Public Property UserTetraFilePath As String
	Get
	Set
```
...
``` C++
public:
property String^ UserTetraFilePath {
	String^ get ();
...
**F#**<br />
``` F#
member UserTetraFilePath : string with get, set
