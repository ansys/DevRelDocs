# AssembledBody.UseRMovingReferenceFrame Property 
...
**VB**<br />
``` VB
Public Property UseRMovingReferenceFrame As Boolean
	Get
	Set
```
...
``` C++
public:
property bool UseRMovingReferenceFrame {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member UseRMovingReferenceFrame : bool with get, set

```


#### Property Value
Type: Boolean<br />The use rotational reference modal.
