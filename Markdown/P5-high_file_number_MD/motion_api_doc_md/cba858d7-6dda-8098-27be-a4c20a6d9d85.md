...
**VB**<br />
``` VB
Public ReadOnly Property RunDllPath As String
	Get
```
...
**F#**<br />
``` F#
member RunDllPath : string with get

```


#### Property Value
Type: String<br />The RunDLL.exe path.
