...
**VB**<br />
``` VB
Public Property ZoomSubKey1 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys ZoomSubKey1 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member ZoomSubKey1 : NavigationKeys with get, set

```


#### Property Value
Type: <a href="204b8288-54ed-0f04-781f-a87360fd4b0d">NavigationKeys</a><br />Second key for the zooming in, out.
