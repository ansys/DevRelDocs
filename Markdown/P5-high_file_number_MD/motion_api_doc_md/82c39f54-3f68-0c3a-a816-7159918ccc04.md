# Document3D.ExportBodyInfo Constructor (Body, TMatrix, Double, String)
...
new : 
        ...
        transform : TMatrix * 
        dLengthFactor : float * 
        strName : string -> ExportBodyInfo
```


#### Parameters
&nbsp;<dl><dt>body</dt><dd>Type: <a href="dc98f941-e8ef-25f9-9a55-0151997e3c14">VM.Managed.CAD.Body</a><br />The body.</dd><dt>transform</dt><dd>Type: <a href="8970ea1a-9b2d-7e4e-a48a-089c3184b6ed">VM.Managed.TMatrix</a><br />The transform.</dd><dt>dLengthFactor</dt><dd>Type: System.Double<br />The length factor.</dd><dt>strName</dt><dd>Type: System.String<br />The name.</dd></dl>
