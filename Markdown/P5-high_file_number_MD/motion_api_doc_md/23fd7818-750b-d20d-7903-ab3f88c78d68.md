...
**VB**<br />
``` VB
Public Property TransKX As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable TransKX {
...
**F#**<br />
``` F#
member TransKX : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The translational stiffness coefficient of x direction.
