# OperationBase.SkipEndOperation Property 
...
**VB**<br />
``` VB
Public Property SkipEndOperation As Boolean
	Get
	Set
```
...
``` C++
public:
property bool SkipEndOperation {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member SkipEndOperation : bool with get, set
