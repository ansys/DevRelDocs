# Document.OnChangeIconForNodalModal Event
...
**VB**<br />
``` VB
Public Event OnChangeIconForNodalModal As EventHandler(Of DocumentEventArgs)
```

**C++**<br />
``` C++
public:
 event EventHandler<DocumentEventArgs^>^ OnChangeIconForNodalModal {
...
**F#**<br />
``` F#
member OnChangeIconForNodalModal : IEvent<EventHandler<DocumentEventArgs>,
    DocumentEventArgs>
