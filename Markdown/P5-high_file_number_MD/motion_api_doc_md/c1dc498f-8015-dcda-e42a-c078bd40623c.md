# Body.SkipRebuildGeometry Property 
...
**VB**<br />
``` VB
Public Property SkipRebuildGeometry As Boolean
	Get
	Set
```
...
``` C++
public:
property bool SkipRebuildGeometry {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member SkipRebuildGeometry : bool with get, set

```


#### Property Value
Type: Boolean<br />`true` if use [Rebuild Geometry]; otherwise, `false`.
