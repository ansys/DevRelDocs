# Settings.CenterMainKey4 Property 
...
**VB**<br />
``` VB
Public Property CenterMainKey4 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys CenterMainKey4 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member CenterMainKey4 : NavigationKeys with get, set
