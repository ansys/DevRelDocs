# Settings.UserTempPath Property 
...
**VB**<br />
``` VB
Public Property UserTempPath As String
	Get
	Set
```
...
**F#**<br />
``` F#
member UserTempPath : string with get, set

```


#### Property Value
Type: String<br />The user temp path.
