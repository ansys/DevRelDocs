# SolidBody.MaxPenetration Property 
...
**VB**<br />
``` VB
Public ReadOnly Property MaxPenetration As ExpressionValueVariable
	Get
```
...
**F#**<br />
``` F#
member MaxPenetration : ExpressionValueVariable with get

```


#### Property Value
Type: ExpressionValueVariable<br />The max penetration.
