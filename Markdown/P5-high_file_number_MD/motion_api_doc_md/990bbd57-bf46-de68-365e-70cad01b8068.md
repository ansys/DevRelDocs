# SetCurveForEdges.MaximumTolerance Property 
...
**VB**<br />
``` VB
Public Property MaximumTolerance As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable MaximumTolerance {
...
**F#**<br />
``` F#
member MaximumTolerance : ExpressionValueVariable with get, set
