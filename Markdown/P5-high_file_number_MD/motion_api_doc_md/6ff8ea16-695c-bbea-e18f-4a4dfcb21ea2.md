# BodyRoller.GetFaceList_Tread Method 
...
**VB**<br />
``` VB
Public Function GetFaceList_Tread As List(Of Face)
```

**C++**<br />
``` C++
public:
List<Face^>^ GetFaceList_Tread()
```

**F#**<br />
``` F#
member GetFaceList_Tread : unit -> List<Face> 
