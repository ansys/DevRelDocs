# OperationBase.IsDoingThread Property 
...
**VB**<br />
``` VB
Public Shared ReadOnly Property IsDoingThread As Boolean
	Get
```
...
``` C++
public:
static property bool IsDoingThread {
	bool get ();
}
```
...
**F#**<br />
``` F#
static member IsDoingThread : bool with get
