# IChainedSegmentInfo.SetTransform Method 
...
abstract SetTransform : 
        transform : ObjectBase -> bool 

```


#### Parameters
&nbsp;<dl><dt>transform</dt><dd>Type: <a href="e4ef36d2-6ffe-3d20-3215-f6ddb4918c59">VM.Managed.ObjectBase</a><br />the transform(DesignFrame, Marker)</dd></dl>
