...
**VB**<br />
``` VB
Public Property RotKX As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable RotKX {
...
**F#**<br />
``` F#
member RotKX : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The rotational stiffness coefficient of x direction.
