# Document3D.RemoveEntityForReplace Method 
...
**C#**<br />
``` C#
public void RemoveEntityForReplace(
	ObjectBase obj
)
```
...
**VB**<br />
``` VB
Public Sub RemoveEntityForReplace ( 
	obj As ObjectBase
)
```
