...
**VB**<br />
``` VB
Public Property WidthInYAxis As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable WidthInYAxis {
...
**F#**<br />
``` F#
member WidthInYAxis : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The Width in Y Axis.

## Exceptions
&nbsp;<table><tr><th>Exception</th><th>Condition</th></tr><tr><td>Exception</td><td>Width in Y Axis is null.</td></tr></table>
