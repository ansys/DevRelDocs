...
**VB**<br />
``` VB
Public Property UseAutoSave As Boolean
	Get
	Set
```
...
**F#**<br />
``` F#
member UseAutoSave : bool with get, set

```


#### Property Value
Type: Boolean<br />`true` if [use auto save]; otherwise, `false`.
