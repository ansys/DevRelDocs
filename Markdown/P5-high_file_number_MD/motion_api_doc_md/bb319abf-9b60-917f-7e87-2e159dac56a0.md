# Mesh.ModalNASTRANFilter Property 
...
**VB**<br />
``` VB
Public Shared ReadOnly Property ModalNASTRANFilter As String
	Get
```
...
``` C++
public:
static property String^ ModalNASTRANFilter {
	String^ get ();
}
```
...
**F#**<br />
``` F#
static member ModalNASTRANFilter : string with get
