# MakeStiffnessSpline Constructor (List(Double[]), List(String), List(String), String)
...
#### Parameters
&nbsp;<dl><dt>lstDeform</dt><dd>Type: System.Collections.Generic.List(Double[])<br />The deform.</dd><dt>lstMethodType</dt><dd>Type: System.Collections.Generic.List(String)<br />Type of the method.</dd><dt>lstSelName</dt><dd>Type: System.Collections.Generic.List(String)<br />Type of the name.</dd><dt>strGearset</dt><dd>Type: System.String<br />The gearset name.</dd></dl>
