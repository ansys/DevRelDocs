# Document3D.EndCADImportLog Method 
...
**VB**<br />
``` VB
Protected Overridable Sub EndCADImportLog
```

**C++**<br />
``` C++
protected:
virtual void EndCADImportLog()
```

**F#**<br />
``` F#
abstract EndCADImportLog : unit -> unit 
override EndCADImportLog : unit -> unit 
```
