# NTSF.DynamicThreshold Property 
...
**C#**<br />
``` C#
public ExpressionValueVariable DynamicThreshold { get; set; }
```

**VB**<br />
``` VB
Public Property DynamicThreshold As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable DynamicThreshold {
...
**F#**<br />
``` F#
member DynamicThreshold : ExpressionValueVariable with get, set
