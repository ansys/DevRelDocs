# PropertySixMotion.RotationalZProperty Property 
...
**VB**<br />
``` VB
Public Property RotationalZProperty As PropertyRevolute
	Get
	Set
```
...
``` C++
public:
property PropertyRevolute^ RotationalZProperty {
...
**F#**<br />
``` F#
member RotationalZProperty : PropertyRevolute with get, set
