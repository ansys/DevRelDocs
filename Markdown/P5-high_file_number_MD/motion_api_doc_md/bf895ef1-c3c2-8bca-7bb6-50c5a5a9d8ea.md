# Settings.RotateSubKey3 Property 
...
**VB**<br />
``` VB
Public Property RotateSubKey3 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys RotateSubKey3 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member RotateSubKey3 : NavigationKeys with get, set

```


#### Property Value
Type: <a href="204b8288-54ed-0f04-781f-a87360fd4b0d">NavigationKeys</a><br />Second key for the view rotation.
