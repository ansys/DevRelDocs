# PropertySixMotion.TranslationalZProperty Property 
...
**VB**<br />
``` VB
Public Property TranslationalZProperty As PropertyTranslational
	Get
	Set
```
...
``` C++
public:
property PropertyTranslational^ TranslationalZProperty {
...
**F#**<br />
``` F#
member TranslationalZProperty : PropertyTranslational with get, set
