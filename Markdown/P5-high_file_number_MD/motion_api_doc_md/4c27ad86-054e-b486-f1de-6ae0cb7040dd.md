# DesignParameterInfo.IsSameCasesForUserInput Method 
...
**C#**<br />
``` C#
public bool IsSameCasesForUserInput(
	List<int> lst
)
```
...
**VB**<br />
``` VB
Public Function IsSameCasesForUserInput ( 
...
**F#**<br />
``` F#
member IsSameCasesForUserInput : 
        lst : List<int> -> bool 
