# PropertyBoundaryConditionBase.ElementTZ Property 
...
**VB**<br />
``` VB
Public Property ElementTZ As CompositeFieldUsable
	Get
	Set
```
...
``` C++
public:
property CompositeFieldUsable^ ElementTZ {
...
**F#**<br />
``` F#
member ElementTZ : CompositeFieldUsable with get, set
