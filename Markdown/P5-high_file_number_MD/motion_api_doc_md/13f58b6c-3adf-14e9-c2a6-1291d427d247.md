# RacewayGeometryForRBEInMeshFree.TemperaryRacewayGeometry Method 
...
**C#**<br />
``` C#
public static RacewayGeometryForRBEInMeshFree TemperaryRacewayGeometry(
...
Public Shared Function TemperaryRacewayGeometry ( 
	...
	matO As OMatrix,
	bAddDoc As Boolean
) As RacewayGeometryForRBEInMeshFree
```

**C++**<br />
``` C++
public:
static RacewayGeometryForRBEInMeshFree^ TemperaryRacewayGeometry(
	RacewayGeometryInfo^ rInfo, 
	IConnectable^ con, 
	HiddenDocumentMeshBase^ doc, 
	DirectionBase^ dirZ, 
...
static member TemperaryRacewayGeometry : 
        ...
        dirZ : DirectionBase * 
        matO : OMatrix * 
        bAddDoc : bool -> RacewayGeometryForRBEInMeshFree 
...
#### Return Value
Type: <a href="4bbe6eef-65a5-cf34-f6f1-dc8d0cf1fb88">RacewayGeometryForRBEInMeshFree</a><br />
