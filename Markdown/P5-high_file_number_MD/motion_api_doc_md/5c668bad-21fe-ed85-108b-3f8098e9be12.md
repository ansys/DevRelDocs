# ContactStandard.DynFriCoef Property 
...
**VB**<br />
``` VB
Public Property DynFriCoef As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable DynFriCoef {
...
**F#**<br />
``` F#
member DynFriCoef : ExpressionValueVariable with get, set
