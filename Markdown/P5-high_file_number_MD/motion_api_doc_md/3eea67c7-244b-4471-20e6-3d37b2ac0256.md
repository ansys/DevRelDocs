# BeamGroup.RestoretoStraight Property 
...
**VB**<br />
``` VB
Public Property RestoretoStraight As Boolean
	Get
	Set
```
...
``` C++
public:
property bool RestoretoStraight {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member RestoretoStraight : bool with get, set
