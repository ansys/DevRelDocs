...
**VB**<br />
``` VB
Public Property TransCY As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable TransCY {
...
**F#**<br />
``` F#
member TransCY : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The translational damping coefficient of y direction.
