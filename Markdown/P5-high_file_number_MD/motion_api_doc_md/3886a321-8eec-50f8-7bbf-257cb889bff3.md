# PropertyShaftSetBase.GetPowerLoadPoint Method 
...
**VB**<br />
``` VB
Public Function GetPowerLoadPoint As List(Of Vector)
```

**C++**<br />
``` C++
public:
List<Vector^>^ GetPowerLoadPoint()
```

**F#**<br />
``` F#
member GetPowerLoadPoint : unit -> List<Vector> 
