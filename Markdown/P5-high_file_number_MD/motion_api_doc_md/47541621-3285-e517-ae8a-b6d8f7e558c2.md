# ILinkContainerEvent.ILinkEventBuilder.CreatePreLinkEvent Method 
...
**C#**<br />
``` C#
EventHandler<LinkEventArgs> CreatePreLinkEvent(
	Object obj
)
```
