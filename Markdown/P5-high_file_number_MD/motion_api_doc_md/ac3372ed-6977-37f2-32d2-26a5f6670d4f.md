# Settings.CenterMainKey2 Property 
...
**VB**<br />
``` VB
Public Property CenterMainKey2 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys CenterMainKey2 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member CenterMainKey2 : NavigationKeys with get, set

```


#### Property Value
Type: <a href="204b8288-54ed-0f04-781f-a87360fd4b0d">NavigationKeys</a><br />First key for the view center.
