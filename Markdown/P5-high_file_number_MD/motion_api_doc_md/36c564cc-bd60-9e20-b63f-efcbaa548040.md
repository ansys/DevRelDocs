# ProfileSprocketBase.m_lstPtWorkPlane Field
...
**VB**<br />
``` VB
Protected m_lstPtWorkPlane As List(Of VectorBase)
```

**C++**<br />
``` C++
protected:
List<VectorBase^>^ m_lstPtWorkPlane
```

**F#**<br />
``` F#
val mutable m_lstPtWorkPlane: List<VectorBase>
```
