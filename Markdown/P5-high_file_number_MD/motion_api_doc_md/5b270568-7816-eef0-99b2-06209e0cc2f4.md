# Settings.MesherCorePath Property 
...
**VB**<br />
``` VB
Public ReadOnly Property MesherCorePath As String
	Get
```
...
``` C++
public:
property String^ MesherCorePath {
	String^ get ();
}
```
...
**F#**<br />
``` F#
member MesherCorePath : string with get

```


#### Property Value
Type: String<br />The VMMesherCore.dll path.
