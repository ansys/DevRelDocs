...
**VB**<br />
``` VB
Public Event OnChildRemoved As EventHandler(Of DocumentEventArgs)
```

**C++**<br />
``` C++
public:
 event EventHandler<DocumentEventArgs^>^ OnChildRemoved {
...
**F#**<br />
``` F#
member OnChildRemoved : IEvent<EventHandler<DocumentEventArgs>,
    DocumentEventArgs>
