# PropertySixMotion.RotationalYProperty Property 
...
**VB**<br />
``` VB
Public Property RotationalYProperty As PropertyRevolute
	Get
	Set
```
...
``` C++
public:
property PropertyRevolute^ RotationalYProperty {
...
**F#**<br />
``` F#
member RotationalYProperty : PropertyRevolute with get, set
