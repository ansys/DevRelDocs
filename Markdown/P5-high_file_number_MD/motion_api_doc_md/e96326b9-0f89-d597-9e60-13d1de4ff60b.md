# NTSF.StictionVelocity Property 
...
**VB**<br />
``` VB
Public Property StictionVelocity As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable StictionVelocity {
...
**F#**<br />
``` F#
member StictionVelocity : ExpressionValueVariable with get, set
