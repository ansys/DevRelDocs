# Document.OnClearSelectNavigator Event
...
**VB**<br />
``` VB
Public Event OnClearSelectNavigator As EventHandler(Of DocumentEventArgs)
```

**C++**<br />
``` C++
public:
 event EventHandler<DocumentEventArgs^>^ OnClearSelectNavigator {
...
**F#**<br />
``` F#
member OnClearSelectNavigator : IEvent<EventHandler<DocumentEventArgs>,
    DocumentEventArgs>
