# SetEdge.GetCenterPositionDirectionImpl Method 
...
**C#**<br />
``` C#
protected override void GetCenterPositionDirectionImpl(
	uint index,
...
**VB**<br />
``` VB
Protected Overrides Sub GetCenterPositionDirectionImpl ( 
	index As UInteger,
