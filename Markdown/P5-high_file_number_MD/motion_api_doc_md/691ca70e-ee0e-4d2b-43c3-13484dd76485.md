# Settings.RotateSubKey1 Property 
...
**VB**<br />
``` VB
Public Property RotateSubKey1 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys RotateSubKey1 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member RotateSubKey1 : NavigationKeys with get, set
