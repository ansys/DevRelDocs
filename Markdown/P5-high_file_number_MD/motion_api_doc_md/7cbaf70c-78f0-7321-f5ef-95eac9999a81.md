# PowerFlow.InputPowerValue Property 
...
**VB**<br />
``` VB
Public Property InputPowerValue As Double
	Get
	Set
```
...
``` C++
public:
property double InputPowerValue {
	double get ();
...
**F#**<br />
``` F#
member InputPowerValue : float with get, set

```


#### Property Value
Type: Double<br />The input power.
