# Configuration.IsIncludeEigenvalue Property 
...
**VB**<br />
``` VB
Public Property IsIncludeEigenvalue As Boolean
	Get
	Set
```
...
``` C++
public:
property bool IsIncludeEigenvalue {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member IsIncludeEigenvalue : bool with get, set

```


#### Property Value
Type: Boolean<br />`true` if [include eigenvalue]; otherwise, `false`.
