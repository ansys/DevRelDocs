# Application.OpenTemplateBasedDocument Method 
...
**C#**<br />
``` C#
public Document3D OpenTemplateBasedDocument(
	string strFilePath,
...
**VB**<br />
``` VB
Public Function OpenTemplateBasedDocument ( 
...
``` C++
public:
Document3D^ OpenTemplateBasedDocument(
	String^ strFilePath, 
	Application.DocumentType type, 
...
**F#**<br />
``` F#
member OpenTemplateBasedDocument : 
        strFilePath : string * 
