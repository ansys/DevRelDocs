# Settings.TranslateMainKey3 Property 
...
**VB**<br />
``` VB
Public Property TranslateMainKey3 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys TranslateMainKey3 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member TranslateMainKey3 : NavigationKeys with get, set
