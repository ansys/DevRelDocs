# Settings.MFInterfacePath Property 
...
**VB**<br />
``` VB
Public ReadOnly Property MFInterfacePath As String
	Get
```
...
``` C++
public:
property String^ MFInterfacePath {
	String^ get ();
}
```
...
**F#**<br />
``` F#
member MFInterfacePath : string with get

```


#### Property Value
Type: String<br />The MF_Interface.dll.
