# Settings.CenterSubKey4 Property 
...
**VB**<br />
``` VB
Public Property CenterSubKey4 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys CenterSubKey4 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member CenterSubKey4 : NavigationKeys with get, set
