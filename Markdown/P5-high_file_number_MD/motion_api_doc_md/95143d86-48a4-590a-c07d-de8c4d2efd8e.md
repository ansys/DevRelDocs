# LinkDataBase.LinkPitch Property 
...
**VB**<br />
``` VB
Public Property LinkPitch As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable LinkPitch {
...
**F#**<br />
``` F#
member LinkPitch : ExpressionValueVariable with get, set
