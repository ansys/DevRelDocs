# CLoadStandard.CLoadFunctionTY Property 
...
**VB**<br />
``` VB
Public Property CLoadFunctionTY As CLoadStandard.CLoadFunction
	Get
	Set
```
...
``` C++
public:
property CLoadStandard.CLoadFunction^ CLoadFunctionTY {
...
**F#**<br />
``` F#
member CLoadFunctionTY : CLoadStandard.CLoadFunction with get, set

```


#### Property Value
Type: <a href="51d60eff-e4d7-b5ee-11ce-fef7adfcd0c3">CLoadStandard.CLoadFunction</a><br />The rotational Y coordinate function.
