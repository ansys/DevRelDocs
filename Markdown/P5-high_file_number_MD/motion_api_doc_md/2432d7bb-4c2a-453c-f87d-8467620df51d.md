# Settings.TranslateSubKey1 Property 
...
**VB**<br />
``` VB
Public Property TranslateSubKey1 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys TranslateSubKey1 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member TranslateSubKey1 : NavigationKeys with get, set
