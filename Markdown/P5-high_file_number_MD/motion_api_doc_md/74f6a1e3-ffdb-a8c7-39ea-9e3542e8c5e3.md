# Settings.MeshfreePreprocessorPath Property 
...
**VB**<br />
``` VB
Public ReadOnly Property MeshfreePreprocessorPath As String
	Get
```
...
``` C++
public:
property String^ MeshfreePreprocessorPath {
	String^ get ();
}
```
...
**F#**<br />
``` F#
member MeshfreePreprocessorPath : string with get

```


#### Property Value
Type: String<br />The MeshfreePreprocessorPath.exe path.
