# ContactStandard.StiffOrder Property 
...
**VB**<br />
``` VB
Public Property StiffOrder As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable StiffOrder {
...
**F#**<br />
``` F#
member StiffOrder : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The stiffness order.
