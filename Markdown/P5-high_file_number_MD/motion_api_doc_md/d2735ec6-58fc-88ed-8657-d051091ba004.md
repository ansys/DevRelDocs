# PropertyHousingBase.IsAvaiableToAddOrModifyCrossHelicalGearWithAxis Method 
...
**C#**<br />
``` C#
public bool IsAvaiableToAddOrModifyCrossHelicalGearWithAxis(
...
**VB**<br />
``` VB
Public Function IsAvaiableToAddOrModifyCrossHelicalGearWithAxis ( 
...
``` C++
public:
bool IsAvaiableToAddOrModifyCrossHelicalGearWithAxis(
	GearTrainDocument^ docGT, 
	String^ strExistShaftsetName, 
	VectorBase^ vecPoint, 
	VectorBase^ vecAxis, 
...
**F#**<br />
``` F#
member IsAvaiableToAddOrModifyCrossHelicalGearWithAxis : 
