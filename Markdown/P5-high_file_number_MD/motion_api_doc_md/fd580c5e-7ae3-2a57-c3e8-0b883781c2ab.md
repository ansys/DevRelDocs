# CLoadStandard.FunctionFZ Property 
...
``` VB
<ObsoleteAttribute>
Public Property FunctionFZ As CLoadStandard.CLoadFunction
	Get
	Set
```
...
public:
[ObsoleteAttribute]
property CLoadStandard.CLoadFunction^ FunctionFZ {
...
``` F#
[<ObsoleteAttribute>]
member FunctionFZ : CLoadStandard.CLoadFunction with get, set
