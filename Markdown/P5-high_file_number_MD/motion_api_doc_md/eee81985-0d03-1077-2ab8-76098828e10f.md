# Settings.AdditionalPythonLibPath Property 
...
**VB**<br />
``` VB
Public ReadOnly Property AdditionalPythonLibPath As IEnumerable(Of String)
	Get
```
...
``` C++
public:
property IEnumerable<String^>^ AdditionalPythonLibPath {
...
**F#**<br />
``` F#
member AdditionalPythonLibPath : IEnumerable<string> with get
