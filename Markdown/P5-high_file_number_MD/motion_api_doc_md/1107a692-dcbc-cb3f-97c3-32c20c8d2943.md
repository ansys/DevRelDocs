# Settings.TextEditorArgument Property 
...
**VB**<br />
``` VB
Public Property TextEditorArgument As String
	Get
	Set
```
...
``` C++
public:
property String^ TextEditorArgument {
	String^ get ();
...
**F#**<br />
``` F#
member TextEditorArgument : string with get, set
