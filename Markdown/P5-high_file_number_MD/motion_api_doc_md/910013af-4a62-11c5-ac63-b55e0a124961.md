# Settings.TranslateSubKey2 Property 
...
**VB**<br />
``` VB
Public Property TranslateSubKey2 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys TranslateSubKey2 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member TranslateSubKey2 : NavigationKeys with get, set
