# OperationBase.SkipClearTemporaryLinkContainer Property 
...
**VB**<br />
``` VB
Public Property SkipClearTemporaryLinkContainer As Boolean
	Get
	Set
```
...
``` C++
public:
property bool SkipClearTemporaryLinkContainer {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member SkipClearTemporaryLinkContainer : bool with get, set
