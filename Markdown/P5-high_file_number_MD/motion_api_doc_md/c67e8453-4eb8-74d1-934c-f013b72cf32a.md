# EigenvalueAnalysisParameter.IsUseBound Property 
...
**VB**<br />
``` VB
Public Property IsUseBound As Boolean
	Get
	Set
```
...
**F#**<br />
``` F#
member IsUseBound : bool with get, set

```


#### Property Value
Type: Boolean<br />`true` if [use bound]; otherwise, `false`.
