# PropertyBush.TransCType Property 
...
``` VB
<ObsoleteAttribute>
Public ReadOnly Property TransCType As PropertyBush.InputType
	Get
```
...
public:
[ObsoleteAttribute]
property PropertyBush.InputType TransCType {
...
``` F#
[<ObsoleteAttribute>]
member TransCType : PropertyBush.InputType with get

```


#### Property Value
Type: <a href="e0c421fe-e473-4933-fa8c-ec3972bb297e">PropertyBush.InputType</a><br />The input type of the translational damping.
