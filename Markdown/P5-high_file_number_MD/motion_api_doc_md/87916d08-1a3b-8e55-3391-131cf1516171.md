# PropertyBoundaryConditionBase.ElementRZ Property 
...
**VB**<br />
``` VB
Public Property ElementRZ As CompositeFieldUsable
	Get
	Set
```
...
``` C++
public:
property CompositeFieldUsable^ ElementRZ {
...
**F#**<br />
``` F#
member ElementRZ : CompositeFieldUsable with get, set
