# Settings.UseDefaultTemp Property 
...
**VB**<br />
``` VB
Public Property UseDefaultTemp As Boolean
	Get
	Set
```
...
**F#**<br />
``` F#
member UseDefaultTemp : bool with get, set

```


#### Property Value
Type: Boolean<br />`true` if [use default temp path]; otherwise, `false`.
