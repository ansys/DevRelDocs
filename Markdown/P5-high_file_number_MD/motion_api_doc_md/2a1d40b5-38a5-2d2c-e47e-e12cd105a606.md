# Configuration.UseSolvingSpeedOption Property 
...
**VB**<br />
``` VB
Public Property UseSolvingSpeedOption As Boolean
	Get
	Set
```
...
``` C++
public:
property bool UseSolvingSpeedOption {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member UseSolvingSpeedOption : bool with get, set

```


#### Property Value
Type: Boolean<br />`true` if [solving speed option]; otherwise, `false`.
