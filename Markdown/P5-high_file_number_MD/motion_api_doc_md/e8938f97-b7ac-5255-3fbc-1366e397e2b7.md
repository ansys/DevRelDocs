# PropertySixMotion.UseTranslationalYProperty Property 
...
**VB**<br />
``` VB
Public Property UseTranslationalYProperty As Boolean
	Get
	Set
```
...
``` C++
public:
property bool UseTranslationalYProperty {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member UseTranslationalYProperty : bool with get, set
...
#### Property Value
Type: Boolean<br />
The translational y property use flag.
