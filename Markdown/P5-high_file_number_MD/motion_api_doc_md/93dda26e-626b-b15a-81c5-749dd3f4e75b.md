# Document.UpdateAllItemInNavigaterForUndoRedo Method 
...
**VB**<br />
``` VB
Public Sub UpdateAllItemInNavigaterForUndoRedo
```

**C++**<br />
``` C++
public:
void UpdateAllItemInNavigaterForUndoRedo()
```

**F#**<br />
``` F#
member UpdateAllItemInNavigaterForUndoRedo : unit -> unit 
