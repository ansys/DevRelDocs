# Document.OnChildRootSelect Event
...
**VB**<br />
``` VB
Public Event OnChildRootSelect As EventHandler(Of DocumentEventArgs)
```

**C++**<br />
``` C++
public:
 event EventHandler<DocumentEventArgs^>^ OnChildRootSelect {
...
**F#**<br />
``` F#
member OnChildRootSelect : IEvent<EventHandler<DocumentEventArgs>,
    DocumentEventArgs>
