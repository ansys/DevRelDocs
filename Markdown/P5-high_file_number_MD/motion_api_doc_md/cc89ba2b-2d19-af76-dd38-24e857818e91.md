...
public class PropertyCYTMC : PropertyContact2Dot5D
```

**VB**<br />
``` VB
<SerializableAttribute>
Public Class PropertyCYTMC
...
``` C++
[SerializableAttribute]
public ref class PropertyCYTMC : public PropertyContact2Dot5D
```
...
The PropertyCYTMC type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="d17e58de-b035-2811-d9a5-f527dcc6a656">PropertyCYTMC</a></td><td>
Initializes a new instance of the PropertyCYTMC class.</td></tr></table>&nbsp;
<a href="#propertycytmc-class">Back to Top</a>
