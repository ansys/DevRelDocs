# PropertyBush.PreTorqueY Property 
...
**VB**<br />
``` VB
Public Property PreTorqueY As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable PreTorqueY {
...
**F#**<br />
``` F#
member PreTorqueY : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The pre torque of y direction.
