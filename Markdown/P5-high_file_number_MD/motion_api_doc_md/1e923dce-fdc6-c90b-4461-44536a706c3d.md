# IChainedSegmentInfo.GetConnectors Method 
...
**VB**<br />
``` VB
Function GetConnectors As ObjectBase()
```

**C++**<br />
``` C++
array<ObjectBase^>^ GetConnectors()
```

**F#**<br />
``` F#
abstract GetConnectors : unit -> ObjectBase[] 

```


#### Return Value
Type: <a href="e4ef36d2-6ffe-3d20-3215-f6ddb4918c59">ObjectBase</a>[]<br />The array of connectors(Body,NodeSet,FaceSet,PatchSet).
