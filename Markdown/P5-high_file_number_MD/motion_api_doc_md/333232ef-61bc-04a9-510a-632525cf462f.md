# PowerFlow.InputEndSpeedValue Property 
...
**VB**<br />
``` VB
Public Property InputEndSpeedValue As Double
	Get
	Set
```
...
``` C++
public:
property double InputEndSpeedValue {
	double get ();
...
**F#**<br />
``` F#
member InputEndSpeedValue : float with get, set

```


#### Property Value
Type: Double<br />The input end speed.
