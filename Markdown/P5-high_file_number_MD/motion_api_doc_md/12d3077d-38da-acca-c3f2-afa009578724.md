# SimulationConfiguration.IsUseMotionStep Property 
...
**VB**<br />
``` VB
Public Property IsUseMotionStep As Boolean
	Get
	Set
```
...
**F#**<br />
``` F#
member IsUseMotionStep : bool with get, set
