# ContactStandard.StiffPerContactArea Property 
...
**VB**<br />
``` VB
Public Property StiffPerContactArea As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable StiffPerContactArea {
...
**F#**<br />
``` F#
member StiffPerContactArea : ExpressionValueVariable with get, set

```


#### Property Value
Type: ExpressionValueVariable<br />The stiffness per contact area.
