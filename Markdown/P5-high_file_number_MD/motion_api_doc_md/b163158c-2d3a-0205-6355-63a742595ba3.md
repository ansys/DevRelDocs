# CLoadStandard.CLoadFunctionFX Property 
...
**VB**<br />
``` VB
Public Property CLoadFunctionFX As CLoadStandard.CLoadFunction
	Get
	Set
```
...
``` C++
public:
property CLoadStandard.CLoadFunction^ CLoadFunctionFX {
...
**F#**<br />
``` F#
member CLoadFunctionFX : CLoadStandard.CLoadFunction with get, set

```


#### Property Value
Type: <a href="51d60eff-e4d7-b5ee-11ce-fef7adfcd0c3">CLoadStandard.CLoadFunction</a><br />The translational X coordinate function.
