# BallPlacing.ShiftOfStartPosition Property 
...
**VB**<br />
``` VB
Public Property ShiftOfStartPosition As ExpressionValueVariable
	Get
	Set
```
...
``` C++
public:
property ExpressionValueVariable ShiftOfStartPosition {
...
**F#**<br />
``` F#
member ShiftOfStartPosition : ExpressionValueVariable with get, set
