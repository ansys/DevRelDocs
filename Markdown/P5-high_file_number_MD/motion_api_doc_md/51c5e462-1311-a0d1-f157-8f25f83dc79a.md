# CouplerBase(*TProperty*).Joint2 Property 
...
**VB**<br />
``` VB
Public Property Joint2 As ObjectBase
	Get
	Set
```
...
**F#**<br />
``` F#
member Joint2 : ObjectBase with get, set

```


#### Property Value
Type: <a href="e4ef36d2-6ffe-3d20-3215-f6ddb4918c59">ObjectBase</a><br />The second joint.
