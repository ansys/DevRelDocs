# SubSystemDocument.ChangeOldFilePath Property 
...
``` VB
<ObsoleteAttribute>
Public Property ChangeOldFilePath As String
	Get
	Set
```
...
public:
[ObsoleteAttribute]
property String^ ChangeOldFilePath {
	String^ get ();
...
``` F#
[<ObsoleteAttribute>]
member ChangeOldFilePath : string with get, set

```


#### Property Value
Type: String<br />The change old file path.
