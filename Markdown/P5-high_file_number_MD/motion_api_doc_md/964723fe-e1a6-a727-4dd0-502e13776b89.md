# CreateConstraint.CreateFixedToGround Method 
...
**C#**<br />
``` C#
public static Fixed CreateFixedToGround(
...
**VB**<br />
``` VB
Public Shared Function CreateFixedToGround ( 
...
``` C++
public:
static Fixed^ CreateFixedToGround(
	Document3D^ activeDocument, 
	IConnectable^ actionConnectable, 
	PointBase^ ptOrigin, 
	String^ strPrefixName
...
**F#**<br />
``` F#
static member CreateFixedToGround : 
