# Settings.ZoomMainKey1 Property 
...
**VB**<br />
``` VB
Public Property ZoomMainKey1 As NavigationKeys
	Get
	Set
```
...
``` C++
public:
property NavigationKeys ZoomMainKey1 {
	NavigationKeys get ();
...
**F#**<br />
``` F#
member ZoomMainKey1 : NavigationKeys with get, set
