# SimulationConfiguration.IncludeStatic Property 
...
**VB**<br />
``` VB
Public Property IncludeStatic As Boolean
	Get
	Set
```
...
**F#**<br />
``` F#
member IncludeStatic : bool with get, set
