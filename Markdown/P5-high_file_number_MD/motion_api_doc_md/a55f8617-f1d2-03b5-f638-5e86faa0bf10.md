# Settings.UseAutoCreateOK Property 
...
**VB**<br />
``` VB
Public Property UseAutoCreateOK As Boolean
	Get
	Set
```
...
**F#**<br />
``` F#
member UseAutoCreateOK : bool with get, set

```


#### Property Value
Type: Boolean<br />`true` if [use auto ok]; otherwise, `false`.
