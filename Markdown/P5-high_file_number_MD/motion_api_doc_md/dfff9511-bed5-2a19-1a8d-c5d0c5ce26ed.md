# GenerateDataForChainedPlacing.Initialize_SegmentList Method 
...
**VB**<br />
``` VB
Public Sub Initialize_SegmentList
```

**C++**<br />
``` C++
public:
void Initialize_SegmentList()
```

**F#**<br />
``` F#
member Initialize_SegmentList : unit -> unit 
