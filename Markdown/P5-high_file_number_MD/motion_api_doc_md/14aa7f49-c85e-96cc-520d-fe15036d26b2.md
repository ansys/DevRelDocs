# Body.GetDefaultMaxFacetSize Method 
...
**VB**<br />
``` VB
Public Function GetDefaultMaxFacetSize As Double
```

**C++**<br />
``` C++
public:
double GetDefaultMaxFacetSize()
```

**F#**<br />
``` F#
member GetDefaultMaxFacetSize : unit -> float 

```


#### Return Value
Type: Double<br />Default maximum facet size
