# PropertyBush.TranslationalOneSideBushingY Property 
...
**VB**<br />
``` VB
Public Property TranslationalOneSideBushingY As Boolean
	Get
	Set
```
...
``` C++
public:
property bool TranslationalOneSideBushingY {
	bool get ();
	void set (bool value);
}
```
...
**F#**<br />
``` F#
member TranslationalOneSideBushingY : bool with get, set

```


#### Property Value
Type: Boolean<br />The flag of translational one side bushing Y.
