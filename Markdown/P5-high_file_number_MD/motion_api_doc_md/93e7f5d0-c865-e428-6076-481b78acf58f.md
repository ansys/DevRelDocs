# SimulationConfiguration.IsUseExportICF Property 
...
**VB**<br />
``` VB
Public Property IsUseExportICF As Boolean
	Get
	Set
```
...
**F#**<br />
``` F#
member IsUseExportICF : bool with get, set

```


#### Property Value
Type: Boolean<br />`true` if this instance is use export ICF; otherwise, `false`.
