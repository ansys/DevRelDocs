...
### *class* ansys.meshing.prime.VolumeNamingType(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`VolumeNamingType.as_integer_ratio`](ansys.meshing.prime.VolumeNamingType.as_integer_ratio.md#ansys.meshing.prime.VolumeNamingType.as_integer_ratio)(/)   | Return integer ratio.                                                      |
|------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
