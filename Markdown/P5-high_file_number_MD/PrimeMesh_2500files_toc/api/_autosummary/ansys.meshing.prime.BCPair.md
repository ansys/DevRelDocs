...
| [`BCPair.print_default`](ansys.meshing.prime.BCPair.print_default.md#ansys.meshing.prime.BCPair.print_default)()                | Print the default values of BCPair.   |
|---------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|
| [`BCPair.set_default`](ansys.meshing.prime.BCPair.set_default.md#ansys.meshing.prime.BCPair.set_default)([source_zonelet, ...]) | Set the default values of BCPair.     |
