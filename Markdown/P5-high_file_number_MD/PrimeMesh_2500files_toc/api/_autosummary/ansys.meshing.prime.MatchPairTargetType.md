...
### *class* ansys.meshing.prime.MatchPairTargetType(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`MatchPairTargetType.as_integer_ratio`](ansys.meshing.prime.MatchPairTargetType.as_integer_ratio.md#ansys.meshing.prime.MatchPairTargetType.as_integer_ratio)(/)   | Return integer ratio.                                                      |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
