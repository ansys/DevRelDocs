...
### *class* ansys.meshing.prime.FlowDirection(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`FlowDirection.as_integer_ratio`](ansys.meshing.prime.FlowDirection.as_integer_ratio.md#ansys.meshing.prime.FlowDirection.as_integer_ratio)(/)   | Return integer ratio.                                                      |
|---------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
