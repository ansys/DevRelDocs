...
| [`FixInvalidNormalNodeParams.print_default`](ansys.meshing.prime.FixInvalidNormalNodeParams.print_default.md#ansys.meshing.prime.FixInvalidNormalNodeParams.print_default)()   | Print the default values of FixInvalidNormalNodeParams.   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|
| [`FixInvalidNormalNodeParams.set_default`](ansys.meshing.prime.FixInvalidNormalNodeParams.set_default.md#ansys.meshing.prime.FixInvalidNormalNodeParams.set_default)([...])    | Set the default values of FixInvalidNormalNodeParams.     |
