...
### *class* ansys.meshing.prime.PartCreationType(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`PartCreationType.as_integer_ratio`](ansys.meshing.prime.PartCreationType.as_integer_ratio.md#ansys.meshing.prime.PartCreationType.as_integer_ratio)(/)   | Return integer ratio.                                                      |
|------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
