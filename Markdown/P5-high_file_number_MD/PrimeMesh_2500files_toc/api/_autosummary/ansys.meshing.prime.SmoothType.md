...
### *class* ansys.meshing.prime.SmoothType(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`SmoothType.as_integer_ratio`](ansys.meshing.prime.SmoothType.as_integer_ratio.md#ansys.meshing.prime.SmoothType.as_integer_ratio)(/)        | Return integer ratio.                                                      |
|-----------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
