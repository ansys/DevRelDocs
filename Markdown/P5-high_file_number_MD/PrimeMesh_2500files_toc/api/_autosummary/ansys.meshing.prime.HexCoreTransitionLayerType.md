...
### *class* ansys.meshing.prime.HexCoreTransitionLayerType(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`HexCoreTransitionLayerType.as_integer_ratio`](ansys.meshing.prime.HexCoreTransitionLayerType.as_integer_ratio.md#ansys.meshing.prime.HexCoreTransitionLayerType.as_integer_ratio)(/)   | Return integer ratio.                                                      |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
