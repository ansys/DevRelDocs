...
| [`SurfaceQualityResult.print_default`](ansys.meshing.prime.SurfaceQualityResult.print_default.md#ansys.meshing.prime.SurfaceQualityResult.print_default)()   | Print the default values of SurfaceQualityResult.   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|
| [`SurfaceQualityResult.set_default`](ansys.meshing.prime.SurfaceQualityResult.set_default.md#ansys.meshing.prime.SurfaceQualityResult.set_default)([...])    | Set the default values of SurfaceQualityResult.     |
