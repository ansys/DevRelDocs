...
| [`OverlapPairs.print_default`](ansys.meshing.prime.OverlapPairs.print_default.md#ansys.meshing.prime.OverlapPairs.print_default)()               | Print the default values of OverlapPairs.   |
|--------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|
| [`OverlapPairs.set_default`](ansys.meshing.prime.OverlapPairs.set_default.md#ansys.meshing.prime.OverlapPairs.set_default)([zone_id0, zone_id1]) | Set the default values of OverlapPairs.     |
