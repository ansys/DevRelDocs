...
### *class* ansys.meshing.prime.VolumeFillType(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`VolumeFillType.as_integer_ratio`](ansys.meshing.prime.VolumeFillType.as_integer_ratio.md#ansys.meshing.prime.VolumeFillType.as_integer_ratio)(/)   | Return integer ratio.                                                      |
|------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
