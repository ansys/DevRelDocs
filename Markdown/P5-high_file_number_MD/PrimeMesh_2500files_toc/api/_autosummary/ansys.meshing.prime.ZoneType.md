...
### *class* ansys.meshing.prime.ZoneType(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`ZoneType.as_integer_ratio`](ansys.meshing.prime.ZoneType.as_integer_ratio.md#ansys.meshing.prime.ZoneType.as_integer_ratio)(/)        | Return integer ratio.                                                      |
|-----------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
