...
| [`DeleteVolumesResults.print_default`](ansys.meshing.prime.DeleteVolumesResults.print_default.md#ansys.meshing.prime.DeleteVolumesResults.print_default)()   | Print the default values of DeleteVolumesResults.   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|
| [`DeleteVolumesResults.set_default`](ansys.meshing.prime.DeleteVolumesResults.set_default.md#ansys.meshing.prime.DeleteVolumesResults.set_default)([...])    | Set the default values of DeleteVolumesResults.     |
