...
| [`IGAResults.print_default`](ansys.meshing.prime.IGAResults.print_default.md#ansys.meshing.prime.IGAResults.print_default)()            | Print the default values of IGAResults.   |
|-----------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|
| [`IGAResults.set_default`](ansys.meshing.prime.IGAResults.set_default.md#ansys.meshing.prime.IGAResults.set_default)([error_code, ...]) | Set the default values of IGAResults.     |
