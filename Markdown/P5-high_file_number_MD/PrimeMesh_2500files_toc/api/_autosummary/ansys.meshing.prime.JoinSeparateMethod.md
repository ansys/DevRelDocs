...
### *class* ansys.meshing.prime.JoinSeparateMethod(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`JoinSeparateMethod.as_integer_ratio`](ansys.meshing.prime.JoinSeparateMethod.as_integer_ratio.md#ansys.meshing.prime.JoinSeparateMethod.as_integer_ratio)(/)   | Return integer ratio.                                                      |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
