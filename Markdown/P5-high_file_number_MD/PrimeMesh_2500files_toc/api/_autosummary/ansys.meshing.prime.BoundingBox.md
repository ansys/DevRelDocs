...
| [`BoundingBox.print_default`](ansys.meshing.prime.BoundingBox.print_default.md#ansys.meshing.prime.BoundingBox.print_default)()                  | Print the default values of BoundingBox.   |
|--------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|
| [`BoundingBox.set_default`](ansys.meshing.prime.BoundingBox.set_default.md#ansys.meshing.prime.BoundingBox.set_default)([xmin, ymin, zmin, ...]) | Set the default values of BoundingBox.     |
