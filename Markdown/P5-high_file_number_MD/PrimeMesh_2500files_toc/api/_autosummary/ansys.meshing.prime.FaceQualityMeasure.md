...
### *class* ansys.meshing.prime.FaceQualityMeasure(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`FaceQualityMeasure.as_integer_ratio`](ansys.meshing.prime.FaceQualityMeasure.as_integer_ratio.md#ansys.meshing.prime.FaceQualityMeasure.as_integer_ratio)(/)   | Return integer ratio.                                                      |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
