...
| [`SearchByFoldsResults.print_default`](ansys.meshing.prime.SearchByFoldsResults.print_default.md#ansys.meshing.prime.SearchByFoldsResults.print_default)()         | Print the default values of SearchByFoldsResults.   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|
| [`SearchByFoldsResults.set_default`](ansys.meshing.prime.SearchByFoldsResults.set_default.md#ansys.meshing.prime.SearchByFoldsResults.set_default)([n_found, ...]) | Set the default values of SearchByFoldsResults.     |
