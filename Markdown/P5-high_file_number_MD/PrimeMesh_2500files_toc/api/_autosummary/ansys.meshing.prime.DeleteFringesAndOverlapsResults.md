...
| [`DeleteFringesAndOverlapsResults.print_default`](ansys.meshing.prime.DeleteFringesAndOverlapsResults.print_default.md#ansys.meshing.prime.DeleteFringesAndOverlapsResults.print_default)()   | Print the default values of DeleteFringesAndOverlapsResults.   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|
| [`DeleteFringesAndOverlapsResults.set_default`](ansys.meshing.prime.DeleteFringesAndOverlapsResults.set_default.md#ansys.meshing.prime.DeleteFringesAndOverlapsResults.set_default)([...])    | Set the default values of DeleteFringesAndOverlapsResults.     |
