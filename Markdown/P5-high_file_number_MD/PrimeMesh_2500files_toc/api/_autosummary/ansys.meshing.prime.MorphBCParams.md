...
| [`MorphBCParams.print_default`](ansys.meshing.prime.MorphBCParams.print_default.md#ansys.meshing.prime.MorphBCParams.print_default)()   | Print the default values of MorphBCParams.   |
|-----------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|
| [`MorphBCParams.set_default`](ansys.meshing.prime.MorphBCParams.set_default.md#ansys.meshing.prime.MorphBCParams.set_default)([...])    | Set the default values of MorphBCParams.     |
