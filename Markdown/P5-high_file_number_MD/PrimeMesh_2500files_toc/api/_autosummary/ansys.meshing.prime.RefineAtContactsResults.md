...
| [`RefineAtContactsResults.print_default`](ansys.meshing.prime.RefineAtContactsResults.print_default.md#ansys.meshing.prime.RefineAtContactsResults.print_default)()   | Print the default values of RefineAtContactsResults.   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|
| [`RefineAtContactsResults.set_default`](ansys.meshing.prime.RefineAtContactsResults.set_default.md#ansys.meshing.prime.RefineAtContactsResults.set_default)([...])    | Set the default values of RefineAtContactsResults.     |
