...
### *class* ansys.meshing.prime.WrapRegion(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`WrapRegion.as_integer_ratio`](ansys.meshing.prime.WrapRegion.as_integer_ratio.md#ansys.meshing.prime.WrapRegion.as_integer_ratio)(/)        | Return integer ratio.                                                      |
|-----------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
