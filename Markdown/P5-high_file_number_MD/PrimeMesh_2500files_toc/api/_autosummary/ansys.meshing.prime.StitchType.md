...
### *class* ansys.meshing.prime.StitchType(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`StitchType.as_integer_ratio`](ansys.meshing.prime.StitchType.as_integer_ratio.md#ansys.meshing.prime.StitchType.as_integer_ratio)(/)        | Return integer ratio.                                                      |
|-----------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
