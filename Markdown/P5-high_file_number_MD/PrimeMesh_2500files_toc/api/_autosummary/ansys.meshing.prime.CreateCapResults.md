...
| [`CreateCapResults.print_default`](ansys.meshing.prime.CreateCapResults.print_default.md#ansys.meshing.prime.CreateCapResults.print_default)()            | Print the default values of CreateCapResults.   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|
| [`CreateCapResults.set_default`](ansys.meshing.prime.CreateCapResults.set_default.md#ansys.meshing.prime.CreateCapResults.set_default)([error_code, ...]) | Set the default values of CreateCapResults.     |
