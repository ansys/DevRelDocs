...
| [`MergePartsResults.print_default`](ansys.meshing.prime.MergePartsResults.print_default.md#ansys.meshing.prime.MergePartsResults.print_default)()            | Print the default values of MergePartsResults.   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|
| [`MergePartsResults.set_default`](ansys.meshing.prime.MergePartsResults.set_default.md#ansys.meshing.prime.MergePartsResults.set_default)([error_code, ...]) | Set the default values of MergePartsResults.     |
