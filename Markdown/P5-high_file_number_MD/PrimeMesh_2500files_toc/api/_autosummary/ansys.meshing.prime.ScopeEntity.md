...
### *class* ansys.meshing.prime.ScopeEntity(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`ScopeEntity.as_integer_ratio`](ansys.meshing.prime.ScopeEntity.as_integer_ratio.md#ansys.meshing.prime.ScopeEntity.as_integer_ratio)(/)   | Return integer ratio.                                                      |
|---------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
