...
| [`CreateZoneResults.print_default`](ansys.meshing.prime.CreateZoneResults.print_default.md#ansys.meshing.prime.CreateZoneResults.print_default)()            | Print the default values of CreateZoneResults.   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|
| [`CreateZoneResults.set_default`](ansys.meshing.prime.CreateZoneResults.set_default.md#ansys.meshing.prime.CreateZoneResults.set_default)([error_code, ...]) | Set the default values of CreateZoneResults.     |
