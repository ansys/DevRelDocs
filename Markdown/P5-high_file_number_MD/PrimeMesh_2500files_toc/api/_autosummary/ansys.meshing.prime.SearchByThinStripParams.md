...
| [`SearchByThinStripParams.print_default`](ansys.meshing.prime.SearchByThinStripParams.print_default.md#ansys.meshing.prime.SearchByThinStripParams.print_default)()   | Print the default values of SearchByThinStripParams.   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|
| [`SearchByThinStripParams.set_default`](ansys.meshing.prime.SearchByThinStripParams.set_default.md#ansys.meshing.prime.SearchByThinStripParams.set_default)([...])    | Set the default values of SearchByThinStripParams.     |
