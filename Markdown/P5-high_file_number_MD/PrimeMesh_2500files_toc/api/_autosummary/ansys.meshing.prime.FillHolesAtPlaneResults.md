...
| [`FillHolesAtPlaneResults.print_default`](ansys.meshing.prime.FillHolesAtPlaneResults.print_default.md#ansys.meshing.prime.FillHolesAtPlaneResults.print_default)()   | Print the default values of FillHolesAtPlaneResults.   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|
| [`FillHolesAtPlaneResults.set_default`](ansys.meshing.prime.FillHolesAtPlaneResults.set_default.md#ansys.meshing.prime.FillHolesAtPlaneResults.set_default)([...])    | Set the default values of FillHolesAtPlaneResults.     |
