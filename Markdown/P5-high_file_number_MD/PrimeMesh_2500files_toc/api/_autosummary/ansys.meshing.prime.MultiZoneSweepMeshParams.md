...
| [`MultiZoneSweepMeshParams.print_default`](ansys.meshing.prime.MultiZoneSweepMeshParams.print_default.md#ansys.meshing.prime.MultiZoneSweepMeshParams.print_default)()   | Print the default values of MultiZoneSweepMeshParams.   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|
| [`MultiZoneSweepMeshParams.set_default`](ansys.meshing.prime.MultiZoneSweepMeshParams.set_default.md#ansys.meshing.prime.MultiZoneSweepMeshParams.set_default)([...])    | Set the default values of MultiZoneSweepMeshParams.     |
