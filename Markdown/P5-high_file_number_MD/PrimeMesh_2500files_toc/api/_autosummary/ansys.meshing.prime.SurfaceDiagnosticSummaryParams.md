...
| [`SurfaceDiagnosticSummaryParams.print_default`](ansys.meshing.prime.SurfaceDiagnosticSummaryParams.print_default.md#ansys.meshing.prime.SurfaceDiagnosticSummaryParams.print_default)()   | Print the default values of SurfaceDiagnosticSummaryParams.   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|
| [`SurfaceDiagnosticSummaryParams.set_default`](ansys.meshing.prime.SurfaceDiagnosticSummaryParams.set_default.md#ansys.meshing.prime.SurfaceDiagnosticSummaryParams.set_default)([...])    | Set the default values of SurfaceDiagnosticSummaryParams.     |
