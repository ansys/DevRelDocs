...
### *class* ansys.meshing.prime.SizingType(value, names=None, \*, module=None, qualname=None, type=None, start=1, boundary=None)
...
| [`SizingType.as_integer_ratio`](ansys.meshing.prime.SizingType.as_integer_ratio.md#ansys.meshing.prime.SizingType.as_integer_ratio)(/)        | Return integer ratio.                                                      |
|-----------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
