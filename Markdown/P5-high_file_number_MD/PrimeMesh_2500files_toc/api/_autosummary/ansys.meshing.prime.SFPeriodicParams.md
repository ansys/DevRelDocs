...
| [`SFPeriodicParams.print_default`](ansys.meshing.prime.SFPeriodicParams.print_default.md#ansys.meshing.prime.SFPeriodicParams.print_default)()             | Print the default values of SFPeriodicParams.   |
|------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|
| [`SFPeriodicParams.set_default`](ansys.meshing.prime.SFPeriodicParams.set_default.md#ansys.meshing.prime.SFPeriodicParams.set_default)([axis, angle, ...]) | Set the default values of SFPeriodicParams.     |
