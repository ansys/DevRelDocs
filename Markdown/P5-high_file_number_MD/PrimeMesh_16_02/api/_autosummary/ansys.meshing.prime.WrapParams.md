...
| [`WrapParams.print_default`](ansys.meshing.prime.WrapParams.print_default.md#ansys.meshing.prime.WrapParams.print_default)()               | Print the default values of WrapParams.   |
|--------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|
| [`WrapParams.set_default`](ansys.meshing.prime.WrapParams.set_default.md#ansys.meshing.prime.WrapParams.set_default)([sizing_method, ...]) | Set the default values of WrapParams.     |
