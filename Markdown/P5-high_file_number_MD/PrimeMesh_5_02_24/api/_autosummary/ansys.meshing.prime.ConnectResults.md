...
| [`ConnectResults.print_default`](ansys.meshing.prime.ConnectResults.print_default.md#ansys.meshing.prime.ConnectResults.print_default)()            | Print the default values of ConnectResults.   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|
| [`ConnectResults.set_default`](ansys.meshing.prime.ConnectResults.set_default.md#ansys.meshing.prime.ConnectResults.set_default)([error_code, ...]) | Set the default values of ConnectResults.     |
