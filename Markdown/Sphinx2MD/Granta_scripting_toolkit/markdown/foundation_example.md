...
All examples use the MI Training database, available from the Ansys Download Center or the Download Software page on the
[Granta MI Support site](https://grantadesign.com/industry/support/granta-mi).
...
* [New Features in MI Scripting Toolkit v1.5](samples/foundation/Deleting_records_and_other_new_v1.5_features.md)
