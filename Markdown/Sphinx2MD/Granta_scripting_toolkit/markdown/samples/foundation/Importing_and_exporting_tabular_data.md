...
```
    ...
    Import-test@01/09/2023 15:58:06
...
```
    ...
    Use MI Viewer to view Import-test@01/09/2023 15:58:06 and check that the Order in 'Characterization of this material' is 1000
