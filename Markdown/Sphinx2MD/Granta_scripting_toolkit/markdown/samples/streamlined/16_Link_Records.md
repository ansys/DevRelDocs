...
```
    ...
    {'MaterialUniverse': {<Record long name: Soda barium glass>}, 'Smart Link to MaterialUniverse': {<Record long name: Barium silicate>, <Record long name: Lithium aluminosilicate>, <Record long name: Alumino silicate - 1723>, <Record long name: Soda barium glass>, <Record long name: Alumino silicate - 1720>}}
