...
<code>scopings_ids</code> should contain the following values: 2, 6, 17, 19.
...
<code>fields_indices</code> vector should contain the following values: 1, 5.
...
To know how to integrate DPF capabilities in already existing project, refer to the [Using DPF capabilities in an existing project](group__group__06__1.md#group__group__06__1) section.
