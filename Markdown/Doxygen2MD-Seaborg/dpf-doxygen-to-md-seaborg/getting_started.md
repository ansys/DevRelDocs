...
To learn more about integrating DPF capabilities into an already existing project, refer to the [Using DPF capabilities in an existing project](group__group__06__1.md#group__group__06__1) section.
...
* location {"type":"element","name":"location","attributes":{"file":"cpp_doc/00_getting_started.md"},"children":[]}
