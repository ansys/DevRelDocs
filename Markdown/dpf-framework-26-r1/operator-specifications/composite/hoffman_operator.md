...
# composite:hoffman_operator

**Version: 0.0.0**

## Description

Computes Hoffman for ElementalNodal data
 ...
 **Scripting name**: hoffman_operator

 **Full name**: composite.hoffman_operator

 **Internal name**: composite::hoffman_operator
