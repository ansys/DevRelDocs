...
| <strong>Pin 1</strong> | mesh_scoping |[`umap<int32,int32>`](../../core-concepts/dpf-types.md#umap<int32,int32>), [`scoping`](../../core-concepts/dpf-types.md#scoping), [`scopings_container`](../../core-concepts/dpf-types.md#scopings-container) | A space (mesh entities) scoping (or scopings container) to rescope / split the fields container given as input. |
...
| <strong>Pin 7</strong> | cutoff_fr |[`double`](../../core-concepts/dpf-types.md#double), [`int32`](../../core-concepts/dpf-types.md#standard-types) | Cutoff frequency. |
