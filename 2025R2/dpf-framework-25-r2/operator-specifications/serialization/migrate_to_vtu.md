...
| <strong>Pin 20</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span> | directory |[`string`](../../core-concepts/dpf-types.md#string) | directory path |
| <strong>Pin 21</strong> | base_name |[`string`](../../core-concepts/dpf-types.md#string) | vtu base file name, (default is file) |
| <strong>Pin 30</strong> | result |[`string`](../../core-concepts/dpf-types.md#string) | if Operator's names are connected to this Pin, only these results are exported (else all available results are exported) |
| <strong>Pin 100</strong> | write_mode |[`string`](../../core-concepts/dpf-types.md#string) | Available are rawbinarycompressed, rawbinary, base64appended, base64inline, ascii, default is (rawbinarycompressed) |
