...
| <strong>Pin 3</strong> | scale_forward_transform |[`double`](../../core-concepts/dpf-types.md#double) | Scale for Forward Transform, default is 2/field_num_elementary_data. |
...
| <strong>Pin 6</strong> | cutoff_frequency |[`double`](../../core-concepts/dpf-types.md#double) | Restrict output frequency up to this cutoff frequency |
