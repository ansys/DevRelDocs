...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span> | in_cms_rbd_file_path |[`string`](../../core-concepts/dpf-types.md#string) | file name with cms_rbd extension where to read the input cms_rbd file. |
