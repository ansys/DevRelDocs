...
| <strong>Pin 1</strong> | default_label |[`string`](../../core-concepts/dpf-types.md#string) | this default label is used if a new meshes container needs to be created (default is unknown) |
