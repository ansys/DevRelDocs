...
|-------|------|------------------|
|  **0**| [property](#output_0) |[`time_freq_support`](../../core-concepts/dpf-types.md#time-freq-support), [`scoping`](../../core-concepts/dpf-types.md#scoping) |


<a id="output_0"></a>
### property (Pin 0)

- **Expected type(s):** [`time_freq_support`](../../core-concepts/dpf-types.md#time-freq-support), [`scoping`](../../core-concepts/dpf-types.md#scoping)
...
my_property_as_time_freq_support = op.outputs.property_as_time_freq_support()
```
</details>
