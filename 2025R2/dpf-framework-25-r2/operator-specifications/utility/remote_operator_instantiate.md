...
| <strong>Pin 5</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span> | output_name |[`string`](../../core-concepts/dpf-types.md#string) | output's name of the workflow to return |
