...
| <strong>Pin 1</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  mode |[`string`](../../core-concepts/dpf-types.md#standard-types}}), [`char`](../../core-concepts/dpf-types.md#char) | zfp mode: fixed-rate ('r'), fixed-precision ('p'), fixed-accuracy ('a') |
