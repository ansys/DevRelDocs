...
| <strong>Pin 9</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span> | requested_location |[`string`](../../core-concepts/dpf-types.md#string) | location (default is elemental) |
...
| <strong>Pin 13</strong> | label |[`string`](../../core-concepts/dpf-types.md#string), [`vector<string>`](../../core-concepts/dpf-types.md#vector<string>) | properties to apply the filtering 'mat' and/or 'elshape' (default is 'elshape') |
