...
| <strong>Pin 2</strong> | default_value |[`double`](../../core-concepts/dpf-types.md#double), [`vector<double>`](../../core-concepts/dpf-types.md#standard-types) | If pin 2 is used, the IDs not found in the field are added with this default value. |
