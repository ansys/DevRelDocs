...
| <strong>Pin 21</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  abstract_field_support |[`abstract_field_support`](../../core-concepts/dpf-types.md#field-support) | The material support originating from an RST file. |
