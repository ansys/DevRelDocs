...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span> | invariant_fc_operator |[`string`](../../core-concepts/dpf-types.md#string) | Name of the invariant operator to be used to calculate filter (available: eqv_fc, invariants_deriv_fc, invariants_fc). |
...
| <strong>Pin 2</strong> | list_of_results |[`vector<string>`](../../core-concepts/dpf-types.md#vector<string>), [`string`](../../core-concepts/dpf-types.md#string) | If no result is given, filter will be applied on Stresses and Strains |
| <strong>Pin 3</strong> | threshold |[`double`](../../core-concepts/dpf-types.md#double) | Threshold from which the operator will filter. |
