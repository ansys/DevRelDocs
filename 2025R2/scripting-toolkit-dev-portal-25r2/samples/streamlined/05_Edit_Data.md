...
```output
(<Record long name: Scripting Toolkit Example 5:Thu May  8 23:33:18 2025>,
...
*Previous cell output:*
```output
Record Name: Scripting Toolkit Example 5:Thu May  8 23:33:18 2025, State: Unreleased
```
## 'Not Applicable' flag
...
*Previous cell output:*
```output
Record Name: "Scripting Toolkit Example 5:Thu May  8 23:33:18 2025", State: "Released"
```
...
*Previous cell output:*
```output
{'v1': <Record long name: Scripting Toolkit Example 5:Thu May  8 23:33:18 2025>}
```
...
```output
{'v1': <Record long name: Scripting Toolkit Example 5:Thu May  8 23:33:18 2025>,
 'v2': <Record long name: Scripting Toolkit Example 5:Thu May  8 23:33:18 2025>}
```
