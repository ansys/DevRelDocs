...
*Previous cell output:*
```output
Scripting toolkit foundation layer example 06:Thu Apr 24 22:58:24 2025
```
...
*Previous cell output:*
```output
Use MI Viewer to view Scripting toolkit foundation layer example 06:Thu Apr 24 22:58:24 2025 and check that the Order in 'Characterization of this material' is 1000
```