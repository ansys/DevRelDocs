...
#### GetAcceleration(unit: str | None = None)
...
#### GetFinalVelocity(unit: str | None = None)
...
#### SetAcceleration(values: Sequence[str | float], unit: str | None = None)
...
#### SetFinalVelocity(values: Sequence[str | float], unit: str | None = None)
