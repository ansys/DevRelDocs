...
```
An exception thrown when trying to set a value using an incompatible type, or when trying to 
 compare two values of incompatible types
**See Also:**
: [Serialized Form](../../../../serialized-form.html#com.phoenix_int.aserver.types.PHXTypeMismatchException)- ======== CONSTRUCTOR SUMMARY ========
- ### Constructor Summary

| Constructor and Description |
| --- |
| Constructor and Description |
| `PHXTypeMismatchException(java.lang.String givenType,
                        java.lang.String expectedType)`Create an exception for attempting to compare two values of incompatible types |
| `PHXTypeMismatchException(java.lang.String name,
                        java.lang.String type,
                        java.lang.String expectedType)`Create an exception for attempting to set a value using an incompatible type |
| `PHXTypeMismatchException(java.lang.String givenType,
                        java.lang.String expectedType,
                        java.lang.Throwable cause)`Create an exception for attempting to compare two values of incompatible types |
========== METHOD SUMMARY ===========
- ### Method Summary
