...
---
**Deprecated:** see `com.phoenix_int.pacz.api.v2.IInstanceFile`
...
|-------------------|----------------------|
| `java.lang.String` | `getName()`<br>**Deprecated.** Get name of instance file |
| `java.lang.String` | `getPath()`<br>**Deprecated.** Get path of instance file |
