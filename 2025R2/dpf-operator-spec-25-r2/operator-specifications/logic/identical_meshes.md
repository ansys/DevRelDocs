...
| <strong>Pin 2</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span> | small_value |[`double`](../../core-concepts/dpf-types.md#double) | define what is a small value for numeric comparison. |
| <strong>Pin 3</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span> | tolerance |[`double`](../../core-concepts/dpf-types.md#double) | define the relative tolerance ceil for numeric comparison. |
