...
| <strong>Pin 1</strong>|  component_priority_table |[`vector<int32>`](../../core-concepts/dpf-types#standard-types) | component priority table (vector of int) |
| <strong>Pin 2</strong>|  sort_by_scoping |[`bool`](../../core-concepts/dpf-types#standard-types) | if true, uses scoping to sort the field (default is false) |
