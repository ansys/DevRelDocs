...
| <strong>Pin 2</strong>|  default_value |[`double`](../../core-concepts/dpf-types#standard-types) | Set a default value for elementary data that do not exist. |
| <strong>Pin 3</strong>|  elementary_data_index_2 |[`int32`](../../core-concepts/dpf-types#standard-types), [`vector<int32>`](../../core-concepts/dpf-types#standard-types) | For field with nature matrix, this is the column indices to extract. |
