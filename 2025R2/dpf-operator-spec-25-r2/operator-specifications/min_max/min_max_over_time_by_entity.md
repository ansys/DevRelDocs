...
| <strong>Pin 3</strong>|  compute_absolute_value |[`bool`](./../../core-concepts/dpf-types#standard-types) | Calculate the absolute value of field entities before computing the min/max. |
| <strong>Pin 4</strong>|  compute_amplitude |[`bool`](./../../core-concepts/dpf-types#standard-types) | Do calculate amplitude. |
...
|-------|------|------------------|-------------|
|  **Pin 0**| min |[`fields_container`](./../../core-concepts/dpf-types#fields-container) |  |
|  **Pin 1**| max |[`fields_container`](./../../core-concepts/dpf-types#fields-container) |  |
|  **Pin 2**| time_freq_of_min |[`fields_container`](./../../core-concepts/dpf-types#fields-container) |  |
|  **Pin 3**| time_freq_of_max |[`fields_container`](./../../core-concepts/dpf-types#fields-container) |  |

## Configurations

| Name| Expected type(s) | Default value | Description |
|-----|------|----------|-------------|
| **incremental** |[`bool`](./../../core-concepts/dpf-types#standard-types) | true | This operator can be run several times with different inputs so that the output will take all the inputs of the different runs into account. It can be used to save memory. For example, a large time scoping can be split in smaller ranges of time to compute the result range by range. |
