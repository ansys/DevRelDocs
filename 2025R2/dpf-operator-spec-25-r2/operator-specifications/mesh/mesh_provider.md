...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong>|  time_scoping |[`int32`](./../../core-concepts/dpf-types#standard-types) | Optional time/frequency set ID of the mesh, supported for adaptative meshes. |
...
| <strong>Pin 14</strong>|  read_cyclic |[`enum dataProcessing::ECyclicReading`](./../../core-concepts/dpf-types#enum-dataprocessing::ecyclicreading), [`int32`](./../../core-concepts/dpf-types#standard-types) | If 1, cyclic symmetry is ignored. If 2, cyclic expansion is done (default is 1). |
| <strong>Pin 25</strong>|  region_scoping |[`scoping`](./../../core-concepts/dpf-types#scoping), [`int32`](./../../core-concepts/dpf-types#standard-types), [`vector<int32>`](./../../core-concepts/dpf-types#standard-types) | region id (integer) or vector of region ids with one entity (vector) or region scoping with one id (scoping) (region corresponds to zone for Fluid results or part for LSDyna results). |
| <strong>Pin 200</strong>|  laziness |[`abstract_data_tree`](./../../core-concepts/dpf-types#abstract-data-tree) | configurate whether lazy evaluation can be performed and to what extent. Supported attributes are: 
...
|-------|------|------------------|-------------|
|  **Pin 0**| mesh |[`abstract_meshed_region`](./../../core-concepts/dpf-types#abstract-meshed-region) |  |
