...
| <strong>Pin 1</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  threshold |[`double`](./../../core-concepts/dpf-types#standard-types) | angle threshold in radian that will trigger an edge detection. |
...
|-------|------|------------------|-------------|
|  **Pin 0**| wireframe |[`abstract_meshed_region`](./../../core-concepts/dpf-types#abstract-meshed-region) |  |
