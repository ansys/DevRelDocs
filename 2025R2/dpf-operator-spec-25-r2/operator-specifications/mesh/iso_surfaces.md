...
| <strong>Pin 1</strong>|  num_surfaces |[`int32`](./../../core-concepts/dpf-types#standard-types) | If provided, iso_values are linearly computed between the min and the max of the field of results. If not, iso_values must be provided by the user through pin 4 |
| <strong>Pin 2</strong>|  mesh |[`meshed_region`](./../../core-concepts/dpf-types#meshed-region) | Mesh to compute the iso-surface from. Used when not given through the support of the field in pin 0. |
...
| <strong>Pin 4</strong>|  vector_iso_values |[`vector<double>`](./../../core-concepts/dpf-types#standard-types) | If provided, user defined iso_values to compute. If not provided, iso_values are linearly compute between the min and the max of the field of results. |
...
|  **Pin 1**| fields_container |[`fields_container`](./../../core-concepts/dpf-types#fields-container) |  |
