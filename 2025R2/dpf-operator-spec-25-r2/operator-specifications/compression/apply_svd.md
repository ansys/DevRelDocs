...
| <strong>Pin 2</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  scalar_double |[`double`](../../core-concepts/dpf-types.md#standard-types) | threshold (precision) as a double, default value is 1e-7 |
| <strong>Pin 3</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  boolean |[`bool`](../../core-concepts/dpf-types.md#standard-types) | apply svd on the initial input data (true) or transposed (square matrix), default value is false |
