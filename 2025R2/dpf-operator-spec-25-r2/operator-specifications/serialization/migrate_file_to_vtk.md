...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong>|  output_filename |[`string`](../../core-concepts/dpf-types#standard-types) |  |
| <strong>Pin 3</strong>|  streams_container |[`streams_container`](../../core-concepts/dpf-types#streams-container) |  |
| <strong>Pin 4</strong>|  data_sources |[`data_sources`](../../core-concepts/dpf-types#data-sources) |  |
...
|-------|------|------------------|-------------|
|  **Pin 0**| data_sources |[`data_sources`](../../core-concepts/dpf-types#data-sources) | Generated output vtk file |
