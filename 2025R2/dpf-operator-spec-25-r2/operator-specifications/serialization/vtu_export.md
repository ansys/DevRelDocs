...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span> | directory |[`string`](../../core-concepts/dpf-types.md#string) | directory path |
| <strong>Pin 1</strong> | base_name |[`string`](../../core-concepts/dpf-types.md#string) | vtu base file name, (default is file) |
...
| <strong>Pin 103</strong> | mesh_properties |[`vector<string>`](../../core-concepts/dpf-types.md#vector<string>), [`string_field`](../../core-concepts/dpf-types.md#string-field) | List of names of mesh properties to export. |
