...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong>|  field_name |[`string`](../../core-concepts/dpf-types#standard-types) | name of the field in the vtk file |
| <strong>Pin 3</strong>|  streams |[`streams_container`](../../core-concepts/dpf-types#streams-container) |  |
