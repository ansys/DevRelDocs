...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  mesh_scoping |[`scoping`](./../../core-concepts/dpf-types#scoping) |  |
| <strong>Pin 1</strong>|  denominator |[`int32`](./../../core-concepts/dpf-types#standard-types) | Set the number of time the scoping is reduced (default is 2). Must be integer value above 1. |
