...
| <strong>Pin 1</strong> | requested_location |[`string`](../../core-concepts/dpf-types.md#string) | if nothing the operator returns the nodes scoping, possible locations are: Nodal(default) or Elemental |
