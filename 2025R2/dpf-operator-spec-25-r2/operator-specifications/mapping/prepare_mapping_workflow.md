...
| <strong>Pin 2</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span> | filter_radius |[`double`](../../core-concepts/dpf-types.md#double) | Radius size for the RBF filter |
| <strong>Pin 3</strong> | influence_box |[`double`](../../core-concepts/dpf-types.md#double) |  |
