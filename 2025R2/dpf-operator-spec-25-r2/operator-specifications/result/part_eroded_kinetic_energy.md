...
| <strong>Pin 6</strong>|  entity_scoping |[`scoping`](../../core-concepts/dpf-types.md#scoping) | entity (part for matsum, interface for rcforc) where the result will be scoped |
| <strong>Pin 50</strong>|  unit_system |[`int32`](../../core-concepts/dpf-types.md#standard-types), [`string`](../../core-concepts/dpf-types.md#standard-types), [`class dataProcessing::unit::CUnitSystem`](../../core-concepts/dpf-types.md#class-dataprocessing::unit::cunitsystem) | Unit System ID (int), semicolon-separated list of base unit strings (str) or UnitSystem instance |
