...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  cs_id |[`int32`](../../core-concepts/dpf-types#standard-types) |  |
...
|-------|------|------------------|-------------|
|  **Pin 0**| field |[`field`](../../core-concepts/dpf-types#field) | the first 9 double are the rotation (3x3 matrix) and the last 3 is the translation vector |
