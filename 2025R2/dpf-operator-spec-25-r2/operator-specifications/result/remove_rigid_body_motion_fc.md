...
| <strong>Pin 1</strong>|  reference_node_id |[`int32`](./../../core-concepts/dpf-types#standard-types) | Id of the reference entity (node). |
...
|  **Pin 1**| translation_field |[`field`](./../../core-concepts/dpf-types#field) | Global rigid translation vector |
|  **Pin 2**| rotation_field |[`field`](./../../core-concepts/dpf-types#field) | Global rigid rotation angles |
|  **Pin 3**| center_field |[`field`](./../../core-concepts/dpf-types#field) | Center of the rigid rotation |
