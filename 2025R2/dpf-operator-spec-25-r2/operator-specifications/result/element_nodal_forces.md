...
| <strong>Pin 2</strong>|  fields_container |[`fields_container`](./../../core-concepts/dpf-types#fields-container) | Fields container already allocated modified inplace |
...
| <strong>Pin 9</strong>|  requested_location |[`string`](./../../core-concepts/dpf-types#standard-types) | requested location Nodal, Elemental or ElementalNodal |
...
| <strong>Pin 26</strong>|  split_shells |[`bool`](./../../core-concepts/dpf-types#standard-types) | This pin forces elemental nodal shell and solid results to be split if this pin is set to true (default is false) |
| <strong>Pin 27</strong>|  shell_layer |[`int32`](./../../core-concepts/dpf-types#standard-types) | If the requested_location pin is not connected, and if spli_shells pin is set to true, we choose one of the shell layer for shell element. |
| <strong>Pin 200</strong>|  split_force_components |[`bool`](./../../core-concepts/dpf-types#standard-types) | If this pin is set to true, the output fields container splits the ENF by degree of freedom ("dof" label, 0 for translation, 1 for rotation, 2 for temperature) and derivative order ("derivative_order" label, 0 for stiffness terms, 1 for damping terms and 2 for inertial terms). Default is false. |
