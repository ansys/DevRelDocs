...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong> | mapdl_exe_path |[`string`](../../core-concepts/dpf-types.md#string) |  |
| <strong>Pin 1</strong> | working_dir |[`string`](../../core-concepts/dpf-types.md#string) |  |
...
| **Pin 1** | ip |[`string`](../../core-concepts/dpf-types.md#string) | returns the Ip if the server_mode pin is set to yes |
| **Pin 2** | port |[`string`](../../core-concepts/dpf-types.md#string) | returns a port when the server mode pin is set to yes |
