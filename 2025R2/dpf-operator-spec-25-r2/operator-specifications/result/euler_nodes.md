...
|-------|-------|------------------|-------------|
| <strong>Pin 3</strong>|  streams_container |[`streams_container`](./../../core-concepts/dpf-types#streams-container), [`stream`](./../../core-concepts/dpf-types#stream) |  |
...
| <strong>Pin 6</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  coord_and_euler |[`bool`](./../../core-concepts/dpf-types#standard-types) | if true, then the field has ncomp=6 with 3 coordinates and 3 Euler angles, else there is only the Euler angles (default is true). |
