...
Read mapdl::rth::TF from an rst file and expand it with cyclic symmetry.
...
| <strong>Pin 19</strong>|  phi |[`double`](../../core-concepts/dpf-types.md#standard-types) | phi angle (default value 0.0) |
 ...
 **Scripting name**: cyclic_expanded_heat_flux

 **Full name**: result.cyclic_expanded_heat_flux

 **Internal name**: mapdl::rth::TF_cyclic
