...
|-------|-------|------------------|-------------|
| <strong>Pin 2</strong>|  fields_container |[`fields_container`](../../core-concepts/dpf-types#fields-container) |  |
| <strong>Pin 3</strong>|  streams_container |[`streams_container`](../../core-concepts/dpf-types#streams-container), [`stream`](../../core-concepts/dpf-types#stream), [`class dataProcessing::CRstFileWrapper`](../../core-concepts/dpf-types#class-dataprocessing::crstfilewrapper) |  |
