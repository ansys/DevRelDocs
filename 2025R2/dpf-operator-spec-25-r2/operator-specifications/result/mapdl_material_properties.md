...
| <strong>Pin 1</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  materials |[`property_field`](../../core-concepts/dpf-types#property-field) | Property field that contains a material id per element. |
