...
| <strong>Pin 1</strong>|  mesh_scoping |[`scoping`](../../core-concepts/dpf-types#scoping) | Master scoping. All harmonics will be intersected with this scoping. |
...
|-------|------|------------------|-------------|
|  **Pin 0**| harmonic_energy |[`fields_container`](../../core-concepts/dpf-types#fields-container) |  |
|  **Pin 1**| harmonic_energy_percentage |[`fields_container`](../../core-concepts/dpf-types#fields-container) |  |
