...
| <strong>Pin 5</strong> | named_selection |[`string`](../../core-concepts/dpf-types.md#string) | Named Selections. Intersection of all  Named Selections with the master scoping will be done. |
