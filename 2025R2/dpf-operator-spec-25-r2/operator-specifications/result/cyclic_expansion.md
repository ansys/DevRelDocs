...
| <strong>Pin 6</strong> | map_size_scoping_out |[`umap<int32,int32>`](../../core-concepts/dpf-types.md#umap<int32,int32>) | map provider by scoping adapter |
| <strong>Pin 7</strong> | normalization_factor |[`double`](../../core-concepts/dpf-types.md#double) |  |
