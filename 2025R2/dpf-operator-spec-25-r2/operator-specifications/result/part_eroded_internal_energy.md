...
| <strong>Pin 6</strong>|  entity_scoping |[`scoping`](./../../core-concepts/dpf-types#scoping) | entity (part for matsum, interface for rcforc) where the result will be scoped |
