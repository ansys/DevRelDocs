...
| **Pin 6** | model_size |[`double`](../../core-concepts/dpf-types.md#double) | size of the model |
| **Pin 7** | field_coordinates_and_euler_angles |[`double`](../../core-concepts/dpf-types.md#double) | coordinates and euler angles of all nodes |
