...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong>|  time_scoping |[`int32`](../../core-concepts/dpf-types#standard-types) | Optional time/frequency set ID of the mesh. |
| <strong>Pin 3</strong>|  streams_container |[`streams_container`](../../core-concepts/dpf-types#streams-container) | streams (mesh file container) (optional) |
...
|-------|------|------------------|-------------|
|  **Pin 0**| mesh_info |[`generic_data_container`](../../core-concepts/dpf-types#generic-data-container) |  |
