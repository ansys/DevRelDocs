...
|-------|-------|------------------|-------------|
| <strong>Pin 7</strong>|  sector_meshed_region |[`abstract_meshed_region`](../../core-concepts/dpf-types.md#abstract-meshed-region), [`meshes_container`](../../core-concepts/dpf-types.md#meshes-container) |  |
...
|-------|------|------------------|-------------|
|  **Pin 0**| meshed_region |[`abstract_meshed_region`](../../core-concepts/dpf-types.md#abstract-meshed-region) | expanded meshed region. |
