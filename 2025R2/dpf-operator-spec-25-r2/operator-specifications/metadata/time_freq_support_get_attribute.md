...
|-------|------|------------------|-------------|
| **Pin 0** | property |[`double`](../../core-concepts/dpf-types.md#double), [`field`](../../core-concepts/dpf-types.md#field), [`scoping`](../../core-concepts/dpf-types.md#scoping) | Returns a double for property: "frequency_tolerance", a single-value Scoping for properties for "set_id" and "cummulative_index", and a Field otherwise. |
