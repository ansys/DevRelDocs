...
| <strong>Pin 2</strong>|  displacement |[`fields_container`](./../../core-concepts/dpf-types#fields-container) | Displacement field's container. Must contain the mesh if mesh not specified in input. |
