...
| <strong>Pin 2</strong>|  volume_fraction |[`bool`](./../../core-concepts/dpf-types#standard-types) | If true, returns influence volume, area or length. If false, the values are normalized with the element volume, area or length. Default: true. |
