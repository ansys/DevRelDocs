...
| <strong>Pin 1</strong>|  scoping |[`scoping`](./../../core-concepts/dpf-types#scoping) | Scoping to integrate on, if not provided, the one from input field is provided. |
| <strong>Pin 7</strong>|  mesh |[`abstract_meshed_region`](./../../core-concepts/dpf-types#abstract-meshed-region) | Mesh to integrate on. |
