...
| <strong>Pin 2</strong>|  mesh |[`abstract_meshed_region`](../../core-concepts/dpf-types#abstract-meshed-region) | Mesh to integrate on. If not provided, the one from input field is employed. |
