...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  field |[`fields_container`](./../../core-concepts/dpf-types#fields-container), [`field`](./../../core-concepts/dpf-types#field) | field or fields container with only one field is expected |
