...
|-------|------|------------------|-------------|
|  **Pin 0**| field_int |[`field`](../../core-concepts/dpf-types#field) | stress intensity field |
|  **Pin 1**| field_eqv |[`field`](../../core-concepts/dpf-types#field) | stress equivalent intensity |
|  **Pin 2**| field_max_shear |[`field`](../../core-concepts/dpf-types#field) | max shear stress field |
