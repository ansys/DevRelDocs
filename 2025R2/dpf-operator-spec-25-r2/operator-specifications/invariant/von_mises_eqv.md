...
| <strong>Pin 13</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  poisson_ratio |[`double`](../../core-concepts/dpf-types#standard-types), [`int32`](../../core-concepts/dpf-types#standard-types) | Poisson ratio to be used in equivalent strain calculation. |
