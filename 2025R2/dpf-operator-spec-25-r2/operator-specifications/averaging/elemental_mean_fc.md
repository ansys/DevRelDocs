...
| <strong>Pin 1</strong>|  collapse_shell_layers |[`bool`](./../../core-concepts/dpf-types#standard-types) | If true, shell layers are averaged as well (default is false). |
| <strong>Pin 2</strong>|  force_averaging |[`bool`](./../../core-concepts/dpf-types#standard-types) | If true you average, if false you just sum. |
...
| <strong>Pin 4</strong>|  abstract_meshed_region |[`abstract_meshed_region`](./../../core-concepts/dpf-types#abstract-meshed-region) | The mesh region in this pin is used to perform the averaging. It is used if there is no fields support. |
