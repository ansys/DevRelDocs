...
| <strong>Pin 1</strong>|  mesh_scoping |[`scoping`](../../core-concepts/dpf-types#scoping) | average only on these entities |
...
|  **Pin 1**| weight |[`property_field`](../../core-concepts/dpf-types#property-field) | Provides the number of times it was found in the elemental nodal field, for each node. Can be used to average later. |
