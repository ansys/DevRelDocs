...
| <strong>Pin 3</strong>|  scoping |[`scoping`](./../../core-concepts/dpf-types#scoping), [`scopings_container`](./../../core-concepts/dpf-types#scopings-container) | Average only on these elements. If it is a scoping container, the label must correspond to the one of the fields containers. |
| <strong>Pin 10</strong>|  collapse_shell_layers |[`bool`](./../../core-concepts/dpf-types#standard-types) | If true, shell layers are averaged as well (default is false). |
