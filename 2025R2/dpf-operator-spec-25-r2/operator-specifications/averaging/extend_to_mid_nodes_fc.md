...
|-----|------|----------|-------------|
| **inplace** |[`bool`](./../../core-concepts/dpf-types#standard-types) | false | The output is written over the input to save memory if this configuration is set to true. Only supported for nodal fields in input. |
