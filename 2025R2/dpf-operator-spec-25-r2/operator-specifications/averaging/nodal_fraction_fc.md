...
| <strong>Pin 3</strong>|  scoping |[`scoping`](../../core-concepts/dpf-types#scoping) | Average only on these nodes. If it is a scoping container, the label must correspond to the one of the fields containers. |
| <strong>Pin 6</strong>|  denominator |[`fields_container`](../../core-concepts/dpf-types#fields-container) | If a fields container is set in this pin, it is used as the denominator of the fraction instead of elemental_nodal_To_nodal_fc. |
