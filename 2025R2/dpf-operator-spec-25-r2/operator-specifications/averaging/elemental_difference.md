...
| <strong>Pin 10</strong>|  through_layers |[`bool`](../../core-concepts/dpf-types#standard-types) | The maximum elemental difference is taken through the different shell layers if true (default is false). |
