...
|-------|------|------------------|-------------|
|  **Pin 0**| fields_container |[`fields_container`](./../../core-concepts/dpf-types#fields-container) | Field containing the (weighted) sum for each component in an elementary data |
