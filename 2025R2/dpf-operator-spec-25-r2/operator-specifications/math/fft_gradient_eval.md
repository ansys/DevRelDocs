...
| <strong>Pin 2</strong>|  fs_ratio |[`int32`](./../../core-concepts/dpf-types#standard-types) | default value = 20 |
...
|-------|------|------------------|-------------|
|  **Pin 0**| coefficients |[`fields_container`](./../../core-concepts/dpf-types#fields-container) |  |
