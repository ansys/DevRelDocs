...
|-------|------|------------------|-------------|
|  **Pin 0**| s_svd |[`fields_container`](./../../core-concepts/dpf-types#fields-container) | Singular values of the input data, where A=U.S.Vt |
|  **Pin 1**| u_svd |[`fields_container`](./../../core-concepts/dpf-types#fields-container) | U of the input data, where A=U.S.Vt |
|  **Pin 2**| vt_svd |[`fields_container`](./../../core-concepts/dpf-types#fields-container) | Vt of the input data, where A=U.S.Vt |
