...
| <strong>Pin 2</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  factor |[`double`](./../../getting-started/using-data-containers.md#double) | Scalar |
...
| **work_by_index** |[`bool`](./../../getting-started/using-data-containers.md#bool) | true | If this option is set to true, loops and comparisons by entity will be done by index instead of ids. |
