...
| <strong>Pin 5</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  int32 |[`int32`](./../../core-concepts/dpf-types#standard-types) | Define min or max. |
