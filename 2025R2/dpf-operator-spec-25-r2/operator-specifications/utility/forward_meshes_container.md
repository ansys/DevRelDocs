...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  meshes |[`meshes_container`](../../core-concepts/dpf-types#meshes-container), [`abstract_meshed_region`](../../core-concepts/dpf-types#abstract-meshed-region) |  |
| <strong>Pin 1</strong>|  default_label |[`string`](../../core-concepts/dpf-types#standard-types) | this default label is used if a new meshes container needs to be created (default is unknown) |
