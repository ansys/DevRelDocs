...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  result_infos |[`vector<shared_ptr<result_info>>`](../../core-concepts/dpf-types#vector<shared-ptr<result-info>>), [`result_info`](../../core-concepts/dpf-types#result-info) | A vector of result info containers to merge or result infos from pin 0 to ... |
...
|-------|------|------------------|-------------|
|  **Pin 0**| merged_result_infos |[`result_info`](../../core-concepts/dpf-types#result-info) |  |
