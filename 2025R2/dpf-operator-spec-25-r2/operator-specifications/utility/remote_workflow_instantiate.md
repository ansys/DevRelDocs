...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  workflow_to_send |[`workflow`](../../core-concepts/dpf-types#workflow), [`int32`](../../core-concepts/dpf-types#standard-types) | local workflow to push to a remote or id of a remote workflow |
