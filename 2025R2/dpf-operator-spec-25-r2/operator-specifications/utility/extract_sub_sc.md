...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  scopings_container |[`scopings_container`](./../../core-concepts/dpf-types#scopings-container) | scopings_container |
...
| <strong>Pin 2</strong>|  collapse_labels |[`bool`](./../../core-concepts/dpf-types#standard-types) | If set to true (default) the input label space (scoping location) is suppressed from the output scopings container, otherwise, label space is kept. |
...
|-------|------|------------------|-------------|
|  **Pin 0**| scopings_container |[`scopings_container`](./../../core-concepts/dpf-types#scopings-container) | scopings_container |
