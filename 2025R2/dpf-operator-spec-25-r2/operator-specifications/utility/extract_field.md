...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  fields_container |[`field`](./../../core-concepts/dpf-types#field), [`fields_container`](./../../core-concepts/dpf-types#fields-container) | if a field is in input, it is passed on as an output |
| <strong>Pin 1</strong>|  indices |[`vector<int32>`](./../../core-concepts/dpf-types#standard-types) | Default is the first field |
