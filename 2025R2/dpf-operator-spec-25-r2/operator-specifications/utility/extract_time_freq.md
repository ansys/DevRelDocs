...
| <strong>Pin 1</strong>|  time_scoping |[`scoping`](../../core-concepts/dpf-types#scoping) |  |
| <strong>Pin 2</strong>|  real_or_complex |[`bool`](../../core-concepts/dpf-types#standard-types) | False for real only (default). True for complex output. |
