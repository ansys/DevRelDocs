...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  meshes_containers |[`vector<shared_ptr<meshes_container>>`](./../../core-concepts/dpf-types#vector<shared-ptr<meshes-container>>), [`meshes_container`](./../../core-concepts/dpf-types#meshes-container) | a vector of meshes containers to merge or meshes containers from pin 0 to ... |
...
|-------|------|------------------|-------------|
|  **Pin 0**| merged_meshes_container |[`meshes_container`](./../../core-concepts/dpf-types#meshes-container) |  |
