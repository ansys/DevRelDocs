...
| <strong>Pin 0</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  supports |[`vector<shared_ptr<abstract_field_support>>`](../../core-concepts/dpf-types.md#vector<shared-ptr<abstract-field-support>>), [`abstract_field_support`](../../core-concepts/dpf-types.md#abstract-field-support) | A vector of supports to merge or supports from pin 0 to ... |
...
|-------|------|------------------|-------------|
|  **Pin 0**| merged_support |[`abstract_field_support`](../../core-concepts/dpf-types.md#abstract-field-support) |  |
