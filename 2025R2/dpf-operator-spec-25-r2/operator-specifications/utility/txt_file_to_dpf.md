...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  input_string |[`string`](./../../core-concepts/dpf-types#standard-types) | ex: 'double:1.0', 'int:1', 'vector<double>:1.0;1.0' |
