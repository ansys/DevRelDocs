...
## New Features summary
  * [Add number of threads control to mapdl::run with a new pin](#add_number_of_threads_control_to_mapdlrun_with_a_new_pin)
  * [Support RealSingle datatype](#support_realsingle_datatype)
  * [Document current density quirks](#document_current_density_quirks)
  * [Source operator: allow to return all times/freq fields](#source_operator_allow_to_return_all_timesfreq_fields)
  * [Improve "custom" source op to support all providers and scripting names](#improve_custom_source_op_to_support_all_providers_and_scripting_names)
  * [Allow normals provider to compute face normals when no elements](#allow_normals_provider_to_compute_face_normals_when_no_elements)
  * [Allow DPF to operate without context](#allow_dpf_to_operate_without_context)
  * [Add Changelog to DPF](#add_changelog_to_dpf)
  * [Cyclic support provider from hdf5](#cyclic_support_provider_from_hdf5)
  * [Support getting the field of a fieldscontainer with fieldscontainer::get_attribute](#support_getting_the_field_of_a_fieldscontainer_with_fieldscontainergetattribute)
  * [Enabled dimension less units with symbol](#enabled_dimension_less_units_with_symbol)
  * [Support Markdown and LaTeX in CHTML_Doc_Generator_2](#support_markdown_and_latex_in_chtmldocgenerator2)
  * [Modify normal and shear strain calculation when cartesian coordinate system is selected](#modify_normal_and_shear_strain_calculation_when_cartesian_coordinate_system_is_selected)
  * [Add remote point name in the dfmf file](#add_remote_point_name_in_the_dfmf_file)
  * [Support for SOLID225 elements](#support_for_solid225_elements)
  * [Support contact results for eCONTA177 and eCONTA172 elements](#support_contact_results_for_econta177_and_econta172_elements)
  * [New operator for PSD FSUM](#new_operator_for_psd_fsum)
  * [Add Operator versions](#add_operator_versions)
  * [Add shell layers pin to HgP](#add_shell_layers_pin_to_hgp)
  * [Handle TemperatureDifference and Improve unit conversion handling](#handle_temperaturedifference_and_improve_unit_conversion_handling)
  * [Add pin alias](#add_pin_alias)
  * [Handle PRETS179 elements](#handle_prets179_elements)
  * [Workflow getOutput DataTree](#workflow_getoutput_datatree)
  * [Add MagneticPotential as an available homogeneity](#add_magneticpotential_as_an_available_homogeneity)
  * [Add read_cyclic pin to equivalent mass operator specification](#add_readcyclic_pin_to_equivalent_mass_operator_specification)
  * [Incrementally write HDF5 fields](#incrementally_write_hdf5_fields)
  * [Create comparison operators for types, property & meshes containers & GDC.](#create_comparison_operators_for_types_property__meshes_containers__gdc)
  * [Allowing to read the element state variable record (ESV)](#allowing_to_read_the_element_state_variable_record_esv)
  * [Import/Export of String fields in hdf5](#importexport_of_string_fields_in_hdf5)
  * [Allow to create a DpfVector for any type](#allow_to_create_a_dpfvector_for_any_type)
  * [PSD 1 sigma operator](#psd_1_sigma_operator)
  * [Element_types_provider to output additional data.](#elementtypesprovider_to_output_additional_data)
  * [Display an explicit error message when the ANSYS_DPF_ACCEPT_LA is not set to Y in the standalone.](#display_an_explicit_error_message_when_the_ansysdpfacceptla_is_not_set_to_y_in_the_standalone)
  * [Creation of nodal to elemental nodal averaging operator.](#creation_of_nodal_to_elemental_nodal_averaging_operator)
  * [Add operators to read magnetic results](#add_operators_to_read_magnetic_results)
  * [SHELL93 ENF + Addition of composite files](#shell93_enf__addition_of_composite_files)
  * [Creation of Sketch matrix operator](#creation_of_sketch_matrix_operator)
  * [Add operator_id operator](#add_operatorid_operator)
  * [Make spectrum_data a source operator and expose .prs reader](#make_spectrumdata_a_source_operator_and_expose_prs_reader)
  * [Add option to serialize in a binary format](#add_option_to_serialize_in_a_binary_format)
### Changes summary
  * [Report key collision when using load_library](#report_key_collision_when_using_loadlibrary)
  * [Change the DataTree API for getting attributes](#change_the_datatree_api_for_getting_attributes)
  * [Require label "panel" in the modal basis for expansion](#require_label_panel_in_the_modal_basis_for_expansion)
  * [Changed license requirement for operator split_field](#changed_license_requirement_for_operator_splitfield)
  * [Make cyclic operators private](#make_cyclic_operators_private)
  * [Modifications to import/export dpf objects for hdf5](#modifications_to_importexport_dpf_objects_for_hdf5)
  * [Avoid throwing in modal_solve for RHS with input_dof_index](#avoid_throwing_in_modalsolve_for_rhs_with_inputdofindex)
  * [Rename magnetic vector potential operator](#rename_magnetic_vector_potential_operator)
  * [ENF results now default to 3D vector fields instead of scalar fields](#enf_results_now_default_to_3d_vector_fields_instead_of_scalar_fields)
  * [Remove prints when DPF server is starting](#remove_prints_when_dpf_server_is_starting)
## Fixes summary
  * [Solve issue with reordering of unfiltered ENFs](#solve_issue_with_reordering_of_unfiltered_enfs)
  * [print custom type collections](#print_custom_type_collections)
  * [issue with node averaged results with scoping](#issue_with_node_averaged_results_with_scoping)
  * [Fix Rescope operator for input fields with no ids in the scoping](#fix_rescope_operator_for_input_fields_with_no_ids_in_the_scoping)
  * [Performance issue on readMeshProperties](#performance_issue_on_readmeshproperties)
  * [Fix append cyclic support on ENG_VOL_cyclic and NMISC_cyclic](#fix_append_cyclic_support_on_engvolcyclic_and_nmisccyclic)
  * [Nodal Averaged Result operators return wrong values when setting a mesh scoping](#nodal_averaged_result_operators_return_wrong_values_when_setting_a_mesh_scoping)
  * [Nodal cyclic expansion creates duplicated scoping ids](#nodal_cyclic_expansion_creates_duplicated_scoping_ids)
  * [Don't read wrong cyclic definition id offsets](#dont_read_wrong_cyclic_definition_id_offsets)
  * [Handle Gasket Degenerated Elements](#handle_gasket_degenerated_elements)
  * [Fix incorrect dimension when reading dsub file](#fix_incorrect_dimension_when_reading_dsub_file)
  * [Custom Type Fields hdf5 export/import to read the type of data](#custom_type_fields_hdf5_exportimport_to_read_the_type_of_data)
  * [Properly initialize the shellLayer obtained for ElementalNodal results](#properly_initialize_the_shelllayer_obtained_for_elementalnodal_results)
  * [Fix out of bound access in HDF5 append](#fix_out_of_bound_access_in_hdf5_append)
  * [Fix corner node filtering/extrapolation](#fix_corner_node_filteringextrapolation)
  * [Fix rotate ENF results](#fix_rotate_enf_results)
  * [Fix bugs for MSUP harmonic analysis with MODE file scoping](#fix_bugs_for_msup_harmonic_analysis_with_mode_file_scoping)
  * [Crash dpf vector commit](#crash_dpf_vector_commit)
  * [RES_cyclic operators can now average from elemental_nodal to elemental](#rescyclic_operators_can_now_average_from_elementalnodal_to_elemental)
  * [Json workflow deserializer](#json_workflow_deserializer)
  * [RTDL_DEEPBIND flag was removed from DLL loading](#rtdldeepbind_flag_was_removed_from_dll_loading)
  * [Fix location of averaged empty fields](#fix_location_of_averaged_empty_fields)
  * [Allow to serialize data in strings for more than 2 Gb](#allow_to_serialize_data_in_strings_for_more_than_2_gb)
  * [Fix missing error message when reading an inexistant custom result](#fix_missing_error_message_when_reading_an_inexistant_custom_result)
  * [HDF5: Fix the TFS' data pointer not being properly expanded](#hdf5_fix_the_tfs_data_pointer_not_being_properly_expanded)
  * [Improve VTU export for several field inputs](#improve_vtu_export_for_several_field_inputs)
  * [Fix skin extraction for point elements](#fix_skin_extraction_for_point_elements)
  * [Fixed double precision issue for DataTree attributes (15 -> 17 digits)](#fixed_double_precision_issue_for_datatree_attributes_15__17_digits)
  * [rescope operator acknowledges only first duplicated value](#rescope_operator_acknowledges_only_first_duplicated_value)
  * [Improve no output pin error message](#improve_no_output_pin_error_message)
  * [Document limitation in rotation of Elemental and ElementalNodal results](#document_limitation_in_rotation_of_elemental_and_elementalnodal_results)
  * [Repair mapdl::rst::mesh_property_provider](#repair_mapdlrstmeshpropertyprovider)
  * [Fix shell layer management for stress results on elements 181 and 281](#fix_shell_layer_management_for_stress_results_on_elements_181_and_281)
  * [Allow to serialize to a file with more than 2Gb](#allow_to_serialize_to_a_file_with_more_than_2gb)
  * [Fix load plugin error code](#fix_load_plugin_error_code)
  * [Read Hdf5 file without license check](#read_hdf5_file_without_license_check)
  * [Fix hdf5 stream_provider operator doesn't check the file existence](#fix_hdf5_streamprovider_operator_doesnt_check_the_file_existence)
  * [Fix Any deep copy to client](#fix_any_deep_copy_to_client)
  * [random failure on license checkout](#random_failure_on_license_checkout)
  * [Add missing support for nodal fields after solid-to-skin operator](#add_missing_support_for_nodal_fields_after_solidtoskin_operator)
  * [modal_damping_ratio operator is outputting NaN when Natural Frequency is exactly 0](#modaldampingratio_operator_is_outputting_nan_when_natural_frequency_is_exactly_0)
  * [Fix available gRPC port search on Windows](#fix_available_grpc_port_search_on_windows)
  * [Infinite loop in function readENFResultBlock](#infinite_loop_in_function_readenfresultblock)
  * [Fix an issue with index in elemental rotation](#fix_an_issue_with_index_in_elemental_rotation)
  * [Close windows port correctly and server graceful shutdown](#close_windows_port_correctly_and_server_graceful_shutdown)
  * [Add mesh to elemental energy results from MAPDL](#add_mesh_to_elemental_energy_results_from_mapdl)
  * [Fix beam material property retrieval for unmatching section and material ID](#fix_beam_material_property_retrieval_for_unmatching_section_and_material_id)
  * [Fix allocation of mesh bitset out of range](#fix_allocation_of_mesh_bitset_out_of_range)
  * [Fix split_shells_solid to correctly propagate shell layers if skin or beam elements are present](#fix_splitshellssolid_to_correctly_propagate_shell_layers_if_skin_or_beam_elements_are_present)
  * [Fix scoping of output for ascending/descending sorting for fieldscontainer](#fix_scoping_of_output_for_ascendingdescending_sorting_for_fieldscontainer)
  * [Remove memory leak in DpfVector and StringField](#remove_memory_leak_in_dpfvector_and_stringfield)
  * [Fix a crash for operator coords_and_euler_nodes when the nput scoping is empty](#fix_a_crash_for_operator_coordsandeulernodes_when_the_nput_scoping_is_empty)
  * [Solve issue with ECT_STAT results reading](#solve_issue_with_ectstat_results_reading)
  * [Fix DpfVector subset modification](#fix_dpfvector_subset_modification)
  * [Fix FieldDefinition.unit() for units with Unknown homogeneity](#fix_fielddefinitionunit_for_units_with_unknown_homogeneity)
  * [Dynamically test for cyclic versions of source operators](#dynamically_test_for_cyclic_versions_of_source_operators)
  * [Fix a crash in mode contribution operator](#fix_a_crash_in_mode_contribution_operator)
  * [Fix pin `split_shells` of source operators with elemental_nodal default location such as `stress`](#fix_pin_splitshells_of_source_operators_with_elementalnodal_default_location_such_as_stress)
  * [Fix naming of comparison operators](#fix_naming_of_comparison_operators)
  * [Correctly handle empty fields in `change_shell_layers`](#correctly_handle_empty_fields_in_changeshelllayers)
  * [Fix `mesh.by_scoping` when the resulting mesh is empty](#fix_meshbyscoping_when_the_resulting_mesh_is_empty)
  * [Fix an inconsistency in results between cyclic operators using a stream and using a datasources](#fix_an_inconsistency_in_results_between_cyclic_operators_using_a_stream_and_using_a_datasources)
  * [Fix shift of unit with the power function](#fix_shift_of_unit_with_the_power_function)
  * [Fix a dmp crash for mode file scoping](#fix_a_dmp_crash_for_mode_file_scoping)
  * [Fix matrix-matrix product for symmetrical matrices (extra diagonal terms were divided by 2)](#fix_matrixmatrix_product_for_symmetrical_matrices_extra_diagonal_terms_were_divided_by_2)
  * [Fix CustomTypeField.setData()](#fix_customtypefieldsetdata)
  * [Fix a solid-to-skin mapping issue when including beam-type elements](#fix_a_solidtoskin_mapping_issue_when_including_beamtype_elements)
  * [Fix mapdl run cmd issue "input missing"](#fix_mapdl_run_cmd_issue_input_missing)
  * [Fix load plugin error reporting.](#fix_load_plugin_error_reporting)
  * [Fix adding empty MeshRegion crashes writing to hdf5](#fix_adding_empty_meshregion_crashes_writing_to_hdf5)
  * [Fix HGP FieldDefinition::setDimensions](#fix_hgp_fielddefinitionsetdimensions)
### Performance Improvements summary
  * [Solve property field provider by name performance issues with distributed files](#solve_property_field_provider_by_name_performance_issues_with_distributed_files)
  * [Improved performance when recovering element results](#improved_performance_when_recovering_element_results)
  * [Improve memory allocation in operator `split_fields`](#improve_memory_allocation_in_operator_splitfields)
  * [Prevent useless memory allocation when creating an empty DpfVector ](#prevent_useless_memory_allocation_when_creating_an_empty_dpfvector_)
  * [CustomTypeFields with double values are now better handling huge sizes](#customtypefields_with_double_values_are_now_better_handling_huge_sizes)
  * [Improve performance of the DataTree](#improve_performance_of_the_datatree)
  * [Improve performance of `solid_to_skin`](#improve_performance_of_solidtoskin)
  * [Improve performance of scoping transposition with a new cache logic](#improve_performance_of_scoping_transposition_with_a_new_cache_logic)
  * [Improve performance of DpfVector](#improve_performance_of_dpfvector)
  * [Improve performances when reading modal results in Mechanical with DPF](#improve_performances_when_reading_modal_results_in_mechanical_with_dpf)
  * [Avoid reserving more data than needed for ZSTD decompression](#avoid_reserving_more_data_than_needed_for_zstd_decompression)
  * [Improve performance of the `split_on_property_type` operator for multiple properties](#improve_performance_of_the_splitonpropertytype_operator_for_multiple_properties)
  * [Improve performance of the `changel_shell_layers` operator](#improve_performance_of_the_changelshelllayers_operator)
  * [Improve performance when getting a unit symbol](#improve_performance_when_getting_a_unit_symbol)
  * [Improve performance of AnyCollection by not casting to Any first](#improve_performance_of_anycollection_by_not_casting_to_any_first)
...
### <a id="dont_read_wrong_cyclic_definition_id_offsets"></a> Don't read wrong cyclic definition id offsets
...
### <a id="fix_a_crash_for_operator_coordsandeulernodes_when_the_nput_scoping_is_empty"></a> Fix a crash for operator coords_and_euler_nodes when the nput scoping is empty
...
### <a id="improve_performance_of_the_changelshelllayers_operator"></a> Improve performance of the `changel_shell_layers` operator
