...
|[TstParityEven](bitfield__tstparityeven.md)|Returns whether the number of bits defined and set to 1 in the input is even.|
...
-   **[High](../../libraries/bitfield/bitfield__high.md)**  
 Returns the bit-field with the most significant bits of the input.
-   **[Low](../../libraries/bitfield/bitfield__low.md)**  
 Returns the bit-field with the least significant bits of the input.
...
-   **[RotBitRt](../../libraries/bitfield/bitfield__rotbitrt.md)**  
 Returns the input with all bits rotated to the right by a number. The least significant bit is rotated to the most significant bit location for every single bit shift cycle.
-   **[SetBit](../../libraries/bitfield/bitfield__setbit.md)**  
 Returns the input with the bit set to 1 at the given position.
...
-   **[ToBool](../../libraries/bitfield/bitfield__tobool.md)**  
 Returns an array of Boolean values from the input.
