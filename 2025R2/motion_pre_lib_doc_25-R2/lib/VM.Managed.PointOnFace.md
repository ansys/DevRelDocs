# <a id="VM_Managed_PointOnFace"></a> Class PointOnFace
...
```csharp
public class PointOnFace : PointOnGeometryBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
