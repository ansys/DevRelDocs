# <a id="VM_Managed_DAFUL_Constraints_PropertyPlanar"></a> Class PropertyPlanar
...
```csharp
public class PropertyPlanar : PropertyConstraint, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IContainer, ILinkContainer, IOwned, IHasID, IArgument
```
