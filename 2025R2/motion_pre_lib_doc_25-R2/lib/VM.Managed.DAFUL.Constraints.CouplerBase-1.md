# <a id="VM_Managed_DAFUL_Constraints_CouplerBase_1"></a> Class CouplerBase<TProperty\>
...
```csharp
public CouplerBase(string strName)
```
...
```csharp
public string Joint1_FullName { get; }
```
...
```csharp
public ObjectBase Joint2 { get; set; }
```
