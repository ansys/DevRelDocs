# <a id="VM_Managed_DAFUL_IBodySegmentShaft"></a> Interface IBodySegmentShaft
...
```csharp
public interface IBodySegmentShaft : IManualTransmissionComponent, IHasBuilder, IConnectable, IMarkerParent, IEntityRelation, IHasBody
```
