# <a id="VM_API_Pre_GeometryAPI"></a> Class GeometryAPI
...
public static void ImportCAD(this IDocument document, string filePath, ResultType resultType = ResultType.Default, Document3D.CadImportUnitType unused = CadImportUnitType.Auto, bool useHealing = true, Document3D.CadImportColorType colorType = CadImportColorType.Default, Color? color = null)
```
...
`unused` Document3D.CadImportUnitType
...
[NotNull(new string[] { "document" })]
[ExistFile(new string[] { "filePath" })]
public static void ReplaceCAD(this IDocument document, string filePath, ResultType resultType = ResultType.Default, Document3D.CadImportUnitType unused = CadImportUnitType.Auto, bool useHealing = true, Document3D.CadImportColorType colorType = CadImportColorType.Default, Color? color = null, bool replaceAllGeometries = true, string[] attributes = null)
```
