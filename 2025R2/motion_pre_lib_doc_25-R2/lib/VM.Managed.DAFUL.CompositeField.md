# <a id="VM_Managed_DAFUL_CompositeField"></a> Class CompositeField
...
```csharp
public abstract class CompositeField : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
protected CompositeField(Property owner)
```
