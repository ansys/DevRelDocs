...
```csharp
public class ApplyRollingBearing : OperationBase, IOperation
```
...
```csharp
public ApplyRollingBearing(HiddenBearingDocument hiddenBearingDocument, Bearing bearing)
```
...
```csharp
public ApplyRollingBearing(JournalParameter jp)
```
