# <a id="VM_Models_Pre_IDesignPoint"></a> Interface IDesignPoint

Namespace: [VM.Models.Pre](VM.Models.Pre.md)  
Assembly: VM.Models.Pre.dll  

```csharp
public interface IDesignPoint : IDesignSubEntity, ISubEntity, IEntityBase, IObjectBase, IHasKeyObject, IHasName, IEnabled, IHasComment, IPointBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider
```
