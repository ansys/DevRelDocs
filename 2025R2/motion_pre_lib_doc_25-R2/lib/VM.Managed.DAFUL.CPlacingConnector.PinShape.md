# <a id="VM_Managed_DAFUL_CPlacingConnector_PinShape"></a> Class PinShape
...
```csharp
public class PinShape : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public string ShapeText(bool bLeft)
```

#### Parameters

`bLeft` [bool](https://learn.microsoft.com/dotnet/api/system.boolean)
