# <a id="VM_Managed_DAFUL_IRotationalMotionComponent"></a> Interface IRotationalMotionComponent
...
```csharp
public interface IRotationalMotionComponent : ICouplerComponent, IForceComponent
```
