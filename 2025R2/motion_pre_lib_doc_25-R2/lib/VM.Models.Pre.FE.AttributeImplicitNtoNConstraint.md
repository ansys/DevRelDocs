# <a id="VM_Models_Pre_FE_AttributeImplicitNtoNConstraint"></a> Class AttributeImplicitNtoNConstraint

Namespace: [VM.Models.Pre.FE](VM.Models.Pre.FE.md)  
Assembly: VM.Models.Pre.FE.dll  

```csharp
public class AttributeImplicitNtoNConstraint : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
