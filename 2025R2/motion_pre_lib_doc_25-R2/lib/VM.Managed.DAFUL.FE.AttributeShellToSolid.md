# <a id="VM_Managed_DAFUL_FE_AttributeShellToSolid"></a> Class AttributeShellToSolid
...
```csharp
public class AttributeShellToSolid : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public AttributeShellToSolid(double dAlpha)
```
