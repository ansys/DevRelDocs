# <a id="VM_Managed_DAFUL_GearTrain_Web"></a> Class Web
...
```csharp
public class Web : GearPropertyBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
WebPropertyValue list is null.
or
WebPropertyValue list is null.
or
WebPropertyValue is null.
