# <a id="VM_Managed_DAFUL_CoSim_Matlab_CoSimulationMatlabConfig"></a> Class CoSimulationMatlabConfig
...
```csharp
public class CoSimulationMatlabConfig : CoSimulationConfig, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public string FileNameOfSimulink { get; set; }
```
