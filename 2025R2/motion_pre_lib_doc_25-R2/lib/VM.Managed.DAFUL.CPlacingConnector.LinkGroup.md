# <a id="VM_Managed_DAFUL_CPlacingConnector_LinkGroup"></a> Class LinkGroup
...
```csharp
public abstract class LinkGroup : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
