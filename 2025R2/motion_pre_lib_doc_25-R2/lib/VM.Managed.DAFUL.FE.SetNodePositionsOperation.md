# <a id="VM_Managed_DAFUL_FE_SetNodePositionsOperation"></a> Class SetNodePositionsOperation
...
```csharp
public class SetNodePositionsOperation : OperationBase, IOperation
```
...
```csharp
public SetNodePositionsOperation(NodalBody nb, string strDFNPath)
```

#### Parameters

`nb` [NodalBody](VM.Managed.DAFUL.FE.NodalBody.md)
