# <a id="VM_Managed_DAFUL_Car_Operation_ExportXMLForFullCar"></a> Class ExportXMLForFullCar
...
ExportXML.m\_scenario, 
ExportXML.m\_bEndSolvingThread, 
ExportXML.Execute\(\), 
ExportXML.GetInformation\(XmlWriter\), 
ExportXML.ExportXMLImpl\(\), 
ExportXML.WriteJournalCore\(\), 
ExportXML.EndExecuteThread\(\), 
ExportXML.Name, 
ExportXML.Execute\(\), 
ExportXML.ExportXMLImpl\(\), 
ExportXML.Name, 
