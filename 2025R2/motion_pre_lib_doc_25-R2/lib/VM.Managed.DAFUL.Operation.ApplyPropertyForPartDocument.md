# <a id="VM_Managed_DAFUL_Operation_ApplyPropertyForPartDocument"></a> Class ApplyPropertyForPartDocument
...
```csharp
public class ApplyPropertyForPartDocument : OperationBase, IOperation
```
