# <a id="VM_Managed_DAFUL_Contact_PropertyMultiContact"></a> Class PropertyMultiContact
...
```csharp
public class PropertyMultiContact : Property, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IContainer, ILinkContainer, IOwned, IHasID
```
