# <a id="VM_Managed_DAFUL_Builder_SolidBodySphere_1"></a> Class SolidBodySphere<T\>

Namespace: [VM.Managed.DAFUL.Builder](VM.Managed.DAFUL.Builder.md)  
Assembly: VMBld.dll  

```csharp
public abstract class SolidBodySphere<T> : SolidBody<T>, IBuilder where T : BuilderSphere, new()
```
