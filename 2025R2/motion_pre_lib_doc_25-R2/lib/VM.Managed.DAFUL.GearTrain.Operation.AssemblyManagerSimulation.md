# <a id="VM_Managed_DAFUL_GearTrain_Operation_AssemblyManagerSimulation"></a> Class AssemblyManagerSimulation
...
```csharp
public class AssemblyManagerSimulation : OperationBase, IOperation
```
...
```csharp
public AssemblyManagerSimulation(GearTrainDocument doc)
```
...
```csharp
public AssemblyManagerSimulation(JournalParameter jp)
```
