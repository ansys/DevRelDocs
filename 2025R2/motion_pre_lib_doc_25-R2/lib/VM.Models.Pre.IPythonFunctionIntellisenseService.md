# <a id="VM_Models_Pre_IPythonFunctionIntellisenseService"></a> Interface IPythonFunctionIntellisenseService
...
```csharp
public interface IPythonFunctionIntellisenseService
```
