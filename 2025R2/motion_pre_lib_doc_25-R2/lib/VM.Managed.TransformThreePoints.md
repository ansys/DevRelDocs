# <a id="VM_Managed_TransformThreePoints"></a> Class TransformThreePoints
...
```csharp
public class TransformThreePoints : TransformBase, IObservableObject, IDisposableObject, ILinkable, ILinkContainerEvent, IVerifiable, IExpression, ITransformBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider
```
