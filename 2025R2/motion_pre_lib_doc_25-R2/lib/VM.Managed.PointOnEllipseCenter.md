# <a id="VM_Managed_PointOnEllipseCenter"></a> Class PointOnEllipseCenter
...
```csharp
public class PointOnEllipseCenter : PointOnGeometryBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
