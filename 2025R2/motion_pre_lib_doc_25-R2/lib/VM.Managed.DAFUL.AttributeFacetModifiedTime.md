# <a id="VM_Managed_DAFUL_AttributeFacetModifiedTime"></a> Class AttributeFacetModifiedTime
...
```csharp
public class AttributeFacetModifiedTime : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
