# <a id="VM_Managed_DAFUL_GearTrain_Backlash"></a> Class Backlash
...
```csharp
public class Backlash : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public GearPairValue PairLower { get; set; }
```
...
```csharp
public GearPairValue PairUpper { get; set; }
```
