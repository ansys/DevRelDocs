# <a id="VM_Managed_DirectionOnEdge"></a> Class DirectionOnEdge
...
```csharp
public class DirectionOnEdge : DirectionOnGeometryBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
