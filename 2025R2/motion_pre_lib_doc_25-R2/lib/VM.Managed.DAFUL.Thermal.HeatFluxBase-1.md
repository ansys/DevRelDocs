# <a id="VM_Managed_DAFUL_Thermal_HeatFluxBase_1"></a> Class HeatFluxBase<TProperty\>
...
```csharp
public abstract class HeatFluxBase<TProperty> : ThermalBase<TProperty>, IObservableObject, IDisposableObject, ILinkable, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IContainer, IEntity, IEntityBase, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, IHasName, IEnabled, IHasComment, IVisible, IDocumentOwner, INamed, INavigatorItem, IVisible, IMultiChangable, IHasProperty, IGroup, IDraw, IDrawIcon, IHasReplaceableEntity where TProperty : PropertyHeatFluxBase, new()
```
...
```csharp
public HeatFluxBase(string strName)
```
