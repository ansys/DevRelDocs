# <a id="VM_Managed_DAFUL_Tire_Operation_ReloadOperation"></a> Class ReloadOperation
...
```csharp
public class ReloadOperation : OperationBase, IOperation
```
...
`strBuilderInfo` [string](https://learn.microsoft.com/dotnet/api/system.string)
