# <a id="VM_Managed_DAFUL_Linear_PropertyActuatorSweptSine"></a> Class PropertyActuatorSweptSine
...
```csharp
public class PropertyActuatorSweptSine : PropertyActuator, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IContainer, ILinkContainer, IOwned, IHasID
```
