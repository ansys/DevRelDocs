# <a id="VM_Managed_CAD_BuilderHasTransform"></a> Class BuilderHasTransform
...
```csharp
public abstract class BuilderHasTransform : BuilderColorGeom, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer
```
