# <a id="VM_Managed_CAD_AttributeBodyModifiedTime"></a> Class AttributeBodyModifiedTime
...
```csharp
public class AttributeBodyModifiedTime : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public string GINFTimeModified { get; set; }
```
