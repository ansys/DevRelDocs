# <a id="VM_Models_Pre_ISubSystemDocument"></a> Interface ISubSystemDocument
...
```csharp
public interface ISubSystemDocument : IDocumentAnalysis, IDocument3D, IHandledDocument, IDocument, IObject, IEventProvider, IContainer, ILinkContainer, IOwned, IHasID, IDocumentOwner
```
