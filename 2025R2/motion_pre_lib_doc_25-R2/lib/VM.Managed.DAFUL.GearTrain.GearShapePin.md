# <a id="VM_Managed_DAFUL_GearTrain_GearShapePin"></a> Class GearShapePin
...
```csharp
public class GearShapePin : GearShapeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
