# <a id="VM_Managed_AttributeCanNotOpenWithNewPreprocessor"></a> Class AttributeCanNotOpenWithNewPreprocessor
...
```csharp
public class AttributeCanNotOpenWithNewPreprocessor : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
