# <a id="VM_Managed_DAFUL_Track_PropertyHydroForce"></a> Class PropertyHydroForce
...
```csharp
public class PropertyHydroForce : Property, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IContainer, ILinkContainer, IOwned, IHasID
```
...
```csharp
public bool IsUseHullReferenceMarker { get; set; }
```
