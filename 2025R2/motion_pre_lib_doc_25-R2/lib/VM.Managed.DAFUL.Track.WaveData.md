# <a id="VM_Managed_DAFUL_Track_WaveData"></a> Class WaveData
...
```csharp
public class WaveData : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public ExpressionValueVariable Period { get; set; }
```
