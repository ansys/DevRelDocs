# <a id="VM_Managed_DAFUL_GearTrain_Operation_ApplyHousing"></a> Class ApplyHousing
...
```csharp
public class ApplyHousing : ApplyDTEntity, IOperation
```
...
### <a id="VM_Managed_DAFUL_GearTrain_Operation_ApplyHousing__ctor_VM_Managed_DAFUL_GearTrain_GearTrainDocument_VM_Managed_DAFUL_Dialog_GearTrain_BodyToDTData___System_Boolean_"></a> ApplyHousing\(GearTrainDocument, BodyToDTData\[\], bool\)

Initializes a new instance of the <xref href="VM.Managed.DAFUL.GearTrain.Operation.ApplyHousing" data-throw-if-not-resolved="false"></xref> class.

```csharp
public ApplyHousing(GearTrainDocument gearTrainDocument, BodyToDTData[] arData, bool bRefresh)
```
...
### <a id="VM_Managed_DAFUL_GearTrain_Operation_ApplyHousing__ctor_VM_Managed_Operation_JournalParameter_"></a> ApplyHousing\(JournalParameter\)

Initializes a new instance of the <xref href="VM.Managed.DAFUL.GearTrain.Operation.ApplyHousing" data-throw-if-not-resolved="false"></xref> class.

```csharp
public ApplyHousing(JournalParameter jp)
```
...
### <a id="VM_Managed_DAFUL_GearTrain_Operation_ApplyHousing_Name"></a> Name
...
### <a id="VM_Managed_DAFUL_GearTrain_Operation_ApplyHousing_Execute"></a> Execute\(\)
