# <a id="VM_Managed_DAFUL_AttributeUseFacetProperty"></a> Class AttributeUseFacetProperty
...
```csharp
public class AttributeUseFacetProperty : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public AttributeUseFacetProperty(bool bUse)
```
