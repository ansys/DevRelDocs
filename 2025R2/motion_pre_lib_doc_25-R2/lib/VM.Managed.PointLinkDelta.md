# <a id="VM_Managed_PointLinkDelta"></a> Class PointLinkDelta
...
[PointLink.m\_linkPoint](VM.Managed.PointLink.md\#VM\_Managed\_PointLink\_m\_linkPoint), 
[PointLink.IsParametric\(Primitive.enRefType\)](VM.Managed.PointLink.md\#VM\_Managed\_PointLink\_IsParametric\_VM\_Managed\_Primitive\_enRefType\_), 
[PointLink.GetFullName\(\)](VM.Managed.PointLink.md\#VM\_Managed\_PointLink\_GetFullName), 
...
[PointLink.IsParameterized](VM.Managed.PointLink.md\#VM\_Managed\_PointLink\_IsParameterized), 
[PointLink.Z](VM.Managed.PointLink.md\#VM\_Managed\_PointLink\_Z), 
[PointLink.Y](VM.Managed.PointLink.md\#VM\_Managed\_PointLink\_Y), 
[PointLink.X](VM.Managed.PointLink.md\#VM\_Managed\_PointLink\_X), 
[PointLink.Value](VM.Managed.PointLink.md\#VM\_Managed\_PointLink\_Value), 
...
```csharp
public PointLinkDelta(IPoint pPoint, Variable deltaX, Variable deltaY, Variable deltaZ)
```
...
`deltaX` [Variable](VM.Managed.Variable.md)

X of Delta.

`deltaY` [Variable](VM.Managed.Variable.md)

Y of Delta.

`deltaZ` [Variable](VM.Managed.Variable.md)
...
```csharp
public PointLinkDelta(IPoint pPoint, double deltaX, double deltaY, double deltaZ)
```
...
```csharp
public PointLinkDelta(IPoint pPoint)
```
...
```csharp
public PointLinkDelta(Variable deltaX, Variable deltaY, Variable deltaZ)
```
...
```csharp
public PointLinkDelta(double deltaX, double deltaY, double deltaZ)
```
...
```csharp
public Variable DeltaX { get; set; }
```
...
```csharp
public Variable DeltaZ { get; set; }
```
