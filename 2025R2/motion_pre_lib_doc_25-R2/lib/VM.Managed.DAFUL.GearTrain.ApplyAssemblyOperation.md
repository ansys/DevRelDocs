# <a id="VM_Managed_DAFUL_GearTrain_ApplyAssemblyOperation"></a> Class ApplyAssemblyOperation
...
```csharp
public class ApplyAssemblyOperation : OperationBase, IOperation
```
...
#### Field Value
 ...
 [ApplyAssemblyOperation](VM.Managed.DAFUL.GearTrain.ApplyAssemblyOperation.md).[ApplyCallback](VM.Managed.DAFUL.GearTrain.ApplyAssemblyOperation.ApplyCallback.md)
