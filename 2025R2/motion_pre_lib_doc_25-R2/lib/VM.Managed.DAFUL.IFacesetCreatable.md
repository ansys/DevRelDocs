# <a id="VM_Managed_DAFUL_IFacesetCreatable"></a> Interface IFacesetCreatable
...
```csharp
public interface IFacesetCreatable : IConnectableNotReference, IConnectable, IMarkerParent, IEntityRelation, IHasBody
```
