# <a id="VM_Managed_DAFUL_GearTrain_ToothThickness"></a> Class ToothThickness
...
```csharp
public class ToothThickness : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
