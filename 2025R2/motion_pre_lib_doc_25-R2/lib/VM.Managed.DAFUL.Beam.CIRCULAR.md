...
### <a id="VM_Managed_DAFUL_Beam_CIRCULAR__ctor"></a> CIRCULAR\(\)
...
### <a id="VM_Managed_DAFUL_Beam_CIRCULAR_GenerateMultiSection_System_Double___System_Int32_"></a> GenerateMultiSection\(double\[\], int\)
