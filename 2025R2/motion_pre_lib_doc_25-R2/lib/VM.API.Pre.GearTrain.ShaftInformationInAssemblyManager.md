# <a id="VM_API_Pre_GearTrain_ShaftInformationInAssemblyManager"></a> Struct ShaftInformationInAssemblyManager
...
```csharp
public struct ShaftInformationInAssemblyManager
```
...
```csharp
public ShaftInformationInAssemblyManager()
```
...
```csharp
public Obj BaseBody { readonly get; set; }
```
...
```csharp
public Obj PowerLoad { readonly get; set; }
```
