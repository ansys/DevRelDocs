# <a id="VM_Models_Pre_Force_TestBase"></a> Class TestBase

Namespace: [VM.Models.Pre.Force](VM.Models.Pre.Force.md)  
Assembly: VM.Models.Pre.Force.dll  

This class is to represent the Test.

```csharp
public abstract class TestBase : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public ExpressionValueVariable NegativeDirectionValue { get; set; }
```
...
```csharp
public ExpressionValueVariable PositiveDirectionValue { get; set; }
```
...
```csharp
public ExpressionValueVariable SimulationTime { get; set; }
```
