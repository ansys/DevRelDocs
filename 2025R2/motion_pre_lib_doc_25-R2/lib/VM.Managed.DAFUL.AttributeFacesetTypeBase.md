# <a id="VM_Managed_DAFUL_AttributeFacesetTypeBase"></a> Class AttributeFacesetTypeBase
...
```csharp
public abstract class AttributeFacesetTypeBase : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
