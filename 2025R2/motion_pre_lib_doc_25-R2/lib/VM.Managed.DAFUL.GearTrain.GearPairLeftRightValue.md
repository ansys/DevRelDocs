# <a id="VM_Managed_DAFUL_GearTrain_GearPairLeftRightValue"></a> Class GearPairLeftRightValue
...
```csharp
public class GearPairLeftRightValue : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
LeftRightValue list is null.
or
LeftRightValue list is null.
or
LeftRightValue is null.
