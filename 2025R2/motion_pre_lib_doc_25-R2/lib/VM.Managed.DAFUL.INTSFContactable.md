# <a id="VM_Managed_DAFUL_INTSFContactable"></a> Interface INTSFContactable
...
```csharp
public interface INTSFContactable : IContactable, IGeometricalComponent, IEntityRelation, IBodyAnalysisType, IHasBody
```
