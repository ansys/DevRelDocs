# <a id="VM_Managed_DAFUL_GearTrain_AttributeBodyToDTDocument"></a> Class AttributeBodyToDTDocument
...
```csharp
public class AttributeBodyToDTDocument : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
