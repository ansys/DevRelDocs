# <a id="VM_Managed_DAFUL_Thermal_FunctionAndUnit"></a> Class FunctionAndUnit
...
```csharp
public class FunctionAndUnit : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable, IReservable
```
...
```csharp
public FunctionAndUnit(ThermalUnitBase thermalUnit)
```

#### Parameters

`thermalUnit` [ThermalUnitBase](VM.Managed.DAFUL.Thermal.ThermalUnitBase.md)
