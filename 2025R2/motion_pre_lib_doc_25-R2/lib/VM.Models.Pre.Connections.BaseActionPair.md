# <a id="VM_Models_Pre_Connections_BaseActionPair"></a> Class BaseActionPair
...
```csharp
public class BaseActionPair : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public MultipleConnectorInfo ActionInformation { get; set; }
```
