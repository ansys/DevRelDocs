...
Entity<PropertyGearSet\>.Initialize\(Unit.ConvertFactor\), 
Entity<PropertyGearSet\>.GetUnnamedObjectName\(object\), 
Entity<PropertyGearSet\>.FindLocal\(string\), 
Entity<PropertyGearSet\>.Property, 
