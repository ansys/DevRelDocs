# <a id="VM_Managed_DAFUL_MeshFree_Operation_ShowMeshFreeBodyPropertyDlg"></a> Class ShowMeshFreeBodyPropertyDlg
...
```csharp
public class ShowMeshFreeBodyPropertyDlg : OperationBase, IOperation
```
