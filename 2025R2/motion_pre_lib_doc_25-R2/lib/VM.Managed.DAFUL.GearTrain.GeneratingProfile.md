# <a id="VM_Managed_DAFUL_GearTrain_GeneratingProfile"></a> Class GeneratingProfile
...
```csharp
public class GeneratingProfile : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public GearPairValue PairGeneratingProfileShiftMinCoefficient { get; set; }
```
