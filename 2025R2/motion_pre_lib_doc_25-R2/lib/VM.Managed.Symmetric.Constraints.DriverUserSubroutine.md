# <a id="VM_Managed_Symmetric_Constraints_DriverUserSubroutine"></a> Class DriverUserSubroutine

Namespace: [VM.Managed.Symmetric.Constraints](VM.Managed.Symmetric.Constraints.md)  
Assembly: VMSymCB.dll  

```csharp
public class DriverUserSubroutine : Driver, ISymmetricBuilder
```
...
### <a id="VM_Managed_Symmetric_Constraints_DriverUserSubroutine__ctor"></a> DriverUserSubroutine\(\)
...
### <a id="VM_Managed_Symmetric_Constraints_DriverUserSubroutine_Build_System_Object_VM_Managed_SymmetricType_VM_Plane_VM_Managed_Document_"></a> Build\(object, SymmetricType, Plane, Document\)
