![](media/7dcc41a06c31d21e90b4ca421e9d0a86.jpeg)
...
2.  Creating TD Models
    ...
    1.  Hello World (Start TD and Create a Node)
...
1.  Create Nodes and a Conductor
...
1.  Use a Loop to Create Many Layers, Nodes, and Conductors
...
1.  Create and Position Finite-Difference Surfaces and Solids
...
1.  Additional Information on Positioning Entities using BaseTrans and LocalTrans
...
1.  Work with Connections, Handles, Markers, and Domains
...
1.  Work with Units, Symbols, and Expressions
...
1.  Create Thermophysical Properties using Bivariate Arrays
...
The variable “arithmeticNodes” would now be an *IEnumerable\<Node\>* containing all of the arithmetic nodes on layer “sheet”.[^2]
...
1.  Query and Edit Finite Elements
...
1.  Working with the Selection Set
...
1.  Miscellaneous End-User Interaction Techniques
...
1.  Create an Orbit and Apply it to a Case Set
...
1.  Communicating with SINDA/FLUINT
...
3.  You can create and modify contour plots and other post-processing output within a TD instance.
    ...
    1.  Work Directly with Results using OpenTDv241.Results
        ...
        1.  Before using OpenTDv241.Results
...
1.  Advanced Results Manipulation and XY Plots
...
![](media/16ae466d28b3584b1dcbdf90484ad0bd.png)

1.  Work with Groups in Results Data
...
1.  Get Model Topology from Solution Results
...
1.  Calculate Heat Rates between Groups
...
1.  Work with Datasets in TD using OpenTDv241.PostProcessing
...
1.  Launching Programs in the Thermal Desktop Process using Add-Ins
...
2.  Extras
    1.  Control how OpenTD Connects to Thermal Desktop
...
1.  Control OpenTD Servers from AutoCAD
...
-   SendLegacyComCommand("case rad0 rad3 cc") // Calculates 1st and 4th radation tasks and cond/cap data.
    ...
    **Updates all entity values based on symbol expressions.
    ...
    1.  The Magic of Implicit Casting
...
1.  Appendix A: Using OpenTD with MATLAB
...
1.  Appendix B: Using OpenTD with Python
...
1.  Appendix C: Using OpenTD with Powershell
...
1.  Appendix D: Using OpenTD Interactively with the C\# Interactive Compiler
