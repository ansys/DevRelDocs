...
Kinetics_ utilities. The general flow of information is depicted in <a href="pgfId-1017373.md#i62358">Figure 1.3: Relationships between the CHEMKIN Pre-processors and an Application</a>. The _Transport_ utilities can be
