...
- **Pin 10** item_index (type: ['int32']) (optional: True): Index of requested item.

- **Pin 11** num_components (type: ['int32']) (optional: True): Number of components for the requested item.
