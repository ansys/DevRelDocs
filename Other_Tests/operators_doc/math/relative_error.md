...
- **Pin 0** value (type: ['field', 'fields_container', 'double', 'vector<double>']) (optional: False): field or fields container with only one field is expected

- **Pin 1** reference (type: ['field', 'fields_container', 'double', 'vector<double>']) (optional: False): field or fields container with only one field is expected
...
- **Pin 1** zero_ref_scoping (type: ['scoping']): Ids of entities where reference value is zero.

- **Pin 2** no_ref_scoping (type: ['scoping']): Ids of entities where there are no reference value.
