...
| <strong>Pin 200</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  custom_ponderation_name |[`string`](../../getting-started/using-data-containers.md#string) | take custom ponderation_field from the topo file by name |
