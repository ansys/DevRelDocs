...
- **Pin 7** mesh (type: ['abstract_meshed_region', 'meshes_container']) (optional: True): mesh. If cylic expansion is to be done, mesh of the base sector
...
- **Pin 15** expanded_meshed_region (type: ['abstract_meshed_region', 'meshes_container']) (optional: True): mesh expanded, use if cyclic expansion is to be done.

- **Pin 18** sectors_to_expand (type: ['vector<int32>', 'scoping', 'scopings_container']) (optional: True): sectors to expand (start at 0), for multistage: use scopings container with 'stage' label, use if cyclic expansion is to be done.

- **Pin 19** phi (type: ['double']) (optional: True): angle phi in degrees (default value 0.0), use if cyclic expansion is to be done.
