...
> ##### Objective
> 
> Given a set of geometrical, material, and loading parameters, the goal of the application is to predict the deformed state of the beam subjected to a concentrated load P.
