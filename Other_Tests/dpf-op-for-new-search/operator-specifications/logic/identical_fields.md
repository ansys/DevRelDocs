...
| <strong>Pin 2</strong> | double_value |[`double`](../../core-concepts/dpf-types.md#double) | Double positive small value. Smallest value which will be considered during the comparison step. All the abs(values) in the field less than this value are considered as null, (default value:1.0e-14). |
