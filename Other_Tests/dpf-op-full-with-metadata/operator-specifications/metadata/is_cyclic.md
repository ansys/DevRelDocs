...
|-------|------|------------------|-------------|
| <strong>Pin 0</strong> <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span> | file_path |[`string`](../../getting-started/using-data-containers.md#string) | returns 'single_stage' or 'multi_stage' or an empty string for non cyclic model |
