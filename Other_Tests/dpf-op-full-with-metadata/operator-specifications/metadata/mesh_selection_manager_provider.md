...
|-------|------|------------------|-------------|
| <strong>Pin 0</strong> <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span> | mesh_selection_manager |[`mesh_selection_manager`](../../getting-started/using-data-containers.md#mesh-selection-manager) |  |
