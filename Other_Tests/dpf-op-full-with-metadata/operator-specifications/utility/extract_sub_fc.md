...
| <strong>Pin 2</strong>|  collapse_labels |[`bool`](../../getting-started/using-data-containers.md#bool) | If set to true (default) the input label space (scoping location) is suppressed from the output fields container, otherwise, label space is kept. |
