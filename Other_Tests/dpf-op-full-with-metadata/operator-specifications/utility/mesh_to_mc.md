...
| <strong>Pin 1</strong> <span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  label |[`label_space`](../../getting-started/using-data-containers.md#label-space) | Sets a label space. |
