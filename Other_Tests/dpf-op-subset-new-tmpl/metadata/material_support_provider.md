...
| **Pin 4** | data_sources |[`data_sources`](../getting-started/using-data-containers.md#data-sources) | Yes | if the stream is null, get the file path from the data sources. |
...
|---------|--------|----------------|-----------|---------------|---------|
| **metadata** | core | material_support_provider | metadata.material_support_provider | mat_support_provider | None |
