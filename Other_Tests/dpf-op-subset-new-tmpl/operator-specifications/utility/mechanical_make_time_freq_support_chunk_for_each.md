...
|-------|-----|------|----------|-------------|
| **Pin 0** | target_time_freq_support |[`time_freq_support`](../../getting-started/using-data-containers.md#time-freq-support) | Yes | List of time freq support to potentially split in chunks. |
...
| **Pin 7** | abstract_meshed_region |[`abstract_meshed_region`](../../getting-started/using-data-containers.md#abstract-meshed-region), [`field`](../../getting-started/using-data-containers.md#field) | Yes | When a mesh is provided, the number of nodes (for "Nodal" results) or number of elements (for "Elemental" results) is used to compute the chunk. When a field is provided, its scoping size is used to compute the chunk. |
...
|---------|--------|----------------|-----------|---------------|---------|
| **utility** | core | None | None | mechanical::make_time_freq_support_chunk_for_each | None |
