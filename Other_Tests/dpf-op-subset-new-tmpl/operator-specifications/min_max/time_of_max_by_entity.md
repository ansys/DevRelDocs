...
| **Pin 3** | abs_value |[`bool`](../../getting-started/using-data-containers.md#bool) | No | Should use absolute value. |
...
|---------|--------|----------------|-----------|---------------|---------|
| **min_max** | core | None | None | time_of_max_by_entity | any_dpf_supported_increments |
