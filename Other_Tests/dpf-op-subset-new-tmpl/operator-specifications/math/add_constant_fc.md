...
| **Pin 1** | ponderation |[`double`](../../getting-started/using-data-containers.md#double), [`vector<double>`](../../getting-started/using-data-containers.md#vector<double>) | Yes | double or vector of double |
...
|---------|--------|----------------|-----------|---------------|---------|
| **math** | core | add_constant_fc | math.add_constant_fc | add_constant_fc | None |
