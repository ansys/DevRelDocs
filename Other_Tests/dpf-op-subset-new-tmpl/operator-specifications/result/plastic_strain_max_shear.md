...
| **Pin 9** | requested_location |[`string`](../../getting-started/using-data-containers.md#string) | No |  |
...
|---------|--------|----------------|-----------|---------------|---------|
| **result** | core | plastic_strain_max_shear | result.plastic_strain_max_shear | EPPL_max_shear | None |
