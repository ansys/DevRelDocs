...
| **Pin 6** | all_dofs |[`bool`](../../getting-started/using-data-containers.md#bool) | No | default is false. |
...
|---------|--------|----------------|-----------|---------------|---------|
| **result** | mapdl | cyclic_equivalent_mass | result.cyclic_equivalent_mass | mapdl::rst::equivalent_mass_cyclic | None |
