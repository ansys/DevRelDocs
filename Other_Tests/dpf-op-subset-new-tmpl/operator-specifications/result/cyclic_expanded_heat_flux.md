...
| **Pin 19** | phi |[`double`](../../getting-started/using-data-containers.md#double) | No | phi angle (default value 0.0) |
...
|---------|--------|----------------|-----------|---------------|---------|
| **result** | mapdl | cyclic_expanded_heat_flux | result.cyclic_expanded_heat_flux | mapdl::rth::TF_cyclic | None |
