...
|---------|--------|----------------|-----------|---------------|---------|
| **result** | core | element_nodal_forces | result.element_nodal_forces | ENF | None |
