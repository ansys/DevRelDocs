...
| **Pin 13** | poisson_ratio |[`double`](../getting-started/using-data-containers.md#double), [`int32`](../getting-started/using-data-containers.md#int32) | Yes | Poisson ratio to be used in equivalent strain calculation. |
...
|---------|--------|----------------|-----------|---------------|---------|
| **invariant** | core | von_mises_eqv_fc | invariant.von_mises_eqv_fc | eqv_fc | None |
