...
| **Pin 1** | zero_ref_scoping |[`scoping`](../getting-started/using-data-containers.md#scoping) | Yes | Ids of entities where reference value is zero. |
| **Pin 2** | no_ref_scoping |[`scoping`](../getting-started/using-data-containers.md#scoping) | Yes | Ids of entities where there are no reference value. |
...
|---------|--------|----------------|-----------|---------------|---------|
| **math** | core | None | None | relative_error | None |
