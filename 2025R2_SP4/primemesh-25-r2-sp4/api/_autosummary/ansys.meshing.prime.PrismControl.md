...
| Name | Description |
|--------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|
| [`PrismControl.get_growth_params`](ansys.meshing.prime.PrismControl.get_growth_params.md#ansys.meshing.prime.PrismControl.get_growth_params)()         | Gets the prism parameters for prism control.                            |
...
| [`PrismControl.set_suggested_name`](ansys.meshing.prime.PrismControl.set_suggested_name.md#ansys.meshing.prime.PrismControl.set_suggested_name)(name)  | Sets the unique name for the prism control based on the suggested name. |
