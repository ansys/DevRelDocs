...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WriteMaterialArrudaBoyce_System_IO_BinaryWriter_VM_Models_FE_Utilities_MaterialAB_System_Int32_"></a> WriteMaterialArrudaBoyce\(BinaryWriter, MaterialAB, int\)

```csharp
public static void WriteMaterialArrudaBoyce(BinaryWriter writer, MaterialAB mat, int nIndex)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WriteMaterialISO_System_IO_BinaryWriter_VM_Models_FE_Utilities_MaterialISO_System_Int32_"></a> WriteMaterialISO\(BinaryWriter, MaterialISO, int\)

```csharp
public static void WriteMaterialISO(BinaryWriter writer, MaterialISO mat, int nIndex)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WriteMaterialMooneyRivlin_System_IO_BinaryWriter_VM_Models_FE_Utilities_MaterialMR_System_Int32_"></a> WriteMaterialMooneyRivlin\(BinaryWriter, MaterialMR, int\)

```csharp
public static void WriteMaterialMooneyRivlin(BinaryWriter writer, MaterialMR mat, int nIndex)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WriteMaterialNeoHookean_System_IO_BinaryWriter_VM_Models_FE_Utilities_MaterialNH_System_Int32_"></a> WriteMaterialNeoHookean\(BinaryWriter, MaterialNH, int\)

```csharp
public static void WriteMaterialNeoHookean(BinaryWriter writer, MaterialNH mat, int nIndex)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WriteMaterialORTHO_System_IO_BinaryWriter_VM_Models_FE_Utilities_MaterialORTHO_System_Int32_"></a> WriteMaterialORTHO\(BinaryWriter, MaterialORTHO, int\)

```csharp
public static void WriteMaterialORTHO(BinaryWriter writer, MaterialORTHO mat, int nIndex)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WriteMaterialOgden_System_IO_BinaryWriter_VM_Models_FE_Utilities_MaterialOG_System_Int32_"></a> WriteMaterialOgden\(BinaryWriter, MaterialOG, int\)

```csharp
public static void WriteMaterialOgden(BinaryWriter writer, MaterialOG mat, int nIndex)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WritePropertyBeam_System_IO_BinaryWriter_VM_Models_FE_Utilities_FEPropertyBeam_System_Int32_"></a> WritePropertyBeam\(BinaryWriter, FEPropertyBeam, int\)

```csharp
public static void WritePropertyBeam(BinaryWriter writer, FEPropertyBeam prop, int nIndex)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WritePropertyBeamL_System_IO_BinaryWriter_VM_Models_FE_Utilities_FEPropertyBeamL_System_Int32_"></a> WritePropertyBeamL\(BinaryWriter, FEPropertyBeamL, int\)

```csharp
public static void WritePropertyBeamL(BinaryWriter writer, FEPropertyBeamL prop, int nIndex)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WritePropertyShell_System_IO_BinaryWriter_VM_Models_FE_Utilities_FEPropertyShell_System_Int32_"></a> WritePropertyShell\(BinaryWriter, FEPropertyShell, int\)

```csharp
public static void WritePropertyShell(BinaryWriter writer, FEPropertyShell prop, int nIndex)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WritePropertySolid_System_IO_BinaryWriter_VM_Models_FE_Utilities_FEPropertySolid_System_Int32_"></a> WritePropertySolid\(BinaryWriter, FEPropertySolid, int\)

```csharp
public static void WritePropertySolid(BinaryWriter writer, FEPropertySolid prop, int nIndex)
```
