...
designdata.subsets.clear()
designdata.subsets.add('Metals')
```
...
record = designdata.create_record(recordName)
...
*Previous cell output:*
```output
[<Record long name: STK Example 8:Wed Oct 30 16:05:46 2024>]
```
