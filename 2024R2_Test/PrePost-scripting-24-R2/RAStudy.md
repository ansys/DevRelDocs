...
#### ExtendSimulation(extension_amount: float | barril.units._scalar.Scalar = 0, time: Optional[Union[TimeStep, int]] = None, inlet_extensions: Optional[list[tuple[str, Union[float, barril.units._scalar.Scalar]]]] = None)
...
#### StartSimulation(skip_summary: bool | None = False, delete_results: bool | None = False)
