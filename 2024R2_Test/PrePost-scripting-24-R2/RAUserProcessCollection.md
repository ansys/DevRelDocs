<a id="rauserprocesscollection"></a>
...
#### CreatePolyhedronProcess(parent: ApiElementItem, stl_filename: str, name: Optional[str] = None, import_scale: float = 1.0, convert_yz: bool = False)
...
#### CreateStreamlinesUserProcess(parent: ApiElementItem, name: Optional[str] = None)
