# <a id="VM_Managed_DAFUL_Operation_SymmetricUpdateOperation"></a> Class SymmetricUpdateOperation
...
```csharp
public class SymmetricUpdateOperation : OperationBase, IOperation
```
