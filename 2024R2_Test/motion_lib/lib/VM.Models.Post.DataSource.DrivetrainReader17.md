# <a id="VM_Models_Post_DataSource_DrivetrainReader17"></a> Class DrivetrainReader17

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DrivetrainReader17 : DrivetrainReader, IDriveTrainReader
```
...
### <a id="VM_Models_Post_DataSource_DrivetrainReader17__ctor"></a> DrivetrainReader17\(\)

```csharp
public DrivetrainReader17()
```

## Methods

### <a id="VM_Models_Post_DataSource_DrivetrainReader17_ReadAssemblyManagerInfo_VM_Models_Post_ResultDocument_VM_Identifier_VM_Models_Post_IDriveTrain___System_String_"></a> ReadAssemblyManagerInfo\(ResultDocument, Identifier, IDriveTrain\[\], string\)
