# <a id="VM_Models_Post_Materials_LinearOrthogonal"></a> Class LinearOrthogonal

Namespace: [VM.Models.Post.Materials](VM.Models.Post.Materials.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class LinearOrthogonal : MaterialBase, IObservableObject, IDisposableObject, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_Materials_LinearOrthogonal__ctor"></a> LinearOrthogonal\(\)

```csharp
public LinearOrthogonal()
```

## Properties

### <a id="VM_Models_Post_Materials_LinearOrthogonal_Density"></a> Density
...
### <a id="VM_Models_Post_Materials_LinearOrthogonal_PoissonRatio"></a> PoissonRatio
...
### <a id="VM_Models_Post_Materials_LinearOrthogonal_Zeta"></a> Zeta
