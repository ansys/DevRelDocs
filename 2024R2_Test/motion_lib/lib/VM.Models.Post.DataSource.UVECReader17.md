# <a id="VM_Models_Post_DataSource_UVECReader17"></a> Class UVECReader17

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class UVECReader17 : UVECReader, IUVECReader
```
...
### <a id="VM_Models_Post_DataSource_UVECReader17__ctor_System_String_"></a> UVECReader17\(string\)

```csharp
public UVECReader17(string filePath)
```
