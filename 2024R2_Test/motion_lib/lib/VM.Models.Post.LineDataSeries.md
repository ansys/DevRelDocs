# <a id="VM_Models_Post_LineDataSeries"></a> Class LineDataSeries

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class LineDataSeries : LineDataSeriesBase, IObservableObject, IDisposableObject, ISeries, IObject, IHasName
```
...
### <a id="VM_Models_Post_LineDataSeries_LineSeriesType"></a> LineSeriesType
...
### <a id="VM_Models_Post_LineDataSeries_NeedSavePoints"></a> NeedSavePoints
...
### <a id="VM_Models_Post_LineDataSeries_PlotDataType"></a> PlotDataType
...
### <a id="VM_Models_Post_LineDataSeries_XUserDefinedAxisDataSet"></a> XUserDefinedAxisDataSet

```csharp
public UserDefinedAxisDataSet XUserDefinedAxisDataSet { get; set; }
```
...
### <a id="VM_Models_Post_LineDataSeries_YUserDefinedAxisDataSet"></a> YUserDefinedAxisDataSet

```csharp
public UserDefinedAxisDataSet YUserDefinedAxisDataSet { get; set; }
```
