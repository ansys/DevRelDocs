# <a id="VM_Models_Post_InterpolationLineDataSeries"></a> Class InterpolationLineDataSeries

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class InterpolationLineDataSeries : HasOriginalSeries, IObservableObject, IDisposableObject, ISeries, IObject, IHasName
```
...
### <a id="VM_Models_Post_InterpolationLineDataSeries_LineSeriesType"></a> LineSeriesType
...
### <a id="VM_Models_Post_InterpolationLineDataSeries_PointCount"></a> PointCount
