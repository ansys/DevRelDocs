# <a id="VM_Models_Post_DataSource_DFEIGReader19"></a> Class DFEIGReader19

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFEIGReader19 : DFEIGTextReader, IDFEIGReader
```
...
[DFEIGReader19](VM.Models.Post.DataSource.DFEIGReader19.md)
...
### <a id="VM_Models_Post_DataSource_DFEIGReader19__ctor"></a> DFEIGReader19\(\)

```csharp
public DFEIGReader19()
```
