# <a id="VM_Models_Post_DataSource_DFGReader19"></a> Class DFGReader19

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFGReader19 : DFGReader, IDFGReader
```
...
### <a id="VM_Models_Post_DataSource_DFGReader19__ctor"></a> DFGReader19\(\)
