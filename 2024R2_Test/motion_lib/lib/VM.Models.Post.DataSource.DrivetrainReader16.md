# <a id="VM_Models_Post_DataSource_DrivetrainReader16"></a> Class DrivetrainReader16

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DrivetrainReader16 : DrivetrainReader, IDriveTrainReader
```
...
### <a id="VM_Models_Post_DataSource_DrivetrainReader16__ctor"></a> DrivetrainReader16\(\)

```csharp
public DrivetrainReader16()
```

## Methods

### <a id="VM_Models_Post_DataSource_DrivetrainReader16_ReadAssemblyManagerInfo_VM_Models_Post_ResultDocument_VM_Identifier_VM_Models_Post_IDriveTrain___System_String_"></a> ReadAssemblyManagerInfo\(ResultDocument, Identifier, IDriveTrain\[\], string\)
