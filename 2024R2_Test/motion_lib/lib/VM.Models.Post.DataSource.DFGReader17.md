# <a id="VM_Models_Post_DataSource_DFGReader17"></a> Class DFGReader17

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFGReader17 : DFGReader, IDFGReader
```
...
### <a id="VM_Models_Post_DataSource_DFGReader17__ctor"></a> DFGReader17\(\)
...
### <a id="VM_Models_Post_DataSource_DFGReader17_ReadModalGeometryData_System_Int32__VM_Models_Post_MetaInfo_System_Int32__"></a> ReadModalGeometryData\(ref int, MetaInfo, ref int\)
