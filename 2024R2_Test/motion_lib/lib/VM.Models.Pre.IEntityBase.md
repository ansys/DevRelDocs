# <a id="VM_Models_Pre_IEntityBase"></a> Interface IEntityBase
...
```csharp
public interface IEntityBase : IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, IHasName, IEnabled, IHasComment
```
