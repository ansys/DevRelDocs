# <a id="VM_Models_Post_FEProperties_SolidProperty"></a> Class SolidProperty

Namespace: [VM.Models.Post.FEProperties](VM.Models.Post.FEProperties.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class SolidProperty : FEPropertyBase, IObservableObject, IDisposableObject, ISolidProperty, IFEProperty, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
IObservableObject, 
IDisposableObject, 
[ISolidProperty](VM.Models.Post.ISolidProperty.md), 
...
### <a id="VM_Models_Post_FEProperties_SolidProperty__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_"></a> SolidProperty\(ResultDocument, Identifier, string\)

```csharp
public SolidProperty(ResultDocument parentDocument, Identifier analysisResultID, string fullName)
```
...
### <a id="VM_Models_Post_FEProperties_SolidProperty_Orientation"></a> Orientation
...
### <a id="VM_Models_Post_FEProperties_SolidProperty_Clone"></a> Clone\(\)
