# <a id="VM_Models_Post_DataSource_UVECReader23"></a> Class UVECReader23

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class UVECReader23 : UVECReader, IUVECReader
```
...
### <a id="VM_Models_Post_DataSource_UVECReader23__ctor_System_String_"></a> UVECReader23\(string\)

```csharp
public UVECReader23(string filePath)
```
