# <a id="VM_Models_Post_ActuatorUSER"></a> Class ActuatorUSER

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class ActuatorUSER : ActuatorBase, IObservableObject, IDisposableObject, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_ActuatorUSER__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_"></a> ActuatorUSER\(ResultDocument, Identifier, string\)

```csharp
public ActuatorUSER(ResultDocument parentDocument, Identifier analysisResultID, string fullName)
```
...
### <a id="VM_Models_Post_ActuatorUSER_Omega"></a> Omega
...
### <a id="VM_Models_Post_ActuatorUSER_PhaseAngle"></a> PhaseAngle
