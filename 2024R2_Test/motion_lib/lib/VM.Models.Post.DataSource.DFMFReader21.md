# <a id="VM_Models_Post_DataSource_DFMFReader21"></a> Class DFMFReader21

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMFReader21 : DFMFReader, IDFMFReader
```
...
### <a id="VM_Models_Post_DataSource_DFMFReader21__ctor"></a> DFMFReader21\(\)
