# <a id="VM_Models_Post_FFTLineDataSeries"></a> Class FFTLineDataSeries

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class FFTLineDataSeries : HasOriginalSeries, IObservableObject, IDisposableObject, ISeries, IObject, IHasName
```
...
### <a id="VM_Models_Post_FFTLineDataSeries_End"></a> End
...
### <a id="VM_Models_Post_FFTLineDataSeries_FFTScaleType"></a> FFTScaleType

```csharp
[SaveProperty(false)]
public ScaleType FFTScaleType { get; set; }
```
...
### <a id="VM_Models_Post_FFTLineDataSeries_FFTType"></a> FFTType
...
### <a id="VM_Models_Post_FFTLineDataSeries_FFTWindowType"></a> FFTWindowType

```csharp
[SaveProperty(false)]
public FFTWindowType FFTWindowType { get; set; }
```
...
### <a id="VM_Models_Post_FFTLineDataSeries_LineSeriesType"></a> LineSeriesType
...
### <a id="VM_Models_Post_FFTLineDataSeries_SelectedCharacteristic"></a> SelectedCharacteristic
...
### <a id="VM_Models_Post_FFTLineDataSeries_SelectedComponent"></a> SelectedComponent
...
### <a id="VM_Models_Post_FFTLineDataSeries_SelectedCoordinateSystem"></a> SelectedCoordinateSystem

```csharp
[SaveProperty(false)]
public string SelectedCoordinateSystem { get; set; }
```
...
### <a id="VM_Models_Post_FFTLineDataSeries_SelectedPoints"></a> SelectedPoints
...
### <a id="VM_Models_Post_FFTLineDataSeries_Start"></a> Start
