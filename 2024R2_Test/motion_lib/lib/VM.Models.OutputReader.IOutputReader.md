# <a id="VM_Models_OutputReader_IOutputReader"></a> Interface IOutputReader
...
### <a id="VM_Models_OutputReader_IOutputReader_GetFlexibleBodyReferenceFrame_System_String_"></a> GetFlexibleBodyReferenceFrame\(string\)

```csharp
IList<double[]> GetFlexibleBodyReferenceFrame(string target)
```
