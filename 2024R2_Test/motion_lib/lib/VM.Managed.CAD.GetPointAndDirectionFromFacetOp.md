# <a id="VM_Managed_CAD_GetPointAndDirectionFromFacetOp"></a> Class GetPointAndDirectionFromFacetOp
...
```csharp
public class GetPointAndDirectionFromFacetOp : OperationBase, IOperation
```
...
### <a id="VM_Managed_CAD_GetPointAndDirectionFromFacetOp__ctor_VM_Managed_CAD_Face_VM_Managed_VectorBase_VM_Managed_VectorBase_"></a> GetPointAndDirectionFromFacetOp\(Face, VectorBase, VectorBase\)

```csharp
public GetPointAndDirectionFromFacetOp(Face face, VectorBase vecPoint, VectorBase vecDirection)
```
