# <a id="VM_Models_Post_DataSource_DFMFReader23"></a> Class DFMFReader23

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMFReader23 : DFMFReader, IDFMFReader
```
...
### <a id="VM_Models_Post_DataSource_DFMFReader23__ctor"></a> DFMFReader23\(\)
