# <a id="VM_Managed_DAFUL_Car_SuspensionDocument"></a> Class SuspensionDocument
...
DocumentAnalysis ← 
SubSystemDocument ← 
[SuspensionDocument](VM.Managed.DAFUL.Car.SuspensionDocument.md)
...
```csharp
public SuspensionDocument(UIntPtr docCore)
```
...
```csharp
[Obsolete]
public ObjectBase ICoordRef { get; set; }
```
...
```csharp
public ObjectBase ICoordRefOfSetUp { get; set; }
```
...
```csharp
[Obsolete]
public ObjectBase IPart { get; set; }
```
...
```csharp
[Obsolete]
public ObjectBase JCoordRef { get; set; }
```
...
```csharp
public ObjectBase JCoordRefOfSetUp { get; set; }
```
...
```csharp
public ObjectBase JPartOfSetUp { get; set; }
```
...
```csharp
public Linker<ObjectBase> _ICoordRefOfSetUp { get; set; }
```
...
```csharp
public Linker<ObjectBase> _JCoordRefOfSetUp { get; set; }
```
...
```csharp
public Linker<ObjectBase> _JPartOfSetUp { get; set; }
```
