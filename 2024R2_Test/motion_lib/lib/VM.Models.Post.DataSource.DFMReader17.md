# <a id="VM_Models_Post_DataSource_DFMReader17"></a> Class DFMReader17

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMReader17 : DFMReader, IDFMReader, IDFMInfo
```
...
### <a id="VM_Models_Post_DataSource_DFMReader17__ctor"></a> DFMReader17\(\)
...
### <a id="VM_Models_Post_DataSource_DFMReader17_BuildModels_VM_Models_Post_ResultDocument_System_String_VM_Models_Post_IDFRReader_VM_Identifier_"></a> BuildModels\(ResultDocument, string, IDFRReader, Identifier\)
...
### <a id="VM_Models_Post_DataSource_DFMReader17_ReadFEMaterial_VM_Models_Post_MetaInfo_System_String_System_Int32__"></a> ReadFEMaterial\(MetaInfo, string, ref int\)
