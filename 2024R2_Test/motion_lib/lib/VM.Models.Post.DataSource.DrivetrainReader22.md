# <a id="VM_Models_Post_DataSource_DrivetrainReader22"></a> Class DrivetrainReader22

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DrivetrainReader22 : DrivetrainReader, IDriveTrainReader
```
...
### <a id="VM_Models_Post_DataSource_DrivetrainReader22__ctor"></a> DrivetrainReader22\(\)

```csharp
public DrivetrainReader22()
```
