# <a id="VM_Managed_DAFUL_GearTrain_HiddenHousingMeshFreeDocument"></a> Class HiddenHousingMeshFreeDocument
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenHousingMeshFreeDocument__ctor_System_UIntPtr_"></a> HiddenHousingMeshFreeDocument\(UIntPtr\)

Initializes a new instance of the <xref href="VM.Managed.DAFUL.GearTrain.HiddenHousingMeshFreeDocument" data-throw-if-not-resolved="false"></xref> class.

```csharp
public HiddenHousingMeshFreeDocument(UIntPtr docCore)
```
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenHousingMeshFreeDocument_InitialCategories"></a> InitialCategories
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenHousingMeshFreeDocument_FindCategory_System_String_"></a> FindCategory\(string\)
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenHousingMeshFreeDocument_InitializeCategoryInfo_System_String_"></a> InitializeCategoryInfo\(string\)
