# <a id="VM_Models_Pre_Durability_AttributeDocumentDurability_DynamicResult"></a> Class AttributeDocumentDurability.DynamicResult
...
```csharp
public class AttributeDocumentDurability.DynamicResult : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
LinkableBase ← 
LinkContainer ← 
[AttributeDocumentDurability.DynamicResult](VM.Models.Pre.Durability.AttributeDocumentDurability.DynamicResult.md)
