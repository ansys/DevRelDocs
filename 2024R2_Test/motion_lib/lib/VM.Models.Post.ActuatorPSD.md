# <a id="VM_Models_Post_ActuatorPSD"></a> Class ActuatorPSD

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class ActuatorPSD : ActuatorBase, IObservableObject, IDisposableObject, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
[ActuatorPSD](VM.Models.Post.ActuatorPSD.md)
...
### <a id="VM_Models_Post_ActuatorPSD__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_"></a> ActuatorPSD\(ResultDocument, Identifier, string\)

```csharp
public ActuatorPSD(ResultDocument parentDocument, Identifier analysisResultID, string fullName)
```
...
### <a id="VM_Models_Post_ActuatorPSD_InputType"></a> InputType
...
### <a id="VM_Models_Post_ActuatorPSD_InterpolationType"></a> InterpolationType
...
#### Property Value
 ...
 [InterpolationType](VM.Models.Post.InterpolationType.md)

### <a id="VM_Models_Post_ActuatorPSD_PhaseAngle"></a> PhaseAngle
...
### <a id="VM_Models_Post_ActuatorPSD_PhaseAngleInterpolationType"></a> PhaseAngleInterpolationType

```csharp
public InterpolationType? PhaseAngleInterpolationType { get; set; }
```
...
### <a id="VM_Models_Post_ActuatorPSD_PhaseAngleSplineIndex"></a> PhaseAngleSplineIndex

```csharp
public int? PhaseAngleSplineIndex { get; set; }
```
...
### <a id="VM_Models_Post_ActuatorPSD_SplineIndex"></a> SplineIndex
