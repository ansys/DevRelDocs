# <a id="VM_Managed_DAFUL_ClearanceRevolute"></a> Class ClearanceRevolute

Namespace: [VM.Managed.DAFUL](VM.Managed.DAFUL.md)  
Assembly: VMDCB.dll  

```csharp
public class ClearanceRevolute : Clearance, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable, ILinkOwner, ILinkUpdateOwner
```
