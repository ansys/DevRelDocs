# <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetPlanetaryDPDocument"></a> Class HiddenGearSetPlanetaryDPDocument
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetPlanetaryDPDocument__ctor_System_UIntPtr_"></a> HiddenGearSetPlanetaryDPDocument\(UIntPtr\)

Initializes a new instance of the <xref href="VM.Managed.DAFUL.GearTrain.HiddenGearSetPlanetaryDPDocument" data-throw-if-not-resolved="false"></xref> class.
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetPlanetaryDPDocument_InitialCategories"></a> InitialCategories
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetPlanetaryDPDocument_NumberOfLOA"></a> NumberOfLOA
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetPlanetaryDPDocument_FindCategory_System_String_"></a> FindCategory\(string\)
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetPlanetaryDPDocument_GetCenterY_System_Double___"></a> GetCenterY\(double\[\]\)
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetPlanetaryDPDocument_GetExternalState_System_Boolean___"></a> GetExternalState\(bool\[\]\)
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetPlanetaryDPDocument_InitializeCategoryInfo_System_String_"></a> InitializeCategoryInfo\(string\)
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetPlanetaryDPDocument_MakeXmlForDocumentPropertyGridForLOA_System_Xml_XmlDocument_System_String__System_Text_StringBuilder_"></a> MakeXmlForDocumentPropertyGridForLOA\(XmlDocument, ref string, StringBuilder\)
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetPlanetaryDPDocument_Show2DimensionCore_System_Int32_System_Boolean___System_Double___System_Double___"></a> Show2DimensionCore\(int, bool\[\], double\[\], double\[\]\)
