# <a id="VM_Models_Post_FEProperties_ShellProperty"></a> Class ShellProperty

Namespace: [VM.Models.Post.FEProperties](VM.Models.Post.FEProperties.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class ShellProperty : FEPropertyBase, IObservableObject, IDisposableObject, IShellProperty, IFEProperty, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
IObservableObject, 
IDisposableObject, 
[IShellProperty](VM.Models.Post.IShellProperty.md), 
...
### <a id="VM_Models_Post_FEProperties_ShellProperty__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_"></a> ShellProperty\(ResultDocument, Identifier, string\)

```csharp
public ShellProperty(ResultDocument parentDocument, Identifier analysisResultID, string fullName)
```
...
### <a id="VM_Models_Post_FEProperties_ShellProperty_Orientation"></a> Orientation
...
### <a id="VM_Models_Post_FEProperties_ShellProperty_Thickness"></a> Thickness
...
### <a id="VM_Models_Post_FEProperties_ShellProperty_Clone"></a> Clone\(\)
