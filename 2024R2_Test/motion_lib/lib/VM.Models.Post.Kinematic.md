# <a id="VM_Models_Post_Kinematic"></a> Class Kinematic

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class Kinematic : RequestBase, IObservableObject, IDisposableObject, IRequest, IPlottable, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_Kinematic__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_"></a> Kinematic\(ResultDocument, Identifier, string\)

```csharp
public Kinematic(ResultDocument parentDocument, Identifier analysisResultID, string fullName)
```
...
### <a id="VM_Models_Post_Kinematic_PlottableType"></a> PlottableType
...
### <a id="VM_Models_Post_Kinematic_IsAngleUnit_System_Int32_"></a> IsAngleUnit\(int\)

```csharp
public bool IsAngleUnit(int icomponent)
```

#### Parameters

`icomponent` [int](https://learn.microsoft.com/dotnet/api/system.int32)
