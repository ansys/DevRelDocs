# <a id="VM_Models_Post_DataSource_UVECReader14"></a> Class UVECReader14

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class UVECReader14 : UVECReader, IUVECReader
```
...
### <a id="VM_Models_Post_DataSource_UVECReader14__ctor_System_String_"></a> UVECReader14\(string\)

```csharp
public UVECReader14(string filePath)
```
