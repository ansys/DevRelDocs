# <a id="VM_Models_Post_DataSource_DFEIGReader13"></a> Class DFEIGReader13

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFEIGReader13 : DFEIGTextReader, IDFEIGReader
```
...
[DFEIGReader13](VM.Models.Post.DataSource.DFEIGReader13.md)
...
### <a id="VM_Models_Post_DataSource_DFEIGReader13__ctor"></a> DFEIGReader13\(\)

```csharp
public DFEIGReader13()
```
