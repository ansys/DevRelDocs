# <a id="VM_Models_Post_DataSource_DFGReader16"></a> Class DFGReader16

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFGReader16 : DFGReader, IDFGReader
```
...
### <a id="VM_Models_Post_DataSource_DFGReader16__ctor"></a> DFGReader16\(\)
...
### <a id="VM_Models_Post_DataSource_DFGReader16_ReadModalGeometryData_System_Int32__VM_Models_Post_MetaInfo_System_Int32__"></a> ReadModalGeometryData\(ref int, MetaInfo, ref int\)
