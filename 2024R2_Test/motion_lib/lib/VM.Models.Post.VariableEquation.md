# <a id="VM_Models_Post_VariableEquation"></a> Class VariableEquation

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class VariableEquation : EntityBase, IObservableObject, IDisposableObject, IPlottable, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_VariableEquation__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_"></a> VariableEquation\(ResultDocument, Identifier, string\)

```csharp
public VariableEquation(ResultDocument parentDocument, Identifier analysisResultID, string fullName)
```
...
### <a id="VM_Models_Post_VariableEquation_CategoryType"></a> CategoryType
...
### <a id="VM_Models_Post_VariableEquation_DisplayName"></a> DisplayName
...
### <a id="VM_Models_Post_VariableEquation_EntityType"></a> EntityType
...
### <a id="VM_Models_Post_VariableEquation_PlottableType"></a> PlottableType
