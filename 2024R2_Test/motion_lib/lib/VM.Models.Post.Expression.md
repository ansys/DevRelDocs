# <a id="VM_Models_Post_Expression"></a> Class Expression

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class Expression : EntityBase, IObservableObject, IDisposableObject, IPlottable, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_Expression__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_"></a> Expression\(ResultDocument, Identifier, string\)

```csharp
public Expression(ResultDocument parentDocument, Identifier analysisResultID, string fullName)
```
...
### <a id="VM_Models_Post_Expression_CategoryType"></a> CategoryType
...
### <a id="VM_Models_Post_Expression_DisplayName"></a> DisplayName
...
### <a id="VM_Models_Post_Expression_EntityType"></a> EntityType
...
### <a id="VM_Models_Post_Expression_PlottableType"></a> PlottableType
