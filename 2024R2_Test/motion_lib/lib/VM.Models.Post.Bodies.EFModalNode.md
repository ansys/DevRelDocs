# <a id="VM_Models_Post_Bodies_EFModalNode"></a> Class EFModalNode

Namespace: [VM.Models.Post.Bodies](VM.Models.Post.Bodies.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class EFModalNode : NodeBase, IObservableObject, IDisposableObject, INode, IBodyComponent, IComponent, IPlottable, IEntity, IObject, IHasName, IHasIndex, IHasID
```
