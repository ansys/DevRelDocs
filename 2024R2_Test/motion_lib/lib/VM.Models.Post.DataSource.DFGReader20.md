# <a id="VM_Models_Post_DataSource_DFGReader20"></a> Class DFGReader20

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFGReader20 : DFGReader, IDFGReader
```
...
### <a id="VM_Models_Post_DataSource_DFGReader20__ctor"></a> DFGReader20\(\)
