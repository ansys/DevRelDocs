# <a id="VM_Models_Post_VisualizationImpl_Visualization_LineDisplayAnimation"></a> Class LineDisplayAnimation
...
```csharp
public class LineDisplayAnimation : VectorDisplayAnimationBase, IVectorDisplayAnimationBase, ILineDisplayAnimation
```
...
[VectorDisplayAnimationBase.UpdateLabel\(\)](VM.Models.Post.VisualizationImpl.Visualization.VectorDisplayAnimationBase.md\#VM\_Models\_Post\_VisualizationImpl\_Visualization\_VectorDisplayAnimationBase\_UpdateLabel), 
[VectorDisplayAnimationBase.CreateMarkup\(string, double, IVectorDisplayAnimationData\)](VM.Models.Post.VisualizationImpl.Visualization.VectorDisplayAnimationBase.md\#VM\_Models\_Post\_VisualizationImpl\_Visualization\_VectorDisplayAnimationBase\_CreateMarkup\_System\_String\_System\_Double\_VM\_Models\_OutputReader\_IVectorDisplayAnimationData\_), 
[VectorDisplayAnimationBase.AddMarkup\(MarkupModel\)](VM.Models.Post.VisualizationImpl.Visualization.VectorDisplayAnimationBase.md\#VM\_Models\_Post\_VisualizationImpl\_Visualization\_VectorDisplayAnimationBase\_AddMarkup\_Ceetron\_CeetronDesktopComponents\_Visualization\_MarkupModel\_), 
[VectorDisplayAnimationBase.UpdateMarkup\(\)](VM.Models.Post.VisualizationImpl.Visualization.VectorDisplayAnimationBase.md\#VM\_Models\_Post\_VisualizationImpl\_Visualization\_VectorDisplayAnimationBase\_UpdateMarkup), 
[VectorDisplayAnimationBase.SetVisible\(bool\)](VM.Models.Post.VisualizationImpl.Visualization.VectorDisplayAnimationBase.md\#VM\_Models\_Post\_VisualizationImpl\_Visualization\_VectorDisplayAnimationBase\_SetVisible\_System\_Boolean\_), 
[VectorDisplayAnimationBase.IsAnimationData\(\)](VM.Models.Post.VisualizationImpl.Visualization.VectorDisplayAnimationBase.md\#VM\_Models\_Post\_VisualizationImpl\_Visualization\_VectorDisplayAnimationBase\_IsAnimationData), 
[VectorDisplayAnimationBase.GetNumberString\(double\)](VM.Models.Post.VisualizationImpl.Visualization.VectorDisplayAnimationBase.md\#VM\_Models\_Post\_VisualizationImpl\_Visualization\_VectorDisplayAnimationBase\_GetNumberString\_System\_Double\_), 
...
### <a id="VM_Models_Post_VisualizationImpl_Visualization_LineDisplayAnimation__ctor"></a> LineDisplayAnimation\(\)

```csharp
public LineDisplayAnimation()
```

## Properties

### <a id="VM_Models_Post_VisualizationImpl_Visualization_LineDisplayAnimation_LineColor"></a> LineColor
...
### <a id="VM_Models_Post_VisualizationImpl_Visualization_LineDisplayAnimation_LineWidth"></a> LineWidth
...
### <a id="VM_Models_Post_VisualizationImpl_Visualization_LineDisplayAnimation_MarkupLines"></a> MarkupLines

```csharp
public List<MarkupLine> MarkupLines { get; set; }
```

#### Property Value

 [List](https://learn.microsoft.com/dotnet/api/system.collections.generic.list\-1)<[MarkupLine](VM.Models.Post.VisualizationImpl.Visualization.MarkupLine.md)\>

## Methods

### <a id="VM_Models_Post_VisualizationImpl_Visualization_LineDisplayAnimation_AddMarkup_Ceetron_CeetronDesktopComponents_Visualization_MarkupModel_"></a> AddMarkup\(MarkupModel\)
...
### <a id="VM_Models_Post_VisualizationImpl_Visualization_LineDisplayAnimation_CreateMarkup_System_String_System_Double_VM_Models_OutputReader_IVectorDisplayAnimationData_"></a> CreateMarkup\(string, double, IVectorDisplayAnimationData\)
...
### <a id="VM_Models_Post_VisualizationImpl_Visualization_LineDisplayAnimation_IsAnimationData"></a> IsAnimationData\(\)
...
### <a id="VM_Models_Post_VisualizationImpl_Visualization_LineDisplayAnimation_RemoveMarkupPart_Ceetron_CeetronDesktopComponents_Visualization_MarkupModel_"></a> RemoveMarkupPart\(MarkupModel\)
...
### <a id="VM_Models_Post_VisualizationImpl_Visualization_LineDisplayAnimation_SetVisible_System_Boolean_"></a> SetVisible\(bool\)
...
### <a id="VM_Models_Post_VisualizationImpl_Visualization_LineDisplayAnimation_UpdateLabel"></a> UpdateLabel\(\)

```csharp
protected override void UpdateLabel()
```

### <a id="VM_Models_Post_VisualizationImpl_Visualization_LineDisplayAnimation_UpdateMarkup"></a> UpdateMarkup\(\)
