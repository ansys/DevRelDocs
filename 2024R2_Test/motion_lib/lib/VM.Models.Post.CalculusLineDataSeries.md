# <a id="VM_Models_Post_CalculusLineDataSeries"></a> Class CalculusLineDataSeries

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class CalculusLineDataSeries : HasOriginalSeries, IObservableObject, IDisposableObject, ISeries, IObject, IHasName
```
...
### <a id="VM_Models_Post_CalculusLineDataSeries_CalculusType"></a> CalculusType

```csharp
[SaveProperty(false)]
public CalculusType CalculusType { get; set; }
```
...
### <a id="VM_Models_Post_CalculusLineDataSeries_LineSeriesType"></a> LineSeriesType
