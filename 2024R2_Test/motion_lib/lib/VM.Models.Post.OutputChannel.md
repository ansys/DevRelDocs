# <a id="VM_Models_Post_OutputChannel"></a> Class OutputChannel

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class OutputChannel : EntityBase, IObservableObject, IDisposableObject, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_OutputChannel__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_"></a> OutputChannel\(ResultDocument, Identifier, string\)

```csharp
public OutputChannel(ResultDocument parentDocument, Identifier analysisResultID, string fullName)
```
...
### <a id="VM_Models_Post_OutputChannel_ActionMarkerIndex"></a> ActionMarkerIndex

```csharp
public int ActionMarkerIndex { get; set; }
```
...
### <a id="VM_Models_Post_OutputChannel_BaseMarkerIndex"></a> BaseMarkerIndex

```csharp
public int BaseMarkerIndex { get; set; }
```
...
### <a id="VM_Models_Post_OutputChannel_CategoryType"></a> CategoryType
...
### <a id="VM_Models_Post_OutputChannel_Direction"></a> Direction
...
### <a id="VM_Models_Post_OutputChannel_EntityType"></a> EntityType
...
### <a id="VM_Models_Post_OutputChannel_OutputType"></a> OutputType
...
### <a id="VM_Models_Post_OutputChannel_ReferenceMarkerIndex"></a> ReferenceMarkerIndex

```csharp
public int ReferenceMarkerIndex { get; set; }
```
...
### <a id="VM_Models_Post_OutputChannel_Type"></a> Type
