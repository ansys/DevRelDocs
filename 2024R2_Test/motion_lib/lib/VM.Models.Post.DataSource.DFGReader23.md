# <a id="VM_Models_Post_DataSource_DFGReader23"></a> Class DFGReader23

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFGReader23 : DFGReader, IDFGReader
```
...
### <a id="VM_Models_Post_DataSource_DFGReader23__ctor"></a> DFGReader23\(\)
