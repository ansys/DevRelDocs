# <a id="VM_Models_Post_DataSource_UVECReader18"></a> Class UVECReader18

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class UVECReader18 : UVECReader, IUVECReader
```
...
### <a id="VM_Models_Post_DataSource_UVECReader18__ctor_System_String_"></a> UVECReader18\(string\)

```csharp
public UVECReader18(string filePath)
```
