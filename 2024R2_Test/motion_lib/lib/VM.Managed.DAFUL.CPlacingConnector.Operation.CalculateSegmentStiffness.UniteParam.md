# <a id="VM_Managed_DAFUL_CPlacingConnector_Operation_CalculateSegmentStiffness_UniteParam"></a> Class CalculateSegmentStiffness.UniteParam
...
```csharp
public class CalculateSegmentStiffness.UniteParam
```
