# <a id="VM_Models_Post_DataSource_DFGReader21"></a> Class DFGReader21

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFGReader21 : DFGReader, IDFGReader
```
...
### <a id="VM_Models_Post_DataSource_DFGReader21__ctor"></a> DFGReader21\(\)
