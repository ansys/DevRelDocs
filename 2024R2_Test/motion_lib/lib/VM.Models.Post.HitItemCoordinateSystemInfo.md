# <a id="VM_Models_Post_HitItemCoordinateSystemInfo"></a> Class HitItemCoordinateSystemInfo

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class HitItemCoordinateSystemInfo : HitItemMarkerInfo, IObservableObject, IDisposableObject
```
...
[HitItemMarkerInfo.Name](VM.Models.Post.HitItemMarkerInfo.md\#VM\_Models\_Post\_HitItemMarkerInfo\_Name), 
[HitItemMarkerInfo.TypeOfHitItemInfo](VM.Models.Post.HitItemMarkerInfo.md\#VM\_Models\_Post\_HitItemMarkerInfo\_TypeOfHitItemInfo), 
...
### <a id="VM_Models_Post_HitItemCoordinateSystemInfo__ctor_VM_Models_Post_IHitItem_"></a> HitItemCoordinateSystemInfo\(IHitItem\)

```csharp
public HitItemCoordinateSystemInfo(IHitItem ptr)
```
...
### <a id="VM_Models_Post_HitItemCoordinateSystemInfo_TypeOfHitItemInfo"></a> TypeOfHitItemInfo
