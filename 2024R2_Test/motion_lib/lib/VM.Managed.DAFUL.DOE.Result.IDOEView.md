...
### <a id="VM_Managed_DAFUL_DOE_Result_IDOEView_Close"></a> Close\(\)

```csharp
void Close()
```

### <a id="VM_Managed_DAFUL_DOE_Result_IDOEView_Open_System_String_"></a> Open\(string\)
...
```csharp
void ReloadResult(string strPath)
```
