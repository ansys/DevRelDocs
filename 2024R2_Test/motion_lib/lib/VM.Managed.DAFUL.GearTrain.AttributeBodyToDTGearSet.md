# <a id="VM_Managed_DAFUL_GearTrain_AttributeBodyToDTGearSet"></a> Class AttributeBodyToDTGearSet
...
```csharp
public class AttributeBodyToDTGearSet : AttributeBodyToAttachedDT, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
