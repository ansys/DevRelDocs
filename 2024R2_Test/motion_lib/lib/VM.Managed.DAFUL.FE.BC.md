...
Entity<PropertyBC\>.Initialize\(Unit.ConvertFactor\), 
Entity<PropertyBC\>.GetUnnamedObjectName\(object\), 
Entity<PropertyBC\>.FindLocal\(string\), 
Entity<PropertyBC\>.Property, 
