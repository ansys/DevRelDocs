# <a id="VM_Models_Post_DataSource_DFMReader13"></a> Class DFMReader13

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMReader13 : DFMReader, IDFMReader, IDFMInfo
```
...
### <a id="VM_Models_Post_DataSource_DFMReader13__ctor"></a> DFMReader13\(\)
...
### <a id="VM_Models_Post_DataSource_DFMReader13_BuildForceConfiguration_System_Int32___"></a> BuildForceConfiguration\(int\[\]\)
...
### <a id="VM_Models_Post_DataSource_DFMReader13_BuildModels_VM_Models_Post_ResultDocument_System_String_VM_Models_Post_IDFRReader_VM_Identifier_"></a> BuildModels\(ResultDocument, string, IDFRReader, Identifier\)
...
### <a id="VM_Models_Post_DataSource_DFMReader13_ReadEigenvalueAnalysis_VM_Models_Post_MetaInfo_VM_Models_Post_IDFRReader_System_String_System_Int32__"></a> ReadEigenvalueAnalysis\(MetaInfo, IDFRReader, string, ref int\)
...
### <a id="VM_Models_Post_DataSource_DFMReader13_ReadFEMaterial_VM_Models_Post_MetaInfo_System_String_System_Int32__"></a> ReadFEMaterial\(MetaInfo, string, ref int\)
...
### <a id="VM_Models_Post_DataSource_DFMReader13_ReadFEProperty_VM_Models_Post_ResultDocument_VM_Identifier_VM_Models_Post_MetaInfo_System_String_System_Int32__"></a> ReadFEProperty\(ResultDocument, Identifier, MetaInfo, string, ref int\)
...
### <a id="VM_Models_Post_DataSource_DFMReader13_ReadUnit_VM_Models_Post_MetaInfo_System_String_System_Int32__"></a> ReadUnit\(MetaInfo, string, ref int\)
...
### <a id="VM_Models_Post_DataSource_DFMReader13_SetVectorDisplayCharacteristics_VM_Models_Post_MetaInfo_"></a> SetVectorDisplayCharacteristics\(MetaInfo\)
