# <a id="VM_Managed_SimulationConfigurationExtraBase"></a> Class SimulationConfigurationExtraBase
...
```csharp
public abstract class SimulationConfigurationExtraBase : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
