# <a id="VM_Models_Post_DataSource_UVECReader19"></a> Class UVECReader19

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class UVECReader19 : UVECReader, IUVECReader
```
...
### <a id="VM_Models_Post_DataSource_UVECReader19__ctor_System_String_"></a> UVECReader19\(string\)

```csharp
public UVECReader19(string filePath)
```
