# <a id="VM_Models_Post_DataSource_DFEIGReader16"></a> Class DFEIGReader16

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFEIGReader16 : DFEIGTextReader, IDFEIGReader
```
...
[DFEIGReader16](VM.Models.Post.DataSource.DFEIGReader16.md)
...
### <a id="VM_Models_Post_DataSource_DFEIGReader16__ctor"></a> DFEIGReader16\(\)

```csharp
public DFEIGReader16()
```
