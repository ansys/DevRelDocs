# <a id="VM_Models_Post_DataSource_DFMFReader19"></a> Class DFMFReader19

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMFReader19 : DFMFReader, IDFMFReader
```
...
### <a id="VM_Models_Post_DataSource_DFMFReader19__ctor"></a> DFMFReader19\(\)
