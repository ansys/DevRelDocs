# <a id="VM_Models_Post_HeatmapLineDataSeries"></a> Class HeatmapLineDataSeries

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class HeatmapLineDataSeries : LineDataSeriesBase, IObservableObject, IDisposableObject, ISeries, IObject, IHasName
```
...
### <a id="VM_Models_Post_HeatmapLineDataSeries_Harmonic"></a> Harmonic
...
### <a id="VM_Models_Post_HeatmapLineDataSeries_Interval"></a> Interval
...
### <a id="VM_Models_Post_HeatmapLineDataSeries_LineSeriesType"></a> LineSeriesType
...
### <a id="VM_Models_Post_HeatmapLineDataSeries_NeedSavePoints"></a> NeedSavePoints
