# <a id="VM_Models_Post_DynamicPPTE2D"></a> Class DynamicPPTE2D

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class DynamicPPTE2D : DriveTrain2D, IObservableObject, IDisposableObject, IObject, IHasName
```
...
### <a id="VM_Models_Post_DynamicPPTE2D_TypeForChart"></a> TypeForChart
