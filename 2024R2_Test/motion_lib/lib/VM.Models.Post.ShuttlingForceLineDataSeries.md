# <a id="VM_Models_Post_ShuttlingForceLineDataSeries"></a> Class ShuttlingForceLineDataSeries

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class ShuttlingForceLineDataSeries : DriveTrainLineDataSeriesBase, IObservableObject, IDisposableObject, ISeries, IObject, IHasName
```
...
### <a id="VM_Models_Post_ShuttlingForceLineDataSeries_LineSeriesType"></a> LineSeriesType
...
### <a id="VM_Models_Post_ShuttlingForceLineDataSeries_Slice"></a> Slice
...
### <a id="VM_Models_Post_ShuttlingForceLineDataSeries_StartTime"></a> StartTime
