# <a id="VM_Models_Post_DriveTrain2D"></a> Class DriveTrain2D

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public abstract class DriveTrain2D : Line2D, IObservableObject, IDisposableObject, IObject, IHasName
```
...
### <a id="VM_Models_Post_DriveTrain2D__ctor_System_Nullable_System_Int32__System_String_System_String_"></a> DriveTrain2D\(int?, string, string\)

```csharp
protected DriveTrain2D(int? id, string fullName, string title)
```
