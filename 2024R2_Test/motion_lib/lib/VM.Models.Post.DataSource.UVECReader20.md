# <a id="VM_Models_Post_DataSource_UVECReader20"></a> Class UVECReader20

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class UVECReader20 : UVECReader, IUVECReader
```
...
### <a id="VM_Models_Post_DataSource_UVECReader20__ctor_System_String_"></a> UVECReader20\(string\)

```csharp
public UVECReader20(string filePath)
```
