# <a id="VM_Managed_DAFUL_GearTrain_GearShapeRackHelical"></a> Class GearShapeRackHelical
...
```csharp
public class GearShapeRackHelical : GearShapeRackBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
### <a id="VM_Managed_DAFUL_GearTrain_GearShapeRackHelical__ctor"></a> GearShapeRackHelical\(\)

Initializes a new instance of the <xref href="VM.Managed.DAFUL.GearTrain.GearShapeRackHelical" data-throw-if-not-resolved="false"></xref> class.
