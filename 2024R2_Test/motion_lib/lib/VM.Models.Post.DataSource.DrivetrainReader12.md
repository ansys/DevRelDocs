# <a id="VM_Models_Post_DataSource_DrivetrainReader12"></a> Class DrivetrainReader12

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DrivetrainReader12 : DrivetrainReader, IDriveTrainReader
```
...
### <a id="VM_Models_Post_DataSource_DrivetrainReader12__ctor"></a> DrivetrainReader12\(\)

```csharp
public DrivetrainReader12()
```

## Methods

### <a id="VM_Models_Post_DataSource_DrivetrainReader12_ReadAssemblyManagerInfo_VM_Models_Post_ResultDocument_VM_Identifier_VM_Models_Post_IDriveTrain___System_String_"></a> ReadAssemblyManagerInfo\(ResultDocument, Identifier, IDriveTrain\[\], string\)
...
### <a id="VM_Models_Post_DataSource_DrivetrainReader12_ReadColormapInfo_VM_Models_Post_DriveTrains_GearSet___System_String_"></a> ReadColormapInfo\(GearSet\[\], string\)
