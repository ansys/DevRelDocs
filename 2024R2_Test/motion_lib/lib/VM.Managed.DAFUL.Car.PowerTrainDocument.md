# <a id="VM_Managed_DAFUL_Car_PowerTrainDocument"></a> Class PowerTrainDocument
...
### <a id="VM_Managed_DAFUL_Car_PowerTrainDocument__ctor_System_UIntPtr_"></a> PowerTrainDocument\(UIntPtr\)
...
```csharp
public PowerTrainDocument(UIntPtr docCore)
```
...
### <a id="VM_Managed_DAFUL_Car_PowerTrainDocument_InitialCategories"></a> InitialCategories
...
### <a id="VM_Managed_DAFUL_Car_PowerTrainDocument_Interfaces"></a> Interfaces
...
### <a id="VM_Managed_DAFUL_Car_PowerTrainDocument_MinorRoleType"></a> MinorRoleType
...
### <a id="VM_Managed_DAFUL_Car_PowerTrainDocument_ClearDocument"></a> ClearDocument\(\)
...
### <a id="VM_Managed_DAFUL_Car_PowerTrainDocument_FindCategory_System_String_"></a> FindCategory\(string\)
...
### <a id="VM_Managed_DAFUL_Car_PowerTrainDocument_InitializeCategoryInfo_System_String_"></a> InitializeCategoryInfo\(string\)
...
### <a id="VM_Managed_DAFUL_Car_PowerTrainDocument_InitializeInterface"></a> InitializeInterface\(\)
...
### <a id="VM_Managed_DAFUL_Car_PowerTrainDocument_InitializeSimParam"></a> InitializeSimParam\(\)
...
### <a id="VM_Managed_DAFUL_Car_PowerTrainDocument_LoadTemplateBasedXml_System_Xml_XmlReader_"></a> LoadTemplateBasedXml\(XmlReader\)
...
### <a id="VM_Managed_DAFUL_Car_PowerTrainDocument_OnDeserialization_System_Object_"></a> OnDeserialization\(object\)
...
### <a id="VM_Managed_DAFUL_Car_PowerTrainDocument_SaveTemplateBasedXml_System_Xml_XmlWriter_"></a> SaveTemplateBasedXml\(XmlWriter\)
