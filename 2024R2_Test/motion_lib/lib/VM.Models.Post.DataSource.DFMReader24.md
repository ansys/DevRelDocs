# <a id="VM_Models_Post_DataSource_DFMReader24"></a> Class DFMReader24

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMReader24 : DFMReader, IDFMReader, IDFMInfo
```
...
### <a id="VM_Models_Post_DataSource_DFMReader24__ctor"></a> DFMReader24\(\)
...
### <a id="VM_Models_Post_DataSource_DFMReader24_SetVectorDisplayCharacteristics_VM_Models_Post_MetaInfo_"></a> SetVectorDisplayCharacteristics\(MetaInfo\)
