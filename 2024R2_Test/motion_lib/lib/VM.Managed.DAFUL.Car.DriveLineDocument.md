...
### <a id="VM_Managed_DAFUL_Car_DriveLineDocument__ctor_System_UIntPtr_"></a> DriveLineDocument\(UIntPtr\)
...
```csharp
public DriveLineDocument(UIntPtr docCore)
```
...
### <a id="VM_Managed_DAFUL_Car_DriveLineDocument_InitialCategories"></a> InitialCategories
...
### <a id="VM_Managed_DAFUL_Car_DriveLineDocument_Interfaces"></a> Interfaces
...
### <a id="VM_Managed_DAFUL_Car_DriveLineDocument_MinorRoleType"></a> MinorRoleType
...
### <a id="VM_Managed_DAFUL_Car_DriveLineDocument_ClearDocument"></a> ClearDocument\(\)
...
### <a id="VM_Managed_DAFUL_Car_DriveLineDocument_FindCategory_System_String_"></a> FindCategory\(string\)
...
### <a id="VM_Managed_DAFUL_Car_DriveLineDocument_InitializeCategoryInfo_System_String_"></a> InitializeCategoryInfo\(string\)
...
### <a id="VM_Managed_DAFUL_Car_DriveLineDocument_InitializeInterface"></a> InitializeInterface\(\)
...
### <a id="VM_Managed_DAFUL_Car_DriveLineDocument_InitializeSimParam"></a> InitializeSimParam\(\)
...
### <a id="VM_Managed_DAFUL_Car_DriveLineDocument_LoadTemplateBasedXml_System_Xml_XmlReader_"></a> LoadTemplateBasedXml\(XmlReader\)
...
### <a id="VM_Managed_DAFUL_Car_DriveLineDocument_OnDeserialization_System_Object_"></a> OnDeserialization\(object\)
...
### <a id="VM_Managed_DAFUL_Car_DriveLineDocument_SaveTemplateBasedXml_System_Xml_XmlWriter_"></a> SaveTemplateBasedXml\(XmlWriter\)
