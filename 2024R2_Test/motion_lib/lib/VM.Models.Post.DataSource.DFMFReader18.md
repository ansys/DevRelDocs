# <a id="VM_Models_Post_DataSource_DFMFReader18"></a> Class DFMFReader18

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMFReader18 : DFMFReader, IDFMFReader
```
...
### <a id="VM_Models_Post_DataSource_DFMFReader18__ctor"></a> DFMFReader18\(\)
