# <a id="VM_Models_Post_StorageLineDataSeries"></a> Class StorageLineDataSeries

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class StorageLineDataSeries : LineDataSeriesBase, IObservableObject, IDisposableObject, ISeries, IObject, IHasName
```
...
### <a id="VM_Models_Post_StorageLineDataSeries_LineSeriesType"></a> LineSeriesType
...
### <a id="VM_Models_Post_StorageLineDataSeries_NeedSavePoints"></a> NeedSavePoints
