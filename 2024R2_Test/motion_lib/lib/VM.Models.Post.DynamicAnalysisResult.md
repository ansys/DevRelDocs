# <a id="VM_Models_Post_DynamicAnalysisResult"></a> Class DynamicAnalysisResult

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class DynamicAnalysisResult : TransientAnalysisResult, IObservableObject, IDisposableObject
```
...
### <a id="VM_Models_Post_DynamicAnalysisResult__ctor_VM_Models_Post_ResultDocument_VM_Models_AnalysisResultType_VM_Models_Post_IUnstructGridModel_VM_Models_Post_MetaInfo_"></a> DynamicAnalysisResult\(ResultDocument, AnalysisResultType, IUnstructGridModel, MetaInfo\)

```csharp
public DynamicAnalysisResult(ResultDocument parentDocument, AnalysisResultType analysisResultType, IUnstructGridModel unstructGridModel, MetaInfo metaInfo)
```
