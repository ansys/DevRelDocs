# <a id="VM_Models_Post_DataSource_DFEIGReader20"></a> Class DFEIGReader20

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFEIGReader20 : DFEIGTextReader, IDFEIGReader
```
...
[DFEIGReader20](VM.Models.Post.DataSource.DFEIGReader20.md)
...
### <a id="VM_Models_Post_DataSource_DFEIGReader20__ctor"></a> DFEIGReader20\(\)

```csharp
public DFEIGReader20()
```
