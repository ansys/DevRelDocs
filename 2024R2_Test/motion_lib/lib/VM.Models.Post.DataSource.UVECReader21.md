# <a id="VM_Models_Post_DataSource_UVECReader21"></a> Class UVECReader21

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class UVECReader21 : UVECReader, IUVECReader
```
...
### <a id="VM_Models_Post_DataSource_UVECReader21__ctor_System_String_"></a> UVECReader21\(string\)

```csharp
public UVECReader21(string filePath)
```
