# <a id="VM_Models_Post_VisualizationImpl_UnstructGrid_ModeContributionUnstructGridModel"></a> Class ModeContributionUnstructGridModel
...
```csharp
[DependencyResolve(typeof(IModeContributionUnstructGridModel))]
public class ModeContributionUnstructGridModel : ContourUnstructGridModel, IModeContributionUnstructGridModel, IContourUnstructGridModel, IUnstructGridModel, IModel
```
...
IModeContributionUnstructGridModel, 
...
### <a id="VM_Models_Post_VisualizationImpl_UnstructGrid_ModeContributionUnstructGridModel__ctor"></a> ModeContributionUnstructGridModel\(\)

```csharp
public ModeContributionUnstructGridModel()
```

## Methods

### <a id="VM_Models_Post_VisualizationImpl_UnstructGrid_ModeContributionUnstructGridModel_UpdateAnimation"></a> UpdateAnimation\(\)
