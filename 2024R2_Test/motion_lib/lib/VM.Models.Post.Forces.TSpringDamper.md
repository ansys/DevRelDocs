# <a id="VM_Models_Post_Forces_TSpringDamper"></a> Class TSpringDamper

Namespace: [VM.Models.Post.Forces](VM.Models.Post.Forces.md)  
Assembly: VM.Models.Post.EntityTypes.dll  

```csharp
public sealed class TSpringDamper : ForceBase, IObservableObject, IDisposableObject, IConnector, IVectorDisplayable, IPlottable, IBodyBase, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_Forces_TSpringDamper__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_VM_Models_Post_IDFMInfo_System_Int32___"></a> TSpringDamper\(ResultDocument, Identifier, string, IDFMInfo, int\[\]\)

```csharp
public TSpringDamper(ResultDocument parentDocument, Identifier analysisResultID, string fullName, IDFMInfo dfmInfo, int[] markerIndexes)
```
...
### <a id="VM_Models_Post_Forces_TSpringDamper_CanLoad"></a> CanLoad
...
### <a id="VM_Models_Post_Forces_TSpringDamper_CanSave"></a> CanSave
...
### <a id="VM_Models_Post_Forces_TSpringDamper_Coil"></a> Coil
...
### <a id="VM_Models_Post_Forces_TSpringDamper_CoilLength1"></a> CoilLength1

```csharp
public double CoilLength1 { get; set; }
```
...
### <a id="VM_Models_Post_Forces_TSpringDamper_CoilLength2"></a> CoilLength2

```csharp
public double CoilLength2 { get; set; }
```
...
### <a id="VM_Models_Post_Forces_TSpringDamper_Color"></a> Color
...
### <a id="VM_Models_Post_Forces_TSpringDamper_ConnectorType"></a> ConnectorType
...
### <a id="VM_Models_Post_Forces_TSpringDamper_DataParts"></a> DataParts
...
### <a id="VM_Models_Post_Forces_TSpringDamper_Diameter"></a> Diameter
...
### <a id="VM_Models_Post_Forces_TSpringDamper_IsVisible"></a> IsVisible
...
### <a id="VM_Models_Post_Forces_TSpringDamper_NUM_OF_RESULT"></a> NUM\_OF\_RESULT
...
### <a id="VM_Models_Post_Forces_TSpringDamper_NUM_OF_VARIABLEBLOCK_RESULT"></a> NUM\_OF\_VARIABLEBLOCK\_RESULT
...
### <a id="VM_Models_Post_Forces_TSpringDamper_RenderType"></a> RenderType
...
### <a id="VM_Models_Post_Forces_TSpringDamper_TextureImage"></a> TextureImage
...
### <a id="VM_Models_Post_Forces_TSpringDamper_ContainsPartIndex_System_Int32_"></a> ContainsPartIndex\(int\)
