# <a id="VM_Models_Post_Line2D"></a> Class Line2D

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public class Line2D : Chart2D, IObservableObject, IDisposableObject, IObject, IHasName
```
...
### <a id="VM_Models_Post_Line2D_AnimationX"></a> AnimationX

```csharp
[SaveProperty(false)]
public double AnimationX { get; set; }
```
...
### <a id="VM_Models_Post_Line2D_AnimationXAxisId"></a> AnimationXAxisId

```csharp
[SaveProperty(false)]
public string AnimationXAxisId { get; set; }
```
...
### <a id="VM_Models_Post_Line2D_AnimationY"></a> AnimationY

```csharp
[SaveProperty(false)]
public double AnimationY { get; set; }
```
...
### <a id="VM_Models_Post_Line2D_AnimationYAxisId"></a> AnimationYAxisId

```csharp
[SaveProperty(false)]
public string AnimationYAxisId { get; set; }
```
...
### <a id="VM_Models_Post_Line2D_AxisX"></a> AxisX
...
### <a id="VM_Models_Post_Line2D_AxisY"></a> AxisY
...
### <a id="VM_Models_Post_Line2D_ChartType"></a> ChartType
...
#### Property Value
 ...
 [ChartType](VM.Models.Post.ChartType.md)

### <a id="VM_Models_Post_Line2D_Legend"></a> Legend
...
### <a id="VM_Models_Post_Line2D_ShowAnimationBar"></a> ShowAnimationBar

```csharp
[SaveProperty(false)]
public bool ShowAnimationBar { get; set; }
```
...
### <a id="VM_Models_Post_Line2D_TrackingCurve"></a> TrackingCurve

```csharp
[SaveProperty(false)]
public bool TrackingCurve { get; set; }
```
...
### <a id="VM_Models_Post_Line2D_TrackingOption"></a> TrackingOption

```csharp
[SaveProperty(false)]
public ChartAxisType TrackingOption { get; set; }
```
...
### <a id="VM_Models_Post_Line2D_TypeForChart"></a> TypeForChart
...
### <a id="VM_Models_Post_Line2D_UseInterpolation"></a> UseInterpolation
...
### <a id="VM_Models_Post_Line2D_CreateExtendedAxis2D_VM_Models_Post_ChartAxisType_VM_Models_Post_AxisType_VM_Models_Post_AxisDirection_System_Nullable_System_Guid__System_String_System_Boolean_System_Boolean_"></a> CreateExtendedAxis2D\(ChartAxisType, AxisType, AxisDirection, Guid?, string, bool, bool\)

```csharp
public ExtendedAxis2D CreateExtendedAxis2D(ChartAxisType chartAxisType, AxisType axisType, AxisDirection axisDirection, Guid? id = null, string unit = "", bool isDefault = false, bool addAfterCreate = true)
```

#### Parameters

`chartAxisType` [ChartAxisType](VM.Models.Post.ChartAxisType.md)

`axisType` [AxisType](VM.Models.Post.AxisType.md)
