# <a id="VM_Models_Post_Bodies_Nodal"></a> Class Nodal

Namespace: [VM.Models.Post.Bodies](VM.Models.Post.Bodies.md)  
Assembly: VM.Models.Post.dll  

```csharp
public class Nodal : FEBody, IObservableObject, IDisposableObject, IPlottable, IContourable, INodal, IFEBody, IBody, IBodyBase, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
[EFModal](VM.Models.Post.Bodies.EFModal.md), 
...
[FEBody.DisposeManagedResources\(\)](VM.Models.Post.Bodies.FEBody.md\#VM\_Models\_Post\_Bodies\_FEBody\_DisposeManagedResources), 
...
### <a id="VM_Models_Post_Bodies_Nodal__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_System_Int32___"></a> Nodal\(ResultDocument, Identifier, string, int\[\]\)

```csharp
public Nodal(ResultDocument parentDocument, Identifier analysisResultID, string fullName, int[] markerIndexes)
```
...
### <a id="VM_Models_Post_Bodies_Nodal_BodyType"></a> BodyType
...
### <a id="VM_Models_Post_Bodies_Nodal_CanLoad"></a> CanLoad
...
### <a id="VM_Models_Post_Bodies_Nodal_CanSave"></a> CanSave
...
### <a id="VM_Models_Post_Bodies_Nodal_CategoryType"></a> CategoryType
...
### <a id="VM_Models_Post_Bodies_Nodal_NodeSets"></a> NodeSets

```csharp
public NodesInfo[] NodeSets { get; set; }
```

#### Property Value

 [NodesInfo](VM.Models.Post.Bodies.NodesInfo.md)\[\]

### <a id="VM_Models_Post_Bodies_Nodal_PlottableType"></a> PlottableType
...
### <a id="VM_Models_Post_Bodies_Nodal_CreateElement_VM_Models_Post_HitItemElementInfo_VM_Models_PlotDataType_"></a> CreateElement\(HitItemElementInfo, PlotDataType\)
...
### <a id="VM_Models_Post_Bodies_Nodal_CreateNode_VM_Models_Post_HitItemNodeInfo_VM_Models_PlotDataType_"></a> CreateNode\(HitItemNodeInfo, PlotDataType\)
...
### <a id="VM_Models_Post_Bodies_Nodal_DisposeManagedResources"></a> DisposeManagedResources\(\)
