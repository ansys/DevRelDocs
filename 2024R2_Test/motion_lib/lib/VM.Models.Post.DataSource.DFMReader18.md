# <a id="VM_Models_Post_DataSource_DFMReader18"></a> Class DFMReader18

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMReader18 : DFMReader, IDFMReader, IDFMInfo
```
...
### <a id="VM_Models_Post_DataSource_DFMReader18__ctor"></a> DFMReader18\(\)
...
### <a id="VM_Models_Post_DataSource_DFMReader18_BuildModels_VM_Models_Post_ResultDocument_System_String_VM_Models_Post_IDFRReader_VM_Identifier_"></a> BuildModels\(ResultDocument, string, IDFRReader, Identifier\)
