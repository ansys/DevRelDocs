# <a id="VM_Managed_DAFUL_GearTrain_Operation_CalculateBeamStiffness"></a> Class CalculateBeamStiffness
...
```csharp
public class CalculateBeamStiffness : OperationBase, IOperation
```
...
```csharp
public CalculateBeamStiffness(HiddenGearSetRackAndPinionDocument doc, string strDocInfo, string strDATFilePath)
```
...
```csharp
public CalculateBeamStiffness(JournalParameter jp)
```
