# <a id="VM_Models_Post_ActuatorBase"></a> Class ActuatorBase

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public abstract class ActuatorBase : EntityBase, IObservableObject, IDisposableObject, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
[ActuatorUSER](VM.Models.Post.ActuatorUSER.md)
...
### <a id="VM_Models_Post_ActuatorBase__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_"></a> ActuatorBase\(ResultDocument, Identifier, string\)

```csharp
protected ActuatorBase(ResultDocument parentDocument, Identifier analysisResultID, string fullName)
```
...
### <a id="VM_Models_Post_ActuatorBase_CategoryType"></a> CategoryType
...
### <a id="VM_Models_Post_ActuatorBase_EntityType"></a> EntityType
