# <a id="VM_Models_Post_DataSource_DFMFReader14"></a> Class DFMFReader14

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMFReader14 : DFMFReader, IDFMFReader
```
...
### <a id="VM_Models_Post_DataSource_DFMFReader14__ctor"></a> DFMFReader14\(\)
