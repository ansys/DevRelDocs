# <a id="VM_Models_Post_ActuatorRotatingMass"></a> Class ActuatorRotatingMass

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class ActuatorRotatingMass : ActuatorBase, IObservableObject, IDisposableObject, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
[ActuatorRotatingMass](VM.Models.Post.ActuatorRotatingMass.md)
...
### <a id="VM_Models_Post_ActuatorRotatingMass__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_"></a> ActuatorRotatingMass\(ResultDocument, Identifier, string\)

```csharp
public ActuatorRotatingMass(ResultDocument parentDocument, Identifier analysisResultID, string fullName)
```
...
### <a id="VM_Models_Post_ActuatorRotatingMass_ForceType"></a> ForceType

```csharp
public ForceDirectionType ForceType { get; set; }
```
...
### <a id="VM_Models_Post_ActuatorRotatingMass_Mass"></a> Mass
...
### <a id="VM_Models_Post_ActuatorRotatingMass_NormalOffset"></a> NormalOffset
...
### <a id="VM_Models_Post_ActuatorRotatingMass_RadialOffset"></a> RadialOffset
