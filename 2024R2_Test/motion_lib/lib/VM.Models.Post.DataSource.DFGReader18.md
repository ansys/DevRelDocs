# <a id="VM_Models_Post_DataSource_DFGReader18"></a> Class DFGReader18

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFGReader18 : DFGReader, IDFGReader
```
...
### <a id="VM_Models_Post_DataSource_DFGReader18__ctor"></a> DFGReader18\(\)
