# <a id="VM_Managed_DAFUL_FEFilm"></a> Class FEFilm
...
```csharp
public FEFilm_TabshapeHexagon TabShape { get; set; }
```
...
### <a id="VM_Managed_DAFUL_FEFilm_UpdateVariablesForTabShape_System_String_System_String_System_String_System_String_System_String_System_String_System_String_System_String_"></a> UpdateVariablesForTabShape\(string, string, string, string, string, string, string, string\)

```csharp
public void UpdateVariablesForTabShape(string tablocation, string width, string length, string chamfer_w, string chamfer_L, string interval, string thickness, string maxwidth)
```
