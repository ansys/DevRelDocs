...
```csharp
protected class Builder.BuilderParamSerializationException : Exception
```
...
```csharp
protected BuilderParamSerializationException(SerializationInfo info, StreamingContext context)
```
...
```csharp
public BuilderParamSerializationException(string message, Exception innerException)
```
...
```csharp
public BuilderParamSerializationException(string message)
```
