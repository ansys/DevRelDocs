# <a id="VM_Models_Post_DataSource_DFMFReader13"></a> Class DFMFReader13

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMFReader13 : DFMFReader, IDFMFReader
```
...
### <a id="VM_Models_Post_DataSource_DFMFReader13__ctor"></a> DFMFReader13\(\)
