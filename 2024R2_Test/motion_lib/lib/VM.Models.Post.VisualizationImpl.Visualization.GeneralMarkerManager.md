# <a id="VM_Models_Post_VisualizationImpl_Visualization_GeneralMarkerManager"></a> Class GeneralMarkerManager
...
```csharp
public class GeneralMarkerManager : MarkerManagerBase, IGeneralMarkerManager, IMarkerManager, ISelectionManager, IAnimationManager, IManager
```
...
### <a id="VM_Models_Post_VisualizationImpl_Visualization_GeneralMarkerManager__ctor_System_String_"></a> GeneralMarkerManager\(string\)

```csharp
public GeneralMarkerManager(string name)
```
...
### <a id="VM_Models_Post_VisualizationImpl_Visualization_GeneralMarkerManager_Remove_VM_Models_Post_IMarkerAnimation_"></a> Remove\(IMarkerAnimation\)
...
### <a id="VM_Models_Post_VisualizationImpl_Visualization_GeneralMarkerManager_Select_System_Collections_Generic_IList_VM_Models_Post_HitItemInfo__"></a> Select\(IList<HitItemInfo\>\)
