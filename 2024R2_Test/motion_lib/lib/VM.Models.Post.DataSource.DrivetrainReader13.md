# <a id="VM_Models_Post_DataSource_DrivetrainReader13"></a> Class DrivetrainReader13

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DrivetrainReader13 : DrivetrainReader, IDriveTrainReader
```
...
### <a id="VM_Models_Post_DataSource_DrivetrainReader13__ctor"></a> DrivetrainReader13\(\)

```csharp
public DrivetrainReader13()
```

## Methods

### <a id="VM_Models_Post_DataSource_DrivetrainReader13_ReadAssemblyManagerInfo_VM_Models_Post_ResultDocument_VM_Identifier_VM_Models_Post_IDriveTrain___System_String_"></a> ReadAssemblyManagerInfo\(ResultDocument, Identifier, IDriveTrain\[\], string\)
...
### <a id="VM_Models_Post_DataSource_DrivetrainReader13_ReadColormapInfo_VM_Models_Post_DriveTrains_GearSet___System_String_"></a> ReadColormapInfo\(GearSet\[\], string\)

```csharp
public override bool ReadColormapInfo(GearSet[] gearSets, string dfmPath)
```
