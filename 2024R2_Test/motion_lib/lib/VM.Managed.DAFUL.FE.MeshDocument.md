...
### <a id="VM_Managed_DAFUL_FE_MeshDocument_ImportMesh_System_String_System_Drawing_Color_System_String_VM_Unit_System_Boolean_"></a> ImportMesh\(string, Color, string, Unit, bool\)

Import mesh.

```csharp
public void ImportMesh(string strMeshFile, Color color, string strModalFile, Unit unit, bool bDropOffHighOrder)
```
...
### <a id="VM_Managed_DAFUL_FE_MeshDocument_ImportMesh_System_String_System_Drawing_Color_VM_Unit_System_Boolean_VM_Models_Pre_FE_CreateSetData_System_String_System_String_"></a> ImportMesh\(string, Color, Unit, bool, CreateSetData, string, string\)

Import mesh.

```csharp
public Mesh ImportMesh(string strMeshFile, Color color, Unit unit, bool bDropOffHighOrder, CreateSetData createSet, string strRunDllPath, string strNF2DFPath)
```
...
### <a id="VM_Managed_DAFUL_FE_MeshDocument_ImportMesh_System_String_System_Drawing_Color_VM_Unit_System_Boolean_VM_Models_Pre_FE_CreateSetData_"></a> ImportMesh\(string, Color, Unit, bool, CreateSetData\)

Import mesh.

```csharp
public Mesh ImportMesh(string strMeshFile, Color color, Unit unit, bool bDropOffHighOrder, CreateSetData createSet)
```
...
### <a id="VM_Managed_DAFUL_FE_MeshDocument_ImportMesh_System_String_System_Drawing_Color_VM_Unit_System_Boolean_"></a> ImportMesh\(string, Color, Unit, bool\)

Import mesh.

```csharp
public Mesh ImportMesh(string strMeshFile, Color color, Unit unit, bool bDropOffHighOrder)
```
