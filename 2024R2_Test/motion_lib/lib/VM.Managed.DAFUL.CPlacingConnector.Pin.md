# <a id="VM_Managed_DAFUL_CPlacingConnector_Pin"></a> Class Pin
...
Entity<PropertyPin\>.Initialize\(Unit.ConvertFactor\), 
Entity<PropertyPin\>.GetUnnamedObjectName\(object\), 
Entity<PropertyPin\>.FindLocal\(string\), 
Entity<PropertyPin\>.Property, 
