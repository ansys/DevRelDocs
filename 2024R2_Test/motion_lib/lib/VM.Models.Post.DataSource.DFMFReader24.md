# <a id="VM_Models_Post_DataSource_DFMFReader24"></a> Class DFMFReader24

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMFReader24 : DFMFReader, IDFMFReader
```
...
### <a id="VM_Models_Post_DataSource_DFMFReader24__ctor"></a> DFMFReader24\(\)
