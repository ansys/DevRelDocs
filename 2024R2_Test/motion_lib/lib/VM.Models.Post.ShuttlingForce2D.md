# <a id="VM_Models_Post_ShuttlingForce2D"></a> Class ShuttlingForce2D

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class ShuttlingForce2D : DriveTrain2D, IObservableObject, IDisposableObject, IObject, IHasName
```
...
### <a id="VM_Models_Post_ShuttlingForce2D_TypeForChart"></a> TypeForChart
