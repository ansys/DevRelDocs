# <a id="VM_Models_Pre_IOrientationFixedAngle"></a> Interface IOrientationFixedAngle

Namespace: [VM.Models.Pre](VM.Models.Pre.md)  
Assembly: VM.Models.Pre.dll  

```csharp
public interface IOrientationFixedAngle : IOrientationEulerAngle, IOrientationBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider
```
