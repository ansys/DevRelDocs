# <a id="VM_Models_Post_DataSource_DFEIGBinaryReader"></a> Class DFEIGBinaryReader

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFEIGBinaryReader : DFEIGReader, IDFEIGReader
```
...
[DFEIGReader24](VM.Models.Post.DataSource.DFEIGReader24.md)
...
### <a id="VM_Models_Post_DataSource_DFEIGBinaryReader__ctor"></a> DFEIGBinaryReader\(\)

```csharp
public DFEIGBinaryReader()
```
