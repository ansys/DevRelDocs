# <a id="VM_Models_Post_DataSource_UVECReader22"></a> Class UVECReader22

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class UVECReader22 : UVECReader, IUVECReader
```
...
### <a id="VM_Models_Post_DataSource_UVECReader22__ctor_System_String_"></a> UVECReader22\(string\)

```csharp
public UVECReader22(string filePath)
```
