# <a id="VM_Managed_DAFUL_ITieContactable"></a> Interface ITieContactable
...
```csharp
public interface ITieContactable : IContactable, IGeometricalComponent, IEntityRelation, IBodyAnalysisType, IHasBody
```
