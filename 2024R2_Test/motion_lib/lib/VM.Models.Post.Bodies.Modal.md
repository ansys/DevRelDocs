# <a id="VM_Models_Post_Bodies_Modal"></a> Class Modal

Namespace: [VM.Models.Post.Bodies](VM.Models.Post.Bodies.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class Modal : FEBody, IObservableObject, IDisposableObject, IPlottable, IContourable, IModal, IFEBody, IBody, IBodyBase, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
[IModal](VM.Models.Post.IModal.md), 
...
### <a id="VM_Models_Post_Bodies_Modal__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_System_Int32___"></a> Modal\(ResultDocument, Identifier, string, int\[\]\)

```csharp
public Modal(ResultDocument parentDocument, Identifier analysisResultID, string fullName, int[] markerIndexes)
```
...
### <a id="VM_Models_Post_Bodies_Modal_BodyType"></a> BodyType
...
### <a id="VM_Models_Post_Bodies_Modal_CanLoad"></a> CanLoad
...
### <a id="VM_Models_Post_Bodies_Modal_CanSave"></a> CanSave
...
### <a id="VM_Models_Post_Bodies_Modal_CategoryType"></a> CategoryType
...
### <a id="VM_Models_Post_Bodies_Modal_DfmfFilePath"></a> DfmfFilePath

```csharp
public string DfmfFilePath { get; set; }
```
...
### <a id="VM_Models_Post_Bodies_Modal_PlottableType"></a> PlottableType
...
### <a id="VM_Models_Post_Bodies_Modal_SelectedModes"></a> SelectedModes

```csharp
public IList<int> SelectedModes { get; set; }
```
...
### <a id="VM_Models_Post_Bodies_Modal_CreateElement_VM_Models_Post_HitItemElementInfo_VM_Models_PlotDataType_"></a> CreateElement\(HitItemElementInfo, PlotDataType\)
...
### <a id="VM_Models_Post_Bodies_Modal_CreateNode_VM_Models_Post_HitItemNodeInfo_VM_Models_PlotDataType_"></a> CreateNode\(HitItemNodeInfo, PlotDataType\)
