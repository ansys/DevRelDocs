# <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetPlanetaryTSDocument"></a> Class HiddenGearSetPlanetaryTSDocument
...
```csharp
public HiddenGearSetPlanetaryTSDocument(UIntPtr docCore)
```
