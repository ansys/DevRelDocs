# <a id="VM_Models_Post_DataSource_DFMFReader17"></a> Class DFMFReader17

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMFReader17 : DFMFReader, IDFMFReader
```
...
### <a id="VM_Models_Post_DataSource_DFMFReader17__ctor"></a> DFMFReader17\(\)
