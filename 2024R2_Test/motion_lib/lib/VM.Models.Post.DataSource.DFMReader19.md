# <a id="VM_Models_Post_DataSource_DFMReader19"></a> Class DFMReader19

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMReader19 : DFMReader, IDFMReader, IDFMInfo
```
...
### <a id="VM_Models_Post_DataSource_DFMReader19__ctor"></a> DFMReader19\(\)
...
### <a id="VM_Models_Post_DataSource_DFMReader19_BuildModels_VM_Models_Post_ResultDocument_System_String_VM_Models_Post_IDFRReader_VM_Identifier_"></a> BuildModels\(ResultDocument, string, IDFRReader, Identifier\)
