...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WriteElementRBE2_System_IO_BinaryWriter_VM_Models_FE_Utilities_FEConstraintRBE_"></a> WriteElementRBE2\(BinaryWriter, FEConstraintRBE\)

```csharp
public static void WriteElementRBE2(BinaryWriter writer, FEConstraintRBE rbe)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WriteMaterialArrudaBoyce_System_IO_BinaryWriter_VM_Models_FE_Utilities_MaterialAB_"></a> WriteMaterialArrudaBoyce\(BinaryWriter, MaterialAB\)

```csharp
public static void WriteMaterialArrudaBoyce(BinaryWriter writer, MaterialAB mat)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WriteMaterialISO_System_IO_BinaryWriter_VM_Models_FE_Utilities_MaterialISO_"></a> WriteMaterialISO\(BinaryWriter, MaterialISO\)

```csharp
public static void WriteMaterialISO(BinaryWriter writer, MaterialISO mat)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WriteMaterialMooneyRivlin_System_IO_BinaryWriter_VM_Models_FE_Utilities_MaterialMR_"></a> WriteMaterialMooneyRivlin\(BinaryWriter, MaterialMR\)

```csharp
public static void WriteMaterialMooneyRivlin(BinaryWriter writer, MaterialMR mat)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WriteMaterialNeoHookean_System_IO_BinaryWriter_VM_Models_FE_Utilities_MaterialNH_"></a> WriteMaterialNeoHookean\(BinaryWriter, MaterialNH\)

```csharp
public static void WriteMaterialNeoHookean(BinaryWriter writer, MaterialNH mat)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WriteMaterialORTHO_System_IO_BinaryWriter_VM_Models_FE_Utilities_MaterialORTHO_"></a> WriteMaterialORTHO\(BinaryWriter, MaterialORTHO\)

```csharp
public static void WriteMaterialORTHO(BinaryWriter writer, MaterialORTHO mat)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WriteMaterialOgden_System_IO_BinaryWriter_VM_Models_FE_Utilities_MaterialOG_"></a> WriteMaterialOgden\(BinaryWriter, MaterialOG\)

```csharp
public static void WriteMaterialOgden(BinaryWriter writer, MaterialOG mat)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WritePropertyBeam_System_IO_BinaryWriter_VM_Models_FE_Utilities_FEPropertyBeam_"></a> WritePropertyBeam\(BinaryWriter, FEPropertyBeam\)

```csharp
public static void WritePropertyBeam(BinaryWriter writer, FEPropertyBeam prop)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WritePropertyBeamL_System_IO_BinaryWriter_VM_Models_FE_Utilities_FEPropertyBeamL_"></a> WritePropertyBeamL\(BinaryWriter, FEPropertyBeamL\)

```csharp
public static void WritePropertyBeamL(BinaryWriter writer, FEPropertyBeamL prop)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WritePropertyShell_System_IO_BinaryWriter_VM_Models_FE_Utilities_FEPropertyShell_"></a> WritePropertyShell\(BinaryWriter, FEPropertyShell\)

```csharp
public static void WritePropertyShell(BinaryWriter writer, FEPropertyShell prop)
```
...
### <a id="VM_Models_FE_Mesh_Writer_NeutralWriter_WritePropertySolid_System_IO_BinaryWriter_VM_Models_FE_Utilities_FEPropertySolid_"></a> WritePropertySolid\(BinaryWriter, FEPropertySolid\)

```csharp
public static void WritePropertySolid(BinaryWriter writer, FEPropertySolid prop)
```
