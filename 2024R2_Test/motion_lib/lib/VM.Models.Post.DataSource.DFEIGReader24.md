# <a id="VM_Models_Post_DataSource_DFEIGReader24"></a> Class DFEIGReader24

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFEIGReader24 : DFEIGBinaryReader, IDFEIGReader
```
...
### <a id="VM_Models_Post_DataSource_DFEIGReader24__ctor"></a> DFEIGReader24\(\)

```csharp
public DFEIGReader24()
```
