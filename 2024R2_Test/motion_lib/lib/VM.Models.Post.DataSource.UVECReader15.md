# <a id="VM_Models_Post_DataSource_UVECReader15"></a> Class UVECReader15

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class UVECReader15 : UVECReader, IUVECReader
```
...
### <a id="VM_Models_Post_DataSource_UVECReader15__ctor_System_String_"></a> UVECReader15\(string\)

```csharp
public UVECReader15(string filePath)
```
