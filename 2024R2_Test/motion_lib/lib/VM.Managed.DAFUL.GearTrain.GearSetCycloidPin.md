# <a id="VM_Managed_DAFUL_GearTrain_GearSetCycloidPin"></a> Class GearSetCycloidPin
...
EntityBase ← 
Entity<PropertyGearSetCycloidPin\> ← 
...
Entity<PropertyGearSetCycloidPin\>.Initialize\(Unit.ConvertFactor\), 
Entity<PropertyGearSetCycloidPin\>.GetUnnamedObjectName\(object\), 
Entity<PropertyGearSetCycloidPin\>.FindLocal\(string\), 
Entity<PropertyGearSetCycloidPin\>.Property, 
...
`bMakePin` [bool](https://learn.microsoft.com/dotnet/api/system.boolean)
