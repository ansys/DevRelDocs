# <a id="VM_Models_Post_DataSource_DrivetrainReader15"></a> Class DrivetrainReader15

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DrivetrainReader15 : DrivetrainReader, IDriveTrainReader
```
...
### <a id="VM_Models_Post_DataSource_DrivetrainReader15__ctor"></a> DrivetrainReader15\(\)

```csharp
public DrivetrainReader15()
```

## Methods

### <a id="VM_Models_Post_DataSource_DrivetrainReader15_ReadAssemblyManagerInfo_VM_Models_Post_ResultDocument_VM_Identifier_VM_Models_Post_IDriveTrain___System_String_"></a> ReadAssemblyManagerInfo\(ResultDocument, Identifier, IDriveTrain\[\], string\)
