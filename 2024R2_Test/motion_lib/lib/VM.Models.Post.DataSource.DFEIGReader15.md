# <a id="VM_Models_Post_DataSource_DFEIGReader15"></a> Class DFEIGReader15

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFEIGReader15 : DFEIGTextReader, IDFEIGReader
```
...
[DFEIGReader15](VM.Models.Post.DataSource.DFEIGReader15.md)
...
### <a id="VM_Models_Post_DataSource_DFEIGReader15__ctor"></a> DFEIGReader15\(\)

```csharp
public DFEIGReader15()
```
