# <a id="VM_CAD_Builders_BuilderParamMultiIntersect"></a> Class BuilderParamMultiIntersect

Namespace: [VM.CAD.Builders](VM.CAD.Builders.md)  
Assembly: VM.CAD.Builders.dll  

```csharp
public class BuilderParamMultiIntersect : BuilderParamMulti
```
...
[BuilderParamMulti.FinalizeParameter\(\)](VM.CAD.Builders.BuilderParamMulti.md\#VM\_CAD\_Builders\_BuilderParamMulti\_FinalizeParameter), 
[BuilderParamMulti.Builders](VM.CAD.Builders.BuilderParamMulti.md\#VM\_CAD\_Builders\_BuilderParamMulti\_Builders), 
...
### <a id="VM_CAD_Builders_BuilderParamMultiIntersect__ctor"></a> BuilderParamMultiIntersect\(\)

```csharp
public BuilderParamMultiIntersect()
```
