# <a id="VM_Managed_DAFUL_GearTrain_Operation_UpdateGearInFE"></a> Class UpdateGearInFE
...
```csharp
public class UpdateGearInFE : OperationInHiddenDocument, IOperation
```
...
```csharp
public UpdateGearInFE(string strGearGeometryName, string strReferenceOffset, string strReferencePoint, string strParentType, string strRBEOrBearing)
```
...
```csharp
public UpdateGearInFE(Document3D document3D, string strGearGeometryName, string strReferenceOffset, string strReferencePoint, string strParentType, string strRBEOrBearing)
```
...
```csharp
public UpdateGearInFE(JournalParameter jp)
```
