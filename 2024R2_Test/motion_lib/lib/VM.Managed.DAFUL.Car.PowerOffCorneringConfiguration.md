# <a id="VM_Managed_DAFUL_Car_PowerOffCorneringConfiguration"></a> Class PowerOffCorneringConfiguration
...
```csharp
public class PowerOffCorneringConfiguration : FullCarAnalysisConfigurationBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable, IEnableManager, IHasRoadFile, ILinkOwner
```
