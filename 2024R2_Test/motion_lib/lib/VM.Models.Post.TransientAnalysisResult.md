# <a id="VM_Models_Post_TransientAnalysisResult"></a> Class TransientAnalysisResult

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public abstract class TransientAnalysisResult : AnalysisResult, IObservableObject, IDisposableObject
```
...
[DynamicAnalysisResult](VM.Models.Post.DynamicAnalysisResult.md), 
[InitialAnalysisResult](VM.Models.Post.InitialAnalysisResult.md), 
[ThermalAnalysisResult](VM.Models.Post.ThermalAnalysisResult.md)
...
[AnalysisResult.DisposeManagedResources\(\)](VM.Models.Post.AnalysisResult.md\#VM\_Models\_Post\_AnalysisResult\_DisposeManagedResources), 
[AnalysisResult.GenerateContour\(\)](VM.Models.Post.AnalysisResult.md\#VM\_Models\_Post\_AnalysisResult\_GenerateContour), 
...
### <a id="VM_Models_Post_TransientAnalysisResult__ctor_VM_Models_Post_ResultDocument_VM_Models_AnalysisResultType_VM_Models_Post_IUnstructGridModel_VM_Models_Post_MetaInfo_"></a> TransientAnalysisResult\(ResultDocument, AnalysisResultType, IUnstructGridModel, MetaInfo\)

```csharp
public TransientAnalysisResult(ResultDocument parentDocument, AnalysisResultType analysisResultType, IUnstructGridModel unstructGridModel, MetaInfo metaInfo)
```
