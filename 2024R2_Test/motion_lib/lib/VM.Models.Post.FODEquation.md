# <a id="VM_Models_Post_FODEquation"></a> Class FODEquation

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class FODEquation : EntityBase, IObservableObject, IDisposableObject, IPlottable, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_FODEquation__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_"></a> FODEquation\(ResultDocument, Identifier, string\)

```csharp
public FODEquation(ResultDocument parentDocument, Identifier analysisResultID, string fullName)
```
...
### <a id="VM_Models_Post_FODEquation_CategoryType"></a> CategoryType
...
### <a id="VM_Models_Post_FODEquation_DisplayName"></a> DisplayName
...
### <a id="VM_Models_Post_FODEquation_EntityType"></a> EntityType
...
### <a id="VM_Models_Post_FODEquation_PlottableType"></a> PlottableType
