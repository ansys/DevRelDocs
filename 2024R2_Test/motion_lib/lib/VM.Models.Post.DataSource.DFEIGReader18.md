# <a id="VM_Models_Post_DataSource_DFEIGReader18"></a> Class DFEIGReader18

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFEIGReader18 : DFEIGTextReader, IDFEIGReader
```
...
[DFEIGReader18](VM.Models.Post.DataSource.DFEIGReader18.md)
...
### <a id="VM_Models_Post_DataSource_DFEIGReader18__ctor"></a> DFEIGReader18\(\)

```csharp
public DFEIGReader18()
```
