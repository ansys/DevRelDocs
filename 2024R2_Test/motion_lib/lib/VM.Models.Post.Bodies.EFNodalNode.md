# <a id="VM_Models_Post_Bodies_EFNodalNode"></a> Class EFNodalNode

Namespace: [VM.Models.Post.Bodies](VM.Models.Post.Bodies.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class EFNodalNode : NodeBase, IObservableObject, IDisposableObject, INode, IBodyComponent, IComponent, IPlottable, IEntity, IObject, IHasName, IHasIndex, IHasID
```
