# <a id="VM_Models_Post_EigenvalueAnalysisResult"></a> Class EigenvalueAnalysisResult

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class EigenvalueAnalysisResult : AnalysisResult, IObservableObject, IDisposableObject
```
...
### <a id="VM_Models_Post_EigenvalueAnalysisResult__ctor_VM_Models_Post_ResultDocument_VM_Models_AnalysisResultType_VM_Models_Post_IUnstructGridModel_VM_Models_Post_MetaInfo_"></a> EigenvalueAnalysisResult\(ResultDocument, AnalysisResultType, IUnstructGridModel, MetaInfo\)

```csharp
public EigenvalueAnalysisResult(ResultDocument parentDocument, AnalysisResultType analysisResultType, IUnstructGridModel unstructGridModel, MetaInfo metaInfo)
```
...
### <a id="VM_Models_Post_EigenvalueAnalysisResult_Frame"></a> Frame
...
### <a id="VM_Models_Post_EigenvalueAnalysisResult_TargetSamplingTime"></a> TargetSamplingTime
...
### <a id="VM_Models_Post_EigenvalueAnalysisResult_WhenAnimationLoaded"></a> WhenAnimationLoaded

```csharp
public IObservable<bool> WhenAnimationLoaded { get; }
```
...
### <a id="VM_Models_Post_EigenvalueAnalysisResult_WhenTargetSamplingTimeApplied"></a> WhenTargetSamplingTimeApplied

```csharp
public IObservable<bool> WhenTargetSamplingTimeApplied { get; }
```
...
### <a id="VM_Models_Post_EigenvalueAnalysisResult_DisposeManagedResources"></a> DisposeManagedResources\(\)

```csharp
protected override void DisposeManagedResources()
```

### <a id="VM_Models_Post_EigenvalueAnalysisResult_InitializeAnimationStates"></a> InitializeAnimationStates\(\)

```csharp
public void InitializeAnimationStates()
```

### <a id="VM_Models_Post_EigenvalueAnalysisResult_LoadAnimation_VM_Models_Post_IFrequency_"></a> LoadAnimation\(IFrequency\)

```csharp
public void LoadAnimation(IFrequency frequency)
```

#### Parameters

`frequency` [IFrequency](VM.Models.Post.IFrequency.md)
