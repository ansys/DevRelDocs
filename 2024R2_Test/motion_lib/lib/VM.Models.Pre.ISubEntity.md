# <a id="VM_Models_Pre_ISubEntity"></a> Interface ISubEntity
...
```csharp
public interface ISubEntity : IEntityBase, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, IHasName, IEnabled, IHasComment
```
