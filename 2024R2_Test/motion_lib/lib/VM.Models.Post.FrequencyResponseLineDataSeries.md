# <a id="VM_Models_Post_FrequencyResponseLineDataSeries"></a> Class FrequencyResponseLineDataSeries

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class FrequencyResponseLineDataSeries : LineDataSeriesBase, IObservableObject, IDisposableObject, ISeries, IObject, IHasName
```
...
### <a id="VM_Models_Post_FrequencyResponseLineDataSeries_From"></a> From
...
### <a id="VM_Models_Post_FrequencyResponseLineDataSeries_LineSeriesType"></a> LineSeriesType
...
### <a id="VM_Models_Post_FrequencyResponseLineDataSeries_NeedSavePoints"></a> NeedSavePoints
...
### <a id="VM_Models_Post_FrequencyResponseLineDataSeries_SamplingTime"></a> SamplingTime
...
### <a id="VM_Models_Post_FrequencyResponseLineDataSeries_SamplingTimeSequence"></a> SamplingTimeSequence
...
### <a id="VM_Models_Post_FrequencyResponseLineDataSeries_SelectedInputChannels"></a> SelectedInputChannels

```csharp
[SaveProperty(false)]
public string[] SelectedInputChannels { get; set; }
```
...
### <a id="VM_Models_Post_FrequencyResponseLineDataSeries_SelectedOutputChannel"></a> SelectedOutputChannel

```csharp
[SaveProperty(false)]
public string SelectedOutputChannel { get; set; }
```
...
### <a id="VM_Models_Post_FrequencyResponseLineDataSeries_Step"></a> Step
...
### <a id="VM_Models_Post_FrequencyResponseLineDataSeries_To"></a> To
