# <a id="VM_Managed_Material_AttributeFatigueMaterial"></a> Class AttributeFatigueMaterial
...
```csharp
public class AttributeFatigueMaterial : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
