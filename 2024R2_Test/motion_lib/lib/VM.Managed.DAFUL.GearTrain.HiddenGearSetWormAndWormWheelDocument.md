# <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetWormAndWormWheelDocument"></a> Class HiddenGearSetWormAndWormWheelDocument
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetWormAndWormWheelDocument__ctor_System_UIntPtr_"></a> HiddenGearSetWormAndWormWheelDocument\(UIntPtr\)

Initializes a new instance of the <xref href="VM.Managed.DAFUL.GearTrain.HiddenGearSetWormAndWormWheelDocument" data-throw-if-not-resolved="false"></xref> class.

```csharp
public HiddenGearSetWormAndWormWheelDocument(UIntPtr docCore)
```
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetWormAndWormWheelDocument_InitialCategories"></a> InitialCategories
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetWormAndWormWheelDocument_FindCategory_System_String_"></a> FindCategory\(string\)
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetWormAndWormWheelDocument_GetCenterY_System_Double___"></a> GetCenterY\(double\[\]\)
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetWormAndWormWheelDocument_GetExternalState_System_Boolean___"></a> GetExternalState\(bool\[\]\)
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetWormAndWormWheelDocument_InitializeCategoryInfo_System_String_"></a> InitializeCategoryInfo\(string\)
