# <a id="VM_Models_Post_HasOriginalSeries"></a> Class HasOriginalSeries

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public abstract class HasOriginalSeries : LineDataSeriesBase, IObservableObject, IDisposableObject, ISeries, IObject, IHasName
```
...
### <a id="VM_Models_Post_HasOriginalSeries_NeedSavePoints"></a> NeedSavePoints
...
### <a id="VM_Models_Post_HasOriginalSeries_OriginalSeriesID"></a> OriginalSeriesID

```csharp
[SaveProperty(false)]
public string OriginalSeriesID { get; init; }
```
...
### <a id="VM_Models_Post_HasOriginalSeries_ParentDocument"></a> ParentDocument
