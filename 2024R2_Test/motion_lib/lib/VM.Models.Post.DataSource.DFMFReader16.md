# <a id="VM_Models_Post_DataSource_DFMFReader16"></a> Class DFMFReader16

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMFReader16 : DFMFReader, IDFMFReader
```
...
### <a id="VM_Models_Post_DataSource_DFMFReader16__ctor"></a> DFMFReader16\(\)
