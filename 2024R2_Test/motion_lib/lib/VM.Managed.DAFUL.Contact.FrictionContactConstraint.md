# <a id="VM_Managed_DAFUL_Contact_FrictionContactConstraint"></a> Class FrictionContactConstraint
...
```csharp
public class FrictionContactConstraint : Friction, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
### <a id="VM_Managed_DAFUL_Contact_FrictionContactConstraint__ctor"></a> FrictionContactConstraint\(\)
