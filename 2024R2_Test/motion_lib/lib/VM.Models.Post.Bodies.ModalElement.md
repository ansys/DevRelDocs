# <a id="VM_Models_Post_Bodies_ModalElement"></a> Class ModalElement

Namespace: [VM.Models.Post.Bodies](VM.Models.Post.Bodies.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class ModalElement : ElementBase, IObservableObject, IDisposableObject, IElement, IBodyComponent, IComponent, IPlottable, IEntity, IObject, IHasName, IHasIndex, IHasID
```
