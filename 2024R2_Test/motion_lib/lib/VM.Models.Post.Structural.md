# <a id="VM_Models_Post_Structural"></a> Class Structural

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class Structural : RequestBase, IObservableObject, IDisposableObject, IRequest, IPlottable, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_Structural__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_"></a> Structural\(ResultDocument, Identifier, string\)

```csharp
public Structural(ResultDocument parentDocument, Identifier analysisResultID, string fullName)
```
...
### <a id="VM_Models_Post_Structural_PlottableType"></a> PlottableType
