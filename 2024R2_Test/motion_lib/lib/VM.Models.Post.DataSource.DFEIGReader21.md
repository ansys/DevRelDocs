# <a id="VM_Models_Post_DataSource_DFEIGReader21"></a> Class DFEIGReader21

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFEIGReader21 : DFEIGTextReader, IDFEIGReader
```
...
[DFEIGReader21](VM.Models.Post.DataSource.DFEIGReader21.md)
...
### <a id="VM_Models_Post_DataSource_DFEIGReader21__ctor"></a> DFEIGReader21\(\)

```csharp
public DFEIGReader21()
```
