# <a id="VM_Models_Post_NonLinearStaticsAnalysisResult"></a> Class NonLinearStaticsAnalysisResult

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class NonLinearStaticsAnalysisResult : StaticAnalysisResult, IObservableObject, IDisposableObject
```
...
### <a id="VM_Models_Post_NonLinearStaticsAnalysisResult__ctor_VM_Models_Post_ResultDocument_VM_Models_AnalysisResultType_VM_Models_Post_IUnstructGridModel_VM_Models_Post_MetaInfo_"></a> NonLinearStaticsAnalysisResult\(ResultDocument, AnalysisResultType, IUnstructGridModel, MetaInfo\)

```csharp
public NonLinearStaticsAnalysisResult(ResultDocument parentDocument, AnalysisResultType analysisResultType, IUnstructGridModel unstructGridModel, MetaInfo metaInfo)
```
