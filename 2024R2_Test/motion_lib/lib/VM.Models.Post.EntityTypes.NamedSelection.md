# <a id="VM_Models_Post_EntityTypes_NamedSelection"></a> Class NamedSelection

Namespace: [VM.Models.Post.EntityTypes](VM.Models.Post.EntityTypes.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class NamedSelection : EntityBase, IObservableObject, IDisposableObject, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_EntityTypes_NamedSelection__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_"></a> NamedSelection\(ResultDocument, Identifier, string\)

```csharp
public NamedSelection(ResultDocument parentDocument, Identifier analysisResultID, string fullName)
```
...
### <a id="VM_Models_Post_EntityTypes_NamedSelection_CategoryType"></a> CategoryType
...
### <a id="VM_Models_Post_EntityTypes_NamedSelection_EntityType"></a> EntityType
...
### <a id="VM_Models_Post_EntityTypes_NamedSelection_Ids"></a> Ids
...
### <a id="VM_Models_Post_EntityTypes_NamedSelection_Location"></a> Location
