# <a id="VM_Models_Post_SInput"></a> Class SInput

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class SInput : EntityBase, IObservableObject, IDisposableObject, IPlottable, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_SInput__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_"></a> SInput\(ResultDocument, Identifier, string\)

```csharp
public SInput(ResultDocument parentDocument, Identifier analysisResultID, string fullName)
```
...
### <a id="VM_Models_Post_SInput_CategoryType"></a> CategoryType
...
### <a id="VM_Models_Post_SInput_DisplayName"></a> DisplayName
...
### <a id="VM_Models_Post_SInput_EntityType"></a> EntityType
...
### <a id="VM_Models_Post_SInput_PlottableType"></a> PlottableType
