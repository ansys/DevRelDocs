# <a id="VM_Managed_DAFUL_Car_ApplyParameterOperation"></a> Class ApplyParameterOperation
...
```csharp
public class ApplyParameterOperation : OperationBase, IOperation
```
...
#### Field Value
 ...
 [ApplyParameterOperation](VM.Managed.DAFUL.Car.ApplyParameterOperation.md).[ApplyParameterCallback](VM.Managed.DAFUL.Car.ApplyParameterOperation.ApplyParameterCallback.md)
