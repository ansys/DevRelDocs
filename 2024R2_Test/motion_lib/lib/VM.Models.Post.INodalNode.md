# <a id="VM_Models_Post_INodalNode"></a> Interface INodalNode

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public interface INodalNode : INode, IBodyComponent, IComponent, IEntity, IObject, IHasName, IHasIndex, IHasID
```
