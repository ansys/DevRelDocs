# <a id="VM_Models_Post_DataSource_DFEIGReader14"></a> Class DFEIGReader14

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFEIGReader14 : DFEIGTextReader, IDFEIGReader
```
...
[DFEIGReader14](VM.Models.Post.DataSource.DFEIGReader14.md)
...
### <a id="VM_Models_Post_DataSource_DFEIGReader14__ctor"></a> DFEIGReader14\(\)

```csharp
public DFEIGReader14()
```
