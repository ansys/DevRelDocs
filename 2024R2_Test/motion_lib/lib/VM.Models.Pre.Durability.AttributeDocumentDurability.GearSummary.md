# <a id="VM_Models_Pre_Durability_AttributeDocumentDurability_GearSummary"></a> Class AttributeDocumentDurability.GearSummary
...
```csharp
public class AttributeDocumentDurability.GearSummary
```
