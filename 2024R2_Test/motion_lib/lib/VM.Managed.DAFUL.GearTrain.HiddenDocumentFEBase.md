# <a id="VM_Managed_DAFUL_GearTrain_HiddenDocumentFEBase"></a> Class HiddenDocumentFEBase
...
```csharp
public HiddenDocumentFEBase(UIntPtr docCore)
```
...
```csharp
public void ReAssemblyNodalBody(NodalBody nb)
```
