# <a id="VM_Models_Post_IElement"></a> Interface IElement

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public interface IElement : IBodyComponent, IComponent, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_IElement_ElementType"></a> ElementType
