# <a id="VM_Models_Post_DataSource_DFMReader16"></a> Class DFMReader16

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMReader16 : DFMReader, IDFMReader, IDFMInfo
```
...
### <a id="VM_Models_Post_DataSource_DFMReader16__ctor"></a> DFMReader16\(\)
...
### <a id="VM_Models_Post_DataSource_DFMReader16_BuildModels_VM_Models_Post_ResultDocument_System_String_VM_Models_Post_IDFRReader_VM_Identifier_"></a> BuildModels\(ResultDocument, string, IDFRReader, Identifier\)
...
### <a id="VM_Models_Post_DataSource_DFMReader16_ReadFEMaterial_VM_Models_Post_MetaInfo_System_String_System_Int32__"></a> ReadFEMaterial\(MetaInfo, string, ref int\)
...
### <a id="VM_Models_Post_DataSource_DFMReader16_ReadFEProperty_VM_Models_Post_ResultDocument_VM_Identifier_VM_Models_Post_MetaInfo_System_String_System_Int32__"></a> ReadFEProperty\(ResultDocument, Identifier, MetaInfo, string, ref int\)
...
### <a id="VM_Models_Post_DataSource_DFMReader16_ReadUnit_VM_Models_Post_MetaInfo_System_String_System_Int32__"></a> ReadUnit\(MetaInfo, string, ref int\)
