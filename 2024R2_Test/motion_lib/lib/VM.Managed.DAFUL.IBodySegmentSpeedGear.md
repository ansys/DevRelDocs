# <a id="VM_Managed_DAFUL_IBodySegmentSpeedGear"></a> Interface IBodySegmentSpeedGear
...
```csharp
public interface IBodySegmentSpeedGear : IManualTransmissionComponent, IHasBuilder, IConnectable, IMarkerParent, IEntityRelation, IHasBody
```
