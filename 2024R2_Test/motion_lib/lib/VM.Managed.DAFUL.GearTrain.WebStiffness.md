# <a id="VM_Managed_DAFUL_GearTrain_WebStiffness"></a> Class WebStiffness
...
```csharp
public class WebStiffness : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public ExpressionValueVariable Angle { get; set; }
```
