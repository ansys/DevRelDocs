# <a id="VM_Models_Post_EFPLoad"></a> Class EFPLoad

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.EntityTypes.dll  

```csharp
public sealed class EFPLoad : EasyFlexEntityBase, IObservableObject, IDisposableObject, IConnector, IPlottable, IVectorDisplayable, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
[EasyFlexEntityBase.EntityType](VM.Models.Post.EasyFlexEntityBase.md\#VM\_Models\_Post\_EasyFlexEntityBase\_EntityType), 
[EasyFlexEntityBase.NUM\_OF\_VARIABLEBLOCK\_RESULT](VM.Models.Post.EasyFlexEntityBase.md\#VM\_Models\_Post\_EasyFlexEntityBase\_NUM\_OF\_VARIABLEBLOCK\_RESULT), 
...
### <a id="VM_Models_Post_EFPLoad__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_VM_Models_Post_IDFMInfo_System_Int32___"></a> EFPLoad\(ResultDocument, Identifier, string, IDFMInfo, int\[\]\)

```csharp
public EFPLoad(ResultDocument parentDocument, Identifier analysisResultID, string fullName, IDFMInfo dfmInfo, int[] markerIndexes)
```
...
### <a id="VM_Models_Post_EFPLoad_CategoryType"></a> CategoryType
...
### <a id="VM_Models_Post_EFPLoad_ConnectorType"></a> ConnectorType
...
### <a id="VM_Models_Post_EFPLoad_NUM_OF_RESULT"></a> NUM\_OF\_RESULT
