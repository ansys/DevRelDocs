# <a id="VM_Models_Post_DataSource_DFEIGReader17"></a> Class DFEIGReader17

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFEIGReader17 : DFEIGTextReader, IDFEIGReader
```
...
[DFEIGReader17](VM.Models.Post.DataSource.DFEIGReader17.md)
...
### <a id="VM_Models_Post_DataSource_DFEIGReader17__ctor"></a> DFEIGReader17\(\)

```csharp
public DFEIGReader17()
```
