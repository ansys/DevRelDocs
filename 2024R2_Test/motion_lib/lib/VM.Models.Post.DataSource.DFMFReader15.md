# <a id="VM_Models_Post_DataSource_DFMFReader15"></a> Class DFMFReader15

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMFReader15 : DFMFReader, IDFMFReader
```
...
### <a id="VM_Models_Post_DataSource_DFMFReader15__ctor"></a> DFMFReader15\(\)
