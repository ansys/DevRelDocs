# <a id="VM_Models_Post_Forces_RSpringDamper"></a> Class RSpringDamper

Namespace: [VM.Models.Post.Forces](VM.Models.Post.Forces.md)  
Assembly: VM.Models.Post.EntityTypes.dll  

```csharp
public sealed class RSpringDamper : ForceBase, IObservableObject, IDisposableObject, IConnector, IVectorDisplayable, IPlottable, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_Forces_RSpringDamper__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_VM_Models_Post_IDFMInfo_System_Int32___"></a> RSpringDamper\(ResultDocument, Identifier, string, IDFMInfo, int\[\]\)

```csharp
public RSpringDamper(ResultDocument parentDocument, Identifier analysisResultID, string fullName, IDFMInfo dfmInfo, int[] markerIndexes)
```
...
### <a id="VM_Models_Post_Forces_RSpringDamper_ConnectorType"></a> ConnectorType
...
### <a id="VM_Models_Post_Forces_RSpringDamper_NUM_OF_RESULT"></a> NUM\_OF\_RESULT
...
### <a id="VM_Models_Post_Forces_RSpringDamper_NUM_OF_VARIABLEBLOCK_RESULT"></a> NUM\_OF\_VARIABLEBLOCK\_RESULT
