# <a id="VM_Models_Post_VisualizationImpl_UnstructGrid_DynamicUnstructGridModel"></a> Class DynamicUnstructGridModel
...
```csharp
public class DynamicUnstructGridModel : ContourUnstructGridModel, IDynamicUnstructGridModel, IContourUnstructGridModel, IUnstructGridModel, IModel
```
...
### <a id="VM_Models_Post_VisualizationImpl_UnstructGrid_DynamicUnstructGridModel__ctor"></a> DynamicUnstructGridModel\(\)

```csharp
public DynamicUnstructGridModel()
```

## Properties

### <a id="VM_Models_Post_VisualizationImpl_UnstructGrid_DynamicUnstructGridModel_RoadGeometryModel"></a> RoadGeometryModel

```csharp
public RoadGeometryModel RoadGeometryModel { get; }
```
...
### <a id="VM_Models_Post_VisualizationImpl_UnstructGrid_DynamicUnstructGridModel_VectorDisplayManager"></a> VectorDisplayManager

```csharp
public IVectorDisplayManager VectorDisplayManager { get; }
```
...
### <a id="VM_Models_Post_VisualizationImpl_UnstructGrid_DynamicUnstructGridModel_CreateVectorDisplayData_VM_Models_Post_IVectorDisplay_System_Int32_"></a> CreateVectorDisplayData\(IVectorDisplay, int\)

```csharp
public IVectorDisplayAnimationBase CreateVectorDisplayData(IVectorDisplay vectorDisplayModel, int stateID)
```

#### Parameters

`vectorDisplayModel` IVectorDisplay
...
### <a id="VM_Models_Post_VisualizationImpl_UnstructGrid_DynamicUnstructGridModel_SetDisplacementResultIDToModelSpec_System_Int32_"></a> SetDisplacementResultIDToModelSpec\(int\)
...
### <a id="VM_Models_Post_VisualizationImpl_UnstructGrid_DynamicUnstructGridModel_SetFirstFrameLageExt"></a> SetFirstFrameLageExt\(\)

```csharp
public void SetFirstFrameLageExt()
```

### <a id="VM_Models_Post_VisualizationImpl_UnstructGrid_DynamicUnstructGridModel_SetGeometryParts_System_Collections_Generic_IEnumerable_VM_Models_Post_IHasRoadGeometry__"></a> SetGeometryParts\(IEnumerable<IHasRoadGeometry\>\)

```csharp
public void SetGeometryParts(IEnumerable<IHasRoadGeometry> vehicleRoads)
```

#### Parameters

`vehicleRoads` [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable\-1)<IHasRoadGeometry\>

### <a id="VM_Models_Post_VisualizationImpl_UnstructGrid_DynamicUnstructGridModel_UpdateAnimation"></a> UpdateAnimation\(\)

```csharp
public override void UpdateAnimation()
```

### <a id="VM_Models_Post_VisualizationImpl_UnstructGrid_DynamicUnstructGridModel_UpdateMaterialProperty_VM_Models_Post_MetaInfo_"></a> UpdateMaterialProperty\(MetaInfo\)

```csharp
public void UpdateMaterialProperty(MetaInfo metaInfo)
```
