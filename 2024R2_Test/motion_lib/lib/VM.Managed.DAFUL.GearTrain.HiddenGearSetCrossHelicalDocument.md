# <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetCrossHelicalDocument"></a> Class HiddenGearSetCrossHelicalDocument
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetCrossHelicalDocument__ctor_System_UIntPtr_"></a> HiddenGearSetCrossHelicalDocument\(UIntPtr\)

Initializes a new instance of the <xref href="VM.Managed.DAFUL.GearTrain.HiddenGearSetCrossHelicalDocument" data-throw-if-not-resolved="false"></xref> class.

```csharp
public HiddenGearSetCrossHelicalDocument(UIntPtr docCore)
```
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetCrossHelicalDocument_InitialCategories"></a> InitialCategories
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetCrossHelicalDocument_FindCategory_System_String_"></a> FindCategory\(string\)
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetCrossHelicalDocument_GetCenterY_System_Double___"></a> GetCenterY\(double\[\]\)
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetCrossHelicalDocument_GetExternalState_System_Boolean___"></a> GetExternalState\(bool\[\]\)
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenGearSetCrossHelicalDocument_InitializeCategoryInfo_System_String_"></a> InitializeCategoryInfo\(string\)
