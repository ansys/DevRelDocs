# <a id="VM_Managed_DAFUL_Car_SteeringDocument"></a> Class SteeringDocument
...
### <a id="VM_Managed_DAFUL_Car_SteeringDocument__ctor_System_UIntPtr_"></a> SteeringDocument\(UIntPtr\)

Initializes a new instance of the <xref href="VM.Managed.DAFUL.Car.SteeringDocument" data-throw-if-not-resolved="false"></xref> class.

```csharp
public SteeringDocument(UIntPtr docCore)
```
...
### <a id="VM_Managed_DAFUL_Car_SteeringDocument_InitialCategories"></a> InitialCategories
...
### <a id="VM_Managed_DAFUL_Car_SteeringDocument_Interfaces"></a> Interfaces
...
### <a id="VM_Managed_DAFUL_Car_SteeringDocument_MinorRoleType"></a> MinorRoleType
...
### <a id="VM_Managed_DAFUL_Car_SteeringDocument_ClearDocument"></a> ClearDocument\(\)
...
### <a id="VM_Managed_DAFUL_Car_SteeringDocument_FindCategory_System_String_"></a> FindCategory\(string\)
...
### <a id="VM_Managed_DAFUL_Car_SteeringDocument_InitializeCategoryInfo_System_String_"></a> InitializeCategoryInfo\(string\)
...
### <a id="VM_Managed_DAFUL_Car_SteeringDocument_InitializeInterface"></a> InitializeInterface\(\)
...
### <a id="VM_Managed_DAFUL_Car_SteeringDocument_InitializeSimParam"></a> InitializeSimParam\(\)
...
### <a id="VM_Managed_DAFUL_Car_SteeringDocument_LoadTemplateBasedXml_System_Xml_XmlReader_"></a> LoadTemplateBasedXml\(XmlReader\)
...
### <a id="VM_Managed_DAFUL_Car_SteeringDocument_OnDeserialization_System_Object_"></a> OnDeserialization\(object\)
...
### <a id="VM_Managed_DAFUL_Car_SteeringDocument_SaveTemplateBasedXml_System_Xml_XmlWriter_"></a> SaveTemplateBasedXml\(XmlWriter\)
