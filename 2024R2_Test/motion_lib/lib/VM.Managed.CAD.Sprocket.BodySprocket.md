# <a id="VM_Managed_CAD_Sprocket_BodySprocket"></a> Class BodySprocket
...
```csharp
public BodySprocket(Builder builder)
```
...
```csharp
public BodySprocket ReGenerateBodyInformation(XmlDocument dom)
```
