# <a id="VM_Managed_DAFUL_Chained_DocumentChainedSegment"></a> Class DocumentChainedSegment
...
### <a id="VM_Managed_DAFUL_Chained_DocumentChainedSegment__ctor_System_UIntPtr_"></a> DocumentChainedSegment\(UIntPtr\)

Initializes a new instance of the <xref href="VM.Managed.DAFUL.Chained.DocumentChainedSegment" data-throw-if-not-resolved="false"></xref> class.
...
### <a id="VM_Managed_DAFUL_Chained_DocumentChainedSegment_InitialCategories"></a> InitialCategories
...
### <a id="VM_Managed_DAFUL_Chained_DocumentChainedSegment_WorkingPlane"></a> WorkingPlane
...
### <a id="VM_Managed_DAFUL_Chained_DocumentChainedSegment_CreateAssemblyImpl"></a> CreateAssemblyImpl\(\)
...
### <a id="VM_Managed_DAFUL_Chained_DocumentChainedSegment_FindCategory_System_String_"></a> FindCategory\(string\)
...
### <a id="VM_Managed_DAFUL_Chained_DocumentChainedSegment_GetData_System_Xml_XmlNode_"></a> GetData\(XmlNode\)
...
### <a id="VM_Managed_DAFUL_Chained_DocumentChainedSegment_InitializeCategoryInfo_System_String_"></a> InitializeCategoryInfo\(string\)
...
### <a id="VM_Managed_DAFUL_Chained_DocumentChainedSegment_LinkRequestDestroying_System_Object_VM_Managed_LinkEventArgs_"></a> LinkRequestDestroying\(object, LinkEventArgs\)
...
### <a id="VM_Managed_DAFUL_Chained_DocumentChainedSegment_OnDeserialization_System_Object_"></a> OnDeserialization\(object\)
...
### <a id="VM_Managed_DAFUL_Chained_DocumentChainedSegment_OnPostMakeDocumentImpl_VM_Managed_DocCreateAnalysisInfo_"></a> OnPostMakeDocumentImpl\(DocCreateAnalysisInfo\)
...
### <a id="VM_Managed_DAFUL_Chained_DocumentChainedSegment_SetData_System_Xml_XmlNode_"></a> SetData\(XmlNode\)
