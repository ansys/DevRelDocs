# <a id="VM_Models_Post_INodalElement"></a> Interface INodalElement

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public interface INodalElement : IElement, IBodyComponent, IComponent, IEntity, IObject, IHasName, IHasIndex, IHasID
```
