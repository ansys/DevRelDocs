# <a id="VM_Models_Post_FrequencyTimeLineDataSeries"></a> Class FrequencyTimeLineDataSeries

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class FrequencyTimeLineDataSeries : LineDataSeriesBase, IObservableObject, IDisposableObject, ISeries, IObject, IHasName
```
...
### <a id="VM_Models_Post_FrequencyTimeLineDataSeries_LineSeriesType"></a> LineSeriesType
...
### <a id="VM_Models_Post_FrequencyTimeLineDataSeries_NeedSavePoints"></a> NeedSavePoints
...
### <a id="VM_Models_Post_FrequencyTimeLineDataSeries_Time"></a> Time
