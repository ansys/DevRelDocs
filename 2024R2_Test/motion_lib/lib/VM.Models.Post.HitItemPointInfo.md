# <a id="VM_Models_Post_HitItemPointInfo"></a> Class HitItemPointInfo

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class HitItemPointInfo : HitItemInfo, IObservableObject, IDisposableObject
```
...
### <a id="VM_Models_Post_HitItemPointInfo__ctor_VM_Models_Post_IHitItem_"></a> HitItemPointInfo\(IHitItem\)

```csharp
public HitItemPointInfo(IHitItem ptr)
```
...
### <a id="VM_Models_Post_HitItemPointInfo_TypeOfHitItemInfo"></a> TypeOfHitItemInfo
