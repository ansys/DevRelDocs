# <a id="VM_Models_Post_DataSource_UVECReader12"></a> Class UVECReader12

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class UVECReader12 : UVECReader, IUVECReader
```
...
### <a id="VM_Models_Post_DataSource_UVECReader12__ctor_System_String_"></a> UVECReader12\(string\)

```csharp
public UVECReader12(string filePath)
```
