# <a id="VM_Managed_DAFUL_Operation_ConfigModify"></a> Class ConfigModify
...
```csharp
public class ConfigModify : SimulationRun, IOperation
```
...
### <a id="VM_Managed_DAFUL_Operation_ConfigModify__ctor_VM_Managed_Document_"></a> ConfigModify\(Document\)
...
### <a id="VM_Managed_DAFUL_Operation_ConfigModify__ctor_VM_Managed_Operation_JournalParameter_"></a> ConfigModify\(JournalParameter\)
...
### <a id="VM_Managed_DAFUL_Operation_ConfigModify_Name"></a> Name
...
### <a id="VM_Managed_DAFUL_Operation_ConfigModify_Execute"></a> Execute\(\)
...
### <a id="VM_Managed_DAFUL_Operation_ConfigModify_PrepareForm_VM_Managed_DAFUL_Pre_Forms_SimulationFormBase_"></a> PrepareForm\(SimulationFormBase\)
...
### <a id="VM_Managed_DAFUL_Operation_ConfigModify_UpdateUI_VM_Managed_UI_IUIUpdate_VM_Managed_Document_"></a> UpdateUI\(IUIUpdate, Document\)
