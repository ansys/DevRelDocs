# <a id="VM_Models_Post_DataSource_DrivetrainReader19"></a> Class DrivetrainReader19

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DrivetrainReader19 : DrivetrainReader, IDriveTrainReader
```
...
### <a id="VM_Models_Post_DataSource_DrivetrainReader19__ctor"></a> DrivetrainReader19\(\)

```csharp
public DrivetrainReader19()
```

## Methods

### <a id="VM_Models_Post_DataSource_DrivetrainReader19_ReadAssemblyManagerInfo_VM_Models_Post_ResultDocument_VM_Identifier_VM_Models_Post_IDriveTrain___System_String_"></a> ReadAssemblyManagerInfo\(ResultDocument, Identifier, IDriveTrain\[\], string\)
