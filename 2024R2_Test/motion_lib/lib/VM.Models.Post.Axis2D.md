# <a id="VM_Models_Post_Axis2D"></a> Class Axis2D

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public class Axis2D : Axis, IObservableObject, IDisposableObject, IObject, IHasName
```
...
### <a id="VM_Models_Post_Axis2D_TitleSize"></a> TitleSize
...
### <a id="VM_Models_Post_Axis2D_TitleWeight"></a> TitleWeight
