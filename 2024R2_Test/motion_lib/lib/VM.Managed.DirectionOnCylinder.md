# <a id="VM_Managed_DirectionOnCylinder"></a> Class DirectionOnCylinder
...
```csharp
public class DirectionOnCylinder : DirectionOnGeometryBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
