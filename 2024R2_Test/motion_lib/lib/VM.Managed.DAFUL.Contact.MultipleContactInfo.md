# <a id="VM_Managed_DAFUL_Contact_MultipleContactInfo"></a> Class MultipleContactInfo
...
```csharp
public class MultipleContactInfo : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public MultipleContactInfo(IOwned owner)
```
