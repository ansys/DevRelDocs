# <a id="VM_Models_Post_HitItemGeneralMarkerInfo"></a> Class HitItemGeneralMarkerInfo

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class HitItemGeneralMarkerInfo : HitItemMarkerInfo, IObservableObject, IDisposableObject
```
...
### <a id="VM_Models_Post_HitItemGeneralMarkerInfo__ctor_VM_Models_Post_IHitItem_"></a> HitItemGeneralMarkerInfo\(IHitItem\)

```csharp
public HitItemGeneralMarkerInfo(IHitItem ptr)
```
...
### <a id="VM_Models_Post_HitItemGeneralMarkerInfo_TypeOfHitItemInfo"></a> TypeOfHitItemInfo
