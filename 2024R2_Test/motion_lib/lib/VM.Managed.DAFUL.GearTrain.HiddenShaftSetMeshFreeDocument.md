# <a id="VM_Managed_DAFUL_GearTrain_HiddenShaftSetMeshFreeDocument"></a> Class HiddenShaftSetMeshFreeDocument
...
[HiddenDocumentMeshFreeBase.ReAssemblyAssembledBody\(AssembledBody\)](VM.Managed.DAFUL.GearTrain.HiddenDocumentMeshFreeBase.md\#VM\_Managed\_DAFUL\_GearTrain\_HiddenDocumentMeshFreeBase\_ReAssemblyAssembledBody\_VM\_Managed\_DAFUL\_AssembledBody\_), 
[HiddenDocumentMeshBase.CreateAssemblyImpl\(\)](VM.Managed.DAFUL.GearTrain.HiddenDocumentMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_HiddenDocumentMeshBase\_CreateAssemblyImpl), 
[HiddenDocumentMeshBase.ClearDocument\(\)](VM.Managed.DAFUL.GearTrain.HiddenDocumentMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_HiddenDocumentMeshBase\_ClearDocument), 
[HiddenDocumentMeshBase.LinkRequestDestroying\(object, LinkEventArgs\)](VM.Managed.DAFUL.GearTrain.HiddenDocumentMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_HiddenDocumentMeshBase\_LinkRequestDestroying\_System\_Object\_VM\_Managed\_LinkEventArgs\_), 
[HiddenDocumentMeshBase.GetUnnamedObjectName\(object\)](VM.Managed.DAFUL.GearTrain.HiddenDocumentMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_HiddenDocumentMeshBase\_GetUnnamedObjectName\_System\_Object\_), 
[HiddenDocumentMeshBase.Find\(string\)](VM.Managed.DAFUL.GearTrain.HiddenDocumentMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_HiddenDocumentMeshBase\_Find\_System\_String\_), 
[HiddenDocumentMeshBase.ShowHideDimension\(\)](VM.Managed.DAFUL.GearTrain.HiddenDocumentMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_HiddenDocumentMeshBase\_ShowHideDimension), 
[HiddenDocumentMeshBase.CreateViewCore\(UIntPtr\)](VM.Managed.DAFUL.GearTrain.HiddenDocumentMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_HiddenDocumentMeshBase\_CreateViewCore\_System\_UIntPtr\_), 
[HiddenDocumentMeshBase.GetAllGears\(\)](VM.Managed.DAFUL.GearTrain.HiddenDocumentMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_HiddenDocumentMeshBase\_GetAllGears), 
[HiddenDocumentMeshBase.VisibleDimension](VM.Managed.DAFUL.GearTrain.HiddenDocumentMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_HiddenDocumentMeshBase\_VisibleDimension), 
[HiddenDocumentMeshBase.RenderingMode](VM.Managed.DAFUL.GearTrain.HiddenDocumentMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_HiddenDocumentMeshBase\_RenderingMode), 
[HiddenDocumentMeshBase.MeshEntity](VM.Managed.DAFUL.GearTrain.HiddenDocumentMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_HiddenDocumentMeshBase\_MeshEntity), 
[HiddenDocumentMeshBase.\_MeshEntity](VM.Managed.DAFUL.GearTrain.HiddenDocumentMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_HiddenDocumentMeshBase\_\_MeshEntity), 
[HiddenDocumentMeshBase.TargetDesign](VM.Managed.DAFUL.GearTrain.HiddenDocumentMeshBase.md\#VM\_Managed\_DAFUL\_GearTrain\_HiddenDocumentMeshBase\_TargetDesign), 
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenShaftSetMeshFreeDocument__ctor_System_UIntPtr_"></a> HiddenShaftSetMeshFreeDocument\(UIntPtr\)

Initializes a new instance of the <xref href="VM.Managed.DAFUL.GearTrain.HiddenShaftSetMeshFreeDocument" data-throw-if-not-resolved="false"></xref> class.

```csharp
public HiddenShaftSetMeshFreeDocument(UIntPtr docCore)
```
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenShaftSetMeshFreeDocument_InitialCategories"></a> InitialCategories
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenShaftSetMeshFreeDocument_FindCategory_System_String_"></a> FindCategory\(string\)
...
### <a id="VM_Managed_DAFUL_GearTrain_HiddenShaftSetMeshFreeDocument_InitializeCategoryInfo_System_String_"></a> InitializeCategoryInfo\(string\)
