# <a id="VM_Models_Post_DataSource_DrivetrainReader18"></a> Class DrivetrainReader18

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DrivetrainReader18 : DrivetrainReader, IDriveTrainReader
```
...
### <a id="VM_Models_Post_DataSource_DrivetrainReader18__ctor"></a> DrivetrainReader18\(\)

```csharp
public DrivetrainReader18()
```

## Methods

### <a id="VM_Models_Post_DataSource_DrivetrainReader18_ReadAssemblyManagerInfo_VM_Models_Post_ResultDocument_VM_Identifier_VM_Models_Post_IDriveTrain___System_String_"></a> ReadAssemblyManagerInfo\(ResultDocument, Identifier, IDriveTrain\[\], string\)
