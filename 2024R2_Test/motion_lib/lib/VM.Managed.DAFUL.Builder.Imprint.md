# <a id="VM_Managed_DAFUL_Builder_Imprint"></a> Class Imprint

Namespace: [VM.Managed.DAFUL.Builder](VM.Managed.DAFUL.Builder.md)  
Assembly: VMBld.dll  

```csharp
public abstract class Imprint : BooleanBase<BuilderImprint>, IBuilder
```
...
`facePick` [PickedFace](VM.Managed.DAFUL.Builder.PickedFace.md)
