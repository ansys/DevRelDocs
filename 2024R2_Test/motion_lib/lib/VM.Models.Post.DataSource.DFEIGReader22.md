# <a id="VM_Models_Post_DataSource_DFEIGReader22"></a> Class DFEIGReader22

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFEIGReader22 : DFEIGTextReader, IDFEIGReader
```
...
[DFEIGReader22](VM.Models.Post.DataSource.DFEIGReader22.md)
...
### <a id="VM_Models_Post_DataSource_DFEIGReader22__ctor"></a> DFEIGReader22\(\)

```csharp
public DFEIGReader22()
```
