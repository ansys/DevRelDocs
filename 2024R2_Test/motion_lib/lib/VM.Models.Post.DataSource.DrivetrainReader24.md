# <a id="VM_Models_Post_DataSource_DrivetrainReader24"></a> Class DrivetrainReader24

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DrivetrainReader24 : DrivetrainReader, IDriveTrainReader
```
...
### <a id="VM_Models_Post_DataSource_DrivetrainReader24__ctor"></a> DrivetrainReader24\(\)

```csharp
public DrivetrainReader24()
```
