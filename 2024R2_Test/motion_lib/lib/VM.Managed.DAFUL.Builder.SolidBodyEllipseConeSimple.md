# <a id="VM_Managed_DAFUL_Builder_SolidBodyEllipseConeSimple"></a> Class SolidBodyEllipseConeSimple

Namespace: [VM.Managed.DAFUL.Builder](VM.Managed.DAFUL.Builder.md)  
Assembly: VMBld.dll  

```csharp
public class SolidBodyEllipseConeSimple : SolidBodyEllipseCone<BuilderEllipseConeSimple>, IBuilder
```
...
[SolidBody<BuilderEllipseConeSimple\>](VM.Managed.DAFUL.Builder.SolidBody\-1.md) ← 
[SolidBodyEllipseCone<BuilderEllipseConeSimple\>](VM.Managed.DAFUL.Builder.SolidBodyEllipseCone\-1.md) ← 
...
[SolidBody<BuilderEllipseConeSimple\>.OnPostBuild\(ObjectBase, Document\)](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_OnPostBuild\_VM\_Managed\_ObjectBase\_VM\_Managed\_Document\_), 
[SolidBody<BuilderEllipseConeSimple\>.OnFinalBuild\(string, Document\)](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_OnFinalBuild\_System\_String\_VM\_Managed\_Document\_), 
[SolidBody<BuilderEllipseConeSimple\>.OnPostAddDoc\(ObjectBase\)](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_OnPostAddDoc\_VM\_Managed\_ObjectBase\_), 
[SolidBody<BuilderEllipseConeSimple\>.SetSolidBuilderProperty\(BuilderEllipseConeSimple\)](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_SetSolidBuilderProperty\_\_0\_), 
[SolidBody<BuilderEllipseConeSimple\>.MakeSymmetricSolidBuilder\(\)](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_MakeSymmetricSolidBuilder), 
[SolidBody<BuilderEllipseConeSimple\>.SolidBuilder](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_SolidBuilder), 
[SolidBody<BuilderEllipseConeSimple\>.Interface](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_Interface), 
[SolidBody<BuilderEllipseConeSimple\>.BodyName](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_BodyName), 
[SolidBody<BuilderEllipseConeSimple\>.Name](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_Name), 
[SolidBody<BuilderEllipseConeSimple\>.AddToDoc](VM.Managed.DAFUL.Builder.SolidBody\-1.md\#VM\_Managed\_DAFUL\_Builder\_SolidBody\_1\_AddToDoc), 
...
### <a id="VM_Managed_DAFUL_Builder_SolidBodyEllipseConeSimple__ctor"></a> SolidBodyEllipseConeSimple\(\)

```csharp
public SolidBodyEllipseConeSimple()
```

## Properties

### <a id="VM_Managed_DAFUL_Builder_SolidBodyEllipseConeSimple_BottomPosition"></a> BottomPosition
...
### <a id="VM_Managed_DAFUL_Builder_SolidBodyEllipseConeSimple_MajorAxis"></a> MajorAxis
...
### <a id="VM_Managed_DAFUL_Builder_SolidBodyEllipseConeSimple_RadiusMajor"></a> RadiusMajor
...
### <a id="VM_Managed_DAFUL_Builder_SolidBodyEllipseConeSimple_RadiusMinor"></a> RadiusMinor
...
### <a id="VM_Managed_DAFUL_Builder_SolidBodyEllipseConeSimple_TopPosition"></a> TopPosition
...
### <a id="VM_Managed_DAFUL_Builder_SolidBodyEllipseConeSimple_TopRadius"></a> TopRadius
...
### <a id="VM_Managed_DAFUL_Builder_SolidBodyEllipseConeSimple_MakeSymmetricSolidBuilder"></a> MakeSymmetricSolidBuilder\(\)
...
### <a id="VM_Managed_DAFUL_Builder_SolidBodyEllipseConeSimple_SetSolidBuilderProperty_VM_Managed_CAD_BuilderEllipseConeSimple_"></a> SetSolidBuilderProperty\(BuilderEllipseConeSimple\)

```csharp
protected override void SetSolidBuilderProperty(BuilderEllipseConeSimple solidBuilder)
```

#### Parameters

`solidBuilder` BuilderEllipseConeSimple
