# <a id="VM_Managed_DAFUL_GearTrain_HiddenHousingFEDocument"></a> Class HiddenHousingFEDocument
...
[HiddenDocumentFEBase.ReAssemblyNodalBody\(NodalBody\)](VM.Managed.DAFUL.GearTrain.HiddenDocumentFEBase.md\#VM\_Managed\_DAFUL\_GearTrain\_HiddenDocumentFEBase\_ReAssemblyNodalBody\_VM\_Managed\_DAFUL\_FE\_NodalBody\_), 
...
```csharp
public HiddenHousingFEDocument(UIntPtr docCore)
```
