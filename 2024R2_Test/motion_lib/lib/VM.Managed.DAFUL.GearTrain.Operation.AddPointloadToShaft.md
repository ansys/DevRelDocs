# <a id="VM_Managed_DAFUL_GearTrain_Operation_AddPointloadToShaft"></a> Class AddPointloadToShaft
...
```csharp
public class AddPointloadToShaft : Create, IOperation
```
...
```csharp
public AddPointloadToShaft(string strInitializerXml)
```
