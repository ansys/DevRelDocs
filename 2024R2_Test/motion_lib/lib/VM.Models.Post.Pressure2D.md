# <a id="VM_Models_Post_Pressure2D"></a> Class Pressure2D

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class Pressure2D : ToothContact, IObservableObject, IDisposableObject, IObject, IHasName
```
...
### <a id="VM_Models_Post_Pressure2D_TypeForChart"></a> TypeForChart
