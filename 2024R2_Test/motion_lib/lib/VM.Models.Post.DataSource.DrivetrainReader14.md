# <a id="VM_Models_Post_DataSource_DrivetrainReader14"></a> Class DrivetrainReader14

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DrivetrainReader14 : DrivetrainReader, IDriveTrainReader
```
...
### <a id="VM_Models_Post_DataSource_DrivetrainReader14__ctor"></a> DrivetrainReader14\(\)

```csharp
public DrivetrainReader14()
```

## Methods

### <a id="VM_Models_Post_DataSource_DrivetrainReader14_ReadAssemblyManagerInfo_VM_Models_Post_ResultDocument_VM_Identifier_VM_Models_Post_IDriveTrain___System_String_"></a> ReadAssemblyManagerInfo\(ResultDocument, Identifier, IDriveTrain\[\], string\)
