# <a id="VM_Models_Post_LinearStaticsAnalysisResult"></a> Class LinearStaticsAnalysisResult

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class LinearStaticsAnalysisResult : StaticAnalysisResult, IObservableObject, IDisposableObject
```
...
### <a id="VM_Models_Post_LinearStaticsAnalysisResult__ctor_VM_Models_Post_ResultDocument_VM_Models_AnalysisResultType_VM_Models_Post_IUnstructGridModel_VM_Models_Post_MetaInfo_"></a> LinearStaticsAnalysisResult\(ResultDocument, AnalysisResultType, IUnstructGridModel, MetaInfo\)

```csharp
public LinearStaticsAnalysisResult(ResultDocument parentDocument, AnalysisResultType analysisResultType, IUnstructGridModel unstructGridModel, MetaInfo metaInfo)
```
