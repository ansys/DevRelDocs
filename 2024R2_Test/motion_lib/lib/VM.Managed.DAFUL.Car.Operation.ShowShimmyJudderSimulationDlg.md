# <a id="VM_Managed_DAFUL_Car_Operation_ShowShimmyJudderSimulationDlg"></a> Class ShowShimmyJudderSimulationDlg
...
```csharp
public class ShowShimmyJudderSimulationDlg : ShimmyJudderSimulationRun, IOperation
```
