# <a id="VM_Models_Post_FrequencyTime"></a> Class FrequencyTime

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class FrequencyTime : EntityBase, IObservableObject, IDisposableObject, IFrequencyTime, IPlottable, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_FrequencyTime__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_System_Double_System_UInt32_"></a> FrequencyTime\(ResultDocument, Identifier, string, double, uint\)

```csharp
public FrequencyTime(ResultDocument parentDocument, Identifier analysisResultID, string fullName, double value, uint parentStateID)
```
...
### <a id="VM_Models_Post_FrequencyTime_CategoryType"></a> CategoryType
...
### <a id="VM_Models_Post_FrequencyTime_EntityType"></a> EntityType
...
### <a id="VM_Models_Post_FrequencyTime_ParentStateID"></a> ParentStateID
...
### <a id="VM_Models_Post_FrequencyTime_PlottableType"></a> PlottableType
...
### <a id="VM_Models_Post_FrequencyTime_Value"></a> Value
