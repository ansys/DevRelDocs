# <a id="VM_Models_Post_SoundPressureLevelLineDataSeries"></a> Class SoundPressureLevelLineDataSeries

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class SoundPressureLevelLineDataSeries : LineDataSeriesBase, IObservableObject, IDisposableObject, ISeries, IObject, IHasName
```
...
### <a id="VM_Models_Post_SoundPressureLevelLineDataSeries_IsRefresh"></a> IsRefresh

```csharp
[SaveProperty(false)]
public override bool IsRefresh { get; set; }
```
...
### <a id="VM_Models_Post_SoundPressureLevelLineDataSeries_LineSeriesType"></a> LineSeriesType
...
### <a id="VM_Models_Post_SoundPressureLevelLineDataSeries_NeedSavePoints"></a> NeedSavePoints
