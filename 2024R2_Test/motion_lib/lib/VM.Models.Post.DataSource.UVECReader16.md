# <a id="VM_Models_Post_DataSource_UVECReader16"></a> Class UVECReader16

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class UVECReader16 : UVECReader, IUVECReader
```
...
### <a id="VM_Models_Post_DataSource_UVECReader16__ctor_System_String_"></a> UVECReader16\(string\)

```csharp
public UVECReader16(string filePath)
```
