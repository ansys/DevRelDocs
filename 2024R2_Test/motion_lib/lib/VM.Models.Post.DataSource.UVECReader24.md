# <a id="VM_Models_Post_DataSource_UVECReader24"></a> Class UVECReader24

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class UVECReader24 : UVECReader, IUVECReader
```
...
### <a id="VM_Models_Post_DataSource_UVECReader24__ctor_System_String_"></a> UVECReader24\(string\)

```csharp
public UVECReader24(string filePath)
```
