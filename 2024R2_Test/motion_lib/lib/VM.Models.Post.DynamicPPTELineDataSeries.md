# <a id="VM_Models_Post_DynamicPPTELineDataSeries"></a> Class DynamicPPTELineDataSeries

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class DynamicPPTELineDataSeries : DriveTrainLineDataSeriesBase, IObservableObject, IDisposableObject, ISeries, IObject, IHasName
```
...
### <a id="VM_Models_Post_DynamicPPTELineDataSeries_LineSeriesType"></a> LineSeriesType
...
### <a id="VM_Models_Post_DynamicPPTELineDataSeries_Slice"></a> Slice
...
### <a id="VM_Models_Post_DynamicPPTELineDataSeries_StartTime"></a> StartTime
