# <a id="VM_Models_Post_DataSource_DFEIGReader12"></a> Class DFEIGReader12

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFEIGReader12 : DFEIGTextReader, IDFEIGReader
```
...
[DFEIGReader12](VM.Models.Post.DataSource.DFEIGReader12.md)
...
### <a id="VM_Models_Post_DataSource_DFEIGReader12__ctor"></a> DFEIGReader12\(\)

```csharp
public DFEIGReader12()
```
