# <a id="VM_Models_Post_Spline"></a> Class Spline

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class Spline : EntityBase, IObservableObject, IDisposableObject, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_Spline__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_"></a> Spline\(ResultDocument, Identifier, string\)

```csharp
public Spline(ResultDocument parentDocument, Identifier analysisResultID, string fullName)
```
...
### <a id="VM_Models_Post_Spline_CategoryType"></a> CategoryType
...
### <a id="VM_Models_Post_Spline_EntityType"></a> EntityType
...
### <a id="VM_Models_Post_Spline_InterpolationType"></a> InterpolationType
...
### <a id="VM_Models_Post_Spline_XValues"></a> XValues
...
### <a id="VM_Models_Post_Spline_YValues"></a> YValues
