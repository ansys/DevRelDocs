# <a id="VM_Managed_AttributeLocalObject_2"></a> Class AttributeLocalObject<TObject, TUpdate\>
...
```csharp
public class AttributeLocalObject<TObject, TUpdate> : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable where TObject : class, ILinkContainer where TUpdate : struct, ILinkContainerEvent.ILinkEventBuilder
```
...
```csharp
public AttributeLocalObject(TObject obj)
```
