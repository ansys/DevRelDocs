# <a id="VM_Managed_CAD_BuilderMultiSubtractSimple"></a> Class BuilderMultiSubtractSimple
...
[BuilderMultiSubtract.CreateParameter\(\)](VM.Managed.CAD.BuilderMultiSubtract.md\#VM\_Managed\_CAD\_BuilderMultiSubtract\_CreateParameter), 
[BuilderMultiSubtract.FillParameter\(BuilderParamBase\)](VM.Managed.CAD.BuilderMultiSubtract.md\#VM\_Managed\_CAD\_BuilderMultiSubtract\_FillParameter\_VM\_CAD\_Builders\_BuilderParamBase\_), 
...
```csharp
public BuilderMultiSubtractSimple(Builder builderTarget, Builder builderTool)
```
