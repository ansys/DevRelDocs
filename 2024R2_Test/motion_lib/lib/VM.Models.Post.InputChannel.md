# <a id="VM_Models_Post_InputChannel"></a> Class InputChannel

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class InputChannel : EntityBase, IObservableObject, IDisposableObject, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_InputChannel__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_"></a> InputChannel\(ResultDocument, Identifier, string\)

```csharp
public InputChannel(ResultDocument parentDocument, Identifier analysisResultID, string fullName)
```
...
### <a id="VM_Models_Post_InputChannel_ActuatorIndex"></a> ActuatorIndex
...
### <a id="VM_Models_Post_InputChannel_CategoryType"></a> CategoryType
...
### <a id="VM_Models_Post_InputChannel_EntityType"></a> EntityType
...
### <a id="VM_Models_Post_InputChannel_ForceType"></a> ForceType
...
### <a id="VM_Models_Post_InputChannel_InputType"></a> InputType
...
### <a id="VM_Models_Post_InputChannel_MarkerIndex"></a> MarkerIndex
