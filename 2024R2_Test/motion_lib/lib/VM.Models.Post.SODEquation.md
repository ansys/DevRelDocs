# <a id="VM_Models_Post_SODEquation"></a> Class SODEquation

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class SODEquation : EntityBase, IObservableObject, IDisposableObject, IPlottable, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_SODEquation__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_"></a> SODEquation\(ResultDocument, Identifier, string\)

```csharp
public SODEquation(ResultDocument parentDocument, Identifier analysisResultID, string fullName)
```
...
### <a id="VM_Models_Post_SODEquation_CategoryType"></a> CategoryType
...
### <a id="VM_Models_Post_SODEquation_DisplayName"></a> DisplayName
...
### <a id="VM_Models_Post_SODEquation_EntityType"></a> EntityType
...
### <a id="VM_Models_Post_SODEquation_PlottableType"></a> PlottableType
