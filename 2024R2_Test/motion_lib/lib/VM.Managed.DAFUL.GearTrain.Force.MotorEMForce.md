...
```csharp
public class MotorEMForce : Entity<PropertyMotorEMForce>, IObservableObject, IDisposableObject, ILinkable, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IContainer, IEntity, IEntityBase, IObjectBase, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, IHasKeyObject, IHasName, IEnabled, IHasComment, IVisible, IDocumentOwner, INamed, INavigatorItem, IVisible, IMultiChangable, IHasProperty, IGroup, IDraw, IDrawIcon, IHasOtherEntityInSameCategory, ITransformable, IReportable, IReferencable
```
...
EntityBase ← 
Entity<PropertyMotorEMForce\> ← 
[MotorEMForce](VM.Managed.DAFUL.GearTrain.Force.MotorEMForce.md)
...
Entity<PropertyMotorEMForce\>.Initialize\(Unit.ConvertFactor\), 
Entity<PropertyMotorEMForce\>.GetUnnamedObjectName\(object\), 
Entity<PropertyMotorEMForce\>.FindLocal\(string\), 
Entity<PropertyMotorEMForce\>.Property, 
...
```csharp
public MotorEMForce(string strName)
```
