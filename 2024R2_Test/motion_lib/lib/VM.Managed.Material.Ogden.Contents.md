# <a id="VM_Managed_Material_Ogden_Contents"></a> Class Ogden.Contents
...
```csharp
public class Ogden.Contents : LinkContainer, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
