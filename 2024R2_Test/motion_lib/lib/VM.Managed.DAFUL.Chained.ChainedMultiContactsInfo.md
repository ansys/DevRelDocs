# <a id="VM_Managed_DAFUL_Chained_ChainedMultiContactsInfo"></a> Class ChainedMultiContactsInfo
...
```csharp
public class ChainedMultiContactsInfo : ChainedMultiBaseInfo, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
