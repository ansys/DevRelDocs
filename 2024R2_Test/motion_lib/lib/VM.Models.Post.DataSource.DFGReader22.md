# <a id="VM_Models_Post_DataSource_DFGReader22"></a> Class DFGReader22

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFGReader22 : DFGReader, IDFGReader
```
...
### <a id="VM_Models_Post_DataSource_DFGReader22__ctor"></a> DFGReader22\(\)
