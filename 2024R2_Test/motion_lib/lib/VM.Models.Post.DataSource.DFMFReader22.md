# <a id="VM_Models_Post_DataSource_DFMFReader22"></a> Class DFMFReader22

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMFReader22 : DFMFReader, IDFMFReader
```
...
### <a id="VM_Models_Post_DataSource_DFMFReader22__ctor"></a> DFMFReader22\(\)
