# <a id="VM_Models_Post_DynamicAnimationSlot"></a> Class DynamicAnimationSlot

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class DynamicAnimationSlot : AnimationSlot, IObservableObject, IDisposableObject, IObject, IHasName
```
