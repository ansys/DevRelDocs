# <a id="VM_Models_Post_ToothContact"></a> Class ToothContact

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public abstract class ToothContact : HeatMap2D, IObservableObject, IDisposableObject, IObject, IHasName
```
...
### <a id="VM_Models_Post_ToothContact__ctor_System_Nullable_System_Int32__System_String_System_String_"></a> ToothContact\(int?, string, string\)

```csharp
protected ToothContact(int? id, string fullName, string chartTitle)
```
...
`chartTitle` [string](https://learn.microsoft.com/dotnet/api/system.string)

## Properties

### <a id="VM_Models_Post_ToothContact_ChartType"></a> ChartType
...
### <a id="VM_Models_Post_ToothContact_HeatmapColorBrush"></a> HeatmapColorBrush
...
### <a id="VM_Models_Post_ToothContact_LegendColorType"></a> LegendColorType
...
### <a id="VM_Models_Post_ToothContact_SelectedObject"></a> SelectedObject
