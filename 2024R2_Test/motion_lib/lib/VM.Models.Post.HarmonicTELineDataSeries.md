# <a id="VM_Models_Post_HarmonicTELineDataSeries"></a> Class HarmonicTELineDataSeries

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class HarmonicTELineDataSeries : DriveTrainLineDataSeriesBase, IObservableObject, IDisposableObject, ISeries, IObject, IHasName
```
...
[DriveTrainLineDataSeriesBase.NeedSavePoints](VM.Models.Post.DriveTrainLineDataSeriesBase.md\#VM\_Models\_Post\_DriveTrainLineDataSeriesBase\_NeedSavePoints), 
[DriveTrainLineDataSeriesBase.SelectedObject](VM.Models.Post.DriveTrainLineDataSeriesBase.md\#VM\_Models\_Post\_DriveTrainLineDataSeriesBase\_SelectedObject), 
[DriveTrainLineDataSeriesBase.SelectedObjectFullPath](VM.Models.Post.DriveTrainLineDataSeriesBase.md\#VM\_Models\_Post\_DriveTrainLineDataSeriesBase\_SelectedObjectFullPath), 
...
### <a id="VM_Models_Post_HarmonicTELineDataSeries_End"></a> End
...
### <a id="VM_Models_Post_HarmonicTELineDataSeries_LineSeriesType"></a> LineSeriesType
...
### <a id="VM_Models_Post_HarmonicTELineDataSeries_SelectedFFTType"></a> SelectedFFTType

```csharp
[SaveProperty(false)]
public FFTType SelectedFFTType { get; set; }
```
...
### <a id="VM_Models_Post_HarmonicTELineDataSeries_SelectedPoint"></a> SelectedPoint
...
### <a id="VM_Models_Post_HarmonicTELineDataSeries_SelectedScaleType"></a> SelectedScaleType

```csharp
[SaveProperty(false)]
public ScaleType SelectedScaleType { get; set; }
```
...
### <a id="VM_Models_Post_HarmonicTELineDataSeries_Start"></a> Start
