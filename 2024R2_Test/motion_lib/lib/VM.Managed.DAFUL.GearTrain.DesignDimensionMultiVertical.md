# <a id="VM_Managed_DAFUL_GearTrain_DesignDimensionMultiVertical"></a> Class DesignDimensionMultiVertical
...
```csharp
public DesignDimensionMultiVertical(string strName)
```
