# <a id="VM_Models_Post_Bodies_Rigid"></a> Class Rigid

Namespace: [VM.Models.Post.Bodies](VM.Models.Post.Bodies.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class Rigid : BodyBase, IObservableObject, IDisposableObject, IBody, IBodyBase, IPlottable, IContourable, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
### <a id="VM_Models_Post_Bodies_Rigid__ctor_VM_Models_Post_ResultDocument_VM_Identifier_System_String_System_Int32___"></a> Rigid\(ResultDocument, Identifier, string, int\[\]\)

```csharp
public Rigid(ResultDocument parentDocument, Identifier analysisResultID, string fullName, int[] markerIndexes)
```
...
### <a id="VM_Models_Post_Bodies_Rigid_BodyType"></a> BodyType
...
### <a id="VM_Models_Post_Bodies_Rigid_CanLoad"></a> CanLoad
...
### <a id="VM_Models_Post_Bodies_Rigid_CanSave"></a> CanSave
...
### <a id="VM_Models_Post_Bodies_Rigid_CategoryType"></a> CategoryType
...
### <a id="VM_Models_Post_Bodies_Rigid_HasGeometry"></a> HasGeometry
...
### <a id="VM_Models_Post_Bodies_Rigid_PlottableType"></a> PlottableType
...
### <a id="VM_Models_Post_Bodies_Rigid_CanContour_VM_Models_ContourMappingType_"></a> CanContour\(ContourMappingType\)
