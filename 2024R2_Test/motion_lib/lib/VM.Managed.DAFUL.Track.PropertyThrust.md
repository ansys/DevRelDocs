# <a id="VM_Managed_DAFUL_Track_PropertyThrust"></a> Class PropertyThrust
...
```csharp
public class PropertyThrust : Property, IObservableObject, IDisposableObject, ILinkable, IObjectBase, IObject, IEventProvider, IHasKeyObject, ILinkContainerEvent, IVerifiable, IHistoryObjectSerializable, IAttributeContainer, IContainer, ILinkContainer, IOwned, IHasID
```
...
#### Property Value
 ...
 [PropertyThrust](VM.Managed.DAFUL.Track.PropertyThrust.md).[ForceType](VM.Managed.DAFUL.Track.PropertyThrust.ForceType.md)
