# <a id="VM_Managed_DAFUL_GearTrain_HiddenBearingDocument"></a> Class HiddenBearingDocument
...
```csharp
public HiddenBearingDocument(UIntPtr docCore)
```
