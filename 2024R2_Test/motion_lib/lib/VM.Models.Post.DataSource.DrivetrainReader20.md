# <a id="VM_Models_Post_DataSource_DrivetrainReader20"></a> Class DrivetrainReader20

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DrivetrainReader20 : DrivetrainReader, IDriveTrainReader
```
...
### <a id="VM_Models_Post_DataSource_DrivetrainReader20__ctor"></a> DrivetrainReader20\(\)

```csharp
public DrivetrainReader20()
```

## Methods

### <a id="VM_Models_Post_DataSource_DrivetrainReader20_ReadAssemblyManagerInfo_VM_Models_Post_ResultDocument_VM_Identifier_VM_Models_Post_IDriveTrain___System_String_"></a> ReadAssemblyManagerInfo\(ResultDocument, Identifier, IDriveTrain\[\], string\)
