# <a id="VM_Models_Post_DataSource_DFMReader12"></a> Class DFMReader12

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMReader12 : DFMReader, IDFMReader, IDFMInfo
```
...
### <a id="VM_Models_Post_DataSource_DFMReader12__ctor"></a> DFMReader12\(\)
...
### <a id="VM_Models_Post_DataSource_DFMReader12_BuildForceConfiguration_System_Int32___"></a> BuildForceConfiguration\(int\[\]\)

```csharp
protected override void BuildForceConfiguration(int[] forces)
```
...
### <a id="VM_Models_Post_DataSource_DFMReader12_BuildModels_VM_Models_Post_ResultDocument_System_String_VM_Models_Post_IDFRReader_VM_Identifier_"></a> BuildModels\(ResultDocument, string, IDFRReader, Identifier\)

```csharp
public override MetaInfo BuildModels(ResultDocument parentDocument, string filepath, IDFRReader dFRInfo, Identifier analysisResultID)
```
...
### <a id="VM_Models_Post_DataSource_DFMReader12_ReadDriveTrain_VM_Models_Post_ResultDocument_VM_Identifier_VM_Models_Post_MetaInfo_System_String_System_Int32__"></a> ReadDriveTrain\(ResultDocument, Identifier, MetaInfo, string, ref int\)

```csharp
protected override void ReadDriveTrain(ResultDocument parentDocument, Identifier analysisResultID, MetaInfo metaInfo, string key, ref int index)
```
...
### <a id="VM_Models_Post_DataSource_DFMReader12_ReadEigenvalueAnalysis_VM_Models_Post_MetaInfo_VM_Models_Post_IDFRReader_System_String_System_Int32__"></a> ReadEigenvalueAnalysis\(MetaInfo, IDFRReader, string, ref int\)

```csharp
protected override void ReadEigenvalueAnalysis(MetaInfo metaInfo, IDFRReader dFRInfo, string key, ref int index)
```
...
### <a id="VM_Models_Post_DataSource_DFMReader12_ReadFEMaterial_VM_Models_Post_MetaInfo_System_String_System_Int32__"></a> ReadFEMaterial\(MetaInfo, string, ref int\)

```csharp
protected override void ReadFEMaterial(MetaInfo metaInfo, string key, ref int index)
```
...
### <a id="VM_Models_Post_DataSource_DFMReader12_ReadFEProperty_VM_Models_Post_ResultDocument_VM_Identifier_VM_Models_Post_MetaInfo_System_String_System_Int32__"></a> ReadFEProperty\(ResultDocument, Identifier, MetaInfo, string, ref int\)

```csharp
protected override void ReadFEProperty(ResultDocument parentDocument, Identifier analysisResultID, MetaInfo metaInfo, string key, ref int index)
```
...
### <a id="VM_Models_Post_DataSource_DFMReader12_ReadUnit_VM_Models_Post_MetaInfo_System_String_System_Int32__"></a> ReadUnit\(MetaInfo, string, ref int\)

```csharp
protected override void ReadUnit(MetaInfo metaInfo, string key, ref int index)
```
...
### <a id="VM_Models_Post_DataSource_DFMReader12_SetVectorDisplayCharacteristics_VM_Models_Post_MetaInfo_"></a> SetVectorDisplayCharacteristics\(MetaInfo\)
