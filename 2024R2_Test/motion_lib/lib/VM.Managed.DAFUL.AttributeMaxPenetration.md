# <a id="VM_Managed_DAFUL_AttributeMaxPenetration"></a> Class AttributeMaxPenetration
...
```csharp
public class AttributeMaxPenetration : AttributeBase, IObservableObject, IDisposableObject, ILinkable, IObject, ILinkContainer, IOwned, IHasID, IEventProvider, ILinkContainerEvent, IVerifiable
```
...
```csharp
public AttributeMaxPenetration(Variable value)
```
