# <a id="VM_Models_Post_EigenvalueAnimationSlot"></a> Class EigenvalueAnimationSlot

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class EigenvalueAnimationSlot : AnimationSlot, IObservableObject, IDisposableObject, IObject, IHasName
```
