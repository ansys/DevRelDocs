# <a id="VM_Models_Post_SimpleMathLineDataSeries"></a> Class SimpleMathLineDataSeries

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class SimpleMathLineDataSeries : LineDataSeriesBase, IObservableObject, IDisposableObject, ISeries, IObject, IHasName
```
...
### <a id="VM_Models_Post_SimpleMathLineDataSeries_LineSeriesType"></a> LineSeriesType
...
### <a id="VM_Models_Post_SimpleMathLineDataSeries_MathType"></a> MathType

```csharp
[SaveProperty(false)]
public SimpleMathType MathType { get; set; }
```
...
### <a id="VM_Models_Post_SimpleMathLineDataSeries_NeedSavePoints"></a> NeedSavePoints
...
### <a id="VM_Models_Post_SimpleMathLineDataSeries_ParentDocument"></a> ParentDocument
...
### <a id="VM_Models_Post_SimpleMathLineDataSeries_PointCount"></a> PointCount
