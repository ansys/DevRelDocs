# <a id="VM_Models_Post_FrequencySequenceLineDataSeries"></a> Class FrequencySequenceLineDataSeries

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class FrequencySequenceLineDataSeries : LineDataSeriesBase, IObservableObject, IDisposableObject, ISeries, IObject, IHasName
```
...
### <a id="VM_Models_Post_FrequencySequenceLineDataSeries_LineSeriesType"></a> LineSeriesType
...
### <a id="VM_Models_Post_FrequencySequenceLineDataSeries_NeedSavePoints"></a> NeedSavePoints
...
### <a id="VM_Models_Post_FrequencySequenceLineDataSeries_Sequence"></a> Sequence
