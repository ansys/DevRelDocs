# <a id="VM_Managed_DAFUL_Car_MinorRoleImpl"></a> Class MinorRoleImpl
...
```csharp
public static void LoadTemplateForMinorRole(XmlReader reader, ref MinorRole typeMR, InterfaceManagerForCar itfMgr)
```
...
`typeMR` [MinorRole](VM.Managed.DAFUL.Car.MinorRole.md)
...
```csharp
public static void SaveTemplateForMinorRole(XmlWriter writer, MinorRole typeMR, InterfaceManagerForCar itfMgr)
```
