# <a id="VM_Models_Post_StaticAnalysisResult"></a> Class StaticAnalysisResult

Namespace: [VM.Models.Post](VM.Models.Post.md)  
Assembly: VM.Models.Post.dll  

```csharp
public abstract class StaticAnalysisResult : AnalysisResult, IObservableObject, IDisposableObject
```
...
[LinearStaticsAnalysisResult](VM.Models.Post.LinearStaticsAnalysisResult.md), 
[NonLinearStaticsAnalysisResult](VM.Models.Post.NonLinearStaticsAnalysisResult.md)
...
### <a id="VM_Models_Post_StaticAnalysisResult__ctor_VM_Models_Post_ResultDocument_VM_Models_AnalysisResultType_VM_Models_Post_IUnstructGridModel_VM_Models_Post_MetaInfo_"></a> StaticAnalysisResult\(ResultDocument, AnalysisResultType, IUnstructGridModel, MetaInfo\)

```csharp
public StaticAnalysisResult(ResultDocument parentDocument, AnalysisResultType analysisResultType, IUnstructGridModel unstructGridModel, MetaInfo metaInfo)
```
