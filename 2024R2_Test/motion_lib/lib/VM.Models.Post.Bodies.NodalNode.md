# <a id="VM_Models_Post_Bodies_NodalNode"></a> Class NodalNode

Namespace: [VM.Models.Post.Bodies](VM.Models.Post.Bodies.md)  
Assembly: VM.Models.Post.dll  

```csharp
public sealed class NodalNode : NodeBase, IObservableObject, IDisposableObject, IPlottable, INodalNode, INode, IBodyComponent, IComponent, IEntity, IObject, IHasName, IHasIndex, IHasID
```
...
[INodalNode](VM.Models.Post.INodalNode.md), 
...
[NodeBase.CategoryType](VM.Models.Post.Bodies.NodeBase.md\#VM\_Models\_Post\_Bodies\_NodeBase\_CategoryType), 
[NodeBase.DisplayName](VM.Models.Post.Bodies.NodeBase.md\#VM\_Models\_Post\_Bodies\_NodeBase\_DisplayName), 
[NodeBase.EntityType](VM.Models.Post.Bodies.NodeBase.md\#VM\_Models\_Post\_Bodies\_NodeBase\_EntityType), 
[NodeBase.PlotDataType](VM.Models.Post.Bodies.NodeBase.md\#VM\_Models\_Post\_Bodies\_NodeBase\_PlotDataType), 
[NodeBase.PlottableType](VM.Models.Post.Bodies.NodeBase.md\#VM\_Models\_Post\_Bodies\_NodeBase\_PlottableType), 
