# <a id="VM_Models_Post_DataSource_DFMFReader12"></a> Class DFMFReader12

Namespace: [VM.Models.Post.DataSource](VM.Models.Post.DataSource.md)  
Assembly: VM.Models.Post.DataSource.dll  

```csharp
public class DFMFReader12 : DFMFReader, IDFMFReader
```
...
### <a id="VM_Models_Post_DataSource_DFMFReader12__ctor"></a> DFMFReader12\(\)
