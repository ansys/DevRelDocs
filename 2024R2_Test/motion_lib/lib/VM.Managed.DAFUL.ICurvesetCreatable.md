# <a id="VM_Managed_DAFUL_ICurvesetCreatable"></a> Interface ICurvesetCreatable
...
```csharp
public interface ICurvesetCreatable : IConnectableNotReference, IConnectable, IMarkerParent, IEntityRelation, IHasBody
```
