...
| `ImpedanceReal`              | Gets the ImpedanceReal.                                                                                                                                                    |
| `Frequency`                  | Gets or sets the Frequency.                                                                                                                                                |
| `ImpedanceImag`              | Gets the ImpedanceImag.                                                                                                                                                    |
| `MaximumRealImpedance`       | Gets the MaximumRealImpedance.                                                                                                                                             |
| `MaximumImagImpedance`       | Gets the MaximumImagImpedance.                                                                                                                                             |
| `MinimumRealImpedance`       | Gets the MinimumRealImpedance.                                                                                                                                             |
| `MinimumImagImpedance`       | Gets the MinimumImagImpedance.                                                                                                                                             |
