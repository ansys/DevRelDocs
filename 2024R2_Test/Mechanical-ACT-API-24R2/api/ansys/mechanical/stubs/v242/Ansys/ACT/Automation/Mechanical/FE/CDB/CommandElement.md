...
| Name | Description |
|--------------------|-------------------------------------------------------------|
| `Csys`             | Gets the coordinate system number.                          |
| `Id`               | Gets the element number.                                    |
| `Mat`              | Gets the material number.                                   |
| `Real`             | Gets the real constant set number.                          |
| `Section`          | Gets the section number.                                    |
| `Type`             | Gets the element type number.                               |
| `ElementShapeFlag` | Gets the element shape flag used for contact element types. |
| `NodeCount`        | Gets the number of nodes.                                   |
