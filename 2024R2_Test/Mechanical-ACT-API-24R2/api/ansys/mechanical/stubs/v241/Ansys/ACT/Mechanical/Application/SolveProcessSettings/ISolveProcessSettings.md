...
| `HybridParallel`                 | Gets or sets the boolean “Hybrid Parallel (Mechanical APDL)” field.   |
| `ThreadsPerProcess`              | Gets or sets the “Threads per process” field.                         |
| `NumberOfProcesses`              | Gets or sets the “Number of processes” field.                         |
| `DCSAutoDownloadResults`         | Gets or sets the “DCS Auto Download Results” field.                   |
