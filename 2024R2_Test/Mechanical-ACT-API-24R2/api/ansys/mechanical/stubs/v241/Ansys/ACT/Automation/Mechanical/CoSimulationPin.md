...
| Name | Description |
|---------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|
| [`Delete`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#CoSimulationPin.Delete)                                   | Run the Delete action.                                                            |
| [`GetChildren`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#id1)                                                 | Gets the list of children, filtered by type.                                      |
| [`GetChildren`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#id1)                                                 | Gets the list of children, filtered by type.                                      |
| [`Activate`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#CoSimulationPin.Activate)                               | Activate the current object.                                                      |
| [`CopyTo`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#CoSimulationPin.CopyTo)                                   | Copies all visible properties from this object to another.                        |
| [`Duplicate`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#CoSimulationPin.Duplicate)                             | Creates a copy of the current DataModelObject.                                    |
| [`GroupAllSimilarChildren`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#CoSimulationPin.GroupAllSimilarChildren) | Run the GroupAllSimilarChildren action.                                           |
| [`GroupSimilarObjects`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#CoSimulationPin.GroupSimilarObjects)         | Run the GroupSimilarObjects action.                                               |
| [`PropertyByName`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#CoSimulationPin.PropertyByName)                   | Get a property by its unique name.                                                |
| [`PropertyByAPIName`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#CoSimulationPin.PropertyByAPIName)             | Get a property by its API name.                                                   |
| [`CreateParameter`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#CoSimulationPin.CreateParameter)                 | Creates a new parameter for a Property.                                           |
| [`GetParameter`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#CoSimulationPin.GetParameter)                       | Gets the parameter corresponding to the given property.                           |
| [`RemoveParameter`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#CoSimulationPin.RemoveParameter)                 | Removes the parameter from the parameter set corresponding to the given property. |

### Properties

| Name | Description |
|---------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|
| [`Scope`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#CoSimulationPin.Scope)                                     | Gets or sets the Joint through Scope.                         |
| [`DOF`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#CoSimulationPin.DOF)                                         | Gets or sets the DOF.                                         |
| [`JointType`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#CoSimulationPin.JointType)                             | Gets or sets the Joint Type.                                  |
| [`PinBehavior`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#CoSimulationPin.PinBehavior)                         | Gets or sets the Pin Behavior.                                |
...
| [`VisibleProperties`](../../../../../v242/Ansys/ACT/Automation/Mechanical/CoSimulationPin.md#CoSimulationPin.VisibleProperties)             | Gets the list of properties that are visible for this object. |
