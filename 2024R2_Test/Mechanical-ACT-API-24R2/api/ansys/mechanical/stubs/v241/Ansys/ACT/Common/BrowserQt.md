...
#### *class* ansys.mechanical.stubs.v241.Ansys.ACT.Common.BrowserQt
...
| `FindParentWindow`           | FindParentWindow method.           |
| `FindParentDialog`           | FindParentDialog method.           |
| `FindTopMostParentControl`   | FindTopMostParentControl method.   |
| `Focus`                      | Focus method.                      |
| `SendToBack`                 | SendToBack method.                 |
| `BringToFront`               | BringToFront method.               |
| `Show`                       | Show method.                       |
| `Hide`                       | Hide method.                       |
| `GetPreferredSize`           | GetPreferredSize method.           |
| `GetPreferredHeightForWidth` | GetPreferredHeightForWidth method. |
...
| `BeginInvoke`                | BeginInvoke method.                |
| `EndInvoke`                  | EndInvoke method.                  |
...
|-------------------|---------------------------|
| `Tag`             | Tag property.             |
| `InvokeRequired`  | InvokeRequired property.  |
...
| `Focused`         | Focused property.         |
| `IsMouseCaptured` | IsMouseCaptured property. |
...
| `Margins`         | Margins property.         |
| `PreferredSize`   | PreferredSize property.   |
| `MinimumSize`     | MinimumSize property.     |
| `MaximumSize`     | MaximumSize property.     |
| `Name`            | Name property.            |
| `ToolTipText`     | ToolTipText property.     |
| `IsDisposed`      | IsDisposed property.      |
