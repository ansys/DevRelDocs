...
| [`Variable`](Variable.md#ansys.mechanical.stubs.v241.Ansys.ACT.Mechanical.Fields.Variable) | Represents an object that is either an input or an output for a P:Ansys.ACT.Mechanical.Fields.Variable.Field. Depending on whether it is an input or output and on the way it is defined, this object holds a series of discrete values |
