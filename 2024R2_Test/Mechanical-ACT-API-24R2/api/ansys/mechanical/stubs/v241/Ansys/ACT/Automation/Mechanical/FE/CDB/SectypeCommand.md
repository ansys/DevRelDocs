...
#### *class* ansys.mechanical.stubs.v241.Ansys.ACT.Automation.Mechanical.FE.CDB.SectypeCommand
...
| Name | Description |
|-------------|--------------------------------------------------------------------------------------------------------|
| `Secid`     | Gets the section type number.                                                                          |
| `Type`      | Get the type.                                                                                          |
| `Subtype`   | Gets the subtype.                                                                                      |
| `Secname`   | Gets the section name.                                                                                 |
| `RefineKey` | Mesh refinement level for thin-walled beam sections. Default is zero. Meaningless if type is not BEAM. |
