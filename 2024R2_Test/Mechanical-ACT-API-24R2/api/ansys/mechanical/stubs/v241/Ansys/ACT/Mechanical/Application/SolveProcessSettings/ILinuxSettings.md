...
| Name | Description |
|-----------------|---------------------------------------------------------------------------------------|
| `Active`        | Gets or sets whether or not manual linux settings are enable for the configuration.   |
| `UserName`      | Gets or sets the user name field for the manual linux settings.                       |
| `WorkingFolder` | Gets or sets the working folder field for the manual linxus settings.                 |
