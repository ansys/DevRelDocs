...
| Name | Description |
|--------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [`Add`](../../../../v242/Ansys/Mechanical/Graphics/SectionPlanes.md#SectionPlanes.Add)           | Adds the given SectionPlane object to the collection to modify the view. Currently only 6 SectionPlane objects in the collection can be activated at once.   |
| [`Clear`](../../../../v242/Ansys/Mechanical/Graphics/SectionPlanes.md#SectionPlanes.Clear)       | Clears the collection of all SectionPlane objects.                                                                                                           |
| [`Remove`](../../../../v242/Ansys/Mechanical/Graphics/SectionPlanes.md#SectionPlanes.Remove)     | Removes the requested SectionPlane from the collection.                                                                                                      |
| [`RemoveAt`](../../../../v242/Ansys/Mechanical/Graphics/SectionPlanes.md#SectionPlanes.RemoveAt) | Removes the SectionPlane at the given index.                                                                                                                 |

### Properties

| Name | Description |
|--------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|
| [`ShowWholeElement`](../../../../v242/Ansys/Mechanical/Graphics/SectionPlanes.md#SectionPlanes.ShowWholeElement)   | Gets or Sets the Element Visibility of the Section Plane   |
| [`Capping`](../../../../v242/Ansys/Mechanical/Graphics/SectionPlanes.md#SectionPlanes.Capping)                     | Gets or Sets the Capping style of the Section Plane        |
| [`Count`](../../../../v242/Ansys/Mechanical/Graphics/SectionPlanes.md#SectionPlanes.Count)                         | The number of section planes in the collection.            |
