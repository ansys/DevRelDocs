...
#### *class* ansys.mechanical.stubs.v241.Ansys.Mechanical.Graphics.ResultPreference
...
| Name | Description |
|--------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|
| [`GeometryView`](../../../../v242/Ansys/Mechanical/Graphics/ResultPreference.md#ResultPreference.GeometryView)                             | Sets the result geometry view.                                          |
| [`ContourView`](../../../../v242/Ansys/Mechanical/Graphics/ResultPreference.md#ResultPreference.ContourView)                               | Sets the result contour view.                                           |
| [`ExtraModelDisplay`](../../../../v242/Ansys/Mechanical/Graphics/ResultPreference.md#ResultPreference.ExtraModelDisplay)                   | Sets the result edge display option.                                    |
| [`DeformationScaling`](../../../../v242/Ansys/Mechanical/Graphics/ResultPreference.md#ResultPreference.DeformationScaling)                 | Sets the deformation scale multiplier to either AutoScale or TrueScale. |
| [`DeformationScaleMultiplier`](../../../../v242/Ansys/Mechanical/Graphics/ResultPreference.md#ResultPreference.DeformationScaleMultiplier) | Sets the deformation scale multiplier.                                  |
| [`IsoSurfaceValue`](../../../../v242/Ansys/Mechanical/Graphics/ResultPreference.md#ResultPreference.IsoSurfaceValue)                       | Sets the capping value for capped iso surface view .                    |
| [`CappingType`](../../../../v242/Ansys/Mechanical/Graphics/ResultPreference.md#ResultPreference.CappingType)                               | Sets the result capping type.                                           |
| [`ScopingDisplay`](../../../../v242/Ansys/Mechanical/Graphics/ResultPreference.md#ResultPreference.ScopingDisplay)                         | Sets the result scoping display.                                        |
| [`ShowMinimum`](../../../../v242/Ansys/Mechanical/Graphics/ResultPreference.md#ResultPreference.ShowMinimum)                               | Displays the result minimum value annotation label.                     |
| [`ShowMaximum`](../../../../v242/Ansys/Mechanical/Graphics/ResultPreference.md#ResultPreference.ShowMaximum)                               | Displays the result maximum value annotation label.                     |
