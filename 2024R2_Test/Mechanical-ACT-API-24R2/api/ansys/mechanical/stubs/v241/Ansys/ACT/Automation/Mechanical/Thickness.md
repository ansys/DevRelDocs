...
#### *class* ansys.mechanical.stubs.v241.Ansys.ACT.Automation.Mechanical.Thickness
...
| Name | Description |
|---------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|
| [`Delete`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.Delete)                                   | Run the Delete action.                                                            |
| [`GetChildren`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#id1)                                           | Gets the list of children, filtered by type.                                      |
| [`GetChildren`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#id1)                                           | Gets the list of children, filtered by type.                                      |
| [`AddComment`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.AddComment)                           | Creates a new child Comment.                                                      |
| [`AddFigure`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.AddFigure)                             | Creates a new child Figure.                                                       |
| [`AddImage`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.AddImage)                               | Creates a new child Image.                                                        |
| [`Activate`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.Activate)                               | Activate the current object.                                                      |
| [`CopyTo`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.CopyTo)                                   | Copies all visible properties from this object to another.                        |
| [`Duplicate`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.Duplicate)                             | Creates a copy of the current DataModelObject.                                    |
| [`GroupAllSimilarChildren`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.GroupAllSimilarChildren) | Run the GroupAllSimilarChildren action.                                           |
| [`GroupSimilarObjects`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.GroupSimilarObjects)         | Run the GroupSimilarObjects action.                                               |
| [`PropertyByName`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.PropertyByName)                   | Get a property by its unique name.                                                |
| [`PropertyByAPIName`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.PropertyByAPIName)             | Get a property by its API name.                                                   |
| [`CreateParameter`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.CreateParameter)                 | Creates a new parameter for a Property.                                           |
| [`GetParameter`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.GetParameter)                       | Gets the parameter corresponding to the given property.                           |
| [`RemoveParameter`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.RemoveParameter)                 | Removes the parameter from the parameter set corresponding to the given property. |

### Properties

| Name | Description |
|-----------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|
| [`InternalObject`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#id0)                                                | Gets the internal object. For advanced usage only.            |
| [`NumberOfSegments`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.NumberOfSegments)                       | Gets or sets the NumberOfSegments.                            |
| [`ThicknessField`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.ThicknessField)                           | Gets or sets the ThicknessField.                              |
| [`RangeMaximum`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.RangeMaximum)                               | Gets or sets the RangeMaximum.                                |
| [`RangeMinimum`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.RangeMinimum)                               | Gets or sets the RangeMinimum.                                |
| [`MembraneOffset`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.MembraneOffset)                           | Gets or sets the MembraneOffset.                              |
| [`ScopeMode`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.ScopeMode)                                     | Gets the ScopeMode.                                           |
| [`OffsetType`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.OffsetType)                                   | Gets or sets the OffsetType.                                  |
| [`IndependentVariable`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.IndependentVariable)                 | Gets or sets the IndependentVariable.                         |
...
| [`Images`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.Images)                                           | Gets the list of associated images.                           |
| [`ReadOnly`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.ReadOnly)                                       | Gets or sets the ReadOnly.                                    |
| [`InternalObject`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#id0)                                                | Gets the internal object. For advanced usage only.            |
| [`Properties`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.Properties)                                   | Gets the list of properties for this object.                  |
| [`VisibleProperties`](../../../../../v242/Ansys/ACT/Automation/Mechanical/Thickness.md#Thickness.VisibleProperties)                     | Gets the list of properties that are visible for this object. |
...
### *property* Thickness.XYZFunctionCoordinateSystem *: [Ansys.ACT.Automation.Mechanical.CoordinateSystem](CoordinateSystem.md#ansys.mechanical.stubs.v241.Ansys.ACT.Automation.Mechanical.CoordinateSystem) | [None](https://docs.python.org/3/library/constants.html#None)*
...
### Thickness.GetChildren(category: [Ansys.Mechanical.DataModel.Enums.DataModelObjectCategory](../../../Mechanical/DataModel/Enums/DataModelObjectCategory.md#ansys.mechanical.stubs.v241.Ansys.Mechanical.DataModel.Enums.DataModelObjectCategory), recurses: System.Boolean, children: System.Collections.Generic.IList[Ansys.Mechanical.DataModel.Interfaces.IDataModelObject])
