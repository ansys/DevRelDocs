...
| Name | Description |
|----------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|
| [`Add`](../../../../../../v242/Ansys/ACT/Automation/Mechanical/AdditiveManufacturing/AMSupportRemovalSequence.md#AMSupportRemovalSequence.Add)           | Adds a support or base removal step.                                    |
| [`RemoveAt`](../../../../../../v242/Ansys/ACT/Automation/Mechanical/AdditiveManufacturing/AMSupportRemovalSequence.md#AMSupportRemovalSequence.RemoveAt) | Remove AM step at index.                                                |
| [`Swap`](../../../../../../v242/Ansys/ACT/Automation/Mechanical/AdditiveManufacturing/AMSupportRemovalSequence.md#id0)                                   | Swaps two steps in the Removal sequence.                                |
| [`Swap`](../../../../../../v242/Ansys/ACT/Automation/Mechanical/AdditiveManufacturing/AMSupportRemovalSequence.md#id0)                                   | Swaps two steps in the Removal sequence by name.                        |
| [`IndexOf`](../../../../../../v242/Ansys/ACT/Automation/Mechanical/AdditiveManufacturing/AMSupportRemovalSequence.md#AMSupportRemovalSequence.IndexOf)   | Returns index of removal object                                         |
| [`Insert`](../../../../../../v242/Ansys/ACT/Automation/Mechanical/AdditiveManufacturing/AMSupportRemovalSequence.md#AMSupportRemovalSequence.Insert)     | Inserts a given step at particular index(zero based)                    |
| [`Contains`](../../../../../../v242/Ansys/ACT/Automation/Mechanical/AdditiveManufacturing/AMSupportRemovalSequence.md#AMSupportRemovalSequence.Contains) | Returns true if the step exists in the sequencer. If not, returns false |

### Properties

| Name | Description |
|------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------|
| [`Count`](../../../../../../v242/Ansys/ACT/Automation/Mechanical/AdditiveManufacturing/AMSupportRemovalSequence.md#AMSupportRemovalSequence.Count)   | Count property.   |
