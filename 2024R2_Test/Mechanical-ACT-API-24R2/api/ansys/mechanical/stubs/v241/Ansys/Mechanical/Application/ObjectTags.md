...
| Name | Description |
|-----------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|
| [`Add`](../../../../v242/Ansys/Mechanical/Application/ObjectTags.md#ObjectTags.Add)           | Adds a new tag to the collection. Throws an error if the tag already exists in the collection.     |
| [`Remove`](../../../../v242/Ansys/Mechanical/Application/ObjectTags.md#ObjectTags.Remove)     | Removes a tag if it exists in the collection.                                                      |
| [`GetTag`](../../../../v242/Ansys/Mechanical/Application/ObjectTags.md#ObjectTags.GetTag)     | Returns the tag in the collection with the given name.                                             |
| [`IndexOf`](../../../../v242/Ansys/Mechanical/Application/ObjectTags.md#ObjectTags.IndexOf)   | Returns the index of the given tag. If the given tag does not exist in the collection, returns -1. |
| [`RemoveAt`](../../../../v242/Ansys/Mechanical/Application/ObjectTags.md#ObjectTags.RemoveAt) | Removes the tag at the given index from the collection.                                            |
| [`Clear`](../../../../v242/Ansys/Mechanical/Application/ObjectTags.md#ObjectTags.Clear)       | Clears the collection, removing all objects from the tags in the collection.                       |
| [`Contains`](../../../../v242/Ansys/Mechanical/Application/ObjectTags.md#ObjectTags.Contains) | Returns whether or not the collection contains the given tag.                                      |

### Properties

| Name | Description |
|-----------------------------------------------------------------------------------------------|------------------------------------------|
| [`Count`](../../../../v242/Ansys/Mechanical/Application/ObjectTags.md#ObjectTags.Count)       | The number of tags in the collection.    |
| [`Item`](../../../../v242/Ansys/Mechanical/Application/ObjectTags.md#id0)                     | Item property.                           |
| [`Item`](../../../../v242/Ansys/Mechanical/Application/ObjectTags.md#id0)                     | Item property.                           |
| [`TagNames`](../../../../v242/Ansys/Mechanical/Application/ObjectTags.md#ObjectTags.TagNames) | The names of the tags in the collection. |
