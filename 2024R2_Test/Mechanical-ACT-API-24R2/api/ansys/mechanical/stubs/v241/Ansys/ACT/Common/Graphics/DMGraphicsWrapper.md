...
| Name | Description |
|-----------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|
| [`Redraw`](../../../../../v242/Ansys/ACT/Common/Graphics/DMGraphicsWrapper.md#DMGraphicsWrapper.Redraw)                           | Forces the scene to redraw its content.                                                  |
| [`Suspend`](../../../../../v242/Ansys/ACT/Common/Graphics/DMGraphicsWrapper.md#DMGraphicsWrapper.Suspend)                         | Prevents the scene to redraw until the Resume controller method was called.              |
| [`ForceResume`](../../../../../v242/Ansys/ACT/Common/Graphics/DMGraphicsWrapper.md#DMGraphicsWrapper.ForceResume)                 | Forces the scene to resume. Useful in interactive context (console) if a reference on an |
| [`CreatePixelPoint`](../../../../../v242/Ansys/ACT/Common/Graphics/DMGraphicsWrapper.md#DMGraphicsWrapper.CreatePixelPoint)       | Creates a point from pixel coordinates (ie. window coordinates).                         |
| [`CreateWorldPoint`](../../../../../v242/Ansys/ACT/Common/Graphics/DMGraphicsWrapper.md#DMGraphicsWrapper.CreateWorldPoint)       | Create a point from world coordinates.                                                   |
| [`CreateVector3D`](../../../../../v242/Ansys/ACT/Common/Graphics/DMGraphicsWrapper.md#DMGraphicsWrapper.CreateVector3D)           | Create a 3D vector from world coordinates.                                               |
| [`ExportScreenToImage`](../../../../../v242/Ansys/ACT/Common/Graphics/DMGraphicsWrapper.md#DMGraphicsWrapper.ExportScreenToImage) | Exports the current Graphics screen to a file.                                           |

### Properties

| Name | Description |
|---------------------------------------------------------------------------------------------------------|-------------------|
| [`Scene`](../../../../../v242/Ansys/ACT/Common/Graphics/DMGraphicsWrapper.md#DMGraphicsWrapper.Scene)   | Gets the scene.   |
