...
---|---|---|---  
For display purposes, some strings in the first three columns are broken into
multiple lines and should be read as continous. For example, the first string
in column two should be interpreted as: .ListLaminatesRequest  
listLaminates| [.ListLaminates
Request](ch01s10s13.md#sherlock_ug_ListLaminatesRequest
"ListLaminatesRequest")| [.ListLaminates Response](ch01s10s13s02.md
"ListLaminatesResponse")| Returns a list of project's CCAs and their
laminates.  
...
"UpdateConductorLayerRequest")| [.ReturnCode](ch01s11.md "gRPC Scalar Value
...
genStackup| [.GenStackupRequest](ch01s10.md#sherlock_ug_genstackuprequest
"GenStackupRequest")| [.ReturnCode](ch01s11.md "gRPC Scalar Value Types")|
