...
<a id="sphx-glr-examples-gallery-examples-gallery-08-lucid-generic-f1-rear-wing-py"></a>

<a id="ref-generic-f1-rw"></a>

<a id="mesh-a-generic-f1-car-rear-wing-for-external-aero-simulation"></a>
...
![Generic F1 rear wing.](images/generic_rear_wing.png)
...
<a id="define-local-size-control-and-generate-size-field"></a>
...
```none
<ansys.meshing.prime.autogen.sizefieldstructs.VolumetricSizeFieldComputeResults object at 0x000002705DE262C0>
```

<!-- GENERATED FROM PYTHON SOURCE LINES 189-194 -->

<a id="generate-surface-mesh"></a>
...
<a id="compute-volumetric-regions"></a>
...
```none
<ansys.meshing.prime.autogen.controlstructs.SetScopeResults object at 0x000002705DE24460>
```

<!-- GENERATED FROM PYTHON SOURCE LINES 235-242 -->

<a id="define-prism-controls"></a>
...
```none
<ansys.meshing.prime.autogen.automeshstructs.AutoMeshResults object at 0x000002705DE26050>
```
...
Maximum inverse-orthoginal quality of the volume mesh :  0.869553
...
```none
C:\Users\sraj\AppData\Local\Temp\tmpus8wvz6g

Exported file:
 C:\Users\sraj\AppData\Local\Temp\tmpus8wvz6g\f1_rear_wing_vol_mesh.cas
```
...
**Total running time of the script:** (1 minutes 25.228 seconds)

<a id="sphx-glr-download-examples-gallery-examples-gallery-08-lucid-generic-f1-rear-wing-py"></a>
