...
<a id="sphx-glr-examples-gallery-examples-gallery-00-lucid-file-io-py"></a>

<a id="ref-file-io"></a>

<a id="convert-data-when-importing-and-exporting-mesh-and-cad-formats"></a>
...
![Part Structure](images/part_type_new.png)
...
![TopoPart after import of CAD file “pyprime_block_import.fmd”.](images/00_after_cad_import.png)
...
![TopoPart after mesh generation.](images/00_after_mesh_generation.png)
...
<a id="export-mesh-as-pyprimemesh-pmdat-native-format-mesh-file"></a>
...
```none
Exported file:
 C:\Users\sraj\AppData\Local\Temp\tmps_6aafuc\pyprime_block_mesh.pmdat
```

<!-- GENERATED FROM PYTHON SOURCE LINES 163-169 -->

<a id="export-mesh-as-ansys-mapdl-cdb-format-mesh-file"></a>
...
```none
Exported file:
 C:\Users\sraj\AppData\Local\Temp\tmps_6aafuc\pyprime_block_mesh.cdb
```

<!-- GENERATED FROM PYTHON SOURCE LINES 177-194 -->

<a id="export-mesh-ansys-fluent-cas-format-mesh-file"></a>
...
Exported file:
 C:\Users\sraj\AppData\Local\Temp\tmps_6aafuc\pyprime_block_mesh.cas
```

<!-- GENERATED FROM PYTHON SOURCE LINES 205-233 -->

<a id="reading-ansys-pyprimemesh-native-mesh-file-pmdat"></a>
...
![TopoPart after reading mesh part.](images/00_import_pmdat.png)
...
![MeshPart after deleting topology.](images/00_after_delete_topology.png)
...
<a id="reading-ansys-fluent-cas-format-mesh-file"></a>

## Reading Ansys Fluent (.cas) format mesh file

Read the exported Fluent format mesh file.

![After import of cas mesh file.](images/00_import_cas.png)
...
<a id="sphx-glr-download-examples-gallery-examples-gallery-00-lucid-file-io-py"></a>
