# Introduction C#&nbsp; D# (Chris edit #4)

(Chris edit #4) Ansys Prime Mesh Python client library 2024 R2 is a modified version of the open source project PyPrimeMesh 0.6.0. Prime Mesh Python client library 2024 R2 is distributed with Ansys 2024 R2. 
