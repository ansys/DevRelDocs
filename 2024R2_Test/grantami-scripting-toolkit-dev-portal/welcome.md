...
`glibc>=2.28`. The use of Scripting Toolkit on other Linux platforms that meet this threshold is
...
library names for Linux operating systems) can be found in the Installation Guide (provided with
your installer from the Ansys Download Center, or downloaded from the
