...
> CreateEulerianGridFunction(‘Weighted Average’, ‘Absolute Translational Velocity’, ‘Particle Mass’)

… will create the Weighted Average of Absolute Translational Velocity by Particle Mass
grid function. The grid function API wrapper is returned.
