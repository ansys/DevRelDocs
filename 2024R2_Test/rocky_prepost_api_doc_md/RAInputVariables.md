...
Rocky API wrapper for the list of parametric input variables.
...
#### RemoveVariable(variable: Union[[RAParametricVar](RAParametricVar.md#generated.RAParametricVar), str])
