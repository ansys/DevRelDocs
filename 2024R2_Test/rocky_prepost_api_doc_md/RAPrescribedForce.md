...
Rocky API wrapper representing an Additional Force motion.
...
#### GetForceValue(unit: Optional[str] = None)
...
#### SetForceValue(values: Sequence[Union[str, float]], unit: Optional[str] = None)
