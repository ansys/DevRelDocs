...
Rocky API wrapper for a motion frame.
...
* **Parameters:**
  ...
  * **define_as** (*unicode*) – How it should be defined. Valid values are:
    : ’fixed_velocity’
...
#### GetRelativeRotationVector(unit: Optional[str] = None)
...
#### GetRotationAngle(unit: Optional[str] = None)
...
#### SetRelativeRotationVector(values: Sequence[Union[str, float]], unit: Optional[str] = None)

Deprecated: Use [`SetOrientationFromAngleAndVector()`](#generated.RAMotionFrame.SetOrientationFromAngleAndVector) instead.

#### SetRotationAngle(value: Union[str, float], unit: Optional[str] = None)
