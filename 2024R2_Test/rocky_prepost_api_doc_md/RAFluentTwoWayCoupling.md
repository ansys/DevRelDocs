...
Rocky API wrapper to manipulate Fluent Two-Way coupling properties.
...
* **Returns:**
  The returned value will be one of [‘UniformDistribution’, ‘VolumetricDiffusion’].
...
* **Returns:**
  The returned list is [‘UniformDistribution’, ‘VolumetricDiffusion’].
...
* **Parameters:**
  **value** – The value to set. Must be one of [‘UniformDistribution’, ‘VolumetricDiffusion’].
* **Raises:**
