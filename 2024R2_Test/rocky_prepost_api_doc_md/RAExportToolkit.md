...
#### ExportFEMForces(csv_filename: str, entities_to_export: Union[ApiElementItem, str, List], timestep_to_export: Optional[ITimeStep] = None, apply_transformation: bool = True)
...
#### ExportGeometryLoads(csv_filename: str, entities_to_export: Union[ApiElementItem, str, List], timestep_to_export: Optional[ITimeStep] = None, apply_transformation: bool = True, export_forces: bool = False)
...
#### ExportGeometryLoadsMultiTime(csv_filename: str, entities_to_export: Union[ApiElementItem, str, List], timesteps_to_export: List[ITimeStep], apply_transformation: bool = True, export_forces: bool = False, show_progress: bool = False)
...
#### ExportParticleToStl(stl_filename: str, particle: Union[str, Particle, ApiElementItem], time_to_export: Optional[ITimeStep] = None, output_unit: Optional[str] = None, target_size: Optional[float] = None, target_unit: Optional[str] = None)
...
#### ExportToSTL(stl_filename: str, entities: Union[Subject, ApiElementItem, str, List], time_to_export: Optional[ITimeStep] = None, output_unit: Optional[str] = None)
