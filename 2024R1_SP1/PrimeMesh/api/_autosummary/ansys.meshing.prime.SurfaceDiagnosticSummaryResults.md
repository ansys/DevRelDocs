...
| [`SurfaceDiagnosticSummaryResults.print_default`](ansys.meshing.prime.SurfaceDiagnosticSummaryResults.print_default.md#ansys.meshing.prime.SurfaceDiagnosticSummaryResults.print_default)()   | Print the default values of SurfaceDiagnosticSummaryResults.   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|
| [`SurfaceDiagnosticSummaryResults.set_default`](ansys.meshing.prime.SurfaceDiagnosticSummaryResults.set_default.md#ansys.meshing.prime.SurfaceDiagnosticSummaryResults.set_default)([...])    | Set the default values of SurfaceDiagnosticSummaryResults.     |
