...
| [`SmoothDihedralFaceNodesParams.print_default`](ansys.meshing.prime.SmoothDihedralFaceNodesParams.print_default.md#ansys.meshing.prime.SmoothDihedralFaceNodesParams.print_default)()   | Print the default values of SmoothDihedralFaceNodesParams.   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|
| [`SmoothDihedralFaceNodesParams.set_default`](ansys.meshing.prime.SmoothDihedralFaceNodesParams.set_default.md#ansys.meshing.prime.SmoothDihedralFaceNodesParams.set_default)([...])    | Set the default values of SmoothDihedralFaceNodesParams.     |
