...
| [`GlobalSizingParams.print_default`](ansys.meshing.prime.GlobalSizingParams.print_default.md#ansys.meshing.prime.GlobalSizingParams.print_default)()          | Print the default values of GlobalSizingParams.   |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|
| [`GlobalSizingParams.set_default`](ansys.meshing.prime.GlobalSizingParams.set_default.md#ansys.meshing.prime.GlobalSizingParams.set_default)([min, max, ...]) | Set the default values of GlobalSizingParams.     |
