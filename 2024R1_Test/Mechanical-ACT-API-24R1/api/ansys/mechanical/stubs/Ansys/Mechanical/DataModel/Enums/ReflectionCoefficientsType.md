...
<a id="ReflectionCoefficientsType"></a>

### *class* ReflectionCoefficientsType
...
```python
from ansys.mechanical.stubs.Ansys.Mechanical.DataModel.Enums import ReflectionCoefficientsType
```
