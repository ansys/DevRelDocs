...
<a id="EXDSavePrintSummaryOnType"></a>

### *class* EXDSavePrintSummaryOnType
...
```python
from ansys.mechanical.stubs.Ansys.Mechanical.DataModel.Enums import EXDSavePrintSummaryOnType
```
